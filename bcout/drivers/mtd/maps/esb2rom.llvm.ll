; ModuleID = '../bcout/drivers/mtd/maps/esb2rom.llvm.bc'
source_filename = "drivers/mtd/maps/esb2rom.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_esb2rom6:\09\09\09"
module asm ".long\09init_esb2rom - .\09\09\09"
module asm ".previous\09\09\09\09\09"

%struct.esb2rom_window = type { i8*, i64, i64, %struct.list_head, %struct.resource, %struct.pci_dev* }
...
%struct.esb2rom_map_info = type { %struct.list_head, %struct.map_info, %struct.mtd_info*, %struct.resource, [28 x i8] }
...
@esb2rom_window = internal global %struct.esb2rom_window { i8* null, i64 0, i64 0, %struct.list_head { %struct.list_head* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.esb2rom_window* @esb2rom_window to i8*), i64 24) to %struct.list_head*), %struct.list_head* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.esb2rom_window* @esb2rom_window to i8*), i64 24) to %struct.list_head*) }, %struct.resource zeroinitializer, %struct.pci_dev* null }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_esb2rom243 = internal global i8* bitcast (i32 ()* @init_esb2rom to i8*), section ".discard.addressable", align 8, !dbg !4115
@__exitcall_cleanup_esb2rom = internal global void ()* @cleanup_esb2rom, section ".exitcall.exit", align 8, !dbg !4117
@__UNIQUE_ID_file244 = internal constant [38 x i8] c"esb2rom.file=drivers/mtd/maps/esb2rom\00", section ".modinfo", align 1, !dbg !4122
@__UNIQUE_ID_license245 = internal constant [20 x i8] c"esb2rom.license=GPL\00", section ".modinfo", align 1, !dbg !4127
@__UNIQUE_ID_author246 = internal constant [55 x i8] c"esb2rom.author=Lew Glendenning <lglendenning@lnxi.com>\00", section ".modinfo", align 1, !dbg !4130
@__UNIQUE_ID_description247 = internal constant [74 x i8] c"esb2rom.description=MTD map driver for BIOS chips on the ESB2 southbridge\00", section ".modinfo", align 1, !dbg !4135
@esb2rom_pci_tbl = internal constant [7 x %struct.pci_device_id] [%struct.pci_device_id { i32 32902, i32 9280, i32 -1, i32 -1, i32 0, i32 0, i64 0 }, %struct.pci_device_id { i32 32902, i32 9344, i32 -1, i32 -1, i32 0, i32 0, i64 0 }, %struct.pci_device_id { i32 32902, i32 9408, i32 -1, i32 -1, i32 0, i32 0, i64 0 }, %struct.pci_device_id { i32 32902, i32 9424, i32 -1, i32 -1, i32 0, i32 0, i64 0 }, %struct.pci_device_id { i32 32902, i32 9633, i32 -1, i32 -1, i32 0, i32 0, i64 0 }, %struct.pci_device_id { i32 32902, i32 9840, i32 -1, i32 -1, i32 0, i32 0, i64 0 }, %struct.pci_device_id zeroinitializer], align 16, !dbg !4140
@.str = private unnamed_addr constant [18 x i8] c"\017device id = %x\0A\00", align 1
@.str.1 = private unnamed_addr constant [23 x i8] c"\017matched device = %x\0A\00", align 1
@.str.2 = private unnamed_addr constant [24 x i8] c"\017matched device id %x\0A\00", align 1
@.str.3 = private unnamed_addr constant [15 x i8] c"\017retVal = %d\0A\00", align 1
@esb2rom_init_one.rom_probe_types = internal global [3 x i8*] [i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.5, i32 0, i32 0), i8* null], align 16, !dbg !4155
@.str.4 = private unnamed_addr constant [10 x i8] c"cfi_probe\00", align 1
@.str.5 = private unnamed_addr constant [12 x i8] c"jedec_probe\00", align 1
@.str.6 = private unnamed_addr constant [29 x i8] c"\017pci_read_config_word : %x\0A\00", align 1
@.str.7 = private unnamed_addr constant [33 x i8] c"\013esb2rom: Rom window is closed\0A\00", align 1
@.str.8 = private unnamed_addr constant [59 x i8] c"\013esb2rom: firmware access control, I can't enable writes\0A\00", align 1
@.str.9 = private unnamed_addr constant [8 x i8] c"esb2rom\00", align 1
@iomem_resource = external dso_local global %struct.resource, align 8
@.str.10 = private unnamed_addr constant [64 x i8] c"\017esb2rom: %s(): Unable to register resource %pR - kernel bug?\0A\00", align 1
@__func__.esb2rom_init_one = private unnamed_addr constant [17 x i8] c"esb2rom_init_one\00", align 1
@.str.11 = private unnamed_addr constant [41 x i8] c"\013esb2rom: ioremap(%08lx, %08lx) failed\0A\00", align 1
@.str.12 = private unnamed_addr constant [26 x i8] c"\013esb2rom: kmalloc failed\00", align 1
@.str.13 = private unnamed_addr constant [10 x i8] c"%s @%08Lx\00", align 1
@.str.14 = private unnamed_addr constant [56 x i8] c"\014esb2rom rom(%llu) larger than window(%lu). fixing...\0A\00", align 1
@.str.15 = private unnamed_addr constant [40 x i8] c"\013esb2rom: cannot reserve MTD resource\0A\00", align 1
@kmalloc_caches = external dso_local global [3 x [14 x %struct.kmem_cache*]], align 16
@.str.16 = private unnamed_addr constant [21 x i8] c"include/linux/slab.h\00", align 1
@llvm.used = appending global [7 x i8*] [i8* bitcast (void ()* @cleanup_esb2rom to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_esb2rom243 to i8*), i8* bitcast (void ()** @__exitcall_cleanup_esb2rom to i8*), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @__UNIQUE_ID_file244, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__UNIQUE_ID_license245, i32 0, i32 0), i8* getelementptr inbounds ([55 x i8], [55 x i8]* @__UNIQUE_ID_author246, i32 0, i32 0), i8* getelementptr inbounds ([74 x i8], [74 x i8]* @__UNIQUE_ID_description247, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @cleanup_esb2rom() #0 section ".exit.text" !dbg !4426 {
entry:
  %0 = load %struct.pci_dev*, %struct.pci_dev** getelementptr inbounds (%struct.esb2rom_window, %struct.esb2rom_window* @esb2rom_window, i32 0, i32 5), align 8, !dbg !4427
  call void @esb2rom_remove_one(%struct.pci_dev* %0) #9, !dbg !4428
  ret void, !dbg !4429
}

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @esb2rom_remove_one(%struct.pci_dev* %pdev) #1 !dbg !4430 {
entry:
  %pdev.addr = alloca %struct.pci_dev*, align 8
  %window = alloca %struct.esb2rom_window*, align 8
  store %struct.pci_dev* %pdev, %struct.pci_dev** %pdev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.pci_dev** %pdev.addr, metadata !4431, metadata !DIExpression()), !dbg !4432
  call void @llvm.dbg.declare(metadata %struct.esb2rom_window** %window, metadata !4433, metadata !DIExpression()), !dbg !4435
  store %struct.esb2rom_window* @esb2rom_window, %struct.esb2rom_window** %window, align 8, !dbg !4435
  %0 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4436
  call void @esb2rom_cleanup(%struct.esb2rom_window* %0) #9, !dbg !4437
  ret void, !dbg !4438
}

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_esb2rom() #0 section ".init.text" !dbg !4439 {
entry:
  %retval = alloca i32, align 4
  %pdev = alloca %struct.pci_dev*, align 8
  %id = alloca %struct.pci_device_id*, align 8
  %retVal = alloca i32, align 4
  call void @llvm.dbg.declare(metadata %struct.pci_dev** %pdev, metadata !4442, metadata !DIExpression()), !dbg !4443
  call void @llvm.dbg.declare(metadata %struct.pci_device_id** %id, metadata !4444, metadata !DIExpression()), !dbg !4445
  call void @llvm.dbg.declare(metadata i32* %retVal, metadata !4446, metadata !DIExpression()), !dbg !4447
  store %struct.pci_dev* null, %struct.pci_dev** %pdev, align 8, !dbg !4448
  store %struct.pci_device_id* getelementptr inbounds ([7 x %struct.pci_device_id], [7 x %struct.pci_device_id]* @esb2rom_pci_tbl, i64 0, i64 0), %struct.pci_device_id** %id, align 8, !dbg !4449
  br label %for.cond, !dbg !4451

for.cond:                                         ; preds = %for.inc, %entry
  %0 = load %struct.pci_device_id*, %struct.pci_device_id** %id, align 8, !dbg !4452
  %vendor = getelementptr inbounds %struct.pci_device_id, %struct.pci_device_id* %0, i32 0, i32 0, !dbg !4454
  %1 = load i32, i32* %vendor, align 8, !dbg !4454
  %tobool = icmp ne i32 %1, 0, !dbg !4455
  br i1 %tobool, label %for.body, label %for.end, !dbg !4455

for.body:                                         ; preds = %for.cond
  %2 = load %struct.pci_device_id*, %struct.pci_device_id** %id, align 8, !dbg !4456
  %device = getelementptr inbounds %struct.pci_device_id, %struct.pci_device_id* %2, i32 0, i32 1, !dbg !4458
  %3 = load i32, i32* %device, align 4, !dbg !4458
  %call = call i32 (i8*, ...) @printk(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32 %3) #10, !dbg !4459
  %4 = load %struct.pci_device_id*, %struct.pci_device_id** %id, align 8, !dbg !4460
  %vendor1 = getelementptr inbounds %struct.pci_device_id, %struct.pci_device_id* %4, i32 0, i32 0, !dbg !4461
  %5 = load i32, i32* %vendor1, align 8, !dbg !4461
  %6 = load %struct.pci_device_id*, %struct.pci_device_id** %id, align 8, !dbg !4462
  %device2 = getelementptr inbounds %struct.pci_device_id, %struct.pci_device_id* %6, i32 0, i32 1, !dbg !4463
  %7 = load i32, i32* %device2, align 4, !dbg !4463
  %call3 = call %struct.pci_dev* @pci_get_device(i32 %5, i32 %7, %struct.pci_dev* null) #9, !dbg !4464
  store %struct.pci_dev* %call3, %struct.pci_dev** %pdev, align 8, !dbg !4465
  %8 = load %struct.pci_dev*, %struct.pci_dev** %pdev, align 8, !dbg !4466
  %tobool4 = icmp ne %struct.pci_dev* %8, null, !dbg !4466
  br i1 %tobool4, label %if.then, label %if.end, !dbg !4468

if.then:                                          ; preds = %for.body
  %9 = load %struct.pci_device_id*, %struct.pci_device_id** %id, align 8, !dbg !4469
  %device5 = getelementptr inbounds %struct.pci_device_id, %struct.pci_device_id* %9, i32 0, i32 1, !dbg !4471
  %10 = load i32, i32* %device5, align 4, !dbg !4471
  %call6 = call i32 (i8*, ...) @printk(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), i32 %10) #10, !dbg !4472
...
for.inc:                                          ; preds = %if.end
  %11 = load %struct.pci_device_id*, %struct.pci_device_id** %id, align 8, !dbg !4475
  %incdec.ptr = getelementptr %struct.pci_device_id, %struct.pci_device_id* %11, i32 1, !dbg !4475
  store %struct.pci_device_id* %incdec.ptr, %struct.pci_device_id** %id, align 8, !dbg !4475
  br label %for.cond, !dbg !4476, !llvm.loop !4477

for.end:                                          ; preds = %if.then, %for.cond
  %12 = load %struct.pci_dev*, %struct.pci_dev** %pdev, align 8, !dbg !4479
  %tobool7 = icmp ne %struct.pci_dev* %12, null, !dbg !4479
  br i1 %tobool7, label %if.then8, label %if.end13, !dbg !4481

if.then8:                                         ; preds = %for.end
  %13 = load %struct.pci_device_id*, %struct.pci_device_id** %id, align 8, !dbg !4482
  %device9 = getelementptr inbounds %struct.pci_device_id, %struct.pci_device_id* %13, i32 0, i32 1, !dbg !4484
  %14 = load i32, i32* %device9, align 4, !dbg !4484
  %call10 = call i32 (i8*, ...) @printk(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.2, i64 0, i64 0), i32 %14) #10, !dbg !4485
  %15 = load %struct.pci_dev*, %struct.pci_dev** %pdev, align 8, !dbg !4486
  %call11 = call i32 @esb2rom_init_one(%struct.pci_dev* %15, %struct.pci_device_id* getelementptr inbounds ([7 x %struct.pci_device_id], [7 x %struct.pci_device_id]* @esb2rom_pci_tbl, i64 0, i64 0)) #10, !dbg !4487
  store i32 %call11, i32* %retVal, align 4, !dbg !4488
  %16 = load %struct.pci_dev*, %struct.pci_dev** %pdev, align 8, !dbg !4489
  call void @pci_dev_put(%struct.pci_dev* %16) #9, !dbg !4490
  %17 = load i32, i32* %retVal, align 4, !dbg !4491
  %call12 = call i32 (i8*, ...) @printk(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3, i64 0, i64 0), i32 %17) #10, !dbg !4492
  %18 = load i32, i32* %retVal, align 4, !dbg !4493
  store i32 %18, i32* %retval, align 4, !dbg !4494
  br label %return, !dbg !4494

if.end13:                                         ; preds = %for.end
  store i32 -6, i32* %retval, align 4, !dbg !4495
  br label %return, !dbg !4495

return:                                           ; preds = %if.end13, %if.then8
  %19 = load i32, i32* %retval, align 4, !dbg !4496
  ret i32 %19, !dbg !4496
}
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @esb2rom_cleanup(%struct.esb2rom_window* %window) #1 !dbg !4497 {
entry:
  %window.addr = alloca %struct.esb2rom_window*, align 8
  %map = alloca %struct.esb2rom_map_info*, align 8
  %scratch = alloca %struct.esb2rom_map_info*, align 8
  %byte = alloca i8, align 1
  %__mptr = alloca i8*, align 8
  %tmp = alloca %struct.esb2rom_map_info*, align 8
  %__mptr4 = alloca i8*, align 8
  %tmp8 = alloca %struct.esb2rom_map_info*, align 8
  %__mptr18 = alloca i8*, align 8
  %tmp23 = alloca %struct.esb2rom_map_info*, align 8
  store %struct.esb2rom_window* %window, %struct.esb2rom_window** %window.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.esb2rom_window** %window.addr, metadata !4500, metadata !DIExpression()), !dbg !4501
  call void @llvm.dbg.declare(metadata %struct.esb2rom_map_info** %map, metadata !4502, metadata !DIExpression()), !dbg !4503
  call void @llvm.dbg.declare(metadata %struct.esb2rom_map_info** %scratch, metadata !4504, metadata !DIExpression()), !dbg !4505
  call void @llvm.dbg.declare(metadata i8* %byte, metadata !4506, metadata !DIExpression()), !dbg !4507
  %0 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window.addr, align 8, !dbg !4508
  %pdev = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %0, i32 0, i32 5, !dbg !4509
  %1 = load %struct.pci_dev*, %struct.pci_dev** %pdev, align 8, !dbg !4509
  %call = call i32 @pci_read_config_byte(%struct.pci_dev* %1, i32 220, i8* %byte) #9, !dbg !4510
  %2 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window.addr, align 8, !dbg !4511
  %pdev1 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %2, i32 0, i32 5, !dbg !4512
  %3 = load %struct.pci_dev*, %struct.pci_dev** %pdev1, align 8, !dbg !4512
  %4 = load i8, i8* %byte, align 1, !dbg !4513
  %conv = zext i8 %4 to i32, !dbg !4513
  %and = and i32 %conv, -2, !dbg !4514
  %conv2 = trunc i32 %and to i8, !dbg !4513
  %call3 = call i32 @pci_write_config_byte(%struct.pci_dev* %3, i32 220, i8 zeroext %conv2) #9, !dbg !4515
  call void @llvm.dbg.declare(metadata i8** %__mptr, metadata !4516, metadata !DIExpression()), !dbg !4519
  %5 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window.addr, align 8, !dbg !4519
  %maps = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %5, i32 0, i32 3, !dbg !4519
  %next = getelementptr inbounds %struct.list_head, %struct.list_head* %maps, i32 0, i32 0, !dbg !4519
  %6 = load %struct.list_head*, %struct.list_head** %next, align 8, !dbg !4519
  %7 = bitcast %struct.list_head* %6 to i8*, !dbg !4519
  store i8* %7, i8** %__mptr, align 8, !dbg !4519
...
do.end:                                           ; preds = %do.body
  %8 = load i8*, i8** %__mptr, align 8, !dbg !4519
  %add.ptr = getelementptr i8, i8* %8, i64 0, !dbg !4519
  %9 = bitcast i8* %add.ptr to %struct.esb2rom_map_info*, !dbg !4519
  store %struct.esb2rom_map_info* %9, %struct.esb2rom_map_info** %tmp, align 8, !dbg !4520
  %10 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %tmp, align 8, !dbg !4519
  store %struct.esb2rom_map_info* %10, %struct.esb2rom_map_info** %map, align 8, !dbg !4522
  call void @llvm.dbg.declare(metadata i8** %__mptr4, metadata !4523, metadata !DIExpression()), !dbg !4525
  %11 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !4525
  %list = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %11, i32 0, i32 0, !dbg !4525
  %next5 = getelementptr inbounds %struct.list_head, %struct.list_head* %list, i32 0, i32 0, !dbg !4525
  %12 = load %struct.list_head*, %struct.list_head** %next5, align 8, !dbg !4525
  %13 = bitcast %struct.list_head* %12 to i8*, !dbg !4525
  store i8* %13, i8** %__mptr4, align 8, !dbg !4525
  br label %do.body6, !dbg !4525

do.body6:                                         ; preds = %do.end
  br label %do.end7, !dbg !4526

do.end7:                                          ; preds = %do.body6
  %14 = load i8*, i8** %__mptr4, align 8, !dbg !4525
  %add.ptr9 = getelementptr i8, i8* %14, i64 0, !dbg !4525
  %15 = bitcast i8* %add.ptr9 to %struct.esb2rom_map_info*, !dbg !4525
  store %struct.esb2rom_map_info* %15, %struct.esb2rom_map_info** %tmp8, align 8, !dbg !4526
  %16 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %tmp8, align 8, !dbg !4525
  store %struct.esb2rom_map_info* %16, %struct.esb2rom_map_info** %scratch, align 8, !dbg !4522
  br label %for.cond, !dbg !4522

for.cond:                                         ; preds = %do.end22, %do.end7
  %17 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !4528
  %list10 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %17, i32 0, i32 0, !dbg !4528
  %18 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window.addr, align 8, !dbg !4528
  %maps11 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %18, i32 0, i32 3, !dbg !4528
  %cmp = icmp eq %struct.list_head* %list10, %maps11, !dbg !4528
  %lnot = xor i1 %cmp, true, !dbg !4528
  br i1 %lnot, label %for.body, label %for.end, !dbg !4522

for.body:                                         ; preds = %for.cond
  %19 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !4530
  %rsrc = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %19, i32 0, i32 3, !dbg !4533
  %parent = getelementptr inbounds %struct.resource, %struct.resource* %rsrc, i32 0, i32 5, !dbg !4534
  %20 = load %struct.resource*, %struct.resource** %parent, align 8, !dbg !4534
  %tobool = icmp ne %struct.resource* %20, null, !dbg !4530
  br i1 %tobool, label %if.then, label %if.end, !dbg !4535

if.then:                                          ; preds = %for.body
  %21 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !4536
  %rsrc13 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %21, i32 0, i32 3, !dbg !4537
  %call14 = call i32 @release_resource(%struct.resource* %rsrc13) #9, !dbg !4538
  br label %if.end, !dbg !4538

if.end:                                           ; preds = %if.then, %for.body
  %22 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !4539
  %mtd = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %22, i32 0, i32 2, !dbg !4540
  %23 = load %struct.mtd_info*, %struct.mtd_info** %mtd, align 8, !dbg !4540
  %call15 = call i32 @mtd_device_unregister(%struct.mtd_info* %23) #9, !dbg !4541
  %24 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !4542
  %mtd16 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %24, i32 0, i32 2, !dbg !4543
  %25 = load %struct.mtd_info*, %struct.mtd_info** %mtd16, align 8, !dbg !4543
  call void @map_destroy(%struct.mtd_info* %25) #9, !dbg !4544
  %26 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !4545
  %list17 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %26, i32 0, i32 0, !dbg !4546
  call void @list_del(%struct.list_head* %list17) #9, !dbg !4547
  %27 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !4548
  %28 = bitcast %struct.esb2rom_map_info* %27 to i8*, !dbg !4548
  call void @kfree(i8* %28) #9, !dbg !4549
  br label %for.inc, !dbg !4550

for.inc:                                          ; preds = %if.end
  %29 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %scratch, align 8, !dbg !4528
  store %struct.esb2rom_map_info* %29, %struct.esb2rom_map_info** %map, align 8, !dbg !4528
  call void @llvm.dbg.declare(metadata i8** %__mptr18, metadata !4551, metadata !DIExpression()), !dbg !4553
  %30 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %scratch, align 8, !dbg !4553
  %list19 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %30, i32 0, i32 0, !dbg !4553
  %next20 = getelementptr inbounds %struct.list_head, %struct.list_head* %list19, i32 0, i32 0, !dbg !4553
  %31 = load %struct.list_head*, %struct.list_head** %next20, align 8, !dbg !4553
  %32 = bitcast %struct.list_head* %31 to i8*, !dbg !4553
  store i8* %32, i8** %__mptr18, align 8, !dbg !4553
  br label %do.body21, !dbg !4553

do.body21:                                        ; preds = %for.inc
  br label %do.end22, !dbg !4554

do.end22:                                         ; preds = %do.body21
  %33 = load i8*, i8** %__mptr18, align 8, !dbg !4553
  %add.ptr24 = getelementptr i8, i8* %33, i64 0, !dbg !4553
  %34 = bitcast i8* %add.ptr24 to %struct.esb2rom_map_info*, !dbg !4553
  store %struct.esb2rom_map_info* %34, %struct.esb2rom_map_info** %tmp23, align 8, !dbg !4554
  %35 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %tmp23, align 8, !dbg !4553
  store %struct.esb2rom_map_info* %35, %struct.esb2rom_map_info** %scratch, align 8, !dbg !4528
  br label %for.cond, !dbg !4528, !llvm.loop !4556

for.end:                                          ; preds = %for.cond
  %36 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window.addr, align 8, !dbg !4558
  %rsrc25 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %36, i32 0, i32 4, !dbg !4560
  %parent26 = getelementptr inbounds %struct.resource, %struct.resource* %rsrc25, i32 0, i32 5, !dbg !4561
  %37 = load %struct.resource*, %struct.resource** %parent26, align 8, !dbg !4561
  %tobool27 = icmp ne %struct.resource* %37, null, !dbg !4558
  br i1 %tobool27, label %if.then28, label %if.end31, !dbg !4562

if.then28:                                        ; preds = %for.end
  %38 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window.addr, align 8, !dbg !4563
  %rsrc29 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %38, i32 0, i32 4, !dbg !4564
  %call30 = call i32 @release_resource(%struct.resource* %rsrc29) #9, !dbg !4565
  br label %if.end31, !dbg !4565

if.end31:                                         ; preds = %if.then28, %for.end
  %39 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window.addr, align 8, !dbg !4566
  %virt = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %39, i32 0, i32 0, !dbg !4568
  %40 = load i8*, i8** %virt, align 8, !dbg !4568
  %tobool32 = icmp ne i8* %40, null, !dbg !4566
  br i1 %tobool32, label %if.then33, label %if.end36, !dbg !4569

if.then33:                                        ; preds = %if.end31
  %41 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window.addr, align 8, !dbg !4570
  %virt34 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %41, i32 0, i32 0, !dbg !4572
  %42 = load i8*, i8** %virt34, align 8, !dbg !4572
  call void @iounmap(i8* %42) #9, !dbg !4573
  %43 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window.addr, align 8, !dbg !4574
  %virt35 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %43, i32 0, i32 0, !dbg !4575
  store i8* null, i8** %virt35, align 8, !dbg !4576
  %44 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window.addr, align 8, !dbg !4577
  %phys = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %44, i32 0, i32 1, !dbg !4578
  store i64 0, i64* %phys, align 8, !dbg !4579
  %45 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window.addr, align 8, !dbg !4580
  %size = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %45, i32 0, i32 2, !dbg !4581
  store i64 0, i64* %size, align 8, !dbg !4582
  br label %if.end36, !dbg !4583

if.end36:                                         ; preds = %if.then33, %if.end31
  %46 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window.addr, align 8, !dbg !4584
  %pdev37 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %46, i32 0, i32 5, !dbg !4585
  %47 = load %struct.pci_dev*, %struct.pci_dev** %pdev37, align 8, !dbg !4585
  call void @pci_dev_put(%struct.pci_dev* %47) #9, !dbg !4586
  ret void, !dbg !4587
}
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @list_del(%struct.list_head* %entry1) #1 !dbg !4588 {
entry:
  %entry.addr = alloca %struct.list_head*, align 8
  store %struct.list_head* %entry1, %struct.list_head** %entry.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %entry.addr, metadata !4592, metadata !DIExpression()), !dbg !4593
  %0 = load %struct.list_head*, %struct.list_head** %entry.addr, align 8, !dbg !4594
  call void @__list_del_entry(%struct.list_head* %0) #9, !dbg !4595
  %1 = load %struct.list_head*, %struct.list_head** %entry.addr, align 8, !dbg !4596
  %next = getelementptr inbounds %struct.list_head, %struct.list_head* %1, i32 0, i32 0, !dbg !4597
  store %struct.list_head* bitcast (i8* getelementptr (i8, i8* inttoptr (i64 256 to i8*), i64 -2401263026318606336) to %struct.list_head*), %struct.list_head** %next, align 8, !dbg !4598
  %2 = load %struct.list_head*, %struct.list_head** %entry.addr, align 8, !dbg !4599
  %prev = getelementptr inbounds %struct.list_head, %struct.list_head* %2, i32 0, i32 1, !dbg !4600
  store %struct.list_head* bitcast (i8* getelementptr (i8, i8* inttoptr (i64 290 to i8*), i64 -2401263026318606336) to %struct.list_head*), %struct.list_head** %prev, align 8, !dbg !4601
  ret void, !dbg !4602
}
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @__list_del_entry(%struct.list_head* %entry1) #1 !dbg !4603 {
entry:
  %entry.addr = alloca %struct.list_head*, align 8
  store %struct.list_head* %entry1, %struct.list_head** %entry.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %entry.addr, metadata !4604, metadata !DIExpression()), !dbg !4605
  %0 = load %struct.list_head*, %struct.list_head** %entry.addr, align 8, !dbg !4606
  %call = call zeroext i1 @__list_del_entry_valid(%struct.list_head* %0) #9, !dbg !4608
  br i1 %call, label %if.end, label %if.then, !dbg !4609

if.then:                                          ; preds = %entry
  br label %return, !dbg !4610

if.end:                                           ; preds = %entry
  %1 = load %struct.list_head*, %struct.list_head** %entry.addr, align 8, !dbg !4611
  %prev = getelementptr inbounds %struct.list_head, %struct.list_head* %1, i32 0, i32 1, !dbg !4612
  %2 = load %struct.list_head*, %struct.list_head** %prev, align 8, !dbg !4612
  %3 = load %struct.list_head*, %struct.list_head** %entry.addr, align 8, !dbg !4613
  %next = getelementptr inbounds %struct.list_head, %struct.list_head* %3, i32 0, i32 0, !dbg !4614
  %4 = load %struct.list_head*, %struct.list_head** %next, align 8, !dbg !4614
  call void @__list_del(%struct.list_head* %2, %struct.list_head* %4) #9, !dbg !4615
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal zeroext i1 @__list_del_entry_valid(%struct.list_head* %entry1) #1 !dbg !4617 {
entry:
  %entry.addr = alloca %struct.list_head*, align 8
  store %struct.list_head* %entry1, %struct.list_head** %entry.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %entry.addr, metadata !4620, metadata !DIExpression()), !dbg !4621
  ret i1 true, !dbg !4622
}

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @__list_del(%struct.list_head* %prev, %struct.list_head* %next) #1 !dbg !4623 {
entry:
  %prev.addr = alloca %struct.list_head*, align 8
  %next.addr = alloca %struct.list_head*, align 8
  store %struct.list_head* %prev, %struct.list_head** %prev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %prev.addr, metadata !4626, metadata !DIExpression()), !dbg !4627
  store %struct.list_head* %next, %struct.list_head** %next.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %next.addr, metadata !4628, metadata !DIExpression()), !dbg !4629
  %0 = load %struct.list_head*, %struct.list_head** %prev.addr, align 8, !dbg !4630
  %1 = load %struct.list_head*, %struct.list_head** %next.addr, align 8, !dbg !4631
  %prev1 = getelementptr inbounds %struct.list_head, %struct.list_head* %1, i32 0, i32 1, !dbg !4632
  store %struct.list_head* %0, %struct.list_head** %prev1, align 8, !dbg !4633
  br label %do.body, !dbg !4634

do.body:                                          ; preds = %entry
  br label %do.body2, !dbg !4635

do.body2:                                         ; preds = %do.body
  br label %do.end, !dbg !4637

do.end:                                           ; preds = %do.body2
  br label %do.body3, !dbg !4635

do.body3:                                         ; preds = %do.end
  %2 = load %struct.list_head*, %struct.list_head** %next.addr, align 8, !dbg !4639
  %3 = load %struct.list_head*, %struct.list_head** %prev.addr, align 8, !dbg !4639
  %next4 = getelementptr inbounds %struct.list_head, %struct.list_head* %3, i32 0, i32 0, !dbg !4639
  store volatile %struct.list_head* %2, %struct.list_head** %next4, align 8, !dbg !4639
  br label %do.end5, !dbg !4639

do.end5:                                          ; preds = %do.body3
  br label %do.end6, !dbg !4635
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @esb2rom_init_one(%struct.pci_dev* %pdev, %struct.pci_device_id* %ent) #0 section ".init.text" !dbg !4157 {
entry:
  %s.addr.i.i = alloca %struct.kmem_cache*, align 8
  call void @llvm.dbg.declare(metadata %struct.kmem_cache** %s.addr.i.i, metadata !4642, metadata !DIExpression()), !dbg !4646
  %flags.addr.i17.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr.i17.i, metadata !4656, metadata !DIExpression()), !dbg !4657
  %size.addr.i18.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr.i18.i, metadata !4658, metadata !DIExpression()), !dbg !4659
  %ret.i.i = alloca i8*, align 8
  call void @llvm.dbg.declare(metadata i8** %ret.i.i, metadata !4660, metadata !DIExpression()), !dbg !4661
  %retval.i12.i = alloca i32, align 4
  %flags.addr.i13.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr.i13.i, metadata !4662, metadata !DIExpression()), !dbg !4666
  %retval.i.i = alloca i32, align 4
  %size.addr.i11.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr.i11.i, metadata !4668, metadata !DIExpression()), !dbg !4672
  %size.addr.i.i.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr.i.i.i, metadata !4674, metadata !DIExpression()), !dbg !4678
  %flags.addr.i.i.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr.i.i.i, metadata !4683, metadata !DIExpression()), !dbg !4684
  %order.addr.i.i.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %order.addr.i.i.i, metadata !4685, metadata !DIExpression()), !dbg !4686
  %size.addr.i.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr.i.i, metadata !4687, metadata !DIExpression()), !dbg !4688
  %flags.addr.i.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr.i.i, metadata !4689, metadata !DIExpression()), !dbg !4690
  %order.i.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %order.i.i, metadata !4691, metadata !DIExpression()), !dbg !4692
  %retval.i = alloca i8*, align 8
  %size.addr.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr.i, metadata !4693, metadata !DIExpression()), !dbg !4694
  %flags.addr.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr.i, metadata !4695, metadata !DIExpression()), !dbg !4696
  %index.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %index.i, metadata !4697, metadata !DIExpression()), !dbg !4698
  %retval = alloca i32, align 4
  %pdev.addr = alloca %struct.pci_dev*, align 8
  ...
  call void @llvm.dbg.declare(metadata %struct.pci_device_id** %ent.addr, metadata !4701, metadata !DIExpression()), !dbg !4702
  call void @llvm.dbg.declare(metadata %struct.esb2rom_window** %window, metadata !4703, metadata !DIExpression()), !dbg !4704
  store %struct.esb2rom_window* @esb2rom_window, %struct.esb2rom_window** %window, align 8, !dbg !4704
  call void @llvm.dbg.declare(metadata %struct.esb2rom_map_info** %map, metadata !4705, metadata !DIExpression()), !dbg !4706
  store %struct.esb2rom_map_info* null, %struct.esb2rom_map_info** %map, align 8, !dbg !4706
  call void @llvm.dbg.declare(metadata i64* %map_top, metadata !4707, metadata !DIExpression()), !dbg !4708
  call void @llvm.dbg.declare(metadata i8* %byte, metadata !4709, metadata !DIExpression()), !dbg !4710
  call void @llvm.dbg.declare(metadata i16* %word, metadata !4711, metadata !DIExpression()), !dbg !4712
  %0 = load %struct.pci_dev*, %struct.pci_dev** %pdev.addr, align 8, !dbg !4713
  %call = call %struct.pci_dev* @pci_dev_get(%struct.pci_dev* %0) #9, !dbg !4714
  %1 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4715
  %pdev1 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %1, i32 0, i32 5, !dbg !4716
  store %struct.pci_dev* %call, %struct.pci_dev** %pdev1, align 8, !dbg !4717
  %2 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4718
  %phys = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %2, i32 0, i32 1, !dbg !4719
  store i64 0, i64* %phys, align 8, !dbg !4720
  %3 = load %struct.pci_dev*, %struct.pci_dev** %pdev.addr, align 8, !dbg !4721
  %call2 = call i32 @pci_read_config_word(%struct.pci_dev* %3, i32 216, i16* %word) #9, !dbg !4722
  %4 = load i16, i16* %word, align 2, !dbg !4723
  %conv = zext i16 %4 to i32, !dbg !4723
  %call3 = call i32 (i8*, ...) @printk(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.6, i64 0, i64 0), i32 %conv) #10, !dbg !4724
  %5 = load i16, i16* %word, align 2, !dbg !4725
  %conv4 = zext i16 %5 to i32, !dbg !4725
  %and = and i32 %conv4, 65295, !dbg !4727
  %cmp = icmp eq i32 %and, 65295, !dbg !4728
  br i1 %cmp, label %if.then, label %if.else, !dbg !4729

if.then:                                          ; preds = %entry
  %6 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4730
  %phys6 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %6, i32 0, i32 1, !dbg !4731
  store i64 4282384384, i64* %phys6, align 8, !dbg !4732
  br label %if.end93, !dbg !4730

if.else:                                          ; preds = %entry
  %7 = load i16, i16* %word, align 2, !dbg !4733
  %conv7 = zext i16 %7 to i32, !dbg !4733
  %and8 = and i32 %conv7, 65294, !dbg !4735
  %cmp9 = icmp eq i32 %and8, 65294, !dbg !4736
  br i1 %cmp9, label %if.then11, label %if.else13, !dbg !4737

if.then11:                                        ; preds = %if.else
  %8 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4738
  %phys12 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %8, i32 0, i32 1, !dbg !4739
  store i64 4283432960, i64* %phys12, align 8, !dbg !4740
  br label %if.end92, !dbg !4738

if.else13:                                        ; preds = %if.else
  %9 = load i16, i16* %word, align 2, !dbg !4741
  %conv14 = zext i16 %9 to i32, !dbg !4741
  %and15 = and i32 %conv14, 65292, !dbg !4743
  %cmp16 = icmp eq i32 %and15, 65292, !dbg !4744
  br i1 %cmp16, label %if.then18, label %if.else20, !dbg !4745

if.then18:                                        ; preds = %if.else13
  %10 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4746
  %phys19 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %10, i32 0, i32 1, !dbg !4747
  store i64 4284481536, i64* %phys19, align 8, !dbg !4748
  br label %if.end91, !dbg !4746

if.else20:                                        ; preds = %if.else13
  %11 = load i16, i16* %word, align 2, !dbg !4749
  %conv21 = zext i16 %11 to i32, !dbg !4749
  %and22 = and i32 %conv21, 65288, !dbg !4751
  %cmp23 = icmp eq i32 %and22, 65288, !dbg !4752
  br i1 %cmp23, label %if.then25, label %if.else27, !dbg !4753

if.then25:                                        ; preds = %if.else20
  %12 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4754
  %phys26 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %12, i32 0, i32 1, !dbg !4755
  store i64 4285530112, i64* %phys26, align 8, !dbg !4756
  br label %if.end90, !dbg !4754

if.else27:                                        ; preds = %if.else20
  %13 = load i16, i16* %word, align 2, !dbg !4757
  %conv28 = zext i16 %13 to i32, !dbg !4757
  %and29 = and i32 %conv28, 65280, !dbg !4759
  %cmp30 = icmp eq i32 %and29, 65280, !dbg !4760
  br i1 %cmp30, label %if.then32, label %if.else34, !dbg !4761

if.then32:                                        ; preds = %if.else27
  %14 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4762
  %phys33 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %14, i32 0, i32 1, !dbg !4763
  store i64 4290772992, i64* %phys33, align 8, !dbg !4764
  br label %if.end89, !dbg !4762

if.else34:                                        ; preds = %if.else27
  %15 = load i16, i16* %word, align 2, !dbg !4765
  %conv35 = zext i16 %15 to i32, !dbg !4765
  %and36 = and i32 %conv35, 65024, !dbg !4767
  %cmp37 = icmp eq i32 %and36, 65024, !dbg !4768
  br i1 %cmp37, label %if.then39, label %if.else41, !dbg !4769

if.then39:                                        ; preds = %if.else34
  %16 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4770
  %phys40 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %16, i32 0, i32 1, !dbg !4771
  store i64 4291297280, i64* %phys40, align 8, !dbg !4772
  br label %if.end88, !dbg !4770

if.else41:                                        ; preds = %if.else34
  %17 = load i16, i16* %word, align 2, !dbg !4773
  %conv42 = zext i16 %17 to i32, !dbg !4773
  %and43 = and i32 %conv42, 64512, !dbg !4775
  %cmp44 = icmp eq i32 %and43, 64512, !dbg !4776
  br i1 %cmp44, label %if.then46, label %if.else48, !dbg !4777

if.then46:                                        ; preds = %if.else41
  %18 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4778
  %phys47 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %18, i32 0, i32 1, !dbg !4779
  store i64 4291821568, i64* %phys47, align 8, !dbg !4780
  br label %if.end87, !dbg !4778

if.else48:                                        ; preds = %if.else41
  %19 = load i16, i16* %word, align 2, !dbg !4781
  %conv49 = zext i16 %19 to i32, !dbg !4781
  %and50 = and i32 %conv49, 63488, !dbg !4783
  %cmp51 = icmp eq i32 %and50, 63488, !dbg !4784
  br i1 %cmp51, label %if.then53, label %if.else55, !dbg !4785

if.then53:                                        ; preds = %if.else48
  %20 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4786
  %phys54 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %20, i32 0, i32 1, !dbg !4787
  store i64 4292345856, i64* %phys54, align 8, !dbg !4788
  br label %if.end86, !dbg !4786

if.else55:                                        ; preds = %if.else48
  %21 = load i16, i16* %word, align 2, !dbg !4789
  %conv56 = zext i16 %21 to i32, !dbg !4789
  %and57 = and i32 %conv56, 61440, !dbg !4791
  %cmp58 = icmp eq i32 %and57, 61440, !dbg !4792
  br i1 %cmp58, label %if.then60, label %if.else62, !dbg !4793

if.then60:                                        ; preds = %if.else55
  %22 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4794
  %phys61 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %22, i32 0, i32 1, !dbg !4795
  store i64 4292870144, i64* %phys61, align 8, !dbg !4796
  br label %if.end85, !dbg !4794

if.else62:                                        ; preds = %if.else55
  %23 = load i16, i16* %word, align 2, !dbg !4797
  %conv63 = zext i16 %23 to i32, !dbg !4797
  %and64 = and i32 %conv63, 57344, !dbg !4799
  %cmp65 = icmp eq i32 %and64, 57344, !dbg !4800
  br i1 %cmp65, label %if.then67, label %if.else69, !dbg !4801

if.then67:                                        ; preds = %if.else62
  %24 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4802
  %phys68 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %24, i32 0, i32 1, !dbg !4803
  store i64 4293394432, i64* %phys68, align 8, !dbg !4804
  br label %if.end84, !dbg !4802

if.else69:                                        ; preds = %if.else62
  %25 = load i16, i16* %word, align 2, !dbg !4805
  %conv70 = zext i16 %25 to i32, !dbg !4805
  %and71 = and i32 %conv70, 49152, !dbg !4807
  %cmp72 = icmp eq i32 %and71, 49152, !dbg !4808
  br i1 %cmp72, label %if.then74, label %if.else76, !dbg !4809

if.then74:                                        ; preds = %if.else69
  %26 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4810
  %phys75 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %26, i32 0, i32 1, !dbg !4811
  store i64 4293918720, i64* %phys75, align 8, !dbg !4812
  br label %if.end83, !dbg !4810

if.else76:                                        ; preds = %if.else69
  %27 = load i16, i16* %word, align 2, !dbg !4813
  %conv77 = zext i16 %27 to i32, !dbg !4813
  %and78 = and i32 %conv77, 32768, !dbg !4815
  %cmp79 = icmp eq i32 %and78, 32768, !dbg !4816
  br i1 %cmp79, label %if.then81, label %if.end, !dbg !4817

if.then81:                                        ; preds = %if.else76
  %28 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4818
  %phys82 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %28, i32 0, i32 1, !dbg !4819
  store i64 4294443008, i64* %phys82, align 8, !dbg !4820
  br label %if.end, !dbg !4818

if.end:                                           ; preds = %if.then81, %if.else76
  br label %if.end83

if.end83:                                         ; preds = %if.end, %if.then74
  br label %if.end84
...
if.end87:                                         ; preds = %if.end86, %if.then46
  br label %if.end88

if.end88:                                         ; preds = %if.end87, %if.then39
  br label %if.end89

if.end89:                                         ; preds = %if.end88, %if.then32
  br label %if.end90

if.end90:                                         ; preds = %if.end89, %if.then25
  br label %if.end91

if.end91:                                         ; preds = %if.end90, %if.then18
  br label %if.end92

if.end92:                                         ; preds = %if.end91, %if.then11
  br label %if.end93

if.end93:                                         ; preds = %if.end92, %if.then
  %29 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4821
  %phys94 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %29, i32 0, i32 1, !dbg !4823
  %30 = load i64, i64* %phys94, align 8, !dbg !4823
  %cmp95 = icmp eq i64 %30, 0, !dbg !4824
  br i1 %cmp95, label %if.then97, label %if.end99, !dbg !4825

if.then97:                                        ; preds = %if.end93
  %call98 = call i32 (i8*, ...) @printk(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.7, i64 0, i64 0)) #10, !dbg !4826
  br label %out, !dbg !4828

if.end99:                                         ; preds = %if.end93
  %31 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4829
  %phys100 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %31, i32 0, i32 1, !dbg !4830
  %32 = load i64, i64* %phys100, align 8, !dbg !4831
  %sub = sub i64 %32, 4194304, !dbg !4831
  store i64 %sub, i64* %phys100, align 8, !dbg !4831
  %33 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4832
  %phys101 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %33, i32 0, i32 1, !dbg !4833
  %34 = load i64, i64* %phys101, align 8, !dbg !4833
  %sub102 = sub i64 4294967295, %34, !dbg !4834
  %add = add i64 %sub102, 1, !dbg !4835
  %35 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4836
  %size = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %35, i32 0, i32 2, !dbg !4837
  store i64 %add, i64* %size, align 8, !dbg !4838
  %36 = load %struct.pci_dev*, %struct.pci_dev** %pdev.addr, align 8, !dbg !4839
  %call103 = call i32 @pci_read_config_byte(%struct.pci_dev* %36, i32 220, i8* %byte) #9, !dbg !4840
  %37 = load i8, i8* %byte, align 1, !dbg !4841
  %conv104 = zext i8 %37 to i32, !dbg !4841
  %and105 = and i32 %conv104, 1, !dbg !4843
  %tobool = icmp ne i32 %and105, 0, !dbg !4843
  br i1 %tobool, label %if.end111, label %land.lhs.true, !dbg !4844

land.lhs.true:                                    ; preds = %if.end99
  %38 = load i8, i8* %byte, align 1, !dbg !4845
  %conv106 = zext i8 %38 to i32, !dbg !4845
  %and107 = and i32 %conv106, 2, !dbg !4846
  %tobool108 = icmp ne i32 %and107, 0, !dbg !4846
  br i1 %tobool108, label %if.then109, label %if.end111, !dbg !4847

if.then109:                                       ; preds = %land.lhs.true
  %call110 = call i32 (i8*, ...) @printk(i8* getelementptr inbounds ([59 x i8], [59 x i8]* @.str.8, i64 0, i64 0)) #10, !dbg !4848
  br label %out, !dbg !4850

if.end111:                                        ; preds = %land.lhs.true, %if.end99
  %39 = load %struct.pci_dev*, %struct.pci_dev** %pdev.addr, align 8, !dbg !4851
  %40 = load i8, i8* %byte, align 1, !dbg !4852
  %conv112 = zext i8 %40 to i32, !dbg !4852
  %or = or i32 %conv112, 1, !dbg !4853
  %conv113 = trunc i32 %or to i8, !dbg !4852
  %call114 = call i32 @pci_write_config_byte(%struct.pci_dev* %39, i32 220, i8 zeroext %conv113) #9, !dbg !4854
  %41 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4855
  %rsrc = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %41, i32 0, i32 4, !dbg !4856
  %name = getelementptr inbounds %struct.resource, %struct.resource* %rsrc, i32 0, i32 2, !dbg !4857
  store i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.9, i64 0, i64 0), i8** %name, align 8, !dbg !4858
  %42 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4859
  %phys115 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %42, i32 0, i32 1, !dbg !4860
  %43 = load i64, i64* %phys115, align 8, !dbg !4860
  %44 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4861
  %rsrc116 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %44, i32 0, i32 4, !dbg !4862
  %start = getelementptr inbounds %struct.resource, %struct.resource* %rsrc116, i32 0, i32 0, !dbg !4863
  store i64 %43, i64* %start, align 8, !dbg !4864
  %45 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4865
  %phys117 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %45, i32 0, i32 1, !dbg !4866
  %46 = load i64, i64* %phys117, align 8, !dbg !4866
  %47 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4867
  %size118 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %47, i32 0, i32 2, !dbg !4868
  %48 = load i64, i64* %size118, align 8, !dbg !4868
  %add119 = add i64 %46, %48, !dbg !4869
  %sub120 = sub i64 %add119, 1, !dbg !4870
  %49 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4871
  %rsrc121 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %49, i32 0, i32 4, !dbg !4872
  %end = getelementptr inbounds %struct.resource, %struct.resource* %rsrc121, i32 0, i32 1, !dbg !4873
  store i64 %sub120, i64* %end, align 8, !dbg !4874
  %50 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4875
  %rsrc122 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %50, i32 0, i32 4, !dbg !4876
  %flags = getelementptr inbounds %struct.resource, %struct.resource* %rsrc122, i32 0, i32 3, !dbg !4877
  store i64 2147484160, i64* %flags, align 8, !dbg !4878
  %51 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4879
  %rsrc123 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %51, i32 0, i32 4, !dbg !4881
  %call124 = call i32 @request_resource(%struct.resource* @iomem_resource, %struct.resource* %rsrc123) #9, !dbg !4882
  %tobool125 = icmp ne i32 %call124, 0, !dbg !4882
  br i1 %tobool125, label %if.then126, label %if.end130, !dbg !4883

if.then126:                                       ; preds = %if.end111
  %52 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4884
  %rsrc127 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %52, i32 0, i32 4, !dbg !4886
  %parent = getelementptr inbounds %struct.resource, %struct.resource* %rsrc127, i32 0, i32 5, !dbg !4887
  store %struct.resource* null, %struct.resource** %parent, align 8, !dbg !4888
  %53 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4889
  %rsrc128 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %53, i32 0, i32 4, !dbg !4890
  %call129 = call i32 (i8*, ...) @printk(i8* getelementptr inbounds ([64 x i8], [64 x i8]* @.str.10, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @__func__.esb2rom_init_one, i64 0, i64 0), %struct.resource* %rsrc128) #10, !dbg !4891
  br label %if.end130, !dbg !4892

if.end130:                                        ; preds = %if.then126, %if.end111
  %54 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4893
  %phys131 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %54, i32 0, i32 1, !dbg !4894
  %55 = load i64, i64* %phys131, align 8, !dbg !4894
  %56 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4895
  %size132 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %56, i32 0, i32 2, !dbg !4896
  %57 = load i64, i64* %size132, align 8, !dbg !4896
  %call133 = call i8* @ioremap(i64 %55, i64 %57) #9, !dbg !4897
  %58 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4898
  %virt = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %58, i32 0, i32 0, !dbg !4899
  store i8* %call133, i8** %virt, align 8, !dbg !4900
  %59 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4901
  %virt134 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %59, i32 0, i32 0, !dbg !4903
  %60 = load i8*, i8** %virt134, align 8, !dbg !4903
  %tobool135 = icmp ne i8* %60, null, !dbg !4901
  br i1 %tobool135, label %if.end140, label %if.then136, !dbg !4904

if.then136:                                       ; preds = %if.end130
  %61 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4905
  %phys137 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %61, i32 0, i32 1, !dbg !4907
  %62 = load i64, i64* %phys137, align 8, !dbg !4907
  %63 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4908
  %size138 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %63, i32 0, i32 2, !dbg !4909
  %64 = load i64, i64* %size138, align 8, !dbg !4909
  %call139 = call i32 (i8*, ...) @printk(i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.11, i64 0, i64 0), i64 %62, i64 %64) #10, !dbg !4910
  br label %out, !dbg !4911

if.end140:                                        ; preds = %if.end130
  %65 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4912
  %phys141 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %65, i32 0, i32 1, !dbg !4913
  %66 = load i64, i64* %phys141, align 8, !dbg !4913
  store i64 %66, i64* %map_top, align 8, !dbg !4914
  %67 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4915
  %phys142 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %67, i32 0, i32 1, !dbg !4917
  %68 = load i64, i64* %phys142, align 8, !dbg !4917
  %and143 = and i64 %68, 4194303, !dbg !4918
  %cmp144 = icmp ne i64 %and143, 0, !dbg !4919
  br i1 %cmp144, label %if.then146, label %if.end149, !dbg !4920

if.then146:                                       ; preds = %if.end140
  %69 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !4921
  %phys147 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %69, i32 0, i32 1, !dbg !4923
  %70 = load i64, i64* %phys147, align 8, !dbg !4923
  %add148 = add i64 %70, 4194304, !dbg !4924
  store i64 %add148, i64* %map_top, align 8, !dbg !4925
  br label %if.end149, !dbg !4926

if.end149:                                        ; preds = %if.then146, %if.end140
  %71 = load i64, i64* %map_top, align 8, !dbg !4927
  %cmp150 = icmp ult i64 %71, 4290772992, !dbg !4929
  br i1 %cmp150, label %if.then152, label %if.end153, !dbg !4930

if.then152:                                       ; preds = %if.end149
  store i64 4290772992, i64* %map_top, align 8, !dbg !4931
  br label %if.end153, !dbg !4932

if.end153:                                        ; preds = %if.then152, %if.end149
  br label %while.cond, !dbg !4933

while.cond:                                       ; preds = %if.end280, %for.end207, %if.end153
  %72 = load i64, i64* %map_top, align 8, !dbg !4934
  %sub154 = sub i64 %72, 1, !dbg !4935
  %cmp155 = icmp ult i64 %sub154, 4294967295, !dbg !4936
  br i1 %cmp155, label %while.body, label %while.end, !dbg !4933

while.body:                                       ; preds = %while.cond
  call void @llvm.dbg.declare(metadata %struct.cfi_private** %cfi, metadata !4937, metadata !DIExpression()), !dbg !5007
  call void @llvm.dbg.declare(metadata i64* %offset, metadata !5008, metadata !DIExpression()), !dbg !5009
  call void @llvm.dbg.declare(metadata i32* %i, metadata !5010, metadata !DIExpression()), !dbg !5011
  %73 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5012
  %tobool157 = icmp ne %struct.esb2rom_map_info* %73, null, !dbg !5012
  br i1 %tobool157, label %if.end160, label %if.then158, !dbg !5013

if.then158:                                       ; preds = %while.body
  store i64 264, i64* %size.addr.i, align 8
  store i32 3264, i32* %flags.addr.i, align 4
  %74 = load i64, i64* %size.addr.i, align 8, !dbg !5014
  %75 = call i1 @llvm.is.constant.i64(i64 %74) #11, !dbg !5015
  br i1 %75, label %if.then.i, label %if.end9.i, !dbg !5016

if.then.i:                                        ; preds = %if.then158
  %76 = load i64, i64* %size.addr.i, align 8, !dbg !5017
  %cmp.i = icmp ugt i64 %76, 8192, !dbg !5018
  br i1 %cmp.i, label %if.then1.i, label %if.end.i, !dbg !5019

if.then1.i:                                       ; preds = %if.then.i
  %77 = load i64, i64* %size.addr.i, align 8, !dbg !5020
  %78 = load i32, i32* %flags.addr.i, align 4, !dbg !5021
  store i64 %77, i64* %size.addr.i.i, align 8
  store i32 %78, i32* %flags.addr.i.i, align 4
  %79 = load i64, i64* %size.addr.i.i, align 8, !dbg !5022
  %call.i.i = call i32 @get_order(i64 %79) #12, !dbg !5023
  store i32 %call.i.i, i32* %order.i.i, align 4, !dbg !4692
  %80 = load i64, i64* %size.addr.i.i, align 8, !dbg !5024
  %81 = load i32, i32* %flags.addr.i.i, align 4, !dbg !5025
  %82 = load i32, i32* %order.i.i, align 4, !dbg !5026
  ...
  %83 = load i64, i64* %size.addr.i.i.i, align 8, !dbg !5027
  %84 = load i32, i32* %flags.addr.i.i.i, align 4, !dbg !5028
  %85 = load i32, i32* %order.addr.i.i.i, align 4, !dbg !5029
  %call.i.i.i = call noalias i8* @kmalloc_order(i64 %83, i32 %84, i32 %85) #13, !dbg !5030
  %ptrint.i.i.i = ptrtoint i8* %call.i.i.i to i64, !dbg !5030
  %maskedptr.i.i.i = and i64 %ptrint.i.i.i, 4095, !dbg !5030
  %maskcond.i.i.i = icmp eq i64 %maskedptr.i.i.i, 0, !dbg !5030
  call void @llvm.assume(i1 %maskcond.i.i.i) #11, !dbg !5030
  store i8* %call.i.i.i, i8** %retval.i, align 8, !dbg !5031
  br label %kmalloc.exit, !dbg !5031

if.end.i:                                         ; preds = %if.then.i
  %86 = load i64, i64* %size.addr.i, align 8, !dbg !5032
  store i64 %86, i64* %size.addr.i11.i, align 8
  %87 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5033
  %tobool.i.i = icmp ne i64 %87, 0, !dbg !5033
  br i1 %tobool.i.i, label %if.end.i.i, label %if.then.i.i, !dbg !5035

if.then.i.i:                                      ; preds = %if.end.i
  store i32 0, i32* %retval.i.i, align 4, !dbg !5036
  br label %kmalloc_index.exit.i, !dbg !5036

if.end.i.i:                                       ; preds = %if.end.i
  %88 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5037
  %cmp.i.i = icmp ule i64 %88, 8, !dbg !5039
  br i1 %cmp.i.i, label %if.then1.i.i, label %if.end2.i.i, !dbg !5040

if.then1.i.i:                                     ; preds = %if.end.i.i
  store i32 3, i32* %retval.i.i, align 4, !dbg !5041
  br label %kmalloc_index.exit.i, !dbg !5041

if.end2.i.i:                                      ; preds = %if.end.i.i
  %89 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5042
  %cmp3.i.i = icmp ugt i64 %89, 64, !dbg !5044
  br i1 %cmp3.i.i, label %land.lhs.true.i.i, label %if.end6.i.i, !dbg !5045

land.lhs.true.i.i:                                ; preds = %if.end2.i.i
  %90 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5046
  %cmp4.i.i = icmp ule i64 %90, 96, !dbg !5047
  br i1 %cmp4.i.i, label %if.then5.i.i, label %if.end6.i.i, !dbg !5048

if.then5.i.i:                                     ; preds = %land.lhs.true.i.i
  store i32 1, i32* %retval.i.i, align 4, !dbg !5049
  br label %kmalloc_index.exit.i, !dbg !5049

if.end6.i.i:                                      ; preds = %land.lhs.true.i.i, %if.end2.i.i
  %91 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5050
  %cmp7.i.i = icmp ugt i64 %91, 128, !dbg !5052
  br i1 %cmp7.i.i, label %land.lhs.true8.i.i, label %if.end11.i.i, !dbg !5053

land.lhs.true8.i.i:                               ; preds = %if.end6.i.i
  %92 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5054
  %cmp9.i.i = icmp ule i64 %92, 192, !dbg !5055
  br i1 %cmp9.i.i, label %if.then10.i.i, label %if.end11.i.i, !dbg !5056

if.then10.i.i:                                    ; preds = %land.lhs.true8.i.i
  store i32 2, i32* %retval.i.i, align 4, !dbg !5057
  br label %kmalloc_index.exit.i, !dbg !5057

if.end11.i.i:                                     ; preds = %land.lhs.true8.i.i, %if.end6.i.i
  %93 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5058
  %cmp12.i.i = icmp ule i64 %93, 8, !dbg !5060
  br i1 %cmp12.i.i, label %if.then13.i.i, label %if.end14.i.i, !dbg !5061

if.then13.i.i:                                    ; preds = %if.end11.i.i
  store i32 3, i32* %retval.i.i, align 4, !dbg !5062
  br label %kmalloc_index.exit.i, !dbg !5062

if.end14.i.i:                                     ; preds = %if.end11.i.i
  %94 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5063
  %cmp15.i.i = icmp ule i64 %94, 16, !dbg !5065
  br i1 %cmp15.i.i, label %if.then16.i.i, label %if.end17.i.i, !dbg !5066

if.then16.i.i:                                    ; preds = %if.end14.i.i
  store i32 4, i32* %retval.i.i, align 4, !dbg !5067
  br label %kmalloc_index.exit.i, !dbg !5067

if.end17.i.i:                                     ; preds = %if.end14.i.i
  %95 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5068
  %cmp18.i.i = icmp ule i64 %95, 32, !dbg !5070
  br i1 %cmp18.i.i, label %if.then19.i.i, label %if.end20.i.i, !dbg !5071

if.then19.i.i:                                    ; preds = %if.end17.i.i
  store i32 5, i32* %retval.i.i, align 4, !dbg !5072
  br label %kmalloc_index.exit.i, !dbg !5072

if.end20.i.i:                                     ; preds = %if.end17.i.i
  %96 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5073
  %cmp21.i.i = icmp ule i64 %96, 64, !dbg !5075
  br i1 %cmp21.i.i, label %if.then22.i.i, label %if.end23.i.i, !dbg !5076

if.then22.i.i:                                    ; preds = %if.end20.i.i
  store i32 6, i32* %retval.i.i, align 4, !dbg !5077
  br label %kmalloc_index.exit.i, !dbg !5077

if.end23.i.i:                                     ; preds = %if.end20.i.i
  %97 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5078
  %cmp24.i.i = icmp ule i64 %97, 128, !dbg !5080
  br i1 %cmp24.i.i, label %if.then25.i.i, label %if.end26.i.i, !dbg !5081

if.then25.i.i:                                    ; preds = %if.end23.i.i
  store i32 7, i32* %retval.i.i, align 4, !dbg !5082
  br label %kmalloc_index.exit.i, !dbg !5082

if.end26.i.i:                                     ; preds = %if.end23.i.i
  %98 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5083
  %cmp27.i.i = icmp ule i64 %98, 256, !dbg !5085
  br i1 %cmp27.i.i, label %if.then28.i.i, label %if.end29.i.i, !dbg !5086

if.then28.i.i:                                    ; preds = %if.end26.i.i
  store i32 8, i32* %retval.i.i, align 4, !dbg !5087
  br label %kmalloc_index.exit.i, !dbg !5087

if.end29.i.i:                                     ; preds = %if.end26.i.i
  %99 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5088
  %cmp30.i.i = icmp ule i64 %99, 512, !dbg !5090
  br i1 %cmp30.i.i, label %if.then31.i.i, label %if.end32.i.i, !dbg !5091

if.then31.i.i:                                    ; preds = %if.end29.i.i
  store i32 9, i32* %retval.i.i, align 4, !dbg !5092
  br label %kmalloc_index.exit.i, !dbg !5092

if.end32.i.i:                                     ; preds = %if.end29.i.i
  %100 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5093
  %cmp33.i.i = icmp ule i64 %100, 1024, !dbg !5095
...
if.end35.i.i:                                     ; preds = %if.end32.i.i
  %101 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5098
  %cmp36.i.i = icmp ule i64 %101, 2048, !dbg !5100
  br i1 %cmp36.i.i, label %if.then37.i.i, label %if.end38.i.i, !dbg !5101

if.then37.i.i:                                    ; preds = %if.end35.i.i
  store i32 11, i32* %retval.i.i, align 4, !dbg !5102
  br label %kmalloc_index.exit.i, !dbg !5102

if.end38.i.i:                                     ; preds = %if.end35.i.i
  %102 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5103
  %cmp39.i.i = icmp ule i64 %102, 4096, !dbg !5105
  br i1 %cmp39.i.i, label %if.then40.i.i, label %if.end41.i.i, !dbg !5106

if.then40.i.i:                                    ; preds = %if.end38.i.i
  store i32 12, i32* %retval.i.i, align 4, !dbg !5107
  br label %kmalloc_index.exit.i, !dbg !5107

if.end41.i.i:                                     ; preds = %if.end38.i.i
  %103 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5108
  %cmp42.i.i = icmp ule i64 %103, 8192, !dbg !5110
  br i1 %cmp42.i.i, label %if.then43.i.i, label %if.end44.i.i, !dbg !5111

if.then43.i.i:                                    ; preds = %if.end41.i.i
  store i32 13, i32* %retval.i.i, align 4, !dbg !5112
  br label %kmalloc_index.exit.i, !dbg !5112

if.end44.i.i:                                     ; preds = %if.end41.i.i
  %104 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5113
  %cmp45.i.i = icmp ule i64 %104, 16384, !dbg !5115
  br i1 %cmp45.i.i, label %if.then46.i.i, label %if.end47.i.i, !dbg !5116

if.then46.i.i:                                    ; preds = %if.end44.i.i
  store i32 14, i32* %retval.i.i, align 4, !dbg !5117
  br label %kmalloc_index.exit.i, !dbg !5117

if.end47.i.i:                                     ; preds = %if.end44.i.i
  %105 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5118
  %cmp48.i.i = icmp ule i64 %105, 32768, !dbg !5120
  br i1 %cmp48.i.i, label %if.then49.i.i, label %if.end50.i.i, !dbg !5121

if.then49.i.i:                                    ; preds = %if.end47.i.i
  store i32 15, i32* %retval.i.i, align 4, !dbg !5122
  br label %kmalloc_index.exit.i, !dbg !5122

if.end50.i.i:                                     ; preds = %if.end47.i.i
  %106 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5123
  %cmp51.i.i = icmp ule i64 %106, 65536, !dbg !5125
  br i1 %cmp51.i.i, label %if.then52.i.i, label %if.end53.i.i, !dbg !5126

if.then52.i.i:                                    ; preds = %if.end50.i.i
  store i32 16, i32* %retval.i.i, align 4, !dbg !5127
  br label %kmalloc_index.exit.i, !dbg !5127

if.end53.i.i:                                     ; preds = %if.end50.i.i
  %107 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5128
  %cmp54.i.i = icmp ule i64 %107, 131072, !dbg !5130
  br i1 %cmp54.i.i, label %if.then55.i.i, label %if.end56.i.i, !dbg !5131

if.then55.i.i:                                    ; preds = %if.end53.i.i
  store i32 17, i32* %retval.i.i, align 4, !dbg !5132
  br label %kmalloc_index.exit.i, !dbg !5132

if.end56.i.i:                                     ; preds = %if.end53.i.i
  %108 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5133
  %cmp57.i.i = icmp ule i64 %108, 262144, !dbg !5135
  br i1 %cmp57.i.i, label %if.then58.i.i, label %if.end59.i.i, !dbg !5136

if.then58.i.i:                                    ; preds = %if.end56.i.i
  store i32 18, i32* %retval.i.i, align 4, !dbg !5137
  br label %kmalloc_index.exit.i, !dbg !5137

if.end59.i.i:                                     ; preds = %if.end56.i.i
  %109 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5138
  %cmp60.i.i = icmp ule i64 %109, 524288, !dbg !5140
  br i1 %cmp60.i.i, label %if.then61.i.i, label %if.end62.i.i, !dbg !5141

if.then61.i.i:                                    ; preds = %if.end59.i.i
  store i32 19, i32* %retval.i.i, align 4, !dbg !5142
  br label %kmalloc_index.exit.i, !dbg !5142

if.end62.i.i:                                     ; preds = %if.end59.i.i
  %110 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5143
  %cmp63.i.i = icmp ule i64 %110, 1048576, !dbg !5145
  br i1 %cmp63.i.i, label %if.then64.i.i, label %if.end65.i.i, !dbg !5146

if.then64.i.i:                                    ; preds = %if.end62.i.i
  store i32 20, i32* %retval.i.i, align 4, !dbg !5147
  br label %kmalloc_index.exit.i, !dbg !5147

if.end65.i.i:                                     ; preds = %if.end62.i.i
  %111 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5148
  %cmp66.i.i = icmp ule i64 %111, 2097152, !dbg !5150
  br i1 %cmp66.i.i, label %if.then67.i.i, label %if.end68.i.i, !dbg !5151

if.then67.i.i:                                    ; preds = %if.end65.i.i
  store i32 21, i32* %retval.i.i, align 4, !dbg !5152
  br label %kmalloc_index.exit.i, !dbg !5152

if.end68.i.i:                                     ; preds = %if.end65.i.i
  %112 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5153
  %cmp69.i.i = icmp ule i64 %112, 4194304, !dbg !5155
  br i1 %cmp69.i.i, label %if.then70.i.i, label %if.end71.i.i, !dbg !5156

if.then70.i.i:                                    ; preds = %if.end68.i.i
  store i32 22, i32* %retval.i.i, align 4, !dbg !5157
  br label %kmalloc_index.exit.i, !dbg !5157

if.end71.i.i:                                     ; preds = %if.end68.i.i
  %113 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5158
  %cmp72.i.i = icmp ule i64 %113, 8388608, !dbg !5160
  br i1 %cmp72.i.i, label %if.then73.i.i, label %if.end74.i.i, !dbg !5161

if.then73.i.i:                                    ; preds = %if.end71.i.i
  store i32 23, i32* %retval.i.i, align 4, !dbg !5162
  br label %kmalloc_index.exit.i, !dbg !5162

if.end74.i.i:                                     ; preds = %if.end71.i.i
  %114 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5163
  %cmp75.i.i = icmp ule i64 %114, 16777216, !dbg !5165
  br i1 %cmp75.i.i, label %if.then76.i.i, label %if.end77.i.i, !dbg !5166

if.then76.i.i:                                    ; preds = %if.end74.i.i
  store i32 24, i32* %retval.i.i, align 4, !dbg !5167
  br label %kmalloc_index.exit.i, !dbg !5167

if.end77.i.i:                                     ; preds = %if.end74.i.i
  %115 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5168
  %cmp78.i.i = icmp ule i64 %115, 33554432, !dbg !5170
  br i1 %cmp78.i.i, label %if.then79.i.i, label %if.end80.i.i, !dbg !5171

if.then79.i.i:                                    ; preds = %if.end77.i.i
  store i32 25, i32* %retval.i.i, align 4, !dbg !5172
  br label %kmalloc_index.exit.i, !dbg !5172

if.end80.i.i:                                     ; preds = %if.end77.i.i
  %116 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5173
  %cmp81.i.i = icmp ule i64 %116, 67108864, !dbg !5175
  br i1 %cmp81.i.i, label %if.then82.i.i, label %if.end83.i.i, !dbg !5176

if.then82.i.i:                                    ; preds = %if.end80.i.i
  store i32 26, i32* %retval.i.i, align 4, !dbg !5177
  br label %kmalloc_index.exit.i, !dbg !5177

if.end83.i.i:                                     ; preds = %if.end80.i.i
  call void asm sideeffect "1:\09.byte 0x0f, 0x0b\0A.pushsection __bug_table,\22aw\22\0A2:\09.long 1b - 2b\09# bug_entry::bug_addr\0A\09.long ${0:c} - 2b\09# bug_entry::file\0A\09.word ${1:c}\09# bug_entry::line\0A\09.word ${2:c}\09# bug_entry::flags\0A\09.org 2b+${3:c}\0A.popsection", "i,i,i,i,~{dirflag},~{fpsr},~{flags}"(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.16, i64 0, i64 0), i32 382, i32 0, i64 12) #11, !dbg !5178, !srcloc !5181
  call void asm sideeffect "${0:c}:\0A\09.pushsection .discard.unreachable\0A\09.long ${0:c}b - .\0A\09.popsection\0A\09", "i,~{dirflag},~{fpsr},~{flags}"(i32 105) #11, !dbg !5182, !srcloc !5185
  unreachable, !dbg !5186

kmalloc_index.exit.i:                             ; preds = %if.then82.i.i, %if.then79.i.i, %if.then76.i.i, %if.then73.i.i, %if.then70.i.i, %if.then67.i.i, %if.then64.i.i, %if.then61.i.i, %if.then58.i.i, %if.then55.i.i, %if.then52.i.i, %if.then49.i.i, %if.then46.i.i, %if.then43.i.i, %if.then40.i.i, %if.then37.i.i, %if.then34.i.i, %if.then31.i.i, %if.then28.i.i, %if.then25.i.i, %if.then22.i.i, %if.then19.i.i, %if.then16.i.i, %if.then13.i.i, %if.then10.i.i, %if.then5.i.i, %if.then1.i.i, %if.then.i.i
  %117 = load i32, i32* %retval.i.i, align 4, !dbg !5187
  store i32 %117, i32* %index.i, align 4, !dbg !5188
  %118 = load i32, i32* %index.i, align 4, !dbg !5189
  %tobool.i = icmp ne i32 %118, 0, !dbg !5189
  br i1 %tobool.i, label %if.end4.i, label %if.then3.i, !dbg !5191

if.then3.i:                                       ; preds = %kmalloc_index.exit.i
  store i8* inttoptr (i64 16 to i8*), i8** %retval.i, align 8, !dbg !5192
  br label %kmalloc.exit, !dbg !5192

if.end4.i:                                        ; preds = %kmalloc_index.exit.i
  %119 = load i32, i32* %flags.addr.i, align 4, !dbg !5193
  store i32 %119, i32* %flags.addr.i13.i, align 4
  %120 = load i32, i32* %flags.addr.i13.i, align 4, !dbg !5194
  %and.i.i = and i32 %120, 17, !dbg !5194
  %cmp.i14.i = icmp eq i32 %and.i.i, 0, !dbg !5194
  %lnot.i.i = xor i1 %cmp.i14.i, true, !dbg !5194
  %lnot.ext.i.i = zext i1 %cmp.i14.i to i32, !dbg !5194
  %conv.i.i = sext i32 %lnot.ext.i.i to i64, !dbg !5194
  br i1 %cmp.i14.i, label %if.then.i15.i, label %if.end.i16.i, !dbg !5196

if.then.i15.i:                                    ; preds = %if.end4.i
  store i32 0, i32* %retval.i12.i, align 4, !dbg !5197
  br label %kmalloc_type.exit.i, !dbg !5197

if.end.i16.i:                                     ; preds = %if.end4.i
  %121 = load i32, i32* %flags.addr.i13.i, align 4, !dbg !5198
  %and2.i.i = and i32 %121, 1, !dbg !5199
  %tobool3.i.i = icmp ne i32 %and2.i.i, 0, !dbg !5198
  %122 = zext i1 %tobool3.i.i to i64, !dbg !5198
  %cond.i.i = select i1 %tobool3.i.i, i32 2, i32 1, !dbg !5198
  store i32 %cond.i.i, i32* %retval.i12.i, align 4, !dbg !5200
  br label %kmalloc_type.exit.i, !dbg !5200

kmalloc_type.exit.i:                              ; preds = %if.end.i16.i, %if.then.i15.i
  %123 = load i32, i32* %retval.i12.i, align 4, !dbg !5201
  %idxprom.i = zext i32 %123 to i64, !dbg !5202
  %arrayidx.i = getelementptr [3 x [14 x %struct.kmem_cache*]], [3 x [14 x %struct.kmem_cache*]]* @kmalloc_caches, i64 0, i64 %idxprom.i, !dbg !5202
  %124 = load i32, i32* %index.i, align 4, !dbg !5203
  %idxprom6.i = zext i32 %124 to i64, !dbg !5202
  %arrayidx7.i = getelementptr [14 x %struct.kmem_cache*], [14 x %struct.kmem_cache*]* %arrayidx.i, i64 0, i64 %idxprom6.i, !dbg !5202
  %125 = load %struct.kmem_cache*, %struct.kmem_cache** %arrayidx7.i, align 8, !dbg !5202
  %126 = load i32, i32* %flags.addr.i, align 4, !dbg !5204
  %127 = load i64, i64* %size.addr.i, align 8, !dbg !5205
  ...
  %128 = load %struct.kmem_cache*, %struct.kmem_cache** %s.addr.i.i, align 8, !dbg !5206
  %129 = load i32, i32* %flags.addr.i17.i, align 4, !dbg !5207
  %call.i19.i = call noalias i8* @kmem_cache_alloc(%struct.kmem_cache* %128, i32 %129) #13, !dbg !5208
  %ptrint.i.i = ptrtoint i8* %call.i19.i to i64, !dbg !5208
  %maskedptr.i.i = and i64 %ptrint.i.i, 7, !dbg !5208
  %maskcond.i.i = icmp eq i64 %maskedptr.i.i, 0, !dbg !5208
  call void @llvm.assume(i1 %maskcond.i.i) #11, !dbg !5208
  store i8* %call.i19.i, i8** %ret.i.i, align 8, !dbg !4661
  %130 = load %struct.kmem_cache*, %struct.kmem_cache** %s.addr.i.i, align 8, !dbg !5209
  %131 = load i8*, i8** %ret.i.i, align 8, !dbg !5210
  %132 = load i64, i64* %size.addr.i18.i, align 8, !dbg !5211
  %133 = load i32, i32* %flags.addr.i17.i, align 4, !dbg !5212
  %call1.i.i = call i8* @kasan_kmalloc(%struct.kmem_cache* %130, i8* %131, i64 %132, i32 %133) #13, !dbg !5213
  store i8* %call1.i.i, i8** %ret.i.i, align 8, !dbg !5214
  %134 = load i8*, i8** %ret.i.i, align 8, !dbg !5215
  store i8* %134, i8** %retval.i, align 8, !dbg !5216
  br label %kmalloc.exit, !dbg !5216

if.end9.i:                                        ; preds = %if.then158
  %135 = load i64, i64* %size.addr.i, align 8, !dbg !5217
  %136 = load i32, i32* %flags.addr.i, align 4, !dbg !5218
  %call10.i = call noalias i8* @__kmalloc(i64 %135, i32 %136) #13, !dbg !5219
  %ptrint.i = ptrtoint i8* %call10.i to i64, !dbg !5219
  %maskedptr.i = and i64 %ptrint.i, 7, !dbg !5219
  %maskcond.i = icmp eq i64 %maskedptr.i, 0, !dbg !5219
  call void @llvm.assume(i1 %maskcond.i) #11, !dbg !5219
  store i8* %call10.i, i8** %retval.i, align 8, !dbg !5220
  br label %kmalloc.exit, !dbg !5220

kmalloc.exit:                                     ; preds = %if.then1.i, %if.then3.i, %kmalloc_type.exit.i, %if.end9.i
  %137 = load i8*, i8** %retval.i, align 8, !dbg !5221
  %138 = bitcast i8* %137 to %struct.esb2rom_map_info*, !dbg !5222
  store %struct.esb2rom_map_info* %138, %struct.esb2rom_map_info** %map, align 8, !dbg !5223
  br label %if.end160, !dbg !5224

if.end160:                                        ; preds = %kmalloc.exit, %while.body
  %139 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5225
  %tobool161 = icmp ne %struct.esb2rom_map_info* %139, null, !dbg !5225
  br i1 %tobool161, label %if.end164, label %if.then162, !dbg !5227

if.then162:                                       ; preds = %if.end160
  %call163 = call i32 (i8*, ...) @printk(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.12, i64 0, i64 0)) #10, !dbg !5228
  br label %out, !dbg !5230

if.end164:                                        ; preds = %if.end160
  %140 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5231
  %141 = bitcast %struct.esb2rom_map_info* %140 to i8*, !dbg !5232
  call void @llvm.memset.p0i8.i64(i8* align 8 %141, i8 0, i64 264, i1 false), !dbg !5232
  %142 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5233
  %list = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %142, i32 0, i32 0, !dbg !5234
  call void @INIT_LIST_HEAD(%struct.list_head* %list) #9, !dbg !5235
  %143 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5236
  %map_name = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %143, i32 0, i32 4, !dbg !5237
  %arraydecay = getelementptr inbounds [28 x i8], [28 x i8]* %map_name, i64 0, i64 0, !dbg !5236
  %144 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5238
  %map165 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %144, i32 0, i32 1, !dbg !5239
  %name166 = getelementptr inbounds %struct.map_info, %struct.map_info* %map165, i32 0, i32 0, !dbg !5240
  store i8* %arraydecay, i8** %name166, align 8, !dbg !5241
  %145 = load i64, i64* %map_top, align 8, !dbg !5242
  %146 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5243
  %map167 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %146, i32 0, i32 1, !dbg !5244
  %phys168 = getelementptr inbounds %struct.map_info, %struct.map_info* %map167, i32 0, i32 2, !dbg !5245
  store i64 %145, i64* %phys168, align 8, !dbg !5246
  %147 = load i64, i64* %map_top, align 8, !dbg !5247
  %148 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !5248
  %phys169 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %148, i32 0, i32 1, !dbg !5249
  %149 = load i64, i64* %phys169, align 8, !dbg !5249
  %sub170 = sub i64 %147, %149, !dbg !5250
  store i64 %sub170, i64* %offset, align 8, !dbg !5251
  %150 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !5252
  %virt171 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %150, i32 0, i32 0, !dbg !5253
  %151 = load i8*, i8** %virt171, align 8, !dbg !5253
  %152 = ptrtoint i8* %151 to i64, !dbg !5254
  %153 = load i64, i64* %offset, align 8, !dbg !5255
  %add172 = add i64 %152, %153, !dbg !5256
  %154 = inttoptr i64 %add172 to i8*, !dbg !5257
  %155 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5258
  %map173 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %155, i32 0, i32 1, !dbg !5259
  %virt174 = getelementptr inbounds %struct.map_info, %struct.map_info* %map173, i32 0, i32 3, !dbg !5260
  store i8* %154, i8** %virt174, align 8, !dbg !5261
  %156 = load i64, i64* %map_top, align 8, !dbg !5262
  %sub175 = sub i64 4294967295, %156, !dbg !5263
  %add176 = add i64 %sub175, 1, !dbg !5264
  %157 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5265
  %map177 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %157, i32 0, i32 1, !dbg !5266
  %size178 = getelementptr inbounds %struct.map_info, %struct.map_info* %map177, i32 0, i32 1, !dbg !5267
  store i64 %add176, i64* %size178, align 8, !dbg !5268
  %158 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5269
  %map_name179 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %158, i32 0, i32 4, !dbg !5270
  %arraydecay180 = getelementptr inbounds [28 x i8], [28 x i8]* %map_name179, i64 0, i64 0, !dbg !5269
  %159 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5271
  %map181 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %159, i32 0, i32 1, !dbg !5272
  %phys182 = getelementptr inbounds %struct.map_info, %struct.map_info* %map181, i32 0, i32 2, !dbg !5273
  %160 = load i64, i64* %phys182, align 8, !dbg !5273
  %call183 = call i32 (i8*, i8*, ...) @sprintf(i8* %arraydecay180, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.13, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.9, i64 0, i64 0), i64 %160) #9, !dbg !5274
  %161 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5275
  %map184 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %161, i32 0, i32 1, !dbg !5277
  %bankwidth = getelementptr inbounds %struct.map_info, %struct.map_info* %map184, i32 0, i32 6, !dbg !5278
  store i32 32, i32* %bankwidth, align 4, !dbg !5279
  br label %for.cond, !dbg !5275

for.cond:                                         ; preds = %for.inc204, %if.end164
  %162 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5280
  %map185 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %162, i32 0, i32 1, !dbg !5282
  %bankwidth186 = getelementptr inbounds %struct.map_info, %struct.map_info* %map185, i32 0, i32 6, !dbg !5283
  %163 = load i32, i32* %bankwidth186, align 4, !dbg !5283
  %tobool187 = icmp ne i32 %163, 0, !dbg !5284
  br i1 %tobool187, label %for.body, label %for.end207, !dbg !5284

for.body:                                         ; preds = %for.cond
  call void @llvm.dbg.declare(metadata i8*** %probe_type, metadata !5285, metadata !DIExpression()), !dbg !5288
  %164 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5289
  %map188 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %164, i32 0, i32 1, !dbg !5291
  %bankwidth189 = getelementptr inbounds %struct.map_info, %struct.map_info* %map188, i32 0, i32 6, !dbg !5292
  %165 = load i32, i32* %bankwidth189, align 4, !dbg !5292
  %call190 = call i32 @map_bankwidth_supported(i32 %165) #9, !dbg !5293
  %tobool191 = icmp ne i32 %call190, 0, !dbg !5293
  br i1 %tobool191, label %if.end193, label %if.then192, !dbg !5294

if.then192:                                       ; preds = %for.body
  br label %for.inc204, !dbg !5295

if.end193:                                        ; preds = %for.body
  %166 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5296
  %map194 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %166, i32 0, i32 1, !dbg !5297
  call void @simple_map_init(%struct.map_info* %map194) #9, !dbg !5298
  store i8** getelementptr inbounds ([3 x i8*], [3 x i8*]* @esb2rom_init_one.rom_probe_types, i64 0, i64 0), i8*** %probe_type, align 8, !dbg !5299
  br label %for.cond195, !dbg !5300

for.cond195:                                      ; preds = %for.inc, %if.end193
  %167 = load i8**, i8*** %probe_type, align 8, !dbg !5301
  %168 = load i8*, i8** %167, align 8, !dbg !5304
  %tobool196 = icmp ne i8* %168, null, !dbg !5305
  br i1 %tobool196, label %for.body197, label %for.end, !dbg !5305

for.body197:                                      ; preds = %for.cond195
  %169 = load i8**, i8*** %probe_type, align 8, !dbg !5306
  %170 = load i8*, i8** %169, align 8, !dbg !5308
  %171 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5309
  %map198 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %171, i32 0, i32 1, !dbg !5310
  %call199 = call %struct.mtd_info* @do_map_probe(i8* %170, %struct.map_info* %map198) #9, !dbg !5311
  %172 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5312
  %mtd = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %172, i32 0, i32 2, !dbg !5313
  store %struct.mtd_info* %call199, %struct.mtd_info** %mtd, align 8, !dbg !5314
  %173 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5315
  %mtd200 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %173, i32 0, i32 2, !dbg !5317
  %174 = load %struct.mtd_info*, %struct.mtd_info** %mtd200, align 8, !dbg !5317
  %tobool201 = icmp ne %struct.mtd_info* %174, null, !dbg !5315
  br i1 %tobool201, label %if.then202, label %if.end203, !dbg !5318

if.then202:                                       ; preds = %for.body197
  br label %found, !dbg !5319

if.end203:                                        ; preds = %for.body197
  br label %for.inc, !dbg !5320

for.inc:                                          ; preds = %if.end203
  %175 = load i8**, i8*** %probe_type, align 8, !dbg !5321
  %incdec.ptr = getelementptr i8*, i8** %175, i32 1, !dbg !5321
  store i8** %incdec.ptr, i8*** %probe_type, align 8, !dbg !5321
  br label %for.cond195, !dbg !5322, !llvm.loop !5323

for.end:                                          ; preds = %for.cond195
  br label %for.inc204, !dbg !5325

for.inc204:                                       ; preds = %for.end, %if.then192
  %176 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5326
  %map205 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %176, i32 0, i32 1, !dbg !5327
  %bankwidth206 = getelementptr inbounds %struct.map_info, %struct.map_info* %map205, i32 0, i32 6, !dbg !5328
  %177 = load i32, i32* %bankwidth206, align 4, !dbg !5329
  %shr = ashr i32 %177, 1, !dbg !5329
  store i32 %shr, i32* %bankwidth206, align 4, !dbg !5329
  br label %for.cond, !dbg !5330, !llvm.loop !5331

for.end207:                                       ; preds = %for.cond
  %178 = load i64, i64* %map_top, align 8, !dbg !5333
  %add208 = add i64 %178, 65536, !dbg !5333
  store i64 %add208, i64* %map_top, align 8, !dbg !5333
  br label %while.cond, !dbg !5334, !llvm.loop !5335

found:                                            ; preds = %if.then202
  call void @llvm.dbg.label(metadata !5337), !dbg !5338
  %179 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5339
  %mtd209 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %179, i32 0, i32 2, !dbg !5341
  %180 = load %struct.mtd_info*, %struct.mtd_info** %mtd209, align 8, !dbg !5341
  %size210 = getelementptr inbounds %struct.mtd_info, %struct.mtd_info* %180, i32 0, i32 2, !dbg !5342
  %181 = load i64, i64* %size210, align 8, !dbg !5342
  %182 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5343
  %map211 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %182, i32 0, i32 1, !dbg !5344
  %size212 = getelementptr inbounds %struct.map_info, %struct.map_info* %map211, i32 0, i32 1, !dbg !5345
  %183 = load i64, i64* %size212, align 8, !dbg !5345
  %cmp213 = icmp ugt i64 %181, %183, !dbg !5346
  br i1 %cmp213, label %if.then215, label %if.end225, !dbg !5347

if.then215:                                       ; preds = %found
  %184 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5348
  %mtd216 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %184, i32 0, i32 2, !dbg !5350
  %185 = load %struct.mtd_info*, %struct.mtd_info** %mtd216, align 8, !dbg !5350
  %size217 = getelementptr inbounds %struct.mtd_info, %struct.mtd_info* %185, i32 0, i32 2, !dbg !5351
  %186 = load i64, i64* %size217, align 8, !dbg !5351
  %187 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5352
  %map218 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %187, i32 0, i32 1, !dbg !5353
  %size219 = getelementptr inbounds %struct.map_info, %struct.map_info* %map218, i32 0, i32 1, !dbg !5354
  %188 = load i64, i64* %size219, align 8, !dbg !5354
  %call220 = call i32 (i8*, ...) @printk(i8* getelementptr inbounds ([56 x i8], [56 x i8]* @.str.14, i64 0, i64 0), i64 %186, i64 %188) #10, !dbg !5355
  %189 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5356
  %map221 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %189, i32 0, i32 1, !dbg !5357
  %size222 = getelementptr inbounds %struct.map_info, %struct.map_info* %map221, i32 0, i32 1, !dbg !5358
  %190 = load i64, i64* %size222, align 8, !dbg !5358
  %191 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5359
  %mtd223 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %191, i32 0, i32 2, !dbg !5360
  %192 = load %struct.mtd_info*, %struct.mtd_info** %mtd223, align 8, !dbg !5360
  %size224 = getelementptr inbounds %struct.mtd_info, %struct.mtd_info* %192, i32 0, i32 2, !dbg !5361
  store i64 %190, i64* %size224, align 8, !dbg !5362
  br label %if.end225, !dbg !5363

if.end225:                                        ; preds = %if.then215, %found
  %193 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !5364
  %rsrc226 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %193, i32 0, i32 4, !dbg !5366
  %parent227 = getelementptr inbounds %struct.resource, %struct.resource* %rsrc226, i32 0, i32 5, !dbg !5367
  %194 = load %struct.resource*, %struct.resource** %parent227, align 8, !dbg !5367
  %tobool228 = icmp ne %struct.resource* %194, null, !dbg !5364
  br i1 %tobool228, label %if.then229, label %if.end257, !dbg !5368

if.then229:                                       ; preds = %if.end225
  %195 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5369
  %map_name230 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %195, i32 0, i32 4, !dbg !5371
  %arraydecay231 = getelementptr inbounds [28 x i8], [28 x i8]* %map_name230, i64 0, i64 0, !dbg !5369
  %196 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5372
  %rsrc232 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %196, i32 0, i32 3, !dbg !5373
  %name233 = getelementptr inbounds %struct.resource, %struct.resource* %rsrc232, i32 0, i32 2, !dbg !5374
  store i8* %arraydecay231, i8** %name233, align 8, !dbg !5375
  %197 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5376
  %map234 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %197, i32 0, i32 1, !dbg !5377
  %phys235 = getelementptr inbounds %struct.map_info, %struct.map_info* %map234, i32 0, i32 2, !dbg !5378
  %198 = load i64, i64* %phys235, align 8, !dbg !5378
  %199 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5379
  %rsrc236 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %199, i32 0, i32 3, !dbg !5380
  %start237 = getelementptr inbounds %struct.resource, %struct.resource* %rsrc236, i32 0, i32 0, !dbg !5381
  store i64 %198, i64* %start237, align 8, !dbg !5382
  %200 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5383
  %map238 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %200, i32 0, i32 1, !dbg !5384
  %phys239 = getelementptr inbounds %struct.map_info, %struct.map_info* %map238, i32 0, i32 2, !dbg !5385
  %201 = load i64, i64* %phys239, align 8, !dbg !5385
  %202 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5386
  %mtd240 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %202, i32 0, i32 2, !dbg !5387
  %203 = load %struct.mtd_info*, %struct.mtd_info** %mtd240, align 8, !dbg !5387
  %size241 = getelementptr inbounds %struct.mtd_info, %struct.mtd_info* %203, i32 0, i32 2, !dbg !5388
  %204 = load i64, i64* %size241, align 8, !dbg !5388
  %add242 = add i64 %201, %204, !dbg !5389
  %sub243 = sub i64 %add242, 1, !dbg !5390
  %205 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5391
  %rsrc244 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %205, i32 0, i32 3, !dbg !5392
  %end245 = getelementptr inbounds %struct.resource, %struct.resource* %rsrc244, i32 0, i32 1, !dbg !5393
  store i64 %sub243, i64* %end245, align 8, !dbg !5394
  %206 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5395
  %rsrc246 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %206, i32 0, i32 3, !dbg !5396
  %flags247 = getelementptr inbounds %struct.resource, %struct.resource* %rsrc246, i32 0, i32 3, !dbg !5397
  store i64 2147484160, i64* %flags247, align 8, !dbg !5398
  %207 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !5399
  %rsrc248 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %207, i32 0, i32 4, !dbg !5401
  %208 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5402
  %rsrc249 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %208, i32 0, i32 3, !dbg !5403
  %call250 = call i32 @request_resource(%struct.resource* %rsrc248, %struct.resource* %rsrc249) #9, !dbg !5404
  %tobool251 = icmp ne i32 %call250, 0, !dbg !5404
  br i1 %tobool251, label %if.then252, label %if.end256, !dbg !5405

if.then252:                                       ; preds = %if.then229
  %call253 = call i32 (i8*, ...) @printk(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.15, i64 0, i64 0)) #10, !dbg !5406
  %209 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5408
  %rsrc254 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %209, i32 0, i32 3, !dbg !5409
  %parent255 = getelementptr inbounds %struct.resource, %struct.resource* %rsrc254, i32 0, i32 5, !dbg !5410
  store %struct.resource* null, %struct.resource** %parent255, align 8, !dbg !5411
  br label %if.end256, !dbg !5412

if.end256:                                        ; preds = %if.then252, %if.then229
  br label %if.end257, !dbg !5413

if.end257:                                        ; preds = %if.end256, %if.end225
  %210 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !5414
  %virt258 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %210, i32 0, i32 0, !dbg !5415
  %211 = load i8*, i8** %virt258, align 8, !dbg !5415
  %212 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5416
  %map259 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %212, i32 0, i32 1, !dbg !5417
  %virt260 = getelementptr inbounds %struct.map_info, %struct.map_info* %map259, i32 0, i32 3, !dbg !5418
  store i8* %211, i8** %virt260, align 8, !dbg !5419
  %213 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !5420
  %phys261 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %213, i32 0, i32 1, !dbg !5421
  %214 = load i64, i64* %phys261, align 8, !dbg !5421
  %215 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5422
  %map262 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %215, i32 0, i32 1, !dbg !5423
  %phys263 = getelementptr inbounds %struct.map_info, %struct.map_info* %map262, i32 0, i32 2, !dbg !5424
  store i64 %214, i64* %phys263, align 8, !dbg !5425
  %216 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5426
  %map264 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %216, i32 0, i32 1, !dbg !5427
  %fldrv_priv = getelementptr inbounds %struct.map_info, %struct.map_info* %map264, i32 0, i32 17, !dbg !5428
  %217 = load i8*, i8** %fldrv_priv, align 8, !dbg !5428
  %218 = bitcast i8* %217 to %struct.cfi_private*, !dbg !5426
  store %struct.cfi_private* %218, %struct.cfi_private** %cfi, align 8, !dbg !5429
  store i32 0, i32* %i, align 4, !dbg !5430
  br label %for.cond265, !dbg !5432

for.cond265:                                      ; preds = %for.inc271, %if.end257
  %219 = load i32, i32* %i, align 4, !dbg !5433
  %220 = load %struct.cfi_private*, %struct.cfi_private** %cfi, align 8, !dbg !5435
  %numchips = getelementptr inbounds %struct.cfi_private, %struct.cfi_private* %220, i32 0, i32 11, !dbg !5436
  %221 = load i32, i32* %numchips, align 8, !dbg !5436
  %cmp266 = icmp slt i32 %219, %221, !dbg !5437
  br i1 %cmp266, label %for.body268, label %for.end272, !dbg !5438

for.body268:                                      ; preds = %for.cond265
  %222 = load i64, i64* %offset, align 8, !dbg !5439
  %223 = load %struct.cfi_private*, %struct.cfi_private** %cfi, align 8, !dbg !5440
  %chips = getelementptr inbounds %struct.cfi_private, %struct.cfi_private* %223, i32 0, i32 15, !dbg !5441
  %224 = load i32, i32* %i, align 4, !dbg !5442
  %idxprom = sext i32 %224 to i64, !dbg !5440
  %arrayidx = getelementptr [0 x %struct.flchip], [0 x %struct.flchip]* %chips, i64 0, i64 %idxprom, !dbg !5440
  %start269 = getelementptr inbounds %struct.flchip, %struct.flchip* %arrayidx, i32 0, i32 0, !dbg !5443
  %225 = load i64, i64* %start269, align 8, !dbg !5444
  %add270 = add i64 %225, %222, !dbg !5444
  store i64 %add270, i64* %start269, align 8, !dbg !5444
  br label %for.inc271, !dbg !5440

for.inc271:                                       ; preds = %for.body268
  %226 = load i32, i32* %i, align 4, !dbg !5445
  %inc = add i32 %226, 1, !dbg !5445
  store i32 %inc, i32* %i, align 4, !dbg !5445
  br label %for.cond265, !dbg !5446, !llvm.loop !5447

for.end272:                                       ; preds = %for.cond265
  %227 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5449
  %mtd273 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %227, i32 0, i32 2, !dbg !5450
  %228 = load %struct.mtd_info*, %struct.mtd_info** %mtd273, align 8, !dbg !5450
  %owner = getelementptr inbounds %struct.mtd_info, %struct.mtd_info* %228, i32 0, i32 54, !dbg !5451
  store %struct.module* null, %struct.module** %owner, align 8, !dbg !5452
  %229 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5453
  %mtd274 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %229, i32 0, i32 2, !dbg !5453
  %230 = load %struct.mtd_info*, %struct.mtd_info** %mtd274, align 8, !dbg !5453
  %call275 = call i32 @mtd_device_parse_register(%struct.mtd_info* %230, i8** null, %struct.mtd_part_parser_data* null, %struct.mtd_partition* null, i32 0) #9, !dbg !5453
  %tobool276 = icmp ne i32 %call275, 0, !dbg !5453
  br i1 %tobool276, label %if.then277, label %if.end280, !dbg !5455

if.then277:                                       ; preds = %for.end272
  %231 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5456
  %mtd278 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %231, i32 0, i32 2, !dbg !5458
  %232 = load %struct.mtd_info*, %struct.mtd_info** %mtd278, align 8, !dbg !5458
  call void @map_destroy(%struct.mtd_info* %232) #9, !dbg !5459
  %233 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5460
  %mtd279 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %233, i32 0, i32 2, !dbg !5461
  store %struct.mtd_info* null, %struct.mtd_info** %mtd279, align 8, !dbg !5462
  br label %out, !dbg !5463

if.end280:                                        ; preds = %for.end272
  %234 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5464
  %mtd281 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %234, i32 0, i32 2, !dbg !5465
  %235 = load %struct.mtd_info*, %struct.mtd_info** %mtd281, align 8, !dbg !5465
  %size282 = getelementptr inbounds %struct.mtd_info, %struct.mtd_info* %235, i32 0, i32 2, !dbg !5466
  %236 = load i64, i64* %size282, align 8, !dbg !5466
  %237 = load i64, i64* %map_top, align 8, !dbg !5467
  %add283 = add i64 %237, %236, !dbg !5467
  store i64 %add283, i64* %map_top, align 8, !dbg !5467
  %238 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5468
  %list284 = getelementptr inbounds %struct.esb2rom_map_info, %struct.esb2rom_map_info* %238, i32 0, i32 0, !dbg !5469
  %239 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !5470
  %maps = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %239, i32 0, i32 3, !dbg !5471
  call void @list_add(%struct.list_head* %list284, %struct.list_head* %maps) #9, !dbg !5472
  store %struct.esb2rom_map_info* null, %struct.esb2rom_map_info** %map, align 8, !dbg !5473
  br label %while.cond, !dbg !4933, !llvm.loop !5335

while.end:                                        ; preds = %while.cond
  br label %out, !dbg !4933

out:                                              ; preds = %while.end, %if.then277, %if.then162, %if.then136, %if.then109, %if.then97
  call void @llvm.dbg.label(metadata !5474), !dbg !5475
  %240 = load %struct.esb2rom_map_info*, %struct.esb2rom_map_info** %map, align 8, !dbg !5476
  %241 = bitcast %struct.esb2rom_map_info* %240 to i8*, !dbg !5476
  call void @kfree(i8* %241) #9, !dbg !5477
  %242 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !5478
  %maps285 = getelementptr inbounds %struct.esb2rom_window, %struct.esb2rom_window* %242, i32 0, i32 3, !dbg !5480
  %call286 = call i32 @list_empty(%struct.list_head* %maps285) #9, !dbg !5481
  %tobool287 = icmp ne i32 %call286, 0, !dbg !5481
  br i1 %tobool287, label %if.then288, label %if.end289, !dbg !5482

if.then288:                                       ; preds = %out
  %243 = load %struct.esb2rom_window*, %struct.esb2rom_window** %window, align 8, !dbg !5483
  call void @esb2rom_cleanup(%struct.esb2rom_window* %243) #9, !dbg !5485
  store i32 -19, i32* %retval, align 4, !dbg !5486
  br label %return, !dbg !5486

if.end289:                                        ; preds = %out
  store i32 0, i32* %retval, align 4, !dbg !5487
  br label %return, !dbg !5487

return:                                           ; preds = %if.end289, %if.then288
  %244 = load i32, i32* %retval, align 4, !dbg !5488
  ret i32 %244, !dbg !5488
}

; Function Attrs: noredzone
declare dso_local %struct.pci_dev* @pci_dev_get(%struct.pci_dev*) #3
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @INIT_LIST_HEAD(%struct.list_head* %list) #1 !dbg !5489 {
entry:
  %list.addr = alloca %struct.list_head*, align 8
  store %struct.list_head* %list, %struct.list_head** %list.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %list.addr, metadata !5490, metadata !DIExpression()), !dbg !5491
...
do.end:                                           ; preds = %do.body1
  br label %do.body2, !dbg !5493

do.body2:                                         ; preds = %do.end
  %0 = load %struct.list_head*, %struct.list_head** %list.addr, align 8, !dbg !5497
  %1 = load %struct.list_head*, %struct.list_head** %list.addr, align 8, !dbg !5497
  %next = getelementptr inbounds %struct.list_head, %struct.list_head* %1, i32 0, i32 0, !dbg !5497
  store volatile %struct.list_head* %0, %struct.list_head** %next, align 8, !dbg !5497
  br label %do.end3, !dbg !5497

do.end3:                                          ; preds = %do.body2
  br label %do.end4, !dbg !5493

do.end4:                                          ; preds = %do.end3
  %2 = load %struct.list_head*, %struct.list_head** %list.addr, align 8, !dbg !5499
  %3 = load %struct.list_head*, %struct.list_head** %list.addr, align 8, !dbg !5500
  %prev = getelementptr inbounds %struct.list_head, %struct.list_head* %3, i32 0, i32 1, !dbg !5501
  store %struct.list_head* %2, %struct.list_head** %prev, align 8, !dbg !5502
  ret void, !dbg !5503
}
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal i32 @map_bankwidth_supported(i32 %w) #1 !dbg !5504 {
entry:
  %retval = alloca i32, align 4
  %w.addr = alloca i32, align 4
  store i32 %w, i32* %w.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %w.addr, metadata !5505, metadata !DIExpression()), !dbg !5506
  %0 = load i32, i32* %w.addr, align 4, !dbg !5507
...
sw.bb:                                            ; preds = %entry, %entry, %entry
  store i32 1, i32* %retval, align 4, !dbg !5509
...
return:                                           ; preds = %sw.default, %sw.bb
  %1 = load i32, i32* %retval, align 4, !dbg !5512
  ret i32 %1, !dbg !5512
}
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @list_add(%struct.list_head* %new, %struct.list_head* %head) #1 !dbg !5513 {
entry:
  %new.addr = alloca %struct.list_head*, align 8
  %head.addr = alloca %struct.list_head*, align 8
  store %struct.list_head* %new, %struct.list_head** %new.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %new.addr, metadata !5514, metadata !DIExpression()), !dbg !5515
  store %struct.list_head* %head, %struct.list_head** %head.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %head.addr, metadata !5516, metadata !DIExpression()), !dbg !5517
  %0 = load %struct.list_head*, %struct.list_head** %new.addr, align 8, !dbg !5518
  %1 = load %struct.list_head*, %struct.list_head** %head.addr, align 8, !dbg !5519
  %2 = load %struct.list_head*, %struct.list_head** %head.addr, align 8, !dbg !5520
  %next = getelementptr inbounds %struct.list_head, %struct.list_head* %2, i32 0, i32 0, !dbg !5521
  %3 = load %struct.list_head*, %struct.list_head** %next, align 8, !dbg !5521
  call void @__list_add(%struct.list_head* %0, %struct.list_head* %1, %struct.list_head* %3) #9, !dbg !5522
  ret void, !dbg !5523
}

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal i32 @list_empty(%struct.list_head* %head) #1 !dbg !5524 {
entry:
  %head.addr = alloca %struct.list_head*, align 8
  %tmp = alloca %struct.list_head*, align 8
  store %struct.list_head* %head, %struct.list_head** %head.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %head.addr, metadata !5529, metadata !DIExpression()), !dbg !5530
...
do.end:                                           ; preds = %do.body
  %0 = load %struct.list_head*, %struct.list_head** %head.addr, align 8, !dbg !5531
  %next = getelementptr inbounds %struct.list_head, %struct.list_head* %0, i32 0, i32 0, !dbg !5531
  %1 = load volatile %struct.list_head*, %struct.list_head** %next, align 8, !dbg !5531
  store %struct.list_head* %1, %struct.list_head** %tmp, align 8, !dbg !5533
  %2 = load %struct.list_head*, %struct.list_head** %tmp, align 8, !dbg !5531
  %3 = load %struct.list_head*, %struct.list_head** %head.addr, align 8, !dbg !5535
  %cmp = icmp eq %struct.list_head* %2, %3, !dbg !5536
  %conv = zext i1 %cmp to i32, !dbg !5536
  ret i32 %conv, !dbg !5537
}
...
define internal i32 @get_order(i64 %size) #8 !dbg !5538 {
entry:
  %x.addr.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %x.addr.i, metadata !5542, metadata !DIExpression()), !dbg !5547
  %bitpos.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %bitpos.i, metadata !5549, metadata !DIExpression()), !dbg !5550
  %retval = alloca i32, align 4
  %size.addr = alloca i64, align 8
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !5551, metadata !DIExpression()), !dbg !5552
  %0 = load i64, i64* %size.addr, align 8, !dbg !5553
  %1 = call i1 @llvm.is.constant.i64(i64 %0), !dbg !5555
  br i1 %1, label %if.then, label %if.end447, !dbg !5556

if.then:                                          ; preds = %entry
  %2 = load i64, i64* %size.addr, align 8, !dbg !5557
  %tobool = icmp ne i64 %2, 0, !dbg !5557
  br i1 %tobool, label %if.end, label %if.then1, !dbg !5560

if.then1:                                         ; preds = %if.then
  store i32 52, i32* %retval, align 4, !dbg !5561
  br label %return, !dbg !5561

if.end:                                           ; preds = %if.then
  %3 = load i64, i64* %size.addr, align 8, !dbg !5562
  %cmp = icmp ult i64 %3, 4096, !dbg !5564
  br i1 %cmp, label %if.then2, label %if.end3, !dbg !5565

if.then2:                                         ; preds = %if.end
  store i32 0, i32* %retval, align 4, !dbg !5566
  br label %return, !dbg !5566

if.end3:                                          ; preds = %if.end
  %4 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub = sub i64 %4, 1, !dbg !5567
  %5 = call i1 @llvm.is.constant.i64(i64 %sub), !dbg !5567
  br i1 %5, label %cond.true, label %cond.false442, !dbg !5567

cond.true:                                        ; preds = %if.end3
  %6 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub4 = sub i64 %6, 1, !dbg !5567
  %7 = call i1 @llvm.is.constant.i64(i64 %sub4), !dbg !5567
  br i1 %7, label %cond.true5, label %cond.false439, !dbg !5567

cond.true5:                                       ; preds = %cond.true
  %8 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub6 = sub i64 %8, 1, !dbg !5567
  %cmp7 = icmp ult i64 %sub6, 2, !dbg !5567
  br i1 %cmp7, label %cond.true8, label %cond.false, !dbg !5567

cond.true8:                                       ; preds = %cond.true5
  br label %cond.end437, !dbg !5567

cond.false:                                       ; preds = %cond.true5
  %9 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub9 = sub i64 %9, 1, !dbg !5567
  %and = and i64 %sub9, -9223372036854775808, !dbg !5567
  %tobool10 = icmp ne i64 %and, 0, !dbg !5567
  br i1 %tobool10, label %cond.true11, label %cond.false12, !dbg !5567

cond.true11:                                      ; preds = %cond.false
  br label %cond.end435, !dbg !5567

cond.false12:                                     ; preds = %cond.false
  %10 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub13 = sub i64 %10, 1, !dbg !5567
  %and14 = and i64 %sub13, 4611686018427387904, !dbg !5567
  %tobool15 = icmp ne i64 %and14, 0, !dbg !5567
  br i1 %tobool15, label %cond.true16, label %cond.false17, !dbg !5567

cond.true16:                                      ; preds = %cond.false12
  br label %cond.end433, !dbg !5567

cond.false17:                                     ; preds = %cond.false12
  %11 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub18 = sub i64 %11, 1, !dbg !5567
  %and19 = and i64 %sub18, 2305843009213693952, !dbg !5567
  %tobool20 = icmp ne i64 %and19, 0, !dbg !5567
  br i1 %tobool20, label %cond.true21, label %cond.false22, !dbg !5567

cond.true21:                                      ; preds = %cond.false17
  br label %cond.end431, !dbg !5567

cond.false22:                                     ; preds = %cond.false17
  %12 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub23 = sub i64 %12, 1, !dbg !5567
  %and24 = and i64 %sub23, 1152921504606846976, !dbg !5567
  %tobool25 = icmp ne i64 %and24, 0, !dbg !5567
  br i1 %tobool25, label %cond.true26, label %cond.false27, !dbg !5567

cond.true26:                                      ; preds = %cond.false22
  br label %cond.end429, !dbg !5567

cond.false27:                                     ; preds = %cond.false22
  %13 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub28 = sub i64 %13, 1, !dbg !5567
  %and29 = and i64 %sub28, 576460752303423488, !dbg !5567
  %tobool30 = icmp ne i64 %and29, 0, !dbg !5567
  br i1 %tobool30, label %cond.true31, label %cond.false32, !dbg !5567

cond.true31:                                      ; preds = %cond.false27
  br label %cond.end427, !dbg !5567

cond.false32:                                     ; preds = %cond.false27
  %14 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub33 = sub i64 %14, 1, !dbg !5567
  %and34 = and i64 %sub33, 288230376151711744, !dbg !5567
  %tobool35 = icmp ne i64 %and34, 0, !dbg !5567
  br i1 %tobool35, label %cond.true36, label %cond.false37, !dbg !5567

cond.true36:                                      ; preds = %cond.false32
  br label %cond.end425, !dbg !5567

cond.false37:                                     ; preds = %cond.false32
  %15 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub38 = sub i64 %15, 1, !dbg !5567
  %and39 = and i64 %sub38, 144115188075855872, !dbg !5567
  %tobool40 = icmp ne i64 %and39, 0, !dbg !5567
  br i1 %tobool40, label %cond.true41, label %cond.false42, !dbg !5567

cond.true41:                                      ; preds = %cond.false37
  br label %cond.end423, !dbg !5567

cond.false42:                                     ; preds = %cond.false37
  %16 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub43 = sub i64 %16, 1, !dbg !5567
  %and44 = and i64 %sub43, 72057594037927936, !dbg !5567
  %tobool45 = icmp ne i64 %and44, 0, !dbg !5567
  br i1 %tobool45, label %cond.true46, label %cond.false47, !dbg !5567

cond.true46:                                      ; preds = %cond.false42
  br label %cond.end421, !dbg !5567

cond.false47:                                     ; preds = %cond.false42
  %17 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub48 = sub i64 %17, 1, !dbg !5567
  %and49 = and i64 %sub48, 36028797018963968, !dbg !5567
  %tobool50 = icmp ne i64 %and49, 0, !dbg !5567
  br i1 %tobool50, label %cond.true51, label %cond.false52, !dbg !5567

cond.true51:                                      ; preds = %cond.false47
  br label %cond.end419, !dbg !5567

cond.false52:                                     ; preds = %cond.false47
  %18 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub53 = sub i64 %18, 1, !dbg !5567
  %and54 = and i64 %sub53, 18014398509481984, !dbg !5567
  %tobool55 = icmp ne i64 %and54, 0, !dbg !5567
  br i1 %tobool55, label %cond.true56, label %cond.false57, !dbg !5567

cond.true56:                                      ; preds = %cond.false52
  br label %cond.end417, !dbg !5567

cond.false57:                                     ; preds = %cond.false52
  %19 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub58 = sub i64 %19, 1, !dbg !5567
  %and59 = and i64 %sub58, 9007199254740992, !dbg !5567
  %tobool60 = icmp ne i64 %and59, 0, !dbg !5567
  br i1 %tobool60, label %cond.true61, label %cond.false62, !dbg !5567

cond.true61:                                      ; preds = %cond.false57
  br label %cond.end415, !dbg !5567

cond.false62:                                     ; preds = %cond.false57
  %20 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub63 = sub i64 %20, 1, !dbg !5567
  %and64 = and i64 %sub63, 4503599627370496, !dbg !5567
  %tobool65 = icmp ne i64 %and64, 0, !dbg !5567
  br i1 %tobool65, label %cond.true66, label %cond.false67, !dbg !5567

cond.true66:                                      ; preds = %cond.false62
  br label %cond.end413, !dbg !5567

cond.false67:                                     ; preds = %cond.false62
  %21 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub68 = sub i64 %21, 1, !dbg !5567
  %and69 = and i64 %sub68, 2251799813685248, !dbg !5567
  %tobool70 = icmp ne i64 %and69, 0, !dbg !5567
  br i1 %tobool70, label %cond.true71, label %cond.false72, !dbg !5567

cond.true71:                                      ; preds = %cond.false67
  br label %cond.end411, !dbg !5567

cond.false72:                                     ; preds = %cond.false67
  %22 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub73 = sub i64 %22, 1, !dbg !5567
  %and74 = and i64 %sub73, 1125899906842624, !dbg !5567
  %tobool75 = icmp ne i64 %and74, 0, !dbg !5567
  br i1 %tobool75, label %cond.true76, label %cond.false77, !dbg !5567

cond.true76:                                      ; preds = %cond.false72
  br label %cond.end409, !dbg !5567

cond.false77:                                     ; preds = %cond.false72
  %23 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub78 = sub i64 %23, 1, !dbg !5567
  %and79 = and i64 %sub78, 562949953421312, !dbg !5567
  %tobool80 = icmp ne i64 %and79, 0, !dbg !5567
  br i1 %tobool80, label %cond.true81, label %cond.false82, !dbg !5567

cond.true81:                                      ; preds = %cond.false77
  br label %cond.end407, !dbg !5567

cond.false82:                                     ; preds = %cond.false77
  %24 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub83 = sub i64 %24, 1, !dbg !5567
  %and84 = and i64 %sub83, 281474976710656, !dbg !5567
  %tobool85 = icmp ne i64 %and84, 0, !dbg !5567
  br i1 %tobool85, label %cond.true86, label %cond.false87, !dbg !5567

cond.true86:                                      ; preds = %cond.false82
  br label %cond.end405, !dbg !5567

cond.false87:                                     ; preds = %cond.false82
  %25 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub88 = sub i64 %25, 1, !dbg !5567
  %and89 = and i64 %sub88, 140737488355328, !dbg !5567
  %tobool90 = icmp ne i64 %and89, 0, !dbg !5567
  br i1 %tobool90, label %cond.true91, label %cond.false92, !dbg !5567

cond.true91:                                      ; preds = %cond.false87
  br label %cond.end403, !dbg !5567

cond.false92:                                     ; preds = %cond.false87
  %26 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub93 = sub i64 %26, 1, !dbg !5567
  %and94 = and i64 %sub93, 70368744177664, !dbg !5567
  %tobool95 = icmp ne i64 %and94, 0, !dbg !5567
  br i1 %tobool95, label %cond.true96, label %cond.false97, !dbg !5567

cond.true96:                                      ; preds = %cond.false92
  br label %cond.end401, !dbg !5567

cond.false97:                                     ; preds = %cond.false92
  %27 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub98 = sub i64 %27, 1, !dbg !5567
  %and99 = and i64 %sub98, 35184372088832, !dbg !5567
  %tobool100 = icmp ne i64 %and99, 0, !dbg !5567
  br i1 %tobool100, label %cond.true101, label %cond.false102, !dbg !5567

cond.true101:                                     ; preds = %cond.false97
  br label %cond.end399, !dbg !5567

cond.false102:                                    ; preds = %cond.false97
  %28 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub103 = sub i64 %28, 1, !dbg !5567
  %and104 = and i64 %sub103, 17592186044416, !dbg !5567
  %tobool105 = icmp ne i64 %and104, 0, !dbg !5567
  br i1 %tobool105, label %cond.true106, label %cond.false107, !dbg !5567

cond.true106:                                     ; preds = %cond.false102
  br label %cond.end397, !dbg !5567

cond.false107:                                    ; preds = %cond.false102
  %29 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub108 = sub i64 %29, 1, !dbg !5567
  %and109 = and i64 %sub108, 8796093022208, !dbg !5567
  %tobool110 = icmp ne i64 %and109, 0, !dbg !5567
  br i1 %tobool110, label %cond.true111, label %cond.false112, !dbg !5567

cond.true111:                                     ; preds = %cond.false107
  br label %cond.end395, !dbg !5567

cond.false112:                                    ; preds = %cond.false107
  %30 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub113 = sub i64 %30, 1, !dbg !5567
  %and114 = and i64 %sub113, 4398046511104, !dbg !5567
  %tobool115 = icmp ne i64 %and114, 0, !dbg !5567
  br i1 %tobool115, label %cond.true116, label %cond.false117, !dbg !5567

cond.true116:                                     ; preds = %cond.false112
  br label %cond.end393, !dbg !5567

cond.false117:                                    ; preds = %cond.false112
  %31 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub118 = sub i64 %31, 1, !dbg !5567
  %and119 = and i64 %sub118, 2199023255552, !dbg !5567
  %tobool120 = icmp ne i64 %and119, 0, !dbg !5567
  br i1 %tobool120, label %cond.true121, label %cond.false122, !dbg !5567

cond.true121:                                     ; preds = %cond.false117
  br label %cond.end391, !dbg !5567

cond.false122:                                    ; preds = %cond.false117
  %32 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub123 = sub i64 %32, 1, !dbg !5567
  %and124 = and i64 %sub123, 1099511627776, !dbg !5567
  %tobool125 = icmp ne i64 %and124, 0, !dbg !5567
  br i1 %tobool125, label %cond.true126, label %cond.false127, !dbg !5567

cond.true126:                                     ; preds = %cond.false122
  br label %cond.end389, !dbg !5567

cond.false127:                                    ; preds = %cond.false122
  %33 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub128 = sub i64 %33, 1, !dbg !5567
  %and129 = and i64 %sub128, 549755813888, !dbg !5567
  %tobool130 = icmp ne i64 %and129, 0, !dbg !5567
  br i1 %tobool130, label %cond.true131, label %cond.false132, !dbg !5567

cond.true131:                                     ; preds = %cond.false127
  br label %cond.end387, !dbg !5567

cond.false132:                                    ; preds = %cond.false127
  %34 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub133 = sub i64 %34, 1, !dbg !5567
  %and134 = and i64 %sub133, 274877906944, !dbg !5567
  %tobool135 = icmp ne i64 %and134, 0, !dbg !5567
  br i1 %tobool135, label %cond.true136, label %cond.false137, !dbg !5567

cond.true136:                                     ; preds = %cond.false132
  br label %cond.end385, !dbg !5567

cond.false137:                                    ; preds = %cond.false132
  %35 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub138 = sub i64 %35, 1, !dbg !5567
  %and139 = and i64 %sub138, 137438953472, !dbg !5567
  %tobool140 = icmp ne i64 %and139, 0, !dbg !5567
  br i1 %tobool140, label %cond.true141, label %cond.false142, !dbg !5567

cond.true141:                                     ; preds = %cond.false137
  br label %cond.end383, !dbg !5567

cond.false142:                                    ; preds = %cond.false137
  %36 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub143 = sub i64 %36, 1, !dbg !5567
  %and144 = and i64 %sub143, 68719476736, !dbg !5567
  %tobool145 = icmp ne i64 %and144, 0, !dbg !5567
  br i1 %tobool145, label %cond.true146, label %cond.false147, !dbg !5567

cond.true146:                                     ; preds = %cond.false142
  br label %cond.end381, !dbg !5567

cond.false147:                                    ; preds = %cond.false142
  %37 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub148 = sub i64 %37, 1, !dbg !5567
  %and149 = and i64 %sub148, 34359738368, !dbg !5567
  %tobool150 = icmp ne i64 %and149, 0, !dbg !5567
  br i1 %tobool150, label %cond.true151, label %cond.false152, !dbg !5567

cond.true151:                                     ; preds = %cond.false147
  br label %cond.end379, !dbg !5567

cond.false152:                                    ; preds = %cond.false147
  %38 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub153 = sub i64 %38, 1, !dbg !5567
  %and154 = and i64 %sub153, 17179869184, !dbg !5567
  %tobool155 = icmp ne i64 %and154, 0, !dbg !5567
  br i1 %tobool155, label %cond.true156, label %cond.false157, !dbg !5567

cond.true156:                                     ; preds = %cond.false152
  br label %cond.end377, !dbg !5567

cond.false157:                                    ; preds = %cond.false152
  %39 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub158 = sub i64 %39, 1, !dbg !5567
  %and159 = and i64 %sub158, 8589934592, !dbg !5567
  %tobool160 = icmp ne i64 %and159, 0, !dbg !5567
  br i1 %tobool160, label %cond.true161, label %cond.false162, !dbg !5567

cond.true161:                                     ; preds = %cond.false157
  br label %cond.end375, !dbg !5567

cond.false162:                                    ; preds = %cond.false157
  %40 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub163 = sub i64 %40, 1, !dbg !5567
  %and164 = and i64 %sub163, 4294967296, !dbg !5567
  %tobool165 = icmp ne i64 %and164, 0, !dbg !5567
  br i1 %tobool165, label %cond.true166, label %cond.false167, !dbg !5567

cond.true166:                                     ; preds = %cond.false162
  br label %cond.end373, !dbg !5567

cond.false167:                                    ; preds = %cond.false162
  %41 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub168 = sub i64 %41, 1, !dbg !5567
  %and169 = and i64 %sub168, 2147483648, !dbg !5567
  %tobool170 = icmp ne i64 %and169, 0, !dbg !5567
  br i1 %tobool170, label %cond.true171, label %cond.false172, !dbg !5567

cond.true171:                                     ; preds = %cond.false167
  br label %cond.end371, !dbg !5567

cond.false172:                                    ; preds = %cond.false167
  %42 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub173 = sub i64 %42, 1, !dbg !5567
  %and174 = and i64 %sub173, 1073741824, !dbg !5567
  %tobool175 = icmp ne i64 %and174, 0, !dbg !5567
  br i1 %tobool175, label %cond.true176, label %cond.false177, !dbg !5567

cond.true176:                                     ; preds = %cond.false172
  br label %cond.end369, !dbg !5567

cond.false177:                                    ; preds = %cond.false172
  %43 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub178 = sub i64 %43, 1, !dbg !5567
  %and179 = and i64 %sub178, 536870912, !dbg !5567
  %tobool180 = icmp ne i64 %and179, 0, !dbg !5567
  br i1 %tobool180, label %cond.true181, label %cond.false182, !dbg !5567

cond.true181:                                     ; preds = %cond.false177
  br label %cond.end367, !dbg !5567

cond.false182:                                    ; preds = %cond.false177
  %44 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub183 = sub i64 %44, 1, !dbg !5567
  %and184 = and i64 %sub183, 268435456, !dbg !5567
  %tobool185 = icmp ne i64 %and184, 0, !dbg !5567
  br i1 %tobool185, label %cond.true186, label %cond.false187, !dbg !5567

cond.true186:                                     ; preds = %cond.false182
  br label %cond.end365, !dbg !5567

cond.false187:                                    ; preds = %cond.false182
  %45 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub188 = sub i64 %45, 1, !dbg !5567
  %and189 = and i64 %sub188, 134217728, !dbg !5567
  %tobool190 = icmp ne i64 %and189, 0, !dbg !5567
  br i1 %tobool190, label %cond.true191, label %cond.false192, !dbg !5567

cond.true191:                                     ; preds = %cond.false187
  br label %cond.end363, !dbg !5567

cond.false192:                                    ; preds = %cond.false187
  %46 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub193 = sub i64 %46, 1, !dbg !5567
  %and194 = and i64 %sub193, 67108864, !dbg !5567
  %tobool195 = icmp ne i64 %and194, 0, !dbg !5567
  br i1 %tobool195, label %cond.true196, label %cond.false197, !dbg !5567

cond.true196:                                     ; preds = %cond.false192
  br label %cond.end361, !dbg !5567

cond.false197:                                    ; preds = %cond.false192
  %47 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub198 = sub i64 %47, 1, !dbg !5567
  %and199 = and i64 %sub198, 33554432, !dbg !5567
  %tobool200 = icmp ne i64 %and199, 0, !dbg !5567
  br i1 %tobool200, label %cond.true201, label %cond.false202, !dbg !5567

cond.true201:                                     ; preds = %cond.false197
  br label %cond.end359, !dbg !5567

cond.false202:                                    ; preds = %cond.false197
  %48 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub203 = sub i64 %48, 1, !dbg !5567
  %and204 = and i64 %sub203, 16777216, !dbg !5567
  %tobool205 = icmp ne i64 %and204, 0, !dbg !5567
  br i1 %tobool205, label %cond.true206, label %cond.false207, !dbg !5567

cond.true206:                                     ; preds = %cond.false202
  br label %cond.end357, !dbg !5567

cond.false207:                                    ; preds = %cond.false202
  %49 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub208 = sub i64 %49, 1, !dbg !5567
  %and209 = and i64 %sub208, 8388608, !dbg !5567
  %tobool210 = icmp ne i64 %and209, 0, !dbg !5567
  br i1 %tobool210, label %cond.true211, label %cond.false212, !dbg !5567

cond.true211:                                     ; preds = %cond.false207
  br label %cond.end355, !dbg !5567

cond.false212:                                    ; preds = %cond.false207
  %50 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub213 = sub i64 %50, 1, !dbg !5567
  %and214 = and i64 %sub213, 4194304, !dbg !5567
  %tobool215 = icmp ne i64 %and214, 0, !dbg !5567
  br i1 %tobool215, label %cond.true216, label %cond.false217, !dbg !5567

cond.true216:                                     ; preds = %cond.false212
  br label %cond.end353, !dbg !5567

cond.false217:                                    ; preds = %cond.false212
  %51 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub218 = sub i64 %51, 1, !dbg !5567
  %and219 = and i64 %sub218, 2097152, !dbg !5567
  %tobool220 = icmp ne i64 %and219, 0, !dbg !5567
  br i1 %tobool220, label %cond.true221, label %cond.false222, !dbg !5567

cond.true221:                                     ; preds = %cond.false217
  br label %cond.end351, !dbg !5567

cond.false222:                                    ; preds = %cond.false217
  %52 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub223 = sub i64 %52, 1, !dbg !5567
  %and224 = and i64 %sub223, 1048576, !dbg !5567
  %tobool225 = icmp ne i64 %and224, 0, !dbg !5567
  br i1 %tobool225, label %cond.true226, label %cond.false227, !dbg !5567

cond.true226:                                     ; preds = %cond.false222
  br label %cond.end349, !dbg !5567

cond.false227:                                    ; preds = %cond.false222
  %53 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub228 = sub i64 %53, 1, !dbg !5567
  %and229 = and i64 %sub228, 524288, !dbg !5567
  %tobool230 = icmp ne i64 %and229, 0, !dbg !5567
  br i1 %tobool230, label %cond.true231, label %cond.false232, !dbg !5567

cond.true231:                                     ; preds = %cond.false227
  br label %cond.end347, !dbg !5567

cond.false232:                                    ; preds = %cond.false227
  %54 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub233 = sub i64 %54, 1, !dbg !5567
  %and234 = and i64 %sub233, 262144, !dbg !5567
  %tobool235 = icmp ne i64 %and234, 0, !dbg !5567
  br i1 %tobool235, label %cond.true236, label %cond.false237, !dbg !5567

cond.true236:                                     ; preds = %cond.false232
  br label %cond.end345, !dbg !5567

cond.false237:                                    ; preds = %cond.false232
  %55 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub238 = sub i64 %55, 1, !dbg !5567
  %and239 = and i64 %sub238, 131072, !dbg !5567
  %tobool240 = icmp ne i64 %and239, 0, !dbg !5567
  br i1 %tobool240, label %cond.true241, label %cond.false242, !dbg !5567

cond.true241:                                     ; preds = %cond.false237
  br label %cond.end343, !dbg !5567

cond.false242:                                    ; preds = %cond.false237
  %56 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub243 = sub i64 %56, 1, !dbg !5567
  %and244 = and i64 %sub243, 65536, !dbg !5567
  %tobool245 = icmp ne i64 %and244, 0, !dbg !5567
  br i1 %tobool245, label %cond.true246, label %cond.false247, !dbg !5567

cond.true246:                                     ; preds = %cond.false242
  br label %cond.end341, !dbg !5567

cond.false247:                                    ; preds = %cond.false242
  %57 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub248 = sub i64 %57, 1, !dbg !5567
  %and249 = and i64 %sub248, 32768, !dbg !5567
  %tobool250 = icmp ne i64 %and249, 0, !dbg !5567
  br i1 %tobool250, label %cond.true251, label %cond.false252, !dbg !5567

cond.true251:                                     ; preds = %cond.false247
  br label %cond.end339, !dbg !5567

cond.false252:                                    ; preds = %cond.false247
  %58 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub253 = sub i64 %58, 1, !dbg !5567
  %and254 = and i64 %sub253, 16384, !dbg !5567
  %tobool255 = icmp ne i64 %and254, 0, !dbg !5567
  br i1 %tobool255, label %cond.true256, label %cond.false257, !dbg !5567

cond.true256:                                     ; preds = %cond.false252
  br label %cond.end337, !dbg !5567

cond.false257:                                    ; preds = %cond.false252
  %59 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub258 = sub i64 %59, 1, !dbg !5567
  %and259 = and i64 %sub258, 8192, !dbg !5567
  %tobool260 = icmp ne i64 %and259, 0, !dbg !5567
  br i1 %tobool260, label %cond.true261, label %cond.false262, !dbg !5567

cond.true261:                                     ; preds = %cond.false257
  br label %cond.end335, !dbg !5567

cond.false262:                                    ; preds = %cond.false257
  %60 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub263 = sub i64 %60, 1, !dbg !5567
  %and264 = and i64 %sub263, 4096, !dbg !5567
  %tobool265 = icmp ne i64 %and264, 0, !dbg !5567
  br i1 %tobool265, label %cond.true266, label %cond.false267, !dbg !5567

cond.true266:                                     ; preds = %cond.false262
  br label %cond.end333, !dbg !5567

cond.false267:                                    ; preds = %cond.false262
  %61 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub268 = sub i64 %61, 1, !dbg !5567
  %and269 = and i64 %sub268, 2048, !dbg !5567
  %tobool270 = icmp ne i64 %and269, 0, !dbg !5567
  br i1 %tobool270, label %cond.true271, label %cond.false272, !dbg !5567

cond.true271:                                     ; preds = %cond.false267
  br label %cond.end331, !dbg !5567

cond.false272:                                    ; preds = %cond.false267
  %62 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub273 = sub i64 %62, 1, !dbg !5567
  %and274 = and i64 %sub273, 1024, !dbg !5567
  %tobool275 = icmp ne i64 %and274, 0, !dbg !5567
  br i1 %tobool275, label %cond.true276, label %cond.false277, !dbg !5567

cond.true276:                                     ; preds = %cond.false272
  br label %cond.end329, !dbg !5567

cond.false277:                                    ; preds = %cond.false272
  %63 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub278 = sub i64 %63, 1, !dbg !5567
  %and279 = and i64 %sub278, 512, !dbg !5567
  %tobool280 = icmp ne i64 %and279, 0, !dbg !5567
  br i1 %tobool280, label %cond.true281, label %cond.false282, !dbg !5567

cond.true281:                                     ; preds = %cond.false277
  br label %cond.end327, !dbg !5567

cond.false282:                                    ; preds = %cond.false277
  %64 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub283 = sub i64 %64, 1, !dbg !5567
  %and284 = and i64 %sub283, 256, !dbg !5567
  %tobool285 = icmp ne i64 %and284, 0, !dbg !5567
  br i1 %tobool285, label %cond.true286, label %cond.false287, !dbg !5567

cond.true286:                                     ; preds = %cond.false282
  br label %cond.end325, !dbg !5567

cond.false287:                                    ; preds = %cond.false282
  %65 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub288 = sub i64 %65, 1, !dbg !5567
  %and289 = and i64 %sub288, 128, !dbg !5567
  %tobool290 = icmp ne i64 %and289, 0, !dbg !5567
  br i1 %tobool290, label %cond.true291, label %cond.false292, !dbg !5567

cond.true291:                                     ; preds = %cond.false287
  br label %cond.end323, !dbg !5567

cond.false292:                                    ; preds = %cond.false287
  %66 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub293 = sub i64 %66, 1, !dbg !5567
  %and294 = and i64 %sub293, 64, !dbg !5567
  %tobool295 = icmp ne i64 %and294, 0, !dbg !5567
  br i1 %tobool295, label %cond.true296, label %cond.false297, !dbg !5567

cond.true296:                                     ; preds = %cond.false292
  br label %cond.end321, !dbg !5567

cond.false297:                                    ; preds = %cond.false292
  %67 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub298 = sub i64 %67, 1, !dbg !5567
  %and299 = and i64 %sub298, 32, !dbg !5567
  %tobool300 = icmp ne i64 %and299, 0, !dbg !5567
  br i1 %tobool300, label %cond.true301, label %cond.false302, !dbg !5567

cond.true301:                                     ; preds = %cond.false297
  br label %cond.end319, !dbg !5567

cond.false302:                                    ; preds = %cond.false297
  %68 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub303 = sub i64 %68, 1, !dbg !5567
  %and304 = and i64 %sub303, 16, !dbg !5567
  %tobool305 = icmp ne i64 %and304, 0, !dbg !5567
  br i1 %tobool305, label %cond.true306, label %cond.false307, !dbg !5567

cond.true306:                                     ; preds = %cond.false302
  br label %cond.end317, !dbg !5567

cond.false307:                                    ; preds = %cond.false302
  %69 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub308 = sub i64 %69, 1, !dbg !5567
  %and309 = and i64 %sub308, 8, !dbg !5567
  %tobool310 = icmp ne i64 %and309, 0, !dbg !5567
  br i1 %tobool310, label %cond.true311, label %cond.false312, !dbg !5567

cond.true311:                                     ; preds = %cond.false307
  br label %cond.end, !dbg !5567

cond.false312:                                    ; preds = %cond.false307
  %70 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub313 = sub i64 %70, 1, !dbg !5567
  %and314 = and i64 %sub313, 4, !dbg !5567
  %tobool315 = icmp ne i64 %and314, 0, !dbg !5567
  %71 = zext i1 %tobool315 to i64, !dbg !5567
  %cond = select i1 %tobool315, i32 2, i32 1, !dbg !5567
  br label %cond.end, !dbg !5567

cond.end:                                         ; preds = %cond.false312, %cond.true311
  %cond316 = phi i32 [ 3, %cond.true311 ], [ %cond, %cond.false312 ], !dbg !5567
  br label %cond.end317, !dbg !5567

cond.end317:                                      ; preds = %cond.end, %cond.true306
  %cond318 = phi i32 [ 4, %cond.true306 ], [ %cond316, %cond.end ], !dbg !5567
  br label %cond.end319, !dbg !5567

cond.end319:                                      ; preds = %cond.end317, %cond.true301
  %cond320 = phi i32 [ 5, %cond.true301 ], [ %cond318, %cond.end317 ], !dbg !5567
  br label %cond.end321, !dbg !5567

cond.end321:                                      ; preds = %cond.end319, %cond.true296
  %cond322 = phi i32 [ 6, %cond.true296 ], [ %cond320, %cond.end319 ], !dbg !5567
  br label %cond.end323, !dbg !5567

cond.end323:                                      ; preds = %cond.end321, %cond.true291
  %cond324 = phi i32 [ 7, %cond.true291 ], [ %cond322, %cond.end321 ], !dbg !5567
  br label %cond.end325, !dbg !5567

cond.end325:                                      ; preds = %cond.end323, %cond.true286
  %cond326 = phi i32 [ 8, %cond.true286 ], [ %cond324, %cond.end323 ], !dbg !5567
  br label %cond.end327, !dbg !5567

cond.end327:                                      ; preds = %cond.end325, %cond.true281
  %cond328 = phi i32 [ 9, %cond.true281 ], [ %cond326, %cond.end325 ], !dbg !5567
  br label %cond.end329, !dbg !5567

cond.end329:                                      ; preds = %cond.end327, %cond.true276
  %cond330 = phi i32 [ 10, %cond.true276 ], [ %cond328, %cond.end327 ], !dbg !5567
  br label %cond.end331, !dbg !5567

cond.end331:                                      ; preds = %cond.end329, %cond.true271
  %cond332 = phi i32 [ 11, %cond.true271 ], [ %cond330, %cond.end329 ], !dbg !5567
  br label %cond.end333, !dbg !5567

cond.end333:                                      ; preds = %cond.end331, %cond.true266
  %cond334 = phi i32 [ 12, %cond.true266 ], [ %cond332, %cond.end331 ], !dbg !5567
  br label %cond.end335, !dbg !5567

cond.end335:                                      ; preds = %cond.end333, %cond.true261
  %cond336 = phi i32 [ 13, %cond.true261 ], [ %cond334, %cond.end333 ], !dbg !5567
  br label %cond.end337, !dbg !5567

cond.end337:                                      ; preds = %cond.end335, %cond.true256
  %cond338 = phi i32 [ 14, %cond.true256 ], [ %cond336, %cond.end335 ], !dbg !5567
  br label %cond.end339, !dbg !5567

cond.end339:                                      ; preds = %cond.end337, %cond.true251
  %cond340 = phi i32 [ 15, %cond.true251 ], [ %cond338, %cond.end337 ], !dbg !5567
  br label %cond.end341, !dbg !5567

cond.end341:                                      ; preds = %cond.end339, %cond.true246
  %cond342 = phi i32 [ 16, %cond.true246 ], [ %cond340, %cond.end339 ], !dbg !5567
  br label %cond.end343, !dbg !5567

cond.end343:                                      ; preds = %cond.end341, %cond.true241
  %cond344 = phi i32 [ 17, %cond.true241 ], [ %cond342, %cond.end341 ], !dbg !5567
  br label %cond.end345, !dbg !5567

cond.end345:                                      ; preds = %cond.end343, %cond.true236
  %cond346 = phi i32 [ 18, %cond.true236 ], [ %cond344, %cond.end343 ], !dbg !5567
  br label %cond.end347, !dbg !5567

cond.end347:                                      ; preds = %cond.end345, %cond.true231
  %cond348 = phi i32 [ 19, %cond.true231 ], [ %cond346, %cond.end345 ], !dbg !5567
  br label %cond.end349, !dbg !5567

cond.end349:                                      ; preds = %cond.end347, %cond.true226
  %cond350 = phi i32 [ 20, %cond.true226 ], [ %cond348, %cond.end347 ], !dbg !5567
  br label %cond.end351, !dbg !5567

cond.end351:                                      ; preds = %cond.end349, %cond.true221
  %cond352 = phi i32 [ 21, %cond.true221 ], [ %cond350, %cond.end349 ], !dbg !5567
  br label %cond.end353, !dbg !5567

cond.end353:                                      ; preds = %cond.end351, %cond.true216
  %cond354 = phi i32 [ 22, %cond.true216 ], [ %cond352, %cond.end351 ], !dbg !5567
  br label %cond.end355, !dbg !5567

cond.end355:                                      ; preds = %cond.end353, %cond.true211
  %cond356 = phi i32 [ 23, %cond.true211 ], [ %cond354, %cond.end353 ], !dbg !5567
  br label %cond.end357, !dbg !5567

cond.end357:                                      ; preds = %cond.end355, %cond.true206
  %cond358 = phi i32 [ 24, %cond.true206 ], [ %cond356, %cond.end355 ], !dbg !5567
  br label %cond.end359, !dbg !5567

cond.end359:                                      ; preds = %cond.end357, %cond.true201
  %cond360 = phi i32 [ 25, %cond.true201 ], [ %cond358, %cond.end357 ], !dbg !5567
  br label %cond.end361, !dbg !5567

cond.end361:                                      ; preds = %cond.end359, %cond.true196
  %cond362 = phi i32 [ 26, %cond.true196 ], [ %cond360, %cond.end359 ], !dbg !5567
  br label %cond.end363, !dbg !5567

cond.end363:                                      ; preds = %cond.end361, %cond.true191
  %cond364 = phi i32 [ 27, %cond.true191 ], [ %cond362, %cond.end361 ], !dbg !5567
  br label %cond.end365, !dbg !5567

cond.end365:                                      ; preds = %cond.end363, %cond.true186
  %cond366 = phi i32 [ 28, %cond.true186 ], [ %cond364, %cond.end363 ], !dbg !5567
  br label %cond.end367, !dbg !5567

cond.end367:                                      ; preds = %cond.end365, %cond.true181
  %cond368 = phi i32 [ 29, %cond.true181 ], [ %cond366, %cond.end365 ], !dbg !5567
  br label %cond.end369, !dbg !5567

cond.end369:                                      ; preds = %cond.end367, %cond.true176
  %cond370 = phi i32 [ 30, %cond.true176 ], [ %cond368, %cond.end367 ], !dbg !5567
  br label %cond.end371, !dbg !5567

cond.end371:                                      ; preds = %cond.end369, %cond.true171
  %cond372 = phi i32 [ 31, %cond.true171 ], [ %cond370, %cond.end369 ], !dbg !5567
  br label %cond.end373, !dbg !5567

cond.end373:                                      ; preds = %cond.end371, %cond.true166
  %cond374 = phi i32 [ 32, %cond.true166 ], [ %cond372, %cond.end371 ], !dbg !5567
  br label %cond.end375, !dbg !5567

cond.end375:                                      ; preds = %cond.end373, %cond.true161
  %cond376 = phi i32 [ 33, %cond.true161 ], [ %cond374, %cond.end373 ], !dbg !5567
  br label %cond.end377, !dbg !5567

cond.end377:                                      ; preds = %cond.end375, %cond.true156
  %cond378 = phi i32 [ 34, %cond.true156 ], [ %cond376, %cond.end375 ], !dbg !5567
  br label %cond.end379, !dbg !5567

cond.end379:                                      ; preds = %cond.end377, %cond.true151
  %cond380 = phi i32 [ 35, %cond.true151 ], [ %cond378, %cond.end377 ], !dbg !5567
  br label %cond.end381, !dbg !5567

cond.end381:                                      ; preds = %cond.end379, %cond.true146
  %cond382 = phi i32 [ 36, %cond.true146 ], [ %cond380, %cond.end379 ], !dbg !5567
  br label %cond.end383, !dbg !5567

cond.end383:                                      ; preds = %cond.end381, %cond.true141
  %cond384 = phi i32 [ 37, %cond.true141 ], [ %cond382, %cond.end381 ], !dbg !5567
  br label %cond.end385, !dbg !5567

cond.end385:                                      ; preds = %cond.end383, %cond.true136
  %cond386 = phi i32 [ 38, %cond.true136 ], [ %cond384, %cond.end383 ], !dbg !5567
  br label %cond.end387, !dbg !5567

cond.end387:                                      ; preds = %cond.end385, %cond.true131
  %cond388 = phi i32 [ 39, %cond.true131 ], [ %cond386, %cond.end385 ], !dbg !5567
  br label %cond.end389, !dbg !5567

cond.end389:                                      ; preds = %cond.end387, %cond.true126
  %cond390 = phi i32 [ 40, %cond.true126 ], [ %cond388, %cond.end387 ], !dbg !5567
  br label %cond.end391, !dbg !5567

cond.end391:                                      ; preds = %cond.end389, %cond.true121
  %cond392 = phi i32 [ 41, %cond.true121 ], [ %cond390, %cond.end389 ], !dbg !5567
  br label %cond.end393, !dbg !5567

cond.end393:                                      ; preds = %cond.end391, %cond.true116
  %cond394 = phi i32 [ 42, %cond.true116 ], [ %cond392, %cond.end391 ], !dbg !5567
  br label %cond.end395, !dbg !5567

cond.end395:                                      ; preds = %cond.end393, %cond.true111
  %cond396 = phi i32 [ 43, %cond.true111 ], [ %cond394, %cond.end393 ], !dbg !5567
  br label %cond.end397, !dbg !5567

cond.end397:                                      ; preds = %cond.end395, %cond.true106
  %cond398 = phi i32 [ 44, %cond.true106 ], [ %cond396, %cond.end395 ], !dbg !5567
  br label %cond.end399, !dbg !5567

cond.end399:                                      ; preds = %cond.end397, %cond.true101
  %cond400 = phi i32 [ 45, %cond.true101 ], [ %cond398, %cond.end397 ], !dbg !5567
  br label %cond.end401, !dbg !5567

cond.end401:                                      ; preds = %cond.end399, %cond.true96
  %cond402 = phi i32 [ 46, %cond.true96 ], [ %cond400, %cond.end399 ], !dbg !5567
  br label %cond.end403, !dbg !5567

cond.end403:                                      ; preds = %cond.end401, %cond.true91
  %cond404 = phi i32 [ 47, %cond.true91 ], [ %cond402, %cond.end401 ], !dbg !5567
  br label %cond.end405, !dbg !5567

cond.end405:                                      ; preds = %cond.end403, %cond.true86
  %cond406 = phi i32 [ 48, %cond.true86 ], [ %cond404, %cond.end403 ], !dbg !5567
  br label %cond.end407, !dbg !5567

cond.end407:                                      ; preds = %cond.end405, %cond.true81
  %cond408 = phi i32 [ 49, %cond.true81 ], [ %cond406, %cond.end405 ], !dbg !5567
  br label %cond.end409, !dbg !5567

cond.end409:                                      ; preds = %cond.end407, %cond.true76
  %cond410 = phi i32 [ 50, %cond.true76 ], [ %cond408, %cond.end407 ], !dbg !5567
  br label %cond.end411, !dbg !5567

cond.end411:                                      ; preds = %cond.end409, %cond.true71
  %cond412 = phi i32 [ 51, %cond.true71 ], [ %cond410, %cond.end409 ], !dbg !5567
  br label %cond.end413, !dbg !5567

cond.end413:                                      ; preds = %cond.end411, %cond.true66
  %cond414 = phi i32 [ 52, %cond.true66 ], [ %cond412, %cond.end411 ], !dbg !5567
  br label %cond.end415, !dbg !5567

cond.end415:                                      ; preds = %cond.end413, %cond.true61
  %cond416 = phi i32 [ 53, %cond.true61 ], [ %cond414, %cond.end413 ], !dbg !5567
  br label %cond.end417, !dbg !5567

cond.end417:                                      ; preds = %cond.end415, %cond.true56
  %cond418 = phi i32 [ 54, %cond.true56 ], [ %cond416, %cond.end415 ], !dbg !5567
  br label %cond.end419, !dbg !5567

cond.end419:                                      ; preds = %cond.end417, %cond.true51
  %cond420 = phi i32 [ 55, %cond.true51 ], [ %cond418, %cond.end417 ], !dbg !5567
  br label %cond.end421, !dbg !5567

cond.end421:                                      ; preds = %cond.end419, %cond.true46
  %cond422 = phi i32 [ 56, %cond.true46 ], [ %cond420, %cond.end419 ], !dbg !5567
  br label %cond.end423, !dbg !5567

cond.end423:                                      ; preds = %cond.end421, %cond.true41
  %cond424 = phi i32 [ 57, %cond.true41 ], [ %cond422, %cond.end421 ], !dbg !5567
  br label %cond.end425, !dbg !5567

cond.end425:                                      ; preds = %cond.end423, %cond.true36
  %cond426 = phi i32 [ 58, %cond.true36 ], [ %cond424, %cond.end423 ], !dbg !5567
  br label %cond.end427, !dbg !5567

cond.end427:                                      ; preds = %cond.end425, %cond.true31
  %cond428 = phi i32 [ 59, %cond.true31 ], [ %cond426, %cond.end425 ], !dbg !5567
  br label %cond.end429, !dbg !5567

cond.end429:                                      ; preds = %cond.end427, %cond.true26
  %cond430 = phi i32 [ 60, %cond.true26 ], [ %cond428, %cond.end427 ], !dbg !5567
  br label %cond.end431, !dbg !5567

cond.end431:                                      ; preds = %cond.end429, %cond.true21
  %cond432 = phi i32 [ 61, %cond.true21 ], [ %cond430, %cond.end429 ], !dbg !5567
  br label %cond.end433, !dbg !5567

cond.end433:                                      ; preds = %cond.end431, %cond.true16
  %cond434 = phi i32 [ 62, %cond.true16 ], [ %cond432, %cond.end431 ], !dbg !5567
  br label %cond.end435, !dbg !5567

cond.end435:                                      ; preds = %cond.end433, %cond.true11
  %cond436 = phi i32 [ 63, %cond.true11 ], [ %cond434, %cond.end433 ], !dbg !5567
  br label %cond.end437, !dbg !5567

cond.end437:                                      ; preds = %cond.end435, %cond.true8
  %cond438 = phi i32 [ 0, %cond.true8 ], [ %cond436, %cond.end435 ], !dbg !5567
  br label %cond.end440, !dbg !5567

cond.false439:                                    ; preds = %cond.true
  br label %cond.end440, !dbg !5567

cond.end440:                                      ; preds = %cond.false439, %cond.end437
  %cond441 = phi i32 [ %cond438, %cond.end437 ], [ -1, %cond.false439 ], !dbg !5567
  br label %cond.end444, !dbg !5567

cond.false442:                                    ; preds = %if.end3
  %72 = load i64, i64* %size.addr, align 8, !dbg !5567
  %sub443 = sub i64 %72, 1, !dbg !5567
  %call = call i32 @__ilog2_u64(i64 %sub443) #12, !dbg !5567
  br label %cond.end444, !dbg !5567

cond.end444:                                      ; preds = %cond.false442, %cond.end440
  %cond445 = phi i32 [ %cond441, %cond.end440 ], [ %call, %cond.false442 ], !dbg !5567
  %sub446 = sub i32 %cond445, 12, !dbg !5568
  %add = add i32 %sub446, 1, !dbg !5569
  store i32 %add, i32* %retval, align 4, !dbg !5570
  br label %return, !dbg !5570

if.end447:                                        ; preds = %entry
  %73 = load i64, i64* %size.addr, align 8, !dbg !5571
  %dec = add i64 %73, -1, !dbg !5571
  store i64 %dec, i64* %size.addr, align 8, !dbg !5571
  %74 = load i64, i64* %size.addr, align 8, !dbg !5572
  %shr = lshr i64 %74, 12, !dbg !5572
  store i64 %shr, i64* %size.addr, align 8, !dbg !5572
  %75 = load i64, i64* %size.addr, align 8, !dbg !5573
  store i64 %75, i64* %x.addr.i, align 8
  store i32 -1, i32* %bitpos.i, align 4, !dbg !5550
  %76 = load i32, i32* %bitpos.i, align 4, !dbg !5574
  %77 = load i64, i64* %x.addr.i, align 8, !dbg !5575
  %78 = call i32 asm "bsrq $1,${0:q}", "=r,rm,0,~{dirflag},~{fpsr},~{flags}"(i64 %77, i32 %76) #14, !dbg !5574, !srcloc !5576
  store i32 %78, i32* %bitpos.i, align 4, !dbg !5574
  %79 = load i32, i32* %bitpos.i, align 4, !dbg !5577
  %add.i = add i32 %79, 1, !dbg !5578
  store i32 %add.i, i32* %retval, align 4, !dbg !5579
  br label %return, !dbg !5579

return:                                           ; preds = %if.end447, %cond.end444, %if.then2, %if.then1
  %80 = load i32, i32* %retval, align 4, !dbg !5580
  ret i32 %80, !dbg !5580
}

; Function Attrs: noinline noredzone nounwind optnone readnone sspstrong
define internal i32 @__ilog2_u64(i64 %n) #8 !dbg !5581 {
entry:
  %x.addr.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %x.addr.i, metadata !5542, metadata !DIExpression()), !dbg !5585
  %bitpos.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %bitpos.i, metadata !5549, metadata !DIExpression()), !dbg !5587
  %n.addr = alloca i64, align 8
  store i64 %n, i64* %n.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %n.addr, metadata !5588, metadata !DIExpression()), !dbg !5589
  %0 = load i64, i64* %n.addr, align 8, !dbg !5590
  store i64 %0, i64* %x.addr.i, align 8
  store i32 -1, i32* %bitpos.i, align 4, !dbg !5587
  %1 = load i32, i32* %bitpos.i, align 4, !dbg !5591
  %2 = load i64, i64* %x.addr.i, align 8, !dbg !5592
  %3 = call i32 asm "bsrq $1,${0:q}", "=r,rm,0,~{dirflag},~{fpsr},~{flags}"(i64 %2, i32 %1) #14, !dbg !5591, !srcloc !5576
  store i32 %3, i32* %bitpos.i, align 4, !dbg !5591
  %4 = load i32, i32* %bitpos.i, align 4, !dbg !5593
  %add.i = add i32 %4, 1, !dbg !5594
  %sub = sub i32 %add.i, 1, !dbg !5595
  ret i32 %sub, !dbg !5596
}
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal i8* @kasan_kmalloc(%struct.kmem_cache* %s, i8* %object, i64 %size, i32 %flags) #1 !dbg !5597 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.kmem_cache** %s.addr, metadata !5601, metadata !DIExpression()), !dbg !5602
  store i8* %object, i8** %object.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %object.addr, metadata !5603, metadata !DIExpression()), !dbg !5604
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !5605, metadata !DIExpression()), !dbg !5606
  store i32 %flags, i32* %flags.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr, metadata !5607, metadata !DIExpression()), !dbg !5608
  %0 = load i8*, i8** %object.addr, align 8, !dbg !5609
  ret i8* %0, !dbg !5610
}

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @__list_add(%struct.list_head* %new, %struct.list_head* %prev, %struct.list_head* %next) #1 !dbg !5611 {
entry:
  %new.addr = alloca %struct.list_head*, align 8
  %prev.addr = alloca %struct.list_head*, align 8
  %next.addr = alloca %struct.list_head*, align 8
  store %struct.list_head* %new, %struct.list_head** %new.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %new.addr, metadata !5614, metadata !DIExpression()), !dbg !5615
  store %struct.list_head* %prev, %struct.list_head** %prev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %prev.addr, metadata !5616, metadata !DIExpression()), !dbg !5617
  store %struct.list_head* %next, %struct.list_head** %next.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %next.addr, metadata !5618, metadata !DIExpression()), !dbg !5619
  %0 = load %struct.list_head*, %struct.list_head** %new.addr, align 8, !dbg !5620
  %1 = load %struct.list_head*, %struct.list_head** %prev.addr, align 8, !dbg !5622
  %2 = load %struct.list_head*, %struct.list_head** %next.addr, align 8, !dbg !5623
  %call = call zeroext i1 @__list_add_valid(%struct.list_head* %0, %struct.list_head* %1, %struct.list_head* %2) #9, !dbg !5624
  br i1 %call, label %if.end, label %if.then, !dbg !5625

if.then:                                          ; preds = %entry
  br label %do.end8, !dbg !5626

if.end:                                           ; preds = %entry
  %3 = load %struct.list_head*, %struct.list_head** %new.addr, align 8, !dbg !5627
  %4 = load %struct.list_head*, %struct.list_head** %next.addr, align 8, !dbg !5628
  %prev1 = getelementptr inbounds %struct.list_head, %struct.list_head* %4, i32 0, i32 1, !dbg !5629
  store %struct.list_head* %3, %struct.list_head** %prev1, align 8, !dbg !5630
  %5 = load %struct.list_head*, %struct.list_head** %next.addr, align 8, !dbg !5631
  %6 = load %struct.list_head*, %struct.list_head** %new.addr, align 8, !dbg !5632
  %next2 = getelementptr inbounds %struct.list_head, %struct.list_head* %6, i32 0, i32 0, !dbg !5633
  store %struct.list_head* %5, %struct.list_head** %next2, align 8, !dbg !5634
  %7 = load %struct.list_head*, %struct.list_head** %prev.addr, align 8, !dbg !5635
  %8 = load %struct.list_head*, %struct.list_head** %new.addr, align 8, !dbg !5636
  %prev3 = getelementptr inbounds %struct.list_head, %struct.list_head* %8, i32 0, i32 1, !dbg !5637
  store %struct.list_head* %7, %struct.list_head** %prev3, align 8, !dbg !5638
  br label %do.body, !dbg !5639

do.body:                                          ; preds = %if.end
  br label %do.body4, !dbg !5640

do.body4:                                         ; preds = %do.body
  br label %do.end, !dbg !5642

do.end:                                           ; preds = %do.body4
  br label %do.body5, !dbg !5640

do.body5:                                         ; preds = %do.end
  %9 = load %struct.list_head*, %struct.list_head** %new.addr, align 8, !dbg !5644
  %10 = load %struct.list_head*, %struct.list_head** %prev.addr, align 8, !dbg !5644
  %next6 = getelementptr inbounds %struct.list_head, %struct.list_head* %10, i32 0, i32 0, !dbg !5644
  store volatile %struct.list_head* %9, %struct.list_head** %next6, align 8, !dbg !5644
  br label %do.end7, !dbg !5644

do.end7:                                          ; preds = %do.body5
  br label %do.end8, !dbg !5640
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal zeroext i1 @__list_add_valid(%struct.list_head* %new, %struct.list_head* %prev, %struct.list_head* %next) #1 !dbg !5647 {
entry:
  %new.addr = alloca %struct.list_head*, align 8
  %prev.addr = alloca %struct.list_head*, align 8
  %next.addr = alloca %struct.list_head*, align 8
  store %struct.list_head* %new, %struct.list_head** %new.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %new.addr, metadata !5650, metadata !DIExpression()), !dbg !5651
  store %struct.list_head* %prev, %struct.list_head** %prev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %prev.addr, metadata !5652, metadata !DIExpression()), !dbg !5653
  store %struct.list_head* %next, %struct.list_head** %next.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %next.addr, metadata !5654, metadata !DIExpression()), !dbg !5655
  ret i1 true, !dbg !5656
}
...
!llvm.dbg.cu = !{!2}
!llvm.module.flags = !{!4421, !4422, !4423, !4424}
!llvm.ident = !{!4425}

!0 = !DIGlobalVariableExpression(var: !1, expr: !DIExpression())
!1 = distinct !DIGlobalVariable(name: "esb2rom_window", scope: !2, file: !3, line: 114, type: !4413, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/mtd/maps/esb2rom.c", directory: "/home/lizy2001/genbc/linux")
...
!139 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "esb2rom_map_info", file: !3, line: 106, size: 2112, elements: !140)
!140 = !{!141, !148, !4092, !4093, !4106}
!141 = !DIDerivedType(tag: DW_TAG_member, name: "list", scope: !139, file: !3, line: 107, baseType: !142, size: 128)
...
!148 = !DIDerivedType(tag: DW_TAG_member, name: "map", scope: !139, file: !3, line: 108, baseType: !149, size: 1152, offset: 128)
...
!4092 = !DIDerivedType(tag: DW_TAG_member, name: "mtd", scope: !139, file: !3, line: 109, baseType: !2682, size: 64, offset: 1280)
!4093 = !DIDerivedType(tag: DW_TAG_member, name: "rsrc", scope: !139, file: !3, line: 110, baseType: !4094, size: 512, offset: 1344)
...
!4106 = !DIDerivedType(tag: DW_TAG_member, name: "map_name", scope: !139, file: !3, line: 111, baseType: !4107, size: 224, offset: 1856)
!4107 = !DICompositeType(tag: DW_TAG_array_type, baseType: !155, size: 224, elements: !4108)
!4108 = !{!4109}
...
!4114 = !{!4115, !4117, !4122, !4127, !4130, !4135, !0, !4140, !4155}
!4115 = !DIGlobalVariableExpression(var: !4116, expr: !DIExpression())
!4116 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_esb2rom243", scope: !2, file: !3, line: 448, type: !137, isLocal: true, isDefinition: true)
!4117 = !DIGlobalVariableExpression(var: !4118, expr: !DIExpression())
!4118 = distinct !DIGlobalVariable(name: "__exitcall_cleanup_esb2rom", scope: !2, file: !3, line: 449, type: !4119, isLocal: true, isDefinition: true)
...
!4123 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file244", scope: !2, file: !3, line: 451, type: !4124, isLocal: true, isDefinition: true, align: 8)
...
!4128 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license245", scope: !2, file: !3, line: 451, type: !4129, isLocal: true, isDefinition: true, align: 8)
...
!4131 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author246", scope: !2, file: !3, line: 452, type: !4132, isLocal: true, isDefinition: true, align: 8)
!4132 = !DICompositeType(tag: DW_TAG_array_type, baseType: !154, size: 440, elements: !4133)
!4133 = !{!4134}
!4134 = !DISubrange(count: 55)
!4135 = !DIGlobalVariableExpression(var: !4136, expr: !DIExpression())
!4136 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_description247", scope: !2, file: !3, line: 453, type: !4137, isLocal: true, isDefinition: true, align: 8)
...
!4141 = distinct !DIGlobalVariable(name: "esb2rom_pci_tbl", scope: !2, file: !3, line: 388, type: !4142, isLocal: true, isDefinition: true)
!4142 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4143, size: 1792, elements: !4153)
...
!4153 = !{!4154}
!4154 = !DISubrange(count: 7)
!4155 = !DIGlobalVariableExpression(var: !4156, expr: !DIExpression())
!4156 = distinct !DIGlobalVariable(name: "rom_probe_types", scope: !4157, file: !3, line: 151, type: !314, isLocal: true, isDefinition: true)
!4157 = distinct !DISubprogram(name: "esb2rom_init_one", scope: !3, file: !3, line: 148, type: !4158, scopeLine: 150, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!4158 = !DISubroutineType(types: !4159)
!4159 = !{!169, !4160, !4264}
!4160 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4161, size: 64)
!4161 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_dev", file: !4162, line: 309, size: 19264, elements: !4163)
!4162 = !DIFile(filename: "./include/linux/pci.h", directory: "/home/lizy2001/genbc/linux")
!4163 = !{!4164, !4165, !4227, !4228, !4229, !4230, !4241, !4242, !4243, !4244, !4245, !4246, !4247, !4248, !4249, !4250, !4251, !4252, !4253, !4254, !4255, !4256, !4257, !4310, !4311, !4312, !4314, !4315, !4316, !4317, !4318, !4319, !4320, !4321, !4322, !4323, !4324, !4325, !4326, !4327, !4328, !4329, !4330, !4331, !4332, !4333, !4336, !4337, !4338, !4339, !4340, !4341, !4342, !4343, !4347, !4348, !4349, !4350, !4351, !4352, !4353, !4354, !4355, !4356, !4357, !4358, !4359, !4360, !4361, !4362, !4363, !4364, !4365, !4366, !4367, !4368, !4369, !4370, !4371, !4372, !4373, !4374, !4375, !4376, !4377, !4378, !4379, !4380, !4381, !4382, !4383, !4384, !4386, !4387, !4389, !4390, !4391, !4392, !4394, !4395, !4396, !4399, !4406, !4407, !4408, !4409, !4410, !4411, !4412}
!4164 = !DIDerivedType(tag: DW_TAG_member, name: "bus_list", scope: !4161, file: !4162, line: 310, baseType: !142, size: 128)
!4165 = !DIDerivedType(tag: DW_TAG_member, name: "bus", scope: !4161, file: !4162, line: 311, baseType: !4166, size: 64, offset: 128)
!4166 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4167, size: 64)
!4167 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_bus", file: !4162, line: 605, size: 8064, elements: !4168)
!4168 = !{!4169, !4170, !4171, !4172, !4173, !4174, !4175, !4177, !4178, !4179, !4203, !4206, !4207, !4211, !4212, !4213, !4214, !4215, !4219, !4220, !4222, !4223, !4224, !4225, !4226}
!4169 = !DIDerivedType(tag: DW_TAG_member, name: "node", scope: !4167, file: !4162, line: 606, baseType: !142, size: 128)
!4170 = !DIDerivedType(tag: DW_TAG_member, name: "parent", scope: !4167, file: !4162, line: 607, baseType: !4166, size: 64, offset: 128)
!4171 = !DIDerivedType(tag: DW_TAG_member, name: "children", scope: !4167, file: !4162, line: 608, baseType: !142, size: 128, offset: 192)
!4172 = !DIDerivedType(tag: DW_TAG_member, name: "devices", scope: !4167, file: !4162, line: 609, baseType: !142, size: 128, offset: 320)
!4173 = !DIDerivedType(tag: DW_TAG_member, name: "self", scope: !4167, file: !4162, line: 610, baseType: !4160, size: 64, offset: 448)
!4174 = !DIDerivedType(tag: DW_TAG_member, name: "slots", scope: !4167, file: !4162, line: 611, baseType: !142, size: 128, offset: 512)
!4175 = !DIDerivedType(tag: DW_TAG_member, name: "resource", scope: !4167, file: !4162, line: 613, baseType: !4176, size: 256, offset: 640)
!4176 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4103, size: 256, elements: !1224)
!4177 = !DIDerivedType(tag: DW_TAG_member, name: "resources", scope: !4167, file: !4162, line: 614, baseType: !142, size: 128, offset: 896)
!4178 = !DIDerivedType(tag: DW_TAG_member, name: "busn_res", scope: !4167, file: !4162, line: 615, baseType: !4094, size: 512, offset: 1024)
!4179 = !DIDerivedType(tag: DW_TAG_member, name: "ops", scope: !4167, file: !4162, line: 617, baseType: !4180, size: 64, offset: 1536)
!4180 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4181, size: 64)
!4181 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_ops", file: !4162, line: 731, size: 320, elements: !4182)
!4182 = !{!4183, !4187, !4191, !4195, !4199}
!4183 = !DIDerivedType(tag: DW_TAG_member, name: "add_bus", scope: !4181, file: !4162, line: 732, baseType: !4184, size: 64)
!4184 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4185, size: 64)
!4185 = !DISubroutineType(types: !4186)
!4186 = !{!169, !4166}
!4187 = !DIDerivedType(tag: DW_TAG_member, name: "remove_bus", scope: !4181, file: !4162, line: 733, baseType: !4188, size: 64, offset: 64)
!4188 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4189, size: 64)
!4189 = !DISubroutineType(types: !4190)
!4190 = !{null, !4166}
!4191 = !DIDerivedType(tag: DW_TAG_member, name: "map_bus", scope: !4181, file: !4162, line: 734, baseType: !4192, size: 64, offset: 128)
!4192 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4193, size: 64)
!4193 = !DISubroutineType(types: !4194)
!4194 = !{!137, !4166, !7, !169}
!4195 = !DIDerivedType(tag: DW_TAG_member, name: "read", scope: !4181, file: !4162, line: 735, baseType: !4196, size: 64, offset: 192)
!4196 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4197, size: 64)
!4197 = !DISubroutineType(types: !4198)
!4198 = !{!169, !4166, !7, !169, !169, !1481}
!4199 = !DIDerivedType(tag: DW_TAG_member, name: "write", scope: !4181, file: !4162, line: 736, baseType: !4200, size: 64, offset: 256)
!4200 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4201, size: 64)
!4201 = !DISubroutineType(types: !4202)
!4202 = !{!169, !4166, !7, !169, !169, !222}
!4203 = !DIDerivedType(tag: DW_TAG_member, name: "msi", scope: !4167, file: !4162, line: 618, baseType: !4204, size: 64, offset: 1600)
!4204 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4205, size: 64)
!4205 = !DICompositeType(tag: DW_TAG_structure_type, name: "msi_controller", file: !4162, line: 537, flags: DIFlagFwdDecl)
!4206 = !DIDerivedType(tag: DW_TAG_member, name: "sysdata", scope: !4167, file: !4162, line: 619, baseType: !137, size: 64, offset: 1664)
!4207 = !DIDerivedType(tag: DW_TAG_member, name: "procdir", scope: !4167, file: !4162, line: 620, baseType: !4208, size: 64, offset: 1728)
...
!4211 = !DIDerivedType(tag: DW_TAG_member, name: "number", scope: !4167, file: !4162, line: 622, baseType: !455, size: 8, offset: 1792)
!4212 = !DIDerivedType(tag: DW_TAG_member, name: "primary", scope: !4167, file: !4162, line: 623, baseType: !455, size: 8, offset: 1800)
!4213 = !DIDerivedType(tag: DW_TAG_member, name: "max_bus_speed", scope: !4167, file: !4162, line: 624, baseType: !455, size: 8, offset: 1808)
!4214 = !DIDerivedType(tag: DW_TAG_member, name: "cur_bus_speed", scope: !4167, file: !4162, line: 625, baseType: !455, size: 8, offset: 1816)
!4215 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !4167, file: !4162, line: 630, baseType: !4216, size: 384, offset: 1824)
!4216 = !DICompositeType(tag: DW_TAG_array_type, baseType: !155, size: 384, elements: !4217)
!4217 = !{!4218}
!4218 = !DISubrange(count: 48)
!4219 = !DIDerivedType(tag: DW_TAG_member, name: "bridge_ctl", scope: !4167, file: !4162, line: 632, baseType: !352, size: 16, offset: 2208)
!4220 = !DIDerivedType(tag: DW_TAG_member, name: "bus_flags", scope: !4167, file: !4162, line: 633, baseType: !4221, size: 16, offset: 2224)
!4221 = !DIDerivedType(tag: DW_TAG_typedef, name: "pci_bus_flags_t", file: !4162, line: 237, baseType: !352)
!4222 = !DIDerivedType(tag: DW_TAG_member, name: "bridge", scope: !4167, file: !4162, line: 634, baseType: !3650, size: 64, offset: 2240)
!4223 = !DIDerivedType(tag: DW_TAG_member, name: "dev", scope: !4167, file: !4162, line: 635, baseType: !258, size: 5568, offset: 2304)
!4224 = !DIDerivedType(tag: DW_TAG_member, name: "legacy_io", scope: !4167, file: !4162, line: 636, baseType: !377, size: 64, offset: 7872)
!4225 = !DIDerivedType(tag: DW_TAG_member, name: "legacy_mem", scope: !4167, file: !4162, line: 637, baseType: !377, size: 64, offset: 7936)
!4226 = !DIDerivedType(tag: DW_TAG_member, name: "is_added", scope: !4167, file: !4162, line: 638, baseType: !7, size: 1, offset: 8000, flags: DIFlagBitField, extraData: i64 8000)
!4227 = !DIDerivedType(tag: DW_TAG_member, name: "subordinate", scope: !4161, file: !4162, line: 312, baseType: !4166, size: 64, offset: 192)
!4228 = !DIDerivedType(tag: DW_TAG_member, name: "sysdata", scope: !4161, file: !4162, line: 314, baseType: !137, size: 64, offset: 256)
!4229 = !DIDerivedType(tag: DW_TAG_member, name: "procent", scope: !4161, file: !4162, line: 315, baseType: !4208, size: 64, offset: 320)
!4230 = !DIDerivedType(tag: DW_TAG_member, name: "slot", scope: !4161, file: !4162, line: 316, baseType: !4231, size: 64, offset: 384)
!4231 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4232, size: 64)
!4232 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_slot", file: !4162, line: 69, size: 832, elements: !4233)
!4233 = !{!4234, !4235, !4236, !4239, !4240}
!4234 = !DIDerivedType(tag: DW_TAG_member, name: "bus", scope: !4232, file: !4162, line: 70, baseType: !4166, size: 64)
!4235 = !DIDerivedType(tag: DW_TAG_member, name: "list", scope: !4232, file: !4162, line: 71, baseType: !142, size: 128, offset: 64)
!4236 = !DIDerivedType(tag: DW_TAG_member, name: "hotplug", scope: !4232, file: !4162, line: 72, baseType: !4237, size: 64, offset: 192)
!4237 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4238, size: 64)
!4238 = !DICompositeType(tag: DW_TAG_structure_type, name: "hotplug_slot", file: !4162, line: 72, flags: DIFlagFwdDecl)
!4239 = !DIDerivedType(tag: DW_TAG_member, name: "number", scope: !4232, file: !4162, line: 73, baseType: !455, size: 8, offset: 256)
!4240 = !DIDerivedType(tag: DW_TAG_member, name: "kobj", scope: !4232, file: !4162, line: 74, baseType: !261, size: 512, offset: 320)
!4241 = !DIDerivedType(tag: DW_TAG_member, name: "devfn", scope: !4161, file: !4162, line: 318, baseType: !7, size: 32, offset: 448)
!4242 = !DIDerivedType(tag: DW_TAG_member, name: "vendor", scope: !4161, file: !4162, line: 319, baseType: !352, size: 16, offset: 480)
!4243 = !DIDerivedType(tag: DW_TAG_member, name: "device", scope: !4161, file: !4162, line: 320, baseType: !352, size: 16, offset: 496)
!4244 = !DIDerivedType(tag: DW_TAG_member, name: "subsystem_vendor", scope: !4161, file: !4162, line: 321, baseType: !352, size: 16, offset: 512)
!4245 = !DIDerivedType(tag: DW_TAG_member, name: "subsystem_device", scope: !4161, file: !4162, line: 322, baseType: !352, size: 16, offset: 528)
!4246 = !DIDerivedType(tag: DW_TAG_member, name: "class", scope: !4161, file: !4162, line: 323, baseType: !7, size: 32, offset: 544)
!4247 = !DIDerivedType(tag: DW_TAG_member, name: "revision", scope: !4161, file: !4162, line: 324, baseType: !1421, size: 8, offset: 576)
!4248 = !DIDerivedType(tag: DW_TAG_member, name: "hdr_type", scope: !4161, file: !4162, line: 325, baseType: !1421, size: 8, offset: 584)
!4249 = !DIDerivedType(tag: DW_TAG_member, name: "pcie_cap", scope: !4161, file: !4162, line: 330, baseType: !1421, size: 8, offset: 592)
!4250 = !DIDerivedType(tag: DW_TAG_member, name: "msi_cap", scope: !4161, file: !4162, line: 331, baseType: !1421, size: 8, offset: 600)
!4251 = !DIDerivedType(tag: DW_TAG_member, name: "msix_cap", scope: !4161, file: !4162, line: 332, baseType: !1421, size: 8, offset: 608)
!4252 = !DIDerivedType(tag: DW_TAG_member, name: "pcie_mpss", scope: !4161, file: !4162, line: 333, baseType: !1421, size: 3, offset: 616, flags: DIFlagBitField, extraData: i64 616)
!4253 = !DIDerivedType(tag: DW_TAG_member, name: "rom_base_reg", scope: !4161, file: !4162, line: 334, baseType: !1421, size: 8, offset: 624)
!4254 = !DIDerivedType(tag: DW_TAG_member, name: "pin", scope: !4161, file: !4162, line: 335, baseType: !1421, size: 8, offset: 632)
!4255 = !DIDerivedType(tag: DW_TAG_member, name: "pcie_flags_reg", scope: !4161, file: !4162, line: 336, baseType: !889, size: 16, offset: 640)
!4256 = !DIDerivedType(tag: DW_TAG_member, name: "dma_alias_mask", scope: !4161, file: !4162, line: 337, baseType: !2750, size: 64, offset: 704)
!4257 = !DIDerivedType(tag: DW_TAG_member, name: "driver", scope: !4161, file: !4162, line: 339, baseType: !4258, size: 64, offset: 768)
!4258 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4259, size: 64)
!4259 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_driver", file: !4162, line: 858, size: 2048, elements: !4260)
!4260 = !{!4261, !4262, !4263, !4265, !4267, !4271, !4275, !4279, !4280, !4284, !4303, !4304, !4305}
!4261 = !DIDerivedType(tag: DW_TAG_member, name: "node", scope: !4259, file: !4162, line: 859, baseType: !142, size: 128)
!4262 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !4259, file: !4162, line: 860, baseType: !153, size: 64, offset: 128)
!4263 = !DIDerivedType(tag: DW_TAG_member, name: "id_table", scope: !4259, file: !4162, line: 861, baseType: !4264, size: 64, offset: 192)
!4264 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4143, size: 64)
!4265 = !DIDerivedType(tag: DW_TAG_member, name: "probe", scope: !4259, file: !4162, line: 862, baseType: !4266, size: 64, offset: 256)
!4266 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4158, size: 64)
!4267 = !DIDerivedType(tag: DW_TAG_member, name: "remove", scope: !4259, file: !4162, line: 863, baseType: !4268, size: 64, offset: 320)
!4268 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4269, size: 64)
!4269 = !DISubroutineType(types: !4270)
!4270 = !{null, !4160}
!4271 = !DIDerivedType(tag: DW_TAG_member, name: "suspend", scope: !4259, file: !4162, line: 864, baseType: !4272, size: 64, offset: 384)
!4272 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4273, size: 64)
!4273 = !DISubroutineType(types: !4274)
!4274 = !{!169, !4160, !3764}
!4275 = !DIDerivedType(tag: DW_TAG_member, name: "resume", scope: !4259, file: !4162, line: 865, baseType: !4276, size: 64, offset: 448)
!4276 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4277, size: 64)
!4277 = !DISubroutineType(types: !4278)
!4278 = !{!169, !4160}
!4279 = !DIDerivedType(tag: DW_TAG_member, name: "shutdown", scope: !4259, file: !4162, line: 866, baseType: !4268, size: 64, offset: 512)
!4280 = !DIDerivedType(tag: DW_TAG_member, name: "sriov_configure", scope: !4259, file: !4162, line: 867, baseType: !4281, size: 64, offset: 576)
!4281 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4282, size: 64)
!4282 = !DISubroutineType(types: !4283)
!4283 = !{!169, !4160, !169}
!4284 = !DIDerivedType(tag: DW_TAG_member, name: "err_handler", scope: !4259, file: !4162, line: 868, baseType: !4285, size: 64, offset: 640)
!4285 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4286, size: 64)
!4286 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !4287)
!4287 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_error_handlers", file: !4162, line: 795, size: 384, elements: !4288)
!4288 = !{!4289, !4295, !4299, !4300, !4301, !4302}
!4289 = !DIDerivedType(tag: DW_TAG_member, name: "error_detected", scope: !4287, file: !4162, line: 797, baseType: !4290, size: 64)
!4290 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4291, size: 64)
!4291 = !DISubroutineType(types: !4292)
!4292 = !{!4293, !4160, !4294}
!4293 = !DIDerivedType(tag: DW_TAG_typedef, name: "pci_ers_result_t", file: !4162, line: 772, baseType: !7)
!4294 = !DIDerivedType(tag: DW_TAG_typedef, name: "pci_channel_state_t", file: !4162, line: 180, baseType: !7)
!4295 = !DIDerivedType(tag: DW_TAG_member, name: "mmio_enabled", scope: !4287, file: !4162, line: 801, baseType: !4296, size: 64, offset: 64)
!4296 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4297, size: 64)
!4297 = !DISubroutineType(types: !4298)
!4298 = !{!4293, !4160}
!4299 = !DIDerivedType(tag: DW_TAG_member, name: "slot_reset", scope: !4287, file: !4162, line: 804, baseType: !4296, size: 64, offset: 128)
!4300 = !DIDerivedType(tag: DW_TAG_member, name: "reset_prepare", scope: !4287, file: !4162, line: 807, baseType: !4268, size: 64, offset: 192)
!4301 = !DIDerivedType(tag: DW_TAG_member, name: "reset_done", scope: !4287, file: !4162, line: 808, baseType: !4268, size: 64, offset: 256)
!4302 = !DIDerivedType(tag: DW_TAG_member, name: "resume", scope: !4287, file: !4162, line: 811, baseType: !4268, size: 64, offset: 320)
!4303 = !DIDerivedType(tag: DW_TAG_member, name: "groups", scope: !4259, file: !4162, line: 869, baseType: !363, size: 64, offset: 704)
!4304 = !DIDerivedType(tag: DW_TAG_member, name: "driver", scope: !4259, file: !4162, line: 870, baseType: !3722, size: 1152, offset: 768)
!4305 = !DIDerivedType(tag: DW_TAG_member, name: "dynids", scope: !4259, file: !4162, line: 871, baseType: !4306, size: 128, offset: 1920)
!4306 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_dynids", file: !4162, line: 759, size: 128, elements: !4307)
!4307 = !{!4308, !4309}
!4308 = !DIDerivedType(tag: DW_TAG_member, name: "lock", scope: !4306, file: !4162, line: 760, baseType: !274)
!4309 = !DIDerivedType(tag: DW_TAG_member, name: "list", scope: !4306, file: !4162, line: 761, baseType: !142, size: 128)
!4310 = !DIDerivedType(tag: DW_TAG_member, name: "dma_mask", scope: !4161, file: !4162, line: 340, baseType: !161, size: 64, offset: 832)
!4311 = !DIDerivedType(tag: DW_TAG_member, name: "dma_parms", scope: !4161, file: !4162, line: 346, baseType: !3946, size: 128, offset: 896)
!4312 = !DIDerivedType(tag: DW_TAG_member, name: "current_state", scope: !4161, file: !4162, line: 348, baseType: !4313, size: 32, offset: 1024)
!4313 = !DIDerivedType(tag: DW_TAG_typedef, name: "pci_power_t", file: !4162, line: 155, baseType: !169)
!4314 = !DIDerivedType(tag: DW_TAG_member, name: "imm_ready", scope: !4161, file: !4162, line: 351, baseType: !7, size: 1, offset: 1056, flags: DIFlagBitField, extraData: i64 1056)
!4315 = !DIDerivedType(tag: DW_TAG_member, name: "pm_cap", scope: !4161, file: !4162, line: 352, baseType: !1421, size: 8, offset: 1064)
!4316 = !DIDerivedType(tag: DW_TAG_member, name: "pme_support", scope: !4161, file: !4162, line: 353, baseType: !7, size: 5, offset: 1072, flags: DIFlagBitField, extraData: i64 1072)
!4317 = !DIDerivedType(tag: DW_TAG_member, name: "pme_poll", scope: !4161, file: !4162, line: 355, baseType: !7, size: 1, offset: 1077, flags: DIFlagBitField, extraData: i64 1072)
!4318 = !DIDerivedType(tag: DW_TAG_member, name: "d1_support", scope: !4161, file: !4162, line: 356, baseType: !7, size: 1, offset: 1078, flags: DIFlagBitField, extraData: i64 1072)
!4319 = !DIDerivedType(tag: DW_TAG_member, name: "d2_support", scope: !4161, file: !4162, line: 357, baseType: !7, size: 1, offset: 1079, flags: DIFlagBitField, extraData: i64 1072)
!4320 = !DIDerivedType(tag: DW_TAG_member, name: "no_d1d2", scope: !4161, file: !4162, line: 358, baseType: !7, size: 1, offset: 1080, flags: DIFlagBitField, extraData: i64 1072)
!4321 = !DIDerivedType(tag: DW_TAG_member, name: "no_d3cold", scope: !4161, file: !4162, line: 359, baseType: !7, size: 1, offset: 1081, flags: DIFlagBitField, extraData: i64 1072)
!4322 = !DIDerivedType(tag: DW_TAG_member, name: "bridge_d3", scope: !4161, file: !4162, line: 360, baseType: !7, size: 1, offset: 1082, flags: DIFlagBitField, extraData: i64 1072)
!4323 = !DIDerivedType(tag: DW_TAG_member, name: "d3cold_allowed", scope: !4161, file: !4162, line: 361, baseType: !7, size: 1, offset: 1083, flags: DIFlagBitField, extraData: i64 1072)
!4324 = !DIDerivedType(tag: DW_TAG_member, name: "mmio_always_on", scope: !4161, file: !4162, line: 362, baseType: !7, size: 1, offset: 1084, flags: DIFlagBitField, extraData: i64 1072)
!4325 = !DIDerivedType(tag: DW_TAG_member, name: "wakeup_prepared", scope: !4161, file: !4162, line: 364, baseType: !7, size: 1, offset: 1085, flags: DIFlagBitField, extraData: i64 1072)
!4326 = !DIDerivedType(tag: DW_TAG_member, name: "runtime_d3cold", scope: !4161, file: !4162, line: 365, baseType: !7, size: 1, offset: 1086, flags: DIFlagBitField, extraData: i64 1072)
!4327 = !DIDerivedType(tag: DW_TAG_member, name: "skip_bus_pm", scope: !4161, file: !4162, line: 369, baseType: !7, size: 1, offset: 1087, flags: DIFlagBitField, extraData: i64 1072)
!4328 = !DIDerivedType(tag: DW_TAG_member, name: "ignore_hotplug", scope: !4161, file: !4162, line: 370, baseType: !7, size: 1, offset: 1088, flags: DIFlagBitField, extraData: i64 1072)
!4329 = !DIDerivedType(tag: DW_TAG_member, name: "hotplug_user_indicators", scope: !4161, file: !4162, line: 371, baseType: !7, size: 1, offset: 1089, flags: DIFlagBitField, extraData: i64 1072)
!4330 = !DIDerivedType(tag: DW_TAG_member, name: "clear_retrain_link", scope: !4161, file: !4162, line: 374, baseType: !7, size: 1, offset: 1090, flags: DIFlagBitField, extraData: i64 1072)
!4331 = !DIDerivedType(tag: DW_TAG_member, name: "d3hot_delay", scope: !4161, file: !4162, line: 376, baseType: !7, size: 32, offset: 1120)
!4332 = !DIDerivedType(tag: DW_TAG_member, name: "d3cold_delay", scope: !4161, file: !4162, line: 377, baseType: !7, size: 32, offset: 1152)
!4333 = !DIDerivedType(tag: DW_TAG_member, name: "link_state", scope: !4161, file: !4162, line: 380, baseType: !4334, size: 64, offset: 1216)
!4334 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4335, size: 64)
!4335 = !DICompositeType(tag: DW_TAG_structure_type, name: "pcie_link_state", file: !4162, line: 303, flags: DIFlagFwdDecl)
!4336 = !DIDerivedType(tag: DW_TAG_member, name: "ltr_path", scope: !4161, file: !4162, line: 381, baseType: !7, size: 1, offset: 1280, flags: DIFlagBitField, extraData: i64 1280)
!4337 = !DIDerivedType(tag: DW_TAG_member, name: "l1ss", scope: !4161, file: !4162, line: 383, baseType: !169, size: 32, offset: 1312)
!4338 = !DIDerivedType(tag: DW_TAG_member, name: "eetlp_prefix_path", scope: !4161, file: !4162, line: 385, baseType: !7, size: 1, offset: 1344, flags: DIFlagBitField, extraData: i64 1344)
!4339 = !DIDerivedType(tag: DW_TAG_member, name: "error_state", scope: !4161, file: !4162, line: 387, baseType: !4294, size: 32, offset: 1376)
!4340 = !DIDerivedType(tag: DW_TAG_member, name: "dev", scope: !4161, file: !4162, line: 388, baseType: !258, size: 5568, offset: 1408)
!4341 = !DIDerivedType(tag: DW_TAG_member, name: "cfg_size", scope: !4161, file: !4162, line: 390, baseType: !169, size: 32, offset: 6976)
!4342 = !DIDerivedType(tag: DW_TAG_member, name: "irq", scope: !4161, file: !4162, line: 396, baseType: !7, size: 32, offset: 7008)
!4343 = !DIDerivedType(tag: DW_TAG_member, name: "resource", scope: !4161, file: !4162, line: 397, baseType: !4344, size: 8704, offset: 7040)
!4344 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4094, size: 8704, elements: !4345)
!4345 = !{!4346}
!4346 = !DISubrange(count: 17)
!4347 = !DIDerivedType(tag: DW_TAG_member, name: "match_driver", scope: !4161, file: !4162, line: 399, baseType: !248, size: 8, offset: 15744)
!4348 = !DIDerivedType(tag: DW_TAG_member, name: "transparent", scope: !4161, file: !4162, line: 401, baseType: !7, size: 1, offset: 15752, flags: DIFlagBitField, extraData: i64 15752)
!4349 = !DIDerivedType(tag: DW_TAG_member, name: "io_window", scope: !4161, file: !4162, line: 402, baseType: !7, size: 1, offset: 15753, flags: DIFlagBitField, extraData: i64 15752)
!4350 = !DIDerivedType(tag: DW_TAG_member, name: "pref_window", scope: !4161, file: !4162, line: 403, baseType: !7, size: 1, offset: 15754, flags: DIFlagBitField, extraData: i64 15752)
!4351 = !DIDerivedType(tag: DW_TAG_member, name: "pref_64_window", scope: !4161, file: !4162, line: 404, baseType: !7, size: 1, offset: 15755, flags: DIFlagBitField, extraData: i64 15752)
!4352 = !DIDerivedType(tag: DW_TAG_member, name: "multifunction", scope: !4161, file: !4162, line: 405, baseType: !7, size: 1, offset: 15756, flags: DIFlagBitField, extraData: i64 15752)
!4353 = !DIDerivedType(tag: DW_TAG_member, name: "is_busmaster", scope: !4161, file: !4162, line: 407, baseType: !7, size: 1, offset: 15757, flags: DIFlagBitField, extraData: i64 15752)
!4354 = !DIDerivedType(tag: DW_TAG_member, name: "no_msi", scope: !4161, file: !4162, line: 408, baseType: !7, size: 1, offset: 15758, flags: DIFlagBitField, extraData: i64 15752)
!4355 = !DIDerivedType(tag: DW_TAG_member, name: "no_64bit_msi", scope: !4161, file: !4162, line: 409, baseType: !7, size: 1, offset: 15759, flags: DIFlagBitField, extraData: i64 15752)
!4356 = !DIDerivedType(tag: DW_TAG_member, name: "block_cfg_access", scope: !4161, file: !4162, line: 410, baseType: !7, size: 1, offset: 15760, flags: DIFlagBitField, extraData: i64 15752)
!4357 = !DIDerivedType(tag: DW_TAG_member, name: "broken_parity_status", scope: !4161, file: !4162, line: 411, baseType: !7, size: 1, offset: 15761, flags: DIFlagBitField, extraData: i64 15752)
!4358 = !DIDerivedType(tag: DW_TAG_member, name: "irq_reroute_variant", scope: !4161, file: !4162, line: 412, baseType: !7, size: 2, offset: 15762, flags: DIFlagBitField, extraData: i64 15752)
!4359 = !DIDerivedType(tag: DW_TAG_member, name: "msi_enabled", scope: !4161, file: !4162, line: 413, baseType: !7, size: 1, offset: 15764, flags: DIFlagBitField, extraData: i64 15752)
!4360 = !DIDerivedType(tag: DW_TAG_member, name: "msix_enabled", scope: !4161, file: !4162, line: 414, baseType: !7, size: 1, offset: 15765, flags: DIFlagBitField, extraData: i64 15752)
!4361 = !DIDerivedType(tag: DW_TAG_member, name: "ari_enabled", scope: !4161, file: !4162, line: 415, baseType: !7, size: 1, offset: 15766, flags: DIFlagBitField, extraData: i64 15752)
!4362 = !DIDerivedType(tag: DW_TAG_member, name: "ats_enabled", scope: !4161, file: !4162, line: 416, baseType: !7, size: 1, offset: 15767, flags: DIFlagBitField, extraData: i64 15752)
!4363 = !DIDerivedType(tag: DW_TAG_member, name: "pasid_enabled", scope: !4161, file: !4162, line: 417, baseType: !7, size: 1, offset: 15768, flags: DIFlagBitField, extraData: i64 15752)
!4364 = !DIDerivedType(tag: DW_TAG_member, name: "pri_enabled", scope: !4161, file: !4162, line: 418, baseType: !7, size: 1, offset: 15769, flags: DIFlagBitField, extraData: i64 15752)
!4365 = !DIDerivedType(tag: DW_TAG_member, name: "is_managed", scope: !4161, file: !4162, line: 419, baseType: !7, size: 1, offset: 15770, flags: DIFlagBitField, extraData: i64 15752)
!4366 = !DIDerivedType(tag: DW_TAG_member, name: "needs_freset", scope: !4161, file: !4162, line: 420, baseType: !7, size: 1, offset: 15771, flags: DIFlagBitField, extraData: i64 15752)
!4367 = !DIDerivedType(tag: DW_TAG_member, name: "state_saved", scope: !4161, file: !4162, line: 421, baseType: !7, size: 1, offset: 15772, flags: DIFlagBitField, extraData: i64 15752)
!4368 = !DIDerivedType(tag: DW_TAG_member, name: "is_physfn", scope: !4161, file: !4162, line: 422, baseType: !7, size: 1, offset: 15773, flags: DIFlagBitField, extraData: i64 15752)
!4369 = !DIDerivedType(tag: DW_TAG_member, name: "is_virtfn", scope: !4161, file: !4162, line: 423, baseType: !7, size: 1, offset: 15774, flags: DIFlagBitField, extraData: i64 15752)
!4370 = !DIDerivedType(tag: DW_TAG_member, name: "reset_fn", scope: !4161, file: !4162, line: 424, baseType: !7, size: 1, offset: 15775, flags: DIFlagBitField, extraData: i64 15752)
!4371 = !DIDerivedType(tag: DW_TAG_member, name: "is_hotplug_bridge", scope: !4161, file: !4162, line: 425, baseType: !7, size: 1, offset: 15776, flags: DIFlagBitField, extraData: i64 15752)
!4372 = !DIDerivedType(tag: DW_TAG_member, name: "shpc_managed", scope: !4161, file: !4162, line: 426, baseType: !7, size: 1, offset: 15777, flags: DIFlagBitField, extraData: i64 15752)
!4373 = !DIDerivedType(tag: DW_TAG_member, name: "is_thunderbolt", scope: !4161, file: !4162, line: 427, baseType: !7, size: 1, offset: 15778, flags: DIFlagBitField, extraData: i64 15752)
!4374 = !DIDerivedType(tag: DW_TAG_member, name: "untrusted", scope: !4161, file: !4162, line: 435, baseType: !7, size: 1, offset: 15779, flags: DIFlagBitField, extraData: i64 15752)
!4375 = !DIDerivedType(tag: DW_TAG_member, name: "external_facing", scope: !4161, file: !4162, line: 441, baseType: !7, size: 1, offset: 15780, flags: DIFlagBitField, extraData: i64 15752)
!4376 = !DIDerivedType(tag: DW_TAG_member, name: "broken_intx_masking", scope: !4161, file: !4162, line: 442, baseType: !7, size: 1, offset: 15781, flags: DIFlagBitField, extraData: i64 15752)
!4377 = !DIDerivedType(tag: DW_TAG_member, name: "io_window_1k", scope: !4161, file: !4162, line: 443, baseType: !7, size: 1, offset: 15782, flags: DIFlagBitField, extraData: i64 15752)
!4378 = !DIDerivedType(tag: DW_TAG_member, name: "irq_managed", scope: !4161, file: !4162, line: 444, baseType: !7, size: 1, offset: 15783, flags: DIFlagBitField, extraData: i64 15752)
!4379 = !DIDerivedType(tag: DW_TAG_member, name: "non_compliant_bars", scope: !4161, file: !4162, line: 445, baseType: !7, size: 1, offset: 15784, flags: DIFlagBitField, extraData: i64 15752)
!4380 = !DIDerivedType(tag: DW_TAG_member, name: "is_probed", scope: !4161, file: !4162, line: 446, baseType: !7, size: 1, offset: 15785, flags: DIFlagBitField, extraData: i64 15752)
!4381 = !DIDerivedType(tag: DW_TAG_member, name: "link_active_reporting", scope: !4161, file: !4162, line: 447, baseType: !7, size: 1, offset: 15786, flags: DIFlagBitField, extraData: i64 15752)
!4382 = !DIDerivedType(tag: DW_TAG_member, name: "no_vf_scan", scope: !4161, file: !4162, line: 448, baseType: !7, size: 1, offset: 15787, flags: DIFlagBitField, extraData: i64 15752)
!4383 = !DIDerivedType(tag: DW_TAG_member, name: "no_command_memory", scope: !4161, file: !4162, line: 449, baseType: !7, size: 1, offset: 15788, flags: DIFlagBitField, extraData: i64 15752)
!4384 = !DIDerivedType(tag: DW_TAG_member, name: "dev_flags", scope: !4161, file: !4162, line: 450, baseType: !4385, size: 16, offset: 15792)
!4385 = !DIDerivedType(tag: DW_TAG_typedef, name: "pci_dev_flags_t", file: !4162, line: 206, baseType: !352)
!4386 = !DIDerivedType(tag: DW_TAG_member, name: "enable_cnt", scope: !4161, file: !4162, line: 451, baseType: !777, size: 32, offset: 15808)
!4387 = !DIDerivedType(tag: DW_TAG_member, name: "saved_config_space", scope: !4161, file: !4162, line: 453, baseType: !4388, size: 512, offset: 15840)
!4388 = !DICompositeType(tag: DW_TAG_array_type, baseType: !222, size: 512, elements: !1801)
!4389 = !DIDerivedType(tag: DW_TAG_member, name: "saved_cap_space", scope: !4161, file: !4162, line: 454, baseType: !664, size: 64, offset: 16384)
!4390 = !DIDerivedType(tag: DW_TAG_member, name: "rom_attr", scope: !4161, file: !4162, line: 455, baseType: !377, size: 64, offset: 16448)
!4391 = !DIDerivedType(tag: DW_TAG_member, name: "rom_attr_enabled", scope: !4161, file: !4162, line: 456, baseType: !169, size: 32, offset: 16512)
!4392 = !DIDerivedType(tag: DW_TAG_member, name: "res_attr", scope: !4161, file: !4162, line: 457, baseType: !4393, size: 1088, offset: 16576)
!4393 = !DICompositeType(tag: DW_TAG_array_type, baseType: !377, size: 1088, elements: !4345)
!4394 = !DIDerivedType(tag: DW_TAG_member, name: "res_attr_wc", scope: !4161, file: !4162, line: 458, baseType: !4393, size: 1088, offset: 17664)
!4395 = !DIDerivedType(tag: DW_TAG_member, name: "msi_irq_groups", scope: !4161, file: !4162, line: 469, baseType: !363, size: 64, offset: 18752)
!4396 = !DIDerivedType(tag: DW_TAG_member, name: "vpd", scope: !4161, file: !4162, line: 471, baseType: !4397, size: 64, offset: 18816)
!4397 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4398, size: 64)
!4398 = !DICompositeType(tag: DW_TAG_structure_type, name: "pci_vpd", file: !4162, line: 304, flags: DIFlagFwdDecl)
!4399 = !DIDerivedType(tag: DW_TAG_member, scope: !4161, file: !4162, line: 478, baseType: !4400, size: 64, offset: 18880)
!4400 = distinct !DICompositeType(tag: DW_TAG_union_type, scope: !4161, file: !4162, line: 478, size: 64, elements: !4401)
!4401 = !{!4402, !4405}
!4402 = !DIDerivedType(tag: DW_TAG_member, name: "sriov", scope: !4400, file: !4162, line: 479, baseType: !4403, size: 64)
!4403 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4404, size: 64)
!4404 = !DICompositeType(tag: DW_TAG_structure_type, name: "pci_sriov", file: !4162, line: 305, flags: DIFlagFwdDecl)
!4405 = !DIDerivedType(tag: DW_TAG_member, name: "physfn", scope: !4400, file: !4162, line: 480, baseType: !4160, size: 64)
!4406 = !DIDerivedType(tag: DW_TAG_member, name: "ats_cap", scope: !4161, file: !4162, line: 482, baseType: !889, size: 16, offset: 18944)
!4407 = !DIDerivedType(tag: DW_TAG_member, name: "ats_stu", scope: !4161, file: !4162, line: 483, baseType: !1421, size: 8, offset: 18960)
!4408 = !DIDerivedType(tag: DW_TAG_member, name: "acs_cap", scope: !4161, file: !4162, line: 497, baseType: !889, size: 16, offset: 18976)
!4409 = !DIDerivedType(tag: DW_TAG_member, name: "rom", scope: !4161, file: !4162, line: 498, baseType: !160, size: 64, offset: 19008)
!4410 = !DIDerivedType(tag: DW_TAG_member, name: "romlen", scope: !4161, file: !4162, line: 499, baseType: !357, size: 64, offset: 19072)
!4411 = !DIDerivedType(tag: DW_TAG_member, name: "driver_override", scope: !4161, file: !4162, line: 500, baseType: !315, size: 64, offset: 19136)
!4412 = !DIDerivedType(tag: DW_TAG_member, name: "priv_flags", scope: !4161, file: !4162, line: 502, baseType: !157, size: 64, offset: 19200)
!4413 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "esb2rom_window", file: !3, line: 97, size: 896, elements: !4414)
!4414 = !{!4415, !4416, !4417, !4418, !4419, !4420}
!4415 = !DIDerivedType(tag: DW_TAG_member, name: "virt", scope: !4413, file: !3, line: 98, baseType: !137, size: 64)
!4416 = !DIDerivedType(tag: DW_TAG_member, name: "phys", scope: !4413, file: !3, line: 99, baseType: !157, size: 64, offset: 64)
!4417 = !DIDerivedType(tag: DW_TAG_member, name: "size", scope: !4413, file: !3, line: 100, baseType: !157, size: 64, offset: 128)
!4418 = !DIDerivedType(tag: DW_TAG_member, name: "maps", scope: !4413, file: !3, line: 101, baseType: !142, size: 128, offset: 192)
!4419 = !DIDerivedType(tag: DW_TAG_member, name: "rsrc", scope: !4413, file: !3, line: 102, baseType: !4094, size: 512, offset: 320)
!4420 = !DIDerivedType(tag: DW_TAG_member, name: "pdev", scope: !4413, file: !3, line: 103, baseType: !4160, size: 64, offset: 832)
!4421 = !{i32 7, !"Dwarf Version", i32 4}
!4422 = !{i32 2, !"Debug Info Version", i32 3}
!4423 = !{i32 1, !"wchar_size", i32 2}
!4424 = !{i32 1, !"Code Model", i32 2}
!4425 = !{!"clang version 10.0.1 (https://github.com/llvm/llvm-project.git ef32c611aa214dea855364efd7ba451ec5ec3f74)"}
!4426 = distinct !DISubprogram(name: "cleanup_esb2rom", scope: !3, file: !3, line: 443, type: !1946, scopeLine: 444, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!4427 = !DILocation(line: 445, column: 36, scope: !4426)
!4428 = !DILocation(line: 445, column: 2, scope: !4426)
!4429 = !DILocation(line: 446, column: 1, scope: !4426)
!4430 = distinct !DISubprogram(name: "esb2rom_remove_one", scope: !3, file: !3, line: 382, type: !4269, scopeLine: 383, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!4431 = !DILocalVariable(name: "pdev", arg: 1, scope: !4430, file: !3, line: 382, type: !4160)
!4432 = !DILocation(line: 382, column: 48, scope: !4430)
!4433 = !DILocalVariable(name: "window", scope: !4430, file: !3, line: 384, type: !4434)
!4434 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4413, size: 64)
!4435 = !DILocation(line: 384, column: 25, scope: !4430)
!4436 = !DILocation(line: 385, column: 18, scope: !4430)
!4437 = !DILocation(line: 385, column: 2, scope: !4430)
!4438 = !DILocation(line: 386, column: 1, scope: !4430)
!4439 = distinct !DISubprogram(name: "init_esb2rom", scope: !3, file: !3, line: 415, type: !4440, scopeLine: 416, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!4440 = !DISubroutineType(types: !4441)
!4441 = !{!169}
!4442 = !DILocalVariable(name: "pdev", scope: !4439, file: !3, line: 417, type: !4160)
!4443 = !DILocation(line: 417, column: 18, scope: !4439)
!4444 = !DILocalVariable(name: "id", scope: !4439, file: !3, line: 418, type: !4264)
!4445 = !DILocation(line: 418, column: 30, scope: !4439)
!4446 = !DILocalVariable(name: "retVal", scope: !4439, file: !3, line: 419, type: !169)
!4447 = !DILocation(line: 419, column: 6, scope: !4439)
!4448 = !DILocation(line: 421, column: 7, scope: !4439)
!4449 = !DILocation(line: 422, column: 10, scope: !4450)
!4450 = distinct !DILexicalBlock(scope: !4439, file: !3, line: 422, column: 2)
!4451 = !DILocation(line: 422, column: 7, scope: !4450)
!4452 = !DILocation(line: 422, column: 29, scope: !4453)
!4453 = distinct !DILexicalBlock(scope: !4450, file: !3, line: 422, column: 2)
!4454 = !DILocation(line: 422, column: 33, scope: !4453)
!4455 = !DILocation(line: 422, column: 2, scope: !4450)
!4456 = !DILocation(line: 423, column: 41, scope: !4457)
!4457 = distinct !DILexicalBlock(scope: !4453, file: !3, line: 422, column: 47)
!4458 = !DILocation(line: 423, column: 45, scope: !4457)
!4459 = !DILocation(line: 423, column: 3, scope: !4457)
!4460 = !DILocation(line: 424, column: 25, scope: !4457)
!4461 = !DILocation(line: 424, column: 29, scope: !4457)
!4462 = !DILocation(line: 424, column: 37, scope: !4457)
!4463 = !DILocation(line: 424, column: 41, scope: !4457)
!4464 = !DILocation(line: 424, column: 10, scope: !4457)
!4465 = !DILocation(line: 424, column: 8, scope: !4457)
!4466 = !DILocation(line: 425, column: 7, scope: !4467)
!4467 = distinct !DILexicalBlock(scope: !4457, file: !3, line: 425, column: 7)
!4468 = !DILocation(line: 425, column: 7, scope: !4457)
!4469 = !DILocation(line: 426, column: 47, scope: !4470)
!4470 = distinct !DILexicalBlock(scope: !4467, file: !3, line: 425, column: 13)
!4471 = !DILocation(line: 426, column: 51, scope: !4470)
!4472 = !DILocation(line: 426, column: 4, scope: !4470)
!4473 = !DILocation(line: 427, column: 4, scope: !4470)
!4474 = !DILocation(line: 429, column: 2, scope: !4457)
!4475 = !DILocation(line: 422, column: 43, scope: !4453)
!4476 = !DILocation(line: 422, column: 2, scope: !4453)
!4477 = distinct !{!4477, !4455, !4478}
!4478 = !DILocation(line: 429, column: 2, scope: !4450)
!4479 = !DILocation(line: 430, column: 6, scope: !4480)
!4480 = distinct !DILexicalBlock(scope: !4439, file: !3, line: 430, column: 6)
!4481 = !DILocation(line: 430, column: 6, scope: !4439)
!4482 = !DILocation(line: 431, column: 47, scope: !4483)
!4483 = distinct !DILexicalBlock(scope: !4480, file: !3, line: 430, column: 12)
!4484 = !DILocation(line: 431, column: 51, scope: !4483)
!4485 = !DILocation(line: 431, column: 3, scope: !4483)
!4486 = !DILocation(line: 432, column: 29, scope: !4483)
!4487 = !DILocation(line: 432, column: 12, scope: !4483)
!4488 = !DILocation(line: 432, column: 10, scope: !4483)
!4489 = !DILocation(line: 433, column: 15, scope: !4483)
!4490 = !DILocation(line: 433, column: 3, scope: !4483)
!4491 = !DILocation(line: 434, column: 38, scope: !4483)
!4492 = !DILocation(line: 434, column: 3, scope: !4483)
!4493 = !DILocation(line: 435, column: 10, scope: !4483)
!4494 = !DILocation(line: 435, column: 3, scope: !4483)
!4495 = !DILocation(line: 437, column: 2, scope: !4439)
!4496 = !DILocation(line: 441, column: 1, scope: !4439)
!4497 = distinct !DISubprogram(name: "esb2rom_cleanup", scope: !3, file: !3, line: 118, type: !4498, scopeLine: 119, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!4498 = !DISubroutineType(types: !4499)
!4499 = !{null, !4434}
!4500 = !DILocalVariable(name: "window", arg: 1, scope: !4497, file: !3, line: 118, type: !4434)
!4501 = !DILocation(line: 118, column: 52, scope: !4497)
!4502 = !DILocalVariable(name: "map", scope: !4497, file: !3, line: 120, type: !138)
!4503 = !DILocation(line: 120, column: 27, scope: !4497)
!4504 = !DILocalVariable(name: "scratch", scope: !4497, file: !3, line: 120, type: !138)
!4505 = !DILocation(line: 120, column: 33, scope: !4497)
!4506 = !DILocalVariable(name: "byte", scope: !4497, file: !3, line: 121, type: !1421)
!4507 = !DILocation(line: 121, column: 5, scope: !4497)
!4508 = !DILocation(line: 124, column: 23, scope: !4497)
!4509 = !DILocation(line: 124, column: 31, scope: !4497)
!4510 = !DILocation(line: 124, column: 2, scope: !4497)
!4511 = !DILocation(line: 125, column: 24, scope: !4497)
!4512 = !DILocation(line: 125, column: 32, scope: !4497)
!4513 = !DILocation(line: 126, column: 3, scope: !4497)
!4514 = !DILocation(line: 126, column: 8, scope: !4497)
!4515 = !DILocation(line: 125, column: 2, scope: !4497)
!4516 = !DILocalVariable(name: "__mptr", scope: !4517, file: !3, line: 129, type: !137)
!4517 = distinct !DILexicalBlock(scope: !4518, file: !3, line: 129, column: 2)
!4518 = distinct !DILexicalBlock(scope: !4497, file: !3, line: 129, column: 2)
!4519 = !DILocation(line: 129, column: 2, scope: !4517)
!4520 = !DILocation(line: 129, column: 2, scope: !4521)
!4521 = distinct !DILexicalBlock(scope: !4517, file: !3, line: 129, column: 2)
!4522 = !DILocation(line: 129, column: 2, scope: !4518)
!4523 = !DILocalVariable(name: "__mptr", scope: !4524, file: !3, line: 129, type: !137)
!4524 = distinct !DILexicalBlock(scope: !4518, file: !3, line: 129, column: 2)
!4525 = !DILocation(line: 129, column: 2, scope: !4524)
!4526 = !DILocation(line: 129, column: 2, scope: !4527)
!4527 = distinct !DILexicalBlock(scope: !4524, file: !3, line: 129, column: 2)
!4528 = !DILocation(line: 129, column: 2, scope: !4529)
!4529 = distinct !DILexicalBlock(scope: !4518, file: !3, line: 129, column: 2)
!4530 = !DILocation(line: 130, column: 7, scope: !4531)
!4531 = distinct !DILexicalBlock(scope: !4532, file: !3, line: 130, column: 7)
!4532 = distinct !DILexicalBlock(scope: !4529, file: !3, line: 129, column: 62)
!4533 = !DILocation(line: 130, column: 12, scope: !4531)
!4534 = !DILocation(line: 130, column: 17, scope: !4531)
!4535 = !DILocation(line: 130, column: 7, scope: !4532)
!4536 = !DILocation(line: 131, column: 22, scope: !4531)
!4537 = !DILocation(line: 131, column: 27, scope: !4531)
!4538 = !DILocation(line: 131, column: 4, scope: !4531)
!4539 = !DILocation(line: 132, column: 25, scope: !4532)
!4540 = !DILocation(line: 132, column: 30, scope: !4532)
!4541 = !DILocation(line: 132, column: 3, scope: !4532)
!4542 = !DILocation(line: 133, column: 15, scope: !4532)
!4543 = !DILocation(line: 133, column: 20, scope: !4532)
!4544 = !DILocation(line: 133, column: 3, scope: !4532)
!4545 = !DILocation(line: 134, column: 13, scope: !4532)
!4546 = !DILocation(line: 134, column: 18, scope: !4532)
!4547 = !DILocation(line: 134, column: 3, scope: !4532)
!4548 = !DILocation(line: 135, column: 9, scope: !4532)
!4549 = !DILocation(line: 135, column: 3, scope: !4532)
!4550 = !DILocation(line: 136, column: 2, scope: !4532)
!4551 = !DILocalVariable(name: "__mptr", scope: !4552, file: !3, line: 129, type: !137)
!4552 = distinct !DILexicalBlock(scope: !4529, file: !3, line: 129, column: 2)
!4553 = !DILocation(line: 129, column: 2, scope: !4552)
!4554 = !DILocation(line: 129, column: 2, scope: !4555)
!4555 = distinct !DILexicalBlock(scope: !4552, file: !3, line: 129, column: 2)
!4556 = distinct !{!4556, !4522, !4557}
!4557 = !DILocation(line: 136, column: 2, scope: !4518)
!4558 = !DILocation(line: 137, column: 6, scope: !4559)
!4559 = distinct !DILexicalBlock(scope: !4497, file: !3, line: 137, column: 6)
!4560 = !DILocation(line: 137, column: 14, scope: !4559)
!4561 = !DILocation(line: 137, column: 19, scope: !4559)
!4562 = !DILocation(line: 137, column: 6, scope: !4497)
!4563 = !DILocation(line: 138, column: 21, scope: !4559)
!4564 = !DILocation(line: 138, column: 29, scope: !4559)
!4565 = !DILocation(line: 138, column: 3, scope: !4559)
!4566 = !DILocation(line: 139, column: 6, scope: !4567)
!4567 = distinct !DILexicalBlock(scope: !4497, file: !3, line: 139, column: 6)
!4568 = !DILocation(line: 139, column: 14, scope: !4567)
!4569 = !DILocation(line: 139, column: 6, scope: !4497)
!4570 = !DILocation(line: 140, column: 11, scope: !4571)
!4571 = distinct !DILexicalBlock(scope: !4567, file: !3, line: 139, column: 20)
!4572 = !DILocation(line: 140, column: 19, scope: !4571)
!4573 = !DILocation(line: 140, column: 3, scope: !4571)
!4574 = !DILocation(line: 141, column: 3, scope: !4571)
!4575 = !DILocation(line: 141, column: 11, scope: !4571)
!4576 = !DILocation(line: 141, column: 16, scope: !4571)
!4577 = !DILocation(line: 142, column: 3, scope: !4571)
!4578 = !DILocation(line: 142, column: 11, scope: !4571)
!4579 = !DILocation(line: 142, column: 16, scope: !4571)
!4580 = !DILocation(line: 143, column: 3, scope: !4571)
!4581 = !DILocation(line: 143, column: 11, scope: !4571)
!4582 = !DILocation(line: 143, column: 16, scope: !4571)
!4583 = !DILocation(line: 144, column: 2, scope: !4571)
!4584 = !DILocation(line: 145, column: 14, scope: !4497)
!4585 = !DILocation(line: 145, column: 22, scope: !4497)
!4586 = !DILocation(line: 145, column: 2, scope: !4497)
!4587 = !DILocation(line: 146, column: 1, scope: !4497)
!4588 = distinct !DISubprogram(name: "list_del", scope: !4589, file: !4589, line: 144, type: !4590, scopeLine: 145, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!4589 = !DIFile(filename: "./include/linux/list.h", directory: "/home/lizy2001/genbc/linux")
!4590 = !DISubroutineType(types: !4591)
!4591 = !{null, !146}
!4592 = !DILocalVariable(name: "entry", arg: 1, scope: !4588, file: !4589, line: 144, type: !146)
!4593 = !DILocation(line: 144, column: 47, scope: !4588)
!4594 = !DILocation(line: 146, column: 19, scope: !4588)
!4595 = !DILocation(line: 146, column: 2, scope: !4588)
!4596 = !DILocation(line: 147, column: 2, scope: !4588)
!4597 = !DILocation(line: 147, column: 9, scope: !4588)
!4598 = !DILocation(line: 147, column: 14, scope: !4588)
!4599 = !DILocation(line: 148, column: 2, scope: !4588)
!4600 = !DILocation(line: 148, column: 9, scope: !4588)
!4601 = !DILocation(line: 148, column: 14, scope: !4588)
!4602 = !DILocation(line: 149, column: 1, scope: !4588)
!4603 = distinct !DISubprogram(name: "__list_del_entry", scope: !4589, file: !4589, line: 130, type: !4590, scopeLine: 131, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!4604 = !DILocalVariable(name: "entry", arg: 1, scope: !4603, file: !4589, line: 130, type: !146)
!4605 = !DILocation(line: 130, column: 55, scope: !4603)
!4606 = !DILocation(line: 132, column: 30, scope: !4607)
!4607 = distinct !DILexicalBlock(scope: !4603, file: !4589, line: 132, column: 6)
!4608 = !DILocation(line: 132, column: 7, scope: !4607)
!4609 = !DILocation(line: 132, column: 6, scope: !4603)
!4610 = !DILocation(line: 133, column: 3, scope: !4607)
!4611 = !DILocation(line: 135, column: 13, scope: !4603)
!4612 = !DILocation(line: 135, column: 20, scope: !4603)
!4613 = !DILocation(line: 135, column: 26, scope: !4603)
!4614 = !DILocation(line: 135, column: 33, scope: !4603)
!4615 = !DILocation(line: 135, column: 2, scope: !4603)
!4616 = !DILocation(line: 136, column: 1, scope: !4603)
!4617 = distinct !DISubprogram(name: "__list_del_entry_valid", scope: !4589, file: !4589, line: 51, type: !4618, scopeLine: 52, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!4618 = !DISubroutineType(types: !4619)
!4619 = !{!248, !146}
!4620 = !DILocalVariable(name: "entry", arg: 1, scope: !4617, file: !4589, line: 51, type: !146)
!4621 = !DILocation(line: 51, column: 61, scope: !4617)
!4622 = !DILocation(line: 53, column: 2, scope: !4617)
!4623 = distinct !DISubprogram(name: "__list_del", scope: !4589, file: !4589, line: 110, type: !4624, scopeLine: 111, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!4624 = !DISubroutineType(types: !4625)
!4625 = !{null, !146, !146}
!4626 = !DILocalVariable(name: "prev", arg: 1, scope: !4623, file: !4589, line: 110, type: !146)
!4627 = !DILocation(line: 110, column: 50, scope: !4623)
!4628 = !DILocalVariable(name: "next", arg: 2, scope: !4623, file: !4589, line: 110, type: !146)
!4629 = !DILocation(line: 110, column: 75, scope: !4623)
!4630 = !DILocation(line: 112, column: 15, scope: !4623)
!4631 = !DILocation(line: 112, column: 2, scope: !4623)
!4632 = !DILocation(line: 112, column: 8, scope: !4623)
!4633 = !DILocation(line: 112, column: 13, scope: !4623)
!4634 = !DILocation(line: 113, column: 2, scope: !4623)
!4635 = !DILocation(line: 113, column: 2, scope: !4636)
!4636 = distinct !DILexicalBlock(scope: !4623, file: !4589, line: 113, column: 2)
!4637 = !DILocation(line: 113, column: 2, scope: !4638)
!4638 = distinct !DILexicalBlock(scope: !4636, file: !4589, line: 113, column: 2)
!4639 = !DILocation(line: 113, column: 2, scope: !4640)
!4640 = distinct !DILexicalBlock(scope: !4636, file: !4589, line: 113, column: 2)
!4641 = !DILocation(line: 114, column: 1, scope: !4623)
!4642 = !DILocalVariable(name: "s", arg: 1, scope: !4643, file: !130, line: 445, type: !1004)
!4643 = distinct !DISubprogram(name: "kmem_cache_alloc_trace", scope: !130, file: !130, line: 445, type: !4644, scopeLine: 447, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!4644 = !DISubroutineType(types: !4645)
!4645 = !{!137, !1004, !773, !357}
!4646 = !DILocation(line: 445, column: 72, scope: !4643, inlinedAt: !4647)
!4647 = distinct !DILocation(line: 552, column: 10, scope: !4648, inlinedAt: !4653)
!4648 = distinct !DILexicalBlock(scope: !4649, file: !130, line: 540, column: 34)
!4649 = distinct !DILexicalBlock(scope: !4650, file: !130, line: 540, column: 6)
!4650 = distinct !DISubprogram(name: "kmalloc", scope: !130, file: !130, line: 538, type: !4651, scopeLine: 539, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!4651 = !DISubroutineType(types: !4652)
!4652 = !{!137, !357, !773}
!4653 = distinct !DILocation(line: 281, column: 10, scope: !4654)
!4654 = distinct !DILexicalBlock(scope: !4655, file: !3, line: 280, column: 7)
!4655 = distinct !DILexicalBlock(scope: !4157, file: !3, line: 275, column: 39)
!4656 = !DILocalVariable(name: "flags", arg: 2, scope: !4643, file: !130, line: 446, type: !773)
!4657 = !DILocation(line: 446, column: 9, scope: !4643, inlinedAt: !4647)
!4658 = !DILocalVariable(name: "size", arg: 3, scope: !4643, file: !130, line: 446, type: !357)
!4659 = !DILocation(line: 446, column: 23, scope: !4643, inlinedAt: !4647)
!4660 = !DILocalVariable(name: "ret", scope: !4643, file: !130, line: 448, type: !137)
!4661 = !DILocation(line: 448, column: 8, scope: !4643, inlinedAt: !4647)
!4662 = !DILocalVariable(name: "flags", arg: 1, scope: !4663, file: !130, line: 318, type: !773)
!4663 = distinct !DISubprogram(name: "kmalloc_type", scope: !130, file: !130, line: 318, type: !4664, scopeLine: 319, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!4664 = !DISubroutineType(types: !4665)
!4665 = !{!129, !773}
!4666 = !DILocation(line: 318, column: 67, scope: !4663, inlinedAt: !4667)
!4667 = distinct !DILocation(line: 553, column: 20, scope: !4648, inlinedAt: !4653)
!4668 = !DILocalVariable(name: "size", arg: 1, scope: !4669, file: !130, line: 346, type: !357)
!4669 = distinct !DISubprogram(name: "kmalloc_index", scope: !130, file: !130, line: 346, type: !4670, scopeLine: 347, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!4670 = !DISubroutineType(types: !4671)
!4671 = !{!7, !357}
!4672 = !DILocation(line: 346, column: 58, scope: !4669, inlinedAt: !4673)
!4673 = distinct !DILocation(line: 547, column: 11, scope: !4648, inlinedAt: !4653)
!4674 = !DILocalVariable(name: "size", arg: 1, scope: !4675, file: !130, line: 472, type: !357)
!4675 = distinct !DISubprogram(name: "kmalloc_order_trace", scope: !130, file: !130, line: 472, type: !4676, scopeLine: 473, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!4676 = !DISubroutineType(types: !4677)
!4677 = !{!137, !357, !773, !7}
!4678 = !DILocation(line: 472, column: 28, scope: !4675, inlinedAt: !4679)
!4679 = distinct !DILocation(line: 481, column: 9, scope: !4680, inlinedAt: !4681)
!4680 = distinct !DISubprogram(name: "kmalloc_large", scope: !130, file: !130, line: 478, type: !4651, scopeLine: 479, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!4681 = distinct !DILocation(line: 545, column: 11, scope: !4682, inlinedAt: !4653)
!4682 = distinct !DILexicalBlock(scope: !4648, file: !130, line: 544, column: 7)
!4683 = !DILocalVariable(name: "flags", arg: 2, scope: !4675, file: !130, line: 472, type: !773)
!4684 = !DILocation(line: 472, column: 40, scope: !4675, inlinedAt: !4679)
!4685 = !DILocalVariable(name: "order", arg: 3, scope: !4675, file: !130, line: 472, type: !7)
!4686 = !DILocation(line: 472, column: 60, scope: !4675, inlinedAt: !4679)
!4687 = !DILocalVariable(name: "size", arg: 1, scope: !4680, file: !130, line: 478, type: !357)
!4688 = !DILocation(line: 478, column: 51, scope: !4680, inlinedAt: !4681)
!4689 = !DILocalVariable(name: "flags", arg: 2, scope: !4680, file: !130, line: 478, type: !773)
!4690 = !DILocation(line: 478, column: 63, scope: !4680, inlinedAt: !4681)
!4691 = !DILocalVariable(name: "order", scope: !4680, file: !130, line: 480, type: !7)
!4692 = !DILocation(line: 480, column: 15, scope: !4680, inlinedAt: !4681)
!4693 = !DILocalVariable(name: "size", arg: 1, scope: !4650, file: !130, line: 538, type: !357)
!4694 = !DILocation(line: 538, column: 45, scope: !4650, inlinedAt: !4653)
!4695 = !DILocalVariable(name: "flags", arg: 2, scope: !4650, file: !130, line: 538, type: !773)
!4696 = !DILocation(line: 538, column: 57, scope: !4650, inlinedAt: !4653)
!4697 = !DILocalVariable(name: "index", scope: !4648, file: !130, line: 542, type: !7)
!4698 = !DILocation(line: 542, column: 16, scope: !4648, inlinedAt: !4653)
!4699 = !DILocalVariable(name: "pdev", arg: 1, scope: !4157, file: !3, line: 148, type: !4160)
!4700 = !DILocation(line: 148, column: 52, scope: !4157)
!4701 = !DILocalVariable(name: "ent", arg: 2, scope: !4157, file: !3, line: 149, type: !4264)
!4702 = !DILocation(line: 149, column: 36, scope: !4157)
!4703 = !DILocalVariable(name: "window", scope: !4157, file: !3, line: 152, type: !4434)
!4704 = !DILocation(line: 152, column: 25, scope: !4157)
!4705 = !DILocalVariable(name: "map", scope: !4157, file: !3, line: 153, type: !138)
!4706 = !DILocation(line: 153, column: 27, scope: !4157)
!4707 = !DILocalVariable(name: "map_top", scope: !4157, file: !3, line: 154, type: !157)
!4708 = !DILocation(line: 154, column: 16, scope: !4157)
!4709 = !DILocalVariable(name: "byte", scope: !4157, file: !3, line: 155, type: !1421)
!4710 = !DILocation(line: 155, column: 5, scope: !4157)
!4711 = !DILocalVariable(name: "word", scope: !4157, file: !3, line: 156, type: !889)
!4712 = !DILocation(line: 156, column: 6, scope: !4157)
!4713 = !DILocation(line: 168, column: 29, scope: !4157)
!4714 = !DILocation(line: 168, column: 17, scope: !4157)
!4715 = !DILocation(line: 168, column: 2, scope: !4157)
!4716 = !DILocation(line: 168, column: 10, scope: !4157)
!4717 = !DILocation(line: 168, column: 15, scope: !4157)
!4718 = !DILocation(line: 187, column: 2, scope: !4157)
!4719 = !DILocation(line: 187, column: 10, scope: !4157)
!4720 = !DILocation(line: 187, column: 15, scope: !4157)
!4721 = !DILocation(line: 188, column: 23, scope: !4157)
!4722 = !DILocation(line: 188, column: 2, scope: !4157)
!4723 = !DILocation(line: 189, column: 51, scope: !4157)
!4724 = !DILocation(line: 189, column: 2, scope: !4157)
!4725 = !DILocation(line: 191, column: 7, scope: !4726)
!4726 = distinct !DILexicalBlock(scope: !4157, file: !3, line: 191, column: 6)
!4727 = !DILocation(line: 191, column: 12, scope: !4726)
!4728 = !DILocation(line: 191, column: 24, scope: !4726)
!4729 = !DILocation(line: 191, column: 6, scope: !4157)
!4730 = !DILocation(line: 192, column: 3, scope: !4726)
!4731 = !DILocation(line: 192, column: 11, scope: !4726)
!4732 = !DILocation(line: 192, column: 16, scope: !4726)
!4733 = !DILocation(line: 193, column: 12, scope: !4734)
!4734 = distinct !DILexicalBlock(scope: !4726, file: !3, line: 193, column: 11)
!4735 = !DILocation(line: 193, column: 17, scope: !4734)
!4736 = !DILocation(line: 193, column: 29, scope: !4734)
!4737 = !DILocation(line: 193, column: 11, scope: !4726)
!4738 = !DILocation(line: 194, column: 3, scope: !4734)
!4739 = !DILocation(line: 194, column: 11, scope: !4734)
!4740 = !DILocation(line: 194, column: 16, scope: !4734)
!4741 = !DILocation(line: 195, column: 12, scope: !4742)
!4742 = distinct !DILexicalBlock(scope: !4734, file: !3, line: 195, column: 11)
!4743 = !DILocation(line: 195, column: 17, scope: !4742)
!4744 = !DILocation(line: 195, column: 29, scope: !4742)
!4745 = !DILocation(line: 195, column: 11, scope: !4734)
!4746 = !DILocation(line: 196, column: 3, scope: !4742)
!4747 = !DILocation(line: 196, column: 11, scope: !4742)
!4748 = !DILocation(line: 196, column: 16, scope: !4742)
!4749 = !DILocation(line: 197, column: 12, scope: !4750)
!4750 = distinct !DILexicalBlock(scope: !4742, file: !3, line: 197, column: 11)
!4751 = !DILocation(line: 197, column: 17, scope: !4750)
!4752 = !DILocation(line: 197, column: 29, scope: !4750)
!4753 = !DILocation(line: 197, column: 11, scope: !4742)
!4754 = !DILocation(line: 198, column: 3, scope: !4750)
!4755 = !DILocation(line: 198, column: 11, scope: !4750)
!4756 = !DILocation(line: 198, column: 16, scope: !4750)
!4757 = !DILocation(line: 199, column: 12, scope: !4758)
!4758 = distinct !DILexicalBlock(scope: !4750, file: !3, line: 199, column: 11)
!4759 = !DILocation(line: 199, column: 17, scope: !4758)
!4760 = !DILocation(line: 199, column: 29, scope: !4758)
!4761 = !DILocation(line: 199, column: 11, scope: !4750)
!4762 = !DILocation(line: 200, column: 3, scope: !4758)
!4763 = !DILocation(line: 200, column: 11, scope: !4758)
!4764 = !DILocation(line: 200, column: 16, scope: !4758)
!4765 = !DILocation(line: 201, column: 12, scope: !4766)
!4766 = distinct !DILexicalBlock(scope: !4758, file: !3, line: 201, column: 11)
!4767 = !DILocation(line: 201, column: 17, scope: !4766)
!4768 = !DILocation(line: 201, column: 31, scope: !4766)
!4769 = !DILocation(line: 201, column: 11, scope: !4758)
!4770 = !DILocation(line: 202, column: 3, scope: !4766)
!4771 = !DILocation(line: 202, column: 11, scope: !4766)
!4772 = !DILocation(line: 202, column: 16, scope: !4766)
!4773 = !DILocation(line: 203, column: 12, scope: !4774)
!4774 = distinct !DILexicalBlock(scope: !4766, file: !3, line: 203, column: 11)
!4775 = !DILocation(line: 203, column: 17, scope: !4774)
!4776 = !DILocation(line: 203, column: 29, scope: !4774)
!4777 = !DILocation(line: 203, column: 11, scope: !4766)
!4778 = !DILocation(line: 204, column: 3, scope: !4774)
!4779 = !DILocation(line: 204, column: 11, scope: !4774)
!4780 = !DILocation(line: 204, column: 16, scope: !4774)
!4781 = !DILocation(line: 205, column: 12, scope: !4782)
!4782 = distinct !DILexicalBlock(scope: !4774, file: !3, line: 205, column: 11)
!4783 = !DILocation(line: 205, column: 17, scope: !4782)
!4784 = !DILocation(line: 205, column: 31, scope: !4782)
!4785 = !DILocation(line: 205, column: 11, scope: !4774)
!4786 = !DILocation(line: 206, column: 3, scope: !4782)
!4787 = !DILocation(line: 206, column: 11, scope: !4782)
!4788 = !DILocation(line: 206, column: 16, scope: !4782)
!4789 = !DILocation(line: 207, column: 12, scope: !4790)
!4790 = distinct !DILexicalBlock(scope: !4782, file: !3, line: 207, column: 11)
!4791 = !DILocation(line: 207, column: 17, scope: !4790)
!4792 = !DILocation(line: 207, column: 29, scope: !4790)
!4793 = !DILocation(line: 207, column: 11, scope: !4782)
!4794 = !DILocation(line: 208, column: 3, scope: !4790)
!4795 = !DILocation(line: 208, column: 11, scope: !4790)
!4796 = !DILocation(line: 208, column: 16, scope: !4790)
!4797 = !DILocation(line: 209, column: 12, scope: !4798)
!4798 = distinct !DILexicalBlock(scope: !4790, file: !3, line: 209, column: 11)
!4799 = !DILocation(line: 209, column: 17, scope: !4798)
!4800 = !DILocation(line: 209, column: 31, scope: !4798)
!4801 = !DILocation(line: 209, column: 11, scope: !4790)
!4802 = !DILocation(line: 210, column: 3, scope: !4798)
!4803 = !DILocation(line: 210, column: 11, scope: !4798)
!4804 = !DILocation(line: 210, column: 16, scope: !4798)
!4805 = !DILocation(line: 211, column: 12, scope: !4806)
!4806 = distinct !DILexicalBlock(scope: !4798, file: !3, line: 211, column: 11)
!4807 = !DILocation(line: 211, column: 17, scope: !4806)
!4808 = !DILocation(line: 211, column: 29, scope: !4806)
!4809 = !DILocation(line: 211, column: 11, scope: !4798)
!4810 = !DILocation(line: 212, column: 3, scope: !4806)
!4811 = !DILocation(line: 212, column: 11, scope: !4806)
!4812 = !DILocation(line: 212, column: 16, scope: !4806)
!4813 = !DILocation(line: 213, column: 12, scope: !4814)
!4814 = distinct !DILexicalBlock(scope: !4806, file: !3, line: 213, column: 11)
!4815 = !DILocation(line: 213, column: 17, scope: !4814)
!4816 = !DILocation(line: 213, column: 31, scope: !4814)
!4817 = !DILocation(line: 213, column: 11, scope: !4806)
!4818 = !DILocation(line: 214, column: 3, scope: !4814)
!4819 = !DILocation(line: 214, column: 11, scope: !4814)
!4820 = !DILocation(line: 214, column: 16, scope: !4814)
!4821 = !DILocation(line: 216, column: 6, scope: !4822)
!4822 = distinct !DILexicalBlock(scope: !4157, file: !3, line: 216, column: 6)
!4823 = !DILocation(line: 216, column: 14, scope: !4822)
!4824 = !DILocation(line: 216, column: 19, scope: !4822)
!4825 = !DILocation(line: 216, column: 6, scope: !4157)
!4826 = !DILocation(line: 217, column: 3, scope: !4827)
!4827 = distinct !DILexicalBlock(scope: !4822, file: !3, line: 216, column: 25)
!4828 = !DILocation(line: 218, column: 3, scope: !4827)
!4829 = !DILocation(line: 222, column: 2, scope: !4157)
!4830 = !DILocation(line: 222, column: 10, scope: !4157)
!4831 = !DILocation(line: 222, column: 15, scope: !4157)
!4832 = !DILocation(line: 223, column: 33, scope: !4157)
!4833 = !DILocation(line: 223, column: 41, scope: !4157)
!4834 = !DILocation(line: 223, column: 31, scope: !4157)
!4835 = !DILocation(line: 223, column: 47, scope: !4157)
!4836 = !DILocation(line: 223, column: 2, scope: !4157)
!4837 = !DILocation(line: 223, column: 10, scope: !4157)
!4838 = !DILocation(line: 223, column: 15, scope: !4157)
!4839 = !DILocation(line: 226, column: 23, scope: !4157)
!4840 = !DILocation(line: 226, column: 2, scope: !4157)
!4841 = !DILocation(line: 227, column: 8, scope: !4842)
!4842 = distinct !DILexicalBlock(scope: !4157, file: !3, line: 227, column: 6)
!4843 = !DILocation(line: 227, column: 13, scope: !4842)
!4844 = !DILocation(line: 227, column: 35, scope: !4842)
!4845 = !DILocation(line: 227, column: 39, scope: !4842)
!4846 = !DILocation(line: 227, column: 44, scope: !4842)
!4847 = !DILocation(line: 227, column: 6, scope: !4157)
!4848 = !DILocation(line: 231, column: 3, scope: !4849)
!4849 = distinct !DILexicalBlock(scope: !4842, file: !3, line: 227, column: 67)
!4850 = !DILocation(line: 232, column: 3, scope: !4849)
!4851 = !DILocation(line: 234, column: 24, scope: !4157)
!4852 = !DILocation(line: 234, column: 41, scope: !4157)
!4853 = !DILocation(line: 234, column: 46, scope: !4157)
!4854 = !DILocation(line: 234, column: 2, scope: !4157)
!4855 = !DILocation(line: 240, column: 2, scope: !4157)
!4856 = !DILocation(line: 240, column: 10, scope: !4157)
!4857 = !DILocation(line: 240, column: 15, scope: !4157)
!4858 = !DILocation(line: 240, column: 20, scope: !4157)
!4859 = !DILocation(line: 241, column: 23, scope: !4157)
!4860 = !DILocation(line: 241, column: 31, scope: !4157)
!4861 = !DILocation(line: 241, column: 2, scope: !4157)
!4862 = !DILocation(line: 241, column: 10, scope: !4157)
!4863 = !DILocation(line: 241, column: 15, scope: !4157)
!4864 = !DILocation(line: 241, column: 21, scope: !4157)
!4865 = !DILocation(line: 242, column: 23, scope: !4157)
!4866 = !DILocation(line: 242, column: 31, scope: !4157)
!4867 = !DILocation(line: 242, column: 38, scope: !4157)
!4868 = !DILocation(line: 242, column: 46, scope: !4157)
!4869 = !DILocation(line: 242, column: 36, scope: !4157)
!4870 = !DILocation(line: 242, column: 51, scope: !4157)
!4871 = !DILocation(line: 242, column: 2, scope: !4157)
!4872 = !DILocation(line: 242, column: 10, scope: !4157)
!4873 = !DILocation(line: 242, column: 15, scope: !4157)
!4874 = !DILocation(line: 242, column: 21, scope: !4157)
!4875 = !DILocation(line: 243, column: 2, scope: !4157)
!4876 = !DILocation(line: 243, column: 10, scope: !4157)
!4877 = !DILocation(line: 243, column: 15, scope: !4157)
!4878 = !DILocation(line: 243, column: 21, scope: !4157)
!4879 = !DILocation(line: 244, column: 41, scope: !4880)
!4880 = distinct !DILexicalBlock(scope: !4157, file: !3, line: 244, column: 6)
!4881 = !DILocation(line: 244, column: 49, scope: !4880)
!4882 = !DILocation(line: 244, column: 6, scope: !4880)
!4883 = !DILocation(line: 244, column: 6, scope: !4157)
!4884 = !DILocation(line: 245, column: 3, scope: !4885)
!4885 = distinct !DILexicalBlock(scope: !4880, file: !3, line: 244, column: 56)
!4886 = !DILocation(line: 245, column: 11, scope: !4885)
!4887 = !DILocation(line: 245, column: 16, scope: !4885)
!4888 = !DILocation(line: 245, column: 23, scope: !4885)
!4889 = !DILocation(line: 248, column: 15, scope: !4885)
!4890 = !DILocation(line: 248, column: 23, scope: !4885)
!4891 = !DILocation(line: 246, column: 3, scope: !4885)
!4892 = !DILocation(line: 249, column: 2, scope: !4885)
!4893 = !DILocation(line: 252, column: 25, scope: !4157)
!4894 = !DILocation(line: 252, column: 33, scope: !4157)
!4895 = !DILocation(line: 252, column: 39, scope: !4157)
!4896 = !DILocation(line: 252, column: 47, scope: !4157)
!4897 = !DILocation(line: 252, column: 17, scope: !4157)
!4898 = !DILocation(line: 252, column: 2, scope: !4157)
!4899 = !DILocation(line: 252, column: 10, scope: !4157)
!4900 = !DILocation(line: 252, column: 15, scope: !4157)
!4901 = !DILocation(line: 253, column: 7, scope: !4902)
!4902 = distinct !DILexicalBlock(scope: !4157, file: !3, line: 253, column: 6)
!4903 = !DILocation(line: 253, column: 15, scope: !4902)
!4904 = !DILocation(line: 253, column: 6, scope: !4157)
!4905 = !DILocation(line: 255, column: 4, scope: !4906)
!4906 = distinct !DILexicalBlock(scope: !4902, file: !3, line: 253, column: 21)
!4907 = !DILocation(line: 255, column: 12, scope: !4906)
!4908 = !DILocation(line: 255, column: 18, scope: !4906)
!4909 = !DILocation(line: 255, column: 26, scope: !4906)
!4910 = !DILocation(line: 254, column: 3, scope: !4906)
!4911 = !DILocation(line: 256, column: 3, scope: !4906)
!4912 = !DILocation(line: 260, column: 12, scope: !4157)
!4913 = !DILocation(line: 260, column: 20, scope: !4157)
!4914 = !DILocation(line: 260, column: 10, scope: !4157)
!4915 = !DILocation(line: 261, column: 7, scope: !4916)
!4916 = distinct !DILexicalBlock(scope: !4157, file: !3, line: 261, column: 6)
!4917 = !DILocation(line: 261, column: 15, scope: !4916)
!4918 = !DILocation(line: 261, column: 20, scope: !4916)
!4919 = !DILocation(line: 261, column: 32, scope: !4916)
!4920 = !DILocation(line: 261, column: 6, scope: !4157)
!4921 = !DILocation(line: 263, column: 13, scope: !4922)
!4922 = distinct !DILexicalBlock(scope: !4916, file: !3, line: 261, column: 38)
!4923 = !DILocation(line: 263, column: 21, scope: !4922)
!4924 = !DILocation(line: 263, column: 26, scope: !4922)
!4925 = !DILocation(line: 263, column: 11, scope: !4922)
!4926 = !DILocation(line: 264, column: 2, scope: !4922)
!4927 = !DILocation(line: 271, column: 6, scope: !4928)
!4928 = distinct !DILexicalBlock(scope: !4157, file: !3, line: 271, column: 6)
!4929 = !DILocation(line: 271, column: 14, scope: !4928)
!4930 = !DILocation(line: 271, column: 6, scope: !4157)
!4931 = !DILocation(line: 272, column: 11, scope: !4928)
!4932 = !DILocation(line: 272, column: 3, scope: !4928)
!4933 = !DILocation(line: 275, column: 2, scope: !4157)
!4934 = !DILocation(line: 275, column: 10, scope: !4157)
!4935 = !DILocation(line: 275, column: 18, scope: !4157)
!4936 = !DILocation(line: 275, column: 23, scope: !4157)
!4937 = !DILocalVariable(name: "cfi", scope: !4655, file: !3, line: 276, type: !4938)
!4938 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4939, size: 64)
!4939 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "cfi_private", file: !4940, line: 273, size: 768, elements: !4941)
!4940 = !DIFile(filename: "./include/linux/mtd/cfi.h", directory: "/home/lizy2001/genbc/linux")
!4941 = !{!4942, !4944, !4945, !4946, !4947, !4948, !4949, !4950, !4951, !4979, !4980, !4981, !4982, !4983, !4984, !4985}
!4942 = !DIDerivedType(tag: DW_TAG_member, name: "cmdset", scope: !4939, file: !4940, line: 274, baseType: !4943, size: 16)
!4943 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint16_t", file: !143, line: 103, baseType: !889)
!4944 = !DIDerivedType(tag: DW_TAG_member, name: "cmdset_priv", scope: !4939, file: !4940, line: 275, baseType: !137, size: 64, offset: 64)
!4945 = !DIDerivedType(tag: DW_TAG_member, name: "interleave", scope: !4939, file: !4940, line: 276, baseType: !169, size: 32, offset: 128)
!4946 = !DIDerivedType(tag: DW_TAG_member, name: "device_type", scope: !4939, file: !4940, line: 277, baseType: !169, size: 32, offset: 160)
!4947 = !DIDerivedType(tag: DW_TAG_member, name: "cfi_mode", scope: !4939, file: !4940, line: 278, baseType: !169, size: 32, offset: 192)
!4948 = !DIDerivedType(tag: DW_TAG_member, name: "addr_unlock1", scope: !4939, file: !4940, line: 279, baseType: !169, size: 32, offset: 224)
!4949 = !DIDerivedType(tag: DW_TAG_member, name: "addr_unlock2", scope: !4939, file: !4940, line: 280, baseType: !169, size: 32, offset: 256)
!4950 = !DIDerivedType(tag: DW_TAG_member, name: "cmdset_setup", scope: !4939, file: !4940, line: 281, baseType: !4085, size: 64, offset: 320)
!4951 = !DIDerivedType(tag: DW_TAG_member, name: "cfiq", scope: !4939, file: !4940, line: 282, baseType: !4952, size: 64, offset: 384)
!4952 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4953, size: 64)
!4953 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "cfi_ident", file: !4940, line: 119, size: 232, elements: !4954)
!4954 = !{!4955, !4957, !4958, !4959, !4960, !4961, !4962, !4963, !4964, !4965, !4966, !4967, !4968, !4969, !4970, !4971, !4972, !4973, !4974, !4975, !4976, !4977}
!4955 = !DIDerivedType(tag: DW_TAG_member, name: "qry", scope: !4953, file: !4940, line: 120, baseType: !4956, size: 24)
!4956 = !DICompositeType(tag: DW_TAG_array_type, baseType: !2798, size: 24, elements: !316)
!4957 = !DIDerivedType(tag: DW_TAG_member, name: "P_ID", scope: !4953, file: !4940, line: 121, baseType: !4943, size: 16, offset: 24)
!4958 = !DIDerivedType(tag: DW_TAG_member, name: "P_ADR", scope: !4953, file: !4940, line: 122, baseType: !4943, size: 16, offset: 40)
!4959 = !DIDerivedType(tag: DW_TAG_member, name: "A_ID", scope: !4953, file: !4940, line: 123, baseType: !4943, size: 16, offset: 56)
!4960 = !DIDerivedType(tag: DW_TAG_member, name: "A_ADR", scope: !4953, file: !4940, line: 124, baseType: !4943, size: 16, offset: 72)
!4961 = !DIDerivedType(tag: DW_TAG_member, name: "VccMin", scope: !4953, file: !4940, line: 125, baseType: !2798, size: 8, offset: 88)
!4962 = !DIDerivedType(tag: DW_TAG_member, name: "VccMax", scope: !4953, file: !4940, line: 126, baseType: !2798, size: 8, offset: 96)
!4963 = !DIDerivedType(tag: DW_TAG_member, name: "VppMin", scope: !4953, file: !4940, line: 127, baseType: !2798, size: 8, offset: 104)
!4964 = !DIDerivedType(tag: DW_TAG_member, name: "VppMax", scope: !4953, file: !4940, line: 128, baseType: !2798, size: 8, offset: 112)
!4965 = !DIDerivedType(tag: DW_TAG_member, name: "WordWriteTimeoutTyp", scope: !4953, file: !4940, line: 129, baseType: !2798, size: 8, offset: 120)
!4966 = !DIDerivedType(tag: DW_TAG_member, name: "BufWriteTimeoutTyp", scope: !4953, file: !4940, line: 130, baseType: !2798, size: 8, offset: 128)
!4967 = !DIDerivedType(tag: DW_TAG_member, name: "BlockEraseTimeoutTyp", scope: !4953, file: !4940, line: 131, baseType: !2798, size: 8, offset: 136)
!4968 = !DIDerivedType(tag: DW_TAG_member, name: "ChipEraseTimeoutTyp", scope: !4953, file: !4940, line: 132, baseType: !2798, size: 8, offset: 144)
!4969 = !DIDerivedType(tag: DW_TAG_member, name: "WordWriteTimeoutMax", scope: !4953, file: !4940, line: 133, baseType: !2798, size: 8, offset: 152)
!4970 = !DIDerivedType(tag: DW_TAG_member, name: "BufWriteTimeoutMax", scope: !4953, file: !4940, line: 134, baseType: !2798, size: 8, offset: 160)
!4971 = !DIDerivedType(tag: DW_TAG_member, name: "BlockEraseTimeoutMax", scope: !4953, file: !4940, line: 135, baseType: !2798, size: 8, offset: 168)
!4972 = !DIDerivedType(tag: DW_TAG_member, name: "ChipEraseTimeoutMax", scope: !4953, file: !4940, line: 136, baseType: !2798, size: 8, offset: 176)
!4973 = !DIDerivedType(tag: DW_TAG_member, name: "DevSize", scope: !4953, file: !4940, line: 137, baseType: !2798, size: 8, offset: 184)
!4974 = !DIDerivedType(tag: DW_TAG_member, name: "InterfaceDesc", scope: !4953, file: !4940, line: 138, baseType: !4943, size: 16, offset: 192)
!4975 = !DIDerivedType(tag: DW_TAG_member, name: "MaxBufWriteSize", scope: !4953, file: !4940, line: 139, baseType: !4943, size: 16, offset: 208)
!4976 = !DIDerivedType(tag: DW_TAG_member, name: "NumEraseRegions", scope: !4953, file: !4940, line: 140, baseType: !2798, size: 8, offset: 224)
!4977 = !DIDerivedType(tag: DW_TAG_member, name: "EraseRegionInfo", scope: !4953, file: !4940, line: 141, baseType: !4978, offset: 232)
!4978 = !DICompositeType(tag: DW_TAG_array_type, baseType: !585, elements: !2394)
!4979 = !DIDerivedType(tag: DW_TAG_member, name: "mfr", scope: !4939, file: !4940, line: 284, baseType: !169, size: 32, offset: 448)
!4980 = !DIDerivedType(tag: DW_TAG_member, name: "id", scope: !4939, file: !4940, line: 284, baseType: !169, size: 32, offset: 480)
!4981 = !DIDerivedType(tag: DW_TAG_member, name: "numchips", scope: !4939, file: !4940, line: 285, baseType: !169, size: 32, offset: 512)
!4982 = !DIDerivedType(tag: DW_TAG_member, name: "sector_erase_cmd", scope: !4939, file: !4940, line: 286, baseType: !175, size: 64, offset: 576)
!4983 = !DIDerivedType(tag: DW_TAG_member, name: "chipshift", scope: !4939, file: !4940, line: 287, baseType: !157, size: 64, offset: 640)
!4984 = !DIDerivedType(tag: DW_TAG_member, name: "im_name", scope: !4939, file: !4940, line: 288, baseType: !153, size: 64, offset: 704)
!4985 = !DIDerivedType(tag: DW_TAG_member, name: "chips", scope: !4939, file: !4940, line: 289, baseType: !4986, offset: 768)
!4986 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4987, elements: !2394)
!4987 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "flchip", file: !99, line: 57, size: 896, elements: !4988)
!4988 = !{!4989, !4990, !4991, !4993, !4994, !4995, !4996, !4997, !4998, !4999, !5000, !5001, !5002, !5003, !5004, !5005, !5006}
!4989 = !DIDerivedType(tag: DW_TAG_member, name: "start", scope: !4987, file: !99, line: 58, baseType: !157, size: 64)
!4990 = !DIDerivedType(tag: DW_TAG_member, name: "ref_point_counter", scope: !4987, file: !99, line: 67, baseType: !169, size: 32, offset: 64)
!4991 = !DIDerivedType(tag: DW_TAG_member, name: "state", scope: !4987, file: !99, line: 68, baseType: !4992, size: 32, offset: 96)
!4992 = !DIDerivedType(tag: DW_TAG_typedef, name: "flstate_t", file: !99, line: 49, baseType: !98)
!4993 = !DIDerivedType(tag: DW_TAG_member, name: "oldstate", scope: !4987, file: !99, line: 69, baseType: !4992, size: 32, offset: 128)
!4994 = !DIDerivedType(tag: DW_TAG_member, name: "write_suspended", scope: !4987, file: !99, line: 71, baseType: !7, size: 1, offset: 160, flags: DIFlagBitField, extraData: i64 160)
!4995 = !DIDerivedType(tag: DW_TAG_member, name: "erase_suspended", scope: !4987, file: !99, line: 72, baseType: !7, size: 1, offset: 161, flags: DIFlagBitField, extraData: i64 160)
!4996 = !DIDerivedType(tag: DW_TAG_member, name: "in_progress_block_addr", scope: !4987, file: !99, line: 73, baseType: !157, size: 64, offset: 192)
!4997 = !DIDerivedType(tag: DW_TAG_member, name: "in_progress_block_mask", scope: !4987, file: !99, line: 74, baseType: !157, size: 64, offset: 256)
!4998 = !DIDerivedType(tag: DW_TAG_member, name: "mutex", scope: !4987, file: !99, line: 76, baseType: !1242, size: 192, offset: 320)
!4999 = !DIDerivedType(tag: DW_TAG_member, name: "wq", scope: !4987, file: !99, line: 77, baseType: !1547, size: 128, offset: 512)
!5000 = !DIDerivedType(tag: DW_TAG_member, name: "word_write_time", scope: !4987, file: !99, line: 79, baseType: !169, size: 32, offset: 640)
!5001 = !DIDerivedType(tag: DW_TAG_member, name: "buffer_write_time", scope: !4987, file: !99, line: 80, baseType: !169, size: 32, offset: 672)
!5002 = !DIDerivedType(tag: DW_TAG_member, name: "erase_time", scope: !4987, file: !99, line: 81, baseType: !169, size: 32, offset: 704)
!5003 = !DIDerivedType(tag: DW_TAG_member, name: "word_write_time_max", scope: !4987, file: !99, line: 83, baseType: !169, size: 32, offset: 736)
!5004 = !DIDerivedType(tag: DW_TAG_member, name: "buffer_write_time_max", scope: !4987, file: !99, line: 84, baseType: !169, size: 32, offset: 768)
!5005 = !DIDerivedType(tag: DW_TAG_member, name: "erase_time_max", scope: !4987, file: !99, line: 85, baseType: !169, size: 32, offset: 800)
!5006 = !DIDerivedType(tag: DW_TAG_member, name: "priv", scope: !4987, file: !99, line: 87, baseType: !137, size: 64, offset: 832)
!5007 = !DILocation(line: 276, column: 23, scope: !4655)
!5008 = !DILocalVariable(name: "offset", scope: !4655, file: !3, line: 277, type: !157)
!5009 = !DILocation(line: 277, column: 17, scope: !4655)
!5010 = !DILocalVariable(name: "i", scope: !4655, file: !3, line: 278, type: !169)
!5011 = !DILocation(line: 278, column: 7, scope: !4655)
!5012 = !DILocation(line: 280, column: 8, scope: !4654)
!5013 = !DILocation(line: 280, column: 7, scope: !4655)
!5014 = !DILocation(line: 540, column: 27, scope: !4649, inlinedAt: !4653)
!5015 = !DILocation(line: 540, column: 6, scope: !4649, inlinedAt: !4653)
!5016 = !DILocation(line: 540, column: 6, scope: !4650, inlinedAt: !4653)
!5017 = !DILocation(line: 544, column: 7, scope: !4682, inlinedAt: !4653)
!5018 = !DILocation(line: 544, column: 12, scope: !4682, inlinedAt: !4653)
!5019 = !DILocation(line: 544, column: 7, scope: !4648, inlinedAt: !4653)
!5020 = !DILocation(line: 545, column: 25, scope: !4682, inlinedAt: !4653)
!5021 = !DILocation(line: 545, column: 31, scope: !4682, inlinedAt: !4653)
!5022 = !DILocation(line: 480, column: 33, scope: !4680, inlinedAt: !4681)
!5023 = !DILocation(line: 480, column: 23, scope: !4680, inlinedAt: !4681)
!5024 = !DILocation(line: 481, column: 29, scope: !4680, inlinedAt: !4681)
!5025 = !DILocation(line: 481, column: 35, scope: !4680, inlinedAt: !4681)
!5026 = !DILocation(line: 481, column: 42, scope: !4680, inlinedAt: !4681)
!5027 = !DILocation(line: 474, column: 23, scope: !4675, inlinedAt: !4679)
!5028 = !DILocation(line: 474, column: 29, scope: !4675, inlinedAt: !4679)
!5029 = !DILocation(line: 474, column: 36, scope: !4675, inlinedAt: !4679)
!5030 = !DILocation(line: 474, column: 9, scope: !4675, inlinedAt: !4679)
!5031 = !DILocation(line: 545, column: 4, scope: !4682, inlinedAt: !4653)
!5032 = !DILocation(line: 547, column: 25, scope: !4648, inlinedAt: !4653)
!5033 = !DILocation(line: 348, column: 7, scope: !5034, inlinedAt: !4673)
!5034 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 348, column: 6)
!5035 = !DILocation(line: 348, column: 6, scope: !4669, inlinedAt: !4673)
!5036 = !DILocation(line: 349, column: 3, scope: !5034, inlinedAt: !4673)
!5037 = !DILocation(line: 351, column: 6, scope: !5038, inlinedAt: !4673)
!5038 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 351, column: 6)
!5039 = !DILocation(line: 351, column: 11, scope: !5038, inlinedAt: !4673)
!5040 = !DILocation(line: 351, column: 6, scope: !4669, inlinedAt: !4673)
!5041 = !DILocation(line: 352, column: 3, scope: !5038, inlinedAt: !4673)
!5042 = !DILocation(line: 354, column: 32, scope: !5043, inlinedAt: !4673)
!5043 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 354, column: 6)
!5044 = !DILocation(line: 354, column: 37, scope: !5043, inlinedAt: !4673)
!5045 = !DILocation(line: 354, column: 42, scope: !5043, inlinedAt: !4673)
!5046 = !DILocation(line: 354, column: 45, scope: !5043, inlinedAt: !4673)
!5047 = !DILocation(line: 354, column: 50, scope: !5043, inlinedAt: !4673)
!5048 = !DILocation(line: 354, column: 6, scope: !4669, inlinedAt: !4673)
!5049 = !DILocation(line: 355, column: 3, scope: !5043, inlinedAt: !4673)
!5050 = !DILocation(line: 356, column: 32, scope: !5051, inlinedAt: !4673)
!5051 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 356, column: 6)
!5052 = !DILocation(line: 356, column: 37, scope: !5051, inlinedAt: !4673)
!5053 = !DILocation(line: 356, column: 43, scope: !5051, inlinedAt: !4673)
!5054 = !DILocation(line: 356, column: 46, scope: !5051, inlinedAt: !4673)
!5055 = !DILocation(line: 356, column: 51, scope: !5051, inlinedAt: !4673)
!5056 = !DILocation(line: 356, column: 6, scope: !4669, inlinedAt: !4673)
!5057 = !DILocation(line: 357, column: 3, scope: !5051, inlinedAt: !4673)
!5058 = !DILocation(line: 358, column: 6, scope: !5059, inlinedAt: !4673)
!5059 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 358, column: 6)
!5060 = !DILocation(line: 358, column: 11, scope: !5059, inlinedAt: !4673)
!5061 = !DILocation(line: 358, column: 6, scope: !4669, inlinedAt: !4673)
!5062 = !DILocation(line: 358, column: 26, scope: !5059, inlinedAt: !4673)
!5063 = !DILocation(line: 359, column: 6, scope: !5064, inlinedAt: !4673)
!5064 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 359, column: 6)
!5065 = !DILocation(line: 359, column: 11, scope: !5064, inlinedAt: !4673)
!5066 = !DILocation(line: 359, column: 6, scope: !4669, inlinedAt: !4673)
!5067 = !DILocation(line: 359, column: 26, scope: !5064, inlinedAt: !4673)
!5068 = !DILocation(line: 360, column: 6, scope: !5069, inlinedAt: !4673)
!5069 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 360, column: 6)
!5070 = !DILocation(line: 360, column: 11, scope: !5069, inlinedAt: !4673)
!5071 = !DILocation(line: 360, column: 6, scope: !4669, inlinedAt: !4673)
!5072 = !DILocation(line: 360, column: 26, scope: !5069, inlinedAt: !4673)
!5073 = !DILocation(line: 361, column: 6, scope: !5074, inlinedAt: !4673)
!5074 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 361, column: 6)
!5075 = !DILocation(line: 361, column: 11, scope: !5074, inlinedAt: !4673)
!5076 = !DILocation(line: 361, column: 6, scope: !4669, inlinedAt: !4673)
!5077 = !DILocation(line: 361, column: 26, scope: !5074, inlinedAt: !4673)
!5078 = !DILocation(line: 362, column: 6, scope: !5079, inlinedAt: !4673)
!5079 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 362, column: 6)
!5080 = !DILocation(line: 362, column: 11, scope: !5079, inlinedAt: !4673)
!5081 = !DILocation(line: 362, column: 6, scope: !4669, inlinedAt: !4673)
!5082 = !DILocation(line: 362, column: 26, scope: !5079, inlinedAt: !4673)
!5083 = !DILocation(line: 363, column: 6, scope: !5084, inlinedAt: !4673)
!5084 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 363, column: 6)
!5085 = !DILocation(line: 363, column: 11, scope: !5084, inlinedAt: !4673)
!5086 = !DILocation(line: 363, column: 6, scope: !4669, inlinedAt: !4673)
!5087 = !DILocation(line: 363, column: 26, scope: !5084, inlinedAt: !4673)
!5088 = !DILocation(line: 364, column: 6, scope: !5089, inlinedAt: !4673)
!5089 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 364, column: 6)
!5090 = !DILocation(line: 364, column: 11, scope: !5089, inlinedAt: !4673)
!5091 = !DILocation(line: 364, column: 6, scope: !4669, inlinedAt: !4673)
!5092 = !DILocation(line: 364, column: 26, scope: !5089, inlinedAt: !4673)
!5093 = !DILocation(line: 365, column: 6, scope: !5094, inlinedAt: !4673)
!5094 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 365, column: 6)
!5095 = !DILocation(line: 365, column: 11, scope: !5094, inlinedAt: !4673)
!5096 = !DILocation(line: 365, column: 6, scope: !4669, inlinedAt: !4673)
!5097 = !DILocation(line: 365, column: 26, scope: !5094, inlinedAt: !4673)
!5098 = !DILocation(line: 366, column: 6, scope: !5099, inlinedAt: !4673)
!5099 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 366, column: 6)
!5100 = !DILocation(line: 366, column: 11, scope: !5099, inlinedAt: !4673)
!5101 = !DILocation(line: 366, column: 6, scope: !4669, inlinedAt: !4673)
!5102 = !DILocation(line: 366, column: 26, scope: !5099, inlinedAt: !4673)
!5103 = !DILocation(line: 367, column: 6, scope: !5104, inlinedAt: !4673)
!5104 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 367, column: 6)
!5105 = !DILocation(line: 367, column: 11, scope: !5104, inlinedAt: !4673)
!5106 = !DILocation(line: 367, column: 6, scope: !4669, inlinedAt: !4673)
!5107 = !DILocation(line: 367, column: 26, scope: !5104, inlinedAt: !4673)
!5108 = !DILocation(line: 368, column: 6, scope: !5109, inlinedAt: !4673)
!5109 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 368, column: 6)
!5110 = !DILocation(line: 368, column: 11, scope: !5109, inlinedAt: !4673)
!5111 = !DILocation(line: 368, column: 6, scope: !4669, inlinedAt: !4673)
!5112 = !DILocation(line: 368, column: 26, scope: !5109, inlinedAt: !4673)
!5113 = !DILocation(line: 369, column: 6, scope: !5114, inlinedAt: !4673)
!5114 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 369, column: 6)
!5115 = !DILocation(line: 369, column: 11, scope: !5114, inlinedAt: !4673)
!5116 = !DILocation(line: 369, column: 6, scope: !4669, inlinedAt: !4673)
!5117 = !DILocation(line: 369, column: 26, scope: !5114, inlinedAt: !4673)
!5118 = !DILocation(line: 370, column: 6, scope: !5119, inlinedAt: !4673)
!5119 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 370, column: 6)
!5120 = !DILocation(line: 370, column: 11, scope: !5119, inlinedAt: !4673)
!5121 = !DILocation(line: 370, column: 6, scope: !4669, inlinedAt: !4673)
!5122 = !DILocation(line: 370, column: 26, scope: !5119, inlinedAt: !4673)
!5123 = !DILocation(line: 371, column: 6, scope: !5124, inlinedAt: !4673)
!5124 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 371, column: 6)
!5125 = !DILocation(line: 371, column: 11, scope: !5124, inlinedAt: !4673)
!5126 = !DILocation(line: 371, column: 6, scope: !4669, inlinedAt: !4673)
!5127 = !DILocation(line: 371, column: 26, scope: !5124, inlinedAt: !4673)
!5128 = !DILocation(line: 372, column: 6, scope: !5129, inlinedAt: !4673)
!5129 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 372, column: 6)
!5130 = !DILocation(line: 372, column: 11, scope: !5129, inlinedAt: !4673)
!5131 = !DILocation(line: 372, column: 6, scope: !4669, inlinedAt: !4673)
!5132 = !DILocation(line: 372, column: 26, scope: !5129, inlinedAt: !4673)
!5133 = !DILocation(line: 373, column: 6, scope: !5134, inlinedAt: !4673)
!5134 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 373, column: 6)
!5135 = !DILocation(line: 373, column: 11, scope: !5134, inlinedAt: !4673)
!5136 = !DILocation(line: 373, column: 6, scope: !4669, inlinedAt: !4673)
!5137 = !DILocation(line: 373, column: 26, scope: !5134, inlinedAt: !4673)
!5138 = !DILocation(line: 374, column: 6, scope: !5139, inlinedAt: !4673)
!5139 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 374, column: 6)
!5140 = !DILocation(line: 374, column: 11, scope: !5139, inlinedAt: !4673)
!5141 = !DILocation(line: 374, column: 6, scope: !4669, inlinedAt: !4673)
!5142 = !DILocation(line: 374, column: 26, scope: !5139, inlinedAt: !4673)
!5143 = !DILocation(line: 375, column: 6, scope: !5144, inlinedAt: !4673)
!5144 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 375, column: 6)
!5145 = !DILocation(line: 375, column: 11, scope: !5144, inlinedAt: !4673)
!5146 = !DILocation(line: 375, column: 6, scope: !4669, inlinedAt: !4673)
!5147 = !DILocation(line: 375, column: 27, scope: !5144, inlinedAt: !4673)
!5148 = !DILocation(line: 376, column: 6, scope: !5149, inlinedAt: !4673)
!5149 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 376, column: 6)
!5150 = !DILocation(line: 376, column: 11, scope: !5149, inlinedAt: !4673)
!5151 = !DILocation(line: 376, column: 6, scope: !4669, inlinedAt: !4673)
!5152 = !DILocation(line: 376, column: 32, scope: !5149, inlinedAt: !4673)
!5153 = !DILocation(line: 377, column: 6, scope: !5154, inlinedAt: !4673)
!5154 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 377, column: 6)
!5155 = !DILocation(line: 377, column: 11, scope: !5154, inlinedAt: !4673)
!5156 = !DILocation(line: 377, column: 6, scope: !4669, inlinedAt: !4673)
!5157 = !DILocation(line: 377, column: 32, scope: !5154, inlinedAt: !4673)
!5158 = !DILocation(line: 378, column: 6, scope: !5159, inlinedAt: !4673)
!5159 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 378, column: 6)
!5160 = !DILocation(line: 378, column: 11, scope: !5159, inlinedAt: !4673)
!5161 = !DILocation(line: 378, column: 6, scope: !4669, inlinedAt: !4673)
!5162 = !DILocation(line: 378, column: 32, scope: !5159, inlinedAt: !4673)
!5163 = !DILocation(line: 379, column: 6, scope: !5164, inlinedAt: !4673)
!5164 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 379, column: 6)
!5165 = !DILocation(line: 379, column: 11, scope: !5164, inlinedAt: !4673)
!5166 = !DILocation(line: 379, column: 6, scope: !4669, inlinedAt: !4673)
!5167 = !DILocation(line: 379, column: 33, scope: !5164, inlinedAt: !4673)
!5168 = !DILocation(line: 380, column: 6, scope: !5169, inlinedAt: !4673)
!5169 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 380, column: 6)
!5170 = !DILocation(line: 380, column: 11, scope: !5169, inlinedAt: !4673)
!5171 = !DILocation(line: 380, column: 6, scope: !4669, inlinedAt: !4673)
!5172 = !DILocation(line: 380, column: 33, scope: !5169, inlinedAt: !4673)
!5173 = !DILocation(line: 381, column: 6, scope: !5174, inlinedAt: !4673)
!5174 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 381, column: 6)
!5175 = !DILocation(line: 381, column: 11, scope: !5174, inlinedAt: !4673)
!5176 = !DILocation(line: 381, column: 6, scope: !4669, inlinedAt: !4673)
!5177 = !DILocation(line: 381, column: 33, scope: !5174, inlinedAt: !4673)
!5178 = !DILocation(line: 382, column: 2, scope: !5179, inlinedAt: !4673)
!5179 = distinct !DILexicalBlock(scope: !5180, file: !130, line: 382, column: 2)
!5180 = distinct !DILexicalBlock(scope: !4669, file: !130, line: 382, column: 2)
!5181 = !{i32 -2144234689, i32 -2144234660, i32 -2144234614, i32 -2144234556, i32 -2144234502, i32 -2144234448, i32 -2144234393, i32 -2144234362}
!5182 = !DILocation(line: 382, column: 2, scope: !5183, inlinedAt: !4673)
!5183 = distinct !DILexicalBlock(scope: !5184, file: !130, line: 382, column: 2)
!5184 = distinct !DILexicalBlock(scope: !5180, file: !130, line: 382, column: 2)
!5185 = !{i32 -2144233919, i32 -2144233912, i32 -2144233858, i32 -2144233827, i32 -2144233797}
!5186 = !DILocation(line: 382, column: 2, scope: !5184, inlinedAt: !4673)
!5187 = !DILocation(line: 386, column: 1, scope: !4669, inlinedAt: !4673)
!5188 = !DILocation(line: 547, column: 9, scope: !4648, inlinedAt: !4653)
!5189 = !DILocation(line: 549, column: 8, scope: !5190, inlinedAt: !4653)
!5190 = distinct !DILexicalBlock(scope: !4648, file: !130, line: 549, column: 7)
!5191 = !DILocation(line: 549, column: 7, scope: !4648, inlinedAt: !4653)
!5192 = !DILocation(line: 550, column: 4, scope: !5190, inlinedAt: !4653)
!5193 = !DILocation(line: 553, column: 33, scope: !4648, inlinedAt: !4653)
!5194 = !DILocation(line: 325, column: 6, scope: !5195, inlinedAt: !4667)
!5195 = distinct !DILexicalBlock(scope: !4663, file: !130, line: 325, column: 6)
!5196 = !DILocation(line: 325, column: 6, scope: !4663, inlinedAt: !4667)
!5197 = !DILocation(line: 326, column: 3, scope: !5195, inlinedAt: !4667)
!5198 = !DILocation(line: 332, column: 9, scope: !4663, inlinedAt: !4667)
!5199 = !DILocation(line: 332, column: 15, scope: !4663, inlinedAt: !4667)
!5200 = !DILocation(line: 332, column: 2, scope: !4663, inlinedAt: !4667)
!5201 = !DILocation(line: 336, column: 1, scope: !4663, inlinedAt: !4667)
!5202 = !DILocation(line: 553, column: 5, scope: !4648, inlinedAt: !4653)
!5203 = !DILocation(line: 553, column: 41, scope: !4648, inlinedAt: !4653)
!5204 = !DILocation(line: 554, column: 5, scope: !4648, inlinedAt: !4653)
!5205 = !DILocation(line: 554, column: 12, scope: !4648, inlinedAt: !4653)
!5206 = !DILocation(line: 448, column: 31, scope: !4643, inlinedAt: !4647)
!5207 = !DILocation(line: 448, column: 34, scope: !4643, inlinedAt: !4647)
!5208 = !DILocation(line: 448, column: 14, scope: !4643, inlinedAt: !4647)
!5209 = !DILocation(line: 450, column: 22, scope: !4643, inlinedAt: !4647)
!5210 = !DILocation(line: 450, column: 25, scope: !4643, inlinedAt: !4647)
!5211 = !DILocation(line: 450, column: 30, scope: !4643, inlinedAt: !4647)
!5212 = !DILocation(line: 450, column: 36, scope: !4643, inlinedAt: !4647)
!5213 = !DILocation(line: 450, column: 8, scope: !4643, inlinedAt: !4647)
!5214 = !DILocation(line: 450, column: 6, scope: !4643, inlinedAt: !4647)
!5215 = !DILocation(line: 451, column: 9, scope: !4643, inlinedAt: !4647)
!5216 = !DILocation(line: 552, column: 3, scope: !4648, inlinedAt: !4653)
!5217 = !DILocation(line: 557, column: 19, scope: !4650, inlinedAt: !4653)
!5218 = !DILocation(line: 557, column: 25, scope: !4650, inlinedAt: !4653)
!5219 = !DILocation(line: 557, column: 9, scope: !4650, inlinedAt: !4653)
!5220 = !DILocation(line: 557, column: 2, scope: !4650, inlinedAt: !4653)
!5221 = !DILocation(line: 558, column: 1, scope: !4650, inlinedAt: !4653)
!5222 = !DILocation(line: 281, column: 10, scope: !4654)
!5223 = !DILocation(line: 281, column: 8, scope: !4654)
!5224 = !DILocation(line: 281, column: 4, scope: !4654)
!5225 = !DILocation(line: 282, column: 8, scope: !5226)
!5226 = distinct !DILexicalBlock(scope: !4655, file: !3, line: 282, column: 7)
!5227 = !DILocation(line: 282, column: 7, scope: !4655)
!5228 = !DILocation(line: 283, column: 4, scope: !5229)
!5229 = distinct !DILexicalBlock(scope: !5226, file: !3, line: 282, column: 13)
!5230 = !DILocation(line: 284, column: 4, scope: !5229)
!5231 = !DILocation(line: 286, column: 10, scope: !4655)
!5232 = !DILocation(line: 286, column: 3, scope: !4655)
!5233 = !DILocation(line: 287, column: 19, scope: !4655)
!5234 = !DILocation(line: 287, column: 24, scope: !4655)
!5235 = !DILocation(line: 287, column: 3, scope: !4655)
!5236 = !DILocation(line: 288, column: 19, scope: !4655)
!5237 = !DILocation(line: 288, column: 24, scope: !4655)
!5238 = !DILocation(line: 288, column: 3, scope: !4655)
!5239 = !DILocation(line: 288, column: 8, scope: !4655)
!5240 = !DILocation(line: 288, column: 12, scope: !4655)
!5241 = !DILocation(line: 288, column: 17, scope: !4655)
!5242 = !DILocation(line: 289, column: 19, scope: !4655)
!5243 = !DILocation(line: 289, column: 3, scope: !4655)
!5244 = !DILocation(line: 289, column: 8, scope: !4655)
!5245 = !DILocation(line: 289, column: 12, scope: !4655)
!5246 = !DILocation(line: 289, column: 17, scope: !4655)
!5247 = !DILocation(line: 290, column: 12, scope: !4655)
!5248 = !DILocation(line: 290, column: 22, scope: !4655)
!5249 = !DILocation(line: 290, column: 30, scope: !4655)
!5250 = !DILocation(line: 290, column: 20, scope: !4655)
!5251 = !DILocation(line: 290, column: 10, scope: !4655)
!5252 = !DILocation(line: 292, column: 22, scope: !4655)
!5253 = !DILocation(line: 292, column: 30, scope: !4655)
!5254 = !DILocation(line: 292, column: 6, scope: !4655)
!5255 = !DILocation(line: 292, column: 39, scope: !4655)
!5256 = !DILocation(line: 292, column: 37, scope: !4655)
!5257 = !DILocation(line: 291, column: 19, scope: !4655)
!5258 = !DILocation(line: 291, column: 3, scope: !4655)
!5259 = !DILocation(line: 291, column: 8, scope: !4655)
!5260 = !DILocation(line: 291, column: 12, scope: !4655)
!5261 = !DILocation(line: 291, column: 17, scope: !4655)
!5262 = !DILocation(line: 293, column: 34, scope: !4655)
!5263 = !DILocation(line: 293, column: 32, scope: !4655)
!5264 = !DILocation(line: 293, column: 42, scope: !4655)
!5265 = !DILocation(line: 293, column: 3, scope: !4655)
!5266 = !DILocation(line: 293, column: 8, scope: !4655)
!5267 = !DILocation(line: 293, column: 12, scope: !4655)
!5268 = !DILocation(line: 293, column: 17, scope: !4655)
!5269 = !DILocation(line: 295, column: 11, scope: !4655)
!5270 = !DILocation(line: 295, column: 16, scope: !4655)
!5271 = !DILocation(line: 296, column: 34, scope: !4655)
!5272 = !DILocation(line: 296, column: 39, scope: !4655)
!5273 = !DILocation(line: 296, column: 43, scope: !4655)
!5274 = !DILocation(line: 295, column: 3, scope: !4655)
!5275 = !DILocation(line: 302, column: 7, scope: !5276)
!5276 = distinct !DILexicalBlock(scope: !4655, file: !3, line: 302, column: 3)
!5277 = !DILocation(line: 302, column: 12, scope: !5276)
!5278 = !DILocation(line: 302, column: 16, scope: !5276)
!5279 = !DILocation(line: 302, column: 26, scope: !5276)
!5280 = !DILocation(line: 302, column: 32, scope: !5281)
!5281 = distinct !DILexicalBlock(scope: !5276, file: !3, line: 302, column: 3)
!5282 = !DILocation(line: 302, column: 37, scope: !5281)
!5283 = !DILocation(line: 302, column: 41, scope: !5281)
!5284 = !DILocation(line: 302, column: 3, scope: !5276)
!5285 = !DILocalVariable(name: "probe_type", scope: !5286, file: !3, line: 304, type: !5287)
!5286 = distinct !DILexicalBlock(scope: !5281, file: !3, line: 303, column: 30)
!5287 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !315, size: 64)
!5288 = !DILocation(line: 304, column: 11, scope: !5286)
!5289 = !DILocation(line: 306, column: 33, scope: !5290)
!5290 = distinct !DILexicalBlock(scope: !5286, file: !3, line: 306, column: 8)
!5291 = !DILocation(line: 306, column: 38, scope: !5290)
!5292 = !DILocation(line: 306, column: 42, scope: !5290)
!5293 = !DILocation(line: 306, column: 9, scope: !5290)
!5294 = !DILocation(line: 306, column: 8, scope: !5286)
!5295 = !DILocation(line: 307, column: 5, scope: !5290)
!5296 = !DILocation(line: 310, column: 21, scope: !5286)
!5297 = !DILocation(line: 310, column: 26, scope: !5286)
!5298 = !DILocation(line: 310, column: 4, scope: !5286)
!5299 = !DILocation(line: 313, column: 15, scope: !5286)
!5300 = !DILocation(line: 314, column: 4, scope: !5286)
!5301 = !DILocation(line: 314, column: 11, scope: !5302)
!5302 = distinct !DILexicalBlock(scope: !5303, file: !3, line: 314, column: 4)
!5303 = distinct !DILexicalBlock(scope: !5286, file: !3, line: 314, column: 4)
!5304 = !DILocation(line: 314, column: 10, scope: !5302)
!5305 = !DILocation(line: 314, column: 4, scope: !5303)
!5306 = !DILocation(line: 315, column: 30, scope: !5307)
!5307 = distinct !DILexicalBlock(scope: !5302, file: !3, line: 314, column: 37)
!5308 = !DILocation(line: 315, column: 29, scope: !5307)
!5309 = !DILocation(line: 315, column: 43, scope: !5307)
!5310 = !DILocation(line: 315, column: 48, scope: !5307)
!5311 = !DILocation(line: 315, column: 16, scope: !5307)
!5312 = !DILocation(line: 315, column: 5, scope: !5307)
!5313 = !DILocation(line: 315, column: 10, scope: !5307)
!5314 = !DILocation(line: 315, column: 14, scope: !5307)
!5315 = !DILocation(line: 316, column: 9, scope: !5316)
!5316 = distinct !DILexicalBlock(scope: !5307, file: !3, line: 316, column: 9)
!5317 = !DILocation(line: 316, column: 14, scope: !5316)
!5318 = !DILocation(line: 316, column: 9, scope: !5307)
!5319 = !DILocation(line: 317, column: 6, scope: !5316)
!5320 = !DILocation(line: 318, column: 4, scope: !5307)
!5321 = !DILocation(line: 314, column: 33, scope: !5302)
!5322 = !DILocation(line: 314, column: 4, scope: !5302)
!5323 = distinct !{!5323, !5305, !5324}
!5324 = !DILocation(line: 318, column: 4, scope: !5303)
!5325 = !DILocation(line: 319, column: 3, scope: !5286)
!5326 = !DILocation(line: 303, column: 4, scope: !5281)
!5327 = !DILocation(line: 303, column: 9, scope: !5281)
!5328 = !DILocation(line: 303, column: 13, scope: !5281)
!5329 = !DILocation(line: 303, column: 23, scope: !5281)
!5330 = !DILocation(line: 302, column: 3, scope: !5281)
!5331 = distinct !{!5331, !5284, !5332}
!5332 = !DILocation(line: 319, column: 3, scope: !5276)
!5333 = !DILocation(line: 320, column: 11, scope: !4655)
!5334 = !DILocation(line: 321, column: 3, scope: !4655)
!5335 = distinct !{!5335, !4933, !5336}
!5336 = !DILocation(line: 368, column: 2, scope: !4157)
!5337 = !DILabel(scope: !4655, name: "found", file: !3, line: 322)
!5338 = !DILocation(line: 322, column: 2, scope: !4655)
!5339 = !DILocation(line: 324, column: 7, scope: !5340)
!5340 = distinct !DILexicalBlock(scope: !4655, file: !3, line: 324, column: 7)
!5341 = !DILocation(line: 324, column: 12, scope: !5340)
!5342 = !DILocation(line: 324, column: 17, scope: !5340)
!5343 = !DILocation(line: 324, column: 24, scope: !5340)
!5344 = !DILocation(line: 324, column: 29, scope: !5340)
!5345 = !DILocation(line: 324, column: 33, scope: !5340)
!5346 = !DILocation(line: 324, column: 22, scope: !5340)
!5347 = !DILocation(line: 324, column: 7, scope: !4655)
!5348 = !DILocation(line: 327, column: 25, scope: !5349)
!5349 = distinct !DILexicalBlock(scope: !5340, file: !3, line: 324, column: 39)
!5350 = !DILocation(line: 327, column: 30, scope: !5349)
!5351 = !DILocation(line: 327, column: 35, scope: !5349)
!5352 = !DILocation(line: 327, column: 41, scope: !5349)
!5353 = !DILocation(line: 327, column: 46, scope: !5349)
!5354 = !DILocation(line: 327, column: 50, scope: !5349)
!5355 = !DILocation(line: 325, column: 4, scope: !5349)
!5356 = !DILocation(line: 328, column: 21, scope: !5349)
!5357 = !DILocation(line: 328, column: 26, scope: !5349)
!5358 = !DILocation(line: 328, column: 30, scope: !5349)
!5359 = !DILocation(line: 328, column: 4, scope: !5349)
!5360 = !DILocation(line: 328, column: 9, scope: !5349)
!5361 = !DILocation(line: 328, column: 14, scope: !5349)
!5362 = !DILocation(line: 328, column: 19, scope: !5349)
!5363 = !DILocation(line: 329, column: 3, scope: !5349)
!5364 = !DILocation(line: 330, column: 7, scope: !5365)
!5365 = distinct !DILexicalBlock(scope: !4655, file: !3, line: 330, column: 7)
!5366 = !DILocation(line: 330, column: 15, scope: !5365)
!5367 = !DILocation(line: 330, column: 20, scope: !5365)
!5368 = !DILocation(line: 330, column: 7, scope: !4655)
!5369 = !DILocation(line: 336, column: 22, scope: !5370)
!5370 = distinct !DILexicalBlock(scope: !5365, file: !3, line: 330, column: 28)
!5371 = !DILocation(line: 336, column: 27, scope: !5370)
!5372 = !DILocation(line: 336, column: 4, scope: !5370)
!5373 = !DILocation(line: 336, column: 9, scope: !5370)
!5374 = !DILocation(line: 336, column: 14, scope: !5370)
!5375 = !DILocation(line: 336, column: 20, scope: !5370)
!5376 = !DILocation(line: 337, column: 22, scope: !5370)
!5377 = !DILocation(line: 337, column: 27, scope: !5370)
!5378 = !DILocation(line: 337, column: 31, scope: !5370)
!5379 = !DILocation(line: 337, column: 4, scope: !5370)
!5380 = !DILocation(line: 337, column: 9, scope: !5370)
!5381 = !DILocation(line: 337, column: 14, scope: !5370)
!5382 = !DILocation(line: 337, column: 20, scope: !5370)
!5383 = !DILocation(line: 338, column: 22, scope: !5370)
!5384 = !DILocation(line: 338, column: 27, scope: !5370)
!5385 = !DILocation(line: 338, column: 31, scope: !5370)
!5386 = !DILocation(line: 338, column: 38, scope: !5370)
!5387 = !DILocation(line: 338, column: 43, scope: !5370)
!5388 = !DILocation(line: 338, column: 48, scope: !5370)
!5389 = !DILocation(line: 338, column: 36, scope: !5370)
!5390 = !DILocation(line: 338, column: 53, scope: !5370)
!5391 = !DILocation(line: 338, column: 4, scope: !5370)
!5392 = !DILocation(line: 338, column: 9, scope: !5370)
!5393 = !DILocation(line: 338, column: 14, scope: !5370)
!5394 = !DILocation(line: 338, column: 20, scope: !5370)
!5395 = !DILocation(line: 339, column: 4, scope: !5370)
!5396 = !DILocation(line: 339, column: 9, scope: !5370)
!5397 = !DILocation(line: 339, column: 14, scope: !5370)
!5398 = !DILocation(line: 339, column: 20, scope: !5370)
!5399 = !DILocation(line: 340, column: 26, scope: !5400)
!5400 = distinct !DILexicalBlock(scope: !5370, file: !3, line: 340, column: 8)
!5401 = !DILocation(line: 340, column: 34, scope: !5400)
!5402 = !DILocation(line: 340, column: 41, scope: !5400)
!5403 = !DILocation(line: 340, column: 46, scope: !5400)
!5404 = !DILocation(line: 340, column: 8, scope: !5400)
!5405 = !DILocation(line: 340, column: 8, scope: !5370)
!5406 = !DILocation(line: 341, column: 5, scope: !5407)
!5407 = distinct !DILexicalBlock(scope: !5400, file: !3, line: 340, column: 53)
!5408 = !DILocation(line: 343, column: 5, scope: !5407)
!5409 = !DILocation(line: 343, column: 10, scope: !5407)
!5410 = !DILocation(line: 343, column: 15, scope: !5407)
!5411 = !DILocation(line: 343, column: 22, scope: !5407)
!5412 = !DILocation(line: 344, column: 4, scope: !5407)
!5413 = !DILocation(line: 345, column: 3, scope: !5370)
!5414 = !DILocation(line: 348, column: 19, scope: !4655)
!5415 = !DILocation(line: 348, column: 27, scope: !4655)
!5416 = !DILocation(line: 348, column: 3, scope: !4655)
!5417 = !DILocation(line: 348, column: 8, scope: !4655)
!5418 = !DILocation(line: 348, column: 12, scope: !4655)
!5419 = !DILocation(line: 348, column: 17, scope: !4655)
!5420 = !DILocation(line: 349, column: 19, scope: !4655)
!5421 = !DILocation(line: 349, column: 27, scope: !4655)
!5422 = !DILocation(line: 349, column: 3, scope: !4655)
!5423 = !DILocation(line: 349, column: 8, scope: !4655)
!5424 = !DILocation(line: 349, column: 12, scope: !4655)
!5425 = !DILocation(line: 349, column: 17, scope: !4655)
!5426 = !DILocation(line: 350, column: 9, scope: !4655)
!5427 = !DILocation(line: 350, column: 14, scope: !4655)
!5428 = !DILocation(line: 350, column: 18, scope: !4655)
!5429 = !DILocation(line: 350, column: 7, scope: !4655)
!5430 = !DILocation(line: 351, column: 9, scope: !5431)
!5431 = distinct !DILexicalBlock(scope: !4655, file: !3, line: 351, column: 3)
!5432 = !DILocation(line: 351, column: 7, scope: !5431)
!5433 = !DILocation(line: 351, column: 14, scope: !5434)
!5434 = distinct !DILexicalBlock(scope: !5431, file: !3, line: 351, column: 3)
!5435 = !DILocation(line: 351, column: 18, scope: !5434)
!5436 = !DILocation(line: 351, column: 23, scope: !5434)
!5437 = !DILocation(line: 351, column: 16, scope: !5434)
!5438 = !DILocation(line: 351, column: 3, scope: !5431)
!5439 = !DILocation(line: 352, column: 27, scope: !5434)
!5440 = !DILocation(line: 352, column: 4, scope: !5434)
!5441 = !DILocation(line: 352, column: 9, scope: !5434)
!5442 = !DILocation(line: 352, column: 15, scope: !5434)
!5443 = !DILocation(line: 352, column: 18, scope: !5434)
!5444 = !DILocation(line: 352, column: 24, scope: !5434)
!5445 = !DILocation(line: 351, column: 34, scope: !5434)
!5446 = !DILocation(line: 351, column: 3, scope: !5434)
!5447 = distinct !{!5447, !5438, !5448}
!5448 = !DILocation(line: 352, column: 27, scope: !5431)
!5449 = !DILocation(line: 355, column: 3, scope: !4655)
!5450 = !DILocation(line: 355, column: 8, scope: !4655)
!5451 = !DILocation(line: 355, column: 13, scope: !4655)
!5452 = !DILocation(line: 355, column: 19, scope: !4655)
!5453 = !DILocation(line: 356, column: 7, scope: !5454)
!5454 = distinct !DILexicalBlock(scope: !4655, file: !3, line: 356, column: 7)
!5455 = !DILocation(line: 356, column: 7, scope: !4655)
!5456 = !DILocation(line: 357, column: 16, scope: !5457)
!5457 = distinct !DILexicalBlock(scope: !5454, file: !3, line: 356, column: 47)
!5458 = !DILocation(line: 357, column: 21, scope: !5457)
!5459 = !DILocation(line: 357, column: 4, scope: !5457)
!5460 = !DILocation(line: 358, column: 4, scope: !5457)
!5461 = !DILocation(line: 358, column: 9, scope: !5457)
!5462 = !DILocation(line: 358, column: 13, scope: !5457)
!5463 = !DILocation(line: 359, column: 4, scope: !5457)
!5464 = !DILocation(line: 363, column: 14, scope: !4655)
!5465 = !DILocation(line: 363, column: 19, scope: !4655)
!5466 = !DILocation(line: 363, column: 24, scope: !4655)
!5467 = !DILocation(line: 363, column: 11, scope: !4655)
!5468 = !DILocation(line: 366, column: 13, scope: !4655)
!5469 = !DILocation(line: 366, column: 18, scope: !4655)
!5470 = !DILocation(line: 366, column: 25, scope: !4655)
!5471 = !DILocation(line: 366, column: 33, scope: !4655)
!5472 = !DILocation(line: 366, column: 3, scope: !4655)
!5473 = !DILocation(line: 367, column: 7, scope: !4655)
!5474 = !DILabel(scope: !4157, name: "out", file: !3, line: 370)
!5475 = !DILocation(line: 370, column: 2, scope: !4157)
!5476 = !DILocation(line: 372, column: 8, scope: !4157)
!5477 = !DILocation(line: 372, column: 2, scope: !4157)
!5478 = !DILocation(line: 375, column: 18, scope: !5479)
!5479 = distinct !DILexicalBlock(scope: !4157, file: !3, line: 375, column: 6)
!5480 = !DILocation(line: 375, column: 26, scope: !5479)
!5481 = !DILocation(line: 375, column: 6, scope: !5479)
!5482 = !DILocation(line: 375, column: 6, scope: !4157)
!5483 = !DILocation(line: 376, column: 19, scope: !5484)
!5484 = distinct !DILexicalBlock(scope: !5479, file: !3, line: 375, column: 33)
!5485 = !DILocation(line: 376, column: 3, scope: !5484)
!5486 = !DILocation(line: 377, column: 3, scope: !5484)
!5487 = !DILocation(line: 379, column: 2, scope: !4157)
!5488 = !DILocation(line: 380, column: 1, scope: !4157)
!5489 = distinct !DISubprogram(name: "INIT_LIST_HEAD", scope: !4589, file: !4589, line: 33, type: !4590, scopeLine: 34, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!5490 = !DILocalVariable(name: "list", arg: 1, scope: !5489, file: !4589, line: 33, type: !146)
!5491 = !DILocation(line: 33, column: 53, scope: !5489)
!5492 = !DILocation(line: 35, column: 2, scope: !5489)
!5493 = !DILocation(line: 35, column: 2, scope: !5494)
!5494 = distinct !DILexicalBlock(scope: !5489, file: !4589, line: 35, column: 2)
!5495 = !DILocation(line: 35, column: 2, scope: !5496)
!5496 = distinct !DILexicalBlock(scope: !5494, file: !4589, line: 35, column: 2)
!5497 = !DILocation(line: 35, column: 2, scope: !5498)
!5498 = distinct !DILexicalBlock(scope: !5494, file: !4589, line: 35, column: 2)
!5499 = !DILocation(line: 36, column: 15, scope: !5489)
!5500 = !DILocation(line: 36, column: 2, scope: !5489)
!5501 = !DILocation(line: 36, column: 8, scope: !5489)
!5502 = !DILocation(line: 36, column: 13, scope: !5489)
!5503 = !DILocation(line: 37, column: 1, scope: !5489)
!5504 = distinct !DISubprogram(name: "map_bankwidth_supported", scope: !150, file: !150, line: 139, type: !3329, scopeLine: 140, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!5505 = !DILocalVariable(name: "w", arg: 1, scope: !5504, file: !150, line: 139, type: !169)
!5506 = !DILocation(line: 139, column: 47, scope: !5504)
!5507 = !DILocation(line: 141, column: 10, scope: !5504)
!5508 = !DILocation(line: 141, column: 2, scope: !5504)
!5509 = !DILocation(line: 160, column: 3, scope: !5510)
!5510 = distinct !DILexicalBlock(scope: !5504, file: !150, line: 141, column: 13)
!5511 = !DILocation(line: 163, column: 3, scope: !5510)
!5512 = !DILocation(line: 165, column: 1, scope: !5504)
!5513 = distinct !DISubprogram(name: "list_add", scope: !4589, file: !4589, line: 84, type: !4624, scopeLine: 85, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!5514 = !DILocalVariable(name: "new", arg: 1, scope: !5513, file: !4589, line: 84, type: !146)
!5515 = !DILocation(line: 84, column: 47, scope: !5513)
!5516 = !DILocalVariable(name: "head", arg: 2, scope: !5513, file: !4589, line: 84, type: !146)
!5517 = !DILocation(line: 84, column: 70, scope: !5513)
!5518 = !DILocation(line: 86, column: 13, scope: !5513)
!5519 = !DILocation(line: 86, column: 18, scope: !5513)
!5520 = !DILocation(line: 86, column: 24, scope: !5513)
!5521 = !DILocation(line: 86, column: 30, scope: !5513)
!5522 = !DILocation(line: 86, column: 2, scope: !5513)
!5523 = !DILocation(line: 87, column: 1, scope: !5513)
!5524 = distinct !DISubprogram(name: "list_empty", scope: !4589, file: !4589, line: 280, type: !5525, scopeLine: 281, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!5525 = !DISubroutineType(types: !5526)
!5526 = !{!169, !5527}
!5527 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !5528, size: 64)
!5528 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !142)
!5529 = !DILocalVariable(name: "head", arg: 1, scope: !5524, file: !4589, line: 280, type: !5527)
!5530 = !DILocation(line: 280, column: 54, scope: !5524)
!5531 = !DILocation(line: 282, column: 9, scope: !5532)
!5532 = distinct !DILexicalBlock(scope: !5524, file: !4589, line: 282, column: 9)
!5533 = !DILocation(line: 282, column: 9, scope: !5534)
!5534 = distinct !DILexicalBlock(scope: !5532, file: !4589, line: 282, column: 9)
!5535 = !DILocation(line: 282, column: 34, scope: !5524)
!5536 = !DILocation(line: 282, column: 31, scope: !5524)
!5537 = !DILocation(line: 282, column: 2, scope: !5524)
!5538 = distinct !DISubprogram(name: "get_order", scope: !5539, file: !5539, line: 29, type: !5540, scopeLine: 30, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!5539 = !DIFile(filename: "./include/asm-generic/getorder.h", directory: "/home/lizy2001/genbc/linux")
!5540 = !DISubroutineType(types: !5541)
!5541 = !{!169, !157}
!5542 = !DILocalVariable(name: "x", arg: 1, scope: !5543, file: !5544, line: 366, type: !163)
!5543 = distinct !DISubprogram(name: "fls64", scope: !5544, file: !5544, line: 366, type: !5545, scopeLine: 367, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!5544 = !DIFile(filename: "./arch/x86/include/asm/bitops.h", directory: "/home/lizy2001/genbc/linux")
!5545 = !DISubroutineType(types: !5546)
!5546 = !{!169, !163}
!5547 = !DILocation(line: 366, column: 40, scope: !5543, inlinedAt: !5548)
!5548 = distinct !DILocation(line: 46, column: 9, scope: !5538)
!5549 = !DILocalVariable(name: "bitpos", scope: !5543, file: !5544, line: 368, type: !169)
!5550 = !DILocation(line: 368, column: 6, scope: !5543, inlinedAt: !5548)
!5551 = !DILocalVariable(name: "size", arg: 1, scope: !5538, file: !5539, line: 29, type: !157)
!5552 = !DILocation(line: 29, column: 63, scope: !5538)
!5553 = !DILocation(line: 31, column: 27, scope: !5554)
!5554 = distinct !DILexicalBlock(scope: !5538, file: !5539, line: 31, column: 6)
!5555 = !DILocation(line: 31, column: 6, scope: !5554)
!5556 = !DILocation(line: 31, column: 6, scope: !5538)
!5557 = !DILocation(line: 32, column: 8, scope: !5558)
!5558 = distinct !DILexicalBlock(scope: !5559, file: !5539, line: 32, column: 7)
!5559 = distinct !DILexicalBlock(scope: !5554, file: !5539, line: 31, column: 34)
!5560 = !DILocation(line: 32, column: 7, scope: !5559)
!5561 = !DILocation(line: 33, column: 4, scope: !5558)
!5562 = !DILocation(line: 35, column: 7, scope: !5563)
!5563 = distinct !DILexicalBlock(scope: !5559, file: !5539, line: 35, column: 7)
!5564 = !DILocation(line: 35, column: 12, scope: !5563)
!5565 = !DILocation(line: 35, column: 7, scope: !5559)
!5566 = !DILocation(line: 36, column: 4, scope: !5563)
!5567 = !DILocation(line: 38, column: 10, scope: !5559)
!5568 = !DILocation(line: 38, column: 28, scope: !5559)
!5569 = !DILocation(line: 38, column: 41, scope: !5559)
!5570 = !DILocation(line: 38, column: 3, scope: !5559)
!5571 = !DILocation(line: 41, column: 6, scope: !5538)
!5572 = !DILocation(line: 42, column: 7, scope: !5538)
!5573 = !DILocation(line: 46, column: 15, scope: !5538)
!5574 = !DILocation(line: 374, column: 2, scope: !5543, inlinedAt: !5548)
!5575 = !DILocation(line: 376, column: 14, scope: !5543, inlinedAt: !5548)
!5576 = !{i32 309636}
!5577 = !DILocation(line: 377, column: 9, scope: !5543, inlinedAt: !5548)
!5578 = !DILocation(line: 377, column: 16, scope: !5543, inlinedAt: !5548)
!5579 = !DILocation(line: 46, column: 2, scope: !5538)
!5580 = !DILocation(line: 48, column: 1, scope: !5538)
!5581 = distinct !DISubprogram(name: "__ilog2_u64", scope: !5582, file: !5582, line: 30, type: !5583, scopeLine: 31, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!5582 = !DIFile(filename: "./include/linux/log2.h", directory: "/home/lizy2001/genbc/linux")
!5583 = !DISubroutineType(types: !5584)
!5584 = !{!169, !161}
!5585 = !DILocation(line: 366, column: 40, scope: !5543, inlinedAt: !5586)
!5586 = distinct !DILocation(line: 32, column: 9, scope: !5581)
!5587 = !DILocation(line: 368, column: 6, scope: !5543, inlinedAt: !5586)
!5588 = !DILocalVariable(name: "n", arg: 1, scope: !5581, file: !5582, line: 30, type: !161)
!5589 = !DILocation(line: 30, column: 21, scope: !5581)
!5590 = !DILocation(line: 32, column: 15, scope: !5581)
!5591 = !DILocation(line: 374, column: 2, scope: !5543, inlinedAt: !5586)
!5592 = !DILocation(line: 376, column: 14, scope: !5543, inlinedAt: !5586)
!5593 = !DILocation(line: 377, column: 9, scope: !5543, inlinedAt: !5586)
!5594 = !DILocation(line: 377, column: 16, scope: !5543, inlinedAt: !5586)
!5595 = !DILocation(line: 32, column: 18, scope: !5581)
!5596 = !DILocation(line: 32, column: 2, scope: !5581)
!5597 = distinct !DISubprogram(name: "kasan_kmalloc", scope: !5598, file: !5598, line: 137, type: !5599, scopeLine: 139, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!5598 = !DIFile(filename: "./include/linux/kasan.h", directory: "/home/lizy2001/genbc/linux")
!5599 = !DISubroutineType(types: !5600)
!5600 = !{!137, !1004, !201, !357, !773}
!5601 = !DILocalVariable(name: "s", arg: 1, scope: !5597, file: !5598, line: 137, type: !1004)
!5602 = !DILocation(line: 137, column: 54, scope: !5597)
!5603 = !DILocalVariable(name: "object", arg: 2, scope: !5597, file: !5598, line: 137, type: !201)
!5604 = !DILocation(line: 137, column: 69, scope: !5597)
!5605 = !DILocalVariable(name: "size", arg: 3, scope: !5597, file: !5598, line: 138, type: !357)
!5606 = !DILocation(line: 138, column: 12, scope: !5597)
!5607 = !DILocalVariable(name: "flags", arg: 4, scope: !5597, file: !5598, line: 138, type: !773)
!5608 = !DILocation(line: 138, column: 24, scope: !5597)
!5609 = !DILocation(line: 140, column: 17, scope: !5597)
!5610 = !DILocation(line: 140, column: 2, scope: !5597)
!5611 = distinct !DISubprogram(name: "__list_add", scope: !4589, file: !4589, line: 63, type: !5612, scopeLine: 66, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!5612 = !DISubroutineType(types: !5613)
!5613 = !{null, !146, !146, !146}
!5614 = !DILocalVariable(name: "new", arg: 1, scope: !5611, file: !4589, line: 63, type: !146)
!5615 = !DILocation(line: 63, column: 49, scope: !5611)
!5616 = !DILocalVariable(name: "prev", arg: 2, scope: !5611, file: !4589, line: 64, type: !146)
!5617 = !DILocation(line: 64, column: 28, scope: !5611)
!5618 = !DILocalVariable(name: "next", arg: 3, scope: !5611, file: !4589, line: 65, type: !146)
!5619 = !DILocation(line: 65, column: 28, scope: !5611)
!5620 = !DILocation(line: 67, column: 24, scope: !5621)
!5621 = distinct !DILexicalBlock(scope: !5611, file: !4589, line: 67, column: 6)
!5622 = !DILocation(line: 67, column: 29, scope: !5621)
!5623 = !DILocation(line: 67, column: 35, scope: !5621)
!5624 = !DILocation(line: 67, column: 7, scope: !5621)
!5625 = !DILocation(line: 67, column: 6, scope: !5611)
!5626 = !DILocation(line: 68, column: 3, scope: !5621)
!5627 = !DILocation(line: 70, column: 15, scope: !5611)
!5628 = !DILocation(line: 70, column: 2, scope: !5611)
!5629 = !DILocation(line: 70, column: 8, scope: !5611)
!5630 = !DILocation(line: 70, column: 13, scope: !5611)
!5631 = !DILocation(line: 71, column: 14, scope: !5611)
!5632 = !DILocation(line: 71, column: 2, scope: !5611)
!5633 = !DILocation(line: 71, column: 7, scope: !5611)
!5634 = !DILocation(line: 71, column: 12, scope: !5611)
!5635 = !DILocation(line: 72, column: 14, scope: !5611)
!5636 = !DILocation(line: 72, column: 2, scope: !5611)
!5637 = !DILocation(line: 72, column: 7, scope: !5611)
!5638 = !DILocation(line: 72, column: 12, scope: !5611)
!5639 = !DILocation(line: 73, column: 2, scope: !5611)
!5640 = !DILocation(line: 73, column: 2, scope: !5641)
!5641 = distinct !DILexicalBlock(scope: !5611, file: !4589, line: 73, column: 2)
!5642 = !DILocation(line: 73, column: 2, scope: !5643)
!5643 = distinct !DILexicalBlock(scope: !5641, file: !4589, line: 73, column: 2)
!5644 = !DILocation(line: 73, column: 2, scope: !5645)
!5645 = distinct !DILexicalBlock(scope: !5641, file: !4589, line: 73, column: 2)
!5646 = !DILocation(line: 74, column: 1, scope: !5611)
!5647 = distinct !DISubprogram(name: "__list_add_valid", scope: !4589, file: !4589, line: 45, type: !5648, scopeLine: 48, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !288)
!5648 = !DISubroutineType(types: !5649)
!5649 = !{!248, !146, !146, !146}
!5650 = !DILocalVariable(name: "new", arg: 1, scope: !5647, file: !4589, line: 45, type: !146)
!5651 = !DILocation(line: 45, column: 55, scope: !5647)
!5652 = !DILocalVariable(name: "prev", arg: 2, scope: !5647, file: !4589, line: 46, type: !146)
!5653 = !DILocation(line: 46, column: 23, scope: !5647)
!5654 = !DILocalVariable(name: "next", arg: 3, scope: !5647, file: !4589, line: 47, type: !146)
!5655 = !DILocation(line: 47, column: 23, scope: !5647)
!5656 = !DILocation(line: 49, column: 2, scope: !5647)
