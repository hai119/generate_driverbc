; ModuleID = '../bcout/drivers/usb/misc/ehset.llvm.bc'
source_filename = "drivers/usb/misc/ehset.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_ehset_driver_init6:\09\09\09"
module asm ".long\09ehset_driver_init - .\09\09\09"
...
@__UNIQUE_ID___addressable_ehset_driver_init211 = internal global i8* bitcast (i32 ()* @ehset_driver_init to i8*), section ".discard.addressable", align 8, !dbg !0
@ehset_driver = internal global %struct.usb_driver { i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0), i32 (%struct.usb_interface*, %struct.usb_device_id*)* @ehset_probe, void (%struct.usb_interface*)* @ehset_disconnect, i32 (%struct.usb_interface*, i32, i8*)* null, i32 (%struct.usb_interface*, i32)* null, i32 (%struct.usb_interface*)* null, i32 (%struct.usb_interface*)* null, i32 (%struct.usb_interface*)* null, i32 (%struct.usb_interface*)* null, %struct.usb_device_id* getelementptr inbounds ([8 x %struct.usb_device_id], [8 x %struct.usb_device_id]* @ehset_id_table, i32 0, i32 0), %struct.attribute_group** null, %struct.usb_dynids zeroinitializer, %struct.usbdrv_wrap zeroinitializer, i8 0 }, align 8, !dbg !3827
@__exitcall_ehset_driver_exit = internal global void ()* @ehset_driver_exit, section ".exitcall.exit", align 8, !dbg !3807
@__UNIQUE_ID_description212 = internal constant [52 x i8] c"ehset.description=USB Driver for EHSET Test Fixture\00", section ".modinfo", align 1, !dbg !3812
@__UNIQUE_ID_file213 = internal constant [34 x i8] c"ehset.file=drivers/usb/misc/ehset\00", section ".modinfo", align 1, !dbg !3817
@__UNIQUE_ID_license214 = internal constant [21 x i8] c"ehset.license=GPL v2\00", section ".modinfo", align 1, !dbg !3822
@.str = private unnamed_addr constant [6 x i8] c"ehset\00", align 1
@.str.1 = private unnamed_addr constant [15 x i8] c"usb_ehset_test\00", align 1
@ehset_id_table = internal constant [8 x %struct.usb_device_id] [%struct.usb_device_id { i16 3, i16 6666, i16 257, i16 0, i16 0, i8 0, i8 0, i8 0, i8 0, i8 0, i8 0, i8 0, i64 0 }, %struct.usb_device_id { i16 3, i16 6666, i16 258, i16 0, i16 0, i8 0, i8 0, i8 0, i8 0, i8 0, i8 0, i8 0, i64 0 }, %struct.usb_device_id { i16 3, i16 6666, i16 259, i16 0, i16 0, i8 0, i8 0, i8 0, i8 0, i8 0, i8 0, i8 0, i64 0 }, %struct.usb_device_id { i16 3, i16 6666, i16 260, i16 0, i16 0, i8 0, i8 0, i8 0, i8 0, i8 0, i8 0, i8 0, i64 0 }, %struct.usb_device_id { i16 3, i16 6666, i16 262, i16 0, i16 0, i8 0, i8 0, i8 0, i8 0, i8 0, i8 0, i8 0, i64 0 }, %struct.usb_device_id { i16 3, i16 6666, i16 263, i16 0, i16 0, i8 0, i8 0, i8 0, i8 0, i8 0, i8 0, i8 0, i64 0 }, %struct.usb_device_id { i16 3, i16 6666, i16 264, i16 0, i16 0, i8 0, i8 0, i8 0, i8 0, i8 0, i8 0, i8 0, i64 0 }, %struct.usb_device_id zeroinitializer], align 16, !dbg !3888
@.str.2 = private unnamed_addr constant [57 x i8] c"SINGLE_STEP_SET_FEATURE test only supported on root hub\0A\00", align 1
@.str.3 = private unnamed_addr constant [27 x i8] c"%s: unsupported PID: 0x%x\0A\00", align 1
@__func__.ehset_probe = private unnamed_addr constant [12 x i8] c"ehset_probe\00", align 1
@kmalloc_caches = external dso_local global [3 x [14 x %struct.kmem_cache*]], align 16
@.str.4 = private unnamed_addr constant [21 x i8] c"include/linux/slab.h\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (i8** @__UNIQUE_ID___addressable_ehset_driver_init211 to i8*), i8* bitcast (void ()* @ehset_driver_exit to i8*), i8* bitcast (void ()** @__exitcall_ehset_driver_exit to i8*), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @__UNIQUE_ID_description212, i32 0, i32 0), i8* getelementptr inbounds ([34 x i8], [34 x i8]* @__UNIQUE_ID_file213, i32 0, i32 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__UNIQUE_ID_license214, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @ehset_driver_init() #0 section ".init.text" !dbg !3896 {
entry:
  %call = call i32 @usb_register_driver(%struct.usb_driver* @ehset_driver, %struct.module* null, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0)) #8, !dbg !3899
  ret i32 %call, !dbg !3899
}

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @ehset_driver_exit() #0 section ".exit.text" !dbg !3900 {
entry:
  call void @usb_deregister(%struct.usb_driver* @ehset_driver) #8, !dbg !3901
  ret void, !dbg !3901
}
...
define internal i32 @ehset_probe(%struct.usb_interface* %intf, %struct.usb_device_id* %id) #2 !dbg !3902 {
entry:
  %s.addr.i.i = alloca %struct.kmem_cache*, align 8
  call void @llvm.dbg.declare(metadata %struct.kmem_cache** %s.addr.i.i, metadata !3903, metadata !DIExpression()), !dbg !3907
  %flags.addr.i17.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr.i17.i, metadata !3916, metadata !DIExpression()), !dbg !3917
  %size.addr.i18.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr.i18.i, metadata !3918, metadata !DIExpression()), !dbg !3919
  %ret.i.i = alloca i8*, align 8
  call void @llvm.dbg.declare(metadata i8** %ret.i.i, metadata !3920, metadata !DIExpression()), !dbg !3921
  %retval.i12.i = alloca i32, align 4
  %flags.addr.i13.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr.i13.i, metadata !3922, metadata !DIExpression()), !dbg !3926
  %retval.i.i = alloca i32, align 4
  %size.addr.i11.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr.i11.i, metadata !3928, metadata !DIExpression()), !dbg !3932
  %size.addr.i.i.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr.i.i.i, metadata !3934, metadata !DIExpression()), !dbg !3938
  %flags.addr.i.i.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr.i.i.i, metadata !3943, metadata !DIExpression()), !dbg !3944
  %order.addr.i.i.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %order.addr.i.i.i, metadata !3945, metadata !DIExpression()), !dbg !3946
  %size.addr.i.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr.i.i, metadata !3947, metadata !DIExpression()), !dbg !3948
  %flags.addr.i.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr.i.i, metadata !3949, metadata !DIExpression()), !dbg !3950
  %order.i.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %order.i.i, metadata !3951, metadata !DIExpression()), !dbg !3952
  %retval.i = alloca i8*, align 8
  %size.addr.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr.i, metadata !3953, metadata !DIExpression()), !dbg !3954
  %flags.addr.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr.i, metadata !3955, metadata !DIExpression()), !dbg !3956
  %index.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %index.i, metadata !3957, metadata !DIExpression()), !dbg !3958
  ...
  %hub_udev = alloca %struct.usb_device*, align 8
  %buf = alloca %struct.usb_device_descriptor*, align 8
  %portnum = alloca i8, align 1
  %test_pid = alloca i16, align 2
  store %struct.usb_interface* %intf, %struct.usb_interface** %intf.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.usb_interface** %intf.addr, metadata !3959, metadata !DIExpression()), !dbg !3960
  store %struct.usb_device_id* %id, %struct.usb_device_id** %id.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.usb_device_id** %id.addr, metadata !3961, metadata !DIExpression()), !dbg !3962
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !3963, metadata !DIExpression()), !dbg !3964
  store i32 -22, i32* %ret, align 4, !dbg !3964
  ...
  %call = call %struct.usb_device* @interface_to_usbdev(%struct.usb_interface* %0) #8, !dbg !3968
  store %struct.usb_device* %call, %struct.usb_device** %dev, align 8, !dbg !3966
  call void @llvm.dbg.declare(metadata %struct.usb_device** %hub_udev, metadata !3969, metadata !DIExpression()), !dbg !3970
  %1 = load %struct.usb_device*, %struct.usb_device** %dev, align 8, !dbg !3971
  %parent = getelementptr inbounds %struct.usb_device, %struct.usb_device* %1, i32 0, i32 11, !dbg !3972
  %2 = load %struct.usb_device*, %struct.usb_device** %parent, align 8, !dbg !3972
  store %struct.usb_device* %2, %struct.usb_device** %hub_udev, align 8, !dbg !3970
  call void @llvm.dbg.declare(metadata %struct.usb_device_descriptor** %buf, metadata !3973, metadata !DIExpression()), !dbg !3975
  call void @llvm.dbg.declare(metadata i8* %portnum, metadata !3976, metadata !DIExpression()), !dbg !3977
  %3 = load %struct.usb_device*, %struct.usb_device** %dev, align 8, !dbg !3978
  %portnum1 = getelementptr inbounds %struct.usb_device, %struct.usb_device* %3, i32 0, i32 24, !dbg !3979
  %4 = load i8, i8* %portnum1, align 2, !dbg !3979
  store i8 %4, i8* %portnum, align 1, !dbg !3977
  call void @llvm.dbg.declare(metadata i16* %test_pid, metadata !3980, metadata !DIExpression()), !dbg !3981
  %5 = load %struct.usb_device*, %struct.usb_device** %dev, align 8, !dbg !3982
  %descriptor = getelementptr inbounds %struct.usb_device, %struct.usb_device* %5, i32 0, i32 15, !dbg !3982
  %idProduct = getelementptr inbounds %struct.usb_device_descriptor, %struct.usb_device_descriptor* %descriptor, i32 0, i32 8, !dbg !3982
  %6 = load i16, i16* %idProduct, align 2, !dbg !3982
  store i16 %6, i16* %test_pid, align 2, !dbg !3981
  %7 = load i16, i16* %test_pid, align 2, !dbg !3983
  %conv = zext i16 %7 to i32, !dbg !3983
  switch i32 %conv, label %sw.default [
    i32 257, label %sw.bb
    i32 258, label %sw.bb7
    i32 259, label %sw.bb14
    i32 260, label %sw.bb21
    i32 262, label %sw.bb28
    i32 263, label %sw.bb38
    i32 264, label %sw.bb46
  ], !dbg !3984

sw.bb:                                            ; preds = %entry
  %8 = load %struct.usb_device*, %struct.usb_device** %hub_udev, align 8, !dbg !3985
  %9 = load %struct.usb_device*, %struct.usb_device** %hub_udev, align 8, !dbg !3986
  %call2 = call i32 @__create_pipe(%struct.usb_device* %9, i32 0) #8, !dbg !3986
  %or = or i32 -2147483648, %call2, !dbg !3986
  %10 = load i8, i8* %portnum, align 1, !dbg !3987
  %conv3 = zext i8 %10 to i32, !dbg !3987
  %or4 = or i32 768, %conv3, !dbg !3988
  %conv5 = trunc i32 %or4 to i16, !dbg !3989
  %call6 = call i32 @usb_control_msg(%struct.usb_device* %8, i32 %or, i8 zeroext 3, i8 zeroext 35, i16 zeroext 21, i16 zeroext %conv5, i8* null, i16 zeroext 0, i32 1000) #8, !dbg !3990
  store i32 %call6, i32* %ret, align 4, !dbg !3991
  br label %sw.epilog, !dbg !3992

sw.bb7:                                           ; preds = %entry
  %11 = load %struct.usb_device*, %struct.usb_device** %hub_udev, align 8, !dbg !3993
  %12 = load %struct.usb_device*, %struct.usb_device** %hub_udev, align 8, !dbg !3994
  %call8 = call i32 @__create_pipe(%struct.usb_device* %12, i32 0) #8, !dbg !3994
  %or9 = or i32 -2147483648, %call8, !dbg !3994
  %13 = load i8, i8* %portnum, align 1, !dbg !3995
  %conv10 = zext i8 %13 to i32, !dbg !3995
  %or11 = or i32 256, %conv10, !dbg !3996
  %conv12 = trunc i32 %or11 to i16, !dbg !3997
  %call13 = call i32 @usb_control_msg(%struct.usb_device* %11, i32 %or9, i8 zeroext 3, i8 zeroext 35, i16 zeroext 21, i16 zeroext %conv12, i8* null, i16 zeroext 0, i32 1000) #8, !dbg !3998
  store i32 %call13, i32* %ret, align 4, !dbg !3999
  br label %sw.epilog, !dbg !4000

sw.bb14:                                          ; preds = %entry
  %14 = load %struct.usb_device*, %struct.usb_device** %hub_udev, align 8, !dbg !4001
  %15 = load %struct.usb_device*, %struct.usb_device** %hub_udev, align 8, !dbg !4002
  %call15 = call i32 @__create_pipe(%struct.usb_device* %15, i32 0) #8, !dbg !4002
  %or16 = or i32 -2147483648, %call15, !dbg !4002
  %16 = load i8, i8* %portnum, align 1, !dbg !4003
  %conv17 = zext i8 %16 to i32, !dbg !4003
  %or18 = or i32 512, %conv17, !dbg !4004
  %conv19 = trunc i32 %or18 to i16, !dbg !4005
  %call20 = call i32 @usb_control_msg(%struct.usb_device* %14, i32 %or16, i8 zeroext 3, i8 zeroext 35, i16 zeroext 21, i16 zeroext %conv19, i8* null, i16 zeroext 0, i32 1000) #8, !dbg !4006
  store i32 %call20, i32* %ret, align 4, !dbg !4007
  br label %sw.epilog, !dbg !4008

sw.bb21:                                          ; preds = %entry
  %17 = load %struct.usb_device*, %struct.usb_device** %hub_udev, align 8, !dbg !4009
  %18 = load %struct.usb_device*, %struct.usb_device** %hub_udev, align 8, !dbg !4010
  %call22 = call i32 @__create_pipe(%struct.usb_device* %18, i32 0) #8, !dbg !4010
  %or23 = or i32 -2147483648, %call22, !dbg !4010
  %19 = load i8, i8* %portnum, align 1, !dbg !4011
  %conv24 = zext i8 %19 to i32, !dbg !4011
  %or25 = or i32 1024, %conv24, !dbg !4012
  %conv26 = trunc i32 %or25 to i16, !dbg !4013
  %call27 = call i32 @usb_control_msg(%struct.usb_device* %17, i32 %or23, i8 zeroext 3, i8 zeroext 35, i16 zeroext 21, i16 zeroext %conv26, i8* null, i16 zeroext 0, i32 1000) #8, !dbg !4014
  store i32 %call27, i32* %ret, align 4, !dbg !4015
  br label %sw.epilog, !dbg !4016

sw.bb28:                                          ; preds = %entry
  call void @msleep(i32 15000) #8, !dbg !4017
  %20 = load %struct.usb_device*, %struct.usb_device** %hub_udev, align 8, !dbg !4018
  %21 = load %struct.usb_device*, %struct.usb_device** %hub_udev, align 8, !dbg !4019
  %call29 = call i32 @__create_pipe(%struct.usb_device* %21, i32 0) #8, !dbg !4019
  %or30 = or i32 -2147483648, %call29, !dbg !4019
  %22 = load i8, i8* %portnum, align 1, !dbg !4020
  %conv31 = zext i8 %22 to i16, !dbg !4020
  %call32 = call i32 @usb_control_msg(%struct.usb_device* %20, i32 %or30, i8 zeroext 3, i8 zeroext 35, i16 zeroext 2, i16 zeroext %conv31, i8* null, i16 zeroext 0, i32 1000) #8, !dbg !4021
  store i32 %call32, i32* %ret, align 4, !dbg !4022
  %23 = load i32, i32* %ret, align 4, !dbg !4023
  %cmp = icmp slt i32 %23, 0, !dbg !4025
...
if.end:                                           ; preds = %sw.bb28
  call void @msleep(i32 15000) #8, !dbg !4028
  %24 = load %struct.usb_device*, %struct.usb_device** %hub_udev, align 8, !dbg !4029
  %25 = load %struct.usb_device*, %struct.usb_device** %hub_udev, align 8, !dbg !4030
  %call34 = call i32 @__create_pipe(%struct.usb_device* %25, i32 0) #8, !dbg !4030
  %or35 = or i32 -2147483648, %call34, !dbg !4030
  %26 = load i8, i8* %portnum, align 1, !dbg !4031
  %conv36 = zext i8 %26 to i16, !dbg !4031
  %call37 = call i32 @usb_control_msg(%struct.usb_device* %24, i32 %or35, i8 zeroext 1, i8 zeroext 35, i16 zeroext 2, i16 zeroext %conv36, i8* null, i16 zeroext 0, i32 1000) #8, !dbg !4032
  store i32 %call37, i32* %ret, align 4, !dbg !4033
  br label %sw.epilog, !dbg !4034

sw.bb38:                                          ; preds = %entry
  call void @msleep(i32 15000) #8, !dbg !4035
  store i64 18, i64* %size.addr.i, align 8
  store i32 3264, i32* %flags.addr.i, align 4
  %27 = load i64, i64* %size.addr.i, align 8, !dbg !4036
  %28 = call i1 @llvm.is.constant.i64(i64 %27) #9, !dbg !4037
  br i1 %28, label %if.then.i, label %if.end9.i, !dbg !4038

if.then.i:                                        ; preds = %sw.bb38
  %29 = load i64, i64* %size.addr.i, align 8, !dbg !4039
  %cmp.i = icmp ugt i64 %29, 8192, !dbg !4040
  br i1 %cmp.i, label %if.then1.i, label %if.end.i, !dbg !4041

if.then1.i:                                       ; preds = %if.then.i
  %30 = load i64, i64* %size.addr.i, align 8, !dbg !4042
  %31 = load i32, i32* %flags.addr.i, align 4, !dbg !4043
  store i64 %30, i64* %size.addr.i.i, align 8
  store i32 %31, i32* %flags.addr.i.i, align 4
  %32 = load i64, i64* %size.addr.i.i, align 8, !dbg !4044
  %call.i.i = call i32 @get_order(i64 %32) #10, !dbg !4045
  store i32 %call.i.i, i32* %order.i.i, align 4, !dbg !3952
  %33 = load i64, i64* %size.addr.i.i, align 8, !dbg !4046
  %34 = load i32, i32* %flags.addr.i.i, align 4, !dbg !4047
  %35 = load i32, i32* %order.i.i, align 4, !dbg !4048
  ...
  %36 = load i64, i64* %size.addr.i.i.i, align 8, !dbg !4049
  %37 = load i32, i32* %flags.addr.i.i.i, align 4, !dbg !4050
  %38 = load i32, i32* %order.addr.i.i.i, align 4, !dbg !4051
  %call.i.i.i = call noalias i8* @kmalloc_order(i64 %36, i32 %37, i32 %38) #11, !dbg !4052
  %ptrint.i.i.i = ptrtoint i8* %call.i.i.i to i64, !dbg !4052
  %maskedptr.i.i.i = and i64 %ptrint.i.i.i, 4095, !dbg !4052
  %maskcond.i.i.i = icmp eq i64 %maskedptr.i.i.i, 0, !dbg !4052
  call void @llvm.assume(i1 %maskcond.i.i.i) #9, !dbg !4052
  store i8* %call.i.i.i, i8** %retval.i, align 8, !dbg !4053
  br label %kmalloc.exit, !dbg !4053

if.end.i:                                         ; preds = %if.then.i
  %39 = load i64, i64* %size.addr.i, align 8, !dbg !4054
  store i64 %39, i64* %size.addr.i11.i, align 8
  %40 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4055
  %tobool.i.i = icmp ne i64 %40, 0, !dbg !4055
  br i1 %tobool.i.i, label %if.end.i.i, label %if.then.i.i, !dbg !4057

if.then.i.i:                                      ; preds = %if.end.i
  store i32 0, i32* %retval.i.i, align 4, !dbg !4058
  br label %kmalloc_index.exit.i, !dbg !4058

if.end.i.i:                                       ; preds = %if.end.i
  %41 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4059
  %cmp.i.i = icmp ule i64 %41, 8, !dbg !4061
  br i1 %cmp.i.i, label %if.then1.i.i, label %if.end2.i.i, !dbg !4062

if.then1.i.i:                                     ; preds = %if.end.i.i
  store i32 3, i32* %retval.i.i, align 4, !dbg !4063
  br label %kmalloc_index.exit.i, !dbg !4063

if.end2.i.i:                                      ; preds = %if.end.i.i
  %42 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4064
  %cmp3.i.i = icmp ugt i64 %42, 64, !dbg !4066
  br i1 %cmp3.i.i, label %land.lhs.true.i.i, label %if.end6.i.i, !dbg !4067

land.lhs.true.i.i:                                ; preds = %if.end2.i.i
  %43 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4068
  %cmp4.i.i = icmp ule i64 %43, 96, !dbg !4069
  br i1 %cmp4.i.i, label %if.then5.i.i, label %if.end6.i.i, !dbg !4070

if.then5.i.i:                                     ; preds = %land.lhs.true.i.i
  store i32 1, i32* %retval.i.i, align 4, !dbg !4071
  br label %kmalloc_index.exit.i, !dbg !4071

if.end6.i.i:                                      ; preds = %land.lhs.true.i.i, %if.end2.i.i
  %44 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4072
  %cmp7.i.i = icmp ugt i64 %44, 128, !dbg !4074
  br i1 %cmp7.i.i, label %land.lhs.true8.i.i, label %if.end11.i.i, !dbg !4075

land.lhs.true8.i.i:                               ; preds = %if.end6.i.i
  %45 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4076
  %cmp9.i.i = icmp ule i64 %45, 192, !dbg !4077
  br i1 %cmp9.i.i, label %if.then10.i.i, label %if.end11.i.i, !dbg !4078

if.then10.i.i:                                    ; preds = %land.lhs.true8.i.i
  store i32 2, i32* %retval.i.i, align 4, !dbg !4079
  br label %kmalloc_index.exit.i, !dbg !4079

if.end11.i.i:                                     ; preds = %land.lhs.true8.i.i, %if.end6.i.i
  %46 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4080
  %cmp12.i.i = icmp ule i64 %46, 8, !dbg !4082
  br i1 %cmp12.i.i, label %if.then13.i.i, label %if.end14.i.i, !dbg !4083

if.then13.i.i:                                    ; preds = %if.end11.i.i
  store i32 3, i32* %retval.i.i, align 4, !dbg !4084
  br label %kmalloc_index.exit.i, !dbg !4084

if.end14.i.i:                                     ; preds = %if.end11.i.i
  %47 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4085
  %cmp15.i.i = icmp ule i64 %47, 16, !dbg !4087
  br i1 %cmp15.i.i, label %if.then16.i.i, label %if.end17.i.i, !dbg !4088

if.then16.i.i:                                    ; preds = %if.end14.i.i
  store i32 4, i32* %retval.i.i, align 4, !dbg !4089
  br label %kmalloc_index.exit.i, !dbg !4089

if.end17.i.i:                                     ; preds = %if.end14.i.i
  %48 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4090
  %cmp18.i.i = icmp ule i64 %48, 32, !dbg !4092
  br i1 %cmp18.i.i, label %if.then19.i.i, label %if.end20.i.i, !dbg !4093

if.then19.i.i:                                    ; preds = %if.end17.i.i
  store i32 5, i32* %retval.i.i, align 4, !dbg !4094
  br label %kmalloc_index.exit.i, !dbg !4094

if.end20.i.i:                                     ; preds = %if.end17.i.i
  %49 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4095
  %cmp21.i.i = icmp ule i64 %49, 64, !dbg !4097
  br i1 %cmp21.i.i, label %if.then22.i.i, label %if.end23.i.i, !dbg !4098

if.then22.i.i:                                    ; preds = %if.end20.i.i
  store i32 6, i32* %retval.i.i, align 4, !dbg !4099
  br label %kmalloc_index.exit.i, !dbg !4099

if.end23.i.i:                                     ; preds = %if.end20.i.i
  %50 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4100
  %cmp24.i.i = icmp ule i64 %50, 128, !dbg !4102
  br i1 %cmp24.i.i, label %if.then25.i.i, label %if.end26.i.i, !dbg !4103

if.then25.i.i:                                    ; preds = %if.end23.i.i
  store i32 7, i32* %retval.i.i, align 4, !dbg !4104
  br label %kmalloc_index.exit.i, !dbg !4104

if.end26.i.i:                                     ; preds = %if.end23.i.i
  %51 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4105
  %cmp27.i.i = icmp ule i64 %51, 256, !dbg !4107
  br i1 %cmp27.i.i, label %if.then28.i.i, label %if.end29.i.i, !dbg !4108

if.then28.i.i:                                    ; preds = %if.end26.i.i
  store i32 8, i32* %retval.i.i, align 4, !dbg !4109
  br label %kmalloc_index.exit.i, !dbg !4109

if.end29.i.i:                                     ; preds = %if.end26.i.i
  %52 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4110
  %cmp30.i.i = icmp ule i64 %52, 512, !dbg !4112
  br i1 %cmp30.i.i, label %if.then31.i.i, label %if.end32.i.i, !dbg !4113

if.then31.i.i:                                    ; preds = %if.end29.i.i
  store i32 9, i32* %retval.i.i, align 4, !dbg !4114
  br label %kmalloc_index.exit.i, !dbg !4114

if.end32.i.i:                                     ; preds = %if.end29.i.i
  %53 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4115
  %cmp33.i.i = icmp ule i64 %53, 1024, !dbg !4117
  br i1 %cmp33.i.i, label %if.then34.i.i, label %if.end35.i.i, !dbg !4118

if.then34.i.i:                                    ; preds = %if.end32.i.i
  store i32 10, i32* %retval.i.i, align 4, !dbg !4119
  br label %kmalloc_index.exit.i, !dbg !4119

if.end35.i.i:                                     ; preds = %if.end32.i.i
  %54 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4120
  %cmp36.i.i = icmp ule i64 %54, 2048, !dbg !4122
  br i1 %cmp36.i.i, label %if.then37.i.i, label %if.end38.i.i, !dbg !4123

if.then37.i.i:                                    ; preds = %if.end35.i.i
  store i32 11, i32* %retval.i.i, align 4, !dbg !4124
  br label %kmalloc_index.exit.i, !dbg !4124

if.end38.i.i:                                     ; preds = %if.end35.i.i
  %55 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4125
  %cmp39.i.i = icmp ule i64 %55, 4096, !dbg !4127
  br i1 %cmp39.i.i, label %if.then40.i.i, label %if.end41.i.i, !dbg !4128

if.then40.i.i:                                    ; preds = %if.end38.i.i
  store i32 12, i32* %retval.i.i, align 4, !dbg !4129
  br label %kmalloc_index.exit.i, !dbg !4129

if.end41.i.i:                                     ; preds = %if.end38.i.i
  %56 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4130
  %cmp42.i.i = icmp ule i64 %56, 8192, !dbg !4132
  br i1 %cmp42.i.i, label %if.then43.i.i, label %if.end44.i.i, !dbg !4133

if.then43.i.i:                                    ; preds = %if.end41.i.i
  store i32 13, i32* %retval.i.i, align 4, !dbg !4134
  br label %kmalloc_index.exit.i, !dbg !4134

if.end44.i.i:                                     ; preds = %if.end41.i.i
  %57 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4135
  %cmp45.i.i = icmp ule i64 %57, 16384, !dbg !4137
  br i1 %cmp45.i.i, label %if.then46.i.i, label %if.end47.i.i, !dbg !4138

if.then46.i.i:                                    ; preds = %if.end44.i.i
  store i32 14, i32* %retval.i.i, align 4, !dbg !4139
  br label %kmalloc_index.exit.i, !dbg !4139

if.end47.i.i:                                     ; preds = %if.end44.i.i
  %58 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4140
  %cmp48.i.i = icmp ule i64 %58, 32768, !dbg !4142
  br i1 %cmp48.i.i, label %if.then49.i.i, label %if.end50.i.i, !dbg !4143

if.then49.i.i:                                    ; preds = %if.end47.i.i
  store i32 15, i32* %retval.i.i, align 4, !dbg !4144
  br label %kmalloc_index.exit.i, !dbg !4144

if.end50.i.i:                                     ; preds = %if.end47.i.i
  %59 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4145
  %cmp51.i.i = icmp ule i64 %59, 65536, !dbg !4147
  br i1 %cmp51.i.i, label %if.then52.i.i, label %if.end53.i.i, !dbg !4148

if.then52.i.i:                                    ; preds = %if.end50.i.i
  store i32 16, i32* %retval.i.i, align 4, !dbg !4149
  br label %kmalloc_index.exit.i, !dbg !4149

if.end53.i.i:                                     ; preds = %if.end50.i.i
  %60 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4150
  %cmp54.i.i = icmp ule i64 %60, 131072, !dbg !4152
  br i1 %cmp54.i.i, label %if.then55.i.i, label %if.end56.i.i, !dbg !4153

if.then55.i.i:                                    ; preds = %if.end53.i.i
  store i32 17, i32* %retval.i.i, align 4, !dbg !4154
  br label %kmalloc_index.exit.i, !dbg !4154

if.end56.i.i:                                     ; preds = %if.end53.i.i
  %61 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4155
  %cmp57.i.i = icmp ule i64 %61, 262144, !dbg !4157
  br i1 %cmp57.i.i, label %if.then58.i.i, label %if.end59.i.i, !dbg !4158

if.then58.i.i:                                    ; preds = %if.end56.i.i
  store i32 18, i32* %retval.i.i, align 4, !dbg !4159
  br label %kmalloc_index.exit.i, !dbg !4159

if.end59.i.i:                                     ; preds = %if.end56.i.i
  %62 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4160
  %cmp60.i.i = icmp ule i64 %62, 524288, !dbg !4162
  br i1 %cmp60.i.i, label %if.then61.i.i, label %if.end62.i.i, !dbg !4163

if.then61.i.i:                                    ; preds = %if.end59.i.i
  store i32 19, i32* %retval.i.i, align 4, !dbg !4164
  br label %kmalloc_index.exit.i, !dbg !4164

if.end62.i.i:                                     ; preds = %if.end59.i.i
  %63 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4165
  %cmp63.i.i = icmp ule i64 %63, 1048576, !dbg !4167
  br i1 %cmp63.i.i, label %if.then64.i.i, label %if.end65.i.i, !dbg !4168

if.then64.i.i:                                    ; preds = %if.end62.i.i
  store i32 20, i32* %retval.i.i, align 4, !dbg !4169
  br label %kmalloc_index.exit.i, !dbg !4169

if.end65.i.i:                                     ; preds = %if.end62.i.i
  %64 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4170
  %cmp66.i.i = icmp ule i64 %64, 2097152, !dbg !4172
  br i1 %cmp66.i.i, label %if.then67.i.i, label %if.end68.i.i, !dbg !4173

if.then67.i.i:                                    ; preds = %if.end65.i.i
  store i32 21, i32* %retval.i.i, align 4, !dbg !4174
  br label %kmalloc_index.exit.i, !dbg !4174

if.end68.i.i:                                     ; preds = %if.end65.i.i
  %65 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4175
  %cmp69.i.i = icmp ule i64 %65, 4194304, !dbg !4177
  br i1 %cmp69.i.i, label %if.then70.i.i, label %if.end71.i.i, !dbg !4178

if.then70.i.i:                                    ; preds = %if.end68.i.i
  store i32 22, i32* %retval.i.i, align 4, !dbg !4179
  br label %kmalloc_index.exit.i, !dbg !4179

if.end71.i.i:                                     ; preds = %if.end68.i.i
  %66 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4180
  %cmp72.i.i = icmp ule i64 %66, 8388608, !dbg !4182
  br i1 %cmp72.i.i, label %if.then73.i.i, label %if.end74.i.i, !dbg !4183

if.then73.i.i:                                    ; preds = %if.end71.i.i
  store i32 23, i32* %retval.i.i, align 4, !dbg !4184
  br label %kmalloc_index.exit.i, !dbg !4184

if.end74.i.i:                                     ; preds = %if.end71.i.i
  %67 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4185
  %cmp75.i.i = icmp ule i64 %67, 16777216, !dbg !4187
  br i1 %cmp75.i.i, label %if.then76.i.i, label %if.end77.i.i, !dbg !4188

if.then76.i.i:                                    ; preds = %if.end74.i.i
  store i32 24, i32* %retval.i.i, align 4, !dbg !4189
  br label %kmalloc_index.exit.i, !dbg !4189

if.end77.i.i:                                     ; preds = %if.end74.i.i
  %68 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4190
  %cmp78.i.i = icmp ule i64 %68, 33554432, !dbg !4192
  br i1 %cmp78.i.i, label %if.then79.i.i, label %if.end80.i.i, !dbg !4193

if.then79.i.i:                                    ; preds = %if.end77.i.i
  store i32 25, i32* %retval.i.i, align 4, !dbg !4194
  br label %kmalloc_index.exit.i, !dbg !4194

if.end80.i.i:                                     ; preds = %if.end77.i.i
  %69 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4195
  %cmp81.i.i = icmp ule i64 %69, 67108864, !dbg !4197
  br i1 %cmp81.i.i, label %if.then82.i.i, label %if.end83.i.i, !dbg !4198

if.then82.i.i:                                    ; preds = %if.end80.i.i
  store i32 26, i32* %retval.i.i, align 4, !dbg !4199
  br label %kmalloc_index.exit.i, !dbg !4199

if.end83.i.i:                                     ; preds = %if.end80.i.i
  call void asm sideeffect "1:\09.byte 0x0f, 0x0b\0A.pushsection __bug_table,\22aw\22\0A2:\09.long 1b - 2b\09# bug_entry::bug_addr\0A\09.long ${0:c} - 2b\09# bug_entry::file\0A\09.word ${1:c}\09# bug_entry::line\0A\09.word ${2:c}\09# bug_entry::flags\0A\09.org 2b+${3:c}\0A.popsection", "i,i,i,i,~{dirflag},~{fpsr},~{flags}"(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.4, i64 0, i64 0), i32 382, i32 0, i64 12) #9, !dbg !4200, !srcloc !4203
  call void asm sideeffect "${0:c}:\0A\09.pushsection .discard.unreachable\0A\09.long ${0:c}b - .\0A\09.popsection\0A\09", "i,~{dirflag},~{fpsr},~{flags}"(i32 105) #9, !dbg !4204, !srcloc !4207
  unreachable, !dbg !4208

kmalloc_index.exit.i:                             ; preds = %if.then82.i.i, %if.then79.i.i, %if.then76.i.i, %if.then73.i.i, %if.then70.i.i, %if.then67.i.i, %if.then64.i.i, %if.then61.i.i, %if.then58.i.i, %if.then55.i.i, %if.then52.i.i, %if.then49.i.i, %if.then46.i.i, %if.then43.i.i, %if.then40.i.i, %if.then37.i.i, %if.then34.i.i, %if.then31.i.i, %if.then28.i.i, %if.then25.i.i, %if.then22.i.i, %if.then19.i.i, %if.then16.i.i, %if.then13.i.i, %if.then10.i.i, %if.then5.i.i, %if.then1.i.i, %if.then.i.i
  %70 = load i32, i32* %retval.i.i, align 4, !dbg !4209
  store i32 %70, i32* %index.i, align 4, !dbg !4210
  %71 = load i32, i32* %index.i, align 4, !dbg !4211
  %tobool.i = icmp ne i32 %71, 0, !dbg !4211
  br i1 %tobool.i, label %if.end4.i, label %if.then3.i, !dbg !4213

if.then3.i:                                       ; preds = %kmalloc_index.exit.i
  store i8* inttoptr (i64 16 to i8*), i8** %retval.i, align 8, !dbg !4214
  br label %kmalloc.exit, !dbg !4214

if.end4.i:                                        ; preds = %kmalloc_index.exit.i
  %72 = load i32, i32* %flags.addr.i, align 4, !dbg !4215
  store i32 %72, i32* %flags.addr.i13.i, align 4
  %73 = load i32, i32* %flags.addr.i13.i, align 4, !dbg !4216
  %and.i.i = and i32 %73, 17, !dbg !4216
  %cmp.i14.i = icmp eq i32 %and.i.i, 0, !dbg !4216
  %lnot.i.i = xor i1 %cmp.i14.i, true, !dbg !4216
  %lnot.ext.i.i = zext i1 %cmp.i14.i to i32, !dbg !4216
  %conv.i.i = sext i32 %lnot.ext.i.i to i64, !dbg !4216
  br i1 %cmp.i14.i, label %if.then.i15.i, label %if.end.i16.i, !dbg !4218

if.then.i15.i:                                    ; preds = %if.end4.i
  store i32 0, i32* %retval.i12.i, align 4, !dbg !4219
  br label %kmalloc_type.exit.i, !dbg !4219

if.end.i16.i:                                     ; preds = %if.end4.i
  %74 = load i32, i32* %flags.addr.i13.i, align 4, !dbg !4220
  %and2.i.i = and i32 %74, 1, !dbg !4221
  %tobool3.i.i = icmp ne i32 %and2.i.i, 0, !dbg !4220
  %75 = zext i1 %tobool3.i.i to i64, !dbg !4220
  %cond.i.i = select i1 %tobool3.i.i, i32 2, i32 1, !dbg !4220
  store i32 %cond.i.i, i32* %retval.i12.i, align 4, !dbg !4222
  br label %kmalloc_type.exit.i, !dbg !4222

kmalloc_type.exit.i:                              ; preds = %if.end.i16.i, %if.then.i15.i
  %76 = load i32, i32* %retval.i12.i, align 4, !dbg !4223
  %idxprom.i = zext i32 %76 to i64, !dbg !4224
  %arrayidx.i = getelementptr [3 x [14 x %struct.kmem_cache*]], [3 x [14 x %struct.kmem_cache*]]* @kmalloc_caches, i64 0, i64 %idxprom.i, !dbg !4224
  %77 = load i32, i32* %index.i, align 4, !dbg !4225
  %idxprom6.i = zext i32 %77 to i64, !dbg !4224
  %arrayidx7.i = getelementptr [14 x %struct.kmem_cache*], [14 x %struct.kmem_cache*]* %arrayidx.i, i64 0, i64 %idxprom6.i, !dbg !4224
  %78 = load %struct.kmem_cache*, %struct.kmem_cache** %arrayidx7.i, align 8, !dbg !4224
  %79 = load i32, i32* %flags.addr.i, align 4, !dbg !4226
  %80 = load i64, i64* %size.addr.i, align 8, !dbg !4227
  ...
  %81 = load %struct.kmem_cache*, %struct.kmem_cache** %s.addr.i.i, align 8, !dbg !4228
  %82 = load i32, i32* %flags.addr.i17.i, align 4, !dbg !4229
  %call.i19.i = call noalias i8* @kmem_cache_alloc(%struct.kmem_cache* %81, i32 %82) #11, !dbg !4230
  %ptrint.i.i = ptrtoint i8* %call.i19.i to i64, !dbg !4230
  %maskedptr.i.i = and i64 %ptrint.i.i, 7, !dbg !4230
  %maskcond.i.i = icmp eq i64 %maskedptr.i.i, 0, !dbg !4230
  call void @llvm.assume(i1 %maskcond.i.i) #9, !dbg !4230
  store i8* %call.i19.i, i8** %ret.i.i, align 8, !dbg !3921
  %83 = load %struct.kmem_cache*, %struct.kmem_cache** %s.addr.i.i, align 8, !dbg !4231
  %84 = load i8*, i8** %ret.i.i, align 8, !dbg !4232
  %85 = load i64, i64* %size.addr.i18.i, align 8, !dbg !4233
  %86 = load i32, i32* %flags.addr.i17.i, align 4, !dbg !4234
  %call1.i.i = call i8* @kasan_kmalloc(%struct.kmem_cache* %83, i8* %84, i64 %85, i32 %86) #11, !dbg !4235
  store i8* %call1.i.i, i8** %ret.i.i, align 8, !dbg !4236
  %87 = load i8*, i8** %ret.i.i, align 8, !dbg !4237
  store i8* %87, i8** %retval.i, align 8, !dbg !4238
  br label %kmalloc.exit, !dbg !4238

if.end9.i:                                        ; preds = %sw.bb38
  %88 = load i64, i64* %size.addr.i, align 8, !dbg !4239
  %89 = load i32, i32* %flags.addr.i, align 4, !dbg !4240
  %call10.i = call noalias i8* @__kmalloc(i64 %88, i32 %89) #11, !dbg !4241
  %ptrint.i = ptrtoint i8* %call10.i to i64, !dbg !4241
  %maskedptr.i = and i64 %ptrint.i, 7, !dbg !4241
  %maskcond.i = icmp eq i64 %maskedptr.i, 0, !dbg !4241
  call void @llvm.assume(i1 %maskcond.i) #9, !dbg !4241
  store i8* %call10.i, i8** %retval.i, align 8, !dbg !4242
  br label %kmalloc.exit, !dbg !4242

kmalloc.exit:                                     ; preds = %if.then1.i, %if.then3.i, %kmalloc_type.exit.i, %if.end9.i
  %90 = load i8*, i8** %retval.i, align 8, !dbg !4243
  %91 = bitcast i8* %90 to %struct.usb_device_descriptor*, !dbg !4244
  store %struct.usb_device_descriptor* %91, %struct.usb_device_descriptor** %buf, align 8, !dbg !4245
  %92 = load %struct.usb_device_descriptor*, %struct.usb_device_descriptor** %buf, align 8, !dbg !4246
  %tobool = icmp ne %struct.usb_device_descriptor* %92, null, !dbg !4246
  br i1 %tobool, label %if.end41, label %if.then40, !dbg !4248

if.then40:                                        ; preds = %kmalloc.exit
  store i32 -12, i32* %retval, align 4, !dbg !4249
  br label %return, !dbg !4249

if.end41:                                         ; preds = %kmalloc.exit
  %93 = load %struct.usb_device*, %struct.usb_device** %dev, align 8, !dbg !4250
  %94 = load %struct.usb_device*, %struct.usb_device** %dev, align 8, !dbg !4251
  %call42 = call i32 @__create_pipe(%struct.usb_device* %94, i32 0) #8, !dbg !4251
  %or43 = or i32 -2147483648, %call42, !dbg !4251
  %or44 = or i32 %or43, 128, !dbg !4251
  %95 = load %struct.usb_device_descriptor*, %struct.usb_device_descriptor** %buf, align 8, !dbg !4252
  %96 = bitcast %struct.usb_device_descriptor* %95 to i8*, !dbg !4252
  %call45 = call i32 @usb_control_msg(%struct.usb_device* %93, i32 %or44, i8 zeroext 6, i8 zeroext -128, i16 zeroext 256, i16 zeroext 0, i8* %96, i16 zeroext 18, i32 5000) #8, !dbg !4253
  store i32 %call45, i32* %ret, align 4, !dbg !4254
  %97 = load %struct.usb_device_descriptor*, %struct.usb_device_descriptor** %buf, align 8, !dbg !4255
  %98 = bitcast %struct.usb_device_descriptor* %97 to i8*, !dbg !4255
  call void @kfree(i8* %98) #8, !dbg !4256
  br label %sw.epilog, !dbg !4257

sw.bb46:                                          ; preds = %entry
  %99 = load %struct.usb_device*, %struct.usb_device** %hub_udev, align 8, !dbg !4258
  %100 = load %struct.usb_device*, %struct.usb_device** %dev, align 8, !dbg !4260
  %bus = getelementptr inbounds %struct.usb_device, %struct.usb_device* %100, i32 0, i32 12, !dbg !4261
  %101 = load %struct.usb_bus*, %struct.usb_bus** %bus, align 8, !dbg !4261
  %root_hub = getelementptr inbounds %struct.usb_bus, %struct.usb_bus* %101, i32 0, i32 11, !dbg !4262
  %102 = load %struct.usb_device*, %struct.usb_device** %root_hub, align 8, !dbg !4262
  %cmp47 = icmp ne %struct.usb_device* %99, %102, !dbg !4263
  br i1 %cmp47, label %if.then49, label %if.end51, !dbg !4264

if.then49:                                        ; preds = %sw.bb46
  %103 = load %struct.usb_interface*, %struct.usb_interface** %intf.addr, align 8, !dbg !4265
  %dev50 = getelementptr inbounds %struct.usb_interface, %struct.usb_interface* %103, i32 0, i32 7, !dbg !4265
  call void (%struct.device*, i8*, ...) @_dev_err(%struct.device* %dev50, i8* getelementptr inbounds ([57 x i8], [57 x i8]* @.str.2, i64 0, i64 0)) #12, !dbg !4265
  br label %sw.epilog, !dbg !4267

if.end51:                                         ; preds = %sw.bb46
  %104 = load %struct.usb_device*, %struct.usb_device** %hub_udev, align 8, !dbg !4268
  %105 = load %struct.usb_device*, %struct.usb_device** %hub_udev, align 8, !dbg !4269
  %call52 = call i32 @__create_pipe(%struct.usb_device* %105, i32 0) #8, !dbg !4269
  %or53 = or i32 -2147483648, %call52, !dbg !4269
  %106 = load i8, i8* %portnum, align 1, !dbg !4270
  %conv54 = zext i8 %106 to i32, !dbg !4270
  %or55 = or i32 1536, %conv54, !dbg !4271
  %conv56 = trunc i32 %or55 to i16, !dbg !4272
  %call57 = call i32 @usb_control_msg(%struct.usb_device* %104, i32 %or53, i8 zeroext 3, i8 zeroext 35, i16 zeroext 21, i16 zeroext %conv56, i8* null, i16 zeroext 0, i32 60000) #8, !dbg !4273
  store i32 %call57, i32* %ret, align 4, !dbg !4274
  br label %sw.epilog, !dbg !4275

sw.default:                                       ; preds = %entry
  %107 = load %struct.usb_interface*, %struct.usb_interface** %intf.addr, align 8, !dbg !4276
  %dev58 = getelementptr inbounds %struct.usb_interface, %struct.usb_interface* %107, i32 0, i32 7, !dbg !4276
  %108 = load i16, i16* %test_pid, align 2, !dbg !4276
  %conv59 = zext i16 %108 to i32, !dbg !4276
  call void (%struct.device*, i8*, ...) @_dev_err(%struct.device* %dev58, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @__func__.ehset_probe, i64 0, i64 0), i32 %conv59) #12, !dbg !4276
  br label %sw.epilog, !dbg !4277

sw.epilog:                                        ; preds = %sw.default, %if.end51, %if.then49, %if.end41, %if.end, %if.then, %sw.bb21, %sw.bb14, %sw.bb7, %sw.bb
  %109 = load i32, i32* %ret, align 4, !dbg !4278
  %cmp60 = icmp slt i32 %109, 0, !dbg !4279
  br i1 %cmp60, label %cond.true, label %cond.false, !dbg !4280

cond.true:                                        ; preds = %sw.epilog
  %110 = load i32, i32* %ret, align 4, !dbg !4281
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %110, %cond.true ], [ 0, %cond.false ], !dbg !4280
  store i32 %cond, i32* %retval, align 4, !dbg !4282
  br label %return, !dbg !4282

return:                                           ; preds = %cond.end, %if.then40
  %111 = load i32, i32* %retval, align 4, !dbg !4283
  ret i32 %111, !dbg !4283
}

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @ehset_disconnect(%struct.usb_interface* %intf) #2 !dbg !4284 {
entry:
  %intf.addr = alloca %struct.usb_interface*, align 8
  store %struct.usb_interface* %intf, %struct.usb_interface** %intf.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.usb_interface** %intf.addr, metadata !4285, metadata !DIExpression()), !dbg !4286
  ret void, !dbg !4287
}
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal %struct.usb_device* @interface_to_usbdev(%struct.usb_interface* %intf) #2 !dbg !4288 {
entry:
  %intf.addr = alloca %struct.usb_interface*, align 8
  %__mptr = alloca i8*, align 8
  %tmp = alloca %struct.usb_device*, align 8
  store %struct.usb_interface* %intf, %struct.usb_interface** %intf.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.usb_interface** %intf.addr, metadata !4291, metadata !DIExpression()), !dbg !4292
  call void @llvm.dbg.declare(metadata i8** %__mptr, metadata !4293, metadata !DIExpression()), !dbg !4295
  %0 = load %struct.usb_interface*, %struct.usb_interface** %intf.addr, align 8, !dbg !4295
  %dev = getelementptr inbounds %struct.usb_interface, %struct.usb_interface* %0, i32 0, i32 7, !dbg !4295
  %parent = getelementptr inbounds %struct.device, %struct.device* %dev, i32 0, i32 1, !dbg !4295
  %1 = load %struct.device*, %struct.device** %parent, align 8, !dbg !4295
  %2 = bitcast %struct.device* %1 to i8*, !dbg !4295
  store i8* %2, i8** %__mptr, align 8, !dbg !4295
  br label %do.body, !dbg !4295

do.body:                                          ; preds = %entry
  br label %do.end, !dbg !4296

do.end:                                           ; preds = %do.body
  %3 = load i8*, i8** %__mptr, align 8, !dbg !4295
  %add.ptr = getelementptr i8, i8* %3, i64 -160, !dbg !4295
  %4 = bitcast i8* %add.ptr to %struct.usb_device*, !dbg !4295
  store %struct.usb_device* %4, %struct.usb_device** %tmp, align 8, !dbg !4296
  %5 = load %struct.usb_device*, %struct.usb_device** %tmp, align 8, !dbg !4295
  ret %struct.usb_device* %5, !dbg !4298
}
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal i32 @__create_pipe(%struct.usb_device* %dev, i32 %endpoint) #2 !dbg !4299 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.usb_device** %dev.addr, metadata !4302, metadata !DIExpression()), !dbg !4303
  store i32 %endpoint, i32* %endpoint.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %endpoint.addr, metadata !4304, metadata !DIExpression()), !dbg !4305
  %0 = load %struct.usb_device*, %struct.usb_device** %dev.addr, align 8, !dbg !4306
  %devnum = getelementptr inbounds %struct.usb_device, %struct.usb_device* %0, i32 0, i32 0, !dbg !4307
  %1 = load i32, i32* %devnum, align 8, !dbg !4307
  %shl = shl i32 %1, 8, !dbg !4308
  %2 = load i32, i32* %endpoint.addr, align 4, !dbg !4309
  %shl1 = shl i32 %2, 15, !dbg !4310
  %or = or i32 %shl, %shl1, !dbg !4311
  ret i32 %or, !dbg !4312
}
...
define internal i32 @get_order(i64 %size) #7 !dbg !4313 {
entry:
  %x.addr.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %x.addr.i, metadata !4317, metadata !DIExpression()), !dbg !4322
  %bitpos.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %bitpos.i, metadata !4324, metadata !DIExpression()), !dbg !4325
  %retval = alloca i32, align 4
  %size.addr = alloca i64, align 8
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !4326, metadata !DIExpression()), !dbg !4327
  %0 = load i64, i64* %size.addr, align 8, !dbg !4328
  %1 = call i1 @llvm.is.constant.i64(i64 %0), !dbg !4330
  br i1 %1, label %if.then, label %if.end447, !dbg !4331

if.then:                                          ; preds = %entry
  %2 = load i64, i64* %size.addr, align 8, !dbg !4332
  %tobool = icmp ne i64 %2, 0, !dbg !4332
  br i1 %tobool, label %if.end, label %if.then1, !dbg !4335

if.then1:                                         ; preds = %if.then
  store i32 52, i32* %retval, align 4, !dbg !4336
  br label %return, !dbg !4336

if.end:                                           ; preds = %if.then
  %3 = load i64, i64* %size.addr, align 8, !dbg !4337
  %cmp = icmp ult i64 %3, 4096, !dbg !4339
  br i1 %cmp, label %if.then2, label %if.end3, !dbg !4340
...
if.end3:                                          ; preds = %if.end
  %4 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub = sub i64 %4, 1, !dbg !4342
  %5 = call i1 @llvm.is.constant.i64(i64 %sub), !dbg !4342
  br i1 %5, label %cond.true, label %cond.false442, !dbg !4342

cond.true:                                        ; preds = %if.end3
  %6 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub4 = sub i64 %6, 1, !dbg !4342
  %7 = call i1 @llvm.is.constant.i64(i64 %sub4), !dbg !4342
  br i1 %7, label %cond.true5, label %cond.false439, !dbg !4342

cond.true5:                                       ; preds = %cond.true
  %8 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub6 = sub i64 %8, 1, !dbg !4342
  %cmp7 = icmp ult i64 %sub6, 2, !dbg !4342
  br i1 %cmp7, label %cond.true8, label %cond.false, !dbg !4342

cond.true8:                                       ; preds = %cond.true5
  br label %cond.end437, !dbg !4342

cond.false:                                       ; preds = %cond.true5
  %9 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub9 = sub i64 %9, 1, !dbg !4342
  %and = and i64 %sub9, -9223372036854775808, !dbg !4342
  %tobool10 = icmp ne i64 %and, 0, !dbg !4342
  br i1 %tobool10, label %cond.true11, label %cond.false12, !dbg !4342

cond.true11:                                      ; preds = %cond.false
  br label %cond.end435, !dbg !4342

cond.false12:                                     ; preds = %cond.false
  %10 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub13 = sub i64 %10, 1, !dbg !4342
  %and14 = and i64 %sub13, 4611686018427387904, !dbg !4342
  %tobool15 = icmp ne i64 %and14, 0, !dbg !4342
  br i1 %tobool15, label %cond.true16, label %cond.false17, !dbg !4342

cond.true16:                                      ; preds = %cond.false12
  br label %cond.end433, !dbg !4342

cond.false17:                                     ; preds = %cond.false12
  %11 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub18 = sub i64 %11, 1, !dbg !4342
  %and19 = and i64 %sub18, 2305843009213693952, !dbg !4342
  %tobool20 = icmp ne i64 %and19, 0, !dbg !4342
  br i1 %tobool20, label %cond.true21, label %cond.false22, !dbg !4342

cond.true21:                                      ; preds = %cond.false17
  br label %cond.end431, !dbg !4342

cond.false22:                                     ; preds = %cond.false17
  %12 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub23 = sub i64 %12, 1, !dbg !4342
  %and24 = and i64 %sub23, 1152921504606846976, !dbg !4342
  %tobool25 = icmp ne i64 %and24, 0, !dbg !4342
  br i1 %tobool25, label %cond.true26, label %cond.false27, !dbg !4342

cond.true26:                                      ; preds = %cond.false22
  br label %cond.end429, !dbg !4342

cond.false27:                                     ; preds = %cond.false22
  %13 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub28 = sub i64 %13, 1, !dbg !4342
  %and29 = and i64 %sub28, 576460752303423488, !dbg !4342
  %tobool30 = icmp ne i64 %and29, 0, !dbg !4342
  br i1 %tobool30, label %cond.true31, label %cond.false32, !dbg !4342

cond.true31:                                      ; preds = %cond.false27
  br label %cond.end427, !dbg !4342

cond.false32:                                     ; preds = %cond.false27
  %14 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub33 = sub i64 %14, 1, !dbg !4342
  %and34 = and i64 %sub33, 288230376151711744, !dbg !4342
  %tobool35 = icmp ne i64 %and34, 0, !dbg !4342
  br i1 %tobool35, label %cond.true36, label %cond.false37, !dbg !4342

cond.true36:                                      ; preds = %cond.false32
  br label %cond.end425, !dbg !4342

cond.false37:                                     ; preds = %cond.false32
  %15 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub38 = sub i64 %15, 1, !dbg !4342
  %and39 = and i64 %sub38, 144115188075855872, !dbg !4342
  %tobool40 = icmp ne i64 %and39, 0, !dbg !4342
  br i1 %tobool40, label %cond.true41, label %cond.false42, !dbg !4342

cond.true41:                                      ; preds = %cond.false37
  br label %cond.end423, !dbg !4342

cond.false42:                                     ; preds = %cond.false37
  %16 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub43 = sub i64 %16, 1, !dbg !4342
  %and44 = and i64 %sub43, 72057594037927936, !dbg !4342
  %tobool45 = icmp ne i64 %and44, 0, !dbg !4342
  br i1 %tobool45, label %cond.true46, label %cond.false47, !dbg !4342

cond.true46:                                      ; preds = %cond.false42
  br label %cond.end421, !dbg !4342

cond.false47:                                     ; preds = %cond.false42
  %17 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub48 = sub i64 %17, 1, !dbg !4342
  %and49 = and i64 %sub48, 36028797018963968, !dbg !4342
  %tobool50 = icmp ne i64 %and49, 0, !dbg !4342
  br i1 %tobool50, label %cond.true51, label %cond.false52, !dbg !4342

cond.true51:                                      ; preds = %cond.false47
  br label %cond.end419, !dbg !4342

cond.false52:                                     ; preds = %cond.false47
  %18 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub53 = sub i64 %18, 1, !dbg !4342
  %and54 = and i64 %sub53, 18014398509481984, !dbg !4342
  %tobool55 = icmp ne i64 %and54, 0, !dbg !4342
  br i1 %tobool55, label %cond.true56, label %cond.false57, !dbg !4342

cond.true56:                                      ; preds = %cond.false52
  br label %cond.end417, !dbg !4342

cond.false57:                                     ; preds = %cond.false52
  %19 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub58 = sub i64 %19, 1, !dbg !4342
  %and59 = and i64 %sub58, 9007199254740992, !dbg !4342
  %tobool60 = icmp ne i64 %and59, 0, !dbg !4342
  br i1 %tobool60, label %cond.true61, label %cond.false62, !dbg !4342

cond.true61:                                      ; preds = %cond.false57
  br label %cond.end415, !dbg !4342

cond.false62:                                     ; preds = %cond.false57
  %20 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub63 = sub i64 %20, 1, !dbg !4342
  %and64 = and i64 %sub63, 4503599627370496, !dbg !4342
  %tobool65 = icmp ne i64 %and64, 0, !dbg !4342
  br i1 %tobool65, label %cond.true66, label %cond.false67, !dbg !4342

cond.true66:                                      ; preds = %cond.false62
  br label %cond.end413, !dbg !4342

cond.false67:                                     ; preds = %cond.false62
  %21 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub68 = sub i64 %21, 1, !dbg !4342
  %and69 = and i64 %sub68, 2251799813685248, !dbg !4342
  %tobool70 = icmp ne i64 %and69, 0, !dbg !4342
  br i1 %tobool70, label %cond.true71, label %cond.false72, !dbg !4342

cond.true71:                                      ; preds = %cond.false67
  br label %cond.end411, !dbg !4342

cond.false72:                                     ; preds = %cond.false67
  %22 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub73 = sub i64 %22, 1, !dbg !4342
  %and74 = and i64 %sub73, 1125899906842624, !dbg !4342
  %tobool75 = icmp ne i64 %and74, 0, !dbg !4342
  br i1 %tobool75, label %cond.true76, label %cond.false77, !dbg !4342

cond.true76:                                      ; preds = %cond.false72
  br label %cond.end409, !dbg !4342

cond.false77:                                     ; preds = %cond.false72
  %23 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub78 = sub i64 %23, 1, !dbg !4342
  %and79 = and i64 %sub78, 562949953421312, !dbg !4342
  %tobool80 = icmp ne i64 %and79, 0, !dbg !4342
  br i1 %tobool80, label %cond.true81, label %cond.false82, !dbg !4342

cond.true81:                                      ; preds = %cond.false77
  br label %cond.end407, !dbg !4342

cond.false82:                                     ; preds = %cond.false77
  %24 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub83 = sub i64 %24, 1, !dbg !4342
  %and84 = and i64 %sub83, 281474976710656, !dbg !4342
  %tobool85 = icmp ne i64 %and84, 0, !dbg !4342
  br i1 %tobool85, label %cond.true86, label %cond.false87, !dbg !4342

cond.true86:                                      ; preds = %cond.false82
  br label %cond.end405, !dbg !4342

cond.false87:                                     ; preds = %cond.false82
  %25 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub88 = sub i64 %25, 1, !dbg !4342
  %and89 = and i64 %sub88, 140737488355328, !dbg !4342
  %tobool90 = icmp ne i64 %and89, 0, !dbg !4342
  br i1 %tobool90, label %cond.true91, label %cond.false92, !dbg !4342

cond.true91:                                      ; preds = %cond.false87
  br label %cond.end403, !dbg !4342

cond.false92:                                     ; preds = %cond.false87
  %26 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub93 = sub i64 %26, 1, !dbg !4342
  %and94 = and i64 %sub93, 70368744177664, !dbg !4342
  %tobool95 = icmp ne i64 %and94, 0, !dbg !4342
  br i1 %tobool95, label %cond.true96, label %cond.false97, !dbg !4342

cond.true96:                                      ; preds = %cond.false92
  br label %cond.end401, !dbg !4342

cond.false97:                                     ; preds = %cond.false92
  %27 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub98 = sub i64 %27, 1, !dbg !4342
  %and99 = and i64 %sub98, 35184372088832, !dbg !4342
  %tobool100 = icmp ne i64 %and99, 0, !dbg !4342
  br i1 %tobool100, label %cond.true101, label %cond.false102, !dbg !4342

cond.true101:                                     ; preds = %cond.false97
  br label %cond.end399, !dbg !4342

cond.false102:                                    ; preds = %cond.false97
  %28 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub103 = sub i64 %28, 1, !dbg !4342
  %and104 = and i64 %sub103, 17592186044416, !dbg !4342
  %tobool105 = icmp ne i64 %and104, 0, !dbg !4342
  br i1 %tobool105, label %cond.true106, label %cond.false107, !dbg !4342

cond.true106:                                     ; preds = %cond.false102
  br label %cond.end397, !dbg !4342

cond.false107:                                    ; preds = %cond.false102
  %29 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub108 = sub i64 %29, 1, !dbg !4342
  %and109 = and i64 %sub108, 8796093022208, !dbg !4342
  %tobool110 = icmp ne i64 %and109, 0, !dbg !4342
  br i1 %tobool110, label %cond.true111, label %cond.false112, !dbg !4342

cond.true111:                                     ; preds = %cond.false107
  br label %cond.end395, !dbg !4342

cond.false112:                                    ; preds = %cond.false107
  %30 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub113 = sub i64 %30, 1, !dbg !4342
  %and114 = and i64 %sub113, 4398046511104, !dbg !4342
  %tobool115 = icmp ne i64 %and114, 0, !dbg !4342
  br i1 %tobool115, label %cond.true116, label %cond.false117, !dbg !4342

cond.true116:                                     ; preds = %cond.false112
  br label %cond.end393, !dbg !4342

cond.false117:                                    ; preds = %cond.false112
  %31 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub118 = sub i64 %31, 1, !dbg !4342
  %and119 = and i64 %sub118, 2199023255552, !dbg !4342
  %tobool120 = icmp ne i64 %and119, 0, !dbg !4342
  br i1 %tobool120, label %cond.true121, label %cond.false122, !dbg !4342

cond.true121:                                     ; preds = %cond.false117
  br label %cond.end391, !dbg !4342

cond.false122:                                    ; preds = %cond.false117
  %32 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub123 = sub i64 %32, 1, !dbg !4342
  %and124 = and i64 %sub123, 1099511627776, !dbg !4342
  %tobool125 = icmp ne i64 %and124, 0, !dbg !4342
  br i1 %tobool125, label %cond.true126, label %cond.false127, !dbg !4342

cond.true126:                                     ; preds = %cond.false122
  br label %cond.end389, !dbg !4342

cond.false127:                                    ; preds = %cond.false122
  %33 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub128 = sub i64 %33, 1, !dbg !4342
  %and129 = and i64 %sub128, 549755813888, !dbg !4342
  %tobool130 = icmp ne i64 %and129, 0, !dbg !4342
  br i1 %tobool130, label %cond.true131, label %cond.false132, !dbg !4342

cond.true131:                                     ; preds = %cond.false127
  br label %cond.end387, !dbg !4342

cond.false132:                                    ; preds = %cond.false127
  %34 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub133 = sub i64 %34, 1, !dbg !4342
  %and134 = and i64 %sub133, 274877906944, !dbg !4342
  %tobool135 = icmp ne i64 %and134, 0, !dbg !4342
  br i1 %tobool135, label %cond.true136, label %cond.false137, !dbg !4342

cond.true136:                                     ; preds = %cond.false132
  br label %cond.end385, !dbg !4342

cond.false137:                                    ; preds = %cond.false132
  %35 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub138 = sub i64 %35, 1, !dbg !4342
  %and139 = and i64 %sub138, 137438953472, !dbg !4342
  %tobool140 = icmp ne i64 %and139, 0, !dbg !4342
  br i1 %tobool140, label %cond.true141, label %cond.false142, !dbg !4342

cond.true141:                                     ; preds = %cond.false137
  br label %cond.end383, !dbg !4342

cond.false142:                                    ; preds = %cond.false137
  %36 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub143 = sub i64 %36, 1, !dbg !4342
  %and144 = and i64 %sub143, 68719476736, !dbg !4342
  %tobool145 = icmp ne i64 %and144, 0, !dbg !4342
  br i1 %tobool145, label %cond.true146, label %cond.false147, !dbg !4342

cond.true146:                                     ; preds = %cond.false142
  br label %cond.end381, !dbg !4342

cond.false147:                                    ; preds = %cond.false142
  %37 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub148 = sub i64 %37, 1, !dbg !4342
  %and149 = and i64 %sub148, 34359738368, !dbg !4342
  %tobool150 = icmp ne i64 %and149, 0, !dbg !4342
  br i1 %tobool150, label %cond.true151, label %cond.false152, !dbg !4342

cond.true151:                                     ; preds = %cond.false147
  br label %cond.end379, !dbg !4342

cond.false152:                                    ; preds = %cond.false147
  %38 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub153 = sub i64 %38, 1, !dbg !4342
  %and154 = and i64 %sub153, 17179869184, !dbg !4342
  %tobool155 = icmp ne i64 %and154, 0, !dbg !4342
  br i1 %tobool155, label %cond.true156, label %cond.false157, !dbg !4342

cond.true156:                                     ; preds = %cond.false152
  br label %cond.end377, !dbg !4342

cond.false157:                                    ; preds = %cond.false152
  %39 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub158 = sub i64 %39, 1, !dbg !4342
  %and159 = and i64 %sub158, 8589934592, !dbg !4342
  %tobool160 = icmp ne i64 %and159, 0, !dbg !4342
  br i1 %tobool160, label %cond.true161, label %cond.false162, !dbg !4342

cond.true161:                                     ; preds = %cond.false157
  br label %cond.end375, !dbg !4342

cond.false162:                                    ; preds = %cond.false157
  %40 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub163 = sub i64 %40, 1, !dbg !4342
  %and164 = and i64 %sub163, 4294967296, !dbg !4342
  %tobool165 = icmp ne i64 %and164, 0, !dbg !4342
  br i1 %tobool165, label %cond.true166, label %cond.false167, !dbg !4342

cond.true166:                                     ; preds = %cond.false162
  br label %cond.end373, !dbg !4342

cond.false167:                                    ; preds = %cond.false162
  %41 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub168 = sub i64 %41, 1, !dbg !4342
  %and169 = and i64 %sub168, 2147483648, !dbg !4342
  %tobool170 = icmp ne i64 %and169, 0, !dbg !4342
  br i1 %tobool170, label %cond.true171, label %cond.false172, !dbg !4342

cond.true171:                                     ; preds = %cond.false167
  br label %cond.end371, !dbg !4342

cond.false172:                                    ; preds = %cond.false167
  %42 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub173 = sub i64 %42, 1, !dbg !4342
  %and174 = and i64 %sub173, 1073741824, !dbg !4342
  %tobool175 = icmp ne i64 %and174, 0, !dbg !4342
  br i1 %tobool175, label %cond.true176, label %cond.false177, !dbg !4342

cond.true176:                                     ; preds = %cond.false172
  br label %cond.end369, !dbg !4342

cond.false177:                                    ; preds = %cond.false172
  %43 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub178 = sub i64 %43, 1, !dbg !4342
  %and179 = and i64 %sub178, 536870912, !dbg !4342
  %tobool180 = icmp ne i64 %and179, 0, !dbg !4342
  br i1 %tobool180, label %cond.true181, label %cond.false182, !dbg !4342

cond.true181:                                     ; preds = %cond.false177
  br label %cond.end367, !dbg !4342

cond.false182:                                    ; preds = %cond.false177
  %44 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub183 = sub i64 %44, 1, !dbg !4342
  %and184 = and i64 %sub183, 268435456, !dbg !4342
  %tobool185 = icmp ne i64 %and184, 0, !dbg !4342
  br i1 %tobool185, label %cond.true186, label %cond.false187, !dbg !4342

cond.true186:                                     ; preds = %cond.false182
  br label %cond.end365, !dbg !4342

cond.false187:                                    ; preds = %cond.false182
  %45 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub188 = sub i64 %45, 1, !dbg !4342
  %and189 = and i64 %sub188, 134217728, !dbg !4342
  %tobool190 = icmp ne i64 %and189, 0, !dbg !4342
  br i1 %tobool190, label %cond.true191, label %cond.false192, !dbg !4342

cond.true191:                                     ; preds = %cond.false187
  br label %cond.end363, !dbg !4342

cond.false192:                                    ; preds = %cond.false187
  %46 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub193 = sub i64 %46, 1, !dbg !4342
  %and194 = and i64 %sub193, 67108864, !dbg !4342
  %tobool195 = icmp ne i64 %and194, 0, !dbg !4342
  br i1 %tobool195, label %cond.true196, label %cond.false197, !dbg !4342

cond.true196:                                     ; preds = %cond.false192
  br label %cond.end361, !dbg !4342

cond.false197:                                    ; preds = %cond.false192
  %47 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub198 = sub i64 %47, 1, !dbg !4342
  %and199 = and i64 %sub198, 33554432, !dbg !4342
  %tobool200 = icmp ne i64 %and199, 0, !dbg !4342
  br i1 %tobool200, label %cond.true201, label %cond.false202, !dbg !4342

cond.true201:                                     ; preds = %cond.false197
  br label %cond.end359, !dbg !4342

cond.false202:                                    ; preds = %cond.false197
  %48 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub203 = sub i64 %48, 1, !dbg !4342
  %and204 = and i64 %sub203, 16777216, !dbg !4342
  %tobool205 = icmp ne i64 %and204, 0, !dbg !4342
  br i1 %tobool205, label %cond.true206, label %cond.false207, !dbg !4342

cond.true206:                                     ; preds = %cond.false202
  br label %cond.end357, !dbg !4342

cond.false207:                                    ; preds = %cond.false202
  %49 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub208 = sub i64 %49, 1, !dbg !4342
  %and209 = and i64 %sub208, 8388608, !dbg !4342
  %tobool210 = icmp ne i64 %and209, 0, !dbg !4342
  br i1 %tobool210, label %cond.true211, label %cond.false212, !dbg !4342

cond.true211:                                     ; preds = %cond.false207
  br label %cond.end355, !dbg !4342

cond.false212:                                    ; preds = %cond.false207
  %50 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub213 = sub i64 %50, 1, !dbg !4342
  %and214 = and i64 %sub213, 4194304, !dbg !4342
  %tobool215 = icmp ne i64 %and214, 0, !dbg !4342
  br i1 %tobool215, label %cond.true216, label %cond.false217, !dbg !4342

cond.true216:                                     ; preds = %cond.false212
  br label %cond.end353, !dbg !4342

cond.false217:                                    ; preds = %cond.false212
  %51 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub218 = sub i64 %51, 1, !dbg !4342
  %and219 = and i64 %sub218, 2097152, !dbg !4342
  %tobool220 = icmp ne i64 %and219, 0, !dbg !4342
  br i1 %tobool220, label %cond.true221, label %cond.false222, !dbg !4342

cond.true221:                                     ; preds = %cond.false217
  br label %cond.end351, !dbg !4342

cond.false222:                                    ; preds = %cond.false217
  %52 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub223 = sub i64 %52, 1, !dbg !4342
  %and224 = and i64 %sub223, 1048576, !dbg !4342
  %tobool225 = icmp ne i64 %and224, 0, !dbg !4342
  br i1 %tobool225, label %cond.true226, label %cond.false227, !dbg !4342

cond.true226:                                     ; preds = %cond.false222
  br label %cond.end349, !dbg !4342

cond.false227:                                    ; preds = %cond.false222
  %53 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub228 = sub i64 %53, 1, !dbg !4342
  %and229 = and i64 %sub228, 524288, !dbg !4342
  %tobool230 = icmp ne i64 %and229, 0, !dbg !4342
  br i1 %tobool230, label %cond.true231, label %cond.false232, !dbg !4342

cond.true231:                                     ; preds = %cond.false227
  br label %cond.end347, !dbg !4342

cond.false232:                                    ; preds = %cond.false227
  %54 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub233 = sub i64 %54, 1, !dbg !4342
  %and234 = and i64 %sub233, 262144, !dbg !4342
  %tobool235 = icmp ne i64 %and234, 0, !dbg !4342
  br i1 %tobool235, label %cond.true236, label %cond.false237, !dbg !4342

cond.true236:                                     ; preds = %cond.false232
  br label %cond.end345, !dbg !4342

cond.false237:                                    ; preds = %cond.false232
  %55 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub238 = sub i64 %55, 1, !dbg !4342
  %and239 = and i64 %sub238, 131072, !dbg !4342
  %tobool240 = icmp ne i64 %and239, 0, !dbg !4342
  br i1 %tobool240, label %cond.true241, label %cond.false242, !dbg !4342

cond.true241:                                     ; preds = %cond.false237
  br label %cond.end343, !dbg !4342

cond.false242:                                    ; preds = %cond.false237
  %56 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub243 = sub i64 %56, 1, !dbg !4342
  %and244 = and i64 %sub243, 65536, !dbg !4342
  %tobool245 = icmp ne i64 %and244, 0, !dbg !4342
  br i1 %tobool245, label %cond.true246, label %cond.false247, !dbg !4342

cond.true246:                                     ; preds = %cond.false242
  br label %cond.end341, !dbg !4342

cond.false247:                                    ; preds = %cond.false242
  %57 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub248 = sub i64 %57, 1, !dbg !4342
  %and249 = and i64 %sub248, 32768, !dbg !4342
  %tobool250 = icmp ne i64 %and249, 0, !dbg !4342
  br i1 %tobool250, label %cond.true251, label %cond.false252, !dbg !4342

cond.true251:                                     ; preds = %cond.false247
  br label %cond.end339, !dbg !4342

cond.false252:                                    ; preds = %cond.false247
  %58 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub253 = sub i64 %58, 1, !dbg !4342
  %and254 = and i64 %sub253, 16384, !dbg !4342
  %tobool255 = icmp ne i64 %and254, 0, !dbg !4342
  br i1 %tobool255, label %cond.true256, label %cond.false257, !dbg !4342

cond.true256:                                     ; preds = %cond.false252
  br label %cond.end337, !dbg !4342

cond.false257:                                    ; preds = %cond.false252
  %59 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub258 = sub i64 %59, 1, !dbg !4342
  %and259 = and i64 %sub258, 8192, !dbg !4342
  %tobool260 = icmp ne i64 %and259, 0, !dbg !4342
  br i1 %tobool260, label %cond.true261, label %cond.false262, !dbg !4342

cond.true261:                                     ; preds = %cond.false257
  br label %cond.end335, !dbg !4342

cond.false262:                                    ; preds = %cond.false257
  %60 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub263 = sub i64 %60, 1, !dbg !4342
  %and264 = and i64 %sub263, 4096, !dbg !4342
  %tobool265 = icmp ne i64 %and264, 0, !dbg !4342
  br i1 %tobool265, label %cond.true266, label %cond.false267, !dbg !4342

cond.true266:                                     ; preds = %cond.false262
  br label %cond.end333, !dbg !4342

cond.false267:                                    ; preds = %cond.false262
  %61 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub268 = sub i64 %61, 1, !dbg !4342
  %and269 = and i64 %sub268, 2048, !dbg !4342
  %tobool270 = icmp ne i64 %and269, 0, !dbg !4342
  br i1 %tobool270, label %cond.true271, label %cond.false272, !dbg !4342

cond.true271:                                     ; preds = %cond.false267
  br label %cond.end331, !dbg !4342

cond.false272:                                    ; preds = %cond.false267
  %62 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub273 = sub i64 %62, 1, !dbg !4342
  %and274 = and i64 %sub273, 1024, !dbg !4342
  %tobool275 = icmp ne i64 %and274, 0, !dbg !4342
  br i1 %tobool275, label %cond.true276, label %cond.false277, !dbg !4342

cond.true276:                                     ; preds = %cond.false272
  br label %cond.end329, !dbg !4342

cond.false277:                                    ; preds = %cond.false272
  %63 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub278 = sub i64 %63, 1, !dbg !4342
  %and279 = and i64 %sub278, 512, !dbg !4342
  %tobool280 = icmp ne i64 %and279, 0, !dbg !4342
  br i1 %tobool280, label %cond.true281, label %cond.false282, !dbg !4342

cond.true281:                                     ; preds = %cond.false277
  br label %cond.end327, !dbg !4342

cond.false282:                                    ; preds = %cond.false277
  %64 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub283 = sub i64 %64, 1, !dbg !4342
  %and284 = and i64 %sub283, 256, !dbg !4342
  %tobool285 = icmp ne i64 %and284, 0, !dbg !4342
  br i1 %tobool285, label %cond.true286, label %cond.false287, !dbg !4342

cond.true286:                                     ; preds = %cond.false282
  br label %cond.end325, !dbg !4342

cond.false287:                                    ; preds = %cond.false282
  %65 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub288 = sub i64 %65, 1, !dbg !4342
  %and289 = and i64 %sub288, 128, !dbg !4342
  %tobool290 = icmp ne i64 %and289, 0, !dbg !4342
  br i1 %tobool290, label %cond.true291, label %cond.false292, !dbg !4342

cond.true291:                                     ; preds = %cond.false287
  br label %cond.end323, !dbg !4342

cond.false292:                                    ; preds = %cond.false287
  %66 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub293 = sub i64 %66, 1, !dbg !4342
  %and294 = and i64 %sub293, 64, !dbg !4342
  %tobool295 = icmp ne i64 %and294, 0, !dbg !4342
  br i1 %tobool295, label %cond.true296, label %cond.false297, !dbg !4342

cond.true296:                                     ; preds = %cond.false292
  br label %cond.end321, !dbg !4342

cond.false297:                                    ; preds = %cond.false292
  %67 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub298 = sub i64 %67, 1, !dbg !4342
  %and299 = and i64 %sub298, 32, !dbg !4342
  %tobool300 = icmp ne i64 %and299, 0, !dbg !4342
  br i1 %tobool300, label %cond.true301, label %cond.false302, !dbg !4342

cond.true301:                                     ; preds = %cond.false297
  br label %cond.end319, !dbg !4342

cond.false302:                                    ; preds = %cond.false297
  %68 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub303 = sub i64 %68, 1, !dbg !4342
  %and304 = and i64 %sub303, 16, !dbg !4342
  %tobool305 = icmp ne i64 %and304, 0, !dbg !4342
  br i1 %tobool305, label %cond.true306, label %cond.false307, !dbg !4342

cond.true306:                                     ; preds = %cond.false302
  br label %cond.end317, !dbg !4342

cond.false307:                                    ; preds = %cond.false302
  %69 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub308 = sub i64 %69, 1, !dbg !4342
  %and309 = and i64 %sub308, 8, !dbg !4342
  %tobool310 = icmp ne i64 %and309, 0, !dbg !4342
  br i1 %tobool310, label %cond.true311, label %cond.false312, !dbg !4342

cond.true311:                                     ; preds = %cond.false307
  br label %cond.end, !dbg !4342

cond.false312:                                    ; preds = %cond.false307
  %70 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub313 = sub i64 %70, 1, !dbg !4342
  %and314 = and i64 %sub313, 4, !dbg !4342
  %tobool315 = icmp ne i64 %and314, 0, !dbg !4342
  %71 = zext i1 %tobool315 to i64, !dbg !4342
  %cond = select i1 %tobool315, i32 2, i32 1, !dbg !4342
  br label %cond.end, !dbg !4342

cond.end:                                         ; preds = %cond.false312, %cond.true311
  %cond316 = phi i32 [ 3, %cond.true311 ], [ %cond, %cond.false312 ], !dbg !4342
  br label %cond.end317, !dbg !4342

cond.end317:                                      ; preds = %cond.end, %cond.true306
  %cond318 = phi i32 [ 4, %cond.true306 ], [ %cond316, %cond.end ], !dbg !4342
  br label %cond.end319, !dbg !4342

cond.end319:                                      ; preds = %cond.end317, %cond.true301
  %cond320 = phi i32 [ 5, %cond.true301 ], [ %cond318, %cond.end317 ], !dbg !4342
  br label %cond.end321, !dbg !4342

cond.end321:                                      ; preds = %cond.end319, %cond.true296
  %cond322 = phi i32 [ 6, %cond.true296 ], [ %cond320, %cond.end319 ], !dbg !4342
  br label %cond.end323, !dbg !4342

cond.end323:                                      ; preds = %cond.end321, %cond.true291
  %cond324 = phi i32 [ 7, %cond.true291 ], [ %cond322, %cond.end321 ], !dbg !4342
  br label %cond.end325, !dbg !4342

cond.end325:                                      ; preds = %cond.end323, %cond.true286
  %cond326 = phi i32 [ 8, %cond.true286 ], [ %cond324, %cond.end323 ], !dbg !4342
  br label %cond.end327, !dbg !4342

cond.end327:                                      ; preds = %cond.end325, %cond.true281
  %cond328 = phi i32 [ 9, %cond.true281 ], [ %cond326, %cond.end325 ], !dbg !4342
  br label %cond.end329, !dbg !4342

cond.end329:                                      ; preds = %cond.end327, %cond.true276
  %cond330 = phi i32 [ 10, %cond.true276 ], [ %cond328, %cond.end327 ], !dbg !4342
  br label %cond.end331, !dbg !4342

cond.end331:                                      ; preds = %cond.end329, %cond.true271
  %cond332 = phi i32 [ 11, %cond.true271 ], [ %cond330, %cond.end329 ], !dbg !4342
  br label %cond.end333, !dbg !4342

cond.end333:                                      ; preds = %cond.end331, %cond.true266
  %cond334 = phi i32 [ 12, %cond.true266 ], [ %cond332, %cond.end331 ], !dbg !4342
  br label %cond.end335, !dbg !4342

cond.end335:                                      ; preds = %cond.end333, %cond.true261
  %cond336 = phi i32 [ 13, %cond.true261 ], [ %cond334, %cond.end333 ], !dbg !4342
  br label %cond.end337, !dbg !4342

cond.end337:                                      ; preds = %cond.end335, %cond.true256
  %cond338 = phi i32 [ 14, %cond.true256 ], [ %cond336, %cond.end335 ], !dbg !4342
  br label %cond.end339, !dbg !4342

cond.end339:                                      ; preds = %cond.end337, %cond.true251
  %cond340 = phi i32 [ 15, %cond.true251 ], [ %cond338, %cond.end337 ], !dbg !4342
  br label %cond.end341, !dbg !4342

cond.end341:                                      ; preds = %cond.end339, %cond.true246
  %cond342 = phi i32 [ 16, %cond.true246 ], [ %cond340, %cond.end339 ], !dbg !4342
  br label %cond.end343, !dbg !4342

cond.end343:                                      ; preds = %cond.end341, %cond.true241
  %cond344 = phi i32 [ 17, %cond.true241 ], [ %cond342, %cond.end341 ], !dbg !4342
  br label %cond.end345, !dbg !4342

cond.end345:                                      ; preds = %cond.end343, %cond.true236
  %cond346 = phi i32 [ 18, %cond.true236 ], [ %cond344, %cond.end343 ], !dbg !4342
  br label %cond.end347, !dbg !4342

cond.end347:                                      ; preds = %cond.end345, %cond.true231
  %cond348 = phi i32 [ 19, %cond.true231 ], [ %cond346, %cond.end345 ], !dbg !4342
  br label %cond.end349, !dbg !4342

cond.end349:                                      ; preds = %cond.end347, %cond.true226
  %cond350 = phi i32 [ 20, %cond.true226 ], [ %cond348, %cond.end347 ], !dbg !4342
  br label %cond.end351, !dbg !4342

cond.end351:                                      ; preds = %cond.end349, %cond.true221
  %cond352 = phi i32 [ 21, %cond.true221 ], [ %cond350, %cond.end349 ], !dbg !4342
  br label %cond.end353, !dbg !4342

cond.end353:                                      ; preds = %cond.end351, %cond.true216
  %cond354 = phi i32 [ 22, %cond.true216 ], [ %cond352, %cond.end351 ], !dbg !4342
  br label %cond.end355, !dbg !4342

cond.end355:                                      ; preds = %cond.end353, %cond.true211
  %cond356 = phi i32 [ 23, %cond.true211 ], [ %cond354, %cond.end353 ], !dbg !4342
  br label %cond.end357, !dbg !4342

cond.end357:                                      ; preds = %cond.end355, %cond.true206
  %cond358 = phi i32 [ 24, %cond.true206 ], [ %cond356, %cond.end355 ], !dbg !4342
  br label %cond.end359, !dbg !4342

cond.end359:                                      ; preds = %cond.end357, %cond.true201
  %cond360 = phi i32 [ 25, %cond.true201 ], [ %cond358, %cond.end357 ], !dbg !4342
  br label %cond.end361, !dbg !4342

cond.end361:                                      ; preds = %cond.end359, %cond.true196
  %cond362 = phi i32 [ 26, %cond.true196 ], [ %cond360, %cond.end359 ], !dbg !4342
  br label %cond.end363, !dbg !4342

cond.end363:                                      ; preds = %cond.end361, %cond.true191
  %cond364 = phi i32 [ 27, %cond.true191 ], [ %cond362, %cond.end361 ], !dbg !4342
  br label %cond.end365, !dbg !4342

cond.end365:                                      ; preds = %cond.end363, %cond.true186
  %cond366 = phi i32 [ 28, %cond.true186 ], [ %cond364, %cond.end363 ], !dbg !4342
  br label %cond.end367, !dbg !4342

cond.end367:                                      ; preds = %cond.end365, %cond.true181
  %cond368 = phi i32 [ 29, %cond.true181 ], [ %cond366, %cond.end365 ], !dbg !4342
  br label %cond.end369, !dbg !4342

cond.end369:                                      ; preds = %cond.end367, %cond.true176
  %cond370 = phi i32 [ 30, %cond.true176 ], [ %cond368, %cond.end367 ], !dbg !4342
  br label %cond.end371, !dbg !4342

cond.end371:                                      ; preds = %cond.end369, %cond.true171
  %cond372 = phi i32 [ 31, %cond.true171 ], [ %cond370, %cond.end369 ], !dbg !4342
  br label %cond.end373, !dbg !4342

cond.end373:                                      ; preds = %cond.end371, %cond.true166
  %cond374 = phi i32 [ 32, %cond.true166 ], [ %cond372, %cond.end371 ], !dbg !4342
  br label %cond.end375, !dbg !4342

cond.end375:                                      ; preds = %cond.end373, %cond.true161
  %cond376 = phi i32 [ 33, %cond.true161 ], [ %cond374, %cond.end373 ], !dbg !4342
  br label %cond.end377, !dbg !4342

cond.end377:                                      ; preds = %cond.end375, %cond.true156
  %cond378 = phi i32 [ 34, %cond.true156 ], [ %cond376, %cond.end375 ], !dbg !4342
  br label %cond.end379, !dbg !4342

cond.end379:                                      ; preds = %cond.end377, %cond.true151
  %cond380 = phi i32 [ 35, %cond.true151 ], [ %cond378, %cond.end377 ], !dbg !4342
  br label %cond.end381, !dbg !4342

cond.end381:                                      ; preds = %cond.end379, %cond.true146
  %cond382 = phi i32 [ 36, %cond.true146 ], [ %cond380, %cond.end379 ], !dbg !4342
  br label %cond.end383, !dbg !4342

cond.end383:                                      ; preds = %cond.end381, %cond.true141
  %cond384 = phi i32 [ 37, %cond.true141 ], [ %cond382, %cond.end381 ], !dbg !4342
  br label %cond.end385, !dbg !4342

cond.end385:                                      ; preds = %cond.end383, %cond.true136
  %cond386 = phi i32 [ 38, %cond.true136 ], [ %cond384, %cond.end383 ], !dbg !4342
  br label %cond.end387, !dbg !4342

cond.end387:                                      ; preds = %cond.end385, %cond.true131
  %cond388 = phi i32 [ 39, %cond.true131 ], [ %cond386, %cond.end385 ], !dbg !4342
  br label %cond.end389, !dbg !4342

cond.end389:                                      ; preds = %cond.end387, %cond.true126
  %cond390 = phi i32 [ 40, %cond.true126 ], [ %cond388, %cond.end387 ], !dbg !4342
  br label %cond.end391, !dbg !4342

cond.end391:                                      ; preds = %cond.end389, %cond.true121
  %cond392 = phi i32 [ 41, %cond.true121 ], [ %cond390, %cond.end389 ], !dbg !4342
  br label %cond.end393, !dbg !4342

cond.end393:                                      ; preds = %cond.end391, %cond.true116
  %cond394 = phi i32 [ 42, %cond.true116 ], [ %cond392, %cond.end391 ], !dbg !4342
  br label %cond.end395, !dbg !4342

cond.end395:                                      ; preds = %cond.end393, %cond.true111
  %cond396 = phi i32 [ 43, %cond.true111 ], [ %cond394, %cond.end393 ], !dbg !4342
  br label %cond.end397, !dbg !4342

cond.end397:                                      ; preds = %cond.end395, %cond.true106
  %cond398 = phi i32 [ 44, %cond.true106 ], [ %cond396, %cond.end395 ], !dbg !4342
  br label %cond.end399, !dbg !4342

cond.end399:                                      ; preds = %cond.end397, %cond.true101
  %cond400 = phi i32 [ 45, %cond.true101 ], [ %cond398, %cond.end397 ], !dbg !4342
  br label %cond.end401, !dbg !4342

cond.end401:                                      ; preds = %cond.end399, %cond.true96
  %cond402 = phi i32 [ 46, %cond.true96 ], [ %cond400, %cond.end399 ], !dbg !4342
  br label %cond.end403, !dbg !4342

cond.end403:                                      ; preds = %cond.end401, %cond.true91
  %cond404 = phi i32 [ 47, %cond.true91 ], [ %cond402, %cond.end401 ], !dbg !4342
  br label %cond.end405, !dbg !4342

cond.end405:                                      ; preds = %cond.end403, %cond.true86
  %cond406 = phi i32 [ 48, %cond.true86 ], [ %cond404, %cond.end403 ], !dbg !4342
  br label %cond.end407, !dbg !4342

cond.end407:                                      ; preds = %cond.end405, %cond.true81
  %cond408 = phi i32 [ 49, %cond.true81 ], [ %cond406, %cond.end405 ], !dbg !4342
  br label %cond.end409, !dbg !4342

cond.end409:                                      ; preds = %cond.end407, %cond.true76
  %cond410 = phi i32 [ 50, %cond.true76 ], [ %cond408, %cond.end407 ], !dbg !4342
  br label %cond.end411, !dbg !4342

cond.end411:                                      ; preds = %cond.end409, %cond.true71
  %cond412 = phi i32 [ 51, %cond.true71 ], [ %cond410, %cond.end409 ], !dbg !4342
  br label %cond.end413, !dbg !4342

cond.end413:                                      ; preds = %cond.end411, %cond.true66
  %cond414 = phi i32 [ 52, %cond.true66 ], [ %cond412, %cond.end411 ], !dbg !4342
  br label %cond.end415, !dbg !4342

cond.end415:                                      ; preds = %cond.end413, %cond.true61
  %cond416 = phi i32 [ 53, %cond.true61 ], [ %cond414, %cond.end413 ], !dbg !4342
  br label %cond.end417, !dbg !4342

cond.end417:                                      ; preds = %cond.end415, %cond.true56
  %cond418 = phi i32 [ 54, %cond.true56 ], [ %cond416, %cond.end415 ], !dbg !4342
  br label %cond.end419, !dbg !4342

cond.end419:                                      ; preds = %cond.end417, %cond.true51
  %cond420 = phi i32 [ 55, %cond.true51 ], [ %cond418, %cond.end417 ], !dbg !4342
  br label %cond.end421, !dbg !4342

cond.end421:                                      ; preds = %cond.end419, %cond.true46
  %cond422 = phi i32 [ 56, %cond.true46 ], [ %cond420, %cond.end419 ], !dbg !4342
  br label %cond.end423, !dbg !4342

cond.end423:                                      ; preds = %cond.end421, %cond.true41
  %cond424 = phi i32 [ 57, %cond.true41 ], [ %cond422, %cond.end421 ], !dbg !4342
  br label %cond.end425, !dbg !4342

cond.end425:                                      ; preds = %cond.end423, %cond.true36
  %cond426 = phi i32 [ 58, %cond.true36 ], [ %cond424, %cond.end423 ], !dbg !4342
  br label %cond.end427, !dbg !4342

cond.end427:                                      ; preds = %cond.end425, %cond.true31
  %cond428 = phi i32 [ 59, %cond.true31 ], [ %cond426, %cond.end425 ], !dbg !4342
  br label %cond.end429, !dbg !4342

cond.end429:                                      ; preds = %cond.end427, %cond.true26
  %cond430 = phi i32 [ 60, %cond.true26 ], [ %cond428, %cond.end427 ], !dbg !4342
  br label %cond.end431, !dbg !4342

cond.end431:                                      ; preds = %cond.end429, %cond.true21
  %cond432 = phi i32 [ 61, %cond.true21 ], [ %cond430, %cond.end429 ], !dbg !4342
  br label %cond.end433, !dbg !4342

cond.end433:                                      ; preds = %cond.end431, %cond.true16
  %cond434 = phi i32 [ 62, %cond.true16 ], [ %cond432, %cond.end431 ], !dbg !4342
  br label %cond.end435, !dbg !4342

cond.end435:                                      ; preds = %cond.end433, %cond.true11
  %cond436 = phi i32 [ 63, %cond.true11 ], [ %cond434, %cond.end433 ], !dbg !4342
  br label %cond.end437, !dbg !4342

cond.end437:                                      ; preds = %cond.end435, %cond.true8
  %cond438 = phi i32 [ 0, %cond.true8 ], [ %cond436, %cond.end435 ], !dbg !4342
  br label %cond.end440, !dbg !4342

cond.false439:                                    ; preds = %cond.true
  br label %cond.end440, !dbg !4342

cond.end440:                                      ; preds = %cond.false439, %cond.end437
  %cond441 = phi i32 [ %cond438, %cond.end437 ], [ -1, %cond.false439 ], !dbg !4342
  br label %cond.end444, !dbg !4342

cond.false442:                                    ; preds = %if.end3
  %72 = load i64, i64* %size.addr, align 8, !dbg !4342
  %sub443 = sub i64 %72, 1, !dbg !4342
  %call = call i32 @__ilog2_u64(i64 %sub443) #10, !dbg !4342
  br label %cond.end444, !dbg !4342

cond.end444:                                      ; preds = %cond.false442, %cond.end440
  %cond445 = phi i32 [ %cond441, %cond.end440 ], [ %call, %cond.false442 ], !dbg !4342
  %sub446 = sub i32 %cond445, 12, !dbg !4343
  %add = add i32 %sub446, 1, !dbg !4344
  store i32 %add, i32* %retval, align 4, !dbg !4345
  br label %return, !dbg !4345

if.end447:                                        ; preds = %entry
  %73 = load i64, i64* %size.addr, align 8, !dbg !4346
  %dec = add i64 %73, -1, !dbg !4346
  store i64 %dec, i64* %size.addr, align 8, !dbg !4346
  %74 = load i64, i64* %size.addr, align 8, !dbg !4347
  %shr = lshr i64 %74, 12, !dbg !4347
  store i64 %shr, i64* %size.addr, align 8, !dbg !4347
  %75 = load i64, i64* %size.addr, align 8, !dbg !4348
  store i64 %75, i64* %x.addr.i, align 8
  store i32 -1, i32* %bitpos.i, align 4, !dbg !4325
  %76 = load i32, i32* %bitpos.i, align 4, !dbg !4349
  %77 = load i64, i64* %x.addr.i, align 8, !dbg !4350
  %78 = call i32 asm "bsrq $1,${0:q}", "=r,rm,0,~{dirflag},~{fpsr},~{flags}"(i64 %77, i32 %76) #13, !dbg !4349, !srcloc !4351
  store i32 %78, i32* %bitpos.i, align 4, !dbg !4349
  %79 = load i32, i32* %bitpos.i, align 4, !dbg !4352
  %add.i = add i32 %79, 1, !dbg !4353
  store i32 %add.i, i32* %retval, align 4, !dbg !4354
  br label %return, !dbg !4354

return:                                           ; preds = %if.end447, %cond.end444, %if.then2, %if.then1
  %80 = load i32, i32* %retval, align 4, !dbg !4355
  ret i32 %80, !dbg !4355
}

; Function Attrs: noinline noredzone nounwind optnone readnone sspstrong
define internal i32 @__ilog2_u64(i64 %n) #7 !dbg !4356 {
entry:
  %x.addr.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %x.addr.i, metadata !4317, metadata !DIExpression()), !dbg !4360
  %bitpos.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %bitpos.i, metadata !4324, metadata !DIExpression()), !dbg !4362
  %n.addr = alloca i64, align 8
  store i64 %n, i64* %n.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %n.addr, metadata !4363, metadata !DIExpression()), !dbg !4364
  %0 = load i64, i64* %n.addr, align 8, !dbg !4365
  store i64 %0, i64* %x.addr.i, align 8
  store i32 -1, i32* %bitpos.i, align 4, !dbg !4362
  %1 = load i32, i32* %bitpos.i, align 4, !dbg !4366
  %2 = load i64, i64* %x.addr.i, align 8, !dbg !4367
  %3 = call i32 asm "bsrq $1,${0:q}", "=r,rm,0,~{dirflag},~{fpsr},~{flags}"(i64 %2, i32 %1) #13, !dbg !4366, !srcloc !4351
  store i32 %3, i32* %bitpos.i, align 4, !dbg !4366
  %4 = load i32, i32* %bitpos.i, align 4, !dbg !4368
  %add.i = add i32 %4, 1, !dbg !4369
  %sub = sub i32 %add.i, 1, !dbg !4370
  ret i32 %sub, !dbg !4371
}
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal i8* @kasan_kmalloc(%struct.kmem_cache* %s, i8* %object, i64 %size, i32 %flags) #2 !dbg !4372 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.kmem_cache** %s.addr, metadata !4375, metadata !DIExpression()), !dbg !4376
  store i8* %object, i8** %object.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %object.addr, metadata !4377, metadata !DIExpression()), !dbg !4378
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !4379, metadata !DIExpression()), !dbg !4380
  store i32 %flags, i32* %flags.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr, metadata !4381, metadata !DIExpression()), !dbg !4382
  %0 = load i8*, i8** %object.addr, align 8, !dbg !4383
  ret i8* %0, !dbg !4384
}
...
!1 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_ehset_driver_init211", scope: !2, file: !3, line: 141, type: !129, isLocal: true, isDefinition: true)
!2 = distinct !DICompileUnit(language: DW_LANG_C89, file: !3, producer: "clang version 10.0.1 (https://github.com/llvm/llvm-project.git ef32c611aa214dea855364efd7ba451ec5ec3f74)", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !120, globals: !3806, splitDebugInlining: false, nameTableKind: None)
!3 = !DIFile(filename: "drivers/usb/misc/ehset.c", directory: "/home/lizy2001/genbc/linux")
...
!124 = !DIDerivedType(tag: DW_TAG_typedef, name: "__u16", file: !125, line: 24, baseType: !126)
...
!127 = !DIDerivedType(tag: DW_TAG_typedef, name: "__le16", file: !128, line: 29, baseType: !124)
!128 = !DIFile(filename: "./include/uapi/linux/types.h", directory: "/home/lizy2001/genbc/linux")
...
!145 = !DIDerivedType(tag: DW_TAG_typedef, name: "__u32", file: !125, line: 27, baseType: !7)
...
!175 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "list_head", file: !131, line: 178, size: 128, elements: !176)
!176 = !{!177, !179}
!177 = !DIDerivedType(tag: DW_TAG_member, name: "next", scope: !175, file: !131, line: 179, baseType: !178, size: 64)
!178 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !175, size: 64)
!179 = !DIDerivedType(tag: DW_TAG_member, name: "prev", scope: !175, file: !131, line: 179, baseType: !178, size: 64, offset: 64)
...
!259 = !{!260, !181, !265, !229}
!260 = !DIDerivedType(tag: DW_TAG_typedef, name: "ssize_t", file: !131, line: 60, baseType: !261)
...
!270 = !DIDerivedType(tag: DW_TAG_typedef, name: "umode_t", file: !131, line: 19, baseType: !126)
...
!275 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !131, line: 55, baseType: !276)
...
!301 = !DIDerivedType(tag: DW_TAG_member, name: "private", scope: !297, file: !254, line: 171, baseType: !129, size: 64, offset: 192)
...
!319 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "callback_head", file: !131, line: 216, size: 128, align: 64, elements: !320)
!320 = !{!321, !323}
!321 = !DIDerivedType(tag: DW_TAG_member, name: "next", scope: !319, file: !131, line: 217, baseType: !322, size: 64)
!322 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !319, size: 64)
!323 = !DIDerivedType(tag: DW_TAG_member, name: "func", scope: !319, file: !131, line: 218, baseType: !324, size: 64, offset: 64)
...
!372 = !DIDerivedType(tag: DW_TAG_typedef, name: "__u64", file: !125, line: 31, baseType: !373)
...
!383 = !DIDerivedType(tag: DW_TAG_member, name: "i_opflags", scope: !380, file: !38, line: 612, baseType: !126, size: 16, offset: 16)
...
!390 = !DIDerivedType(tag: DW_TAG_typedef, name: "uid_t", file: !131, line: 32, baseType: !391)
...
!397 = !DIDerivedType(tag: DW_TAG_typedef, name: "gid_t", file: !131, line: 33, baseType: !398)
...
!420 = !{null, !129}
!421 = !DIDerivedType(tag: DW_TAG_member, name: "arg", scope: !414, file: !415, line: 12, baseType: !129, size: 64, offset: 64)
...
!440 = !DIDerivedType(tag: DW_TAG_typedef, name: "bool", file: !131, line: 30, baseType: !441)
...
!463 = !DIDerivedType(tag: DW_TAG_typedef, name: "dev_t", file: !131, line: 16, baseType: !464)
!464 = !DIDerivedType(tag: DW_TAG_typedef, name: "__kernel_dev_t", file: !131, line: 13, baseType: !143)
...
!481 = !DIDerivedType(tag: DW_TAG_typedef, name: "loff_t", file: !131, line: 46, baseType: !482)
...
!490 = !DIDerivedType(tag: DW_TAG_typedef, name: "__s64", file: !125, line: 30, baseType: !483)
...
!509 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint32_t", file: !131, line: 104, baseType: !143)
...
!585 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "hlist_head", file: !131, line: 182, size: 64, elements: !586)
!586 = !{!587}
!587 = !DIDerivedType(tag: DW_TAG_member, name: "first", scope: !585, file: !131, line: 183, baseType: !588, size: 64)
!588 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !589, size: 64)
!589 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "hlist_node", file: !131, line: 186, size: 128, elements: !590)
!590 = !{!591, !592}
!591 = !DIDerivedType(tag: DW_TAG_member, name: "next", scope: !589, file: !131, line: 187, baseType: !588, size: 64)
!592 = !DIDerivedType(tag: DW_TAG_member, name: "pprev", scope: !589, file: !131, line: 187, baseType: !593, size: 64, offset: 64)
...
!693 = !DIDerivedType(tag: DW_TAG_member, name: "xa_flags", scope: !689, file: !690, line: 295, baseType: !130, size: 32)
!694 = !DIDerivedType(tag: DW_TAG_member, name: "xa_head", scope: !689, file: !690, line: 296, baseType: !129, size: 64, offset: 64)
!695 = !DIDerivedType(tag: DW_TAG_member, name: "gfp_mask", scope: !685, file: !38, line: 454, baseType: !130, size: 32, offset: 192)
!696 = !DIDerivedType(tag: DW_TAG_member, name: "i_mmap_writable", scope: !685, file: !38, line: 455, baseType: !697, size: 32, offset: 224)
!697 = !DIDerivedType(tag: DW_TAG_typedef, name: "atomic_t", file: !131, line: 168, baseType: !698)
!698 = distinct !DICompositeType(tag: DW_TAG_structure_type, file: !131, line: 166, size: 32, elements: !699)
!699 = !{!700}
!700 = !DIDerivedType(tag: DW_TAG_member, name: "counter", scope: !698, file: !131, line: 167, baseType: !136, size: 32)
...
!723 = !DIDerivedType(tag: DW_TAG_typedef, name: "atomic64_t", file: !131, line: 175, baseType: !724)
!724 = distinct !DICompositeType(tag: DW_TAG_structure_type, file: !131, line: 173, size: 64, elements: !725)
!725 = !{!726}
!726 = !DIDerivedType(tag: DW_TAG_member, name: "counter", scope: !724, file: !131, line: 174, baseType: !727, size: 64)
...
!771 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !129, size: 64)
...
!775 = !{!136, !306, !684, !481, !7, !7, !671, !129}
...
!779 = !{!780, !684, !780}
!780 = !DIDerivedType(tag: DW_TAG_typedef, name: "sector_t", file: !131, line: 125, baseType: !371)
...
!806 = !DIDerivedType(tag: DW_TAG_member, name: "private", scope: !798, file: !38, line: 328, baseType: !129, size: 64, offset: 192)
...
!809 = !DIDerivedType(tag: DW_TAG_typedef, name: "u16", file: !144, line: 19, baseType: !124)
...
!862 = !DIDerivedType(tag: DW_TAG_member, name: "private_data", scope: !685, file: !38, line: 470, baseType: !129, size: 64, offset: 1152)
...
!869 = !DIDerivedType(tag: DW_TAG_typedef, name: "dma_addr_t", file: !131, line: 143, baseType: !371)
...
!886 = !DIDerivedType(tag: DW_TAG_member, name: "freelist", scope: !871, file: !673, line: 119, baseType: !129, size: 64, offset: 192)
...
!889 = !{!890, !891, !892}
!890 = !DIDerivedType(tag: DW_TAG_member, name: "s_mem", scope: !888, file: !673, line: 121, baseType: !129, size: 64)
...
!963 = !DIDerivedType(tag: DW_TAG_member, name: "vm_private_data", scope: !931, file: !673, line: 362, baseType: !129, size: 64, offset: 1344)
...
!1040 = !DIDerivedType(tag: DW_TAG_member, name: "ia32_compat", scope: !1032, file: !1031, line: 37, baseType: !126, size: 16, offset: 448)
...
!1048 = !DIDerivedType(tag: DW_TAG_member, name: "vdso", scope: !1032, file: !1031, line: 41, baseType: !129, size: 64, offset: 704)
...
!1055 = !DIDerivedType(tag: DW_TAG_member, name: "data", scope: !1052, file: !1053, line: 14, baseType: !129, size: 64)
...
!1073 = !DIDerivedType(tag: DW_TAG_typedef, name: "__s16", file: !125, line: 23, baseType: !1074)
...
!1097 = !DIDerivedType(tag: DW_TAG_member, name: "stack", scope: !1086, file: !1087, line: 657, baseType: !129, size: 64, offset: 192)
...
!1140 = !DIDerivedType(tag: DW_TAG_member, name: "on_rq", scope: !1134, file: !1087, line: 494, baseType: !126, size: 16, offset: 288)
!1141 = !DIDerivedType(tag: DW_TAG_member, name: "on_list", scope: !1134, file: !1087, line: 495, baseType: !126, size: 16, offset: 304)
...
!1203 = !DIDerivedType(tag: DW_TAG_typedef, name: "clockid_t", file: !131, line: 27, baseType: !1204)
...
!1222 = !DIDerivedType(tag: DW_TAG_typedef, name: "__u8", file: !125, line: 21, baseType: !377)
...
!1314 = !DIDerivedType(tag: DW_TAG_typedef, name: "__s32", file: !125, line: 26, baseType: !136)
...
!1328 = !DIDerivedType(tag: DW_TAG_typedef, name: "pid_t", file: !131, line: 22, baseType: !1329)
...
!1451 = !DIDerivedType(tag: DW_TAG_typedef, name: "int32_t", file: !131, line: 98, baseType: !1313)
...
!1461 = !DIDerivedType(tag: DW_TAG_member, name: "security", scope: !1445, file: !1446, line: 201, baseType: !129, size: 64, offset: 576)
...
!1472 = !DIDerivedType(tag: DW_TAG_member, name: "quotalen", scope: !1445, file: !1446, line: 210, baseType: !126, size: 16, offset: 864)
!1473 = !DIDerivedType(tag: DW_TAG_member, name: "datalen", scope: !1445, file: !1446, line: 211, baseType: !126, size: 16, offset: 880)
...
!1519 = !{!1520, !1521}
!1520 = !DIDerivedType(tag: DW_TAG_member, name: "rcu_data0", scope: !1518, file: !1446, line: 129, baseType: !129, size: 64)
!1521 = !DIDerivedType(tag: DW_TAG_member, name: "data", scope: !1518, file: !1446, line: 130, baseType: !1522, size: 256)
!1522 = !DICompositeType(tag: DW_TAG_array_type, baseType: !129, size: 256, elements: !1024)
...
!1581 = !DICompositeType(tag: DW_TAG_structure_type, name: "user_namespace", file: !386, line: 18, flags: DIFlagFwdDecl)
...
!1778 = !DIDerivedType(tag: DW_TAG_member, name: "journal_info", scope: !1086, file: !1087, line: 1043, baseType: !129, size: 64, offset: 10560)
...
!1800 = !DIDerivedType(tag: DW_TAG_member, name: "ioprio", scope: !1793, file: !1794, line: 107, baseType: !126, size: 16, offset: 128)
...
!1869 = !DIDerivedType(tag: DW_TAG_member, name: "sival_ptr", scope: !1866, file: !1851, line: 10, baseType: !129, size: 64)
...
!1888 = !{!1889, !1890}
!1889 = !DIDerivedType(tag: DW_TAG_member, name: "_addr", scope: !1887, file: !1851, line: 65, baseType: !129, size: 64)
...
!1899 = !DIDerivedType(tag: DW_TAG_member, name: "_lower", scope: !1895, file: !1851, line: 86, baseType: !129, size: 64, offset: 64)
!1900 = !DIDerivedType(tag: DW_TAG_member, name: "_upper", scope: !1895, file: !1851, line: 87, baseType: !129, size: 64, offset: 128)
...
!1913 = !{!1914, !1915, !1916}
!1914 = !DIDerivedType(tag: DW_TAG_member, name: "_call_addr", scope: !1912, file: !1851, line: 105, baseType: !129, size: 64)
...
!1984 = !DIDerivedType(tag: DW_TAG_member, name: "mce_vaddr", scope: !1086, file: !1087, line: 1342, baseType: !129, size: 64, offset: 13248)
...
!2014 = !DIDerivedType(tag: DW_TAG_member, name: "es", scope: !1992, file: !1993, line: 495, baseType: !126, size: 16, offset: 256)
!2015 = !DIDerivedType(tag: DW_TAG_member, name: "ds", scope: !1992, file: !1993, line: 496, baseType: !126, size: 16, offset: 272)
!2016 = !DIDerivedType(tag: DW_TAG_member, name: "fsindex", scope: !1992, file: !1993, line: 497, baseType: !126, size: 16, offset: 288)
!2017 = !DIDerivedType(tag: DW_TAG_member, name: "gsindex", scope: !1992, file: !1993, line: 498, baseType: !126, size: 16, offset: 304)
...
!2195 = !DIDerivedType(tag: DW_TAG_member, name: "zone_device_data", scope: !2190, file: !673, line: 162, baseType: !129, size: 64, offset: 64)
...
!2213 = !DIDerivedType(tag: DW_TAG_member, name: "gfp_mask", scope: !2210, file: !2211, line: 13, baseType: !130, size: 32)
...
!2383 = !DIDerivedType(tag: DW_TAG_typedef, name: "blkcnt_t", file: !131, line: 126, baseType: !371)
...
!2454 = !DIDerivedType(tag: DW_TAG_member, name: "dqi_priv", scope: !2425, file: !32, line: 232, baseType: !129, size: 64, offset: 512)
...
!2484 = !DIDerivedType(tag: DW_TAG_member, name: "s_fs_info", scope: !550, file: !38, line: 1465, baseType: !129, size: 64, offset: 6400)
...
!2503 = !DIDerivedType(tag: DW_TAG_typedef, name: "fmode_t", file: !131, line: 150, baseType: !7)
...
!2628 = !DIDerivedType(tag: DW_TAG_member, name: "i_bytes", scope: !380, file: !38, line: 649, baseType: !126, size: 16, offset: 896)
...
!2697 = !{!2698, !306, !2699}
!2698 = !DIDerivedType(tag: DW_TAG_typedef, name: "__poll_t", file: !128, line: 52, baseType: !7)
...
!2718 = !{!136, !306, !2719}
!2719 = !DIDerivedType(tag: DW_TAG_typedef, name: "fl_owner_t", file: !38, line: 1007, baseType: !129)
...
!2901 = !DIDerivedType(tag: DW_TAG_member, name: "i_private", scope: !380, file: !38, line: 720, baseType: !129, size: 64, offset: 4160)
...
!2919 = !DIDerivedType(tag: DW_TAG_member, name: "d_fsdata", scope: !337, file: !334, line: 105, baseType: !129, size: 64, offset: 960)
...
!2963 = !DIDerivedType(tag: DW_TAG_member, name: "private_data", scope: !307, file: !38, line: 945, baseType: !129, size: 64, offset: 1408)
...
!3099 = !DIDerivedType(tag: DW_TAG_member, name: "priv", scope: !3094, file: !569, line: 202, baseType: !129, size: 64, offset: 192)
...
!3149 = !DIDerivedType(tag: DW_TAG_member, name: "priv", scope: !3019, file: !569, line: 148, baseType: !129, size: 64, offset: 768)
!3150 = !DIDerivedType(tag: DW_TAG_member, name: "id", scope: !3019, file: !569, line: 154, baseType: !371, size: 64, offset: 832)
!3151 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !3019, file: !569, line: 156, baseType: !126, size: 16, offset: 896)
...
!3314 = !DIDerivedType(tag: DW_TAG_member, name: "platform_data", scope: !165, file: !67, line: 473, baseType: !129, size: 64, offset: 896)
!3315 = !DIDerivedType(tag: DW_TAG_member, name: "driver_data", scope: !165, file: !67, line: 475, baseType: !129, size: 64, offset: 960)
...
!3558 = !DIDerivedType(tag: DW_TAG_member, name: "wMaxPacketSize", scope: !3552, file: !88, line: 413, baseType: !127, size: 16, offset: 32)
...
!3569 = !DIDerivedType(tag: DW_TAG_member, name: "wBytesPerInterval", scope: !3563, file: !88, line: 695, baseType: !127, size: 16, offset: 32)
...
!3575 = !DIDerivedType(tag: DW_TAG_member, name: "wReseved", scope: !3571, file: !88, line: 680, baseType: !127, size: 16, offset: 16)
!3576 = !DIDerivedType(tag: DW_TAG_member, name: "dwBytesPerInterval", scope: !3571, file: !88, line: 681, baseType: !3577, size: 32, offset: 32)
!3577 = !DIDerivedType(tag: DW_TAG_typedef, name: "__le32", file: !128, line: 31, baseType: !145)
!3578 = !DIDerivedType(tag: DW_TAG_member, name: "urb_list", scope: !3549, file: !6, line: 71, baseType: !175, size: 128, offset: 192)
!3579 = !DIDerivedType(tag: DW_TAG_member, name: "hcpriv", scope: !3549, file: !6, line: 72, baseType: !129, size: 64, offset: 320)
...
!3594 = !DIDerivedType(tag: DW_TAG_member, name: "bcdUSB", scope: !3590, file: !88, line: 293, baseType: !127, size: 16, offset: 16)
...
!3599 = !DIDerivedType(tag: DW_TAG_member, name: "idVendor", scope: !3590, file: !88, line: 298, baseType: !127, size: 16, offset: 64)
!3600 = !DIDerivedType(tag: DW_TAG_member, name: "idProduct", scope: !3590, file: !88, line: 299, baseType: !127, size: 16, offset: 80)
!3601 = !DIDerivedType(tag: DW_TAG_member, name: "bcdDevice", scope: !3590, file: !88, line: 300, baseType: !127, size: 16, offset: 96)
...
!3616 = !DIDerivedType(tag: DW_TAG_member, name: "wTotalLength", scope: !3612, file: !88, line: 848, baseType: !127, size: 16, offset: 16)
...
!3634 = !DIDerivedType(tag: DW_TAG_member, name: "wSpeedSupported", scope: !3628, file: !88, line: 923, baseType: !127, size: 16, offset: 32)
...
!3637 = !DIDerivedType(tag: DW_TAG_member, name: "bU2DevExitLat", scope: !3628, file: !88, line: 930, baseType: !127, size: 16, offset: 64)
...
!3647 = !DIDerivedType(tag: DW_TAG_member, name: "wFunctionalitySupport", scope: !3640, file: !88, line: 963, baseType: !127, size: 16, offset: 64)
!3648 = !DIDerivedType(tag: DW_TAG_member, name: "wReserved", scope: !3640, file: !88, line: 967, baseType: !127, size: 16, offset: 80)
...
!3676 = !DIDerivedType(tag: DW_TAG_member, name: "wTotalLength", scope: !3672, file: !88, line: 353, baseType: !127, size: 16, offset: 16)
...
!3755 = !DIDerivedType(tag: DW_TAG_member, name: "bus_mA", scope: !133, file: !6, line: 661, baseType: !126, size: 16, offset: 9344)
...
!3806 = !{!0, !3807, !3812, !3817, !3822, !3827, !3888}
!3807 = !DIGlobalVariableExpression(var: !3808, expr: !DIExpression())
!3808 = distinct !DIGlobalVariable(name: "__exitcall_ehset_driver_exit", scope: !2, file: !3, line: 141, type: !3809, isLocal: true, isDefinition: true)
...
!3813 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_description212", scope: !2, file: !3, line: 143, type: !3814, isLocal: true, isDefinition: true, align: 8)
!3814 = !DICompositeType(tag: DW_TAG_array_type, baseType: !173, size: 416, elements: !3815)
!3815 = !{!3816}
!3816 = !DISubrange(count: 52)
!3817 = !DIGlobalVariableExpression(var: !3818, expr: !DIExpression())
!3818 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file213", scope: !2, file: !3, line: 144, type: !3819, isLocal: true, isDefinition: true, align: 8)
!3819 = !DICompositeType(tag: DW_TAG_array_type, baseType: !173, size: 272, elements: !3820)
!3820 = !{!3821}
!3821 = !DISubrange(count: 34)
!3822 = !DIGlobalVariableExpression(var: !3823, expr: !DIExpression())
!3823 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license214", scope: !2, file: !3, line: 144, type: !3824, isLocal: true, isDefinition: true, align: 8)
!3824 = !DICompositeType(tag: DW_TAG_array_type, baseType: !173, size: 168, elements: !3825)
!3825 = !{!3826}
!3826 = !DISubrange(count: 21)
!3827 = !DIGlobalVariableExpression(var: !3828, expr: !DIExpression())
!3828 = distinct !DIGlobalVariable(name: "ehset_driver", scope: !2, file: !3, line: 134, type: !3829, isLocal: true, isDefinition: true)
...
!3831 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !3829, file: !6, line: 1185, baseType: !172, size: 64)
...
!3838 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "usb_device_id", file: !3250, line: 121, size: 256, elements: !3839)
!3839 = !{!3840, !3841, !3842, !3843, !3844, !3845, !3846, !3847, !3848, !3849, !3850, !3851, !3852}
!3840 = !DIDerivedType(tag: DW_TAG_member, name: "match_flags", scope: !3838, file: !3250, line: 123, baseType: !124, size: 16)
!3841 = !DIDerivedType(tag: DW_TAG_member, name: "idVendor", scope: !3838, file: !3250, line: 126, baseType: !124, size: 16, offset: 16)
!3842 = !DIDerivedType(tag: DW_TAG_member, name: "idProduct", scope: !3838, file: !3250, line: 127, baseType: !124, size: 16, offset: 32)
!3843 = !DIDerivedType(tag: DW_TAG_member, name: "bcdDevice_lo", scope: !3838, file: !3250, line: 128, baseType: !124, size: 16, offset: 48)
!3844 = !DIDerivedType(tag: DW_TAG_member, name: "bcdDevice_hi", scope: !3838, file: !3250, line: 129, baseType: !124, size: 16, offset: 64)
!3845 = !DIDerivedType(tag: DW_TAG_member, name: "bDeviceClass", scope: !3838, file: !3250, line: 132, baseType: !1222, size: 8, offset: 80)
!3846 = !DIDerivedType(tag: DW_TAG_member, name: "bDeviceSubClass", scope: !3838, file: !3250, line: 133, baseType: !1222, size: 8, offset: 88)
!3847 = !DIDerivedType(tag: DW_TAG_member, name: "bDeviceProtocol", scope: !3838, file: !3250, line: 134, baseType: !1222, size: 8, offset: 96)
!3848 = !DIDerivedType(tag: DW_TAG_member, name: "bInterfaceClass", scope: !3838, file: !3250, line: 137, baseType: !1222, size: 8, offset: 104)
!3849 = !DIDerivedType(tag: DW_TAG_member, name: "bInterfaceSubClass", scope: !3838, file: !3250, line: 138, baseType: !1222, size: 8, offset: 112)
!3850 = !DIDerivedType(tag: DW_TAG_member, name: "bInterfaceProtocol", scope: !3838, file: !3250, line: 139, baseType: !1222, size: 8, offset: 120)
!3851 = !DIDerivedType(tag: DW_TAG_member, name: "bInterfaceNumber", scope: !3838, file: !3250, line: 142, baseType: !1222, size: 8, offset: 128)
!3852 = !DIDerivedType(tag: DW_TAG_member, name: "driver_info", scope: !3838, file: !3250, line: 145, baseType: !3269, size: 64, align: 64, offset: 192)
...
!3873 = !DIDerivedType(tag: DW_TAG_member, name: "dev_groups", scope: !3829, file: !6, line: 1203, baseType: !282, size: 64, offset: 640)
...
!3876 = !{!3877, !3878}
!3877 = !DIDerivedType(tag: DW_TAG_member, name: "lock", scope: !3875, file: !6, line: 1092, baseType: !188)
!3878 = !DIDerivedType(tag: DW_TAG_member, name: "list", scope: !3875, file: !6, line: 1093, baseType: !175, size: 128)
...
!3881 = !{!3882, !3883}
!3882 = !DIDerivedType(tag: DW_TAG_member, name: "driver", scope: !3880, file: !6, line: 1114, baseType: !3238, size: 1152)
!3883 = !DIDerivedType(tag: DW_TAG_member, name: "for_devices", scope: !3880, file: !6, line: 1115, baseType: !136, size: 32, offset: 1152)
...
!3889 = distinct !DIGlobalVariable(name: "ehset_id_table", scope: !2, file: !3, line: 122, type: !3890, isLocal: true, isDefinition: true)
!3890 = !DICompositeType(tag: DW_TAG_array_type, baseType: !3837, size: 2048, elements: !1199)
...
!3896 = distinct !DISubprogram(name: "ehset_driver_init", scope: !3, file: !3, line: 141, type: !3897, scopeLine: 141, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !202)
!3897 = !DISubroutineType(types: !3898)
!3898 = !{!136}
!3899 = !DILocation(line: 141, column: 1, scope: !3896)
!3900 = distinct !DISubprogram(name: "ehset_driver_exit", scope: !3, file: !3, line: 141, type: !1744, scopeLine: 141, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !202)
!3901 = !DILocation(line: 141, column: 1, scope: !3900)
!3902 = distinct !DISubprogram(name: "ehset_probe", scope: !3, file: !3, line: 21, type: !3834, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !202)
!3903 = !DILocalVariable(name: "s", arg: 1, scope: !3904, file: !114, line: 445, type: !884)
!3904 = distinct !DISubprogram(name: "kmem_cache_alloc_trace", scope: !114, file: !114, line: 445, type: !3905, scopeLine: 447, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !202)
!3905 = !DISubroutineType(types: !3906)
!3906 = !{!129, !884, !130, !275}
!3907 = !DILocation(line: 445, column: 72, scope: !3904, inlinedAt: !3908)
!3908 = distinct !DILocation(line: 552, column: 10, scope: !3909, inlinedAt: !3914)
!3909 = distinct !DILexicalBlock(scope: !3910, file: !114, line: 540, column: 34)
!3910 = distinct !DILexicalBlock(scope: !3911, file: !114, line: 540, column: 6)
!3911 = distinct !DISubprogram(name: "kmalloc", scope: !114, file: !114, line: 538, type: !3912, scopeLine: 539, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !202)
!3912 = !DISubroutineType(types: !3913)
!3913 = !{!129, !275, !130}
!3914 = distinct !DILocation(line: 79, column: 9, scope: !3915)
!3915 = distinct !DILexicalBlock(scope: !3902, file: !3, line: 31, column: 20)
!3916 = !DILocalVariable(name: "flags", arg: 2, scope: !3904, file: !114, line: 446, type: !130)
!3917 = !DILocation(line: 446, column: 9, scope: !3904, inlinedAt: !3908)
!3918 = !DILocalVariable(name: "size", arg: 3, scope: !3904, file: !114, line: 446, type: !275)
!3919 = !DILocation(line: 446, column: 23, scope: !3904, inlinedAt: !3908)
!3920 = !DILocalVariable(name: "ret", scope: !3904, file: !114, line: 448, type: !129)
!3921 = !DILocation(line: 448, column: 8, scope: !3904, inlinedAt: !3908)
!3922 = !DILocalVariable(name: "flags", arg: 1, scope: !3923, file: !114, line: 318, type: !130)
!3923 = distinct !DISubprogram(name: "kmalloc_type", scope: !114, file: !114, line: 318, type: !3924, scopeLine: 319, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !202)
!3924 = !DISubroutineType(types: !3925)
!3925 = !{!113, !130}
!3926 = !DILocation(line: 318, column: 67, scope: !3923, inlinedAt: !3927)
!3927 = distinct !DILocation(line: 553, column: 20, scope: !3909, inlinedAt: !3914)
!3928 = !DILocalVariable(name: "size", arg: 1, scope: !3929, file: !114, line: 346, type: !275)
!3929 = distinct !DISubprogram(name: "kmalloc_index", scope: !114, file: !114, line: 346, type: !3930, scopeLine: 347, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !202)
!3930 = !DISubroutineType(types: !3931)
!3931 = !{!7, !275}
!3932 = !DILocation(line: 346, column: 58, scope: !3929, inlinedAt: !3933)
!3933 = distinct !DILocation(line: 547, column: 11, scope: !3909, inlinedAt: !3914)
!3934 = !DILocalVariable(name: "size", arg: 1, scope: !3935, file: !114, line: 472, type: !275)
!3935 = distinct !DISubprogram(name: "kmalloc_order_trace", scope: !114, file: !114, line: 472, type: !3936, scopeLine: 473, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !202)
!3936 = !DISubroutineType(types: !3937)
!3937 = !{!129, !275, !130, !7}
!3938 = !DILocation(line: 472, column: 28, scope: !3935, inlinedAt: !3939)
!3939 = distinct !DILocation(line: 481, column: 9, scope: !3940, inlinedAt: !3941)
!3940 = distinct !DISubprogram(name: "kmalloc_large", scope: !114, file: !114, line: 478, type: !3912, scopeLine: 479, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !202)
!3941 = distinct !DILocation(line: 545, column: 11, scope: !3942, inlinedAt: !3914)
!3942 = distinct !DILexicalBlock(scope: !3909, file: !114, line: 544, column: 7)
!3943 = !DILocalVariable(name: "flags", arg: 2, scope: !3935, file: !114, line: 472, type: !130)
!3944 = !DILocation(line: 472, column: 40, scope: !3935, inlinedAt: !3939)
!3945 = !DILocalVariable(name: "order", arg: 3, scope: !3935, file: !114, line: 472, type: !7)
!3946 = !DILocation(line: 472, column: 60, scope: !3935, inlinedAt: !3939)
!3947 = !DILocalVariable(name: "size", arg: 1, scope: !3940, file: !114, line: 478, type: !275)
!3948 = !DILocation(line: 478, column: 51, scope: !3940, inlinedAt: !3941)
!3949 = !DILocalVariable(name: "flags", arg: 2, scope: !3940, file: !114, line: 478, type: !130)
!3950 = !DILocation(line: 478, column: 63, scope: !3940, inlinedAt: !3941)
!3951 = !DILocalVariable(name: "order", scope: !3940, file: !114, line: 480, type: !7)
!3952 = !DILocation(line: 480, column: 15, scope: !3940, inlinedAt: !3941)
!3953 = !DILocalVariable(name: "size", arg: 1, scope: !3911, file: !114, line: 538, type: !275)
!3954 = !DILocation(line: 538, column: 45, scope: !3911, inlinedAt: !3914)
!3955 = !DILocalVariable(name: "flags", arg: 2, scope: !3911, file: !114, line: 538, type: !130)
!3956 = !DILocation(line: 538, column: 57, scope: !3911, inlinedAt: !3914)
!3957 = !DILocalVariable(name: "index", scope: !3909, file: !114, line: 542, type: !7)
!3958 = !DILocation(line: 542, column: 16, scope: !3909, inlinedAt: !3914)
!3959 = !DILocalVariable(name: "intf", arg: 1, scope: !3902, file: !3, line: 21, type: !3698)
!3960 = !DILocation(line: 21, column: 46, scope: !3902)
!3961 = !DILocalVariable(name: "id", arg: 2, scope: !3902, file: !3, line: 22, type: !3836)
!3962 = !DILocation(line: 22, column: 38, scope: !3902)
!3963 = !DILocalVariable(name: "ret", scope: !3902, file: !3, line: 24, type: !136)
!3964 = !DILocation(line: 24, column: 6, scope: !3902)
!3965 = !DILocalVariable(name: "dev", scope: !3902, file: !3, line: 25, type: !132)
!3966 = !DILocation(line: 25, column: 21, scope: !3902)
!3967 = !DILocation(line: 25, column: 47, scope: !3902)
!3968 = !DILocation(line: 25, column: 27, scope: !3902)
!3969 = !DILocalVariable(name: "hub_udev", scope: !3902, file: !3, line: 26, type: !132)
!3970 = !DILocation(line: 26, column: 21, scope: !3902)
!3971 = !DILocation(line: 26, column: 32, scope: !3902)
!3972 = !DILocation(line: 26, column: 37, scope: !3902)
!3973 = !DILocalVariable(name: "buf", scope: !3902, file: !3, line: 27, type: !3974)
!3974 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !3590, size: 64)
!3975 = !DILocation(line: 27, column: 32, scope: !3902)
!3976 = !DILocalVariable(name: "portnum", scope: !3902, file: !3, line: 28, type: !1221)
!3977 = !DILocation(line: 28, column: 5, scope: !3902)
!3978 = !DILocation(line: 28, column: 15, scope: !3902)
!3979 = !DILocation(line: 28, column: 20, scope: !3902)
!3980 = !DILocalVariable(name: "test_pid", scope: !3902, file: !3, line: 29, type: !809)
!3981 = !DILocation(line: 29, column: 6, scope: !3902)
!3982 = !DILocation(line: 29, column: 17, scope: !3902)
!3983 = !DILocation(line: 31, column: 10, scope: !3902)
!3984 = !DILocation(line: 31, column: 2, scope: !3902)
!3985 = !DILocation(line: 33, column: 25, scope: !3915)
!3986 = !DILocation(line: 33, column: 35, scope: !3915)
!3987 = !DILocation(line: 36, column: 32, scope: !3915)
!3988 = !DILocation(line: 36, column: 30, scope: !3915)
!3989 = !DILocation(line: 36, column: 6, scope: !3915)
!3990 = !DILocation(line: 33, column: 9, scope: !3915)
!3991 = !DILocation(line: 33, column: 7, scope: !3915)
!3992 = !DILocation(line: 38, column: 3, scope: !3915)
!3993 = !DILocation(line: 40, column: 25, scope: !3915)
!3994 = !DILocation(line: 40, column: 35, scope: !3915)
!3995 = !DILocation(line: 43, column: 26, scope: !3915)
!3996 = !DILocation(line: 43, column: 24, scope: !3915)
!3997 = !DILocation(line: 43, column: 6, scope: !3915)
!3998 = !DILocation(line: 40, column: 9, scope: !3915)
!3999 = !DILocation(line: 40, column: 7, scope: !3915)
!4000 = !DILocation(line: 45, column: 3, scope: !3915)
!4001 = !DILocation(line: 47, column: 25, scope: !3915)
!4002 = !DILocation(line: 47, column: 35, scope: !3915)
!4003 = !DILocation(line: 50, column: 26, scope: !3915)
!4004 = !DILocation(line: 50, column: 24, scope: !3915)
!4005 = !DILocation(line: 50, column: 6, scope: !3915)
!4006 = !DILocation(line: 47, column: 9, scope: !3915)
!4007 = !DILocation(line: 47, column: 7, scope: !3915)
!4008 = !DILocation(line: 52, column: 3, scope: !3915)
!4009 = !DILocation(line: 54, column: 25, scope: !3915)
!4010 = !DILocation(line: 54, column: 35, scope: !3915)
!4011 = !DILocation(line: 57, column: 31, scope: !3915)
!4012 = !DILocation(line: 57, column: 29, scope: !3915)
!4013 = !DILocation(line: 57, column: 6, scope: !3915)
!4014 = !DILocation(line: 54, column: 9, scope: !3915)
!4015 = !DILocation(line: 54, column: 7, scope: !3915)
!4016 = !DILocation(line: 59, column: 3, scope: !3915)
!4017 = !DILocation(line: 62, column: 3, scope: !3915)
!4018 = !DILocation(line: 63, column: 25, scope: !3915)
!4019 = !DILocation(line: 63, column: 35, scope: !3915)
!4020 = !DILocation(line: 65, column: 29, scope: !3915)
!4021 = !DILocation(line: 63, column: 9, scope: !3915)
!4022 = !DILocation(line: 63, column: 7, scope: !3915)
!4023 = !DILocation(line: 67, column: 7, scope: !4024)
!4024 = distinct !DILexicalBlock(scope: !3915, file: !3, line: 67, column: 7)
!4025 = !DILocation(line: 67, column: 11, scope: !4024)
!4026 = !DILocation(line: 67, column: 7, scope: !3915)
!4027 = !DILocation(line: 68, column: 4, scope: !4024)
!4028 = !DILocation(line: 70, column: 3, scope: !3915)
!4029 = !DILocation(line: 71, column: 25, scope: !3915)
!4030 = !DILocation(line: 71, column: 35, scope: !3915)
!4031 = !DILocation(line: 73, column: 29, scope: !3915)
!4032 = !DILocation(line: 71, column: 9, scope: !3915)
!4033 = !DILocation(line: 71, column: 7, scope: !3915)
!4034 = !DILocation(line: 75, column: 3, scope: !3915)
!4035 = !DILocation(line: 78, column: 3, scope: !3915)
!4036 = !DILocation(line: 540, column: 27, scope: !3910, inlinedAt: !3914)
!4037 = !DILocation(line: 540, column: 6, scope: !3910, inlinedAt: !3914)
!4038 = !DILocation(line: 540, column: 6, scope: !3911, inlinedAt: !3914)
!4039 = !DILocation(line: 544, column: 7, scope: !3942, inlinedAt: !3914)
!4040 = !DILocation(line: 544, column: 12, scope: !3942, inlinedAt: !3914)
!4041 = !DILocation(line: 544, column: 7, scope: !3909, inlinedAt: !3914)
!4042 = !DILocation(line: 545, column: 25, scope: !3942, inlinedAt: !3914)
!4043 = !DILocation(line: 545, column: 31, scope: !3942, inlinedAt: !3914)
!4044 = !DILocation(line: 480, column: 33, scope: !3940, inlinedAt: !3941)
!4045 = !DILocation(line: 480, column: 23, scope: !3940, inlinedAt: !3941)
!4046 = !DILocation(line: 481, column: 29, scope: !3940, inlinedAt: !3941)
!4047 = !DILocation(line: 481, column: 35, scope: !3940, inlinedAt: !3941)
!4048 = !DILocation(line: 481, column: 42, scope: !3940, inlinedAt: !3941)
!4049 = !DILocation(line: 474, column: 23, scope: !3935, inlinedAt: !3939)
!4050 = !DILocation(line: 474, column: 29, scope: !3935, inlinedAt: !3939)
!4051 = !DILocation(line: 474, column: 36, scope: !3935, inlinedAt: !3939)
!4052 = !DILocation(line: 474, column: 9, scope: !3935, inlinedAt: !3939)
!4053 = !DILocation(line: 545, column: 4, scope: !3942, inlinedAt: !3914)
!4054 = !DILocation(line: 547, column: 25, scope: !3909, inlinedAt: !3914)
!4055 = !DILocation(line: 348, column: 7, scope: !4056, inlinedAt: !3933)
!4056 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 348, column: 6)
!4057 = !DILocation(line: 348, column: 6, scope: !3929, inlinedAt: !3933)
!4058 = !DILocation(line: 349, column: 3, scope: !4056, inlinedAt: !3933)
!4059 = !DILocation(line: 351, column: 6, scope: !4060, inlinedAt: !3933)
!4060 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 351, column: 6)
!4061 = !DILocation(line: 351, column: 11, scope: !4060, inlinedAt: !3933)
!4062 = !DILocation(line: 351, column: 6, scope: !3929, inlinedAt: !3933)
!4063 = !DILocation(line: 352, column: 3, scope: !4060, inlinedAt: !3933)
!4064 = !DILocation(line: 354, column: 32, scope: !4065, inlinedAt: !3933)
!4065 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 354, column: 6)
!4066 = !DILocation(line: 354, column: 37, scope: !4065, inlinedAt: !3933)
!4067 = !DILocation(line: 354, column: 42, scope: !4065, inlinedAt: !3933)
!4068 = !DILocation(line: 354, column: 45, scope: !4065, inlinedAt: !3933)
!4069 = !DILocation(line: 354, column: 50, scope: !4065, inlinedAt: !3933)
!4070 = !DILocation(line: 354, column: 6, scope: !3929, inlinedAt: !3933)
!4071 = !DILocation(line: 355, column: 3, scope: !4065, inlinedAt: !3933)
!4072 = !DILocation(line: 356, column: 32, scope: !4073, inlinedAt: !3933)
!4073 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 356, column: 6)
!4074 = !DILocation(line: 356, column: 37, scope: !4073, inlinedAt: !3933)
!4075 = !DILocation(line: 356, column: 43, scope: !4073, inlinedAt: !3933)
!4076 = !DILocation(line: 356, column: 46, scope: !4073, inlinedAt: !3933)
!4077 = !DILocation(line: 356, column: 51, scope: !4073, inlinedAt: !3933)
!4078 = !DILocation(line: 356, column: 6, scope: !3929, inlinedAt: !3933)
!4079 = !DILocation(line: 357, column: 3, scope: !4073, inlinedAt: !3933)
!4080 = !DILocation(line: 358, column: 6, scope: !4081, inlinedAt: !3933)
!4081 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 358, column: 6)
!4082 = !DILocation(line: 358, column: 11, scope: !4081, inlinedAt: !3933)
!4083 = !DILocation(line: 358, column: 6, scope: !3929, inlinedAt: !3933)
!4084 = !DILocation(line: 358, column: 26, scope: !4081, inlinedAt: !3933)
!4085 = !DILocation(line: 359, column: 6, scope: !4086, inlinedAt: !3933)
!4086 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 359, column: 6)
!4087 = !DILocation(line: 359, column: 11, scope: !4086, inlinedAt: !3933)
!4088 = !DILocation(line: 359, column: 6, scope: !3929, inlinedAt: !3933)
!4089 = !DILocation(line: 359, column: 26, scope: !4086, inlinedAt: !3933)
!4090 = !DILocation(line: 360, column: 6, scope: !4091, inlinedAt: !3933)
!4091 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 360, column: 6)
!4092 = !DILocation(line: 360, column: 11, scope: !4091, inlinedAt: !3933)
!4093 = !DILocation(line: 360, column: 6, scope: !3929, inlinedAt: !3933)
!4094 = !DILocation(line: 360, column: 26, scope: !4091, inlinedAt: !3933)
!4095 = !DILocation(line: 361, column: 6, scope: !4096, inlinedAt: !3933)
!4096 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 361, column: 6)
!4097 = !DILocation(line: 361, column: 11, scope: !4096, inlinedAt: !3933)
!4098 = !DILocation(line: 361, column: 6, scope: !3929, inlinedAt: !3933)
!4099 = !DILocation(line: 361, column: 26, scope: !4096, inlinedAt: !3933)
!4100 = !DILocation(line: 362, column: 6, scope: !4101, inlinedAt: !3933)
!4101 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 362, column: 6)
!4102 = !DILocation(line: 362, column: 11, scope: !4101, inlinedAt: !3933)
!4103 = !DILocation(line: 362, column: 6, scope: !3929, inlinedAt: !3933)
!4104 = !DILocation(line: 362, column: 26, scope: !4101, inlinedAt: !3933)
!4105 = !DILocation(line: 363, column: 6, scope: !4106, inlinedAt: !3933)
!4106 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 363, column: 6)
!4107 = !DILocation(line: 363, column: 11, scope: !4106, inlinedAt: !3933)
!4108 = !DILocation(line: 363, column: 6, scope: !3929, inlinedAt: !3933)
!4109 = !DILocation(line: 363, column: 26, scope: !4106, inlinedAt: !3933)
!4110 = !DILocation(line: 364, column: 6, scope: !4111, inlinedAt: !3933)
!4111 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 364, column: 6)
!4112 = !DILocation(line: 364, column: 11, scope: !4111, inlinedAt: !3933)
!4113 = !DILocation(line: 364, column: 6, scope: !3929, inlinedAt: !3933)
!4114 = !DILocation(line: 364, column: 26, scope: !4111, inlinedAt: !3933)
!4115 = !DILocation(line: 365, column: 6, scope: !4116, inlinedAt: !3933)
!4116 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 365, column: 6)
!4117 = !DILocation(line: 365, column: 11, scope: !4116, inlinedAt: !3933)
!4118 = !DILocation(line: 365, column: 6, scope: !3929, inlinedAt: !3933)
!4119 = !DILocation(line: 365, column: 26, scope: !4116, inlinedAt: !3933)
!4120 = !DILocation(line: 366, column: 6, scope: !4121, inlinedAt: !3933)
!4121 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 366, column: 6)
!4122 = !DILocation(line: 366, column: 11, scope: !4121, inlinedAt: !3933)
!4123 = !DILocation(line: 366, column: 6, scope: !3929, inlinedAt: !3933)
!4124 = !DILocation(line: 366, column: 26, scope: !4121, inlinedAt: !3933)
!4125 = !DILocation(line: 367, column: 6, scope: !4126, inlinedAt: !3933)
!4126 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 367, column: 6)
!4127 = !DILocation(line: 367, column: 11, scope: !4126, inlinedAt: !3933)
!4128 = !DILocation(line: 367, column: 6, scope: !3929, inlinedAt: !3933)
!4129 = !DILocation(line: 367, column: 26, scope: !4126, inlinedAt: !3933)
!4130 = !DILocation(line: 368, column: 6, scope: !4131, inlinedAt: !3933)
!4131 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 368, column: 6)
!4132 = !DILocation(line: 368, column: 11, scope: !4131, inlinedAt: !3933)
!4133 = !DILocation(line: 368, column: 6, scope: !3929, inlinedAt: !3933)
!4134 = !DILocation(line: 368, column: 26, scope: !4131, inlinedAt: !3933)
!4135 = !DILocation(line: 369, column: 6, scope: !4136, inlinedAt: !3933)
!4136 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 369, column: 6)
!4137 = !DILocation(line: 369, column: 11, scope: !4136, inlinedAt: !3933)
!4138 = !DILocation(line: 369, column: 6, scope: !3929, inlinedAt: !3933)
!4139 = !DILocation(line: 369, column: 26, scope: !4136, inlinedAt: !3933)
!4140 = !DILocation(line: 370, column: 6, scope: !4141, inlinedAt: !3933)
!4141 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 370, column: 6)
!4142 = !DILocation(line: 370, column: 11, scope: !4141, inlinedAt: !3933)
!4143 = !DILocation(line: 370, column: 6, scope: !3929, inlinedAt: !3933)
!4144 = !DILocation(line: 370, column: 26, scope: !4141, inlinedAt: !3933)
!4145 = !DILocation(line: 371, column: 6, scope: !4146, inlinedAt: !3933)
!4146 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 371, column: 6)
!4147 = !DILocation(line: 371, column: 11, scope: !4146, inlinedAt: !3933)
!4148 = !DILocation(line: 371, column: 6, scope: !3929, inlinedAt: !3933)
!4149 = !DILocation(line: 371, column: 26, scope: !4146, inlinedAt: !3933)
!4150 = !DILocation(line: 372, column: 6, scope: !4151, inlinedAt: !3933)
!4151 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 372, column: 6)
!4152 = !DILocation(line: 372, column: 11, scope: !4151, inlinedAt: !3933)
!4153 = !DILocation(line: 372, column: 6, scope: !3929, inlinedAt: !3933)
!4154 = !DILocation(line: 372, column: 26, scope: !4151, inlinedAt: !3933)
!4155 = !DILocation(line: 373, column: 6, scope: !4156, inlinedAt: !3933)
!4156 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 373, column: 6)
!4157 = !DILocation(line: 373, column: 11, scope: !4156, inlinedAt: !3933)
!4158 = !DILocation(line: 373, column: 6, scope: !3929, inlinedAt: !3933)
!4159 = !DILocation(line: 373, column: 26, scope: !4156, inlinedAt: !3933)
!4160 = !DILocation(line: 374, column: 6, scope: !4161, inlinedAt: !3933)
!4161 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 374, column: 6)
!4162 = !DILocation(line: 374, column: 11, scope: !4161, inlinedAt: !3933)
!4163 = !DILocation(line: 374, column: 6, scope: !3929, inlinedAt: !3933)
!4164 = !DILocation(line: 374, column: 26, scope: !4161, inlinedAt: !3933)
!4165 = !DILocation(line: 375, column: 6, scope: !4166, inlinedAt: !3933)
!4166 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 375, column: 6)
!4167 = !DILocation(line: 375, column: 11, scope: !4166, inlinedAt: !3933)
!4168 = !DILocation(line: 375, column: 6, scope: !3929, inlinedAt: !3933)
!4169 = !DILocation(line: 375, column: 27, scope: !4166, inlinedAt: !3933)
!4170 = !DILocation(line: 376, column: 6, scope: !4171, inlinedAt: !3933)
!4171 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 376, column: 6)
!4172 = !DILocation(line: 376, column: 11, scope: !4171, inlinedAt: !3933)
!4173 = !DILocation(line: 376, column: 6, scope: !3929, inlinedAt: !3933)
!4174 = !DILocation(line: 376, column: 32, scope: !4171, inlinedAt: !3933)
!4175 = !DILocation(line: 377, column: 6, scope: !4176, inlinedAt: !3933)
!4176 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 377, column: 6)
!4177 = !DILocation(line: 377, column: 11, scope: !4176, inlinedAt: !3933)
!4178 = !DILocation(line: 377, column: 6, scope: !3929, inlinedAt: !3933)
!4179 = !DILocation(line: 377, column: 32, scope: !4176, inlinedAt: !3933)
!4180 = !DILocation(line: 378, column: 6, scope: !4181, inlinedAt: !3933)
!4181 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 378, column: 6)
!4182 = !DILocation(line: 378, column: 11, scope: !4181, inlinedAt: !3933)
!4183 = !DILocation(line: 378, column: 6, scope: !3929, inlinedAt: !3933)
!4184 = !DILocation(line: 378, column: 32, scope: !4181, inlinedAt: !3933)
!4185 = !DILocation(line: 379, column: 6, scope: !4186, inlinedAt: !3933)
!4186 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 379, column: 6)
!4187 = !DILocation(line: 379, column: 11, scope: !4186, inlinedAt: !3933)
!4188 = !DILocation(line: 379, column: 6, scope: !3929, inlinedAt: !3933)
!4189 = !DILocation(line: 379, column: 33, scope: !4186, inlinedAt: !3933)
!4190 = !DILocation(line: 380, column: 6, scope: !4191, inlinedAt: !3933)
!4191 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 380, column: 6)
!4192 = !DILocation(line: 380, column: 11, scope: !4191, inlinedAt: !3933)
!4193 = !DILocation(line: 380, column: 6, scope: !3929, inlinedAt: !3933)
!4194 = !DILocation(line: 380, column: 33, scope: !4191, inlinedAt: !3933)
!4195 = !DILocation(line: 381, column: 6, scope: !4196, inlinedAt: !3933)
!4196 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 381, column: 6)
!4197 = !DILocation(line: 381, column: 11, scope: !4196, inlinedAt: !3933)
!4198 = !DILocation(line: 381, column: 6, scope: !3929, inlinedAt: !3933)
!4199 = !DILocation(line: 381, column: 33, scope: !4196, inlinedAt: !3933)
!4200 = !DILocation(line: 382, column: 2, scope: !4201, inlinedAt: !3933)
!4201 = distinct !DILexicalBlock(scope: !4202, file: !114, line: 382, column: 2)
!4202 = distinct !DILexicalBlock(scope: !3929, file: !114, line: 382, column: 2)
!4203 = !{i32 -2144243577, i32 -2144243548, i32 -2144243502, i32 -2144243444, i32 -2144243390, i32 -2144243336, i32 -2144243281, i32 -2144243250}
!4204 = !DILocation(line: 382, column: 2, scope: !4205, inlinedAt: !3933)
!4205 = distinct !DILexicalBlock(scope: !4206, file: !114, line: 382, column: 2)
!4206 = distinct !DILexicalBlock(scope: !4202, file: !114, line: 382, column: 2)
!4207 = !{i32 -2144242807, i32 -2144242800, i32 -2144242746, i32 -2144242715, i32 -2144242685}
!4208 = !DILocation(line: 382, column: 2, scope: !4206, inlinedAt: !3933)
!4209 = !DILocation(line: 386, column: 1, scope: !3929, inlinedAt: !3933)
!4210 = !DILocation(line: 547, column: 9, scope: !3909, inlinedAt: !3914)
!4211 = !DILocation(line: 549, column: 8, scope: !4212, inlinedAt: !3914)
!4212 = distinct !DILexicalBlock(scope: !3909, file: !114, line: 549, column: 7)
!4213 = !DILocation(line: 549, column: 7, scope: !3909, inlinedAt: !3914)
!4214 = !DILocation(line: 550, column: 4, scope: !4212, inlinedAt: !3914)
!4215 = !DILocation(line: 553, column: 33, scope: !3909, inlinedAt: !3914)
!4216 = !DILocation(line: 325, column: 6, scope: !4217, inlinedAt: !3927)
!4217 = distinct !DILexicalBlock(scope: !3923, file: !114, line: 325, column: 6)
!4218 = !DILocation(line: 325, column: 6, scope: !3923, inlinedAt: !3927)
!4219 = !DILocation(line: 326, column: 3, scope: !4217, inlinedAt: !3927)
!4220 = !DILocation(line: 332, column: 9, scope: !3923, inlinedAt: !3927)
!4221 = !DILocation(line: 332, column: 15, scope: !3923, inlinedAt: !3927)
!4222 = !DILocation(line: 332, column: 2, scope: !3923, inlinedAt: !3927)
!4223 = !DILocation(line: 336, column: 1, scope: !3923, inlinedAt: !3927)
!4224 = !DILocation(line: 553, column: 5, scope: !3909, inlinedAt: !3914)
!4225 = !DILocation(line: 553, column: 41, scope: !3909, inlinedAt: !3914)
!4226 = !DILocation(line: 554, column: 5, scope: !3909, inlinedAt: !3914)
!4227 = !DILocation(line: 554, column: 12, scope: !3909, inlinedAt: !3914)
!4228 = !DILocation(line: 448, column: 31, scope: !3904, inlinedAt: !3908)
!4229 = !DILocation(line: 448, column: 34, scope: !3904, inlinedAt: !3908)
!4230 = !DILocation(line: 448, column: 14, scope: !3904, inlinedAt: !3908)
!4231 = !DILocation(line: 450, column: 22, scope: !3904, inlinedAt: !3908)
!4232 = !DILocation(line: 450, column: 25, scope: !3904, inlinedAt: !3908)
!4233 = !DILocation(line: 450, column: 30, scope: !3904, inlinedAt: !3908)
!4234 = !DILocation(line: 450, column: 36, scope: !3904, inlinedAt: !3908)
!4235 = !DILocation(line: 450, column: 8, scope: !3904, inlinedAt: !3908)
!4236 = !DILocation(line: 450, column: 6, scope: !3904, inlinedAt: !3908)
!4237 = !DILocation(line: 451, column: 9, scope: !3904, inlinedAt: !3908)
!4238 = !DILocation(line: 552, column: 3, scope: !3909, inlinedAt: !3914)
!4239 = !DILocation(line: 557, column: 19, scope: !3911, inlinedAt: !3914)
!4240 = !DILocation(line: 557, column: 25, scope: !3911, inlinedAt: !3914)
!4241 = !DILocation(line: 557, column: 9, scope: !3911, inlinedAt: !3914)
!4242 = !DILocation(line: 557, column: 2, scope: !3911, inlinedAt: !3914)
!4243 = !DILocation(line: 558, column: 1, scope: !3911, inlinedAt: !3914)
!4244 = !DILocation(line: 79, column: 9, scope: !3915)
!4245 = !DILocation(line: 79, column: 7, scope: !3915)
!4246 = !DILocation(line: 80, column: 8, scope: !4247)
!4247 = distinct !DILexicalBlock(scope: !3915, file: !3, line: 80, column: 7)
!4248 = !DILocation(line: 80, column: 7, scope: !3915)
!4249 = !DILocation(line: 81, column: 4, scope: !4247)
!4250 = !DILocation(line: 83, column: 25, scope: !3915)
!4251 = !DILocation(line: 83, column: 30, scope: !3915)
!4252 = !DILocation(line: 86, column: 6, scope: !3915)
!4253 = !DILocation(line: 83, column: 9, scope: !3915)
!4254 = !DILocation(line: 83, column: 7, scope: !3915)
!4255 = !DILocation(line: 88, column: 9, scope: !3915)
!4256 = !DILocation(line: 88, column: 3, scope: !3915)
!4257 = !DILocation(line: 89, column: 3, scope: !3915)
!4258 = !DILocation(line: 98, column: 7, scope: !4259)
!4259 = distinct !DILexicalBlock(scope: !3915, file: !3, line: 98, column: 7)
!4260 = !DILocation(line: 98, column: 19, scope: !4259)
!4261 = !DILocation(line: 98, column: 24, scope: !4259)
!4262 = !DILocation(line: 98, column: 29, scope: !4259)
!4263 = !DILocation(line: 98, column: 16, scope: !4259)
!4264 = !DILocation(line: 98, column: 7, scope: !3915)
!4265 = !DILocation(line: 99, column: 4, scope: !4266)
!4266 = distinct !DILexicalBlock(scope: !4259, file: !3, line: 98, column: 39)
!4267 = !DILocation(line: 100, column: 4, scope: !4266)
!4268 = !DILocation(line: 103, column: 25, scope: !3915)
!4269 = !DILocation(line: 103, column: 35, scope: !3915)
!4270 = !DILocation(line: 106, column: 17, scope: !3915)
!4271 = !DILocation(line: 106, column: 15, scope: !3915)
!4272 = !DILocation(line: 106, column: 6, scope: !3915)
!4273 = !DILocation(line: 103, column: 9, scope: !3915)
!4274 = !DILocation(line: 103, column: 7, scope: !3915)
!4275 = !DILocation(line: 109, column: 3, scope: !3915)
!4276 = !DILocation(line: 111, column: 3, scope: !3915)
!4277 = !DILocation(line: 113, column: 2, scope: !3915)
!4278 = !DILocation(line: 115, column: 10, scope: !3902)
!4279 = !DILocation(line: 115, column: 14, scope: !3902)
!4280 = !DILocation(line: 115, column: 9, scope: !3902)
!4281 = !DILocation(line: 115, column: 21, scope: !3902)
!4282 = !DILocation(line: 115, column: 2, scope: !3902)
!4283 = !DILocation(line: 116, column: 1, scope: !3902)
!4284 = distinct !DISubprogram(name: "ehset_disconnect", scope: !3, file: !3, line: 118, type: !3855, scopeLine: 119, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !202)
!4285 = !DILocalVariable(name: "intf", arg: 1, scope: !4284, file: !3, line: 118, type: !3698)
!4286 = !DILocation(line: 118, column: 52, scope: !4284)
!4287 = !DILocation(line: 120, column: 1, scope: !4284)
!4288 = distinct !DISubprogram(name: "interface_to_usbdev", scope: !6, file: !6, line: 715, type: !4289, scopeLine: 716, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !202)
!4289 = !DISubroutineType(types: !4290)
!4290 = !{!132, !3698}
!4291 = !DILocalVariable(name: "intf", arg: 1, scope: !4288, file: !6, line: 715, type: !3698)
!4292 = !DILocation(line: 715, column: 76, scope: !4288)
!4293 = !DILocalVariable(name: "__mptr", scope: !4294, file: !6, line: 717, type: !129)
!4294 = distinct !DILexicalBlock(scope: !4288, file: !6, line: 717, column: 9)
!4295 = !DILocation(line: 717, column: 9, scope: !4294)
!4296 = !DILocation(line: 717, column: 9, scope: !4297)
!4297 = distinct !DILexicalBlock(scope: !4294, file: !6, line: 717, column: 9)
!4298 = !DILocation(line: 717, column: 2, scope: !4288)
!4299 = distinct !DISubprogram(name: "__create_pipe", scope: !6, file: !6, line: 1945, type: !4300, scopeLine: 1947, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !202)
!4300 = !DISubroutineType(types: !4301)
!4301 = !{!7, !132, !7}
!4302 = !DILocalVariable(name: "dev", arg: 1, scope: !4299, file: !6, line: 1945, type: !132)
!4303 = !DILocation(line: 1945, column: 61, scope: !4299)
!4304 = !DILocalVariable(name: "endpoint", arg: 2, scope: !4299, file: !6, line: 1946, type: !7)
!4305 = !DILocation(line: 1946, column: 16, scope: !4299)
!4306 = !DILocation(line: 1948, column: 10, scope: !4299)
!4307 = !DILocation(line: 1948, column: 15, scope: !4299)
!4308 = !DILocation(line: 1948, column: 22, scope: !4299)
!4309 = !DILocation(line: 1948, column: 31, scope: !4299)
!4310 = !DILocation(line: 1948, column: 40, scope: !4299)
!4311 = !DILocation(line: 1948, column: 28, scope: !4299)
!4312 = !DILocation(line: 1948, column: 2, scope: !4299)
!4313 = distinct !DISubprogram(name: "get_order", scope: !4314, file: !4314, line: 29, type: !4315, scopeLine: 30, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !202)
!4314 = !DIFile(filename: "./include/asm-generic/getorder.h", directory: "/home/lizy2001/genbc/linux")
!4315 = !DISubroutineType(types: !4316)
!4316 = !{!136, !278}
!4317 = !DILocalVariable(name: "x", arg: 1, scope: !4318, file: !4319, line: 366, type: !372)
!4318 = distinct !DISubprogram(name: "fls64", scope: !4319, file: !4319, line: 366, type: !4320, scopeLine: 367, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !202)
!4319 = !DIFile(filename: "./arch/x86/include/asm/bitops.h", directory: "/home/lizy2001/genbc/linux")
!4320 = !DISubroutineType(types: !4321)
!4321 = !{!136, !372}
!4322 = !DILocation(line: 366, column: 40, scope: !4318, inlinedAt: !4323)
!4323 = distinct !DILocation(line: 46, column: 9, scope: !4313)
!4324 = !DILocalVariable(name: "bitpos", scope: !4318, file: !4319, line: 368, type: !136)
!4325 = !DILocation(line: 368, column: 6, scope: !4318, inlinedAt: !4323)
!4326 = !DILocalVariable(name: "size", arg: 1, scope: !4313, file: !4314, line: 29, type: !278)
!4327 = !DILocation(line: 29, column: 63, scope: !4313)
!4328 = !DILocation(line: 31, column: 27, scope: !4329)
!4329 = distinct !DILexicalBlock(scope: !4313, file: !4314, line: 31, column: 6)
!4330 = !DILocation(line: 31, column: 6, scope: !4329)
!4331 = !DILocation(line: 31, column: 6, scope: !4313)
!4332 = !DILocation(line: 32, column: 8, scope: !4333)
!4333 = distinct !DILexicalBlock(scope: !4334, file: !4314, line: 32, column: 7)
!4334 = distinct !DILexicalBlock(scope: !4329, file: !4314, line: 31, column: 34)
!4335 = !DILocation(line: 32, column: 7, scope: !4334)
!4336 = !DILocation(line: 33, column: 4, scope: !4333)
!4337 = !DILocation(line: 35, column: 7, scope: !4338)
!4338 = distinct !DILexicalBlock(scope: !4334, file: !4314, line: 35, column: 7)
!4339 = !DILocation(line: 35, column: 12, scope: !4338)
!4340 = !DILocation(line: 35, column: 7, scope: !4334)
!4341 = !DILocation(line: 36, column: 4, scope: !4338)
!4342 = !DILocation(line: 38, column: 10, scope: !4334)
!4343 = !DILocation(line: 38, column: 28, scope: !4334)
!4344 = !DILocation(line: 38, column: 41, scope: !4334)
!4345 = !DILocation(line: 38, column: 3, scope: !4334)
!4346 = !DILocation(line: 41, column: 6, scope: !4313)
!4347 = !DILocation(line: 42, column: 7, scope: !4313)
!4348 = !DILocation(line: 46, column: 15, scope: !4313)
!4349 = !DILocation(line: 374, column: 2, scope: !4318, inlinedAt: !4323)
!4350 = !DILocation(line: 376, column: 14, scope: !4318, inlinedAt: !4323)
!4351 = !{i32 243179}
!4352 = !DILocation(line: 377, column: 9, scope: !4318, inlinedAt: !4323)
!4353 = !DILocation(line: 377, column: 16, scope: !4318, inlinedAt: !4323)
!4354 = !DILocation(line: 46, column: 2, scope: !4313)
!4355 = !DILocation(line: 48, column: 1, scope: !4313)
!4356 = distinct !DISubprogram(name: "__ilog2_u64", scope: !4357, file: !4357, line: 30, type: !4358, scopeLine: 31, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !202)
!4357 = !DIFile(filename: "./include/linux/log2.h", directory: "/home/lizy2001/genbc/linux")
!4358 = !DISubroutineType(types: !4359)
!4359 = !{!136, !371}
!4360 = !DILocation(line: 366, column: 40, scope: !4318, inlinedAt: !4361)
!4361 = distinct !DILocation(line: 32, column: 9, scope: !4356)
!4362 = !DILocation(line: 368, column: 6, scope: !4318, inlinedAt: !4361)
!4363 = !DILocalVariable(name: "n", arg: 1, scope: !4356, file: !4357, line: 30, type: !371)
!4364 = !DILocation(line: 30, column: 21, scope: !4356)
!4365 = !DILocation(line: 32, column: 15, scope: !4356)
!4366 = !DILocation(line: 374, column: 2, scope: !4318, inlinedAt: !4361)
!4367 = !DILocation(line: 376, column: 14, scope: !4318, inlinedAt: !4361)
!4368 = !DILocation(line: 377, column: 9, scope: !4318, inlinedAt: !4361)
!4369 = !DILocation(line: 377, column: 16, scope: !4318, inlinedAt: !4361)
!4370 = !DILocation(line: 32, column: 18, scope: !4356)
!4371 = !DILocation(line: 32, column: 2, scope: !4356)
!4372 = distinct !DISubprogram(name: "kasan_kmalloc", scope: !1982, file: !1982, line: 137, type: !4373, scopeLine: 139, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !202)
!4373 = !DISubroutineType(types: !4374)
!4374 = !{!129, !884, !2998, !275, !130}
!4375 = !DILocalVariable(name: "s", arg: 1, scope: !4372, file: !1982, line: 137, type: !884)
!4376 = !DILocation(line: 137, column: 54, scope: !4372)
!4377 = !DILocalVariable(name: "object", arg: 2, scope: !4372, file: !1982, line: 137, type: !2998)
!4378 = !DILocation(line: 137, column: 69, scope: !4372)
!4379 = !DILocalVariable(name: "size", arg: 3, scope: !4372, file: !1982, line: 138, type: !275)
!4380 = !DILocation(line: 138, column: 12, scope: !4372)
!4381 = !DILocalVariable(name: "flags", arg: 4, scope: !4372, file: !1982, line: 138, type: !130)
!4382 = !DILocation(line: 138, column: 24, scope: !4372)
!4383 = !DILocation(line: 140, column: 17, scope: !4372)
!4384 = !DILocation(line: 140, column: 2, scope: !4372)
