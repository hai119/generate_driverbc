; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-dvico-portable.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-dvico-portable.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_dvico_portable6:\09\09\09"
module asm ".long\09init_rc_map_dvico_portable - .\09\09\09"
...
@dvico_portable_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([36 x %struct.rc_map_table], [36 x %struct.rc_map_table]* @rc_map_dvico_portable_table, i32 0, i32 0), i32 36, i32 0, i32 0, i32 9, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_dvico_portable202 = internal global i8* bitcast (i32 ()* @init_rc_map_dvico_portable to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_dvico_portable = internal global void ()* @exit_rc_map_dvico_portable, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [66 x i8] c"rc_dvico_portable.file=drivers/media/rc/keymaps/rc-dvico-portable\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [30 x i8] c"rc_dvico_portable.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [47 x i8] c"rc_dvico_portable.author=Mauro Carvalho Chehab\00", section ".modinfo", align 1, !dbg !60
@rc_map_dvico_portable_table = internal global [36 x %struct.rc_map_table] [%struct.rc_map_table { i64 770, i32 141 }, %struct.rc_map_table { i64 835, i32 356 }, %struct.rc_map_table { i64 774, i32 365 }, %struct.rc_map_table { i64 858, i32 158 }, %struct.rc_map_table { i64 773, i32 139 }, %struct.rc_map_table { i64 839, i32 358 }, %struct.rc_map_table { i64 769, i32 15 }, %struct.rc_map_table { i64 834, i32 165 }, %struct.rc_map_table { i64 841, i32 115 }, %struct.rc_map_table { i64 777, i32 114 }, %struct.rc_map_table { i64 852, i32 402 }, %struct.rc_map_table { i64 779, i32 403 }, %struct.rc_map_table { i64 790, i32 212 }, %struct.rc_map_table { i64 832, i32 386 }, %struct.rc_map_table { i64 837, i32 134 }, %struct.rc_map_table { i64 793, i32 513 }, %struct.rc_map_table { i64 792, i32 514 }, %struct.rc_map_table { i64 795, i32 515 }, %struct.rc_map_table { i64 794, i32 516 }, %struct.rc_map_table { i64 856, i32 517 }, %struct.rc_map_table { i64 857, i32 518 }, %struct.rc_map_table { i64 789, i32 519 }, %struct.rc_map_table { i64 788, i32 520 }, %struct.rc_map_table { i64 791, i32 521 }, %struct.rc_map_table { i64 836, i32 371 }, %struct.rc_map_table { i64 853, i32 512 }, %struct.rc_map_table { i64 775, i32 372 }, %struct.rc_map_table { i64 778, i32 168 }, %struct.rc_map_table { i64 776, i32 164 }, %struct.rc_map_table { i64 843, i32 208 }, %struct.rc_map_table { i64 859, i32 113 }, %struct.rc_map_table { i64 772, i32 128 }, %struct.rc_map_table { i64 854, i32 167 }, %struct.rc_map_table { i64 855, i32 116 }, %struct.rc_map_table { i64 833, i32 240 }, %struct.rc_map_table { i64 768, i32 240 }], align 16, !dbg !65
@.str = private unnamed_addr constant [18 x i8] c"rc-dvico-portable\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_dvico_portable to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_dvico_portable202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_dvico_portable to i8*), i8* getelementptr inbounds ([66 x i8], [66 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([47 x i8], [47 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_dvico_portable() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @dvico_portable_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_dvico_portable() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @dvico_portable_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "dvico_portable_map", scope: !2, file: !3, line: 50, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-dvico-portable.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_dvico_portable202", scope: !2, file: !3, line: 69, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_dvico_portable", scope: !2, file: !3, line: 70, type: !43, isLocal: true, isDefinition: true)
...
!66 = distinct !DIGlobalVariable(name: "rc_map_dvico_portable_table", scope: !2, file: !3, line: 11, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_dvico_portable", scope: !3, file: !3, line: 64, type: !46, scopeLine: 65, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 66, column: 2, scope: !123)
!125 = !DILocation(line: 67, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_dvico_portable", scope: !3, file: !3, line: 59, type: !127, scopeLine: 60, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
