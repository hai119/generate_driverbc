; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-trekstor.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-trekstor.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_trekstor6:\09\09\09"
module asm ".long\09init_rc_map_trekstor - .\09\09\09"
...
@trekstor_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([28 x %struct.rc_map_table], [28 x %struct.rc_map_table]* @trekstor, i32 0, i32 0), i32 28, i32 0, i32 0, i32 9, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_trekstor202 = internal global i8* bitcast (i32 ()* @init_rc_map_trekstor to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_trekstor = internal global void ()* @exit_rc_map_trekstor, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [54 x i8] c"rc_trekstor.file=drivers/media/rc/keymaps/rc-trekstor\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [24 x i8] c"rc_trekstor.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [50 x i8] c"rc_trekstor.author=Antti Palosaari <crope@iki.fi>\00", section ".modinfo", align 1, !dbg !60
@trekstor = internal global [28 x %struct.rc_map_table] [%struct.rc_map_table { i64 132, i32 512 }, %struct.rc_map_table { i64 133, i32 113 }, %struct.rc_map_table { i64 134, i32 172 }, %struct.rc_map_table { i64 135, i32 103 }, %struct.rc_map_table { i64 136, i32 352 }, %struct.rc_map_table { i64 137, i32 106 }, %struct.rc_map_table { i64 138, i32 208 }, %struct.rc_map_table { i64 139, i32 115 }, %struct.rc_map_table { i64 140, i32 108 }, %struct.rc_map_table { i64 141, i32 207 }, %struct.rc_map_table { i64 142, i32 128 }, %struct.rc_map_table { i64 143, i32 365 }, %struct.rc_map_table { i64 144, i32 519 }, %struct.rc_map_table { i64 145, i32 516 }, %struct.rc_map_table { i64 146, i32 513 }, %struct.rc_map_table { i64 147, i32 403 }, %struct.rc_map_table { i64 148, i32 520 }, %struct.rc_map_table { i64 149, i32 517 }, %struct.rc_map_table { i64 150, i32 514 }, %struct.rc_map_table { i64 151, i32 402 }, %struct.rc_map_table { i64 152, i32 521 }, %struct.rc_map_table { i64 153, i32 518 }, %struct.rc_map_table { i64 154, i32 515 }, %struct.rc_map_table { i64 155, i32 114 }, %struct.rc_map_table { i64 156, i32 377 }, %struct.rc_map_table { i64 157, i32 167 }, %struct.rc_map_table { i64 158, i32 168 }, %struct.rc_map_table { i64 159, i32 105 }], align 16, !dbg !65
@.str = private unnamed_addr constant [12 x i8] c"rc-trekstor\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_trekstor to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_trekstor202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_trekstor to i8*), i8* getelementptr inbounds ([54 x i8], [54 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_trekstor() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @trekstor_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_trekstor() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @trekstor_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "trekstor_map", scope: !2, file: !3, line: 45, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-trekstor.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_trekstor202", scope: !2, file: !3, line: 64, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_trekstor", scope: !2, file: !3, line: 65, type: !43, isLocal: true, isDefinition: true)
...
!49 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file203", scope: !2, file: !3, line: 67, type: !50, isLocal: true, isDefinition: true, align: 8)
...
!56 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license204", scope: !2, file: !3, line: 67, type: !57, isLocal: true, isDefinition: true, align: 8)
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 192, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 24)
!60 = !DIGlobalVariableExpression(var: !61, expr: !DIExpression())
!61 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author205", scope: !2, file: !3, line: 68, type: !62, isLocal: true, isDefinition: true, align: 8)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 400, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 50)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "trekstor", scope: !2, file: !3, line: 14, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_trekstor", scope: !3, file: !3, line: 59, type: !46, scopeLine: 60, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 61, column: 2, scope: !123)
!125 = !DILocation(line: 62, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_trekstor", scope: !3, file: !3, line: 54, type: !127, scopeLine: 55, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!127 = !DISubroutineType(types: !128)
!128 = !{!129}
!129 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!130 = !DILocation(line: 56, column: 9, scope: !126)
!131 = !DILocation(line: 56, column: 2, scope: !126)
