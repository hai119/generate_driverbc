; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-kworld-315u.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-kworld-315u.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_kworld_315u6:\09\09\09"
module asm ".long\09init_rc_map_kworld_315u - .\09\09\09"
...
@kworld_315u_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([32 x %struct.rc_map_table], [32 x %struct.rc_map_table]* @kworld_315u, i32 0, i32 0), i32 32, i32 0, i32 0, i32 9, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_kworld_315u202 = internal global i8* bitcast (i32 ()* @init_rc_map_kworld_315u to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_kworld_315u = internal global void ()* @exit_rc_map_kworld_315u, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [60 x i8] c"rc_kworld_315u.file=drivers/media/rc/keymaps/rc-kworld-315u\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [27 x i8] c"rc_kworld_315u.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [44 x i8] c"rc_kworld_315u.author=Mauro Carvalho Chehab\00", section ".modinfo", align 1, !dbg !60
@kworld_315u = internal global [32 x %struct.rc_map_table] [%struct.rc_map_table { i64 24899, i32 116 }, %struct.rc_map_table { i64 24833, i32 393 }, %struct.rc_map_table { i64 24843, i32 372 }, %struct.rc_map_table { i64 24835, i32 356 }, %struct.rc_map_table { i64 24836, i32 513 }, %struct.rc_map_table { i64 24840, i32 514 }, %struct.rc_map_table { i64 24834, i32 515 }, %struct.rc_map_table { i64 24841, i32 402 }, %struct.rc_map_table { i64 24847, i32 516 }, %struct.rc_map_table { i64 24837, i32 517 }, %struct.rc_map_table { i64 24838, i32 518 }, %struct.rc_map_table { i64 24839, i32 403 }, %struct.rc_map_table { i64 24844, i32 519 }, %struct.rc_map_table { i64 24845, i32 520 }, %struct.rc_map_table { i64 24842, i32 521 }, %struct.rc_map_table { i64 24846, i32 115 }, %struct.rc_map_table { i64 24848, i32 405 }, %struct.rc_map_table { i64 24849, i32 512 }, %struct.rc_map_table { i64 24850, i32 28 }, %struct.rc_map_table { i64 24851, i32 114 }, %struct.rc_map_table { i64 24852, i32 167 }, %struct.rc_map_table { i64 24853, i32 128 }, %struct.rc_map_table { i64 24854, i32 207 }, %struct.rc_map_table { i64 24855, i32 113 }, %struct.rc_map_table { i64 24856, i32 103 }, %struct.rc_map_table { i64 24857, i32 108 }, %struct.rc_map_table { i64 24858, i32 105 }, %struct.rc_map_table { i64 24859, i32 106 }, %struct.rc_map_table { i64 24860, i32 398 }, %struct.rc_map_table { i64 24861, i32 399 }, %struct.rc_map_table { i64 24862, i32 400 }, %struct.rc_map_table { i64 24863, i32 401 }], align 16, !dbg !65
@.str = private unnamed_addr constant [15 x i8] c"rc-kworld-315u\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_kworld_315u to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_kworld_315u202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_kworld_315u to i8*), i8* getelementptr inbounds ([60 x i8], [60 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([44 x i8], [44 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_kworld_315u() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @kworld_315u_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_kworld_315u() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @kworld_315u_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "kworld_315u_map", scope: !2, file: !3, line: 56, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-kworld-315u.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_kworld_315u202", scope: !2, file: !3, line: 75, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_kworld_315u", scope: !2, file: !3, line: 76, type: !43, isLocal: true, isDefinition: true)
...
!49 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file203", scope: !2, file: !3, line: 78, type: !50, isLocal: true, isDefinition: true, align: 8)
...
!56 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license204", scope: !2, file: !3, line: 78, type: !57, isLocal: true, isDefinition: true, align: 8)
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 216, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 27)
!60 = !DIGlobalVariableExpression(var: !61, expr: !DIExpression())
!61 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author205", scope: !2, file: !3, line: 79, type: !62, isLocal: true, isDefinition: true, align: 8)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 352, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 44)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "kworld_315u", scope: !2, file: !3, line: 14, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_kworld_315u", scope: !3, file: !3, line: 70, type: !46, scopeLine: 71, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 72, column: 2, scope: !123)
!125 = !DILocation(line: 73, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_kworld_315u", scope: !3, file: !3, line: 65, type: !127, scopeLine: 66, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!127 = !DISubroutineType(types: !128)
!128 = !{!129}
!129 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!130 = !DILocation(line: 67, column: 9, scope: !126)
!131 = !DILocation(line: 67, column: 2, scope: !126)
