; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-medion-x10-digitainer.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-medion-x10-digitainer.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_medion_x10_digitainer6:\09\09\09"
module asm ".long\09init_rc_map_medion_x10_digitainer - .\09\09\09"
...
@medion_x10_digitainer_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([49 x %struct.rc_map_table], [49 x %struct.rc_map_table]* @medion_x10_digitainer, i32 0, i32 0), i32 49, i32 0, i32 0, i32 1, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_medion_x10_digitainer202 = internal global i8* bitcast (i32 ()* @init_rc_map_medion_x10_digitainer to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_medion_x10_digitainer = internal global void ()* @exit_rc_map_medion_x10_digitainer, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_description203 = internal constant [88 x i8] c"rc_medion_x10_digitainer.description=Medion X10 RF remote keytable (Digitainer variant)\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_author204 = internal constant [69 x i8] c"rc_medion_x10_digitainer.author=Anssi Hannula <anssi.hannula@iki.fi>\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_file205 = internal constant [80 x i8] c"rc_medion_x10_digitainer.file=drivers/media/rc/keymaps/rc-medion-x10-digitainer\00", section ".modinfo", align 1, !dbg !60
@__UNIQUE_ID_license206 = internal constant [37 x i8] c"rc_medion_x10_digitainer.license=GPL\00", section ".modinfo", align 1, !dbg !65
@medion_x10_digitainer = internal global [49 x %struct.rc_map_table] [%struct.rc_map_table { i64 2, i32 116 }, %struct.rc_map_table { i64 44, i32 377 }, %struct.rc_map_table { i64 45, i32 393 }, %struct.rc_map_table { i64 4, i32 389 }, %struct.rc_map_table { i64 22, i32 388 }, %struct.rc_map_table { i64 6, i32 392 }, %struct.rc_map_table { i64 46, i32 385 }, %struct.rc_map_table { i64 49, i32 365 }, %struct.rc_map_table { i64 5, i32 442 }, %struct.rc_map_table { i64 47, i32 358 }, %struct.rc_map_table { i64 120, i32 103 }, %struct.rc_map_table { i64 112, i32 108 }, %struct.rc_map_table { i64 25, i32 139 }, %struct.rc_map_table { i64 29, i32 105 }, %struct.rc_map_table { i64 30, i32 352 }, %struct.rc_map_table { i64 31, i32 106 }, %struct.rc_map_table { i64 32, i32 158 }, %struct.rc_map_table { i64 9, i32 115 }, %struct.rc_map_table { i64 8, i32 114 }, %struct.rc_map_table { i64 0, i32 113 }, %struct.rc_map_table { i64 27, i32 353 }, %struct.rc_map_table { i64 11, i32 402 }, %struct.rc_map_table { i64 12, i32 403 }, %struct.rc_map_table { i64 28, i32 405 }, %struct.rc_map_table { i64 50, i32 398 }, %struct.rc_map_table { i64 51, i32 399 }, %struct.rc_map_table { i64 52, i32 400 }, %struct.rc_map_table { i64 53, i32 401 }, %struct.rc_map_table { i64 40, i32 128 }, %struct.rc_map_table { i64 41, i32 119 }, %struct.rc_map_table { i64 37, i32 207 }, %struct.rc_map_table { i64 33, i32 412 }, %struct.rc_map_table { i64 24, i32 212 }, %struct.rc_map_table { i64 35, i32 407 }, %struct.rc_map_table { i64 36, i32 168 }, %struct.rc_map_table { i64 39, i32 167 }, %struct.rc_map_table { i64 38, i32 159 }, %struct.rc_map_table { i64 13, i32 513 }, %struct.rc_map_table { i64 14, i32 514 }, %struct.rc_map_table { i64 15, i32 515 }, %struct.rc_map_table { i64 16, i32 516 }, %struct.rc_map_table { i64 17, i32 517 }, %struct.rc_map_table { i64 18, i32 518 }, %struct.rc_map_table { i64 19, i32 519 }, %struct.rc_map_table { i64 20, i32 520 }, %struct.rc_map_table { i64 21, i32 521 }, %struct.rc_map_table { i64 23, i32 512 }, %struct.rc_map_table { i64 26, i32 103 }, %struct.rc_map_table { i64 34, i32 108 }], align 16, !dbg !70
@.str = private unnamed_addr constant [25 x i8] c"rc-medion-x10-digitainer\00", align 1
@llvm.used = appending global [7 x i8*] [i8* bitcast (void ()* @exit_rc_map_medion_x10_digitainer to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_medion_x10_digitainer202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_medion_x10_digitainer to i8*), i8* getelementptr inbounds ([88 x i8], [88 x i8]* @__UNIQUE_ID_description203, i32 0, i32 0), i8* getelementptr inbounds ([69 x i8], [69 x i8]* @__UNIQUE_ID_author204, i32 0, i32 0), i8* getelementptr inbounds ([80 x i8], [80 x i8]* @__UNIQUE_ID_file205, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @__UNIQUE_ID_license206, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_medion_x10_digitainer() #0 section ".exit.text" !dbg !128 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @medion_x10_digitainer_map) #2, !dbg !129
  ret void, !dbg !130
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_medion_x10_digitainer() #0 section ".init.text" !dbg !131 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @medion_x10_digitainer_map) #2, !dbg !135
...
!1 = distinct !DIGlobalVariable(name: "medion_x10_digitainer_map", scope: !2, file: !3, line: 86, type: !87, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-medion-x10-digitainer.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_medion_x10_digitainer202", scope: !2, file: !3, line: 105, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_medion_x10_digitainer", scope: !2, file: !3, line: 106, type: !43, isLocal: true, isDefinition: true)
...
!49 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_description203", scope: !2, file: !3, line: 108, type: !50, isLocal: true, isDefinition: true, align: 8)
!50 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 704, elements: !53)
!51 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !52)
!52 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!53 = !{!54}
!54 = !DISubrange(count: 88)
!55 = !DIGlobalVariableExpression(var: !56, expr: !DIExpression())
!56 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author204", scope: !2, file: !3, line: 109, type: !57, isLocal: true, isDefinition: true, align: 8)
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 552, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 69)
!60 = !DIGlobalVariableExpression(var: !61, expr: !DIExpression())
!61 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file205", scope: !2, file: !3, line: 110, type: !62, isLocal: true, isDefinition: true, align: 8)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 640, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 80)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license206", scope: !2, file: !3, line: 110, type: !67, isLocal: true, isDefinition: true, align: 8)
!67 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 296, elements: !68)
!68 = !{!69}
!69 = !DISubrange(count: 37)
!70 = !DIGlobalVariableExpression(var: !71, expr: !DIExpression())
!71 = distinct !DIGlobalVariable(name: "medion_x10_digitainer", scope: !2, file: !3, line: 16, type: !72, isLocal: true, isDefinition: true)
!72 = !DICompositeType(tag: DW_TAG_array_type, baseType: !73, size: 6272, elements: !85)
...
!128 = distinct !DISubprogram(name: "exit_rc_map_medion_x10_digitainer", scope: !3, file: !3, line: 100, type: !46, scopeLine: 101, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !122)
!129 = !DILocation(line: 102, column: 2, scope: !128)
!130 = !DILocation(line: 103, column: 1, scope: !128)
!131 = distinct !DISubprogram(name: "init_rc_map_medion_x10_digitainer", scope: !3, file: !3, line: 95, type: !132, scopeLine: 96, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !122)
!132 = !DISubroutineType(types: !133)
!133 = !{!134}
!134 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!135 = !DILocation(line: 97, column: 9, scope: !131)
!136 = !DILocation(line: 97, column: 2, scope: !131)
