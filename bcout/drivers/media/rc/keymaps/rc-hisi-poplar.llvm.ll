; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-hisi-poplar.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-hisi-poplar.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_hisi_poplar6:\09\09\09"
module asm ".long\09init_rc_map_hisi_poplar - .\09\09\09"
...
@hisi_poplar_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([29 x %struct.rc_map_table], [29 x %struct.rc_map_table]* @hisi_poplar_keymap, i32 0, i32 0), i32 29, i32 0, i32 0, i32 9, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_hisi_poplar202 = internal global i8* bitcast (i32 ()* @init_rc_map_hisi_poplar to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_hisi_poplar = internal global void ()* @exit_rc_map_hisi_poplar, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [60 x i8] c"rc_hisi_poplar.file=drivers/media/rc/keymaps/rc-hisi-poplar\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [30 x i8] c"rc_hisi_poplar.license=GPL v2\00", section ".modinfo", align 1, !dbg !55
@hisi_poplar_keymap = internal global [29 x %struct.rc_map_table] [%struct.rc_map_table { i64 45714, i32 513 }, %struct.rc_map_table { i64 45715, i32 514 }, %struct.rc_map_table { i64 45772, i32 515 }, %struct.rc_map_table { i64 45710, i32 516 }, %struct.rc_map_table { i64 45711, i32 517 }, %struct.rc_map_table { i64 45768, i32 518 }, %struct.rc_map_table { i64 45706, i32 519 }, %struct.rc_map_table { i64 45707, i32 520 }, %struct.rc_map_table { i64 45764, i32 521 }, %struct.rc_map_table { i64 45703, i32 512 }, %struct.rc_map_table { i64 45698, i32 172 }, %struct.rc_map_table { i64 45770, i32 103 }, %struct.rc_map_table { i64 45721, i32 105 }, %struct.rc_map_table { i64 45761, i32 106 }, %struct.rc_map_table { i64 45778, i32 108 }, %struct.rc_map_table { i64 45765, i32 111 }, %struct.rc_map_table { i64 45724, i32 113 }, %struct.rc_map_table { i64 45697, i32 114 }, %struct.rc_map_table { i64 45696, i32 115 }, %struct.rc_map_table { i64 45788, i32 116 }, %struct.rc_map_table { i64 45722, i32 139 }, %struct.rc_map_table { i64 45709, i32 141 }, %struct.rc_map_table { i64 45765, i32 158 }, %struct.rc_map_table { i64 45717, i32 164 }, %struct.rc_map_table { i64 45774, i32 28 }, %struct.rc_map_table { i64 45701, i32 402 }, %struct.rc_map_table { i64 45702, i32 403 }, %struct.rc_map_table { i64 45786, i32 522 }, %struct.rc_map_table { i64 45776, i32 523 }], align 16, !dbg !60
@.str = private unnamed_addr constant [15 x i8] c"rc-hisi-poplar\00", align 1
@llvm.used = appending global [5 x i8*] [i8* bitcast (void ()* @exit_rc_map_hisi_poplar to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_hisi_poplar202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_hisi_poplar to i8*), i8* getelementptr inbounds ([60 x i8], [60 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_hisi_poplar() #0 section ".exit.text" !dbg !118 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @hisi_poplar_map) #2, !dbg !119
  ret void, !dbg !120
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_hisi_poplar() #0 section ".init.text" !dbg !121 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @hisi_poplar_map) #2, !dbg !125
...
!1 = distinct !DIGlobalVariable(name: "hisi_poplar_map", scope: !2, file: !3, line: 43, type: !77, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-hisi-poplar.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_hisi_poplar202", scope: !2, file: !3, line: 62, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_hisi_poplar", scope: !2, file: !3, line: 63, type: !43, isLocal: true, isDefinition: true)
...
!61 = distinct !DIGlobalVariable(name: "hisi_poplar_keymap", scope: !2, file: !3, line: 11, type: !62, isLocal: true, isDefinition: true)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !63, size: 3712, elements: !75)
...
!118 = distinct !DISubprogram(name: "exit_rc_map_hisi_poplar", scope: !3, file: !3, line: 57, type: !46, scopeLine: 58, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !112)
!119 = !DILocation(line: 59, column: 2, scope: !118)
!120 = !DILocation(line: 60, column: 1, scope: !118)
!121 = distinct !DISubprogram(name: "init_rc_map_hisi_poplar", scope: !3, file: !3, line: 52, type: !122, scopeLine: 53, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !112)
!122 = !DISubroutineType(types: !123)
!123 = !{!124}
!124 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!125 = !DILocation(line: 54, column: 9, scope: !121)
!126 = !DILocation(line: 54, column: 2, scope: !121)
