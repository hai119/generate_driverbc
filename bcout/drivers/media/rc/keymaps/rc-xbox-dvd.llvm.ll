; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-xbox-dvd.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-xbox-dvd.c"
...
@xbox_dvd_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([27 x %struct.rc_map_table], [27 x %struct.rc_map_table]* @xbox_dvd, i32 0, i32 0), i32 27, i32 0, i32 0, i32 27, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
...
@__UNIQUE_ID_file203 = internal constant [54 x i8] c"rc_xbox_dvd.file=drivers/media/rc/keymaps/rc-xbox-dvd\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [24 x i8] c"rc_xbox_dvd.license=GPL\00", section ".modinfo", align 1, !dbg !55
@xbox_dvd = internal global [27 x %struct.rc_map_table] [%struct.rc_map_table { i64 2571, i32 352 }, %struct.rc_map_table { i64 2726, i32 103 }, %struct.rc_map_table { i64 2727, i32 108 }, %struct.rc_map_table { i64 2728, i32 106 }, %struct.rc_map_table { i64 2729, i32 105 }, %struct.rc_map_table { i64 2755, i32 358 }, %struct.rc_map_table { i64 2758, i32 521 }, %struct.rc_map_table { i64 2759, i32 520 }, %struct.rc_map_table { i64 2760, i32 519 }, %struct.rc_map_table { i64 2761, i32 518 }, %struct.rc_map_table { i64 2762, i32 517 }, %struct.rc_map_table { i64 2763, i32 516 }, %struct.rc_map_table { i64 2764, i32 515 }, %struct.rc_map_table { i64 2765, i32 514 }, %struct.rc_map_table { i64 2766, i32 513 }, %struct.rc_map_table { i64 2767, i32 512 }, %struct.rc_map_table { i64 2773, i32 371 }, %struct.rc_map_table { i64 2776, i32 158 }, %struct.rc_map_table { i64 2781, i32 165 }, %struct.rc_map_table { i64 2783, i32 163 }, %struct.rc_map_table { i64 2784, i32 128 }, %struct.rc_map_table { i64 2786, i32 168 }, %struct.rc_map_table { i64 2787, i32 208 }, %struct.rc_map_table { i64 2789, i32 369 }, %struct.rc_map_table { i64 2790, i32 119 }, %struct.rc_map_table { i64 2794, i32 207 }, %struct.rc_map_table { i64 2807, i32 139 }], align 16, !dbg !60
@.str = private unnamed_addr constant [12 x i8] c"rc-xbox-dvd\00", align 1
@llvm.used = appending global [5 x i8*] [i8* bitcast (void ()* @exit_rc_map to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map to i8*), i8* getelementptr inbounds ([54 x i8], [54 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map() #0 section ".exit.text" !dbg !118 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @xbox_dvd_map) #2, !dbg !119
  ret void, !dbg !120
}
...
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @xbox_dvd_map) #2, !dbg !125
...
!1 = distinct !DIGlobalVariable(name: "xbox_dvd_map", scope: !2, file: !3, line: 41, type: !77, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-xbox-dvd.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map202", scope: !2, file: !3, line: 60, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map", scope: !2, file: !3, line: 61, type: !43, isLocal: true, isDefinition: true)
...
!61 = distinct !DIGlobalVariable(name: "xbox_dvd", scope: !2, file: !3, line: 9, type: !62, isLocal: true, isDefinition: true)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !63, size: 3456, elements: !75)
...
!118 = distinct !DISubprogram(name: "exit_rc_map", scope: !3, file: !3, line: 55, type: !46, scopeLine: 56, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !112)
!119 = !DILocation(line: 57, column: 2, scope: !118)
!120 = !DILocation(line: 58, column: 1, scope: !118)
!121 = distinct !DISubprogram(name: "init_rc_map", scope: !3, file: !3, line: 50, type: !122, scopeLine: 51, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !112)
!122 = !DISubroutineType(types: !123)
!123 = !{!124}
!124 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!125 = !DILocation(line: 52, column: 9, scope: !121)
!126 = !DILocation(line: 52, column: 2, scope: !121)
