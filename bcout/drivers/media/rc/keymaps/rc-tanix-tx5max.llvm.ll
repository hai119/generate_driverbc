; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-tanix-tx5max.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-tanix-tx5max.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_tanix_tx5max6:\09\09\09"
module asm ".long\09init_rc_map_tanix_tx5max - .\09\09\09"
...
@tanix_tx5max_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([24 x %struct.rc_map_table], [24 x %struct.rc_map_table]* @tanix_tx5max, i32 0, i32 0), i32 24, i32 0, i32 0, i32 10, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_tanix_tx5max202 = internal global i8* bitcast (i32 ()* @init_rc_map_tanix_tx5max to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_tanix_tx5max = internal global void ()* @exit_rc_map_tanix_tx5max, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [62 x i8] c"rc_tanix_tx5max.file=drivers/media/rc/keymaps/rc-tanix-tx5max\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [28 x i8] c"rc_tanix_tx5max.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [69 x i8] c"rc_tanix_tx5max.author=Christian Hewitt <christianshewitt@gmail.com>\00", section ".modinfo", align 1, !dbg !60
@tanix_tx5max = internal global [24 x %struct.rc_map_table] [%struct.rc_map_table { i64 4210765, i32 116 }, %struct.rc_map_table { i64 4210755, i32 113 }, %struct.rc_map_table { i64 4210711, i32 114 }, %struct.rc_map_table { i64 4210712, i32 115 }, %struct.rc_map_table { i64 4210699, i32 103 }, %struct.rc_map_table { i64 4210704, i32 105 }, %struct.rc_map_table { i64 4210705, i32 106 }, %struct.rc_map_table { i64 4210702, i32 108 }, %struct.rc_map_table { i64 4210701, i32 352 }, %struct.rc_map_table { i64 4210714, i32 102 }, %struct.rc_map_table { i64 4210757, i32 139 }, %struct.rc_map_table { i64 4210754, i32 158 }, %struct.rc_map_table { i64 4210689, i32 2 }, %struct.rc_map_table { i64 4210690, i32 3 }, %struct.rc_map_table { i64 4210691, i32 4 }, %struct.rc_map_table { i64 4210692, i32 5 }, %struct.rc_map_table { i64 4210693, i32 6 }, %struct.rc_map_table { i64 4210694, i32 7 }, %struct.rc_map_table { i64 4210695, i32 8 }, %struct.rc_map_table { i64 4210696, i32 9 }, %struct.rc_map_table { i64 4210697, i32 10 }, %struct.rc_map_table { i64 4210759, i32 370 }, %struct.rc_map_table { i64 4210688, i32 11 }, %struct.rc_map_table { i64 4210700, i32 111 }], align 16, !dbg !65
@.str = private unnamed_addr constant [16 x i8] c"rc-tanix-tx5max\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_tanix_tx5max to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_tanix_tx5max202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_tanix_tx5max to i8*), i8* getelementptr inbounds ([62 x i8], [62 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([69 x i8], [69 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_tanix_tx5max() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @tanix_tx5max_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_tanix_tx5max() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @tanix_tx5max_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "tanix_tx5max_map", scope: !2, file: !3, line: 45, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-tanix-tx5max.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_tanix_tx5max202", scope: !2, file: !3, line: 64, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_tanix_tx5max", scope: !2, file: !3, line: 65, type: !43, isLocal: true, isDefinition: true)
...
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 552, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 69)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "tanix_tx5max", scope: !2, file: !3, line: 11, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_tanix_tx5max", scope: !3, file: !3, line: 59, type: !46, scopeLine: 60, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 61, column: 2, scope: !123)
!125 = !DILocation(line: 62, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_tanix_tx5max", scope: !3, file: !3, line: 54, type: !127, scopeLine: 55, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
