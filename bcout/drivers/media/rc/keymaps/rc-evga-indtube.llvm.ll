; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-evga-indtube.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-evga-indtube.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_evga_indtube6:\09\09\09"
module asm ".long\09init_rc_map_evga_indtube - .\09\09\09"
...
@evga_indtube_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([16 x %struct.rc_map_table], [16 x %struct.rc_map_table]* @evga_indtube, i32 0, i32 0), i32 16, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_evga_indtube202 = internal global i8* bitcast (i32 ()* @init_rc_map_evga_indtube to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_evga_indtube = internal global void ()* @exit_rc_map_evga_indtube, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [62 x i8] c"rc_evga_indtube.file=drivers/media/rc/keymaps/rc-evga-indtube\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [28 x i8] c"rc_evga_indtube.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [45 x i8] c"rc_evga_indtube.author=Mauro Carvalho Chehab\00", section ".modinfo", align 1, !dbg !60
@evga_indtube = internal global [16 x %struct.rc_map_table] [%struct.rc_map_table { i64 18, i32 116 }, %struct.rc_map_table { i64 2, i32 373 }, %struct.rc_map_table { i64 20, i32 113 }, %struct.rc_map_table { i64 26, i32 402 }, %struct.rc_map_table { i64 22, i32 378 }, %struct.rc_map_table { i64 29, i32 115 }, %struct.rc_map_table { i64 5, i32 403 }, %struct.rc_map_table { i64 15, i32 164 }, %struct.rc_map_table { i64 25, i32 114 }, %struct.rc_map_table { i64 28, i32 168 }, %struct.rc_map_table { i64 13, i32 167 }, %struct.rc_map_table { i64 24, i32 159 }, %struct.rc_map_table { i64 30, i32 412 }, %struct.rc_map_table { i64 27, i32 128 }, %struct.rc_map_table { i64 31, i32 407 }, %struct.rc_map_table { i64 19, i32 212 }], align 16, !dbg !65
@.str = private unnamed_addr constant [16 x i8] c"rc-evga-indtube\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_evga_indtube to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_evga_indtube202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_evga_indtube to i8*), i8* getelementptr inbounds ([62 x i8], [62 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_evga_indtube() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @evga_indtube_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_evga_indtube() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @evga_indtube_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "evga_indtube_map", scope: !2, file: !3, line: 34, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-evga-indtube.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_evga_indtube202", scope: !2, file: !3, line: 53, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_evga_indtube", scope: !2, file: !3, line: 54, type: !43, isLocal: true, isDefinition: true)
...
!49 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file203", scope: !2, file: !3, line: 56, type: !50, isLocal: true, isDefinition: true, align: 8)
...
!56 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license204", scope: !2, file: !3, line: 56, type: !57, isLocal: true, isDefinition: true, align: 8)
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 224, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 28)
!60 = !DIGlobalVariableExpression(var: !61, expr: !DIExpression())
!61 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author205", scope: !2, file: !3, line: 57, type: !62, isLocal: true, isDefinition: true, align: 8)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 360, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 45)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "evga_indtube", scope: !2, file: !3, line: 15, type: !67, isLocal: true, isDefinition: true)
!67 = !DICompositeType(tag: DW_TAG_array_type, baseType: !68, size: 2048, elements: !80)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_evga_indtube", scope: !3, file: !3, line: 48, type: !46, scopeLine: 49, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 50, column: 2, scope: !123)
!125 = !DILocation(line: 51, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_evga_indtube", scope: !3, file: !3, line: 43, type: !127, scopeLine: 44, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!127 = !DISubroutineType(types: !128)
!128 = !{!129}
!129 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!130 = !DILocation(line: 45, column: 9, scope: !126)
!131 = !DILocation(line: 45, column: 2, scope: !126)
