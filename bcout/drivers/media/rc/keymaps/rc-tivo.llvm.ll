; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-tivo.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-tivo.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_tivo6:\09\09\09"
module asm ".long\09init_rc_map_tivo - .\09\09\09"
...
@tivo_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([45 x %struct.rc_map_table], [45 x %struct.rc_map_table]* @tivo, i32 0, i32 0), i32 45, i32 0, i32 0, i32 11, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_tivo202 = internal global i8* bitcast (i32 ()* @init_rc_map_tivo to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_tivo = internal global void ()* @exit_rc_map_tivo, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [46 x i8] c"rc_tivo.file=drivers/media/rc/keymaps/rc-tivo\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [20 x i8] c"rc_tivo.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [47 x i8] c"rc_tivo.author=Jarod Wilson <jarod@redhat.com>\00", section ".modinfo", align 1, !dbg !60
@tivo = internal global [45 x %struct.rc_map_table] [%struct.rc_map_table { i64 814084105, i32 226 }, %struct.rc_map_table { i64 814080016, i32 356 }, %struct.rc_map_table { i64 814080017, i32 377 }, %struct.rc_map_table { i64 814071860, i32 241 }, %struct.rc_map_table { i64 814080019, i32 358 }, %struct.rc_map_table { i64 814063711, i32 154 }, %struct.rc_map_table { i64 8728671, i32 154 }, %struct.rc_map_table { i64 814071862, i32 365 }, %struct.rc_map_table { i64 814080020, i32 103 }, %struct.rc_map_table { i64 814080022, i32 108 }, %struct.rc_map_table { i64 814080023, i32 105 }, %struct.rc_map_table { i64 814080021, i32 106 }, %struct.rc_map_table { i64 814080024, i32 178 }, %struct.rc_map_table { i64 814080025, i32 353 }, %struct.rc_map_table { i64 814080026, i32 177 }, %struct.rc_map_table { i64 814080028, i32 115 }, %struct.rc_map_table { i64 814080029, i32 114 }, %struct.rc_map_table { i64 814080027, i32 113 }, %struct.rc_map_table { i64 814075936, i32 167 }, %struct.rc_map_table { i64 814080030, i32 402 }, %struct.rc_map_table { i64 814080031, i32 403 }, %struct.rc_map_table { i64 8728607, i32 403 }, %struct.rc_map_table { i64 814075937, i32 207 }, %struct.rc_map_table { i64 814075939, i32 119 }, %struct.rc_map_table { i64 814075941, i32 409 }, %struct.rc_map_table { i64 814075938, i32 168 }, %struct.rc_map_table { i64 814075940, i32 208 }, %struct.rc_map_table { i64 814075942, i32 412 }, %struct.rc_map_table { i64 814075943, i32 407 }, %struct.rc_map_table { i64 814067780, i32 372 }, %struct.rc_map_table { i64 814067784, i32 128 }, %struct.rc_map_table { i64 814067786, i32 389 }, %struct.rc_map_table { i64 814075944, i32 513 }, %struct.rc_map_table { i64 814075945, i32 514 }, %struct.rc_map_table { i64 814075946, i32 515 }, %struct.rc_map_table { i64 814075947, i32 516 }, %struct.rc_map_table { i64 814075948, i32 517 }, %struct.rc_map_table { i64 814075949, i32 518 }, %struct.rc_map_table { i64 814075950, i32 519 }, %struct.rc_map_table { i64 814075951, i32 520 }, %struct.rc_map_table { i64 8728623, i32 520 }, %struct.rc_map_table { i64 814071856, i32 521 }, %struct.rc_map_table { i64 814071857, i32 512 }, %struct.rc_map_table { i64 814071859, i32 28 }, %struct.rc_map_table { i64 814071858, i32 355 }], align 16, !dbg !65
@.str = private unnamed_addr constant [8 x i8] c"rc-tivo\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_tivo to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_tivo202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_tivo to i8*), i8* getelementptr inbounds ([46 x i8], [46 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([47 x i8], [47 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_tivo() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @tivo_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_tivo() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @tivo_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "tivo_map", scope: !2, file: !3, line: 72, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-tivo.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_tivo202", scope: !2, file: !3, line: 91, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_tivo", scope: !2, file: !3, line: 92, type: !43, isLocal: true, isDefinition: true)
...
!61 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author205", scope: !2, file: !3, line: 95, type: !62, isLocal: true, isDefinition: true, align: 8)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 376, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 47)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "tivo", scope: !2, file: !3, line: 18, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_tivo", scope: !3, file: !3, line: 86, type: !46, scopeLine: 87, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 88, column: 2, scope: !123)
!125 = !DILocation(line: 89, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_tivo", scope: !3, file: !3, line: 81, type: !127, scopeLine: 82, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!127 = !DISubroutineType(types: !128)
!128 = !{!129}
!129 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!130 = !DILocation(line: 83, column: 9, scope: !126)
!131 = !DILocation(line: 83, column: 2, scope: !126)
