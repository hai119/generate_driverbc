; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-ati-tv-wonder-hd-600.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-ati-tv-wonder-hd-600.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_ati_tv_wonder_hd_6006:\09\09\09"
module asm ".long\09init_rc_map_ati_tv_wonder_hd_600 - .\09\09\09"
...
@ati_tv_wonder_hd_600_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([24 x %struct.rc_map_table], [24 x %struct.rc_map_table]* @ati_tv_wonder_hd_600, i32 0, i32 0), i32 24, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_ati_tv_wonder_hd_600202 = internal global i8* bitcast (i32 ()* @init_rc_map_ati_tv_wonder_hd_600 to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_ati_tv_wonder_hd_600 = internal global void ()* @exit_rc_map_ati_tv_wonder_hd_600, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [78 x i8] c"rc_ati_tv_wonder_hd_600.file=drivers/media/rc/keymaps/rc-ati-tv-wonder-hd-600\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [36 x i8] c"rc_ati_tv_wonder_hd_600.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [53 x i8] c"rc_ati_tv_wonder_hd_600.author=Mauro Carvalho Chehab\00", section ".modinfo", align 1, !dbg !60
@ati_tv_wonder_hd_600 = internal global [24 x %struct.rc_map_table] [%struct.rc_map_table { i64 0, i32 167 }, %struct.rc_map_table { i64 1, i32 164 }, %struct.rc_map_table { i64 2, i32 128 }, %struct.rc_map_table { i64 3, i32 116 }, %struct.rc_map_table { i64 4, i32 412 }, %struct.rc_map_table { i64 5, i32 168 }, %struct.rc_map_table { i64 6, i32 159 }, %struct.rc_map_table { i64 7, i32 407 }, %struct.rc_map_table { i64 8, i32 365 }, %struct.rc_map_table { i64 9, i32 102 }, %struct.rc_map_table { i64 10, i32 139 }, %struct.rc_map_table { i64 11, i32 402 }, %struct.rc_map_table { i64 12, i32 158 }, %struct.rc_map_table { i64 13, i32 103 }, %struct.rc_map_table { i64 14, i32 358 }, %struct.rc_map_table { i64 15, i32 403 }, %struct.rc_map_table { i64 16, i32 105 }, %struct.rc_map_table { i64 17, i32 353 }, %struct.rc_map_table { i64 18, i32 106 }, %struct.rc_map_table { i64 19, i32 115 }, %struct.rc_map_table { i64 20, i32 405 }, %struct.rc_map_table { i64 21, i32 108 }, %struct.rc_map_table { i64 22, i32 113 }, %struct.rc_map_table { i64 23, i32 114 }], align 16, !dbg !65
@.str = private unnamed_addr constant [24 x i8] c"rc-ati-tv-wonder-hd-600\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_ati_tv_wonder_hd_600 to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_ati_tv_wonder_hd_600202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_ati_tv_wonder_hd_600 to i8*), i8* getelementptr inbounds ([78 x i8], [78 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([53 x i8], [53 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_ati_tv_wonder_hd_600() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @ati_tv_wonder_hd_600_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_ati_tv_wonder_hd_600() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @ati_tv_wonder_hd_600_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "ati_tv_wonder_hd_600_map", scope: !2, file: !3, line: 42, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-ati-tv-wonder-hd-600.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_ati_tv_wonder_hd_600202", scope: !2, file: !3, line: 61, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_ati_tv_wonder_hd_600", scope: !2, file: !3, line: 62, type: !43, isLocal: true, isDefinition: true)
...
!49 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file203", scope: !2, file: !3, line: 64, type: !50, isLocal: true, isDefinition: true, align: 8)
!50 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 624, elements: !53)
!51 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !52)
!52 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!53 = !{!54}
!54 = !DISubrange(count: 78)
!55 = !DIGlobalVariableExpression(var: !56, expr: !DIExpression())
!56 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license204", scope: !2, file: !3, line: 64, type: !57, isLocal: true, isDefinition: true, align: 8)
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 288, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 36)
!60 = !DIGlobalVariableExpression(var: !61, expr: !DIExpression())
!61 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author205", scope: !2, file: !3, line: 65, type: !62, isLocal: true, isDefinition: true, align: 8)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 424, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 53)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "ati_tv_wonder_hd_600", scope: !2, file: !3, line: 15, type: !67, isLocal: true, isDefinition: true)
!67 = !DICompositeType(tag: DW_TAG_array_type, baseType: !68, size: 3072, elements: !80)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_ati_tv_wonder_hd_600", scope: !3, file: !3, line: 56, type: !46, scopeLine: 57, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 58, column: 2, scope: !123)
!125 = !DILocation(line: 59, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_ati_tv_wonder_hd_600", scope: !3, file: !3, line: 51, type: !127, scopeLine: 52, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!127 = !DISubroutineType(types: !128)
!128 = !{!129}
!129 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!130 = !DILocation(line: 53, column: 9, scope: !126)
!131 = !DILocation(line: 53, column: 2, scope: !126)
