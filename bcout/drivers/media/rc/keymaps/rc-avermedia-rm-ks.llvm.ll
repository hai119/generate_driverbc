; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-avermedia-rm-ks.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-avermedia-rm-ks.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_avermedia_rm_ks6:\09\09\09"
module asm ".long\09init_rc_map_avermedia_rm_ks - .\09\09\09"
...
@avermedia_rm_ks_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([27 x %struct.rc_map_table], [27 x %struct.rc_map_table]* @avermedia_rm_ks, i32 0, i32 0), i32 27, i32 0, i32 0, i32 9, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_avermedia_rm_ks202 = internal global i8* bitcast (i32 ()* @init_rc_map_avermedia_rm_ks to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_avermedia_rm_ks = internal global void ()* @exit_rc_map_avermedia_rm_ks, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [68 x i8] c"rc_avermedia_rm_ks.file=drivers/media/rc/keymaps/rc-avermedia-rm-ks\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [31 x i8] c"rc_avermedia_rm_ks.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [57 x i8] c"rc_avermedia_rm_ks.author=Antti Palosaari <crope@iki.fi>\00", section ".modinfo", align 1, !dbg !60
@avermedia_rm_ks = internal global [27 x %struct.rc_map_table] [%struct.rc_map_table { i64 1281, i32 356 }, %struct.rc_map_table { i64 1282, i32 402 }, %struct.rc_map_table { i64 1283, i32 403 }, %struct.rc_map_table { i64 1284, i32 115 }, %struct.rc_map_table { i64 1285, i32 114 }, %struct.rc_map_table { i64 1286, i32 113 }, %struct.rc_map_table { i64 1287, i32 129 }, %struct.rc_map_table { i64 1288, i32 393 }, %struct.rc_map_table { i64 1289, i32 513 }, %struct.rc_map_table { i64 1290, i32 514 }, %struct.rc_map_table { i64 1291, i32 515 }, %struct.rc_map_table { i64 1292, i32 516 }, %struct.rc_map_table { i64 1293, i32 517 }, %struct.rc_map_table { i64 1294, i32 518 }, %struct.rc_map_table { i64 1295, i32 519 }, %struct.rc_map_table { i64 1296, i32 520 }, %struct.rc_map_table { i64 1297, i32 521 }, %struct.rc_map_table { i64 1298, i32 512 }, %struct.rc_map_table { i64 1299, i32 392 }, %struct.rc_map_table { i64 1301, i32 365 }, %struct.rc_map_table { i64 1302, i32 164 }, %struct.rc_map_table { i64 1303, i32 167 }, %struct.rc_map_table { i64 1304, i32 128 }, %struct.rc_map_table { i64 1308, i32 158 }, %struct.rc_map_table { i64 1309, i32 159 }, %struct.rc_map_table { i64 1357, i32 358 }, %struct.rc_map_table { i64 1366, i32 372 }], align 16, !dbg !65
@.str = private unnamed_addr constant [19 x i8] c"rc-avermedia-rm-ks\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_avermedia_rm_ks to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_avermedia_rm_ks202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_avermedia_rm_ks to i8*), i8* getelementptr inbounds ([68 x i8], [68 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([57 x i8], [57 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_avermedia_rm_ks() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @avermedia_rm_ks_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_avermedia_rm_ks() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @avermedia_rm_ks_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "avermedia_rm_ks_map", scope: !2, file: !3, line: 44, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-avermedia-rm-ks.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_avermedia_rm_ks202", scope: !2, file: !3, line: 63, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_avermedia_rm_ks", scope: !2, file: !3, line: 64, type: !43, isLocal: true, isDefinition: true)
...
!66 = distinct !DIGlobalVariable(name: "avermedia_rm_ks", scope: !2, file: !3, line: 14, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_avermedia_rm_ks", scope: !3, file: !3, line: 58, type: !46, scopeLine: 59, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 60, column: 2, scope: !123)
!125 = !DILocation(line: 61, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_avermedia_rm_ks", scope: !3, file: !3, line: 53, type: !127, scopeLine: 54, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
