; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-wetek-hub.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-wetek-hub.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_wetek_hub6:\09\09\09"
module asm ".long\09init_rc_map_wetek_hub - .\09\09\09"
...
@wetek_hub_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([12 x %struct.rc_map_table], [12 x %struct.rc_map_table]* @wetek_hub, i32 0, i32 0), i32 12, i32 0, i32 0, i32 9, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_wetek_hub202 = internal global i8* bitcast (i32 ()* @init_rc_map_wetek_hub to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_wetek_hub = internal global void ()* @exit_rc_map_wetek_hub, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [56 x i8] c"rc_wetek_hub.file=drivers/media/rc/keymaps/rc-wetek-hub\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [25 x i8] c"rc_wetek_hub.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [66 x i8] c"rc_wetek_hub.author=Christian Hewitt <christianshewitt@gmail.com>\00", section ".modinfo", align 1, !dbg !60
@wetek_hub = internal global [12 x %struct.rc_map_table] [%struct.rc_map_table { i64 30705, i32 116 }, %struct.rc_map_table { i64 30706, i32 102 }, %struct.rc_map_table { i64 30707, i32 113 }, %struct.rc_map_table { i64 30708, i32 103 }, %struct.rc_map_table { i64 30709, i32 108 }, %struct.rc_map_table { i64 30710, i32 105 }, %struct.rc_map_table { i64 30711, i32 106 }, %struct.rc_map_table { i64 30712, i32 352 }, %struct.rc_map_table { i64 30713, i32 158 }, %struct.rc_map_table { i64 30714, i32 139 }, %struct.rc_map_table { i64 30715, i32 115 }, %struct.rc_map_table { i64 30716, i32 114 }], align 16, !dbg !65
@.str = private unnamed_addr constant [13 x i8] c"rc-wetek-hub\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_wetek_hub to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_wetek_hub202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_wetek_hub to i8*), i8* getelementptr inbounds ([56 x i8], [56 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([66 x i8], [66 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_wetek_hub() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @wetek_hub_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_wetek_hub() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @wetek_hub_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "wetek_hub_map", scope: !2, file: !3, line: 30, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-wetek-hub.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_wetek_hub202", scope: !2, file: !3, line: 49, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_wetek_hub", scope: !2, file: !3, line: 50, type: !43, isLocal: true, isDefinition: true)
...
!49 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file203", scope: !2, file: !3, line: 52, type: !50, isLocal: true, isDefinition: true, align: 8)
...
!56 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license204", scope: !2, file: !3, line: 52, type: !57, isLocal: true, isDefinition: true, align: 8)
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 200, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 25)
!60 = !DIGlobalVariableExpression(var: !61, expr: !DIExpression())
!61 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author205", scope: !2, file: !3, line: 53, type: !62, isLocal: true, isDefinition: true, align: 8)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 528, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 66)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "wetek_hub", scope: !2, file: !3, line: 11, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_wetek_hub", scope: !3, file: !3, line: 44, type: !46, scopeLine: 45, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 46, column: 2, scope: !123)
!125 = !DILocation(line: 47, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_wetek_hub", scope: !3, file: !3, line: 39, type: !127, scopeLine: 40, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!127 = !DISubroutineType(types: !128)
!128 = !{!129}
!129 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!130 = !DILocation(line: 41, column: 9, scope: !126)
