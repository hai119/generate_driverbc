; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-behold.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-behold.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_behold6:\09\09\09"
module asm ".long\09init_rc_map_behold - .\09\09\09"
...
@behold_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([34 x %struct.rc_map_table], [34 x %struct.rc_map_table]* @behold, i32 0, i32 0), i32 34, i32 0, i32 0, i32 10, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_behold202 = internal global i8* bitcast (i32 ()* @init_rc_map_behold to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_behold = internal global void ()* @exit_rc_map_behold, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [50 x i8] c"rc_behold.file=drivers/media/rc/keymaps/rc-behold\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [22 x i8] c"rc_behold.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [39 x i8] c"rc_behold.author=Mauro Carvalho Chehab\00", section ".modinfo", align 1, !dbg !60
@behold = internal global [34 x %struct.rc_map_table] [%struct.rc_map_table { i64 8809244, i32 386 }, %struct.rc_map_table { i64 8809234, i32 116 }, %struct.rc_map_table { i64 8809217, i32 513 }, %struct.rc_map_table { i64 8809218, i32 514 }, %struct.rc_map_table { i64 8809219, i32 515 }, %struct.rc_map_table { i64 8809220, i32 516 }, %struct.rc_map_table { i64 8809221, i32 517 }, %struct.rc_map_table { i64 8809222, i32 518 }, %struct.rc_map_table { i64 8809223, i32 519 }, %struct.rc_map_table { i64 8809224, i32 520 }, %struct.rc_map_table { i64 8809225, i32 521 }, %struct.rc_map_table { i64 8809226, i32 129 }, %struct.rc_map_table { i64 8809216, i32 512 }, %struct.rc_map_table { i64 8809239, i32 373 }, %struct.rc_map_table { i64 8809236, i32 375 }, %struct.rc_map_table { i64 8809232, i32 372 }, %struct.rc_map_table { i64 8809227, i32 402 }, %struct.rc_map_table { i64 8809240, i32 114 }, %struct.rc_map_table { i64 8809238, i32 352 }, %struct.rc_map_table { i64 8809228, i32 115 }, %struct.rc_map_table { i64 8809237, i32 403 }, %struct.rc_map_table { i64 8809233, i32 113 }, %struct.rc_map_table { i64 8809229, i32 358 }, %struct.rc_map_table { i64 8809231, i32 167 }, %struct.rc_map_table { i64 8809243, i32 164 }, %struct.rc_map_table { i64 8809242, i32 128 }, %struct.rc_map_table { i64 8809230, i32 388 }, %struct.rc_map_table { i64 8809247, i32 398 }, %struct.rc_map_table { i64 8809246, i32 393 }, %struct.rc_map_table { i64 8809245, i32 142 }, %struct.rc_map_table { i64 8809235, i32 399 }, %struct.rc_map_table { i64 8809241, i32 401 }, %struct.rc_map_table { i64 8809304, i32 409 }, %struct.rc_map_table { i64 8809308, i32 212 }], align 16, !dbg !65
@.str = private unnamed_addr constant [10 x i8] c"rc-behold\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_behold to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_behold202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_behold to i8*), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([39 x i8], [39 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_behold() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @behold_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_behold() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @behold_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "behold_map", scope: !2, file: !3, line: 114, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-behold.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_behold202", scope: !2, file: !3, line: 133, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_behold", scope: !2, file: !3, line: 134, type: !43, isLocal: true, isDefinition: true)
...
!49 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file203", scope: !2, file: !3, line: 136, type: !50, isLocal: true, isDefinition: true, align: 8)
...
!56 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license204", scope: !2, file: !3, line: 136, type: !57, isLocal: true, isDefinition: true, align: 8)
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 176, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 22)
!60 = !DIGlobalVariableExpression(var: !61, expr: !DIExpression())
!61 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author205", scope: !2, file: !3, line: 137, type: !62, isLocal: true, isDefinition: true, align: 8)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 312, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 39)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "behold", scope: !2, file: !3, line: 23, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_behold", scope: !3, file: !3, line: 128, type: !46, scopeLine: 129, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 130, column: 2, scope: !123)
!125 = !DILocation(line: 131, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_behold", scope: !3, file: !3, line: 123, type: !127, scopeLine: 124, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!127 = !DISubroutineType(types: !128)
!128 = !{!129}
!129 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!130 = !DILocation(line: 125, column: 9, scope: !126)
!131 = !DILocation(line: 125, column: 2, scope: !126)
