; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-pinnacle-pctv-hd.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-pinnacle-pctv-hd.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_pinnacle_pctv_hd6:\09\09\09"
module asm ".long\09init_rc_map_pinnacle_pctv_hd - .\09\09\09"
...
@pinnacle_pctv_hd_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([26 x %struct.rc_map_table], [26 x %struct.rc_map_table]* @pinnacle_pctv_hd, i32 0, i32 0), i32 26, i32 0, i32 0, i32 2, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_pinnacle_pctv_hd202 = internal global i8* bitcast (i32 ()* @init_rc_map_pinnacle_pctv_hd to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_pinnacle_pctv_hd = internal global void ()* @exit_rc_map_pinnacle_pctv_hd, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [70 x i8] c"rc_pinnacle_pctv_hd.file=drivers/media/rc/keymaps/rc-pinnacle-pctv-hd\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [32 x i8] c"rc_pinnacle_pctv_hd.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [49 x i8] c"rc_pinnacle_pctv_hd.author=Mauro Carvalho Chehab\00", section ".modinfo", align 1, !dbg !60
@pinnacle_pctv_hd = internal global [26 x %struct.rc_map_table] [%struct.rc_map_table { i64 1792, i32 113 }, %struct.rc_map_table { i64 1793, i32 139 }, %struct.rc_map_table { i64 1849, i32 116 }, %struct.rc_map_table { i64 1795, i32 115 }, %struct.rc_map_table { i64 1797, i32 352 }, %struct.rc_map_table { i64 1801, i32 114 }, %struct.rc_map_table { i64 1798, i32 402 }, %struct.rc_map_table { i64 1804, i32 403 }, %struct.rc_map_table { i64 1807, i32 513 }, %struct.rc_map_table { i64 1813, i32 514 }, %struct.rc_map_table { i64 1808, i32 515 }, %struct.rc_map_table { i64 1816, i32 516 }, %struct.rc_map_table { i64 1819, i32 517 }, %struct.rc_map_table { i64 1822, i32 518 }, %struct.rc_map_table { i64 1809, i32 519 }, %struct.rc_map_table { i64 1825, i32 520 }, %struct.rc_map_table { i64 1810, i32 521 }, %struct.rc_map_table { i64 1831, i32 512 }, %struct.rc_map_table { i64 1828, i32 372 }, %struct.rc_map_table { i64 1834, i32 370 }, %struct.rc_map_table { i64 1837, i32 168 }, %struct.rc_map_table { i64 1840, i32 164 }, %struct.rc_map_table { i64 1843, i32 208 }, %struct.rc_map_table { i64 1846, i32 167 }, %struct.rc_map_table { i64 1852, i32 128 }, %struct.rc_map_table { i64 1855, i32 138 }], align 16, !dbg !65
@.str = private unnamed_addr constant [20 x i8] c"rc-pinnacle-pctv-hd\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_pinnacle_pctv_hd to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_pinnacle_pctv_hd202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_pinnacle_pctv_hd to i8*), i8* getelementptr inbounds ([70 x i8], [70 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([49 x i8], [49 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_pinnacle_pctv_hd() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @pinnacle_pctv_hd_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_pinnacle_pctv_hd() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @pinnacle_pctv_hd_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "pinnacle_pctv_hd_map", scope: !2, file: !3, line: 43, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-pinnacle-pctv-hd.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_pinnacle_pctv_hd202", scope: !2, file: !3, line: 62, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_pinnacle_pctv_hd", scope: !2, file: !3, line: 63, type: !43, isLocal: true, isDefinition: true)
...
!49 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file203", scope: !2, file: !3, line: 65, type: !50, isLocal: true, isDefinition: true, align: 8)
...
!56 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license204", scope: !2, file: !3, line: 65, type: !57, isLocal: true, isDefinition: true, align: 8)
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 256, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 32)
!60 = !DIGlobalVariableExpression(var: !61, expr: !DIExpression())
!61 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author205", scope: !2, file: !3, line: 66, type: !62, isLocal: true, isDefinition: true, align: 8)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 392, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 49)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "pinnacle_pctv_hd", scope: !2, file: !3, line: 13, type: !67, isLocal: true, isDefinition: true)
!67 = !DICompositeType(tag: DW_TAG_array_type, baseType: !68, size: 3328, elements: !80)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_pinnacle_pctv_hd", scope: !3, file: !3, line: 57, type: !46, scopeLine: 58, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 59, column: 2, scope: !123)
!125 = !DILocation(line: 60, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_pinnacle_pctv_hd", scope: !3, file: !3, line: 52, type: !127, scopeLine: 53, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!127 = !DISubroutineType(types: !128)
!128 = !{!129}
!129 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!130 = !DILocation(line: 54, column: 9, scope: !126)
!131 = !DILocation(line: 54, column: 2, scope: !126)
