; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-dvico-mce.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-dvico-mce.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_dvico_mce6:\09\09\09"
module asm ".long\09init_rc_map_dvico_mce - .\09\09\09"
...
@dvico_mce_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([45 x %struct.rc_map_table], [45 x %struct.rc_map_table]* @rc_map_dvico_mce_table, i32 0, i32 0), i32 45, i32 0, i32 0, i32 9, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_dvico_mce202 = internal global i8* bitcast (i32 ()* @init_rc_map_dvico_mce to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_dvico_mce = internal global void ()* @exit_rc_map_dvico_mce, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [56 x i8] c"rc_dvico_mce.file=drivers/media/rc/keymaps/rc-dvico-mce\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [25 x i8] c"rc_dvico_mce.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [42 x i8] c"rc_dvico_mce.author=Mauro Carvalho Chehab\00", section ".modinfo", align 1, !dbg !60
@rc_map_dvico_mce_table = internal global [45 x %struct.rc_map_table] [%struct.rc_map_table { i64 258, i32 377 }, %struct.rc_map_table { i64 270, i32 391 }, %struct.rc_map_table { i64 282, i32 389 }, %struct.rc_map_table { i64 286, i32 364 }, %struct.rc_map_table { i64 278, i32 141 }, %struct.rc_map_table { i64 326, i32 356 }, %struct.rc_map_table { i64 266, i32 365 }, %struct.rc_map_table { i64 329, i32 158 }, %struct.rc_map_table { i64 333, i32 139 }, %struct.rc_map_table { i64 337, i32 103 }, %struct.rc_map_table { i64 347, i32 105 }, %struct.rc_map_table { i64 351, i32 106 }, %struct.rc_map_table { i64 339, i32 108 }, %struct.rc_map_table { i64 350, i32 352 }, %struct.rc_map_table { i64 345, i32 358 }, %struct.rc_map_table { i64 341, i32 15 }, %struct.rc_map_table { i64 271, i32 165 }, %struct.rc_map_table { i64 274, i32 163 }, %struct.rc_map_table { i64 322, i32 28 }, %struct.rc_map_table { i64 277, i32 115 }, %struct.rc_map_table { i64 261, i32 114 }, %struct.rc_map_table { i64 273, i32 402 }, %struct.rc_map_table { i64 265, i32 403 }, %struct.rc_map_table { i64 338, i32 212 }, %struct.rc_map_table { i64 346, i32 386 }, %struct.rc_map_table { i64 281, i32 134 }, %struct.rc_map_table { i64 267, i32 513 }, %struct.rc_map_table { i64 279, i32 514 }, %struct.rc_map_table { i64 283, i32 515 }, %struct.rc_map_table { i64 263, i32 516 }, %struct.rc_map_table { i64 336, i32 517 }, %struct.rc_map_table { i64 340, i32 518 }, %struct.rc_map_table { i64 328, i32 519 }, %struct.rc_map_table { i64 332, i32 520 }, %struct.rc_map_table { i64 344, i32 521 }, %struct.rc_map_table { i64 275, i32 371 }, %struct.rc_map_table { i64 259, i32 512 }, %struct.rc_map_table { i64 287, i32 372 }, %struct.rc_map_table { i64 323, i32 168 }, %struct.rc_map_table { i64 327, i32 164 }, %struct.rc_map_table { i64 335, i32 208 }, %struct.rc_map_table { i64 343, i32 113 }, %struct.rc_map_table { i64 269, i32 128 }, %struct.rc_map_table { i64 257, i32 167 }, %struct.rc_map_table { i64 334, i32 116 }], align 16, !dbg !65
@.str = private unnamed_addr constant [13 x i8] c"rc-dvico-mce\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_dvico_mce to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_dvico_mce202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_dvico_mce to i8*), i8* getelementptr inbounds ([56 x i8], [56 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([42 x i8], [42 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_dvico_mce() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @dvico_mce_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_dvico_mce() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @dvico_mce_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "dvico_mce_map", scope: !2, file: !3, line: 59, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-dvico-mce.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_dvico_mce202", scope: !2, file: !3, line: 78, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_dvico_mce", scope: !2, file: !3, line: 79, type: !43, isLocal: true, isDefinition: true)
...
!66 = distinct !DIGlobalVariable(name: "rc_map_dvico_mce_table", scope: !2, file: !3, line: 11, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_dvico_mce", scope: !3, file: !3, line: 73, type: !46, scopeLine: 74, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 75, column: 2, scope: !123)
!125 = !DILocation(line: 76, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_dvico_mce", scope: !3, file: !3, line: 68, type: !127, scopeLine: 69, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
