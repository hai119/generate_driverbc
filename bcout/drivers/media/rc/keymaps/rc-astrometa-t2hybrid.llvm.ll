; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-astrometa-t2hybrid.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-astrometa-t2hybrid.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_t2hybrid6:\09\09\09"
module asm ".long\09init_rc_map_t2hybrid - .\09\09\09"
...
@t2hybrid_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([21 x %struct.rc_map_table], [21 x %struct.rc_map_table]* @t2hybrid, i32 0, i32 0), i32 21, i32 0, i32 0, i32 9, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_t2hybrid202 = internal global i8* bitcast (i32 ()* @init_rc_map_t2hybrid to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_t2hybrid = internal global void ()* @exit_rc_map_t2hybrid, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [74 x i8] c"rc_astrometa_t2hybrid.file=drivers/media/rc/keymaps/rc-astrometa-t2hybrid\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [34 x i8] c"rc_astrometa_t2hybrid.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [63 x i8] c"rc_astrometa_t2hybrid.author=Oleh Kravchenko <oleg@kaa.org.ua>\00", section ".modinfo", align 1, !dbg !60
@t2hybrid = internal global [21 x %struct.rc_map_table] [%struct.rc_map_table { i64 77, i32 356 }, %struct.rc_map_table { i64 84, i32 393 }, %struct.rc_map_table { i64 22, i32 113 }, %struct.rc_map_table { i64 76, i32 167 }, %struct.rc_map_table { i64 5, i32 402 }, %struct.rc_map_table { i64 12, i32 359 }, %struct.rc_map_table { i64 10, i32 114 }, %struct.rc_map_table { i64 64, i32 372 }, %struct.rc_map_table { i64 30, i32 115 }, %struct.rc_map_table { i64 18, i32 512 }, %struct.rc_map_table { i64 2, i32 403 }, %struct.rc_map_table { i64 28, i32 129 }, %struct.rc_map_table { i64 9, i32 513 }, %struct.rc_map_table { i64 29, i32 514 }, %struct.rc_map_table { i64 31, i32 515 }, %struct.rc_map_table { i64 13, i32 516 }, %struct.rc_map_table { i64 25, i32 517 }, %struct.rc_map_table { i64 27, i32 518 }, %struct.rc_map_table { i64 17, i32 519 }, %struct.rc_map_table { i64 21, i32 520 }, %struct.rc_map_table { i64 23, i32 521 }], align 16, !dbg !65
@.str = private unnamed_addr constant [22 x i8] c"rc-astrometa-t2hybrid\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_t2hybrid to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_t2hybrid202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_t2hybrid to i8*), i8* getelementptr inbounds ([74 x i8], [74 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([34 x i8], [34 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([63 x i8], [63 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_t2hybrid() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @t2hybrid_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_t2hybrid() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @t2hybrid_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "t2hybrid_map", scope: !2, file: !3, line: 41, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-astrometa-t2hybrid.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_t2hybrid202", scope: !2, file: !3, line: 60, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_t2hybrid", scope: !2, file: !3, line: 61, type: !43, isLocal: true, isDefinition: true)
...
!49 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file203", scope: !2, file: !3, line: 63, type: !50, isLocal: true, isDefinition: true, align: 8)
...
!56 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license204", scope: !2, file: !3, line: 63, type: !57, isLocal: true, isDefinition: true, align: 8)
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 272, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 34)
!60 = !DIGlobalVariableExpression(var: !61, expr: !DIExpression())
!61 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author205", scope: !2, file: !3, line: 64, type: !62, isLocal: true, isDefinition: true, align: 8)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 504, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 63)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "t2hybrid", scope: !2, file: !3, line: 11, type: !67, isLocal: true, isDefinition: true)
!67 = !DICompositeType(tag: DW_TAG_array_type, baseType: !68, size: 2688, elements: !80)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_t2hybrid", scope: !3, file: !3, line: 55, type: !46, scopeLine: 56, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 57, column: 2, scope: !123)
!125 = !DILocation(line: 58, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_t2hybrid", scope: !3, file: !3, line: 50, type: !127, scopeLine: 51, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!127 = !DISubroutineType(types: !128)
!128 = !{!129}
!129 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!130 = !DILocation(line: 52, column: 9, scope: !126)
