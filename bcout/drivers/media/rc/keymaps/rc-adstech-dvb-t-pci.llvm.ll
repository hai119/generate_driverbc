; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-adstech-dvb-t-pci.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-adstech-dvb-t-pci.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_adstech_dvb_t_pci6:\09\09\09"
module asm ".long\09init_rc_map_adstech_dvb_t_pci - .\09\09\09"
...
@adstech_dvb_t_pci_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([44 x %struct.rc_map_table], [44 x %struct.rc_map_table]* @adstech_dvb_t_pci, i32 0, i32 0), i32 44, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_adstech_dvb_t_pci202 = internal global i8* bitcast (i32 ()* @init_rc_map_adstech_dvb_t_pci to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_adstech_dvb_t_pci = internal global void ()* @exit_rc_map_adstech_dvb_t_pci, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [72 x i8] c"rc_adstech_dvb_t_pci.file=drivers/media/rc/keymaps/rc-adstech-dvb-t-pci\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [33 x i8] c"rc_adstech_dvb_t_pci.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [50 x i8] c"rc_adstech_dvb_t_pci.author=Mauro Carvalho Chehab\00", section ".modinfo", align 1, !dbg !60
@adstech_dvb_t_pci = internal global [44 x %struct.rc_map_table] [%struct.rc_map_table { i64 77, i32 512 }, %struct.rc_map_table { i64 87, i32 513 }, %struct.rc_map_table { i64 79, i32 514 }, %struct.rc_map_table { i64 83, i32 515 }, %struct.rc_map_table { i64 86, i32 516 }, %struct.rc_map_table { i64 78, i32 517 }, %struct.rc_map_table { i64 94, i32 518 }, %struct.rc_map_table { i64 84, i32 519 }, %struct.rc_map_table { i64 76, i32 520 }, %struct.rc_map_table { i64 92, i32 521 }, %struct.rc_map_table { i64 91, i32 116 }, %struct.rc_map_table { i64 95, i32 113 }, %struct.rc_map_table { i64 85, i32 354 }, %struct.rc_map_table { i64 93, i32 217 }, %struct.rc_map_table { i64 23, i32 365 }, %struct.rc_map_table { i64 31, i32 139 }, %struct.rc_map_table { i64 15, i32 103 }, %struct.rc_map_table { i64 70, i32 108 }, %struct.rc_map_table { i64 22, i32 105 }, %struct.rc_map_table { i64 30, i32 106 }, %struct.rc_map_table { i64 14, i32 353 }, %struct.rc_map_table { i64 90, i32 358 }, %struct.rc_map_table { i64 82, i32 174 }, %struct.rc_map_table { i64 89, i32 412 }, %struct.rc_map_table { i64 81, i32 407 }, %struct.rc_map_table { i64 88, i32 168 }, %struct.rc_map_table { i64 80, i32 159 }, %struct.rc_map_table { i64 68, i32 164 }, %struct.rc_map_table { i64 7, i32 128 }, %struct.rc_map_table { i64 27, i32 167 }, %struct.rc_map_table { i64 19, i32 386 }, %struct.rc_map_table { i64 10, i32 30 }, %struct.rc_map_table { i64 18, i32 48 }, %struct.rc_map_table { i64 3, i32 398 }, %struct.rc_map_table { i64 1, i32 399 }, %struct.rc_map_table { i64 0, i32 400 }, %struct.rc_map_table { i64 6, i32 389 }, %struct.rc_map_table { i64 72, i32 390 }, %struct.rc_map_table { i64 64, i32 393 }, %struct.rc_map_table { i64 25, i32 392 }, %struct.rc_map_table { i64 11, i32 402 }, %struct.rc_map_table { i64 8, i32 403 }, %struct.rc_map_table { i64 21, i32 115 }, %struct.rc_map_table { i64 28, i32 114 }], align 16, !dbg !65
@.str = private unnamed_addr constant [21 x i8] c"rc-adstech-dvb-t-pci\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_adstech_dvb_t_pci to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_adstech_dvb_t_pci202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_adstech_dvb_t_pci to i8*), i8* getelementptr inbounds ([72 x i8], [72 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_adstech_dvb_t_pci() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @adstech_dvb_t_pci_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_adstech_dvb_t_pci() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @adstech_dvb_t_pci_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "adstech_dvb_t_pci_map", scope: !2, file: !3, line: 62, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-adstech-dvb-t-pci.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_adstech_dvb_t_pci202", scope: !2, file: !3, line: 81, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_adstech_dvb_t_pci", scope: !2, file: !3, line: 82, type: !43, isLocal: true, isDefinition: true)
...
!66 = distinct !DIGlobalVariable(name: "adstech_dvb_t_pci", scope: !2, file: !3, line: 13, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_adstech_dvb_t_pci", scope: !3, file: !3, line: 76, type: !46, scopeLine: 77, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 78, column: 2, scope: !123)
!125 = !DILocation(line: 79, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_adstech_dvb_t_pci", scope: !3, file: !3, line: 71, type: !127, scopeLine: 72, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
