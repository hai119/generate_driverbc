; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-pinnacle-grey.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-pinnacle-grey.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_pinnacle_grey6:\09\09\09"
module asm ".long\09init_rc_map_pinnacle_grey - .\09\09\09"
...
@pinnacle_grey_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([41 x %struct.rc_map_table], [41 x %struct.rc_map_table]* @pinnacle_grey, i32 0, i32 0), i32 41, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_pinnacle_grey202 = internal global i8* bitcast (i32 ()* @init_rc_map_pinnacle_grey to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_pinnacle_grey = internal global void ()* @exit_rc_map_pinnacle_grey, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [64 x i8] c"rc_pinnacle_grey.file=drivers/media/rc/keymaps/rc-pinnacle-grey\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [29 x i8] c"rc_pinnacle_grey.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [46 x i8] c"rc_pinnacle_grey.author=Mauro Carvalho Chehab\00", section ".modinfo", align 1, !dbg !60
@pinnacle_grey = internal global [41 x %struct.rc_map_table] [%struct.rc_map_table { i64 58, i32 512 }, %struct.rc_map_table { i64 49, i32 513 }, %struct.rc_map_table { i64 50, i32 514 }, %struct.rc_map_table { i64 51, i32 515 }, %struct.rc_map_table { i64 52, i32 516 }, %struct.rc_map_table { i64 53, i32 517 }, %struct.rc_map_table { i64 54, i32 518 }, %struct.rc_map_table { i64 55, i32 519 }, %struct.rc_map_table { i64 56, i32 520 }, %struct.rc_map_table { i64 57, i32 521 }, %struct.rc_map_table { i64 47, i32 116 }, %struct.rc_map_table { i64 46, i32 25 }, %struct.rc_map_table { i64 31, i32 38 }, %struct.rc_map_table { i64 43, i32 23 }, %struct.rc_map_table { i64 45, i32 375 }, %struct.rc_map_table { i64 30, i32 372 }, %struct.rc_map_table { i64 27, i32 115 }, %struct.rc_map_table { i64 15, i32 114 }, %struct.rc_map_table { i64 23, i32 402 }, %struct.rc_map_table { i64 28, i32 403 }, %struct.rc_map_table { i64 37, i32 358 }, %struct.rc_map_table { i64 60, i32 113 }, %struct.rc_map_table { i64 61, i32 105 }, %struct.rc_map_table { i64 59, i32 106 }, %struct.rc_map_table { i64 63, i32 103 }, %struct.rc_map_table { i64 62, i32 108 }, %struct.rc_map_table { i64 26, i32 28 }, %struct.rc_map_table { i64 29, i32 139 }, %struct.rc_map_table { i64 25, i32 129 }, %struct.rc_map_table { i64 22, i32 165 }, %struct.rc_map_table { i64 19, i32 163 }, %struct.rc_map_table { i64 21, i32 119 }, %struct.rc_map_table { i64 14, i32 168 }, %struct.rc_map_table { i64 13, i32 207 }, %struct.rc_map_table { i64 11, i32 128 }, %struct.rc_map_table { i64 7, i32 159 }, %struct.rc_map_table { i64 39, i32 167 }, %struct.rc_map_table { i64 38, i32 386 }, %struct.rc_map_table { i64 41, i32 388 }, %struct.rc_map_table { i64 42, i32 226 }, %struct.rc_map_table { i64 24, i32 365 }], align 16, !dbg !65
@.str = private unnamed_addr constant [17 x i8] c"rc-pinnacle-grey\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_pinnacle_grey to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_pinnacle_grey202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_pinnacle_grey to i8*), i8* getelementptr inbounds ([64 x i8], [64 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([46 x i8], [46 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_pinnacle_grey() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @pinnacle_grey_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_pinnacle_grey() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @pinnacle_grey_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "pinnacle_grey_map", scope: !2, file: !3, line: 62, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-pinnacle-grey.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_pinnacle_grey202", scope: !2, file: !3, line: 81, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_pinnacle_grey", scope: !2, file: !3, line: 82, type: !43, isLocal: true, isDefinition: true)
...
!61 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author205", scope: !2, file: !3, line: 85, type: !62, isLocal: true, isDefinition: true, align: 8)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 368, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 46)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "pinnacle_grey", scope: !2, file: !3, line: 11, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_pinnacle_grey", scope: !3, file: !3, line: 76, type: !46, scopeLine: 77, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 78, column: 2, scope: !123)
!125 = !DILocation(line: 79, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_pinnacle_grey", scope: !3, file: !3, line: 71, type: !127, scopeLine: 72, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!127 = !DISubroutineType(types: !128)
!128 = !{!129}
!129 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!130 = !DILocation(line: 73, column: 9, scope: !126)
!131 = !DILocation(line: 73, column: 2, scope: !126)
