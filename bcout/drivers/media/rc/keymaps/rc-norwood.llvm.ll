; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-norwood.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-norwood.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_norwood6:\09\09\09"
module asm ".long\09init_rc_map_norwood - .\09\09\09"
...
@norwood_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([35 x %struct.rc_map_table], [35 x %struct.rc_map_table]* @norwood, i32 0, i32 0), i32 35, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_norwood202 = internal global i8* bitcast (i32 ()* @init_rc_map_norwood to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_norwood = internal global void ()* @exit_rc_map_norwood, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [52 x i8] c"rc_norwood.file=drivers/media/rc/keymaps/rc-norwood\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [23 x i8] c"rc_norwood.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [40 x i8] c"rc_norwood.author=Mauro Carvalho Chehab\00", section ".modinfo", align 1, !dbg !60
@norwood = internal global [35 x %struct.rc_map_table] [%struct.rc_map_table { i64 32, i32 512 }, %struct.rc_map_table { i64 33, i32 513 }, %struct.rc_map_table { i64 34, i32 514 }, %struct.rc_map_table { i64 35, i32 515 }, %struct.rc_map_table { i64 36, i32 516 }, %struct.rc_map_table { i64 37, i32 517 }, %struct.rc_map_table { i64 38, i32 518 }, %struct.rc_map_table { i64 39, i32 519 }, %struct.rc_map_table { i64 40, i32 520 }, %struct.rc_map_table { i64 41, i32 521 }, %struct.rc_map_table { i64 120, i32 393 }, %struct.rc_map_table { i64 44, i32 174 }, %struct.rc_map_table { i64 42, i32 353 }, %struct.rc_map_table { i64 105, i32 129 }, %struct.rc_map_table { i64 50, i32 225 }, %struct.rc_map_table { i64 51, i32 224 }, %struct.rc_map_table { i64 107, i32 78 }, %struct.rc_map_table { i64 108, i32 74 }, %struct.rc_map_table { i64 45, i32 113 }, %struct.rc_map_table { i64 48, i32 115 }, %struct.rc_map_table { i64 49, i32 114 }, %struct.rc_map_table { i64 96, i32 402 }, %struct.rc_map_table { i64 97, i32 403 }, %struct.rc_map_table { i64 63, i32 167 }, %struct.rc_map_table { i64 55, i32 207 }, %struct.rc_map_table { i64 54, i32 119 }, %struct.rc_map_table { i64 43, i32 128 }, %struct.rc_map_table { i64 103, i32 208 }, %struct.rc_map_table { i64 102, i32 168 }, %struct.rc_map_table { i64 62, i32 217 }, %struct.rc_map_table { i64 46, i32 212 }, %struct.rc_map_table { i64 109, i32 139 }, %struct.rc_map_table { i64 47, i32 372 }, %struct.rc_map_table { i64 52, i32 385 }, %struct.rc_map_table { i64 101, i32 116 }], align 16, !dbg !65
@.str = private unnamed_addr constant [11 x i8] c"rc-norwood\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_norwood to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_norwood202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_norwood to i8*), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([40 x i8], [40 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_norwood() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @norwood_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_norwood() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @norwood_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "norwood_map", scope: !2, file: !3, line: 58, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-norwood.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_norwood202", scope: !2, file: !3, line: 77, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_norwood", scope: !2, file: !3, line: 78, type: !43, isLocal: true, isDefinition: true)
...
!66 = distinct !DIGlobalVariable(name: "norwood", scope: !2, file: !3, line: 15, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_norwood", scope: !3, file: !3, line: 72, type: !46, scopeLine: 73, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 74, column: 2, scope: !123)
!125 = !DILocation(line: 75, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_norwood", scope: !3, file: !3, line: 67, type: !127, scopeLine: 68, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
