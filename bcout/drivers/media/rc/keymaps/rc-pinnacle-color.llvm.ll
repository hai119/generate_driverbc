; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-pinnacle-color.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-pinnacle-color.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_pinnacle_color6:\09\09\09"
module asm ".long\09init_rc_map_pinnacle_color - .\09\09\09"
...
@pinnacle_color_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([42 x %struct.rc_map_table], [42 x %struct.rc_map_table]* @pinnacle_color, i32 0, i32 0), i32 42, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_pinnacle_color202 = internal global i8* bitcast (i32 ()* @init_rc_map_pinnacle_color to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_pinnacle_color = internal global void ()* @exit_rc_map_pinnacle_color, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [66 x i8] c"rc_pinnacle_color.file=drivers/media/rc/keymaps/rc-pinnacle-color\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [30 x i8] c"rc_pinnacle_color.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [47 x i8] c"rc_pinnacle_color.author=Mauro Carvalho Chehab\00", section ".modinfo", align 1, !dbg !60
@pinnacle_color = internal global [42 x %struct.rc_map_table] [%struct.rc_map_table { i64 89, i32 113 }, %struct.rc_map_table { i64 74, i32 116 }, %struct.rc_map_table { i64 24, i32 388 }, %struct.rc_map_table { i64 38, i32 377 }, %struct.rc_map_table { i64 61, i32 210 }, %struct.rc_map_table { i64 72, i32 398 }, %struct.rc_map_table { i64 4, i32 399 }, %struct.rc_map_table { i64 17, i32 400 }, %struct.rc_map_table { i64 0, i32 401 }, %struct.rc_map_table { i64 45, i32 115 }, %struct.rc_map_table { i64 30, i32 114 }, %struct.rc_map_table { i64 73, i32 139 }, %struct.rc_map_table { i64 22, i32 402 }, %struct.rc_map_table { i64 23, i32 403 }, %struct.rc_map_table { i64 32, i32 103 }, %struct.rc_map_table { i64 33, i32 108 }, %struct.rc_map_table { i64 34, i32 105 }, %struct.rc_map_table { i64 35, i32 106 }, %struct.rc_map_table { i64 13, i32 353 }, %struct.rc_map_table { i64 8, i32 158 }, %struct.rc_map_table { i64 7, i32 173 }, %struct.rc_map_table { i64 47, i32 372 }, %struct.rc_map_table { i64 41, i32 167 }, %struct.rc_map_table { i64 75, i32 119 }, %struct.rc_map_table { i64 77, i32 168 }, %struct.rc_map_table { i64 46, i32 207 }, %struct.rc_map_table { i64 78, i32 159 }, %struct.rc_map_table { i64 83, i32 412 }, %struct.rc_map_table { i64 76, i32 128 }, %struct.rc_map_table { i64 84, i32 407 }, %struct.rc_map_table { i64 105, i32 512 }, %struct.rc_map_table { i64 106, i32 513 }, %struct.rc_map_table { i64 107, i32 514 }, %struct.rc_map_table { i64 108, i32 515 }, %struct.rc_map_table { i64 109, i32 516 }, %struct.rc_map_table { i64 110, i32 517 }, %struct.rc_map_table { i64 111, i32 518 }, %struct.rc_map_table { i64 112, i32 519 }, %struct.rc_map_table { i64 113, i32 520 }, %struct.rc_map_table { i64 114, i32 521 }, %struct.rc_map_table { i64 116, i32 363 }, %struct.rc_map_table { i64 10, i32 14 }], align 16, !dbg !65
@.str = private unnamed_addr constant [18 x i8] c"rc-pinnacle-color\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_pinnacle_color to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_pinnacle_color202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_pinnacle_color to i8*), i8* getelementptr inbounds ([66 x i8], [66 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([47 x i8], [47 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_pinnacle_color() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @pinnacle_color_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_pinnacle_color() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @pinnacle_color_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "pinnacle_color_map", scope: !2, file: !3, line: 67, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-pinnacle-color.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_pinnacle_color202", scope: !2, file: !3, line: 86, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_pinnacle_color", scope: !2, file: !3, line: 87, type: !43, isLocal: true, isDefinition: true)
...
!66 = distinct !DIGlobalVariable(name: "pinnacle_color", scope: !2, file: !3, line: 11, type: !67, isLocal: true, isDefinition: true)
!67 = !DICompositeType(tag: DW_TAG_array_type, baseType: !68, size: 5376, elements: !80)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_pinnacle_color", scope: !3, file: !3, line: 81, type: !46, scopeLine: 82, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 83, column: 2, scope: !123)
!125 = !DILocation(line: 84, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_pinnacle_color", scope: !3, file: !3, line: 76, type: !127, scopeLine: 77, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
