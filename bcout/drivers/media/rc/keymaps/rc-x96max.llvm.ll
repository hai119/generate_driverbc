; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-x96max.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-x96max.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_x96max6:\09\09\09"
module asm ".long\09init_rc_map_x96max - .\09\09\09"
...
@x96max_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([28 x %struct.rc_map_table], [28 x %struct.rc_map_table]* @x96max, i32 0, i32 0), i32 28, i32 0, i32 0, i32 9, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_x96max202 = internal global i8* bitcast (i32 ()* @init_rc_map_x96max to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_x96max = internal global void ()* @exit_rc_map_x96max, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [50 x i8] c"rc_x96max.file=drivers/media/rc/keymaps/rc-x96max\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [22 x i8] c"rc_x96max.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [62 x i8] c"rc_x96max.author=Christian Hewitt <christianshewitt@gmail.com\00", section ".modinfo", align 1, !dbg !60
@x96max = internal global [28 x %struct.rc_map_table] [%struct.rc_map_table { i64 320, i32 116 }, %struct.rc_map_table { i64 280, i32 115 }, %struct.rc_map_table { i64 272, i32 114 }, %struct.rc_map_table { i64 323, i32 113 }, %struct.rc_map_table { i64 256, i32 365 }, %struct.rc_map_table { i64 281, i32 158 }, %struct.rc_map_table { i64 278, i32 103 }, %struct.rc_map_table { i64 337, i32 105 }, %struct.rc_map_table { i64 336, i32 106 }, %struct.rc_map_table { i64 282, i32 108 }, %struct.rc_map_table { i64 275, i32 352 }, %struct.rc_map_table { i64 273, i32 102 }, %struct.rc_map_table { i64 332, i32 438 }, %struct.rc_map_table { i64 345, i32 412 }, %struct.rc_map_table { i64 346, i32 164 }, %struct.rc_map_table { i64 344, i32 407 }, %struct.rc_map_table { i64 327, i32 139 }, %struct.rc_map_table { i64 257, i32 512 }, %struct.rc_map_table { i64 322, i32 14 }, %struct.rc_map_table { i64 334, i32 513 }, %struct.rc_map_table { i64 269, i32 514 }, %struct.rc_map_table { i64 268, i32 515 }, %struct.rc_map_table { i64 330, i32 516 }, %struct.rc_map_table { i64 265, i32 517 }, %struct.rc_map_table { i64 264, i32 518 }, %struct.rc_map_table { i64 326, i32 519 }, %struct.rc_map_table { i64 261, i32 520 }, %struct.rc_map_table { i64 260, i32 521 }], align 16, !dbg !65
@.str = private unnamed_addr constant [10 x i8] c"rc-x96max\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_x96max to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_x96max202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_x96max to i8*), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([62 x i8], [62 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_x96max() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @x96max_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_x96max() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @x96max_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "x96max_map", scope: !2, file: !3, line: 60, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-x96max.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_x96max202", scope: !2, file: !3, line: 79, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_x96max", scope: !2, file: !3, line: 80, type: !43, isLocal: true, isDefinition: true)
...
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 496, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 62)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "x96max", scope: !2, file: !3, line: 12, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_x96max", scope: !3, file: !3, line: 74, type: !46, scopeLine: 75, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 76, column: 2, scope: !123)
!125 = !DILocation(line: 77, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_x96max", scope: !3, file: !3, line: 69, type: !127, scopeLine: 70, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
