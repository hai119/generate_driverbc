; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-pixelview-mk12.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-pixelview-mk12.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_pixelview6:\09\09\09"
module asm ".long\09init_rc_map_pixelview - .\09\09\09"
...
@pixelview_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([31 x %struct.rc_map_table], [31 x %struct.rc_map_table]* @pixelview_mk12, i32 0, i32 0), i32 31, i32 0, i32 0, i32 10, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_pixelview202 = internal global i8* bitcast (i32 ()* @init_rc_map_pixelview to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_pixelview = internal global void ()* @exit_rc_map_pixelview, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [66 x i8] c"rc_pixelview_mk12.file=drivers/media/rc/keymaps/rc-pixelview-mk12\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [30 x i8] c"rc_pixelview_mk12.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [47 x i8] c"rc_pixelview_mk12.author=Mauro Carvalho Chehab\00", section ".modinfo", align 1, !dbg !60
@pixelview_mk12 = internal global [31 x %struct.rc_map_table] [%struct.rc_map_table { i64 8809219, i32 386 }, %struct.rc_map_table { i64 8809246, i32 356 }, %struct.rc_map_table { i64 8809217, i32 513 }, %struct.rc_map_table { i64 8809227, i32 514 }, %struct.rc_map_table { i64 8809243, i32 515 }, %struct.rc_map_table { i64 8809221, i32 516 }, %struct.rc_map_table { i64 8809225, i32 517 }, %struct.rc_map_table { i64 8809237, i32 518 }, %struct.rc_map_table { i64 8809222, i32 519 }, %struct.rc_map_table { i64 8809226, i32 520 }, %struct.rc_map_table { i64 8809234, i32 521 }, %struct.rc_map_table { i64 8809218, i32 512 }, %struct.rc_map_table { i64 8809235, i32 129 }, %struct.rc_map_table { i64 8809232, i32 413 }, %struct.rc_map_table { i64 8809216, i32 393 }, %struct.rc_map_table { i64 8809240, i32 113 }, %struct.rc_map_table { i64 8809241, i32 212 }, %struct.rc_map_table { i64 8809242, i32 217 }, %struct.rc_map_table { i64 8809238, i32 402 }, %struct.rc_map_table { i64 8809236, i32 403 }, %struct.rc_map_table { i64 8809247, i32 115 }, %struct.rc_map_table { i64 8809239, i32 114 }, %struct.rc_map_table { i64 8809244, i32 372 }, %struct.rc_map_table { i64 8809220, i32 168 }, %struct.rc_map_table { i64 8809230, i32 167 }, %struct.rc_map_table { i64 8809228, i32 159 }, %struct.rc_map_table { i64 8809245, i32 128 }, %struct.rc_map_table { i64 8809224, i32 207 }, %struct.rc_map_table { i64 8809231, i32 119 }, %struct.rc_map_table { i64 8809229, i32 377 }, %struct.rc_map_table { i64 8809223, i32 385 }], align 16, !dbg !65
@.str = private unnamed_addr constant [18 x i8] c"rc-pixelview-mk12\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_pixelview to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_pixelview202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_pixelview to i8*), i8* getelementptr inbounds ([66 x i8], [66 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([47 x i8], [47 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_pixelview() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @pixelview_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_pixelview() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @pixelview_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "pixelview_map", scope: !2, file: !3, line: 56, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-pixelview-mk12.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_pixelview202", scope: !2, file: !3, line: 75, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_pixelview", scope: !2, file: !3, line: 76, type: !43, isLocal: true, isDefinition: true)
...
!66 = distinct !DIGlobalVariable(name: "pixelview_mk12", scope: !2, file: !3, line: 15, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_pixelview", scope: !3, file: !3, line: 70, type: !46, scopeLine: 71, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 72, column: 2, scope: !123)
!125 = !DILocation(line: 73, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_pixelview", scope: !3, file: !3, line: 65, type: !127, scopeLine: 66, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
