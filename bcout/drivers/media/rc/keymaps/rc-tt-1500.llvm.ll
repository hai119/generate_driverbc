; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-tt-1500.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-tt-1500.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_tt_15006:\09\09\09"
module asm ".long\09init_rc_map_tt_1500 - .\09\09\09"
...
@tt_1500_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([39 x %struct.rc_map_table], [39 x %struct.rc_map_table]* @tt_1500, i32 0, i32 0), i32 39, i32 0, i32 0, i32 2, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_tt_1500202 = internal global i8* bitcast (i32 ()* @init_rc_map_tt_1500 to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_tt_1500 = internal global void ()* @exit_rc_map_tt_1500, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [52 x i8] c"rc_tt_1500.file=drivers/media/rc/keymaps/rc-tt-1500\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [23 x i8] c"rc_tt_1500.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [40 x i8] c"rc_tt_1500.author=Mauro Carvalho Chehab\00", section ".modinfo", align 1, !dbg !60
@tt_1500 = internal global [39 x %struct.rc_map_table] [%struct.rc_map_table { i64 5377, i32 116 }, %struct.rc_map_table { i64 5378, i32 410 }, %struct.rc_map_table { i64 5379, i32 513 }, %struct.rc_map_table { i64 5380, i32 514 }, %struct.rc_map_table { i64 5381, i32 515 }, %struct.rc_map_table { i64 5382, i32 516 }, %struct.rc_map_table { i64 5383, i32 517 }, %struct.rc_map_table { i64 5384, i32 518 }, %struct.rc_map_table { i64 5385, i32 519 }, %struct.rc_map_table { i64 5386, i32 520 }, %struct.rc_map_table { i64 5387, i32 521 }, %struct.rc_map_table { i64 5388, i32 512 }, %struct.rc_map_table { i64 5389, i32 103 }, %struct.rc_map_table { i64 5390, i32 105 }, %struct.rc_map_table { i64 5391, i32 352 }, %struct.rc_map_table { i64 5392, i32 106 }, %struct.rc_map_table { i64 5393, i32 108 }, %struct.rc_map_table { i64 5394, i32 358 }, %struct.rc_map_table { i64 5395, i32 174 }, %struct.rc_map_table { i64 5396, i32 398 }, %struct.rc_map_table { i64 5397, i32 399 }, %struct.rc_map_table { i64 5398, i32 400 }, %struct.rc_map_table { i64 5399, i32 401 }, %struct.rc_map_table { i64 5400, i32 113 }, %struct.rc_map_table { i64 5401, i32 388 }, %struct.rc_map_table { i64 5402, i32 373 }, %struct.rc_map_table { i64 5409, i32 357 }, %struct.rc_map_table { i64 5410, i32 365 }, %struct.rc_map_table { i64 5411, i32 402 }, %struct.rc_map_table { i64 5412, i32 403 }, %struct.rc_map_table { i64 5413, i32 115 }, %struct.rc_map_table { i64 5414, i32 114 }, %struct.rc_map_table { i64 5415, i32 141 }, %struct.rc_map_table { i64 5434, i32 167 }, %struct.rc_map_table { i64 5435, i32 207 }, %struct.rc_map_table { i64 5436, i32 128 }, %struct.rc_map_table { i64 5437, i32 168 }, %struct.rc_map_table { i64 5438, i32 119 }, %struct.rc_map_table { i64 5439, i32 159 }], align 16, !dbg !65
@.str = private unnamed_addr constant [11 x i8] c"rc-tt-1500\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_tt_1500 to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_tt_1500202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_tt_1500 to i8*), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([40 x i8], [40 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_tt_1500() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @tt_1500_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_tt_1500() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @tt_1500_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "tt_1500_map", scope: !2, file: !3, line: 55, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-tt-1500.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_tt_1500202", scope: !2, file: !3, line: 74, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_tt_1500", scope: !2, file: !3, line: 75, type: !43, isLocal: true, isDefinition: true)
...
!66 = distinct !DIGlobalVariable(name: "tt_1500", scope: !2, file: !3, line: 13, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_tt_1500", scope: !3, file: !3, line: 69, type: !46, scopeLine: 70, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 71, column: 2, scope: !123)
!125 = !DILocation(line: 72, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_tt_1500", scope: !3, file: !3, line: 64, type: !127, scopeLine: 65, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
