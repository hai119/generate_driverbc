; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-odroid.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-odroid.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_odroid6:\09\09\09"
module asm ".long\09init_rc_map_odroid - .\09\09\09"
...
@odroid_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([12 x %struct.rc_map_table], [12 x %struct.rc_map_table]* @odroid, i32 0, i32 0), i32 12, i32 0, i32 0, i32 9, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_odroid202 = internal global i8* bitcast (i32 ()* @init_rc_map_odroid to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_odroid = internal global void ()* @exit_rc_map_odroid, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [50 x i8] c"rc_odroid.file=drivers/media/rc/keymaps/rc-odroid\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [22 x i8] c"rc_odroid.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [62 x i8] c"rc_odroid.author=Christian Hewitt <christianshewitt@gmail.com\00", section ".modinfo", align 1, !dbg !60
@odroid = internal global [12 x %struct.rc_map_table] [%struct.rc_map_table { i64 45788, i32 116 }, %struct.rc_map_table { i64 45704, i32 113 }, %struct.rc_map_table { i64 45698, i32 102 }, %struct.rc_map_table { i64 45770, i32 103 }, %struct.rc_map_table { i64 45721, i32 105 }, %struct.rc_map_table { i64 45774, i32 352 }, %struct.rc_map_table { i64 45761, i32 106 }, %struct.rc_map_table { i64 45778, i32 108 }, %struct.rc_map_table { i64 45765, i32 139 }, %struct.rc_map_table { i64 45722, i32 158 }, %struct.rc_map_table { i64 45697, i32 114 }, %struct.rc_map_table { i64 45696, i32 115 }], align 16, !dbg !65
@.str = private unnamed_addr constant [10 x i8] c"rc-odroid\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_odroid to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_odroid202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_odroid to i8*), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([62 x i8], [62 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_odroid() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @odroid_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_odroid() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @odroid_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "odroid_map", scope: !2, file: !3, line: 31, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-odroid.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_odroid202", scope: !2, file: !3, line: 50, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_odroid", scope: !2, file: !3, line: 51, type: !43, isLocal: true, isDefinition: true)
...
!66 = distinct !DIGlobalVariable(name: "odroid", scope: !2, file: !3, line: 12, type: !67, isLocal: true, isDefinition: true)
!67 = !DICompositeType(tag: DW_TAG_array_type, baseType: !68, size: 1536, elements: !80)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_odroid", scope: !3, file: !3, line: 45, type: !46, scopeLine: 46, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 47, column: 2, scope: !123)
!125 = !DILocation(line: 48, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_odroid", scope: !3, file: !3, line: 40, type: !127, scopeLine: 41, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
