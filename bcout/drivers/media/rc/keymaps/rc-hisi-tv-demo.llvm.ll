; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-hisi-tv-demo.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-hisi-tv-demo.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_hisi_tv_demo6:\09\09\09"
module asm ".long\09init_rc_map_hisi_tv_demo - .\09\09\09"
...
@hisi_tv_demo_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([41 x %struct.rc_map_table], [41 x %struct.rc_map_table]* @hisi_tv_demo_keymap, i32 0, i32 0), i32 41, i32 0, i32 0, i32 9, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_hisi_tv_demo202 = internal global i8* bitcast (i32 ()* @init_rc_map_hisi_tv_demo to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_hisi_tv_demo = internal global void ()* @exit_rc_map_hisi_tv_demo, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [62 x i8] c"rc_hisi_tv_demo.file=drivers/media/rc/keymaps/rc-hisi-tv-demo\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [31 x i8] c"rc_hisi_tv_demo.license=GPL v2\00", section ".modinfo", align 1, !dbg !55
@hisi_tv_demo_keymap = internal global [41 x %struct.rc_map_table] [%struct.rc_map_table { i64 146, i32 513 }, %struct.rc_map_table { i64 147, i32 514 }, %struct.rc_map_table { i64 204, i32 515 }, %struct.rc_map_table { i64 159, i32 516 }, %struct.rc_map_table { i64 142, i32 517 }, %struct.rc_map_table { i64 143, i32 518 }, %struct.rc_map_table { i64 200, i32 519 }, %struct.rc_map_table { i64 148, i32 520 }, %struct.rc_map_table { i64 138, i32 521 }, %struct.rc_map_table { i64 139, i32 512 }, %struct.rc_map_table { i64 206, i32 28 }, %struct.rc_map_table { i64 202, i32 103 }, %struct.rc_map_table { i64 153, i32 105 }, %struct.rc_map_table { i64 132, i32 104 }, %struct.rc_map_table { i64 193, i32 106 }, %struct.rc_map_table { i64 210, i32 108 }, %struct.rc_map_table { i64 137, i32 109 }, %struct.rc_map_table { i64 209, i32 113 }, %struct.rc_map_table { i64 152, i32 114 }, %struct.rc_map_table { i64 144, i32 115 }, %struct.rc_map_table { i64 156, i32 116 }, %struct.rc_map_table { i64 214, i32 128 }, %struct.rc_map_table { i64 151, i32 139 }, %struct.rc_map_table { i64 203, i32 158 }, %struct.rc_map_table { i64 218, i32 164 }, %struct.rc_map_table { i64 128, i32 358 }, %struct.rc_map_table { i64 195, i32 168 }, %struct.rc_map_table { i64 135, i32 172 }, %struct.rc_map_table { i64 208, i32 208 }, %struct.rc_map_table { i64 196, i32 213 }, %struct.rc_map_table { i64 130, i32 257 }, %struct.rc_map_table { i64 199, i32 258 }, %struct.rc_map_table { i64 134, i32 362 }, %struct.rc_map_table { i64 217, i32 370 }, %struct.rc_map_table { i64 133, i32 372 }, %struct.rc_map_table { i64 155, i32 398 }, %struct.rc_map_table { i64 154, i32 399 }, %struct.rc_map_table { i64 192, i32 400 }, %struct.rc_map_table { i64 194, i32 401 }, %struct.rc_map_table { i64 157, i32 403 }, %struct.rc_map_table { i64 207, i32 402 }], align 16, !dbg !60
@.str = private unnamed_addr constant [16 x i8] c"rc-hisi-tv-demo\00", align 1
@llvm.used = appending global [5 x i8*] [i8* bitcast (void ()* @exit_rc_map_hisi_tv_demo to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_hisi_tv_demo202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_hisi_tv_demo to i8*), i8* getelementptr inbounds ([62 x i8], [62 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_hisi_tv_demo() #0 section ".exit.text" !dbg !118 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @hisi_tv_demo_map) #2, !dbg !119
  ret void, !dbg !120
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_hisi_tv_demo() #0 section ".init.text" !dbg !121 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @hisi_tv_demo_map) #2, !dbg !125
...
!1 = distinct !DIGlobalVariable(name: "hisi_tv_demo_map", scope: !2, file: !3, line: 55, type: !77, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-hisi-tv-demo.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_hisi_tv_demo202", scope: !2, file: !3, line: 74, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_hisi_tv_demo", scope: !2, file: !3, line: 75, type: !43, isLocal: true, isDefinition: true)
...
!61 = distinct !DIGlobalVariable(name: "hisi_tv_demo_keymap", scope: !2, file: !3, line: 11, type: !62, isLocal: true, isDefinition: true)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !63, size: 5248, elements: !75)
...
!118 = distinct !DISubprogram(name: "exit_rc_map_hisi_tv_demo", scope: !3, file: !3, line: 69, type: !46, scopeLine: 70, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !112)
!119 = !DILocation(line: 71, column: 2, scope: !118)
!120 = !DILocation(line: 72, column: 1, scope: !118)
!121 = distinct !DISubprogram(name: "init_rc_map_hisi_tv_demo", scope: !3, file: !3, line: 64, type: !122, scopeLine: 65, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !112)
!122 = !DISubroutineType(types: !123)
!123 = !{!124}
!124 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!125 = !DILocation(line: 66, column: 9, scope: !121)
!126 = !DILocation(line: 66, column: 2, scope: !121)
