; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-terratec-cinergy-s2-hd.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-terratec-cinergy-s2-hd.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_terratec_cinergy_s2_hd6:\09\09\09"
module asm ".long\09init_rc_map_terratec_cinergy_s2_hd - .\09\09\09"
...
@terratec_cinergy_s2_hd_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([48 x %struct.rc_map_table], [48 x %struct.rc_map_table]* @terratec_cinergy_s2_hd, i32 0, i32 0), i32 48, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_terratec_cinergy_s2_hd202 = internal global i8* bitcast (i32 ()* @init_rc_map_terratec_cinergy_s2_hd to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_terratec_cinergy_s2_hd = internal global void ()* @exit_rc_map_terratec_cinergy_s2_hd, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [82 x i8] c"rc_terratec_cinergy_s2_hd.file=drivers/media/rc/keymaps/rc-terratec-cinergy-s2-hd\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [38 x i8] c"rc_terratec_cinergy_s2_hd.license=GPL\00", section ".modinfo", align 1, !dbg !55
@terratec_cinergy_s2_hd = internal global [48 x %struct.rc_map_table] [%struct.rc_map_table { i64 3, i32 407 }, %struct.rc_map_table { i64 7, i32 167 }, %struct.rc_map_table { i64 11, i32 412 }, %struct.rc_map_table { i64 16, i32 208 }, %struct.rc_map_table { i64 17, i32 168 }, %struct.rc_map_table { i64 18, i32 1 }, %struct.rc_map_table { i64 19, i32 207 }, %struct.rc_map_table { i64 20, i32 442 }, %struct.rc_map_table { i64 21, i32 392 }, %struct.rc_map_table { i64 22, i32 226 }, %struct.rc_map_table { i64 23, i32 128 }, %struct.rc_map_table { i64 24, i32 389 }, %struct.rc_map_table { i64 25, i32 377 }, %struct.rc_map_table { i64 26, i32 111 }, %struct.rc_map_table { i64 27, i32 388 }, %struct.rc_map_table { i64 28, i32 370 }, %struct.rc_map_table { i64 29, i32 139 }, %struct.rc_map_table { i64 30, i32 102 }, %struct.rc_map_table { i64 31, i32 119 }, %struct.rc_map_table { i64 32, i32 403 }, %struct.rc_map_table { i64 33, i32 114 }, %struct.rc_map_table { i64 34, i32 113 }, %struct.rc_map_table { i64 35, i32 115 }, %struct.rc_map_table { i64 36, i32 402 }, %struct.rc_map_table { i64 37, i32 401 }, %struct.rc_map_table { i64 38, i32 400 }, %struct.rc_map_table { i64 39, i32 399 }, %struct.rc_map_table { i64 40, i32 398 }, %struct.rc_map_table { i64 41, i32 358 }, %struct.rc_map_table { i64 43, i32 108 }, %struct.rc_map_table { i64 44, i32 106 }, %struct.rc_map_table { i64 45, i32 352 }, %struct.rc_map_table { i64 46, i32 105 }, %struct.rc_map_table { i64 47, i32 103 }, %struct.rc_map_table { i64 48, i32 365 }, %struct.rc_map_table { i64 50, i32 393 }, %struct.rc_map_table { i64 51, i32 512 }, %struct.rc_map_table { i64 52, i32 379 }, %struct.rc_map_table { i64 53, i32 521 }, %struct.rc_map_table { i64 54, i32 520 }, %struct.rc_map_table { i64 55, i32 519 }, %struct.rc_map_table { i64 56, i32 518 }, %struct.rc_map_table { i64 57, i32 517 }, %struct.rc_map_table { i64 58, i32 516 }, %struct.rc_map_table { i64 59, i32 515 }, %struct.rc_map_table { i64 60, i32 514 }, %struct.rc_map_table { i64 61, i32 513 }, %struct.rc_map_table { i64 62, i32 116 }], align 16, !dbg !60
@.str = private unnamed_addr constant [26 x i8] c"rc-terratec-cinergy-s2-hd\00", align 1
@llvm.used = appending global [5 x i8*] [i8* bitcast (void ()* @exit_rc_map_terratec_cinergy_s2_hd to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_terratec_cinergy_s2_hd202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_terratec_cinergy_s2_hd to i8*), i8* getelementptr inbounds ([82 x i8], [82 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_terratec_cinergy_s2_hd() #0 section ".exit.text" !dbg !118 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @terratec_cinergy_s2_hd_map) #2, !dbg !119
  ret void, !dbg !120
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_terratec_cinergy_s2_hd() #0 section ".init.text" !dbg !121 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @terratec_cinergy_s2_hd_map) #2, !dbg !125
...
!1 = distinct !DIGlobalVariable(name: "terratec_cinergy_s2_hd_map", scope: !2, file: !3, line: 60, type: !77, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-terratec-cinergy-s2-hd.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_terratec_cinergy_s2_hd202", scope: !2, file: !3, line: 79, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_terratec_cinergy_s2_hd", scope: !2, file: !3, line: 80, type: !43, isLocal: true, isDefinition: true)
...
!50 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 656, elements: !53)
!51 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !52)
!52 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!53 = !{!54}
!54 = !DISubrange(count: 82)
...
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 304, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 38)
!60 = !DIGlobalVariableExpression(var: !61, expr: !DIExpression())
!61 = distinct !DIGlobalVariable(name: "terratec_cinergy_s2_hd", scope: !2, file: !3, line: 8, type: !62, isLocal: true, isDefinition: true)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !63, size: 6144, elements: !75)
...
!118 = distinct !DISubprogram(name: "exit_rc_map_terratec_cinergy_s2_hd", scope: !3, file: !3, line: 74, type: !46, scopeLine: 75, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !112)
!119 = !DILocation(line: 76, column: 2, scope: !118)
!120 = !DILocation(line: 77, column: 1, scope: !118)
!121 = distinct !DISubprogram(name: "init_rc_map_terratec_cinergy_s2_hd", scope: !3, file: !3, line: 69, type: !122, scopeLine: 70, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !112)
!122 = !DISubroutineType(types: !123)
!123 = !{!124}
!124 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!125 = !DILocation(line: 71, column: 9, scope: !121)
!126 = !DILocation(line: 71, column: 2, scope: !121)
