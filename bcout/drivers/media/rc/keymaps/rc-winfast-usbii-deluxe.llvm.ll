; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-winfast-usbii-deluxe.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-winfast-usbii-deluxe.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_winfast_usbii_deluxe6:\09\09\09"
module asm ".long\09init_rc_map_winfast_usbii_deluxe - .\09\09\09"
...
@winfast_usbii_deluxe_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([28 x %struct.rc_map_table], [28 x %struct.rc_map_table]* @winfast_usbii_deluxe, i32 0, i32 0), i32 28, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_winfast_usbii_deluxe202 = internal global i8* bitcast (i32 ()* @init_rc_map_winfast_usbii_deluxe to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_winfast_usbii_deluxe = internal global void ()* @exit_rc_map_winfast_usbii_deluxe, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [78 x i8] c"rc_winfast_usbii_deluxe.file=drivers/media/rc/keymaps/rc-winfast-usbii-deluxe\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [36 x i8] c"rc_winfast_usbii_deluxe.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [53 x i8] c"rc_winfast_usbii_deluxe.author=Mauro Carvalho Chehab\00", section ".modinfo", align 1, !dbg !60
@winfast_usbii_deluxe = internal global [28 x %struct.rc_map_table] [%struct.rc_map_table { i64 98, i32 512 }, %struct.rc_map_table { i64 117, i32 513 }, %struct.rc_map_table { i64 118, i32 514 }, %struct.rc_map_table { i64 119, i32 515 }, %struct.rc_map_table { i64 121, i32 516 }, %struct.rc_map_table { i64 122, i32 517 }, %struct.rc_map_table { i64 123, i32 518 }, %struct.rc_map_table { i64 125, i32 519 }, %struct.rc_map_table { i64 126, i32 520 }, %struct.rc_map_table { i64 127, i32 521 }, %struct.rc_map_table { i64 56, i32 212 }, %struct.rc_map_table { i64 55, i32 167 }, %struct.rc_map_table { i64 53, i32 359 }, %struct.rc_map_table { i64 116, i32 115 }, %struct.rc_map_table { i64 120, i32 114 }, %struct.rc_map_table { i64 100, i32 113 }, %struct.rc_map_table { i64 33, i32 363 }, %struct.rc_map_table { i64 124, i32 402 }, %struct.rc_map_table { i64 96, i32 403 }, %struct.rc_map_table { i64 97, i32 405 }, %struct.rc_map_table { i64 114, i32 393 }, %struct.rc_map_table { i64 112, i32 356 }, %struct.rc_map_table { i64 57, i32 154 }, %struct.rc_map_table { i64 58, i32 181 }, %struct.rc_map_table { i64 115, i32 372 }, %struct.rc_map_table { i64 102, i32 358 }, %struct.rc_map_table { i64 49, i32 52 }, %struct.rc_map_table { i64 99, i32 28 }], align 16, !dbg !65
@.str = private unnamed_addr constant [24 x i8] c"rc-winfast-usbii-deluxe\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_winfast_usbii_deluxe to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_winfast_usbii_deluxe202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_winfast_usbii_deluxe to i8*), i8* getelementptr inbounds ([78 x i8], [78 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([53 x i8], [53 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_winfast_usbii_deluxe() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @winfast_usbii_deluxe_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_winfast_usbii_deluxe() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @winfast_usbii_deluxe_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "winfast_usbii_deluxe_map", scope: !2, file: !3, line: 55, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-winfast-usbii-deluxe.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_winfast_usbii_deluxe202", scope: !2, file: !3, line: 74, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_winfast_usbii_deluxe", scope: !2, file: !3, line: 75, type: !43, isLocal: true, isDefinition: true)
...
!66 = distinct !DIGlobalVariable(name: "winfast_usbii_deluxe", scope: !2, file: !3, line: 15, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_winfast_usbii_deluxe", scope: !3, file: !3, line: 69, type: !46, scopeLine: 70, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 71, column: 2, scope: !123)
!125 = !DILocation(line: 72, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_winfast_usbii_deluxe", scope: !3, file: !3, line: 64, type: !127, scopeLine: 65, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!127 = !DISubroutineType(types: !128)
!128 = !{!129}
!129 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!130 = !DILocation(line: 66, column: 9, scope: !126)
!131 = !DILocation(line: 66, column: 2, scope: !126)
