; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-dm1105-nec.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-dm1105-nec.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_dm1105_nec6:\09\09\09"
module asm ".long\09init_rc_map_dm1105_nec - .\09\09\09"
...
@dm1105_nec_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([31 x %struct.rc_map_table], [31 x %struct.rc_map_table]* @dm1105_nec, i32 0, i32 0), i32 31, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_dm1105_nec202 = internal global i8* bitcast (i32 ()* @init_rc_map_dm1105_nec to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_dm1105_nec = internal global void ()* @exit_rc_map_dm1105_nec, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [58 x i8] c"rc_dm1105_nec.file=drivers/media/rc/keymaps/rc-dm1105-nec\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [26 x i8] c"rc_dm1105_nec.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [43 x i8] c"rc_dm1105_nec.author=Mauro Carvalho Chehab\00", section ".modinfo", align 1, !dbg !60
@dm1105_nec = internal global [31 x %struct.rc_map_table] [%struct.rc_map_table { i64 10, i32 356 }, %struct.rc_map_table { i64 12, i32 113 }, %struct.rc_map_table { i64 17, i32 513 }, %struct.rc_map_table { i64 18, i32 514 }, %struct.rc_map_table { i64 19, i32 515 }, %struct.rc_map_table { i64 20, i32 516 }, %struct.rc_map_table { i64 21, i32 517 }, %struct.rc_map_table { i64 22, i32 518 }, %struct.rc_map_table { i64 23, i32 519 }, %struct.rc_map_table { i64 24, i32 520 }, %struct.rc_map_table { i64 25, i32 521 }, %struct.rc_map_table { i64 16, i32 512 }, %struct.rc_map_table { i64 28, i32 402 }, %struct.rc_map_table { i64 15, i32 403 }, %struct.rc_map_table { i64 26, i32 115 }, %struct.rc_map_table { i64 14, i32 114 }, %struct.rc_map_table { i64 4, i32 167 }, %struct.rc_map_table { i64 9, i32 363 }, %struct.rc_map_table { i64 8, i32 14 }, %struct.rc_map_table { i64 7, i32 208 }, %struct.rc_map_table { i64 11, i32 119 }, %struct.rc_map_table { i64 2, i32 1 }, %struct.rc_map_table { i64 3, i32 15 }, %struct.rc_map_table { i64 0, i32 103 }, %struct.rc_map_table { i64 31, i32 28 }, %struct.rc_map_table { i64 1, i32 108 }, %struct.rc_map_table { i64 5, i32 167 }, %struct.rc_map_table { i64 6, i32 128 }, %struct.rc_map_table { i64 64, i32 372 }, %struct.rc_map_table { i64 30, i32 377 }, %struct.rc_map_table { i64 27, i32 48 }], align 16, !dbg !65
@.str = private unnamed_addr constant [14 x i8] c"rc-dm1105-nec\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_dm1105_nec to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_dm1105_nec202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_dm1105_nec to i8*), i8* getelementptr inbounds ([58 x i8], [58 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([43 x i8], [43 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_dm1105_nec() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @dm1105_nec_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_dm1105_nec() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @dm1105_nec_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "dm1105_nec_map", scope: !2, file: !3, line: 49, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-dm1105-nec.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_dm1105_nec202", scope: !2, file: !3, line: 68, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_dm1105_nec", scope: !2, file: !3, line: 69, type: !43, isLocal: true, isDefinition: true)
...
!66 = distinct !DIGlobalVariable(name: "dm1105_nec", scope: !2, file: !3, line: 15, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_dm1105_nec", scope: !3, file: !3, line: 63, type: !46, scopeLine: 64, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 65, column: 2, scope: !123)
!125 = !DILocation(line: 66, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_dm1105_nec", scope: !3, file: !3, line: 58, type: !127, scopeLine: 59, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
