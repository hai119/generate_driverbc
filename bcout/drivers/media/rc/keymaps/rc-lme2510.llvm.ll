; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-lme2510.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-lme2510.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_lme2510_map6:\09\09\09"
module asm ".long\09init_rc_lme2510_map - .\09\09\09"
...
@lme2510_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([66 x %struct.rc_map_table], [66 x %struct.rc_map_table]* @lme2510_rc, i32 0, i32 0), i32 66, i32 0, i32 0, i32 9, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_lme2510_map202 = internal global i8* bitcast (i32 ()* @init_rc_lme2510_map to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_lme2510_map = internal global void ()* @exit_rc_lme2510_map, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [52 x i8] c"rc_lme2510.file=drivers/media/rc/keymaps/rc-lme2510\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [23 x i8] c"rc_lme2510.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [55 x i8] c"rc_lme2510.author=Malcolm Priestley tvboxspy@gmail.com\00", section ".modinfo", align 1, !dbg !60
@lme2510_rc = internal global [66 x %struct.rc_map_table] [%struct.rc_map_table { i64 4010981957, i32 512 }, %struct.rc_map_table { i64 4010975327, i32 513 }, %struct.rc_map_table { i64 4010979152, i32 514 }, %struct.rc_map_table { i64 4010975837, i32 515 }, %struct.rc_map_table { i64 4010982977, i32 516 }, %struct.rc_map_table { i64 4010997002, i32 517 }, %struct.rc_map_table { i64 4010982722, i32 518 }, %struct.rc_map_table { i64 4010981447, i32 519 }, %struct.rc_map_table { i64 4010980937, i32 520 }, %struct.rc_map_table { i64 4010998277, i32 521 }, %struct.rc_map_table { i64 4010982467, i32 116 }, %struct.rc_map_table { i64 4010981702, i32 370 }, %struct.rc_map_table { i64 4010998022, i32 119 }, %struct.rc_map_table { i64 4010998787, i32 439 }, %struct.rc_map_table { i64 4010999042, i32 119 }, %struct.rc_map_table { i64 4010975582, i32 115 }, %struct.rc_map_table { i64 4010976092, i32 114 }, %struct.rc_map_table { i64 4010997257, i32 402 }, %struct.rc_map_table { i64 4010992922, i32 403 }, %struct.rc_map_table { i64 4010991902, i32 207 }, %struct.rc_map_table { i64 4010992667, i32 372 }, %struct.rc_map_table { i64 4010976857, i32 113 }, %struct.rc_map_table { i64 4010976602, i32 377 }, %struct.rc_map_table { i64 4010993432, i32 167 }, %struct.rc_map_table { i64 4010997767, i32 365 }, %struct.rc_map_table { i64 4010999297, i32 128 }, %struct.rc_map_table { i64 4282444309, i32 512 }, %struct.rc_map_table { i64 4282447624, i32 513 }, %struct.rc_map_table { i64 4282447369, i32 514 }, %struct.rc_map_table { i64 4282447114, i32 515 }, %struct.rc_map_table { i64 4282446604, i32 516 }, %struct.rc_map_table { i64 4282446349, i32 517 }, %struct.rc_map_table { i64 4282446094, i32 518 }, %struct.rc_map_table { i64 4282445584, i32 519 }, %struct.rc_map_table { i64 4282445329, i32 520 }, %struct.rc_map_table { i64 4282445074, i32 521 }, %struct.rc_map_table { i64 4282449664, i32 116 }, %struct.rc_map_table { i64 4282448644, i32 439 }, %struct.rc_map_table { i64 4282443034, i32 119 }, %struct.rc_map_table { i64 4282449154, i32 115 }, %struct.rc_map_table { i64 4282448134, i32 114 }, %struct.rc_map_table { i64 4282449409, i32 402 }, %struct.rc_map_table { i64 4282448389, i32 403 }, %struct.rc_map_table { i64 4282444564, i32 372 }, %struct.rc_map_table { i64 4282443544, i32 167 }, %struct.rc_map_table { i64 4282444054, i32 128 }, %struct.rc_map_table { i64 4278248220, i32 512 }, %struct.rc_map_table { i64 4278253575, i32 513 }, %struct.rc_map_table { i64 4278250005, i32 514 }, %struct.rc_map_table { i64 4278253065, i32 515 }, %struct.rc_map_table { i64 4278249750, i32 516 }, %struct.rc_map_table { i64 4278248985, i32 517 }, %struct.rc_map_table { i64 4278252045, i32 518 }, %struct.rc_map_table { i64 4278252300, i32 519 }, %struct.rc_map_table { i64 4278249240, i32 520 }, %struct.rc_map_table { i64 4278231390, i32 521 }, %struct.rc_map_table { i64 4278237765, i32 116 }, %struct.rc_map_table { i64 4278238020, i32 439 }, %struct.rc_map_table { i64 4278236490, i32 119 }, %struct.rc_map_table { i64 4278237255, i32 115 }, %struct.rc_map_table { i64 4278238275, i32 114 }, %struct.rc_map_table { i64 4278237510, i32 402 }, %struct.rc_map_table { i64 4278239040, i32 403 }, %struct.rc_map_table { i64 4278253320, i32 372 }, %struct.rc_map_table { i64 4278238530, i32 167 }, %struct.rc_map_table { i64 4278232410, i32 128 }], align 16, !dbg !65
@.str = private unnamed_addr constant [11 x i8] c"rc-lme2510\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_lme2510_map to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_lme2510_map202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_lme2510_map to i8*), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([55 x i8], [55 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_lme2510_map() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @lme2510_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_lme2510_map() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @lme2510_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "lme2510_map", scope: !2, file: !3, line: 83, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-lme2510.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_lme2510_map202", scope: !2, file: !3, line: 102, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_lme2510_map", scope: !2, file: !3, line: 103, type: !43, isLocal: true, isDefinition: true)
...
!49 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file203", scope: !2, file: !3, line: 105, type: !50, isLocal: true, isDefinition: true, align: 8)
...
!56 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license204", scope: !2, file: !3, line: 105, type: !57, isLocal: true, isDefinition: true, align: 8)
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 184, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 23)
!60 = !DIGlobalVariableExpression(var: !61, expr: !DIExpression())
!61 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author205", scope: !2, file: !3, line: 106, type: !62, isLocal: true, isDefinition: true, align: 8)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 440, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 55)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "lme2510_rc", scope: !2, file: !3, line: 11, type: !67, isLocal: true, isDefinition: true)
!67 = !DICompositeType(tag: DW_TAG_array_type, baseType: !68, size: 8448, elements: !80)
...
!123 = distinct !DISubprogram(name: "exit_rc_lme2510_map", scope: !3, file: !3, line: 97, type: !46, scopeLine: 98, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 99, column: 2, scope: !123)
!125 = !DILocation(line: 100, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_lme2510_map", scope: !3, file: !3, line: 92, type: !127, scopeLine: 93, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!127 = !DISubroutineType(types: !128)
!128 = !{!129}
!129 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!130 = !DILocation(line: 94, column: 9, scope: !126)
!131 = !DILocation(line: 94, column: 2, scope: !126)
