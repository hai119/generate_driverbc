; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-dib0700-nec.llvm.bc'
...
@dib0700_nec_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([70 x %struct.rc_map_table], [70 x %struct.rc_map_table]* @dib0700_nec_table, i32 0, i32 0), i32 70, i32 0, i32 0, i32 9, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
...
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @dib0700_nec_map) #2, !dbg !124
  ret void, !dbg !125
}
...
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @dib0700_nec_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "dib0700_nec_map", scope: !2, file: !3, line: 97, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-dib0700-nec.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map202", scope: !2, file: !3, line: 116, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map", scope: !2, file: !3, line: 117, type: !43, isLocal: true, isDefinition: true)
...
!49 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file203", scope: !2, file: !3, line: 119, type: !50, isLocal: true, isDefinition: true, align: 8)
...
!56 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license204", scope: !2, file: !3, line: 119, type: !57, isLocal: true, isDefinition: true, align: 8)
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 216, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 27)
!60 = !DIGlobalVariableExpression(var: !61, expr: !DIExpression())
!61 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author205", scope: !2, file: !3, line: 120, type: !62, isLocal: true, isDefinition: true, align: 8)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 352, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 44)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "dib0700_nec_table", scope: !2, file: !3, line: 16, type: !67, isLocal: true, isDefinition: true)
!67 = !DICompositeType(tag: DW_TAG_array_type, baseType: !68, size: 8960, elements: !80)
...
!123 = distinct !DISubprogram(name: "exit_rc_map", scope: !3, file: !3, line: 111, type: !46, scopeLine: 112, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 113, column: 2, scope: !123)
!125 = !DILocation(line: 114, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map", scope: !3, file: !3, line: 106, type: !127, scopeLine: 107, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!127 = !DISubroutineType(types: !128)
!128 = !{!129}
!129 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!130 = !DILocation(line: 108, column: 9, scope: !126)
!131 = !DILocation(line: 108, column: 2, scope: !126)
