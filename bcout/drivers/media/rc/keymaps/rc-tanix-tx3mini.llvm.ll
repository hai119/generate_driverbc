; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-tanix-tx3mini.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-tanix-tx3mini.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_tanix_tx3mini6:\09\09\09"
module asm ".long\09init_rc_map_tanix_tx3mini - .\09\09\09"
...
@tanix_tx3mini_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([31 x %struct.rc_map_table], [31 x %struct.rc_map_table]* @tanix_tx3mini, i32 0, i32 0), i32 31, i32 0, i32 0, i32 9, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_tanix_tx3mini202 = internal global i8* bitcast (i32 ()* @init_rc_map_tanix_tx3mini to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_tanix_tx3mini = internal global void ()* @exit_rc_map_tanix_tx3mini, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [64 x i8] c"rc_tanix_tx3mini.file=drivers/media/rc/keymaps/rc-tanix-tx3mini\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [29 x i8] c"rc_tanix_tx3mini.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [70 x i8] c"rc_tanix_tx3mini.author=Christian Hewitt <christianshewitt@gmail.com>\00", section ".modinfo", align 1, !dbg !60
@tanix_tx3mini = internal global [31 x %struct.rc_map_table] [%struct.rc_map_table { i64 32849, i32 116 }, %struct.rc_map_table { i64 32845, i32 113 }, %struct.rc_map_table { i64 32777, i32 398 }, %struct.rc_map_table { i64 32785, i32 399 }, %struct.rc_map_table { i64 32852, i32 400 }, %struct.rc_map_table { i64 32847, i32 401 }, %struct.rc_map_table { i64 32854, i32 114 }, %struct.rc_map_table { i64 32957, i32 412 }, %struct.rc_map_table { i64 32955, i32 407 }, %struct.rc_map_table { i64 32846, i32 115 }, %struct.rc_map_table { i64 32851, i32 102 }, %struct.rc_map_table { i64 32795, i32 158 }, %struct.rc_map_table { i64 32806, i32 103 }, %struct.rc_map_table { i64 32808, i32 108 }, %struct.rc_map_table { i64 32805, i32 105 }, %struct.rc_map_table { i64 32807, i32 106 }, %struct.rc_map_table { i64 32781, i32 352 }, %struct.rc_map_table { i64 32841, i32 139 }, %struct.rc_map_table { i64 32850, i32 365 }, %struct.rc_map_table { i64 32817, i32 2 }, %struct.rc_map_table { i64 32818, i32 3 }, %struct.rc_map_table { i64 32819, i32 4 }, %struct.rc_map_table { i64 32820, i32 5 }, %struct.rc_map_table { i64 32821, i32 6 }, %struct.rc_map_table { i64 32822, i32 7 }, %struct.rc_map_table { i64 32823, i32 8 }, %struct.rc_map_table { i64 32824, i32 9 }, %struct.rc_map_table { i64 32825, i32 10 }, %struct.rc_map_table { i64 32856, i32 370 }, %struct.rc_map_table { i64 32816, i32 11 }, %struct.rc_map_table { i64 32836, i32 111 }], align 16, !dbg !65
@.str = private unnamed_addr constant [17 x i8] c"rc-tanix-tx3mini\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_tanix_tx3mini to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_tanix_tx3mini202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_tanix_tx3mini to i8*), i8* getelementptr inbounds ([64 x i8], [64 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([70 x i8], [70 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_tanix_tx3mini() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @tanix_tx3mini_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_tanix_tx3mini() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @tanix_tx3mini_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "tanix_tx3mini_map", scope: !2, file: !3, line: 54, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-tanix-tx3mini.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_tanix_tx3mini202", scope: !2, file: !3, line: 73, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_tanix_tx3mini", scope: !2, file: !3, line: 74, type: !43, isLocal: true, isDefinition: true)
...
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 560, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 70)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "tanix_tx3mini", scope: !2, file: !3, line: 11, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_tanix_tx3mini", scope: !3, file: !3, line: 68, type: !46, scopeLine: 69, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 70, column: 2, scope: !123)
!125 = !DILocation(line: 71, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_tanix_tx3mini", scope: !3, file: !3, line: 63, type: !127, scopeLine: 64, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
