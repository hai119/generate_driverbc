; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-tango.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-tango.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_tango6:\09\09\09"
module asm ".long\09init_rc_map_tango - .\09\09\09"
...
@tango_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([50 x %struct.rc_map_table], [50 x %struct.rc_map_table]* @tango_table, i32 0, i32 0), i32 50, i32 0, i32 0, i32 10, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_tango202 = internal global i8* bitcast (i32 ()* @init_rc_map_tango to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_tango = internal global void ()* @exit_rc_map_tango, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_author203 = internal constant [30 x i8] c"rc_tango.author=Sigma Designs\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_file204 = internal constant [48 x i8] c"rc_tango.file=drivers/media/rc/keymaps/rc-tango\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_license205 = internal constant [21 x i8] c"rc_tango.license=GPL\00", section ".modinfo", align 1, !dbg !60
@tango_table = internal global [50 x %struct.rc_map_table] [%struct.rc_map_table { i64 314186, i32 116 }, %struct.rc_map_table { i64 314184, i32 144 }, %struct.rc_map_table { i64 314127, i32 141 }, %struct.rc_map_table { i64 314189, i32 205 }, %struct.rc_map_table { i64 314190, i32 115 }, %struct.rc_map_table { i64 314180, i32 161 }, %struct.rc_map_table { i64 314131, i32 377 }, %struct.rc_map_table { i64 314193, i32 113 }, %struct.rc_map_table { i64 314194, i32 114 }, %struct.rc_map_table { i64 314177, i32 513 }, %struct.rc_map_table { i64 314115, i32 514 }, %struct.rc_map_table { i64 314178, i32 515 }, %struct.rc_map_table { i64 314181, i32 516 }, %struct.rc_map_table { i64 314119, i32 517 }, %struct.rc_map_table { i64 314182, i32 518 }, %struct.rc_map_table { i64 314197, i32 519 }, %struct.rc_map_table { i64 314135, i32 520 }, %struct.rc_map_table { i64 314198, i32 521 }, %struct.rc_map_table { i64 314139, i32 512 }, %struct.rc_map_table { i64 314201, i32 111 }, %struct.rc_map_table { i64 314202, i32 58 }, %struct.rc_map_table { i64 314183, i32 158 }, %struct.rc_map_table { i64 314117, i32 227 }, %struct.rc_map_table { i64 314118, i32 103 }, %struct.rc_map_table { i64 314179, i32 105 }, %struct.rc_map_table { i64 314113, i32 106 }, %struct.rc_map_table { i64 314122, i32 108 }, %struct.rc_map_table { i64 314114, i32 28 }, %struct.rc_map_table { i64 314187, i32 358 }, %struct.rc_map_table { i64 314121, i32 102 }, %struct.rc_map_table { i64 314195, i32 139 }, %struct.rc_map_table { i64 314130, i32 412 }, %struct.rc_map_table { i64 314192, i32 207 }, %struct.rc_map_table { i64 314129, i32 407 }, %struct.rc_map_table { i64 314191, i32 369 }, %struct.rc_map_table { i64 314126, i32 168 }, %struct.rc_map_table { i64 314188, i32 128 }, %struct.rc_map_table { i64 314125, i32 159 }, %struct.rc_map_table { i64 314199, i32 439 }, %struct.rc_map_table { i64 314134, i32 371 }, %struct.rc_map_table { i64 314196, i32 119 }, %struct.rc_map_table { i64 314133, i32 409 }, %struct.rc_map_table { i64 314203, i32 359 }, %struct.rc_map_table { i64 314138, i32 392 }, %struct.rc_map_table { i64 314200, i32 370 }, %struct.rc_map_table { i64 314137, i32 372 }, %struct.rc_map_table { i64 314207, i32 398 }, %struct.rc_map_table { i64 314142, i32 399 }, %struct.rc_map_table { i64 314204, i32 400 }, %struct.rc_map_table { i64 314141, i32 401 }], align 16, !dbg !65
@.str = private unnamed_addr constant [9 x i8] c"rc-tango\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_tango to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_tango202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_tango to i8*), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__UNIQUE_ID_author203, i32 0, i32 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @__UNIQUE_ID_file204, i32 0, i32 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__UNIQUE_ID_license205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_tango() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @tango_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_tango() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @tango_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "tango_map", scope: !2, file: !3, line: 66, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-tango.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_tango202", scope: !2, file: !3, line: 85, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_tango", scope: !2, file: !3, line: 86, type: !43, isLocal: true, isDefinition: true)
...
!49 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author203", scope: !2, file: !3, line: 88, type: !50, isLocal: true, isDefinition: true, align: 8)
!50 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 240, elements: !53)
!51 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !52)
!52 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!53 = !{!54}
!54 = !DISubrange(count: 30)
!55 = !DIGlobalVariableExpression(var: !56, expr: !DIExpression())
!56 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file204", scope: !2, file: !3, line: 89, type: !57, isLocal: true, isDefinition: true, align: 8)
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 384, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 48)
!60 = !DIGlobalVariableExpression(var: !61, expr: !DIExpression())
!61 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license205", scope: !2, file: !3, line: 89, type: !62, isLocal: true, isDefinition: true, align: 8)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 168, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 21)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "tango_table", scope: !2, file: !3, line: 9, type: !67, isLocal: true, isDefinition: true)
!67 = !DICompositeType(tag: DW_TAG_array_type, baseType: !68, size: 6400, elements: !80)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_tango", scope: !3, file: !3, line: 80, type: !46, scopeLine: 81, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 82, column: 2, scope: !123)
!125 = !DILocation(line: 83, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_tango", scope: !3, file: !3, line: 75, type: !127, scopeLine: 76, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
