; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-alink-dtu-m.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-alink-dtu-m.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_alink_dtu_m6:\09\09\09"
module asm ".long\09init_rc_map_alink_dtu_m - .\09\09\09"
...
@alink_dtu_m_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([18 x %struct.rc_map_table], [18 x %struct.rc_map_table]* @alink_dtu_m, i32 0, i32 0), i32 18, i32 0, i32 0, i32 9, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_alink_dtu_m202 = internal global i8* bitcast (i32 ()* @init_rc_map_alink_dtu_m to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_alink_dtu_m = internal global void ()* @exit_rc_map_alink_dtu_m, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [60 x i8] c"rc_alink_dtu_m.file=drivers/media/rc/keymaps/rc-alink-dtu-m\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [27 x i8] c"rc_alink_dtu_m.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [53 x i8] c"rc_alink_dtu_m.author=Antti Palosaari <crope@iki.fi>\00", section ".modinfo", align 1, !dbg !60
@alink_dtu_m = internal global [18 x %struct.rc_map_table] [%struct.rc_map_table { i64 2048, i32 115 }, %struct.rc_map_table { i64 2049, i32 513 }, %struct.rc_map_table { i64 2050, i32 515 }, %struct.rc_map_table { i64 2051, i32 519 }, %struct.rc_map_table { i64 2052, i32 521 }, %struct.rc_map_table { i64 2053, i32 181 }, %struct.rc_map_table { i64 2054, i32 512 }, %struct.rc_map_table { i64 2055, i32 363 }, %struct.rc_map_table { i64 2061, i32 517 }, %struct.rc_map_table { i64 2063, i32 514 }, %struct.rc_map_table { i64 2066, i32 356 }, %struct.rc_map_table { i64 2068, i32 402 }, %struct.rc_map_table { i64 2070, i32 114 }, %struct.rc_map_table { i64 2072, i32 518 }, %struct.rc_map_table { i64 2074, i32 113 }, %struct.rc_map_table { i64 2075, i32 520 }, %struct.rc_map_table { i64 2076, i32 516 }, %struct.rc_map_table { i64 2077, i32 403 }], align 16, !dbg !65
@.str = private unnamed_addr constant [15 x i8] c"rc-alink-dtu-m\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_alink_dtu_m to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_alink_dtu_m202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_alink_dtu_m to i8*), i8* getelementptr inbounds ([60 x i8], [60 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([53 x i8], [53 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_alink_dtu_m() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @alink_dtu_m_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_alink_dtu_m() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @alink_dtu_m_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "alink_dtu_m_map", scope: !2, file: !3, line: 33, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-alink-dtu-m.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_alink_dtu_m202", scope: !2, file: !3, line: 52, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_alink_dtu_m", scope: !2, file: !3, line: 53, type: !43, isLocal: true, isDefinition: true)
...
!49 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file203", scope: !2, file: !3, line: 55, type: !50, isLocal: true, isDefinition: true, align: 8)
...
!56 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license204", scope: !2, file: !3, line: 55, type: !57, isLocal: true, isDefinition: true, align: 8)
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 216, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 27)
!60 = !DIGlobalVariableExpression(var: !61, expr: !DIExpression())
!61 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author205", scope: !2, file: !3, line: 56, type: !62, isLocal: true, isDefinition: true, align: 8)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 424, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 53)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "alink_dtu_m", scope: !2, file: !3, line: 12, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_alink_dtu_m", scope: !3, file: !3, line: 47, type: !46, scopeLine: 48, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 49, column: 2, scope: !123)
!125 = !DILocation(line: 50, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_alink_dtu_m", scope: !3, file: !3, line: 42, type: !127, scopeLine: 43, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!127 = !DISubroutineType(types: !128)
!128 = !{!129}
!129 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!130 = !DILocation(line: 44, column: 9, scope: !126)
!131 = !DILocation(line: 44, column: 2, scope: !126)
