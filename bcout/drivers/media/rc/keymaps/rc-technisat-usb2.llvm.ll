; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-technisat-usb2.llvm.bc'
...
@technisat_usb2_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([33 x %struct.rc_map_table], [33 x %struct.rc_map_table]* @technisat_usb2, i32 0, i32 0), i32 33, i32 0, i32 0, i32 2, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
...
@__UNIQUE_ID_author203 = internal constant [71 x i8] c"rc_technisat_usb2.author=Patrick Boettcher <pboettcher@kernellabs.com>\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_file204 = internal constant [66 x i8] c"rc_technisat_usb2.file=drivers/media/rc/keymaps/rc-technisat-usb2\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_license205 = internal constant [30 x i8] c"rc_technisat_usb2.license=GPL\00", section ".modinfo", align 1, !dbg !60
@technisat_usb2 = internal global [33 x %struct.rc_map_table] [%struct.rc_map_table { i64 2572, i32 116 }, %struct.rc_map_table { i64 2561, i32 513 }, %struct.rc_map_table { i64 2562, i32 514 }, %struct.rc_map_table { i64 2563, i32 515 }, %struct.rc_map_table { i64 2573, i32 113 }, %struct.rc_map_table { i64 2564, i32 516 }, %struct.rc_map_table { i64 2565, i32 517 }, %struct.rc_map_table { i64 2566, i32 518 }, %struct.rc_map_table { i64 2616, i32 393 }, %struct.rc_map_table { i64 2567, i32 519 }, %struct.rc_map_table { i64 2568, i32 520 }, %struct.rc_map_table { i64 2569, i32 521 }, %struct.rc_map_table { i64 2560, i32 512 }, %struct.rc_map_table { i64 2639, i32 358 }, %struct.rc_map_table { i64 2592, i32 402 }, %struct.rc_map_table { i64 2642, i32 139 }, %struct.rc_map_table { i64 2577, i32 115 }, %struct.rc_map_table { i64 2647, i32 352 }, %struct.rc_map_table { i64 2576, i32 114 }, %struct.rc_map_table { i64 2607, i32 365 }, %struct.rc_map_table { i64 2593, i32 403 }, %struct.rc_map_table { i64 2594, i32 173 }, %struct.rc_map_table { i64 2620, i32 388 }, %struct.rc_map_table { i64 2678, i32 28 }, %struct.rc_map_table { i64 2575, i32 138 }, %struct.rc_map_table { i64 2667, i32 398 }, %struct.rc_map_table { i64 2668, i32 399 }, %struct.rc_map_table { i64 2669, i32 400 }, %struct.rc_map_table { i64 2670, i32 401 }, %struct.rc_map_table { i64 2601, i32 128 }, %struct.rc_map_table { i64 2595, i32 368 }, %struct.rc_map_table { i64 2643, i32 377 }, %struct.rc_map_table { i64 2570, i32 362 }], align 16, !dbg !65
@.str = private unnamed_addr constant [18 x i8] c"rc-technisat-usb2\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map to i8*), i8* getelementptr inbounds ([71 x i8], [71 x i8]* @__UNIQUE_ID_author203, i32 0, i32 0), i8* getelementptr inbounds ([66 x i8], [66 x i8]* @__UNIQUE_ID_file204, i32 0, i32 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__UNIQUE_ID_license205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @technisat_usb2_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @technisat_usb2_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "technisat_usb2_map", scope: !2, file: !3, line: 67, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-technisat-usb2.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map202", scope: !2, file: !3, line: 86, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map", scope: !2, file: !3, line: 87, type: !43, isLocal: true, isDefinition: true)
...
!49 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author203", scope: !2, file: !3, line: 89, type: !50, isLocal: true, isDefinition: true, align: 8)
...
!56 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file204", scope: !2, file: !3, line: 90, type: !57, isLocal: true, isDefinition: true, align: 8)
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 528, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 66)
!60 = !DIGlobalVariableExpression(var: !61, expr: !DIExpression())
!61 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license205", scope: !2, file: !3, line: 90, type: !62, isLocal: true, isDefinition: true, align: 8)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 240, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 30)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "technisat_usb2", scope: !2, file: !3, line: 31, type: !67, isLocal: true, isDefinition: true)
!67 = !DICompositeType(tag: DW_TAG_array_type, baseType: !68, size: 4224, elements: !80)
...
!123 = distinct !DISubprogram(name: "exit_rc_map", scope: !3, file: !3, line: 81, type: !46, scopeLine: 82, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 83, column: 2, scope: !123)
!125 = !DILocation(line: 84, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map", scope: !3, file: !3, line: 76, type: !127, scopeLine: 77, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
