; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-geekbox.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-geekbox.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_geekbox6:\09\09\09"
module asm ".long\09init_rc_map_geekbox - .\09\09\09"
...
@geekbox_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([12 x %struct.rc_map_table], [12 x %struct.rc_map_table]* @geekbox, i32 0, i32 0), i32 12, i32 0, i32 0, i32 9, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_geekbox202 = internal global i8* bitcast (i32 ()* @init_rc_map_geekbox to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_geekbox = internal global void ()* @exit_rc_map_geekbox, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [52 x i8] c"rc_geekbox.file=drivers/media/rc/keymaps/rc-geekbox\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [23 x i8] c"rc_geekbox.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [75 x i8] c"rc_geekbox.author=Martin Blumenstingl <martin.blumenstingl@googlemail.com>\00", section ".modinfo", align 1, !dbg !60
@geekbox = internal global [12 x %struct.rc_map_table] [%struct.rc_map_table { i64 1, i32 158 }, %struct.rc_map_table { i64 2, i32 108 }, %struct.rc_map_table { i64 3, i32 103 }, %struct.rc_map_table { i64 7, i32 352 }, %struct.rc_map_table { i64 11, i32 115 }, %struct.rc_map_table { i64 14, i32 105 }, %struct.rc_map_table { i64 19, i32 139 }, %struct.rc_map_table { i64 20, i32 116 }, %struct.rc_map_table { i64 26, i32 106 }, %struct.rc_map_table { i64 72, i32 102 }, %struct.rc_map_table { i64 88, i32 114 }, %struct.rc_map_table { i64 92, i32 375 }], align 16, !dbg !65
@.str = private unnamed_addr constant [11 x i8] c"rc-geekbox\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_geekbox to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_geekbox202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_geekbox to i8*), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([75 x i8], [75 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_geekbox() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @geekbox_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_geekbox() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @geekbox_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "geekbox_map", scope: !2, file: !3, line: 26, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-geekbox.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_geekbox202", scope: !2, file: !3, line: 45, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_geekbox", scope: !2, file: !3, line: 46, type: !43, isLocal: true, isDefinition: true)
...
!49 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file203", scope: !2, file: !3, line: 48, type: !50, isLocal: true, isDefinition: true, align: 8)
...
!56 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license204", scope: !2, file: !3, line: 48, type: !57, isLocal: true, isDefinition: true, align: 8)
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 184, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 23)
!60 = !DIGlobalVariableExpression(var: !61, expr: !DIExpression())
!61 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author205", scope: !2, file: !3, line: 49, type: !62, isLocal: true, isDefinition: true, align: 8)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 600, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 75)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "geekbox", scope: !2, file: !3, line: 11, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_geekbox", scope: !3, file: !3, line: 40, type: !46, scopeLine: 41, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 42, column: 2, scope: !123)
!125 = !DILocation(line: 43, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_geekbox", scope: !3, file: !3, line: 35, type: !127, scopeLine: 36, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
