; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-avermedia.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-avermedia.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_avermedia6:\09\09\09"
module asm ".long\09init_rc_map_avermedia - .\09\09\09"
...
@avermedia_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([36 x %struct.rc_map_table], [36 x %struct.rc_map_table]* @avermedia, i32 0, i32 0), i32 36, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_avermedia202 = internal global i8* bitcast (i32 ()* @init_rc_map_avermedia to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_avermedia = internal global void ()* @exit_rc_map_avermedia, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [56 x i8] c"rc_avermedia.file=drivers/media/rc/keymaps/rc-avermedia\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [25 x i8] c"rc_avermedia.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [42 x i8] c"rc_avermedia.author=Mauro Carvalho Chehab\00", section ".modinfo", align 1, !dbg !60
@avermedia = internal global [36 x %struct.rc_map_table] [%struct.rc_map_table { i64 40, i32 513 }, %struct.rc_map_table { i64 24, i32 514 }, %struct.rc_map_table { i64 56, i32 515 }, %struct.rc_map_table { i64 36, i32 516 }, %struct.rc_map_table { i64 20, i32 517 }, %struct.rc_map_table { i64 52, i32 518 }, %struct.rc_map_table { i64 44, i32 519 }, %struct.rc_map_table { i64 28, i32 520 }, %struct.rc_map_table { i64 60, i32 521 }, %struct.rc_map_table { i64 34, i32 512 }, %struct.rc_map_table { i64 32, i32 377 }, %struct.rc_map_table { i64 16, i32 383 }, %struct.rc_map_table { i64 48, i32 388 }, %struct.rc_map_table { i64 0, i32 116 }, %struct.rc_map_table { i64 8, i32 393 }, %struct.rc_map_table { i64 4, i32 392 }, %struct.rc_map_table { i64 12, i32 372 }, %struct.rc_map_table { i64 18, i32 370 }, %struct.rc_map_table { i64 50, i32 168 }, %struct.rc_map_table { i64 2, i32 210 }, %struct.rc_map_table { i64 42, i32 217 }, %struct.rc_map_table { i64 26, i32 142 }, %struct.rc_map_table { i64 58, i32 212 }, %struct.rc_map_table { i64 10, i32 113 }, %struct.rc_map_table { i64 38, i32 167 }, %struct.rc_map_table { i64 22, i32 119 }, %struct.rc_map_table { i64 54, i32 128 }, %struct.rc_map_table { i64 6, i32 207 }, %struct.rc_map_table { i64 46, i32 398 }, %struct.rc_map_table { i64 33, i32 399 }, %struct.rc_map_table { i64 14, i32 400 }, %struct.rc_map_table { i64 1, i32 401 }, %struct.rc_map_table { i64 30, i32 114 }, %struct.rc_map_table { i64 62, i32 115 }, %struct.rc_map_table { i64 17, i32 403 }, %struct.rc_map_table { i64 49, i32 402 }], align 16, !dbg !65
@.str = private unnamed_addr constant [13 x i8] c"rc-avermedia\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_avermedia to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_avermedia202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_avermedia to i8*), i8* getelementptr inbounds ([56 x i8], [56 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([42 x i8], [42 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_avermedia() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @avermedia_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_avermedia() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @avermedia_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "avermedia_map", scope: !2, file: !3, line: 59, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-avermedia.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_avermedia202", scope: !2, file: !3, line: 78, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_avermedia", scope: !2, file: !3, line: 79, type: !43, isLocal: true, isDefinition: true)
...
!66 = distinct !DIGlobalVariable(name: "avermedia", scope: !2, file: !3, line: 13, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_avermedia", scope: !3, file: !3, line: 73, type: !46, scopeLine: 74, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 75, column: 2, scope: !123)
!125 = !DILocation(line: 76, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_avermedia", scope: !3, file: !3, line: 68, type: !127, scopeLine: 69, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
