; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-iodata-bctv7e.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-iodata-bctv7e.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_iodata_bctv7e6:\09\09\09"
module asm ".long\09init_rc_map_iodata_bctv7e - .\09\09\09"
...
@iodata_bctv7e_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([36 x %struct.rc_map_table], [36 x %struct.rc_map_table]* @iodata_bctv7e, i32 0, i32 0), i32 36, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_iodata_bctv7e202 = internal global i8* bitcast (i32 ()* @init_rc_map_iodata_bctv7e to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_iodata_bctv7e = internal global void ()* @exit_rc_map_iodata_bctv7e, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [64 x i8] c"rc_iodata_bctv7e.file=drivers/media/rc/keymaps/rc-iodata-bctv7e\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [29 x i8] c"rc_iodata_bctv7e.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [46 x i8] c"rc_iodata_bctv7e.author=Mauro Carvalho Chehab\00", section ".modinfo", align 1, !dbg !60
@iodata_bctv7e = internal global [36 x %struct.rc_map_table] [%struct.rc_map_table { i64 64, i32 377 }, %struct.rc_map_table { i64 32, i32 385 }, %struct.rc_map_table { i64 96, i32 365 }, %struct.rc_map_table { i64 0, i32 116 }, %struct.rc_map_table { i64 68, i32 512 }, %struct.rc_map_table { i64 80, i32 513 }, %struct.rc_map_table { i64 48, i32 514 }, %struct.rc_map_table { i64 112, i32 515 }, %struct.rc_map_table { i64 72, i32 516 }, %struct.rc_map_table { i64 40, i32 517 }, %struct.rc_map_table { i64 104, i32 518 }, %struct.rc_map_table { i64 88, i32 519 }, %struct.rc_map_table { i64 56, i32 520 }, %struct.rc_map_table { i64 120, i32 521 }, %struct.rc_map_table { i64 16, i32 38 }, %struct.rc_map_table { i64 8, i32 359 }, %struct.rc_map_table { i64 24, i32 164 }, %struct.rc_map_table { i64 36, i32 28 }, %struct.rc_map_table { i64 100, i32 1 }, %struct.rc_map_table { i64 4, i32 50 }, %struct.rc_map_table { i64 84, i32 393 }, %struct.rc_map_table { i64 52, i32 402 }, %struct.rc_map_table { i64 116, i32 115 }, %struct.rc_map_table { i64 20, i32 113 }, %struct.rc_map_table { i64 76, i32 379 }, %struct.rc_map_table { i64 44, i32 403 }, %struct.rc_map_table { i64 108, i32 114 }, %struct.rc_map_table { i64 12, i32 372 }, %struct.rc_map_table { i64 92, i32 119 }, %struct.rc_map_table { i64 60, i32 398 }, %struct.rc_map_table { i64 124, i32 167 }, %struct.rc_map_table { i64 28, i32 128 }, %struct.rc_map_table { i64 65, i32 168 }, %struct.rc_map_table { i64 33, i32 207 }, %struct.rc_map_table { i64 97, i32 208 }, %struct.rc_map_table { i64 1, i32 407 }], align 16, !dbg !65
@.str = private unnamed_addr constant [17 x i8] c"rc-iodata-bctv7e\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_iodata_bctv7e to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_iodata_bctv7e202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_iodata_bctv7e to i8*), i8* getelementptr inbounds ([64 x i8], [64 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([46 x i8], [46 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_iodata_bctv7e() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @iodata_bctv7e_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_iodata_bctv7e() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @iodata_bctv7e_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "iodata_bctv7e_map", scope: !2, file: !3, line: 61, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-iodata-bctv7e.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_iodata_bctv7e202", scope: !2, file: !3, line: 80, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_iodata_bctv7e", scope: !2, file: !3, line: 81, type: !43, isLocal: true, isDefinition: true)
...
!66 = distinct !DIGlobalVariable(name: "iodata_bctv7e", scope: !2, file: !3, line: 13, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_iodata_bctv7e", scope: !3, file: !3, line: 75, type: !46, scopeLine: 76, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 77, column: 2, scope: !123)
!125 = !DILocation(line: 78, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_iodata_bctv7e", scope: !3, file: !3, line: 70, type: !127, scopeLine: 71, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
