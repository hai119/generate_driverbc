; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-avermedia-a16d.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-avermedia-a16d.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_avermedia_a16d6:\09\09\09"
module asm ".long\09init_rc_map_avermedia_a16d - .\09\09\09"
...
@avermedia_a16d_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([34 x %struct.rc_map_table], [34 x %struct.rc_map_table]* @avermedia_a16d, i32 0, i32 0), i32 34, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_avermedia_a16d202 = internal global i8* bitcast (i32 ()* @init_rc_map_avermedia_a16d to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_avermedia_a16d = internal global void ()* @exit_rc_map_avermedia_a16d, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [66 x i8] c"rc_avermedia_a16d.file=drivers/media/rc/keymaps/rc-avermedia-a16d\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [30 x i8] c"rc_avermedia_a16d.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [47 x i8] c"rc_avermedia_a16d.author=Mauro Carvalho Chehab\00", section ".modinfo", align 1, !dbg !60
@avermedia_a16d = internal global [34 x %struct.rc_map_table] [%struct.rc_map_table { i64 32, i32 395 }, %struct.rc_map_table { i64 0, i32 116 }, %struct.rc_map_table { i64 40, i32 513 }, %struct.rc_map_table { i64 24, i32 514 }, %struct.rc_map_table { i64 56, i32 515 }, %struct.rc_map_table { i64 36, i32 516 }, %struct.rc_map_table { i64 20, i32 517 }, %struct.rc_map_table { i64 52, i32 518 }, %struct.rc_map_table { i64 44, i32 519 }, %struct.rc_map_table { i64 28, i32 520 }, %struct.rc_map_table { i64 60, i32 521 }, %struct.rc_map_table { i64 18, i32 370 }, %struct.rc_map_table { i64 34, i32 512 }, %struct.rc_map_table { i64 50, i32 168 }, %struct.rc_map_table { i64 58, i32 410 }, %struct.rc_map_table { i64 2, i32 210 }, %struct.rc_map_table { i64 17, i32 403 }, %struct.rc_map_table { i64 49, i32 402 }, %struct.rc_map_table { i64 12, i32 372 }, %struct.rc_map_table { i64 30, i32 114 }, %struct.rc_map_table { i64 62, i32 115 }, %struct.rc_map_table { i64 10, i32 113 }, %struct.rc_map_table { i64 4, i32 392 }, %struct.rc_map_table { i64 38, i32 167 }, %struct.rc_map_table { i64 6, i32 207 }, %struct.rc_map_table { i64 54, i32 128 }, %struct.rc_map_table { i64 22, i32 119 }, %struct.rc_map_table { i64 46, i32 168 }, %struct.rc_map_table { i64 14, i32 208 }, %struct.rc_map_table { i64 48, i32 388 }, %struct.rc_map_table { i64 33, i32 399 }, %struct.rc_map_table { i64 1, i32 401 }, %struct.rc_map_table { i64 8, i32 365 }, %struct.rc_map_table { i64 42, i32 139 }], align 16, !dbg !65
@.str = private unnamed_addr constant [18 x i8] c"rc-avermedia-a16d\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_avermedia_a16d to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_avermedia_a16d202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_avermedia_a16d to i8*), i8* getelementptr inbounds ([66 x i8], [66 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([47 x i8], [47 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_avermedia_a16d() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @avermedia_a16d_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_avermedia_a16d() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @avermedia_a16d_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "avermedia_a16d_map", scope: !2, file: !3, line: 48, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-avermedia-a16d.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_avermedia_a16d202", scope: !2, file: !3, line: 67, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_avermedia_a16d", scope: !2, file: !3, line: 68, type: !43, isLocal: true, isDefinition: true)
...
!49 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file203", scope: !2, file: !3, line: 70, type: !50, isLocal: true, isDefinition: true, align: 8)
...
!56 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license204", scope: !2, file: !3, line: 70, type: !57, isLocal: true, isDefinition: true, align: 8)
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 240, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 30)
!60 = !DIGlobalVariableExpression(var: !61, expr: !DIExpression())
!61 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author205", scope: !2, file: !3, line: 71, type: !62, isLocal: true, isDefinition: true, align: 8)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 376, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 47)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "avermedia_a16d", scope: !2, file: !3, line: 11, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_avermedia_a16d", scope: !3, file: !3, line: 62, type: !46, scopeLine: 63, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 64, column: 2, scope: !123)
!125 = !DILocation(line: 65, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_avermedia_a16d", scope: !3, file: !3, line: 57, type: !127, scopeLine: 58, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!127 = !DISubroutineType(types: !128)
!128 = !{!129}
!129 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!130 = !DILocation(line: 59, column: 9, scope: !126)
!131 = !DILocation(line: 59, column: 2, scope: !126)
