; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-asus-ps3-100.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-asus-ps3-100.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_asus_ps3_1006:\09\09\09"
module asm ".long\09init_rc_map_asus_ps3_100 - .\09\09\09"
...
@asus_ps3_100_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([41 x %struct.rc_map_table], [41 x %struct.rc_map_table]* @asus_ps3_100, i32 0, i32 0), i32 41, i32 0, i32 0, i32 2, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_asus_ps3_100202 = internal global i8* bitcast (i32 ()* @init_rc_map_asus_ps3_100 to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_asus_ps3_100 = internal global void ()* @exit_rc_map_asus_ps3_100, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [62 x i8] c"rc_asus_ps3_100.file=drivers/media/rc/keymaps/rc-asus-ps3-100\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [28 x i8] c"rc_asus_ps3_100.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [45 x i8] c"rc_asus_ps3_100.author=Mauro Carvalho Chehab\00", section ".modinfo", align 1, !dbg !60
@asus_ps3_100 = internal global [41 x %struct.rc_map_table] [%struct.rc_map_table { i64 2076, i32 102 }, %struct.rc_map_table { i64 2078, i32 377 }, %struct.rc_map_table { i64 2051, i32 388 }, %struct.rc_map_table { i64 2089, i32 116 }, %struct.rc_map_table { i64 2059, i32 398 }, %struct.rc_map_table { i64 2061, i32 400 }, %struct.rc_map_table { i64 2054, i32 401 }, %struct.rc_map_table { i64 2055, i32 399 }, %struct.rc_map_table { i64 2090, i32 512 }, %struct.rc_map_table { i64 2070, i32 513 }, %struct.rc_map_table { i64 2066, i32 514 }, %struct.rc_map_table { i64 2068, i32 515 }, %struct.rc_map_table { i64 2102, i32 516 }, %struct.rc_map_table { i64 2098, i32 517 }, %struct.rc_map_table { i64 2100, i32 518 }, %struct.rc_map_table { i64 2062, i32 519 }, %struct.rc_map_table { i64 2058, i32 520 }, %struct.rc_map_table { i64 2060, i32 521 }, %struct.rc_map_table { i64 2069, i32 115 }, %struct.rc_map_table { i64 2086, i32 114 }, %struct.rc_map_table { i64 2101, i32 402 }, %struct.rc_map_table { i64 2084, i32 403 }, %struct.rc_map_table { i64 2056, i32 103 }, %struct.rc_map_table { i64 2052, i32 108 }, %struct.rc_map_table { i64 2072, i32 105 }, %struct.rc_map_table { i64 2064, i32 106 }, %struct.rc_map_table { i64 2085, i32 28 }, %struct.rc_map_table { i64 2082, i32 174 }, %struct.rc_map_table { i64 2092, i32 406 }, %struct.rc_map_table { i64 2080, i32 392 }, %struct.rc_map_table { i64 2103, i32 375 }, %struct.rc_map_table { i64 2094, i32 372 }, %struct.rc_map_table { i64 2050, i32 113 }, %struct.rc_map_table { i64 2097, i32 168 }, %struct.rc_map_table { i64 2065, i32 167 }, %struct.rc_map_table { i64 2057, i32 128 }, %struct.rc_map_table { i64 2053, i32 208 }, %struct.rc_map_table { i64 2081, i32 412 }, %struct.rc_map_table { i64 2074, i32 119 }, %struct.rc_map_table { i64 2105, i32 207 }, %struct.rc_map_table { i64 2073, i32 407 }], align 16, !dbg !65
@.str = private unnamed_addr constant [16 x i8] c"rc-asus-ps3-100\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_asus_ps3_100 to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_asus_ps3_100202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_asus_ps3_100 to i8*), i8* getelementptr inbounds ([62 x i8], [62 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_asus_ps3_100() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @asus_ps3_100_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_asus_ps3_100() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @asus_ps3_100_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "asus_ps3_100_map", scope: !2, file: !3, line: 63, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-asus-ps3-100.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_asus_ps3_100202", scope: !2, file: !3, line: 82, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_asus_ps3_100", scope: !2, file: !3, line: 83, type: !43, isLocal: true, isDefinition: true)
...
!66 = distinct !DIGlobalVariable(name: "asus_ps3_100", scope: !2, file: !3, line: 11, type: !67, isLocal: true, isDefinition: true)
!67 = !DICompositeType(tag: DW_TAG_array_type, baseType: !68, size: 5248, elements: !80)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_asus_ps3_100", scope: !3, file: !3, line: 77, type: !46, scopeLine: 78, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 79, column: 1, scope: !123)
!125 = !DILocation(line: 80, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_asus_ps3_100", scope: !3, file: !3, line: 72, type: !127, scopeLine: 73, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!127 = !DISubroutineType(types: !128)
!128 = !{!129}
!129 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!130 = !DILocation(line: 74, column: 8, scope: !126)
!131 = !DILocation(line: 74, column: 1, scope: !126)
