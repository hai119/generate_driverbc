; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-wetek-play2.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-wetek-play2.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_wetek_play26:\09\09\09"
module asm ".long\09init_rc_map_wetek_play2 - .\09\09\09"
...
@wetek_play2_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([43 x %struct.rc_map_table], [43 x %struct.rc_map_table]* @wetek_play2, i32 0, i32 0), i32 43, i32 0, i32 0, i32 10, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_wetek_play2202 = internal global i8* bitcast (i32 ()* @init_rc_map_wetek_play2 to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_wetek_play2 = internal global void ()* @exit_rc_map_wetek_play2, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [60 x i8] c"rc_wetek_play2.file=drivers/media/rc/keymaps/rc-wetek-play2\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [27 x i8] c"rc_wetek_play2.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [67 x i8] c"rc_wetek_play2.author=Christian Hewitt <christianshewitt@gmail.com\00", section ".modinfo", align 1, !dbg !60
@wetek_play2 = internal global [43 x %struct.rc_map_table] [%struct.rc_map_table { i64 6184706, i32 116 }, %struct.rc_map_table { i64 6184774, i32 142 }, %struct.rc_map_table { i64 6184720, i32 113 }, %struct.rc_map_table { i64 6184738, i32 2 }, %struct.rc_map_table { i64 6184739, i32 3 }, %struct.rc_map_table { i64 6184740, i32 4 }, %struct.rc_map_table { i64 6184741, i32 5 }, %struct.rc_map_table { i64 6184742, i32 6 }, %struct.rc_map_table { i64 6184743, i32 7 }, %struct.rc_map_table { i64 6184744, i32 8 }, %struct.rc_map_table { i64 6184745, i32 9 }, %struct.rc_map_table { i64 6184752, i32 10 }, %struct.rc_map_table { i64 6184817, i32 158 }, %struct.rc_map_table { i64 6184737, i32 11 }, %struct.rc_map_table { i64 6184818, i32 58 }, %struct.rc_map_table { i64 6184707, i32 102 }, %struct.rc_map_table { i64 6184801, i32 158 }, %struct.rc_map_table { i64 6184823, i32 171 }, %struct.rc_map_table { i64 6184835, i32 365 }, %struct.rc_map_table { i64 6184836, i32 375 }, %struct.rc_map_table { i64 6184776, i32 139 }, %struct.rc_map_table { i64 6184784, i32 103 }, %struct.rc_map_table { i64 6184779, i32 108 }, %struct.rc_map_table { i64 6184780, i32 105 }, %struct.rc_map_table { i64 6184781, i32 106 }, %struct.rc_map_table { i64 6184775, i32 352 }, %struct.rc_map_table { i64 6184772, i32 115 }, %struct.rc_map_table { i64 6184771, i32 114 }, %struct.rc_map_table { i64 6184783, i32 364 }, %struct.rc_map_table { i64 6184834, i32 370 }, %struct.rc_map_table { i64 6184769, i32 104 }, %struct.rc_map_table { i64 6184770, i32 109 }, %struct.rc_map_table { i64 6184819, i32 398 }, %struct.rc_map_table { i64 6184820, i32 399 }, %struct.rc_map_table { i64 6184821, i32 400 }, %struct.rc_map_table { i64 6184822, i32 401 }, %struct.rc_map_table { i64 6184807, i32 165 }, %struct.rc_map_table { i64 6184825, i32 168 }, %struct.rc_map_table { i64 6184832, i32 208 }, %struct.rc_map_table { i64 6184833, i32 163 }, %struct.rc_map_table { i64 6184708, i32 167 }, %struct.rc_map_table { i64 6184748, i32 164 }, %struct.rc_map_table { i64 6184747, i32 128 }], align 16, !dbg !65
@.str = private unnamed_addr constant [15 x i8] c"rc-wetek-play2\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_wetek_play2 to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_wetek_play2202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_wetek_play2 to i8*), i8* getelementptr inbounds ([60 x i8], [60 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([67 x i8], [67 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_wetek_play2() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @wetek_play2_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_wetek_play2() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @wetek_play2_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "wetek_play2_map", scope: !2, file: !3, line: 70, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-wetek-play2.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_wetek_play2202", scope: !2, file: !3, line: 89, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_wetek_play2", scope: !2, file: !3, line: 90, type: !43, isLocal: true, isDefinition: true)
...
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 536, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 67)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "wetek_play2", scope: !2, file: !3, line: 12, type: !67, isLocal: true, isDefinition: true)
!67 = !DICompositeType(tag: DW_TAG_array_type, baseType: !68, size: 5504, elements: !80)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_wetek_play2", scope: !3, file: !3, line: 84, type: !46, scopeLine: 85, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 86, column: 2, scope: !123)
!125 = !DILocation(line: 87, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_wetek_play2", scope: !3, file: !3, line: 79, type: !127, scopeLine: 80, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
