; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-reddo.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-reddo.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_reddo6:\09\09\09"
module asm ".long\09init_rc_map_reddo - .\09\09\09"
...
@reddo_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([23 x %struct.rc_map_table], [23 x %struct.rc_map_table]* @reddo, i32 0, i32 0), i32 23, i32 0, i32 0, i32 10, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_reddo202 = internal global i8* bitcast (i32 ()* @init_rc_map_reddo to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_reddo = internal global void ()* @exit_rc_map_reddo, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [48 x i8] c"rc_reddo.file=drivers/media/rc/keymaps/rc-reddo\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [21 x i8] c"rc_reddo.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [47 x i8] c"rc_reddo.author=Antti Palosaari <crope@iki.fi>\00", section ".modinfo", align 1, !dbg !60
@reddo = internal global [23 x %struct.rc_map_table] [%struct.rc_map_table { i64 6411777, i32 365 }, %struct.rc_map_table { i64 6411778, i32 515 }, %struct.rc_map_table { i64 6411780, i32 513 }, %struct.rc_map_table { i64 6411781, i32 517 }, %struct.rc_map_table { i64 6411782, i32 518 }, %struct.rc_map_table { i64 6411783, i32 403 }, %struct.rc_map_table { i64 6411784, i32 514 }, %struct.rc_map_table { i64 6411785, i32 402 }, %struct.rc_map_table { i64 6411786, i32 521 }, %struct.rc_map_table { i64 6411787, i32 372 }, %struct.rc_map_table { i64 6411788, i32 519 }, %struct.rc_map_table { i64 6411789, i32 520 }, %struct.rc_map_table { i64 6411790, i32 115 }, %struct.rc_map_table { i64 6411791, i32 516 }, %struct.rc_map_table { i64 6411792, i32 1 }, %struct.rc_map_table { i64 6411793, i32 512 }, %struct.rc_map_table { i64 6411794, i32 352 }, %struct.rc_map_table { i64 6411795, i32 114 }, %struct.rc_map_table { i64 6411796, i32 167 }, %struct.rc_map_table { i64 6411797, i32 128 }, %struct.rc_map_table { i64 6411798, i32 207 }, %struct.rc_map_table { i64 6411799, i32 113 }, %struct.rc_map_table { i64 6411843, i32 356 }], align 16, !dbg !65
@.str = private unnamed_addr constant [9 x i8] c"rc-reddo\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_reddo to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_reddo202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_reddo to i8*), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([47 x i8], [47 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_reddo() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @reddo_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_reddo() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @reddo_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "reddo_map", scope: !2, file: !3, line: 50, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-reddo.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_reddo202", scope: !2, file: !3, line: 69, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_reddo", scope: !2, file: !3, line: 70, type: !43, isLocal: true, isDefinition: true)
...
!66 = distinct !DIGlobalVariable(name: "reddo", scope: !2, file: !3, line: 24, type: !67, isLocal: true, isDefinition: true)
!67 = !DICompositeType(tag: DW_TAG_array_type, baseType: !68, size: 2944, elements: !80)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_reddo", scope: !3, file: !3, line: 64, type: !46, scopeLine: 65, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 66, column: 2, scope: !123)
!125 = !DILocation(line: 67, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_reddo", scope: !3, file: !3, line: 59, type: !127, scopeLine: 60, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
