; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-eztv.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-eztv.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_eztv6:\09\09\09"
module asm ".long\09init_rc_map_eztv - .\09\09\09"
...
@eztv_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([44 x %struct.rc_map_table], [44 x %struct.rc_map_table]* @eztv, i32 0, i32 0), i32 44, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_eztv202 = internal global i8* bitcast (i32 ()* @init_rc_map_eztv to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_eztv = internal global void ()* @exit_rc_map_eztv, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [46 x i8] c"rc_eztv.file=drivers/media/rc/keymaps/rc-eztv\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [20 x i8] c"rc_eztv.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [37 x i8] c"rc_eztv.author=Mauro Carvalho Chehab\00", section ".modinfo", align 1, !dbg !60
@eztv = internal global [44 x %struct.rc_map_table] [%struct.rc_map_table { i64 18, i32 116 }, %struct.rc_map_table { i64 1, i32 377 }, %struct.rc_map_table { i64 21, i32 389 }, %struct.rc_map_table { i64 23, i32 392 }, %struct.rc_map_table { i64 27, i32 113 }, %struct.rc_map_table { i64 2, i32 368 }, %struct.rc_map_table { i64 30, i32 370 }, %struct.rc_map_table { i64 22, i32 372 }, %struct.rc_map_table { i64 28, i32 393 }, %struct.rc_map_table { i64 29, i32 408 }, %struct.rc_map_table { i64 47, i32 217 }, %struct.rc_map_table { i64 48, i32 363 }, %struct.rc_map_table { i64 49, i32 138 }, %struct.rc_map_table { i64 50, i32 373 }, %struct.rc_map_table { i64 51, i32 1 }, %struct.rc_map_table { i64 12, i32 103 }, %struct.rc_map_table { i64 16, i32 108 }, %struct.rc_map_table { i64 8, i32 105 }, %struct.rc_map_table { i64 4, i32 106 }, %struct.rc_map_table { i64 3, i32 353 }, %struct.rc_map_table { i64 31, i32 168 }, %struct.rc_map_table { i64 32, i32 164 }, %struct.rc_map_table { i64 41, i32 159 }, %struct.rc_map_table { i64 20, i32 129 }, %struct.rc_map_table { i64 43, i32 167 }, %struct.rc_map_table { i64 44, i32 128 }, %struct.rc_map_table { i64 45, i32 207 }, %struct.rc_map_table { i64 46, i32 212 }, %struct.rc_map_table { i64 0, i32 512 }, %struct.rc_map_table { i64 5, i32 513 }, %struct.rc_map_table { i64 6, i32 514 }, %struct.rc_map_table { i64 7, i32 515 }, %struct.rc_map_table { i64 9, i32 516 }, %struct.rc_map_table { i64 10, i32 517 }, %struct.rc_map_table { i64 11, i32 518 }, %struct.rc_map_table { i64 13, i32 519 }, %struct.rc_map_table { i64 14, i32 520 }, %struct.rc_map_table { i64 15, i32 521 }, %struct.rc_map_table { i64 42, i32 115 }, %struct.rc_map_table { i64 17, i32 114 }, %struct.rc_map_table { i64 24, i32 402 }, %struct.rc_map_table { i64 25, i32 403 }, %struct.rc_map_table { i64 19, i32 28 }, %struct.rc_map_table { i64 33, i32 52 }], align 16, !dbg !65
@.str = private unnamed_addr constant [8 x i8] c"rc-eztv\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_eztv to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_eztv202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_eztv to i8*), i8* getelementptr inbounds ([46 x i8], [46 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_eztv() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @eztv_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_eztv() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @eztv_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "eztv_map", scope: !2, file: !3, line: 69, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-eztv.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_eztv202", scope: !2, file: !3, line: 88, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_eztv", scope: !2, file: !3, line: 89, type: !43, isLocal: true, isDefinition: true)
...
!50 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 368, elements: !53)
...
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 160, elements: !58)
!58 = !{!59}
...
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 296, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 37)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "eztv", scope: !2, file: !3, line: 14, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_eztv", scope: !3, file: !3, line: 83, type: !46, scopeLine: 84, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 85, column: 2, scope: !123)
!125 = !DILocation(line: 86, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_eztv", scope: !3, file: !3, line: 78, type: !127, scopeLine: 79, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
