; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-avermedia-m135a.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-avermedia-m135a.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_avermedia_m135a6:\09\09\09"
module asm ".long\09init_rc_map_avermedia_m135a - .\09\09\09"
...
@avermedia_m135a_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([80 x %struct.rc_map_table], [80 x %struct.rc_map_table]* @avermedia_m135a, i32 0, i32 0), i32 80, i32 0, i32 0, i32 9, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_avermedia_m135a202 = internal global i8* bitcast (i32 ()* @init_rc_map_avermedia_m135a to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_avermedia_m135a = internal global void ()* @exit_rc_map_avermedia_m135a, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [68 x i8] c"rc_avermedia_m135a.file=drivers/media/rc/keymaps/rc-avermedia-m135a\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [31 x i8] c"rc_avermedia_m135a.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [48 x i8] c"rc_avermedia_m135a.author=Mauro Carvalho Chehab\00", section ".modinfo", align 1, !dbg !60
@avermedia_m135a = internal global [80 x %struct.rc_map_table] [%struct.rc_map_table { i64 512, i32 356 }, %struct.rc_map_table { i64 558, i32 52 }, %struct.rc_map_table { i64 513, i32 373 }, %struct.rc_map_table { i64 517, i32 513 }, %struct.rc_map_table { i64 518, i32 514 }, %struct.rc_map_table { i64 519, i32 515 }, %struct.rc_map_table { i64 521, i32 516 }, %struct.rc_map_table { i64 522, i32 517 }, %struct.rc_map_table { i64 523, i32 518 }, %struct.rc_map_table { i64 525, i32 519 }, %struct.rc_map_table { i64 526, i32 520 }, %struct.rc_map_table { i64 527, i32 521 }, %struct.rc_map_table { i64 529, i32 512 }, %struct.rc_map_table { i64 531, i32 106 }, %struct.rc_map_table { i64 530, i32 105 }, %struct.rc_map_table { i64 533, i32 139 }, %struct.rc_map_table { i64 535, i32 212 }, %struct.rc_map_table { i64 528, i32 410 }, %struct.rc_map_table { i64 771, i32 402 }, %struct.rc_map_table { i64 770, i32 403 }, %struct.rc_map_table { i64 543, i32 115 }, %struct.rc_map_table { i64 542, i32 114 }, %struct.rc_map_table { i64 524, i32 28 }, %struct.rc_map_table { i64 532, i32 113 }, %struct.rc_map_table { i64 520, i32 392 }, %struct.rc_map_table { i64 515, i32 388 }, %struct.rc_map_table { i64 516, i32 365 }, %struct.rc_map_table { i64 555, i32 378 }, %struct.rc_map_table { i64 541, i32 398 }, %struct.rc_map_table { i64 540, i32 400 }, %struct.rc_map_table { i64 769, i32 399 }, %struct.rc_map_table { i64 768, i32 401 }, %struct.rc_map_table { i64 538, i32 164 }, %struct.rc_map_table { i64 537, i32 167 }, %struct.rc_map_table { i64 536, i32 207 }, %struct.rc_map_table { i64 539, i32 128 }, %struct.rc_map_table { i64 1025, i32 356 }, %struct.rc_map_table { i64 1030, i32 113 }, %struct.rc_map_table { i64 1032, i32 373 }, %struct.rc_map_table { i64 1033, i32 513 }, %struct.rc_map_table { i64 1034, i32 514 }, %struct.rc_map_table { i64 1035, i32 515 }, %struct.rc_map_table { i64 1036, i32 516 }, %struct.rc_map_table { i64 1037, i32 517 }, %struct.rc_map_table { i64 1038, i32 518 }, %struct.rc_map_table { i64 1039, i32 519 }, %struct.rc_map_table { i64 1040, i32 520 }, %struct.rc_map_table { i64 1041, i32 521 }, %struct.rc_map_table { i64 1100, i32 52 }, %struct.rc_map_table { i64 1042, i32 512 }, %struct.rc_map_table { i64 1031, i32 173 }, %struct.rc_map_table { i64 1043, i32 392 }, %struct.rc_map_table { i64 1088, i32 375 }, %struct.rc_map_table { i64 1089, i32 102 }, %struct.rc_map_table { i64 1090, i32 158 }, %struct.rc_map_table { i64 1095, i32 103 }, %struct.rc_map_table { i64 1096, i32 108 }, %struct.rc_map_table { i64 1097, i32 105 }, %struct.rc_map_table { i64 1098, i32 106 }, %struct.rc_map_table { i64 1099, i32 352 }, %struct.rc_map_table { i64 1028, i32 115 }, %struct.rc_map_table { i64 1029, i32 114 }, %struct.rc_map_table { i64 1026, i32 402 }, %struct.rc_map_table { i64 1027, i32 403 }, %struct.rc_map_table { i64 1091, i32 398 }, %struct.rc_map_table { i64 1092, i32 399 }, %struct.rc_map_table { i64 1093, i32 400 }, %struct.rc_map_table { i64 1094, i32 401 }, %struct.rc_map_table { i64 1044, i32 388 }, %struct.rc_map_table { i64 1045, i32 365 }, %struct.rc_map_table { i64 1050, i32 378 }, %struct.rc_map_table { i64 1051, i32 212 }, %struct.rc_map_table { i64 1047, i32 167 }, %struct.rc_map_table { i64 1046, i32 164 }, %struct.rc_map_table { i64 1048, i32 128 }, %struct.rc_map_table { i64 1049, i32 119 }, %struct.rc_map_table { i64 1055, i32 412 }, %struct.rc_map_table { i64 1052, i32 168 }, %struct.rc_map_table { i64 1053, i32 159 }, %struct.rc_map_table { i64 1054, i32 407 }], align 16, !dbg !65
@.str = private unnamed_addr constant [19 x i8] c"rc-avermedia-m135a\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_avermedia_m135a to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_avermedia_m135a202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_avermedia_m135a to i8*), i8* getelementptr inbounds ([68 x i8], [68 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([48 x i8], [48 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_avermedia_m135a() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @avermedia_m135a_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_avermedia_m135a() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @avermedia_m135a_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "avermedia_m135a_map", scope: !2, file: !3, line: 121, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-avermedia-m135a.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_avermedia_m135a202", scope: !2, file: !3, line: 140, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_avermedia_m135a", scope: !2, file: !3, line: 141, type: !43, isLocal: true, isDefinition: true)
...
!49 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file203", scope: !2, file: !3, line: 143, type: !50, isLocal: true, isDefinition: true, align: 8)
...
!56 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license204", scope: !2, file: !3, line: 143, type: !57, isLocal: true, isDefinition: true, align: 8)
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 248, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 31)
!60 = !DIGlobalVariableExpression(var: !61, expr: !DIExpression())
!61 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author205", scope: !2, file: !3, line: 144, type: !62, isLocal: true, isDefinition: true, align: 8)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 384, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 48)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "avermedia_m135a", scope: !2, file: !3, line: 21, type: !67, isLocal: true, isDefinition: true)
!67 = !DICompositeType(tag: DW_TAG_array_type, baseType: !68, size: 10240, elements: !80)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_avermedia_m135a", scope: !3, file: !3, line: 135, type: !46, scopeLine: 136, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 137, column: 2, scope: !123)
!125 = !DILocation(line: 138, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_avermedia_m135a", scope: !3, file: !3, line: 130, type: !127, scopeLine: 131, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!127 = !DISubroutineType(types: !128)
!128 = !{!129}
!129 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!130 = !DILocation(line: 132, column: 9, scope: !126)
!131 = !DILocation(line: 132, column: 2, scope: !126)
