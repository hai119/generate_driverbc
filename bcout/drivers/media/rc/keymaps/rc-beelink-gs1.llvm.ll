; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-beelink-gs1.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-beelink-gs1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_beelink_gs16:\09\09\09"
module asm ".long\09init_rc_map_beelink_gs1 - .\09\09\09"
...
@beelink_gs1_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([30 x %struct.rc_map_table], [30 x %struct.rc_map_table]* @beelink_gs1_table, i32 0, i32 0), i32 30, i32 0, i32 0, i32 9, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_beelink_gs1202 = internal global i8* bitcast (i32 ()* @init_rc_map_beelink_gs1 to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_beelink_gs1 = internal global void ()* @exit_rc_map_beelink_gs1, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [60 x i8] c"rc_beelink_gs1.file=drivers/media/rc/keymaps/rc-beelink-gs1\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [27 x i8] c"rc_beelink_gs1.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [61 x i8] c"rc_beelink_gs1.author=Cl\C3\A9ment P\C3\A9ron <peron.clem@gmail.com>\00", section ".modinfo", align 1, !dbg !60
@beelink_gs1_table = internal global [30 x %struct.rc_map_table] [%struct.rc_map_table { i64 32849, i32 116 }, %struct.rc_map_table { i64 32845, i32 113 }, %struct.rc_map_table { i64 32832, i32 171 }, %struct.rc_map_table { i64 32806, i32 103 }, %struct.rc_map_table { i64 32808, i32 108 }, %struct.rc_map_table { i64 32805, i32 105 }, %struct.rc_map_table { i64 32807, i32 106 }, %struct.rc_map_table { i64 32781, i32 352 }, %struct.rc_map_table { i64 32851, i32 102 }, %struct.rc_map_table { i64 32956, i32 226 }, %struct.rc_map_table { i64 32795, i32 158 }, %struct.rc_map_table { i64 32841, i32 139 }, %struct.rc_map_table { i64 32846, i32 115 }, %struct.rc_map_table { i64 32854, i32 114 }, %struct.rc_map_table { i64 32852, i32 370 }, %struct.rc_map_table { i64 32850, i32 365 }, %struct.rc_map_table { i64 32833, i32 402 }, %struct.rc_map_table { i64 32834, i32 403 }, %struct.rc_map_table { i64 32817, i32 2 }, %struct.rc_map_table { i64 32818, i32 3 }, %struct.rc_map_table { i64 32819, i32 4 }, %struct.rc_map_table { i64 32820, i32 5 }, %struct.rc_map_table { i64 32821, i32 6 }, %struct.rc_map_table { i64 32822, i32 7 }, %struct.rc_map_table { i64 32823, i32 8 }, %struct.rc_map_table { i64 32824, i32 9 }, %struct.rc_map_table { i64 32825, i32 10 }, %struct.rc_map_table { i64 32836, i32 111 }, %struct.rc_map_table { i64 32816, i32 11 }, %struct.rc_map_table { i64 32856, i32 373 }], align 16, !dbg !65
@.str = private unnamed_addr constant [15 x i8] c"rc-beelink-gs1\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_beelink_gs1 to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_beelink_gs1202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_beelink_gs1 to i8*), i8* getelementptr inbounds ([60 x i8], [60 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([61 x i8], [61 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_beelink_gs1() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @beelink_gs1_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_beelink_gs1() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @beelink_gs1_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "beelink_gs1_map", scope: !2, file: !3, line: 61, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-beelink-gs1.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_beelink_gs1202", scope: !2, file: !3, line: 80, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_beelink_gs1", scope: !2, file: !3, line: 81, type: !43, isLocal: true, isDefinition: true)
...
!66 = distinct !DIGlobalVariable(name: "beelink_gs1_table", scope: !2, file: !3, line: 11, type: !67, isLocal: true, isDefinition: true)
!67 = !DICompositeType(tag: DW_TAG_array_type, baseType: !68, size: 3840, elements: !80)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_beelink_gs1", scope: !3, file: !3, line: 75, type: !46, scopeLine: 76, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 77, column: 2, scope: !123)
!125 = !DILocation(line: 78, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_beelink_gs1", scope: !3, file: !3, line: 70, type: !127, scopeLine: 71, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
