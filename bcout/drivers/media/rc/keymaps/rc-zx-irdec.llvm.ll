; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-zx-irdec.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-zx-irdec.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_zx_irdec6:\09\09\09"
module asm ".long\09init_rc_map_zx_irdec - .\09\09\09"
...
@zx_irdec_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([40 x %struct.rc_map_table], [40 x %struct.rc_map_table]* @zx_irdec_table, i32 0, i32 0), i32 40, i32 0, i32 0, i32 9, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_zx_irdec202 = internal global i8* bitcast (i32 ()* @init_rc_map_zx_irdec to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_zx_irdec = internal global void ()* @exit_rc_map_zx_irdec, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_author203 = internal constant [52 x i8] c"rc_zx_irdec.author=Shawn Guo <shawn.guo@linaro.org>\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_file204 = internal constant [54 x i8] c"rc_zx_irdec.file=drivers/media/rc/keymaps/rc-zx-irdec\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_license205 = internal constant [27 x i8] c"rc_zx_irdec.license=GPL v2\00", section ".modinfo", align 1, !dbg !60
@zx_irdec_table = internal global [40 x %struct.rc_map_table] [%struct.rc_map_table { i64 1, i32 513 }, %struct.rc_map_table { i64 2, i32 514 }, %struct.rc_map_table { i64 3, i32 515 }, %struct.rc_map_table { i64 4, i32 516 }, %struct.rc_map_table { i64 5, i32 517 }, %struct.rc_map_table { i64 6, i32 518 }, %struct.rc_map_table { i64 7, i32 519 }, %struct.rc_map_table { i64 8, i32 520 }, %struct.rc_map_table { i64 9, i32 521 }, %struct.rc_map_table { i64 49, i32 512 }, %struct.rc_map_table { i64 22, i32 111 }, %struct.rc_map_table { i64 10, i32 373 }, %struct.rc_map_table { i64 12, i32 115 }, %struct.rc_map_table { i64 24, i32 114 }, %struct.rc_map_table { i64 11, i32 402 }, %struct.rc_map_table { i64 21, i32 403 }, %struct.rc_map_table { i64 13, i32 104 }, %struct.rc_map_table { i64 19, i32 109 }, %struct.rc_map_table { i64 70, i32 208 }, %struct.rc_map_table { i64 67, i32 168 }, %struct.rc_map_table { i64 68, i32 164 }, %struct.rc_map_table { i64 69, i32 128 }, %struct.rc_map_table { i64 73, i32 352 }, %struct.rc_map_table { i64 71, i32 103 }, %struct.rc_map_table { i64 75, i32 108 }, %struct.rc_map_table { i64 72, i32 105 }, %struct.rc_map_table { i64 74, i32 106 }, %struct.rc_map_table { i64 77, i32 139 }, %struct.rc_map_table { i64 86, i32 580 }, %struct.rc_map_table { i64 76, i32 158 }, %struct.rc_map_table { i64 30, i32 358 }, %struct.rc_map_table { i64 78, i32 59 }, %struct.rc_map_table { i64 79, i32 60 }, %struct.rc_map_table { i64 80, i32 61 }, %struct.rc_map_table { i64 81, i32 62 }, %struct.rc_map_table { i64 28, i32 392 }, %struct.rc_map_table { i64 18, i32 113 }, %struct.rc_map_table { i64 17, i32 52 }, %struct.rc_map_table { i64 29, i32 141 }, %struct.rc_map_table { i64 64, i32 116 }], align 16, !dbg !65
@.str = private unnamed_addr constant [12 x i8] c"rc-zx-irdec\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_zx_irdec to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_zx_irdec202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_zx_irdec to i8*), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @__UNIQUE_ID_author203, i32 0, i32 0), i8* getelementptr inbounds ([54 x i8], [54 x i8]* @__UNIQUE_ID_file204, i32 0, i32 0), i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__UNIQUE_ID_license205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_zx_irdec() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @zx_irdec_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_zx_irdec() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @zx_irdec_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "zx_irdec_map", scope: !2, file: !3, line: 53, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-zx-irdec.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_zx_irdec202", scope: !2, file: !3, line: 72, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_zx_irdec", scope: !2, file: !3, line: 73, type: !43, isLocal: true, isDefinition: true)
...
!49 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author203", scope: !2, file: !3, line: 75, type: !50, isLocal: true, isDefinition: true, align: 8)
...
!56 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file204", scope: !2, file: !3, line: 76, type: !57, isLocal: true, isDefinition: true, align: 8)
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 432, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 54)
!60 = !DIGlobalVariableExpression(var: !61, expr: !DIExpression())
!61 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license205", scope: !2, file: !3, line: 76, type: !62, isLocal: true, isDefinition: true, align: 8)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 216, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 27)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "zx_irdec_table", scope: !2, file: !3, line: 10, type: !67, isLocal: true, isDefinition: true)
!67 = !DICompositeType(tag: DW_TAG_array_type, baseType: !68, size: 5120, elements: !80)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_zx_irdec", scope: !3, file: !3, line: 67, type: !46, scopeLine: 68, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 69, column: 2, scope: !123)
!125 = !DILocation(line: 70, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_zx_irdec", scope: !3, file: !3, line: 62, type: !127, scopeLine: 63, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
