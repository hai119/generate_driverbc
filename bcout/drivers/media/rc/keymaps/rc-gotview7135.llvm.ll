; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-gotview7135.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-gotview7135.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_gotview71356:\09\09\09"
module asm ".long\09init_rc_map_gotview7135 - .\09\09\09"
...
@gotview7135_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([34 x %struct.rc_map_table], [34 x %struct.rc_map_table]* @gotview7135, i32 0, i32 0), i32 34, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_gotview7135202 = internal global i8* bitcast (i32 ()* @init_rc_map_gotview7135 to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_gotview7135 = internal global void ()* @exit_rc_map_gotview7135, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [60 x i8] c"rc_gotview7135.file=drivers/media/rc/keymaps/rc-gotview7135\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [27 x i8] c"rc_gotview7135.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [44 x i8] c"rc_gotview7135.author=Mauro Carvalho Chehab\00", section ".modinfo", align 1, !dbg !60
@gotview7135 = internal global [34 x %struct.rc_map_table] [%struct.rc_map_table { i64 17, i32 116 }, %struct.rc_map_table { i64 53, i32 377 }, %struct.rc_map_table { i64 27, i32 512 }, %struct.rc_map_table { i64 41, i32 513 }, %struct.rc_map_table { i64 25, i32 514 }, %struct.rc_map_table { i64 57, i32 515 }, %struct.rc_map_table { i64 31, i32 516 }, %struct.rc_map_table { i64 44, i32 517 }, %struct.rc_map_table { i64 33, i32 518 }, %struct.rc_map_table { i64 36, i32 519 }, %struct.rc_map_table { i64 24, i32 520 }, %struct.rc_map_table { i64 43, i32 521 }, %struct.rc_map_table { i64 59, i32 129 }, %struct.rc_map_table { i64 6, i32 392 }, %struct.rc_map_table { i64 49, i32 210 }, %struct.rc_map_table { i64 62, i32 393 }, %struct.rc_map_table { i64 16, i32 402 }, %struct.rc_map_table { i64 32, i32 403 }, %struct.rc_map_table { i64 12, i32 114 }, %struct.rc_map_table { i64 40, i32 115 }, %struct.rc_map_table { i64 8, i32 113 }, %struct.rc_map_table { i64 38, i32 217 }, %struct.rc_map_table { i64 63, i32 212 }, %struct.rc_map_table { i64 18, i32 167 }, %struct.rc_map_table { i64 50, i32 128 }, %struct.rc_map_table { i64 60, i32 207 }, %struct.rc_map_table { i64 29, i32 168 }, %struct.rc_map_table { i64 45, i32 119 }, %struct.rc_map_table { i64 13, i32 159 }, %struct.rc_map_table { i64 5, i32 372 }, %struct.rc_map_table { i64 42, i32 191 }, %struct.rc_map_table { i64 14, i32 192 }, %struct.rc_map_table { i64 30, i32 359 }, %struct.rc_map_table { i64 56, i32 194 }], align 16, !dbg !65
@.str = private unnamed_addr constant [15 x i8] c"rc-gotview7135\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_gotview7135 to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_gotview7135202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_gotview7135 to i8*), i8* getelementptr inbounds ([60 x i8], [60 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([44 x i8], [44 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_gotview7135() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @gotview7135_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_gotview7135() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @gotview7135_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "gotview7135_map", scope: !2, file: !3, line: 52, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-gotview7135.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_gotview7135202", scope: !2, file: !3, line: 71, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_gotview7135", scope: !2, file: !3, line: 72, type: !43, isLocal: true, isDefinition: true)
...
!49 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file203", scope: !2, file: !3, line: 74, type: !50, isLocal: true, isDefinition: true, align: 8)
...
!56 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license204", scope: !2, file: !3, line: 74, type: !57, isLocal: true, isDefinition: true, align: 8)
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 216, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 27)
!60 = !DIGlobalVariableExpression(var: !61, expr: !DIExpression())
!61 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author205", scope: !2, file: !3, line: 75, type: !62, isLocal: true, isDefinition: true, align: 8)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 352, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 44)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "gotview7135", scope: !2, file: !3, line: 13, type: !67, isLocal: true, isDefinition: true)
!67 = !DICompositeType(tag: DW_TAG_array_type, baseType: !68, size: 4352, elements: !80)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_gotview7135", scope: !3, file: !3, line: 66, type: !46, scopeLine: 67, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 68, column: 2, scope: !123)
!125 = !DILocation(line: 69, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_gotview7135", scope: !3, file: !3, line: 61, type: !127, scopeLine: 62, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!127 = !DISubroutineType(types: !128)
!128 = !{!129}
!129 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!130 = !DILocation(line: 63, column: 9, scope: !126)
!131 = !DILocation(line: 63, column: 2, scope: !126)
