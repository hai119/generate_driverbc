; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-streamzap.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-streamzap.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_streamzap6:\09\09\09"
module asm ".long\09init_rc_map_streamzap - .\09\09\09"
...
@streamzap_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([35 x %struct.rc_map_table], [35 x %struct.rc_map_table]* @streamzap, i32 0, i32 0), i32 35, i32 0, i32 0, i32 4, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_streamzap202 = internal global i8* bitcast (i32 ()* @init_rc_map_streamzap to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_streamzap = internal global void ()* @exit_rc_map_streamzap, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [56 x i8] c"rc_streamzap.file=drivers/media/rc/keymaps/rc-streamzap\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [25 x i8] c"rc_streamzap.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [52 x i8] c"rc_streamzap.author=Jarod Wilson <jarod@redhat.com>\00", section ".modinfo", align 1, !dbg !60
@streamzap = internal global [35 x %struct.rc_map_table] [%struct.rc_map_table { i64 10432, i32 512 }, %struct.rc_map_table { i64 10433, i32 513 }, %struct.rc_map_table { i64 10434, i32 514 }, %struct.rc_map_table { i64 10435, i32 515 }, %struct.rc_map_table { i64 10436, i32 516 }, %struct.rc_map_table { i64 10437, i32 517 }, %struct.rc_map_table { i64 10438, i32 518 }, %struct.rc_map_table { i64 10439, i32 519 }, %struct.rc_map_table { i64 10440, i32 520 }, %struct.rc_map_table { i64 10441, i32 521 }, %struct.rc_map_table { i64 10442, i32 116 }, %struct.rc_map_table { i64 10443, i32 113 }, %struct.rc_map_table { i64 10444, i32 402 }, %struct.rc_map_table { i64 10445, i32 115 }, %struct.rc_map_table { i64 10446, i32 403 }, %struct.rc_map_table { i64 10447, i32 114 }, %struct.rc_map_table { i64 10448, i32 103 }, %struct.rc_map_table { i64 10449, i32 105 }, %struct.rc_map_table { i64 10450, i32 352 }, %struct.rc_map_table { i64 10451, i32 106 }, %struct.rc_map_table { i64 10452, i32 108 }, %struct.rc_map_table { i64 10453, i32 139 }, %struct.rc_map_table { i64 10454, i32 174 }, %struct.rc_map_table { i64 10455, i32 207 }, %struct.rc_map_table { i64 10456, i32 119 }, %struct.rc_map_table { i64 10457, i32 128 }, %struct.rc_map_table { i64 10458, i32 158 }, %struct.rc_map_table { i64 10459, i32 159 }, %struct.rc_map_table { i64 10460, i32 167 }, %struct.rc_map_table { i64 10461, i32 168 }, %struct.rc_map_table { i64 10462, i32 208 }, %struct.rc_map_table { i64 10464, i32 398 }, %struct.rc_map_table { i64 10465, i32 399 }, %struct.rc_map_table { i64 10466, i32 400 }, %struct.rc_map_table { i64 10467, i32 401 }], align 16, !dbg !65
@.str = private unnamed_addr constant [13 x i8] c"rc-streamzap\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_streamzap to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_streamzap202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_streamzap to i8*), i8* getelementptr inbounds ([56 x i8], [56 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_streamzap() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @streamzap_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_streamzap() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @streamzap_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "streamzap_map", scope: !2, file: !3, line: 54, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-streamzap.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_streamzap202", scope: !2, file: !3, line: 73, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_streamzap", scope: !2, file: !3, line: 74, type: !43, isLocal: true, isDefinition: true)
...
!66 = distinct !DIGlobalVariable(name: "streamzap", scope: !2, file: !3, line: 11, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_streamzap", scope: !3, file: !3, line: 68, type: !46, scopeLine: 69, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 70, column: 2, scope: !123)
!125 = !DILocation(line: 71, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_streamzap", scope: !3, file: !3, line: 63, type: !127, scopeLine: 64, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
