; ModuleID = '../bcout/drivers/media/rc/keymaps/rc-twinhan1027.llvm.bc'
source_filename = "drivers/media/rc/keymaps/rc-twinhan1027.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_init_rc_map_twinhan_vp10276:\09\09\09"
module asm ".long\09init_rc_map_twinhan_vp1027 - .\09\09\09"
...
@twinhan_vp1027_map = internal global %struct.rc_map_list { %struct.list_head zeroinitializer, %struct.rc_map { %struct.rc_map_table* getelementptr inbounds ([53 x %struct.rc_map_table], [53 x %struct.rc_map_table]* @twinhan_vp1027, i32 0, i32 0), i32 53, i32 0, i32 0, i32 9, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), %struct.spinlock zeroinitializer } }, align 8, !dbg !0
@__UNIQUE_ID___addressable_init_rc_map_twinhan_vp1027202 = internal global i8* bitcast (i32 ()* @init_rc_map_twinhan_vp1027 to i8*), section ".discard.addressable", align 8, !dbg !38
@__exitcall_exit_rc_map_twinhan_vp1027 = internal global void ()* @exit_rc_map_twinhan_vp1027, section ".exitcall.exit", align 8, !dbg !41
@__UNIQUE_ID_file203 = internal constant [60 x i8] c"rc_twinhan1027.file=drivers/media/rc/keymaps/rc-twinhan1027\00", section ".modinfo", align 1, !dbg !48
@__UNIQUE_ID_license204 = internal constant [27 x i8] c"rc_twinhan1027.license=GPL\00", section ".modinfo", align 1, !dbg !55
@__UNIQUE_ID_author205 = internal constant [56 x i8] c"rc_twinhan1027.author=Sergey Ivanov <123kash@gmail.com>\00", section ".modinfo", align 1, !dbg !60
@twinhan_vp1027 = internal global [53 x %struct.rc_map_table] [%struct.rc_map_table { i64 22, i32 356 }, %struct.rc_map_table { i64 23, i32 364 }, %struct.rc_map_table { i64 15, i32 388 }, %struct.rc_map_table { i64 72, i32 358 }, %struct.rc_map_table { i64 28, i32 365 }, %struct.rc_map_table { i64 4, i32 395 }, %struct.rc_map_table { i64 3, i32 513 }, %struct.rc_map_table { i64 1, i32 514 }, %struct.rc_map_table { i64 6, i32 515 }, %struct.rc_map_table { i64 9, i32 516 }, %struct.rc_map_table { i64 29, i32 517 }, %struct.rc_map_table { i64 31, i32 518 }, %struct.rc_map_table { i64 13, i32 519 }, %struct.rc_map_table { i64 25, i32 520 }, %struct.rc_map_table { i64 27, i32 521 }, %struct.rc_map_table { i64 21, i32 512 }, %struct.rc_map_table { i64 12, i32 223 }, %struct.rc_map_table { i64 74, i32 355 }, %struct.rc_map_table { i64 19, i32 14 }, %struct.rc_map_table { i64 0, i32 15 }, %struct.rc_map_table { i64 75, i32 103 }, %struct.rc_map_table { i64 81, i32 108 }, %struct.rc_map_table { i64 78, i32 105 }, %struct.rc_map_table { i64 82, i32 106 }, %struct.rc_map_table { i64 79, i32 28 }, %struct.rc_map_table { i64 30, i32 115 }, %struct.rc_map_table { i64 10, i32 114 }, %struct.rc_map_table { i64 2, i32 403 }, %struct.rc_map_table { i64 5, i32 402 }, %struct.rc_map_table { i64 17, i32 167 }, %struct.rc_map_table { i64 20, i32 207 }, %struct.rc_map_table { i64 76, i32 119 }, %struct.rc_map_table { i64 26, i32 128 }, %struct.rc_map_table { i64 64, i32 168 }, %struct.rc_map_table { i64 18, i32 208 }, %struct.rc_map_table { i64 65, i32 165 }, %struct.rc_map_table { i64 66, i32 163 }, %struct.rc_map_table { i64 84, i32 234 }, %struct.rc_map_table { i64 80, i32 368 }, %struct.rc_map_table { i64 71, i32 226 }, %struct.rc_map_table { i64 77, i32 375 }, %struct.rc_map_table { i64 67, i32 370 }, %struct.rc_map_table { i64 16, i32 113 }, %struct.rc_map_table { i64 73, i32 392 }, %struct.rc_map_table { i64 7, i32 142 }, %struct.rc_map_table { i64 8, i32 393 }, %struct.rc_map_table { i64 14, i32 129 }, %struct.rc_map_table { i64 69, i32 13 }, %struct.rc_map_table { i64 70, i32 12 }, %struct.rc_map_table { i64 24, i32 398 }, %struct.rc_map_table { i64 83, i32 399 }, %struct.rc_map_table { i64 94, i32 400 }, %struct.rc_map_table { i64 95, i32 401 }], align 16, !dbg !65
@.str = private unnamed_addr constant [15 x i8] c"rc-twinhan1027\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (void ()* @exit_rc_map_twinhan_vp1027 to i8*), i8* bitcast (i8** @__UNIQUE_ID___addressable_init_rc_map_twinhan_vp1027202 to i8*), i8* bitcast (void ()** @__exitcall_exit_rc_map_twinhan_vp1027 to i8*), i8* getelementptr inbounds ([60 x i8], [60 x i8]* @__UNIQUE_ID_file203, i32 0, i32 0), i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__UNIQUE_ID_license204, i32 0, i32 0), i8* getelementptr inbounds ([56 x i8], [56 x i8]* @__UNIQUE_ID_author205, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @exit_rc_map_twinhan_vp1027() #0 section ".exit.text" !dbg !123 {
entry:
  call void @rc_map_unregister(%struct.rc_map_list* @twinhan_vp1027_map) #2, !dbg !124
  ret void, !dbg !125
}
...
; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @init_rc_map_twinhan_vp1027() #0 section ".init.text" !dbg !126 {
entry:
  %call = call i32 @rc_map_register(%struct.rc_map_list* @twinhan_vp1027_map) #2, !dbg !130
...
!1 = distinct !DIGlobalVariable(name: "twinhan_vp1027_map", scope: !2, file: !3, line: 66, type: !82, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/media/rc/keymaps/rc-twinhan1027.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5}
...
!39 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_init_rc_map_twinhan_vp1027202", scope: !2, file: !3, line: 85, type: !40, isLocal: true, isDefinition: true)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!41 = !DIGlobalVariableExpression(var: !42, expr: !DIExpression())
!42 = distinct !DIGlobalVariable(name: "__exitcall_exit_rc_map_twinhan_vp1027", scope: !2, file: !3, line: 86, type: !43, isLocal: true, isDefinition: true)
...
!49 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file203", scope: !2, file: !3, line: 88, type: !50, isLocal: true, isDefinition: true, align: 8)
!50 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 480, elements: !53)
!51 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !52)
!52 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!53 = !{!54}
!54 = !DISubrange(count: 60)
!55 = !DIGlobalVariableExpression(var: !56, expr: !DIExpression())
!56 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license204", scope: !2, file: !3, line: 88, type: !57, isLocal: true, isDefinition: true, align: 8)
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 216, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 27)
!60 = !DIGlobalVariableExpression(var: !61, expr: !DIExpression())
!61 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author205", scope: !2, file: !3, line: 89, type: !62, isLocal: true, isDefinition: true, align: 8)
!62 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 448, elements: !63)
!63 = !{!64}
!64 = !DISubrange(count: 56)
!65 = !DIGlobalVariableExpression(var: !66, expr: !DIExpression())
!66 = distinct !DIGlobalVariable(name: "twinhan_vp1027", scope: !2, file: !3, line: 5, type: !67, isLocal: true, isDefinition: true)
...
!123 = distinct !DISubprogram(name: "exit_rc_map_twinhan_vp1027", scope: !3, file: !3, line: 80, type: !46, scopeLine: 81, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!124 = !DILocation(line: 82, column: 2, scope: !123)
!125 = !DILocation(line: 83, column: 1, scope: !123)
!126 = distinct !DISubprogram(name: "init_rc_map_twinhan_vp1027", scope: !3, file: !3, line: 75, type: !127, scopeLine: 76, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !117)
!127 = !DISubroutineType(types: !128)
!128 = !{!129}
!129 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!130 = !DILocation(line: 77, column: 9, scope: !126)
!131 = !DILocation(line: 77, column: 2, scope: !126)
