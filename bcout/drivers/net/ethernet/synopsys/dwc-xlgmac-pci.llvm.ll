; ModuleID = '../bcout/drivers/net/ethernet/synopsys/dwc-xlgmac-pci.llvm.bc'
source_filename = "drivers/net/ethernet/synopsys/dwc-xlgmac-pci.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_xlgmac_pci_driver_init6:\09\09\09"
module asm ".long\09xlgmac_pci_driver_init - .\09\09\09"
...
%struct.xlgmac_resources = type { i8*, i32 }

@__UNIQUE_ID___addressable_xlgmac_pci_driver_init325 = internal global i8* bitcast (i32 ()* @xlgmac_pci_driver_init to i8*), section ".discard.addressable", align 8, !dbg !0
@xlgmac_pci_driver = internal global %struct.pci_driver { %struct.list_head zeroinitializer, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), %struct.pci_device_id* getelementptr inbounds ([2 x %struct.pci_device_id], [2 x %struct.pci_device_id]* @xlgmac_pci_tbl, i32 0, i32 0), i32 (%struct.pci_dev*, %struct.pci_device_id*)* @xlgmac_probe, void (%struct.pci_dev*)* @xlgmac_remove, i32 (%struct.pci_dev*, i32)* null, i32 (%struct.pci_dev*)* null, void (%struct.pci_dev*)* null, i32 (%struct.pci_dev*, i32)* null, %struct.pci_error_handlers* null, %struct.attribute_group** null, %struct.device_driver zeroinitializer, %struct.pci_dynids zeroinitializer }, align 8, !dbg !7466
@__exitcall_xlgmac_pci_driver_exit = internal global void ()* @xlgmac_pci_driver_exit, section ".exitcall.exit", align 8, !dbg !7396
@__UNIQUE_ID_description326 = internal constant [50 x i8] c"dwc_xlgmac.description=Synopsys DWC XLGMAC Driver\00", section ".modinfo", align 1, !dbg !7401
@__UNIQUE_ID_version327 = internal constant [25 x i8] c"dwc_xlgmac.version=1.0.0\00", section ".modinfo", align 1, !dbg !7406
...
@__modver_attr = internal constant %struct.module_version_attribute* @___modver_attr, section "__modver", align 8, !dbg !7411
@__UNIQUE_ID_author328 = internal constant [50 x i8] c"dwc_xlgmac.author=Jie Deng <jiedeng@synopsys.com>\00", section ".modinfo", align 1, !dbg !7456
@__UNIQUE_ID_file329 = internal constant [57 x i8] c"dwc_xlgmac.file=drivers/net/ethernet/synopsys/dwc-xlgmac\00", section ".modinfo", align 1, !dbg !7458
@__UNIQUE_ID_license330 = internal constant [32 x i8] c"dwc_xlgmac.license=Dual BSD/GPL\00", section ".modinfo", align 1, !dbg !7463
@.str = private unnamed_addr constant [11 x i8] c"dwc_xlgmac\00", align 1
@.str.1 = private unnamed_addr constant [11 x i8] c"dwc-xlgmac\00", align 1
@xlgmac_pci_tbl = internal constant [2 x %struct.pci_device_id] [%struct.pci_device_id { i32 5827, i32 29442, i32 -1, i32 -1, i32 0, i32 0, i64 0 }, %struct.pci_device_id zeroinitializer], align 16, !dbg !7740
@.str.2 = private unnamed_addr constant [32 x i8] c"ERROR: failed to enable device\0A\00", align 1
@.str.3 = private unnamed_addr constant [8 x i8] c"version\00", align 1
@.str.4 = private unnamed_addr constant [6 x i8] c"1.0.0\00", align 1
@llvm.used = appending global [9 x i8*] [i8* bitcast (i8** @__UNIQUE_ID___addressable_xlgmac_pci_driver_init325 to i8*), i8* bitcast (void ()* @xlgmac_pci_driver_exit to i8*), i8* bitcast (void ()** @__exitcall_xlgmac_pci_driver_exit to i8*), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @__UNIQUE_ID_description326, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__UNIQUE_ID_version327, i32 0, i32 0), i8* bitcast (%struct.module_version_attribute** @__modver_attr to i8*), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @__UNIQUE_ID_author328, i32 0, i32 0), i8* getelementptr inbounds ([57 x i8], [57 x i8]* @__UNIQUE_ID_file329, i32 0, i32 0), i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__UNIQUE_ID_license330, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @xlgmac_pci_driver_init() #0 section ".init.text" !dbg !7750 {
entry:
  %call = call i32 @__pci_register_driver(%struct.pci_driver* @xlgmac_pci_driver, %struct.module* null, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0)) #6, !dbg !7753
  ret i32 %call, !dbg !7753
}

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @xlgmac_pci_driver_exit() #0 section ".exit.text" !dbg !7754 {
entry:
  call void @pci_unregister_driver(%struct.pci_driver* @xlgmac_pci_driver) #6, !dbg !7755
  ret void, !dbg !7755
}
...
define internal i32 @xlgmac_probe(%struct.pci_dev* %pcidev, %struct.pci_device_id* %id) #2 !dbg !7756 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.pci_dev** %pcidev.addr, metadata !7757, metadata !DIExpression()), !dbg !7758
  store %struct.pci_device_id* %id, %struct.pci_device_id** %id.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.pci_device_id** %id.addr, metadata !7759, metadata !DIExpression()), !dbg !7760
  call void @llvm.dbg.declare(metadata %struct.device** %dev, metadata !7761, metadata !DIExpression()), !dbg !7762
  %0 = load %struct.pci_dev*, %struct.pci_dev** %pcidev.addr, align 8, !dbg !7763
  %dev1 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %0, i32 0, i32 41, !dbg !7764
  store %struct.device* %dev1, %struct.device** %dev, align 8, !dbg !7762
  call void @llvm.dbg.declare(metadata %struct.xlgmac_resources* %res, metadata !7765, metadata !DIExpression()), !dbg !7771
  call void @llvm.dbg.declare(metadata i32* %i, metadata !7772, metadata !DIExpression()), !dbg !7773
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !7774, metadata !DIExpression()), !dbg !7775
  %1 = load %struct.pci_dev*, %struct.pci_dev** %pcidev.addr, align 8, !dbg !7776
  %call = call i32 @pcim_enable_device(%struct.pci_dev* %1) #6, !dbg !7777
  store i32 %call, i32* %ret, align 4, !dbg !7778
  %2 = load i32, i32* %ret, align 4, !dbg !7779
  %tobool = icmp ne i32 %2, 0, !dbg !7779
  br i1 %tobool, label %if.then, label %if.end, !dbg !7781

if.then:                                          ; preds = %entry
  %3 = load %struct.device*, %struct.device** %dev, align 8, !dbg !7782
  call void (%struct.device*, i8*, ...) @_dev_err(%struct.device* %3, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.2, i64 0, i64 0)) #7, !dbg !7782
  %4 = load i32, i32* %ret, align 4, !dbg !7784
  store i32 %4, i32* %retval, align 4, !dbg !7785
  br label %return, !dbg !7785

if.end:                                           ; preds = %entry
  store i32 0, i32* %i, align 4, !dbg !7786
  br label %for.cond, !dbg !7788

for.cond:                                         ; preds = %for.inc, %if.end
  %5 = load i32, i32* %i, align 4, !dbg !7789
  %cmp = icmp slt i32 %5, 6, !dbg !7791
  br i1 %cmp, label %for.body, label %for.end, !dbg !7792

for.body:                                         ; preds = %for.cond
  %6 = load %struct.pci_dev*, %struct.pci_dev** %pcidev.addr, align 8, !dbg !7793
  %resource = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %6, i32 0, i32 44, !dbg !7793
  %7 = load i32, i32* %i, align 4, !dbg !7793
  %idxprom = sext i32 %7 to i64, !dbg !7793
  %arrayidx = getelementptr [17 x %struct.resource], [17 x %struct.resource]* %resource, i64 0, i64 %idxprom, !dbg !7793
  %start = getelementptr inbounds %struct.resource, %struct.resource* %arrayidx, i32 0, i32 0, !dbg !7793
  %8 = load i64, i64* %start, align 8, !dbg !7793
  %cmp2 = icmp eq i64 %8, 0, !dbg !7793
  br i1 %cmp2, label %land.lhs.true, label %cond.false, !dbg !7793

land.lhs.true:                                    ; preds = %for.body
  %9 = load %struct.pci_dev*, %struct.pci_dev** %pcidev.addr, align 8, !dbg !7793
  %resource3 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %9, i32 0, i32 44, !dbg !7793
  %10 = load i32, i32* %i, align 4, !dbg !7793
  %idxprom4 = sext i32 %10 to i64, !dbg !7793
  %arrayidx5 = getelementptr [17 x %struct.resource], [17 x %struct.resource]* %resource3, i64 0, i64 %idxprom4, !dbg !7793
  %end = getelementptr inbounds %struct.resource, %struct.resource* %arrayidx5, i32 0, i32 1, !dbg !7793
  %11 = load i64, i64* %end, align 8, !dbg !7793
  %12 = load %struct.pci_dev*, %struct.pci_dev** %pcidev.addr, align 8, !dbg !7793
  %resource6 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %12, i32 0, i32 44, !dbg !7793
  %13 = load i32, i32* %i, align 4, !dbg !7793
  %idxprom7 = sext i32 %13 to i64, !dbg !7793
  %arrayidx8 = getelementptr [17 x %struct.resource], [17 x %struct.resource]* %resource6, i64 0, i64 %idxprom7, !dbg !7793
  %start9 = getelementptr inbounds %struct.resource, %struct.resource* %arrayidx8, i32 0, i32 0, !dbg !7793
  %14 = load i64, i64* %start9, align 8, !dbg !7793
  %cmp10 = icmp eq i64 %11, %14, !dbg !7793
  br i1 %cmp10, label %cond.true, label %cond.false, !dbg !7793

cond.true:                                        ; preds = %land.lhs.true
  br label %cond.end, !dbg !7793

cond.false:                                       ; preds = %land.lhs.true, %for.body
  %15 = load %struct.pci_dev*, %struct.pci_dev** %pcidev.addr, align 8, !dbg !7793
  %resource11 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %15, i32 0, i32 44, !dbg !7793
  %16 = load i32, i32* %i, align 4, !dbg !7793
  %idxprom12 = sext i32 %16 to i64, !dbg !7793
  %arrayidx13 = getelementptr [17 x %struct.resource], [17 x %struct.resource]* %resource11, i64 0, i64 %idxprom12, !dbg !7793
  %end14 = getelementptr inbounds %struct.resource, %struct.resource* %arrayidx13, i32 0, i32 1, !dbg !7793
  %17 = load i64, i64* %end14, align 8, !dbg !7793
  %18 = load %struct.pci_dev*, %struct.pci_dev** %pcidev.addr, align 8, !dbg !7793
  %resource15 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %18, i32 0, i32 44, !dbg !7793
  %19 = load i32, i32* %i, align 4, !dbg !7793
  %idxprom16 = sext i32 %19 to i64, !dbg !7793
  %arrayidx17 = getelementptr [17 x %struct.resource], [17 x %struct.resource]* %resource15, i64 0, i64 %idxprom16, !dbg !7793
  %start18 = getelementptr inbounds %struct.resource, %struct.resource* %arrayidx17, i32 0, i32 0, !dbg !7793
  %20 = load i64, i64* %start18, align 8, !dbg !7793
  %sub = sub i64 %17, %20, !dbg !7793
  %add = add i64 %sub, 1, !dbg !7793
  br label %cond.end, !dbg !7793

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i64 [ 0, %cond.true ], [ %add, %cond.false ], !dbg !7793
  %cmp19 = icmp eq i64 %cond, 0, !dbg !7796
  br i1 %cmp19, label %if.then20, label %if.end21, !dbg !7797

if.then20:                                        ; preds = %cond.end
  br label %for.inc, !dbg !7798

if.end21:                                         ; preds = %cond.end
  %21 = load %struct.pci_dev*, %struct.pci_dev** %pcidev.addr, align 8, !dbg !7799
  %22 = load i32, i32* %i, align 4, !dbg !7800
  %sh_prom = zext i32 %22 to i64, !dbg !7800
  %shl = shl i64 1, %sh_prom, !dbg !7800
  %conv = trunc i64 %shl to i32, !dbg !7800
  %call22 = call i32 @pcim_iomap_regions(%struct.pci_dev* %21, i32 %conv, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i64 0, i64 0)) #6, !dbg !7801
  store i32 %call22, i32* %ret, align 4, !dbg !7802
  %23 = load i32, i32* %ret, align 4, !dbg !7803
  %tobool23 = icmp ne i32 %23, 0, !dbg !7803
  br i1 %tobool23, label %if.then24, label %if.end25, !dbg !7805

if.then24:                                        ; preds = %if.end21
  %24 = load i32, i32* %ret, align 4, !dbg !7806
  store i32 %24, i32* %retval, align 4, !dbg !7807
...
for.inc:                                          ; preds = %if.then20
  %25 = load i32, i32* %i, align 4, !dbg !7809
  %inc = add i32 %25, 1, !dbg !7809
  store i32 %inc, i32* %i, align 4, !dbg !7809
  br label %for.cond, !dbg !7810, !llvm.loop !7811

for.end:                                          ; preds = %if.end25, %for.cond
  %26 = load %struct.pci_dev*, %struct.pci_dev** %pcidev.addr, align 8, !dbg !7813
  call void @pci_set_master(%struct.pci_dev* %26) #6, !dbg !7814
  %27 = bitcast %struct.xlgmac_resources* %res to i8*, !dbg !7815
  call void @llvm.memset.p0i8.i64(i8* align 8 %27, i8 0, i64 16, i1 false), !dbg !7815
  %28 = load %struct.pci_dev*, %struct.pci_dev** %pcidev.addr, align 8, !dbg !7816
  %irq = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %28, i32 0, i32 43, !dbg !7817
  %29 = load i32, i32* %irq, align 4, !dbg !7817
  %irq26 = getelementptr inbounds %struct.xlgmac_resources, %struct.xlgmac_resources* %res, i32 0, i32 1, !dbg !7818
  store i32 %29, i32* %irq26, align 8, !dbg !7819
  %30 = load %struct.pci_dev*, %struct.pci_dev** %pcidev.addr, align 8, !dbg !7820
  %call27 = call i8** @pcim_iomap_table(%struct.pci_dev* %30) #6, !dbg !7821
  %31 = load i32, i32* %i, align 4, !dbg !7822
  %idxprom28 = sext i32 %31 to i64, !dbg !7821
  %arrayidx29 = getelementptr i8*, i8** %call27, i64 %idxprom28, !dbg !7821
  %32 = load i8*, i8** %arrayidx29, align 8, !dbg !7821
  %addr = getelementptr inbounds %struct.xlgmac_resources, %struct.xlgmac_resources* %res, i32 0, i32 0, !dbg !7823
  store i8* %32, i8** %addr, align 8, !dbg !7824
  %33 = load %struct.pci_dev*, %struct.pci_dev** %pcidev.addr, align 8, !dbg !7825
  %dev30 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %33, i32 0, i32 41, !dbg !7826
  %call31 = call i32 @xlgmac_drv_probe(%struct.device* %dev30, %struct.xlgmac_resources* %res) #6, !dbg !7827
  store i32 %call31, i32* %retval, align 4, !dbg !7828
  br label %return, !dbg !7828

return:                                           ; preds = %for.end, %if.then24, %if.then
  %34 = load i32, i32* %retval, align 4, !dbg !7829
  ret i32 %34, !dbg !7829
}

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @xlgmac_remove(%struct.pci_dev* %pcidev) #2 !dbg !7830 {
entry:
  %pcidev.addr = alloca %struct.pci_dev*, align 8
  store %struct.pci_dev* %pcidev, %struct.pci_dev** %pcidev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.pci_dev** %pcidev.addr, metadata !7831, metadata !DIExpression()), !dbg !7832
  %0 = load %struct.pci_dev*, %struct.pci_dev** %pcidev.addr, align 8, !dbg !7833
  %dev = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %0, i32 0, i32 41, !dbg !7834
  %call = call i32 @xlgmac_drv_remove(%struct.device* %dev) #6, !dbg !7835
  ret void, !dbg !7836
}
...
; Function Attrs: noredzone
declare dso_local i32 @xlgmac_drv_remove(%struct.device*) #1
...
!llvm.dbg.cu = !{!2}
!llvm.module.flags = !{!7745, !7746, !7747, !7748}
!llvm.ident = !{!7749}

!0 = !DIGlobalVariableExpression(var: !1, expr: !DIExpression())
!1 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_xlgmac_pci_driver_init325", scope: !2, file: !3, line: 73, type: !591, isLocal: true, isDefinition: true)
!2 = distinct !DICompileUnit(language: DW_LANG_C89, file: !3, producer: "clang version 10.0.1 (https://github.com/llvm/llvm-project.git ef32c611aa214dea855364efd7ba451ec5ec3f74)", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !7394, globals: !7395, splitDebugInlining: false, nameTableKind: None)
!3 = !DIFile(filename: "drivers/net/ethernet/synopsys/dwc-xlgmac-pci.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5, !13, !19, !24, !30, !37, !57, !64, !95, !129, !170, !177, !208, !221, !229, !235, !242, !246, !250, !257, !263, !6491, !6627, !6707, !6783, !6791, !6198, !7063, !7083, !7153, !7257, !7269, !4289, !4384, !5051, !5070}
...
!7020 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "phy_device", file: !7021, line: 539, size: 10112, elements: !7022)
!7021 = !DIFile(filename: "./include/linux/phy.h", directory: "/home/lizy2001/genbc/linux")
!7022 = !{!7023, !7115, !7235, !7236, !7242, !7243, !7244, !7245, !7246, !7247, !7248, !7249, !7250, !7251, !7252, !7253, !7254, !7255, !7256, !7266, !7267, !7298, !7299, !7300, !7301, !7302, !7303, !7304, !7305, !7306, !7307, !7308, !7309, !7310, !7311, !7312, !7313, !7314, !7315, !7316, !7323, !7324, !7325, !7328, !7331, !7332, !7358, !7359, !7360, !7364}
!7023 = !DIDerivedType(tag: DW_TAG_member, name: "mdio", scope: !7020, file: !7021, line: 540, baseType: !7024, size: 6336)
!7024 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "mdio_device", file: !7025, line: 34, size: 6336, elements: !7026)
!7025 = !DIFile(filename: "./include/linux/mdio.h", directory: "/home/lizy2001/genbc/linux")
!7026 = !{!7027, !7028, !7100, !7101, !7102, !7106, !7107, !7108, !7109, !7110, !7113, !7114}
!7027 = !DIDerivedType(tag: DW_TAG_member, name: "dev", scope: !7024, file: !7025, line: 35, baseType: !6540, size: 5568)
!7028 = !DIDerivedType(tag: DW_TAG_member, name: "bus", scope: !7024, file: !7025, line: 37, baseType: !7029, size: 64, offset: 5568)
!7029 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7030, size: 64)
!7030 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "mii_bus", file: !7021, line: 301, size: 20544, elements: !7031)
!7031 = !{!7032, !7033, !7034, !7038, !7039, !7043, !7047, !7051, !7060, !7061, !7062, !7069, !7070, !7073, !7074, !7075, !7077, !7078, !7079, !7082, !7089, !7090}
!7032 = !DIDerivedType(tag: DW_TAG_member, name: "owner", scope: !7030, file: !7021, line: 302, baseType: !980, size: 64)
!7033 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !7030, file: !7021, line: 303, baseType: !292, size: 64, offset: 64)
!7034 = !DIDerivedType(tag: DW_TAG_member, name: "id", scope: !7030, file: !7021, line: 304, baseType: !7035, size: 488, offset: 128)
!7035 = !DICompositeType(tag: DW_TAG_array_type, baseType: !268, size: 488, elements: !7036)
!7036 = !{!7037}
!7037 = !DISubrange(count: 61)
!7038 = !DIDerivedType(tag: DW_TAG_member, name: "priv", scope: !7030, file: !7021, line: 305, baseType: !591, size: 64, offset: 640)
!7039 = !DIDerivedType(tag: DW_TAG_member, name: "read", scope: !7030, file: !7021, line: 307, baseType: !7040, size: 64, offset: 704)
!7040 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7041, size: 64)
!7041 = !DISubroutineType(types: !7042)
!7042 = !{!32, !7029, !32, !32}
!7043 = !DIDerivedType(tag: DW_TAG_member, name: "write", scope: !7030, file: !7021, line: 309, baseType: !7044, size: 64, offset: 768)
!7044 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7045, size: 64)
!7045 = !DISubroutineType(types: !7046)
!7046 = !{!32, !7029, !32, !32, !581}
!7047 = !DIDerivedType(tag: DW_TAG_member, name: "reset", scope: !7030, file: !7021, line: 311, baseType: !7048, size: 64, offset: 832)
!7048 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7049, size: 64)
!7049 = !DISubroutineType(types: !7050)
!7050 = !{!32, !7029}
!7051 = !DIDerivedType(tag: DW_TAG_member, name: "stats", scope: !7030, file: !7021, line: 314, baseType: !7052, size: 8192, offset: 896)
!7052 = !DICompositeType(tag: DW_TAG_array_type, baseType: !7053, size: 8192, elements: !819)
!7053 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "mdio_bus_stats", file: !7021, line: 250, size: 256, elements: !7054)
!7054 = !{!7055, !7056, !7057, !7058, !7059}
!7055 = !DIDerivedType(tag: DW_TAG_member, name: "transfers", scope: !7053, file: !7021, line: 251, baseType: !6511, size: 64)
!7056 = !DIDerivedType(tag: DW_TAG_member, name: "errors", scope: !7053, file: !7021, line: 252, baseType: !6511, size: 64, offset: 64)
!7057 = !DIDerivedType(tag: DW_TAG_member, name: "writes", scope: !7053, file: !7021, line: 253, baseType: !6511, size: 64, offset: 128)
!7058 = !DIDerivedType(tag: DW_TAG_member, name: "reads", scope: !7053, file: !7021, line: 254, baseType: !6511, size: 64, offset: 192)
!7059 = !DIDerivedType(tag: DW_TAG_member, name: "syncp", scope: !7053, file: !7021, line: 256, baseType: !3071, offset: 256)
!7060 = !DIDerivedType(tag: DW_TAG_member, name: "mdio_lock", scope: !7030, file: !7021, line: 320, baseType: !1665, size: 192, offset: 9088)
!7061 = !DIDerivedType(tag: DW_TAG_member, name: "parent", scope: !7030, file: !7021, line: 323, baseType: !6545, size: 64, offset: 9280)
!7062 = !DIDerivedType(tag: DW_TAG_member, name: "state", scope: !7030, file: !7021, line: 330, baseType: !7063, size: 32, offset: 9344)
!7063 = !DICompositeType(tag: DW_TAG_enumeration_type, scope: !7030, file: !7021, line: 325, baseType: !7, size: 32, elements: !7064)
!7064 = !{!7065, !7066, !7067, !7068}
!7065 = !DIEnumerator(name: "MDIOBUS_ALLOCATED", value: 1, isUnsigned: true)
!7066 = !DIEnumerator(name: "MDIOBUS_REGISTERED", value: 2, isUnsigned: true)
!7067 = !DIEnumerator(name: "MDIOBUS_UNREGISTERED", value: 3, isUnsigned: true)
!7068 = !DIEnumerator(name: "MDIOBUS_RELEASED", value: 4, isUnsigned: true)
!7069 = !DIDerivedType(tag: DW_TAG_member, name: "dev", scope: !7030, file: !7021, line: 333, baseType: !6540, size: 5568, offset: 9408)
!7070 = !DIDerivedType(tag: DW_TAG_member, name: "mdio_map", scope: !7030, file: !7021, line: 336, baseType: !7071, size: 2048, offset: 14976)
!7071 = !DICompositeType(tag: DW_TAG_array_type, baseType: !7072, size: 2048, elements: !819)
!7072 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7024, size: 64)
!7073 = !DIDerivedType(tag: DW_TAG_member, name: "phy_mask", scope: !7030, file: !7021, line: 339, baseType: !987, size: 32, offset: 17024)
!7074 = !DIDerivedType(tag: DW_TAG_member, name: "phy_ignore_ta_mask", scope: !7030, file: !7021, line: 342, baseType: !987, size: 32, offset: 17056)
!7075 = !DIDerivedType(tag: DW_TAG_member, name: "irq", scope: !7030, file: !7021, line: 348, baseType: !7076, size: 1024, offset: 17088)
!7076 = !DICompositeType(tag: DW_TAG_array_type, baseType: !32, size: 1024, elements: !819)
!7077 = !DIDerivedType(tag: DW_TAG_member, name: "reset_delay_us", scope: !7030, file: !7021, line: 351, baseType: !32, size: 32, offset: 18112)
!7078 = !DIDerivedType(tag: DW_TAG_member, name: "reset_post_delay_us", scope: !7030, file: !7021, line: 353, baseType: !32, size: 32, offset: 18144)
!7079 = !DIDerivedType(tag: DW_TAG_member, name: "reset_gpiod", scope: !7030, file: !7021, line: 355, baseType: !7080, size: 64, offset: 18176)
!7080 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7081, size: 64)
!7081 = !DICompositeType(tag: DW_TAG_structure_type, name: "gpio_desc", file: !7025, line: 19, flags: DIFlagFwdDecl)
!7082 = !DIDerivedType(tag: DW_TAG_member, name: "probe_capabilities", scope: !7030, file: !7021, line: 363, baseType: !7083, size: 32, offset: 18240)
!7083 = !DICompositeType(tag: DW_TAG_enumeration_type, scope: !7030, file: !7021, line: 358, baseType: !7, size: 32, elements: !7084)
!7084 = !{!7085, !7086, !7087, !7088}
!7085 = !DIEnumerator(name: "MDIOBUS_NO_CAP", value: 0, isUnsigned: true)
!7086 = !DIEnumerator(name: "MDIOBUS_C22", value: 1, isUnsigned: true)
!7087 = !DIEnumerator(name: "MDIOBUS_C45", value: 2, isUnsigned: true)
!7088 = !DIEnumerator(name: "MDIOBUS_C22_C45", value: 3, isUnsigned: true)
!7089 = !DIDerivedType(tag: DW_TAG_member, name: "shared_lock", scope: !7030, file: !7021, line: 366, baseType: !1665, size: 192, offset: 18304)
!7090 = !DIDerivedType(tag: DW_TAG_member, name: "shared", scope: !7030, file: !7021, line: 369, baseType: !7091, size: 2048, offset: 18496)
!7091 = !DICompositeType(tag: DW_TAG_array_type, baseType: !7092, size: 2048, elements: !819)
!7092 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7093, size: 64)
!7093 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "phy_package_shared", file: !7021, line: 271, size: 256, elements: !7094)
!7094 = !{!7095, !7096, !7097, !7098, !7099}
!7095 = !DIDerivedType(tag: DW_TAG_member, name: "addr", scope: !7093, file: !7021, line: 272, baseType: !32, size: 32)
!7096 = !DIDerivedType(tag: DW_TAG_member, name: "refcnt", scope: !7093, file: !7021, line: 273, baseType: !568, size: 32, offset: 32)
!7097 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !7093, file: !7021, line: 274, baseType: !312, size: 64, offset: 64)
!7098 = !DIDerivedType(tag: DW_TAG_member, name: "priv_size", scope: !7093, file: !7021, line: 275, baseType: !1039, size: 64, offset: 128)
!7099 = !DIDerivedType(tag: DW_TAG_member, name: "priv", scope: !7093, file: !7021, line: 283, baseType: !591, size: 64, offset: 192)
!7100 = !DIDerivedType(tag: DW_TAG_member, name: "modalias", scope: !7024, file: !7025, line: 38, baseType: !4625, size: 256, offset: 5632)
!7101 = !DIDerivedType(tag: DW_TAG_member, name: "bus_match", scope: !7024, file: !7025, line: 40, baseType: !6614, size: 64, offset: 5888)
!7102 = !DIDerivedType(tag: DW_TAG_member, name: "device_free", scope: !7024, file: !7025, line: 41, baseType: !7103, size: 64, offset: 5952)
!7103 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7104, size: 64)
!7104 = !DISubroutineType(types: !7105)
!7105 = !{null, !7072}
!7106 = !DIDerivedType(tag: DW_TAG_member, name: "device_remove", scope: !7024, file: !7025, line: 42, baseType: !7103, size: 64, offset: 6016)
!7107 = !DIDerivedType(tag: DW_TAG_member, name: "addr", scope: !7024, file: !7025, line: 45, baseType: !32, size: 32, offset: 6080)
!7108 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !7024, file: !7025, line: 46, baseType: !32, size: 32, offset: 6112)
!7109 = !DIDerivedType(tag: DW_TAG_member, name: "reset_gpio", scope: !7024, file: !7025, line: 47, baseType: !7080, size: 64, offset: 6144)
!7110 = !DIDerivedType(tag: DW_TAG_member, name: "reset_ctrl", scope: !7024, file: !7025, line: 48, baseType: !7111, size: 64, offset: 6208)
!7111 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7112, size: 64)
!7112 = !DICompositeType(tag: DW_TAG_structure_type, name: "reset_control", file: !7025, line: 21, flags: DIFlagFwdDecl)
!7113 = !DIDerivedType(tag: DW_TAG_member, name: "reset_assert_delay", scope: !7024, file: !7025, line: 49, baseType: !7, size: 32, offset: 6272)
!7114 = !DIDerivedType(tag: DW_TAG_member, name: "reset_deassert_delay", scope: !7024, file: !7025, line: 50, baseType: !7, size: 32, offset: 6304)
!7115 = !DIDerivedType(tag: DW_TAG_member, name: "drv", scope: !7020, file: !7021, line: 544, baseType: !7116, size: 64, offset: 6336)
!7116 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7117, size: 64)
!7117 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "phy_driver", file: !7021, line: 694, size: 3840, elements: !7118)
!7118 = !{!7119, !7124, !7125, !7126, !7127, !7130, !7131, !7132, !7136, !7137, !7138, !7139, !7140, !7141, !7142, !7143, !7144, !7145, !7146, !7147, !7158, !7162, !7163, !7167, !7171, !7172, !7176, !7180, !7181, !7185, !7189, !7193, !7194, !7207, !7211, !7212, !7216, !7220, !7225, !7229, !7233, !7234}
!7119 = !DIDerivedType(tag: DW_TAG_member, name: "mdiodrv", scope: !7117, file: !7021, line: 695, baseType: !7120, size: 1216)
!7120 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "mdio_driver_common", file: !7025, line: 55, size: 1216, elements: !7121)
!7121 = !{!7122, !7123}
!7122 = !DIDerivedType(tag: DW_TAG_member, name: "driver", scope: !7120, file: !7025, line: 56, baseType: !6618, size: 1152)
!7123 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !7120, file: !7025, line: 57, baseType: !32, size: 32, offset: 1152)
!7124 = !DIDerivedType(tag: DW_TAG_member, name: "phy_id", scope: !7117, file: !7021, line: 696, baseType: !987, size: 32, offset: 1216)
!7125 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !7117, file: !7021, line: 697, baseType: !1038, size: 64, offset: 1280)
!7126 = !DIDerivedType(tag: DW_TAG_member, name: "phy_id_mask", scope: !7117, file: !7021, line: 698, baseType: !987, size: 32, offset: 1344)
!7127 = !DIDerivedType(tag: DW_TAG_member, name: "features", scope: !7117, file: !7021, line: 699, baseType: !7128, size: 64, offset: 1408)
!7128 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !7129)
!7129 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4259, size: 64)
!7130 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !7117, file: !7021, line: 700, baseType: !987, size: 32, offset: 1472)
!7131 = !DIDerivedType(tag: DW_TAG_member, name: "driver_data", scope: !7117, file: !7021, line: 701, baseType: !3258, size: 64, offset: 1536)
!7132 = !DIDerivedType(tag: DW_TAG_member, name: "soft_reset", scope: !7117, file: !7021, line: 706, baseType: !7133, size: 64, offset: 1600)
!7133 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7134, size: 64)
!7134 = !DISubroutineType(types: !7135)
!7135 = !{!32, !7019}
!7136 = !DIDerivedType(tag: DW_TAG_member, name: "config_init", scope: !7117, file: !7021, line: 712, baseType: !7133, size: 64, offset: 1664)
!7137 = !DIDerivedType(tag: DW_TAG_member, name: "probe", scope: !7117, file: !7021, line: 718, baseType: !7133, size: 64, offset: 1728)
!7138 = !DIDerivedType(tag: DW_TAG_member, name: "get_features", scope: !7117, file: !7021, line: 724, baseType: !7133, size: 64, offset: 1792)
!7139 = !DIDerivedType(tag: DW_TAG_member, name: "suspend", scope: !7117, file: !7021, line: 728, baseType: !7133, size: 64, offset: 1856)
!7140 = !DIDerivedType(tag: DW_TAG_member, name: "resume", scope: !7117, file: !7021, line: 730, baseType: !7133, size: 64, offset: 1920)
!7141 = !DIDerivedType(tag: DW_TAG_member, name: "config_aneg", scope: !7117, file: !7021, line: 738, baseType: !7133, size: 64, offset: 1984)
!7142 = !DIDerivedType(tag: DW_TAG_member, name: "aneg_done", scope: !7117, file: !7021, line: 741, baseType: !7133, size: 64, offset: 2048)
!7143 = !DIDerivedType(tag: DW_TAG_member, name: "read_status", scope: !7117, file: !7021, line: 744, baseType: !7133, size: 64, offset: 2112)
!7144 = !DIDerivedType(tag: DW_TAG_member, name: "ack_interrupt", scope: !7117, file: !7021, line: 747, baseType: !7133, size: 64, offset: 2176)
!7145 = !DIDerivedType(tag: DW_TAG_member, name: "config_intr", scope: !7117, file: !7021, line: 750, baseType: !7133, size: 64, offset: 2240)
!7146 = !DIDerivedType(tag: DW_TAG_member, name: "did_interrupt", scope: !7117, file: !7021, line: 757, baseType: !7133, size: 64, offset: 2304)
!7147 = !DIDerivedType(tag: DW_TAG_member, name: "handle_interrupt", scope: !7117, file: !7021, line: 760, baseType: !7148, size: 64, offset: 2368)
!7148 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7149, size: 64)
!7149 = !DISubroutineType(types: !7150)
!7150 = !{!7151, !7019}
!7151 = !DIDerivedType(tag: DW_TAG_typedef, name: "irqreturn_t", file: !7152, line: 17, baseType: !7153)
!7152 = !DIFile(filename: "./include/linux/irqreturn.h", directory: "/home/lizy2001/genbc/linux")
!7153 = !DICompositeType(tag: DW_TAG_enumeration_type, name: "irqreturn", file: !7152, line: 11, baseType: !7, size: 32, elements: !7154)
!7154 = !{!7155, !7156, !7157}
!7155 = !DIEnumerator(name: "IRQ_NONE", value: 0, isUnsigned: true)
!7156 = !DIEnumerator(name: "IRQ_HANDLED", value: 1, isUnsigned: true)
!7157 = !DIEnumerator(name: "IRQ_WAKE_THREAD", value: 2, isUnsigned: true)
!7158 = !DIDerivedType(tag: DW_TAG_member, name: "remove", scope: !7117, file: !7021, line: 763, baseType: !7159, size: 64, offset: 2432)
!7159 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7160, size: 64)
!7160 = !DISubroutineType(types: !7161)
!7161 = !{null, !7019}
!7162 = !DIDerivedType(tag: DW_TAG_member, name: "match_phy_device", scope: !7117, file: !7021, line: 770, baseType: !7133, size: 64, offset: 2496)
!7163 = !DIDerivedType(tag: DW_TAG_member, name: "set_wol", scope: !7117, file: !7021, line: 778, baseType: !7164, size: 64, offset: 2560)
!7164 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7165, size: 64)
!7165 = !DISubroutineType(types: !7166)
!7166 = !{!32, !7019, !5561}
!7167 = !DIDerivedType(tag: DW_TAG_member, name: "get_wol", scope: !7117, file: !7021, line: 784, baseType: !7168, size: 64, offset: 2624)
!7168 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7169, size: 64)
!7169 = !DISubroutineType(types: !7170)
!7170 = !{null, !7019, !5561}
!7171 = !DIDerivedType(tag: DW_TAG_member, name: "link_change_notify", scope: !7117, file: !7021, line: 794, baseType: !7159, size: 64, offset: 2688)
!7172 = !DIDerivedType(tag: DW_TAG_member, name: "read_mmd", scope: !7117, file: !7021, line: 806, baseType: !7173, size: 64, offset: 2752)
!7173 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7174, size: 64)
!7174 = !DISubroutineType(types: !7175)
!7175 = !{!32, !7019, !32, !581}
!7176 = !DIDerivedType(tag: DW_TAG_member, name: "write_mmd", scope: !7117, file: !7021, line: 818, baseType: !7177, size: 64, offset: 2816)
!7177 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7178, size: 64)
!7178 = !DISubroutineType(types: !7179)
!7179 = !{!32, !7019, !32, !581, !581}
!7180 = !DIDerivedType(tag: DW_TAG_member, name: "read_page", scope: !7117, file: !7021, line: 822, baseType: !7133, size: 64, offset: 2880)
!7181 = !DIDerivedType(tag: DW_TAG_member, name: "write_page", scope: !7117, file: !7021, line: 824, baseType: !7182, size: 64, offset: 2944)
!7182 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7183, size: 64)
!7183 = !DISubroutineType(types: !7184)
!7184 = !{!32, !7019, !32}
!7185 = !DIDerivedType(tag: DW_TAG_member, name: "module_info", scope: !7117, file: !7021, line: 830, baseType: !7186, size: 64, offset: 3008)
!7186 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7187, size: 64)
!7187 = !DISubroutineType(types: !7188)
!7188 = !{!32, !7019, !5926}
!7189 = !DIDerivedType(tag: DW_TAG_member, name: "module_eeprom", scope: !7117, file: !7021, line: 837, baseType: !7190, size: 64, offset: 3072)
!7190 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7191, size: 64)
!7191 = !DISubroutineType(types: !7192)
!7192 = !{!32, !7019, !5605, !793}
!7193 = !DIDerivedType(tag: DW_TAG_member, name: "cable_test_start", scope: !7117, file: !7021, line: 841, baseType: !7133, size: 64, offset: 3136)
!7194 = !DIDerivedType(tag: DW_TAG_member, name: "cable_test_tdr_start", scope: !7117, file: !7021, line: 844, baseType: !7195, size: 64, offset: 3200)
...
!7199 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !7200)
!7200 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "phy_tdr_config", file: !7021, line: 663, size: 128, elements: !7201)
!7201 = !{!7202, !7203, !7204, !7205}
!7202 = !DIDerivedType(tag: DW_TAG_member, name: "first", scope: !7200, file: !7021, line: 664, baseType: !987, size: 32)
!7203 = !DIDerivedType(tag: DW_TAG_member, name: "last", scope: !7200, file: !7021, line: 665, baseType: !987, size: 32, offset: 32)
!7204 = !DIDerivedType(tag: DW_TAG_member, name: "step", scope: !7200, file: !7021, line: 666, baseType: !987, size: 32, offset: 64)
!7205 = !DIDerivedType(tag: DW_TAG_member, name: "pair", scope: !7200, file: !7021, line: 667, baseType: !7206, size: 8, offset: 96)
!7206 = !DIDerivedType(tag: DW_TAG_typedef, name: "s8", file: !332, line: 16, baseType: !5995)
!7207 = !DIDerivedType(tag: DW_TAG_member, name: "cable_test_get_status", scope: !7117, file: !7021, line: 851, baseType: !7208, size: 64, offset: 3264)
!7208 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7209, size: 64)
!7209 = !DISubroutineType(types: !7210)
!7210 = !{!32, !7019, !2007}
!7211 = !DIDerivedType(tag: DW_TAG_member, name: "get_sset_count", scope: !7117, file: !7021, line: 855, baseType: !7133, size: 64, offset: 3328)
!7212 = !DIDerivedType(tag: DW_TAG_member, name: "get_strings", scope: !7117, file: !7021, line: 857, baseType: !7213, size: 64, offset: 3392)
!7213 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7214, size: 64)
!7214 = !DISubroutineType(types: !7215)
!7215 = !{null, !7019, !793}
!7216 = !DIDerivedType(tag: DW_TAG_member, name: "get_stats", scope: !7117, file: !7021, line: 859, baseType: !7217, size: 64, offset: 3456)
!7217 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7218, size: 64)
!7218 = !DISubroutineType(types: !7219)
!7219 = !{null, !7019, !5714, !5372}
!7220 = !DIDerivedType(tag: DW_TAG_member, name: "get_tunable", scope: !7117, file: !7021, line: 864, baseType: !7221, size: 64, offset: 3520)
!7221 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7222, size: 64)
!7222 = !DISubroutineType(types: !7223)
!7223 = !{!32, !7019, !7224, !591}
!7224 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !5958, size: 64)
!7225 = !DIDerivedType(tag: DW_TAG_member, name: "set_tunable", scope: !7117, file: !7021, line: 867, baseType: !7226, size: 64, offset: 3584)
!7226 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7227, size: 64)
!7227 = !DISubroutineType(types: !7228)
!7228 = !{!32, !7019, !7224, !3258}
!7229 = !DIDerivedType(tag: DW_TAG_member, name: "set_loopback", scope: !7117, file: !7021, line: 871, baseType: !7230, size: 64, offset: 3648)
!7230 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7231, size: 64)
!7231 = !DISubroutineType(types: !7232)
!7232 = !{!32, !7019, !771}
!7233 = !DIDerivedType(tag: DW_TAG_member, name: "get_sqi", scope: !7117, file: !7021, line: 873, baseType: !7133, size: 64, offset: 3712)
!7234 = !DIDerivedType(tag: DW_TAG_member, name: "get_sqi_max", scope: !7117, file: !7021, line: 875, baseType: !7133, size: 64, offset: 3776)
!7235 = !DIDerivedType(tag: DW_TAG_member, name: "phy_id", scope: !7020, file: !7021, line: 546, baseType: !987, size: 32, offset: 6400)
!7236 = !DIDerivedType(tag: DW_TAG_member, name: "c45_ids", scope: !7020, file: !7021, line: 548, baseType: !7237, size: 1088, offset: 6432)
!7237 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "phy_c45_device_ids", file: !7021, line: 461, size: 1088, elements: !7238)
!7238 = !{!7239, !7240, !7241}
!7239 = !DIDerivedType(tag: DW_TAG_member, name: "devices_in_package", scope: !7237, file: !7021, line: 462, baseType: !987, size: 32)
!7240 = !DIDerivedType(tag: DW_TAG_member, name: "mmds_present", scope: !7237, file: !7021, line: 463, baseType: !987, size: 32, offset: 32)
!7241 = !DIDerivedType(tag: DW_TAG_member, name: "device_ids", scope: !7237, file: !7021, line: 464, baseType: !4145, size: 1024, offset: 64)
!7242 = !DIDerivedType(tag: DW_TAG_member, name: "is_c45", scope: !7020, file: !7021, line: 549, baseType: !7, size: 1, offset: 7520, flags: DIFlagBitField, extraData: i64 7520)
!7243 = !DIDerivedType(tag: DW_TAG_member, name: "is_internal", scope: !7020, file: !7021, line: 550, baseType: !7, size: 1, offset: 7521, flags: DIFlagBitField, extraData: i64 7520)
!7244 = !DIDerivedType(tag: DW_TAG_member, name: "is_pseudo_fixed_link", scope: !7020, file: !7021, line: 551, baseType: !7, size: 1, offset: 7522, flags: DIFlagBitField, extraData: i64 7520)
!7245 = !DIDerivedType(tag: DW_TAG_member, name: "is_gigabit_capable", scope: !7020, file: !7021, line: 552, baseType: !7, size: 1, offset: 7523, flags: DIFlagBitField, extraData: i64 7520)
!7246 = !DIDerivedType(tag: DW_TAG_member, name: "has_fixups", scope: !7020, file: !7021, line: 553, baseType: !7, size: 1, offset: 7524, flags: DIFlagBitField, extraData: i64 7520)
!7247 = !DIDerivedType(tag: DW_TAG_member, name: "suspended", scope: !7020, file: !7021, line: 554, baseType: !7, size: 1, offset: 7525, flags: DIFlagBitField, extraData: i64 7520)
!7248 = !DIDerivedType(tag: DW_TAG_member, name: "suspended_by_mdio_bus", scope: !7020, file: !7021, line: 555, baseType: !7, size: 1, offset: 7526, flags: DIFlagBitField, extraData: i64 7520)
!7249 = !DIDerivedType(tag: DW_TAG_member, name: "sysfs_links", scope: !7020, file: !7021, line: 556, baseType: !7, size: 1, offset: 7527, flags: DIFlagBitField, extraData: i64 7520)
!7250 = !DIDerivedType(tag: DW_TAG_member, name: "loopback_enabled", scope: !7020, file: !7021, line: 557, baseType: !7, size: 1, offset: 7528, flags: DIFlagBitField, extraData: i64 7520)
!7251 = !DIDerivedType(tag: DW_TAG_member, name: "downshifted_rate", scope: !7020, file: !7021, line: 558, baseType: !7, size: 1, offset: 7529, flags: DIFlagBitField, extraData: i64 7520)
!7252 = !DIDerivedType(tag: DW_TAG_member, name: "autoneg", scope: !7020, file: !7021, line: 560, baseType: !7, size: 1, offset: 7530, flags: DIFlagBitField, extraData: i64 7520)
!7253 = !DIDerivedType(tag: DW_TAG_member, name: "link", scope: !7020, file: !7021, line: 562, baseType: !7, size: 1, offset: 7531, flags: DIFlagBitField, extraData: i64 7520)
!7254 = !DIDerivedType(tag: DW_TAG_member, name: "autoneg_complete", scope: !7020, file: !7021, line: 563, baseType: !7, size: 1, offset: 7532, flags: DIFlagBitField, extraData: i64 7520)
!7255 = !DIDerivedType(tag: DW_TAG_member, name: "interrupts", scope: !7020, file: !7021, line: 566, baseType: !7, size: 1, offset: 7533, flags: DIFlagBitField, extraData: i64 7520)
!7256 = !DIDerivedType(tag: DW_TAG_member, name: "state", scope: !7020, file: !7021, line: 568, baseType: !7257, size: 32, offset: 7552)
!7257 = !DICompositeType(tag: DW_TAG_enumeration_type, name: "phy_state", file: !7021, line: 443, baseType: !7, size: 32, elements: !7258)
!7258 = !{!7259, !7260, !7261, !7262, !7263, !7264, !7265}
!7259 = !DIEnumerator(name: "PHY_DOWN", value: 0, isUnsigned: true)
!7260 = !DIEnumerator(name: "PHY_READY", value: 1, isUnsigned: true)
!7261 = !DIEnumerator(name: "PHY_HALTED", value: 2, isUnsigned: true)
!7262 = !DIEnumerator(name: "PHY_UP", value: 3, isUnsigned: true)
!7263 = !DIEnumerator(name: "PHY_RUNNING", value: 4, isUnsigned: true)
!7264 = !DIEnumerator(name: "PHY_NOLINK", value: 5, isUnsigned: true)
!7265 = !DIEnumerator(name: "PHY_CABLETEST", value: 6, isUnsigned: true)
!7266 = !DIDerivedType(tag: DW_TAG_member, name: "dev_flags", scope: !7020, file: !7021, line: 570, baseType: !987, size: 32, offset: 7584)
!7267 = !DIDerivedType(tag: DW_TAG_member, name: "interface", scope: !7020, file: !7021, line: 572, baseType: !7268, size: 32, offset: 7616)
!7268 = !DIDerivedType(tag: DW_TAG_typedef, name: "phy_interface_t", file: !7021, line: 148, baseType: !7269)
!7269 = !DICompositeType(tag: DW_TAG_enumeration_type, file: !7021, line: 118, baseType: !7, size: 32, elements: !7270)
!7270 = !{!7271, !7272, !7273, !7274, !7275, !7276, !7277, !7278, !7279, !7280, !7281, !7282, !7283, !7284, !7285, !7286, !7287, !7288, !7289, !7290, !7291, !7292, !7293, !7294, !7295, !7296, !7297}
!7271 = !DIEnumerator(name: "PHY_INTERFACE_MODE_NA", value: 0, isUnsigned: true)
!7272 = !DIEnumerator(name: "PHY_INTERFACE_MODE_INTERNAL", value: 1, isUnsigned: true)
!7273 = !DIEnumerator(name: "PHY_INTERFACE_MODE_MII", value: 2, isUnsigned: true)
!7274 = !DIEnumerator(name: "PHY_INTERFACE_MODE_GMII", value: 3, isUnsigned: true)
!7275 = !DIEnumerator(name: "PHY_INTERFACE_MODE_SGMII", value: 4, isUnsigned: true)
!7276 = !DIEnumerator(name: "PHY_INTERFACE_MODE_TBI", value: 5, isUnsigned: true)
!7277 = !DIEnumerator(name: "PHY_INTERFACE_MODE_REVMII", value: 6, isUnsigned: true)
!7278 = !DIEnumerator(name: "PHY_INTERFACE_MODE_RMII", value: 7, isUnsigned: true)
!7279 = !DIEnumerator(name: "PHY_INTERFACE_MODE_RGMII", value: 8, isUnsigned: true)
!7280 = !DIEnumerator(name: "PHY_INTERFACE_MODE_RGMII_ID", value: 9, isUnsigned: true)
!7281 = !DIEnumerator(name: "PHY_INTERFACE_MODE_RGMII_RXID", value: 10, isUnsigned: true)
!7282 = !DIEnumerator(name: "PHY_INTERFACE_MODE_RGMII_TXID", value: 11, isUnsigned: true)
!7283 = !DIEnumerator(name: "PHY_INTERFACE_MODE_RTBI", value: 12, isUnsigned: true)
!7284 = !DIEnumerator(name: "PHY_INTERFACE_MODE_SMII", value: 13, isUnsigned: true)
!7285 = !DIEnumerator(name: "PHY_INTERFACE_MODE_XGMII", value: 14, isUnsigned: true)
!7286 = !DIEnumerator(name: "PHY_INTERFACE_MODE_XLGMII", value: 15, isUnsigned: true)
!7287 = !DIEnumerator(name: "PHY_INTERFACE_MODE_MOCA", value: 16, isUnsigned: true)
!7288 = !DIEnumerator(name: "PHY_INTERFACE_MODE_QSGMII", value: 17, isUnsigned: true)
!7289 = !DIEnumerator(name: "PHY_INTERFACE_MODE_TRGMII", value: 18, isUnsigned: true)
!7290 = !DIEnumerator(name: "PHY_INTERFACE_MODE_1000BASEX", value: 19, isUnsigned: true)
!7291 = !DIEnumerator(name: "PHY_INTERFACE_MODE_2500BASEX", value: 20, isUnsigned: true)
!7292 = !DIEnumerator(name: "PHY_INTERFACE_MODE_RXAUI", value: 21, isUnsigned: true)
!7293 = !DIEnumerator(name: "PHY_INTERFACE_MODE_XAUI", value: 22, isUnsigned: true)
!7294 = !DIEnumerator(name: "PHY_INTERFACE_MODE_10GBASER", value: 23, isUnsigned: true)
!7295 = !DIEnumerator(name: "PHY_INTERFACE_MODE_USXGMII", value: 24, isUnsigned: true)
!7296 = !DIEnumerator(name: "PHY_INTERFACE_MODE_10GKR", value: 25, isUnsigned: true)
!7297 = !DIEnumerator(name: "PHY_INTERFACE_MODE_MAX", value: 26, isUnsigned: true)
!7298 = !DIDerivedType(tag: DW_TAG_member, name: "speed", scope: !7020, file: !7021, line: 578, baseType: !32, size: 32, offset: 7648)
!7299 = !DIDerivedType(tag: DW_TAG_member, name: "duplex", scope: !7020, file: !7021, line: 579, baseType: !32, size: 32, offset: 7680)
!7300 = !DIDerivedType(tag: DW_TAG_member, name: "pause", scope: !7020, file: !7021, line: 580, baseType: !32, size: 32, offset: 7712)
!7301 = !DIDerivedType(tag: DW_TAG_member, name: "asym_pause", scope: !7020, file: !7021, line: 581, baseType: !32, size: 32, offset: 7744)
!7302 = !DIDerivedType(tag: DW_TAG_member, name: "master_slave_get", scope: !7020, file: !7021, line: 582, baseType: !794, size: 8, offset: 7776)
!7303 = !DIDerivedType(tag: DW_TAG_member, name: "master_slave_set", scope: !7020, file: !7021, line: 583, baseType: !794, size: 8, offset: 7784)
!7304 = !DIDerivedType(tag: DW_TAG_member, name: "master_slave_state", scope: !7020, file: !7021, line: 584, baseType: !794, size: 8, offset: 7792)
!7305 = !DIDerivedType(tag: DW_TAG_member, name: "supported", scope: !7020, file: !7021, line: 588, baseType: !6011, size: 128, offset: 7808)
!7306 = !DIDerivedType(tag: DW_TAG_member, name: "advertising", scope: !7020, file: !7021, line: 589, baseType: !6011, size: 128, offset: 7936)
!7307 = !DIDerivedType(tag: DW_TAG_member, name: "lp_advertising", scope: !7020, file: !7021, line: 590, baseType: !6011, size: 128, offset: 8064)
!7308 = !DIDerivedType(tag: DW_TAG_member, name: "adv_old", scope: !7020, file: !7021, line: 592, baseType: !6011, size: 128, offset: 8192)
!7309 = !DIDerivedType(tag: DW_TAG_member, name: "eee_broken_modes", scope: !7020, file: !7021, line: 595, baseType: !987, size: 32, offset: 8320)
!7310 = !DIDerivedType(tag: DW_TAG_member, name: "irq", scope: !7020, file: !7021, line: 609, baseType: !32, size: 32, offset: 8352)
!7311 = !DIDerivedType(tag: DW_TAG_member, name: "priv", scope: !7020, file: !7021, line: 613, baseType: !591, size: 64, offset: 8384)
!7312 = !DIDerivedType(tag: DW_TAG_member, name: "shared", scope: !7020, file: !7021, line: 617, baseType: !7092, size: 64, offset: 8448)
!7313 = !DIDerivedType(tag: DW_TAG_member, name: "skb", scope: !7020, file: !7021, line: 620, baseType: !415, size: 64, offset: 8512)
!7314 = !DIDerivedType(tag: DW_TAG_member, name: "ehdr", scope: !7020, file: !7021, line: 621, baseType: !591, size: 64, offset: 8576)
!7315 = !DIDerivedType(tag: DW_TAG_member, name: "nest", scope: !7020, file: !7021, line: 622, baseType: !854, size: 64, offset: 8640)
!7316 = !DIDerivedType(tag: DW_TAG_member, name: "state_queue", scope: !7020, file: !7021, line: 625, baseType: !7317, size: 704, offset: 8704)
!7317 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "delayed_work", file: !2830, line: 115, size: 704, elements: !7318)
!7318 = !{!7319, !7320, !7321, !7322}
!7319 = !DIDerivedType(tag: DW_TAG_member, name: "work", scope: !7317, file: !2830, line: 116, baseType: !2829, size: 256)
!7320 = !DIDerivedType(tag: DW_TAG_member, name: "timer", scope: !7317, file: !2830, line: 117, baseType: !3235, size: 320, offset: 256)
!7321 = !DIDerivedType(tag: DW_TAG_member, name: "wq", scope: !7317, file: !2830, line: 120, baseType: !4717, size: 64, offset: 576)
!7322 = !DIDerivedType(tag: DW_TAG_member, name: "cpu", scope: !7317, file: !2830, line: 121, baseType: !32, size: 32, offset: 640)
!7323 = !DIDerivedType(tag: DW_TAG_member, name: "lock", scope: !7020, file: !7021, line: 627, baseType: !1665, size: 192, offset: 9408)
!7324 = !DIDerivedType(tag: DW_TAG_member, name: "sfp_bus_attached", scope: !7020, file: !7021, line: 630, baseType: !771, size: 8, offset: 9600)
!7325 = !DIDerivedType(tag: DW_TAG_member, name: "sfp_bus", scope: !7020, file: !7021, line: 631, baseType: !7326, size: 64, offset: 9664)
!7326 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7327, size: 64)
!7327 = !DICompositeType(tag: DW_TAG_structure_type, name: "sfp_bus", file: !31, line: 60, flags: DIFlagFwdDecl)
!7328 = !DIDerivedType(tag: DW_TAG_member, name: "phylink", scope: !7020, file: !7021, line: 632, baseType: !7329, size: 64, offset: 9728)
!7329 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7330, size: 64)
!7330 = !DICompositeType(tag: DW_TAG_structure_type, name: "phylink", file: !7021, line: 237, flags: DIFlagFwdDecl)
!7331 = !DIDerivedType(tag: DW_TAG_member, name: "attached_dev", scope: !7020, file: !7021, line: 633, baseType: !290, size: 64, offset: 9792)
!7332 = !DIDerivedType(tag: DW_TAG_member, name: "mii_ts", scope: !7020, file: !7021, line: 634, baseType: !7333, size: 64, offset: 9856)
!7333 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7334, size: 64)
!7334 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "mii_timestamper", file: !7335, line: 46, size: 384, elements: !7336)
!7335 = !DIFile(filename: "./include/linux/mii_timestamper.h", directory: "/home/lizy2001/genbc/linux")
!7336 = !{!7337, !7341, !7345, !7349, !7353, !7357}
!7337 = !DIDerivedType(tag: DW_TAG_member, name: "rxtstamp", scope: !7334, file: !7335, line: 47, baseType: !7338, size: 64)
!7338 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7339, size: 64)
!7339 = !DISubroutineType(types: !7340)
!7340 = !{!771, !7333, !415, !32}
!7341 = !DIDerivedType(tag: DW_TAG_member, name: "txtstamp", scope: !7334, file: !7335, line: 50, baseType: !7342, size: 64, offset: 64)
!7342 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7343, size: 64)
!7343 = !DISubroutineType(types: !7344)
!7344 = !{null, !7333, !415, !32}
!7345 = !DIDerivedType(tag: DW_TAG_member, name: "hwtstamp", scope: !7334, file: !7335, line: 53, baseType: !7346, size: 64, offset: 128)
!7346 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7347, size: 64)
!7347 = !DISubroutineType(types: !7348)
!7348 = !{!32, !7333, !597}
!7349 = !DIDerivedType(tag: DW_TAG_member, name: "link_state", scope: !7334, file: !7335, line: 56, baseType: !7350, size: 64, offset: 192)
!7350 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7351, size: 64)
!7351 = !DISubroutineType(types: !7352)
!7352 = !{null, !7333, !7019}
!7353 = !DIDerivedType(tag: DW_TAG_member, name: "ts_info", scope: !7334, file: !7335, line: 59, baseType: !7354, size: 64, offset: 256)
!7354 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7355, size: 64)
!7355 = !DISubroutineType(types: !7356)
!7356 = !{!32, !7333, !5911}
!7357 = !DIDerivedType(tag: DW_TAG_member, name: "device", scope: !7334, file: !7335, line: 62, baseType: !6545, size: 64, offset: 320)
!7358 = !DIDerivedType(tag: DW_TAG_member, name: "mdix", scope: !7020, file: !7021, line: 636, baseType: !794, size: 8, offset: 9920)
!7359 = !DIDerivedType(tag: DW_TAG_member, name: "mdix_ctrl", scope: !7020, file: !7021, line: 637, baseType: !794, size: 8, offset: 9928)
!7360 = !DIDerivedType(tag: DW_TAG_member, name: "phy_link_change", scope: !7020, file: !7021, line: 639, baseType: !7361, size: 64, offset: 9984)
!7361 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7362, size: 64)
!7362 = !DISubroutineType(types: !7363)
!7363 = !{null, !7019, !771}
!7364 = !DIDerivedType(tag: DW_TAG_member, name: "adjust_link", scope: !7020, file: !7021, line: 640, baseType: !405, size: 64, offset: 10048)
!7365 = !DIDerivedType(tag: DW_TAG_member, name: "sfp_bus", scope: !264, file: !31, line: 2150, baseType: !7326, size: 64, offset: 14912)
...
!7394 = !{!980}
!7395 = !{!0, !7396, !7401, !7406, !7411, !7456, !7458, !7463, !7466, !7740, !7743}
!7396 = !DIGlobalVariableExpression(var: !7397, expr: !DIExpression())
!7397 = distinct !DIGlobalVariable(name: "__exitcall_xlgmac_pci_driver_exit", scope: !2, file: !3, line: 73, type: !7398, isLocal: true, isDefinition: true)
!7398 = !DIDerivedType(tag: DW_TAG_typedef, name: "exitcall_t", file: !7399, line: 117, baseType: !7400)
!7399 = !DIFile(filename: "./include/linux/init.h", directory: "/home/lizy2001/genbc/linux")
!7400 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !3809, size: 64)
!7401 = !DIGlobalVariableExpression(var: !7402, expr: !DIExpression())
!7402 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_description326", scope: !2, file: !3, line: 75, type: !7403, isLocal: true, isDefinition: true, align: 8)
!7403 = !DICompositeType(tag: DW_TAG_array_type, baseType: !293, size: 400, elements: !7404)
!7404 = !{!7405}
!7405 = !DISubrange(count: 50)
!7406 = !DIGlobalVariableExpression(var: !7407, expr: !DIExpression())
!7407 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_version327", scope: !2, file: !3, line: 76, type: !7408, isLocal: true, isDefinition: true, align: 8)
!7408 = !DICompositeType(tag: DW_TAG_array_type, baseType: !293, size: 200, elements: !7409)
!7409 = !{!7410}
!7410 = !DISubrange(count: 25)
!7411 = !DIGlobalVariableExpression(var: !7412, expr: !DIExpression())
!7412 = distinct !DIGlobalVariable(name: "__modver_attr", scope: !2, file: !3, line: 76, type: !7413, isLocal: true, isDefinition: true)
...
!7416 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "module_version_attribute", file: !7417, line: 65, size: 576, align: 64, elements: !7418)
!7417 = !DIFile(filename: "./include/linux/module.h", directory: "/home/lizy2001/genbc/linux")
!7418 = !{!7419, !7454, !7455}
!7419 = !DIDerivedType(tag: DW_TAG_member, name: "mattr", scope: !7416, file: !7417, line: 66, baseType: !7420, size: 448)
!7420 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "module_attribute", file: !7417, line: 54, size: 448, elements: !7421)
!7421 = !{!7422, !7423, !7438, !7442, !7446, !7450}
!7422 = !DIDerivedType(tag: DW_TAG_member, name: "attr", scope: !7420, file: !7417, line: 55, baseType: !6146, size: 128)
!7423 = !DIDerivedType(tag: DW_TAG_member, name: "show", scope: !7420, file: !7417, line: 56, baseType: !7424, size: 64, offset: 128)
!7424 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7425, size: 64)
!7425 = !DISubroutineType(types: !7426)
!7426 = !{!1521, !7427, !7428, !1038}
!7427 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7420, size: 64)
!7428 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7429, size: 64)
!7429 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "module_kobject", file: !7417, line: 46, size: 768, elements: !7430)
!7430 = !{!7431, !7432, !7433, !7434, !7437}
!7431 = !DIDerivedType(tag: DW_TAG_member, name: "kobj", scope: !7429, file: !7417, line: 47, baseType: !6120, size: 512)
!7432 = !DIDerivedType(tag: DW_TAG_member, name: "mod", scope: !7429, file: !7417, line: 48, baseType: !980, size: 64, offset: 512)
!7433 = !DIDerivedType(tag: DW_TAG_member, name: "drivers_dir", scope: !7429, file: !7417, line: 49, baseType: !6125, size: 64, offset: 576)
!7434 = !DIDerivedType(tag: DW_TAG_member, name: "mp", scope: !7429, file: !7417, line: 50, baseType: !7435, size: 64, offset: 640)
!7435 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7436, size: 64)
!7436 = !DICompositeType(tag: DW_TAG_structure_type, name: "module_param_attrs", file: !7417, line: 50, flags: DIFlagFwdDecl)
!7437 = !DIDerivedType(tag: DW_TAG_member, name: "kobj_completion", scope: !7429, file: !7417, line: 51, baseType: !2596, size: 64, offset: 704)
!7438 = !DIDerivedType(tag: DW_TAG_member, name: "store", scope: !7420, file: !7417, line: 58, baseType: !7439, size: 64, offset: 192)
!7439 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7440, size: 64)
!7440 = !DISubroutineType(types: !7441)
!7441 = !{!1521, !7427, !7428, !292, !1039}
!7442 = !DIDerivedType(tag: DW_TAG_member, name: "setup", scope: !7420, file: !7417, line: 60, baseType: !7443, size: 64, offset: 256)
!7443 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7444, size: 64)
!7444 = !DISubroutineType(types: !7445)
!7445 = !{null, !980, !292}
!7446 = !DIDerivedType(tag: DW_TAG_member, name: "test", scope: !7420, file: !7417, line: 61, baseType: !7447, size: 64, offset: 320)
!7447 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7448, size: 64)
!7448 = !DISubroutineType(types: !7449)
!7449 = !{!32, !980}
!7450 = !DIDerivedType(tag: DW_TAG_member, name: "free", scope: !7420, file: !7417, line: 62, baseType: !7451, size: 64, offset: 384)
!7451 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7452, size: 64)
!7452 = !DISubroutineType(types: !7453)
!7453 = !{null, !980}
!7454 = !DIDerivedType(tag: DW_TAG_member, name: "module_name", scope: !7416, file: !7417, line: 67, baseType: !292, size: 64, offset: 448)
!7455 = !DIDerivedType(tag: DW_TAG_member, name: "version", scope: !7416, file: !7417, line: 68, baseType: !292, size: 64, offset: 512)
!7456 = !DIGlobalVariableExpression(var: !7457, expr: !DIExpression())
!7457 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author328", scope: !2, file: !3, line: 77, type: !7403, isLocal: true, isDefinition: true, align: 8)
!7458 = !DIGlobalVariableExpression(var: !7459, expr: !DIExpression())
!7459 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file329", scope: !2, file: !3, line: 78, type: !7460, isLocal: true, isDefinition: true, align: 8)
!7460 = !DICompositeType(tag: DW_TAG_array_type, baseType: !293, size: 456, elements: !7461)
!7461 = !{!7462}
!7462 = !DISubrange(count: 57)
!7463 = !DIGlobalVariableExpression(var: !7464, expr: !DIExpression())
!7464 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license330", scope: !2, file: !3, line: 78, type: !7465, isLocal: true, isDefinition: true, align: 8)
!7465 = !DICompositeType(tag: DW_TAG_array_type, baseType: !293, size: 256, elements: !819)
!7466 = !DIGlobalVariableExpression(var: !7467, expr: !DIExpression())
!7467 = distinct !DIGlobalVariable(name: "xlgmac_pci_driver", scope: !2, file: !3, line: 66, type: !7468, isLocal: true, isDefinition: true)
!7468 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_driver", file: !7469, line: 858, size: 2048, elements: !7470)
!7469 = !DIFile(filename: "./include/linux/pci.h", directory: "/home/lizy2001/genbc/linux")
!7470 = !{!7471, !7472, !7473, !7485, !7698, !7702, !7706, !7710, !7711, !7715, !7733, !7734, !7735}
!7471 = !DIDerivedType(tag: DW_TAG_member, name: "node", scope: !7468, file: !7469, line: 859, baseType: !284, size: 128)
!7472 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !7468, file: !7469, line: 860, baseType: !292, size: 64, offset: 128)
!7473 = !DIDerivedType(tag: DW_TAG_member, name: "id_table", scope: !7468, file: !7469, line: 861, baseType: !7474, size: 64, offset: 192)
!7474 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7475, size: 64)
!7475 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !7476)
!7476 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_device_id", file: !6636, line: 38, size: 256, elements: !7477)
!7477 = !{!7478, !7479, !7480, !7481, !7482, !7483, !7484}
!7478 = !DIDerivedType(tag: DW_TAG_member, name: "vendor", scope: !7476, file: !6636, line: 39, baseType: !493, size: 32)
!7479 = !DIDerivedType(tag: DW_TAG_member, name: "device", scope: !7476, file: !6636, line: 39, baseType: !493, size: 32, offset: 32)
!7480 = !DIDerivedType(tag: DW_TAG_member, name: "subvendor", scope: !7476, file: !6636, line: 40, baseType: !493, size: 32, offset: 64)
!7481 = !DIDerivedType(tag: DW_TAG_member, name: "subdevice", scope: !7476, file: !6636, line: 40, baseType: !493, size: 32, offset: 96)
!7482 = !DIDerivedType(tag: DW_TAG_member, name: "class", scope: !7476, file: !6636, line: 41, baseType: !493, size: 32, offset: 128)
!7483 = !DIDerivedType(tag: DW_TAG_member, name: "class_mask", scope: !7476, file: !6636, line: 41, baseType: !493, size: 32, offset: 160)
!7484 = !DIDerivedType(tag: DW_TAG_member, name: "driver_data", scope: !7476, file: !6636, line: 42, baseType: !6650, size: 64, offset: 192)
!7485 = !DIDerivedType(tag: DW_TAG_member, name: "probe", scope: !7468, file: !7469, line: 862, baseType: !7486, size: 64, offset: 256)
...
!7490 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_dev", file: !7469, line: 309, size: 19264, elements: !7491)
!7491 = !{!7492, !7493, !7562, !7563, !7564, !7565, !7576, !7577, !7578, !7579, !7580, !7581, !7582, !7583, !7584, !7585, !7586, !7587, !7588, !7589, !7590, !7591, !7592, !7594, !7595, !7596, !7598, !7599, !7600, !7601, !7602, !7603, !7604, !7605, !7606, !7607, !7608, !7609, !7610, !7611, !7612, !7613, !7614, !7615, !7616, !7617, !7620, !7621, !7622, !7623, !7625, !7626, !7627, !7628, !7632, !7633, !7634, !7635, !7636, !7637, !7638, !7639, !7640, !7641, !7642, !7643, !7644, !7645, !7646, !7647, !7648, !7649, !7650, !7651, !7652, !7653, !7654, !7655, !7656, !7657, !7658, !7659, !7660, !7661, !7662, !7663, !7664, !7665, !7666, !7667, !7668, !7669, !7671, !7672, !7674, !7675, !7676, !7677, !7679, !7680, !7681, !7684, !7691, !7692, !7693, !7694, !7695, !7696, !7697}
!7492 = !DIDerivedType(tag: DW_TAG_member, name: "bus_list", scope: !7490, file: !7469, line: 310, baseType: !284, size: 128)
!7493 = !DIDerivedType(tag: DW_TAG_member, name: "bus", scope: !7490, file: !7469, line: 311, baseType: !7494, size: 64, offset: 128)
!7494 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7495, size: 64)
!7495 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_bus", file: !7469, line: 605, size: 8064, elements: !7496)
!7496 = !{!7497, !7498, !7499, !7500, !7501, !7502, !7503, !7518, !7519, !7520, !7544, !7547, !7548, !7549, !7550, !7551, !7552, !7553, !7554, !7555, !7557, !7558, !7559, !7560, !7561}
!7497 = !DIDerivedType(tag: DW_TAG_member, name: "node", scope: !7495, file: !7469, line: 606, baseType: !284, size: 128)
!7498 = !DIDerivedType(tag: DW_TAG_member, name: "parent", scope: !7495, file: !7469, line: 607, baseType: !7494, size: 64, offset: 128)
!7499 = !DIDerivedType(tag: DW_TAG_member, name: "children", scope: !7495, file: !7469, line: 608, baseType: !284, size: 128, offset: 192)
!7500 = !DIDerivedType(tag: DW_TAG_member, name: "devices", scope: !7495, file: !7469, line: 609, baseType: !284, size: 128, offset: 320)
!7501 = !DIDerivedType(tag: DW_TAG_member, name: "self", scope: !7495, file: !7469, line: 610, baseType: !7489, size: 64, offset: 448)
!7502 = !DIDerivedType(tag: DW_TAG_member, name: "slots", scope: !7495, file: !7469, line: 611, baseType: !284, size: 128, offset: 512)
!7503 = !DIDerivedType(tag: DW_TAG_member, name: "resource", scope: !7495, file: !7469, line: 613, baseType: !7504, size: 256, offset: 640)
!7504 = !DICompositeType(tag: DW_TAG_array_type, baseType: !7505, size: 256, elements: !2272)
!7505 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7506, size: 64)
!7506 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "resource", file: !7507, line: 20, size: 512, elements: !7508)
!7507 = !DIFile(filename: "./include/linux/ioport.h", directory: "/home/lizy2001/genbc/linux")
!7508 = !{!7509, !7511, !7512, !7513, !7514, !7515, !7516, !7517}
!7509 = !DIDerivedType(tag: DW_TAG_member, name: "start", scope: !7506, file: !7507, line: 21, baseType: !7510, size: 64)
!7510 = !DIDerivedType(tag: DW_TAG_typedef, name: "resource_size_t", file: !277, line: 158, baseType: !4045)
!7511 = !DIDerivedType(tag: DW_TAG_member, name: "end", scope: !7506, file: !7507, line: 22, baseType: !7510, size: 64, offset: 64)
!7512 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !7506, file: !7507, line: 23, baseType: !292, size: 64, offset: 128)
!7513 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !7506, file: !7507, line: 24, baseType: !312, size: 64, offset: 192)
!7514 = !DIDerivedType(tag: DW_TAG_member, name: "desc", scope: !7506, file: !7507, line: 25, baseType: !312, size: 64, offset: 256)
!7515 = !DIDerivedType(tag: DW_TAG_member, name: "parent", scope: !7506, file: !7507, line: 26, baseType: !7505, size: 64, offset: 320)
!7516 = !DIDerivedType(tag: DW_TAG_member, name: "sibling", scope: !7506, file: !7507, line: 26, baseType: !7505, size: 64, offset: 384)
!7517 = !DIDerivedType(tag: DW_TAG_member, name: "child", scope: !7506, file: !7507, line: 26, baseType: !7505, size: 64, offset: 448)
!7518 = !DIDerivedType(tag: DW_TAG_member, name: "resources", scope: !7495, file: !7469, line: 614, baseType: !284, size: 128, offset: 896)
!7519 = !DIDerivedType(tag: DW_TAG_member, name: "busn_res", scope: !7495, file: !7469, line: 615, baseType: !7506, size: 512, offset: 1024)
!7520 = !DIDerivedType(tag: DW_TAG_member, name: "ops", scope: !7495, file: !7469, line: 617, baseType: !7521, size: 64, offset: 1536)
!7521 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7522, size: 64)
!7522 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_ops", file: !7469, line: 731, size: 320, elements: !7523)
!7523 = !{!7524, !7528, !7532, !7536, !7540}
!7524 = !DIDerivedType(tag: DW_TAG_member, name: "add_bus", scope: !7522, file: !7469, line: 732, baseType: !7525, size: 64)
!7525 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7526, size: 64)
!7526 = !DISubroutineType(types: !7527)
!7527 = !{!32, !7494}
!7528 = !DIDerivedType(tag: DW_TAG_member, name: "remove_bus", scope: !7522, file: !7469, line: 733, baseType: !7529, size: 64, offset: 64)
!7529 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7530, size: 64)
!7530 = !DISubroutineType(types: !7531)
!7531 = !{null, !7494}
!7532 = !DIDerivedType(tag: DW_TAG_member, name: "map_bus", scope: !7522, file: !7469, line: 734, baseType: !7533, size: 64, offset: 128)
!7533 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7534, size: 64)
!7534 = !DISubroutineType(types: !7535)
!7535 = !{!591, !7494, !7, !32}
!7536 = !DIDerivedType(tag: DW_TAG_member, name: "read", scope: !7522, file: !7469, line: 735, baseType: !7537, size: 64, offset: 192)
!7537 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7538, size: 64)
!7538 = !DISubroutineType(types: !7539)
!7539 = !{!32, !7494, !7, !32, !32, !2516}
!7540 = !DIDerivedType(tag: DW_TAG_member, name: "write", scope: !7522, file: !7469, line: 736, baseType: !7541, size: 64, offset: 256)
!7541 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7542, size: 64)
!7542 = !DISubroutineType(types: !7543)
!7543 = !{!32, !7494, !7, !32, !32, !987}
!7544 = !DIDerivedType(tag: DW_TAG_member, name: "msi", scope: !7495, file: !7469, line: 618, baseType: !7545, size: 64, offset: 1600)
!7545 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7546, size: 64)
!7546 = !DICompositeType(tag: DW_TAG_structure_type, name: "msi_controller", file: !7469, line: 537, flags: DIFlagFwdDecl)
!7547 = !DIDerivedType(tag: DW_TAG_member, name: "sysdata", scope: !7495, file: !7469, line: 619, baseType: !591, size: 64, offset: 1664)
!7548 = !DIDerivedType(tag: DW_TAG_member, name: "procdir", scope: !7495, file: !7469, line: 620, baseType: !3010, size: 64, offset: 1728)
!7549 = !DIDerivedType(tag: DW_TAG_member, name: "number", scope: !7495, file: !7469, line: 622, baseType: !482, size: 8, offset: 1792)
!7550 = !DIDerivedType(tag: DW_TAG_member, name: "primary", scope: !7495, file: !7469, line: 623, baseType: !482, size: 8, offset: 1800)
!7551 = !DIDerivedType(tag: DW_TAG_member, name: "max_bus_speed", scope: !7495, file: !7469, line: 624, baseType: !482, size: 8, offset: 1808)
!7552 = !DIDerivedType(tag: DW_TAG_member, name: "cur_bus_speed", scope: !7495, file: !7469, line: 625, baseType: !482, size: 8, offset: 1816)
!7553 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !7495, file: !7469, line: 630, baseType: !457, size: 384, offset: 1824)
!7554 = !DIDerivedType(tag: DW_TAG_member, name: "bridge_ctl", scope: !7495, file: !7469, line: 632, baseType: !476, size: 16, offset: 2208)
!7555 = !DIDerivedType(tag: DW_TAG_member, name: "bus_flags", scope: !7495, file: !7469, line: 633, baseType: !7556, size: 16, offset: 2224)
!7556 = !DIDerivedType(tag: DW_TAG_typedef, name: "pci_bus_flags_t", file: !7469, line: 237, baseType: !476)
!7557 = !DIDerivedType(tag: DW_TAG_member, name: "bridge", scope: !7495, file: !7469, line: 634, baseType: !6545, size: 64, offset: 2240)
!7558 = !DIDerivedType(tag: DW_TAG_member, name: "dev", scope: !7495, file: !7469, line: 635, baseType: !6540, size: 5568, offset: 2304)
!7559 = !DIDerivedType(tag: DW_TAG_member, name: "legacy_io", scope: !7495, file: !7469, line: 636, baseType: !6171, size: 64, offset: 7872)
!7560 = !DIDerivedType(tag: DW_TAG_member, name: "legacy_mem", scope: !7495, file: !7469, line: 637, baseType: !6171, size: 64, offset: 7936)
!7561 = !DIDerivedType(tag: DW_TAG_member, name: "is_added", scope: !7495, file: !7469, line: 638, baseType: !7, size: 1, offset: 8000, flags: DIFlagBitField, extraData: i64 8000)
!7562 = !DIDerivedType(tag: DW_TAG_member, name: "subordinate", scope: !7490, file: !7469, line: 312, baseType: !7494, size: 64, offset: 192)
!7563 = !DIDerivedType(tag: DW_TAG_member, name: "sysdata", scope: !7490, file: !7469, line: 314, baseType: !591, size: 64, offset: 256)
!7564 = !DIDerivedType(tag: DW_TAG_member, name: "procent", scope: !7490, file: !7469, line: 315, baseType: !3010, size: 64, offset: 320)
!7565 = !DIDerivedType(tag: DW_TAG_member, name: "slot", scope: !7490, file: !7469, line: 316, baseType: !7566, size: 64, offset: 384)
!7566 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7567, size: 64)
!7567 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_slot", file: !7469, line: 69, size: 832, elements: !7568)
!7568 = !{!7569, !7570, !7571, !7574, !7575}
!7569 = !DIDerivedType(tag: DW_TAG_member, name: "bus", scope: !7567, file: !7469, line: 70, baseType: !7494, size: 64)
!7570 = !DIDerivedType(tag: DW_TAG_member, name: "list", scope: !7567, file: !7469, line: 71, baseType: !284, size: 128, offset: 64)
!7571 = !DIDerivedType(tag: DW_TAG_member, name: "hotplug", scope: !7567, file: !7469, line: 72, baseType: !7572, size: 64, offset: 192)
!7572 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7573, size: 64)
!7573 = !DICompositeType(tag: DW_TAG_structure_type, name: "hotplug_slot", file: !7469, line: 72, flags: DIFlagFwdDecl)
!7574 = !DIDerivedType(tag: DW_TAG_member, name: "number", scope: !7567, file: !7469, line: 73, baseType: !482, size: 8, offset: 256)
!7575 = !DIDerivedType(tag: DW_TAG_member, name: "kobj", scope: !7567, file: !7469, line: 74, baseType: !6120, size: 512, offset: 320)
!7576 = !DIDerivedType(tag: DW_TAG_member, name: "devfn", scope: !7490, file: !7469, line: 318, baseType: !7, size: 32, offset: 448)
!7577 = !DIDerivedType(tag: DW_TAG_member, name: "vendor", scope: !7490, file: !7469, line: 319, baseType: !476, size: 16, offset: 480)
!7578 = !DIDerivedType(tag: DW_TAG_member, name: "device", scope: !7490, file: !7469, line: 320, baseType: !476, size: 16, offset: 496)
!7579 = !DIDerivedType(tag: DW_TAG_member, name: "subsystem_vendor", scope: !7490, file: !7469, line: 321, baseType: !476, size: 16, offset: 512)
!7580 = !DIDerivedType(tag: DW_TAG_member, name: "subsystem_device", scope: !7490, file: !7469, line: 322, baseType: !476, size: 16, offset: 528)
!7581 = !DIDerivedType(tag: DW_TAG_member, name: "class", scope: !7490, file: !7469, line: 323, baseType: !7, size: 32, offset: 544)
!7582 = !DIDerivedType(tag: DW_TAG_member, name: "revision", scope: !7490, file: !7469, line: 324, baseType: !794, size: 8, offset: 576)
!7583 = !DIDerivedType(tag: DW_TAG_member, name: "hdr_type", scope: !7490, file: !7469, line: 325, baseType: !794, size: 8, offset: 584)
!7584 = !DIDerivedType(tag: DW_TAG_member, name: "pcie_cap", scope: !7490, file: !7469, line: 330, baseType: !794, size: 8, offset: 592)
!7585 = !DIDerivedType(tag: DW_TAG_member, name: "msi_cap", scope: !7490, file: !7469, line: 331, baseType: !794, size: 8, offset: 600)
!7586 = !DIDerivedType(tag: DW_TAG_member, name: "msix_cap", scope: !7490, file: !7469, line: 332, baseType: !794, size: 8, offset: 608)
!7587 = !DIDerivedType(tag: DW_TAG_member, name: "pcie_mpss", scope: !7490, file: !7469, line: 333, baseType: !794, size: 3, offset: 616, flags: DIFlagBitField, extraData: i64 616)
!7588 = !DIDerivedType(tag: DW_TAG_member, name: "rom_base_reg", scope: !7490, file: !7469, line: 334, baseType: !794, size: 8, offset: 624)
!7589 = !DIDerivedType(tag: DW_TAG_member, name: "pin", scope: !7490, file: !7469, line: 335, baseType: !794, size: 8, offset: 632)
!7590 = !DIDerivedType(tag: DW_TAG_member, name: "pcie_flags_reg", scope: !7490, file: !7469, line: 336, baseType: !581, size: 16, offset: 640)
!7591 = !DIDerivedType(tag: DW_TAG_member, name: "dma_alias_mask", scope: !7490, file: !7469, line: 337, baseType: !3439, size: 64, offset: 704)
!7592 = !DIDerivedType(tag: DW_TAG_member, name: "driver", scope: !7490, file: !7469, line: 339, baseType: !7593, size: 64, offset: 768)
!7593 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7468, size: 64)
!7594 = !DIDerivedType(tag: DW_TAG_member, name: "dma_mask", scope: !7490, file: !7469, line: 340, baseType: !331, size: 64, offset: 832)
!7595 = !DIDerivedType(tag: DW_TAG_member, name: "dma_parms", scope: !7490, file: !7469, line: 346, baseType: !6850, size: 128, offset: 896)
!7596 = !DIDerivedType(tag: DW_TAG_member, name: "current_state", scope: !7490, file: !7469, line: 348, baseType: !7597, size: 32, offset: 1024)
!7597 = !DIDerivedType(tag: DW_TAG_typedef, name: "pci_power_t", file: !7469, line: 155, baseType: !32)
!7598 = !DIDerivedType(tag: DW_TAG_member, name: "imm_ready", scope: !7490, file: !7469, line: 351, baseType: !7, size: 1, offset: 1056, flags: DIFlagBitField, extraData: i64 1056)
!7599 = !DIDerivedType(tag: DW_TAG_member, name: "pm_cap", scope: !7490, file: !7469, line: 352, baseType: !794, size: 8, offset: 1064)
!7600 = !DIDerivedType(tag: DW_TAG_member, name: "pme_support", scope: !7490, file: !7469, line: 353, baseType: !7, size: 5, offset: 1072, flags: DIFlagBitField, extraData: i64 1072)
!7601 = !DIDerivedType(tag: DW_TAG_member, name: "pme_poll", scope: !7490, file: !7469, line: 355, baseType: !7, size: 1, offset: 1077, flags: DIFlagBitField, extraData: i64 1072)
!7602 = !DIDerivedType(tag: DW_TAG_member, name: "d1_support", scope: !7490, file: !7469, line: 356, baseType: !7, size: 1, offset: 1078, flags: DIFlagBitField, extraData: i64 1072)
!7603 = !DIDerivedType(tag: DW_TAG_member, name: "d2_support", scope: !7490, file: !7469, line: 357, baseType: !7, size: 1, offset: 1079, flags: DIFlagBitField, extraData: i64 1072)
!7604 = !DIDerivedType(tag: DW_TAG_member, name: "no_d1d2", scope: !7490, file: !7469, line: 358, baseType: !7, size: 1, offset: 1080, flags: DIFlagBitField, extraData: i64 1072)
!7605 = !DIDerivedType(tag: DW_TAG_member, name: "no_d3cold", scope: !7490, file: !7469, line: 359, baseType: !7, size: 1, offset: 1081, flags: DIFlagBitField, extraData: i64 1072)
!7606 = !DIDerivedType(tag: DW_TAG_member, name: "bridge_d3", scope: !7490, file: !7469, line: 360, baseType: !7, size: 1, offset: 1082, flags: DIFlagBitField, extraData: i64 1072)
!7607 = !DIDerivedType(tag: DW_TAG_member, name: "d3cold_allowed", scope: !7490, file: !7469, line: 361, baseType: !7, size: 1, offset: 1083, flags: DIFlagBitField, extraData: i64 1072)
!7608 = !DIDerivedType(tag: DW_TAG_member, name: "mmio_always_on", scope: !7490, file: !7469, line: 362, baseType: !7, size: 1, offset: 1084, flags: DIFlagBitField, extraData: i64 1072)
!7609 = !DIDerivedType(tag: DW_TAG_member, name: "wakeup_prepared", scope: !7490, file: !7469, line: 364, baseType: !7, size: 1, offset: 1085, flags: DIFlagBitField, extraData: i64 1072)
!7610 = !DIDerivedType(tag: DW_TAG_member, name: "runtime_d3cold", scope: !7490, file: !7469, line: 365, baseType: !7, size: 1, offset: 1086, flags: DIFlagBitField, extraData: i64 1072)
!7611 = !DIDerivedType(tag: DW_TAG_member, name: "skip_bus_pm", scope: !7490, file: !7469, line: 369, baseType: !7, size: 1, offset: 1087, flags: DIFlagBitField, extraData: i64 1072)
!7612 = !DIDerivedType(tag: DW_TAG_member, name: "ignore_hotplug", scope: !7490, file: !7469, line: 370, baseType: !7, size: 1, offset: 1088, flags: DIFlagBitField, extraData: i64 1072)
!7613 = !DIDerivedType(tag: DW_TAG_member, name: "hotplug_user_indicators", scope: !7490, file: !7469, line: 371, baseType: !7, size: 1, offset: 1089, flags: DIFlagBitField, extraData: i64 1072)
!7614 = !DIDerivedType(tag: DW_TAG_member, name: "clear_retrain_link", scope: !7490, file: !7469, line: 374, baseType: !7, size: 1, offset: 1090, flags: DIFlagBitField, extraData: i64 1072)
!7615 = !DIDerivedType(tag: DW_TAG_member, name: "d3hot_delay", scope: !7490, file: !7469, line: 376, baseType: !7, size: 32, offset: 1120)
!7616 = !DIDerivedType(tag: DW_TAG_member, name: "d3cold_delay", scope: !7490, file: !7469, line: 377, baseType: !7, size: 32, offset: 1152)
!7617 = !DIDerivedType(tag: DW_TAG_member, name: "link_state", scope: !7490, file: !7469, line: 380, baseType: !7618, size: 64, offset: 1216)
!7618 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7619, size: 64)
!7619 = !DICompositeType(tag: DW_TAG_structure_type, name: "pcie_link_state", file: !7469, line: 303, flags: DIFlagFwdDecl)
!7620 = !DIDerivedType(tag: DW_TAG_member, name: "ltr_path", scope: !7490, file: !7469, line: 381, baseType: !7, size: 1, offset: 1280, flags: DIFlagBitField, extraData: i64 1280)
!7621 = !DIDerivedType(tag: DW_TAG_member, name: "l1ss", scope: !7490, file: !7469, line: 383, baseType: !32, size: 32, offset: 1312)
!7622 = !DIDerivedType(tag: DW_TAG_member, name: "eetlp_prefix_path", scope: !7490, file: !7469, line: 385, baseType: !7, size: 1, offset: 1344, flags: DIFlagBitField, extraData: i64 1344)
!7623 = !DIDerivedType(tag: DW_TAG_member, name: "error_state", scope: !7490, file: !7469, line: 387, baseType: !7624, size: 32, offset: 1376)
!7624 = !DIDerivedType(tag: DW_TAG_typedef, name: "pci_channel_state_t", file: !7469, line: 180, baseType: !7)
!7625 = !DIDerivedType(tag: DW_TAG_member, name: "dev", scope: !7490, file: !7469, line: 388, baseType: !6540, size: 5568, offset: 1408)
!7626 = !DIDerivedType(tag: DW_TAG_member, name: "cfg_size", scope: !7490, file: !7469, line: 390, baseType: !32, size: 32, offset: 6976)
!7627 = !DIDerivedType(tag: DW_TAG_member, name: "irq", scope: !7490, file: !7469, line: 396, baseType: !7, size: 32, offset: 7008)
!7628 = !DIDerivedType(tag: DW_TAG_member, name: "resource", scope: !7490, file: !7469, line: 397, baseType: !7629, size: 8704, offset: 7040)
!7629 = !DICompositeType(tag: DW_TAG_array_type, baseType: !7506, size: 8704, elements: !7630)
!7630 = !{!7631}
!7631 = !DISubrange(count: 17)
!7632 = !DIDerivedType(tag: DW_TAG_member, name: "match_driver", scope: !7490, file: !7469, line: 399, baseType: !771, size: 8, offset: 15744)
!7633 = !DIDerivedType(tag: DW_TAG_member, name: "transparent", scope: !7490, file: !7469, line: 401, baseType: !7, size: 1, offset: 15752, flags: DIFlagBitField, extraData: i64 15752)
!7634 = !DIDerivedType(tag: DW_TAG_member, name: "io_window", scope: !7490, file: !7469, line: 402, baseType: !7, size: 1, offset: 15753, flags: DIFlagBitField, extraData: i64 15752)
!7635 = !DIDerivedType(tag: DW_TAG_member, name: "pref_window", scope: !7490, file: !7469, line: 403, baseType: !7, size: 1, offset: 15754, flags: DIFlagBitField, extraData: i64 15752)
!7636 = !DIDerivedType(tag: DW_TAG_member, name: "pref_64_window", scope: !7490, file: !7469, line: 404, baseType: !7, size: 1, offset: 15755, flags: DIFlagBitField, extraData: i64 15752)
!7637 = !DIDerivedType(tag: DW_TAG_member, name: "multifunction", scope: !7490, file: !7469, line: 405, baseType: !7, size: 1, offset: 15756, flags: DIFlagBitField, extraData: i64 15752)
!7638 = !DIDerivedType(tag: DW_TAG_member, name: "is_busmaster", scope: !7490, file: !7469, line: 407, baseType: !7, size: 1, offset: 15757, flags: DIFlagBitField, extraData: i64 15752)
!7639 = !DIDerivedType(tag: DW_TAG_member, name: "no_msi", scope: !7490, file: !7469, line: 408, baseType: !7, size: 1, offset: 15758, flags: DIFlagBitField, extraData: i64 15752)
!7640 = !DIDerivedType(tag: DW_TAG_member, name: "no_64bit_msi", scope: !7490, file: !7469, line: 409, baseType: !7, size: 1, offset: 15759, flags: DIFlagBitField, extraData: i64 15752)
!7641 = !DIDerivedType(tag: DW_TAG_member, name: "block_cfg_access", scope: !7490, file: !7469, line: 410, baseType: !7, size: 1, offset: 15760, flags: DIFlagBitField, extraData: i64 15752)
!7642 = !DIDerivedType(tag: DW_TAG_member, name: "broken_parity_status", scope: !7490, file: !7469, line: 411, baseType: !7, size: 1, offset: 15761, flags: DIFlagBitField, extraData: i64 15752)
!7643 = !DIDerivedType(tag: DW_TAG_member, name: "irq_reroute_variant", scope: !7490, file: !7469, line: 412, baseType: !7, size: 2, offset: 15762, flags: DIFlagBitField, extraData: i64 15752)
!7644 = !DIDerivedType(tag: DW_TAG_member, name: "msi_enabled", scope: !7490, file: !7469, line: 413, baseType: !7, size: 1, offset: 15764, flags: DIFlagBitField, extraData: i64 15752)
!7645 = !DIDerivedType(tag: DW_TAG_member, name: "msix_enabled", scope: !7490, file: !7469, line: 414, baseType: !7, size: 1, offset: 15765, flags: DIFlagBitField, extraData: i64 15752)
!7646 = !DIDerivedType(tag: DW_TAG_member, name: "ari_enabled", scope: !7490, file: !7469, line: 415, baseType: !7, size: 1, offset: 15766, flags: DIFlagBitField, extraData: i64 15752)
!7647 = !DIDerivedType(tag: DW_TAG_member, name: "ats_enabled", scope: !7490, file: !7469, line: 416, baseType: !7, size: 1, offset: 15767, flags: DIFlagBitField, extraData: i64 15752)
!7648 = !DIDerivedType(tag: DW_TAG_member, name: "pasid_enabled", scope: !7490, file: !7469, line: 417, baseType: !7, size: 1, offset: 15768, flags: DIFlagBitField, extraData: i64 15752)
!7649 = !DIDerivedType(tag: DW_TAG_member, name: "pri_enabled", scope: !7490, file: !7469, line: 418, baseType: !7, size: 1, offset: 15769, flags: DIFlagBitField, extraData: i64 15752)
!7650 = !DIDerivedType(tag: DW_TAG_member, name: "is_managed", scope: !7490, file: !7469, line: 419, baseType: !7, size: 1, offset: 15770, flags: DIFlagBitField, extraData: i64 15752)
!7651 = !DIDerivedType(tag: DW_TAG_member, name: "needs_freset", scope: !7490, file: !7469, line: 420, baseType: !7, size: 1, offset: 15771, flags: DIFlagBitField, extraData: i64 15752)
!7652 = !DIDerivedType(tag: DW_TAG_member, name: "state_saved", scope: !7490, file: !7469, line: 421, baseType: !7, size: 1, offset: 15772, flags: DIFlagBitField, extraData: i64 15752)
!7653 = !DIDerivedType(tag: DW_TAG_member, name: "is_physfn", scope: !7490, file: !7469, line: 422, baseType: !7, size: 1, offset: 15773, flags: DIFlagBitField, extraData: i64 15752)
!7654 = !DIDerivedType(tag: DW_TAG_member, name: "is_virtfn", scope: !7490, file: !7469, line: 423, baseType: !7, size: 1, offset: 15774, flags: DIFlagBitField, extraData: i64 15752)
!7655 = !DIDerivedType(tag: DW_TAG_member, name: "reset_fn", scope: !7490, file: !7469, line: 424, baseType: !7, size: 1, offset: 15775, flags: DIFlagBitField, extraData: i64 15752)
!7656 = !DIDerivedType(tag: DW_TAG_member, name: "is_hotplug_bridge", scope: !7490, file: !7469, line: 425, baseType: !7, size: 1, offset: 15776, flags: DIFlagBitField, extraData: i64 15752)
!7657 = !DIDerivedType(tag: DW_TAG_member, name: "shpc_managed", scope: !7490, file: !7469, line: 426, baseType: !7, size: 1, offset: 15777, flags: DIFlagBitField, extraData: i64 15752)
!7658 = !DIDerivedType(tag: DW_TAG_member, name: "is_thunderbolt", scope: !7490, file: !7469, line: 427, baseType: !7, size: 1, offset: 15778, flags: DIFlagBitField, extraData: i64 15752)
!7659 = !DIDerivedType(tag: DW_TAG_member, name: "untrusted", scope: !7490, file: !7469, line: 435, baseType: !7, size: 1, offset: 15779, flags: DIFlagBitField, extraData: i64 15752)
!7660 = !DIDerivedType(tag: DW_TAG_member, name: "external_facing", scope: !7490, file: !7469, line: 441, baseType: !7, size: 1, offset: 15780, flags: DIFlagBitField, extraData: i64 15752)
!7661 = !DIDerivedType(tag: DW_TAG_member, name: "broken_intx_masking", scope: !7490, file: !7469, line: 442, baseType: !7, size: 1, offset: 15781, flags: DIFlagBitField, extraData: i64 15752)
!7662 = !DIDerivedType(tag: DW_TAG_member, name: "io_window_1k", scope: !7490, file: !7469, line: 443, baseType: !7, size: 1, offset: 15782, flags: DIFlagBitField, extraData: i64 15752)
!7663 = !DIDerivedType(tag: DW_TAG_member, name: "irq_managed", scope: !7490, file: !7469, line: 444, baseType: !7, size: 1, offset: 15783, flags: DIFlagBitField, extraData: i64 15752)
!7664 = !DIDerivedType(tag: DW_TAG_member, name: "non_compliant_bars", scope: !7490, file: !7469, line: 445, baseType: !7, size: 1, offset: 15784, flags: DIFlagBitField, extraData: i64 15752)
!7665 = !DIDerivedType(tag: DW_TAG_member, name: "is_probed", scope: !7490, file: !7469, line: 446, baseType: !7, size: 1, offset: 15785, flags: DIFlagBitField, extraData: i64 15752)
!7666 = !DIDerivedType(tag: DW_TAG_member, name: "link_active_reporting", scope: !7490, file: !7469, line: 447, baseType: !7, size: 1, offset: 15786, flags: DIFlagBitField, extraData: i64 15752)
!7667 = !DIDerivedType(tag: DW_TAG_member, name: "no_vf_scan", scope: !7490, file: !7469, line: 448, baseType: !7, size: 1, offset: 15787, flags: DIFlagBitField, extraData: i64 15752)
!7668 = !DIDerivedType(tag: DW_TAG_member, name: "no_command_memory", scope: !7490, file: !7469, line: 449, baseType: !7, size: 1, offset: 15788, flags: DIFlagBitField, extraData: i64 15752)
!7669 = !DIDerivedType(tag: DW_TAG_member, name: "dev_flags", scope: !7490, file: !7469, line: 450, baseType: !7670, size: 16, offset: 15792)
!7670 = !DIDerivedType(tag: DW_TAG_typedef, name: "pci_dev_flags_t", file: !7469, line: 206, baseType: !476)
!7671 = !DIDerivedType(tag: DW_TAG_member, name: "enable_cnt", scope: !7490, file: !7469, line: 451, baseType: !383, size: 32, offset: 15808)
!7672 = !DIDerivedType(tag: DW_TAG_member, name: "saved_config_space", scope: !7490, file: !7469, line: 453, baseType: !7673, size: 512, offset: 15840)
!7673 = !DICompositeType(tag: DW_TAG_array_type, baseType: !987, size: 512, elements: !269)
!7674 = !DIDerivedType(tag: DW_TAG_member, name: "saved_cap_space", scope: !7490, file: !7469, line: 454, baseType: !1581, size: 64, offset: 16384)
!7675 = !DIDerivedType(tag: DW_TAG_member, name: "rom_attr", scope: !7490, file: !7469, line: 455, baseType: !6171, size: 64, offset: 16448)
!7676 = !DIDerivedType(tag: DW_TAG_member, name: "rom_attr_enabled", scope: !7490, file: !7469, line: 456, baseType: !32, size: 32, offset: 16512)
!7677 = !DIDerivedType(tag: DW_TAG_member, name: "res_attr", scope: !7490, file: !7469, line: 457, baseType: !7678, size: 1088, offset: 16576)
!7678 = !DICompositeType(tag: DW_TAG_array_type, baseType: !6171, size: 1088, elements: !7630)
!7679 = !DIDerivedType(tag: DW_TAG_member, name: "res_attr_wc", scope: !7490, file: !7469, line: 458, baseType: !7678, size: 1088, offset: 17664)
!7680 = !DIDerivedType(tag: DW_TAG_member, name: "msi_irq_groups", scope: !7490, file: !7469, line: 469, baseType: !6157, size: 64, offset: 18752)
!7681 = !DIDerivedType(tag: DW_TAG_member, name: "vpd", scope: !7490, file: !7469, line: 471, baseType: !7682, size: 64, offset: 18816)
!7682 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7683, size: 64)
!7683 = !DICompositeType(tag: DW_TAG_structure_type, name: "pci_vpd", file: !7469, line: 304, flags: DIFlagFwdDecl)
!7684 = !DIDerivedType(tag: DW_TAG_member, scope: !7490, file: !7469, line: 478, baseType: !7685, size: 64, offset: 18880)
!7685 = distinct !DICompositeType(tag: DW_TAG_union_type, scope: !7490, file: !7469, line: 478, size: 64, elements: !7686)
!7686 = !{!7687, !7690}
!7687 = !DIDerivedType(tag: DW_TAG_member, name: "sriov", scope: !7685, file: !7469, line: 479, baseType: !7688, size: 64)
!7688 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7689, size: 64)
!7689 = !DICompositeType(tag: DW_TAG_structure_type, name: "pci_sriov", file: !7469, line: 305, flags: DIFlagFwdDecl)
!7690 = !DIDerivedType(tag: DW_TAG_member, name: "physfn", scope: !7685, file: !7469, line: 480, baseType: !7489, size: 64)
!7691 = !DIDerivedType(tag: DW_TAG_member, name: "ats_cap", scope: !7490, file: !7469, line: 482, baseType: !581, size: 16, offset: 18944)
!7692 = !DIDerivedType(tag: DW_TAG_member, name: "ats_stu", scope: !7490, file: !7469, line: 483, baseType: !794, size: 8, offset: 18960)
!7693 = !DIDerivedType(tag: DW_TAG_member, name: "acs_cap", scope: !7490, file: !7469, line: 497, baseType: !581, size: 16, offset: 18976)
!7694 = !DIDerivedType(tag: DW_TAG_member, name: "rom", scope: !7490, file: !7469, line: 498, baseType: !4045, size: 64, offset: 19008)
!7695 = !DIDerivedType(tag: DW_TAG_member, name: "romlen", scope: !7490, file: !7469, line: 499, baseType: !1039, size: 64, offset: 19072)
!7696 = !DIDerivedType(tag: DW_TAG_member, name: "driver_override", scope: !7490, file: !7469, line: 500, baseType: !1038, size: 64, offset: 19136)
!7697 = !DIDerivedType(tag: DW_TAG_member, name: "priv_flags", scope: !7490, file: !7469, line: 502, baseType: !312, size: 64, offset: 19200)
!7698 = !DIDerivedType(tag: DW_TAG_member, name: "remove", scope: !7468, file: !7469, line: 863, baseType: !7699, size: 64, offset: 320)
!7699 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7700, size: 64)
!7700 = !DISubroutineType(types: !7701)
!7701 = !{null, !7489}
!7702 = !DIDerivedType(tag: DW_TAG_member, name: "suspend", scope: !7468, file: !7469, line: 864, baseType: !7703, size: 64, offset: 384)
!7703 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7704, size: 64)
!7704 = !DISubroutineType(types: !7705)
!7705 = !{!32, !7489, !6661}
!7706 = !DIDerivedType(tag: DW_TAG_member, name: "resume", scope: !7468, file: !7469, line: 865, baseType: !7707, size: 64, offset: 448)
!7707 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7708, size: 64)
!7708 = !DISubroutineType(types: !7709)
!7709 = !{!32, !7489}
!7710 = !DIDerivedType(tag: DW_TAG_member, name: "shutdown", scope: !7468, file: !7469, line: 866, baseType: !7699, size: 64, offset: 512)
!7711 = !DIDerivedType(tag: DW_TAG_member, name: "sriov_configure", scope: !7468, file: !7469, line: 867, baseType: !7712, size: 64, offset: 576)
!7712 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7713, size: 64)
!7713 = !DISubroutineType(types: !7714)
!7714 = !{!32, !7489, !32}
!7715 = !DIDerivedType(tag: DW_TAG_member, name: "err_handler", scope: !7468, file: !7469, line: 868, baseType: !7716, size: 64, offset: 640)
!7716 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7717, size: 64)
!7717 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !7718)
!7718 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_error_handlers", file: !7469, line: 795, size: 384, elements: !7719)
!7719 = !{!7720, !7725, !7729, !7730, !7731, !7732}
!7720 = !DIDerivedType(tag: DW_TAG_member, name: "error_detected", scope: !7718, file: !7469, line: 797, baseType: !7721, size: 64)
!7721 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7722, size: 64)
!7722 = !DISubroutineType(types: !7723)
!7723 = !{!7724, !7489, !7624}
!7724 = !DIDerivedType(tag: DW_TAG_typedef, name: "pci_ers_result_t", file: !7469, line: 772, baseType: !7)
!7725 = !DIDerivedType(tag: DW_TAG_member, name: "mmio_enabled", scope: !7718, file: !7469, line: 801, baseType: !7726, size: 64, offset: 64)
!7726 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7727, size: 64)
!7727 = !DISubroutineType(types: !7728)
!7728 = !{!7724, !7489}
!7729 = !DIDerivedType(tag: DW_TAG_member, name: "slot_reset", scope: !7718, file: !7469, line: 804, baseType: !7726, size: 64, offset: 128)
!7730 = !DIDerivedType(tag: DW_TAG_member, name: "reset_prepare", scope: !7718, file: !7469, line: 807, baseType: !7699, size: 64, offset: 192)
!7731 = !DIDerivedType(tag: DW_TAG_member, name: "reset_done", scope: !7718, file: !7469, line: 808, baseType: !7699, size: 64, offset: 256)
!7732 = !DIDerivedType(tag: DW_TAG_member, name: "resume", scope: !7718, file: !7469, line: 811, baseType: !7699, size: 64, offset: 320)
!7733 = !DIDerivedType(tag: DW_TAG_member, name: "groups", scope: !7468, file: !7469, line: 869, baseType: !6157, size: 64, offset: 704)
!7734 = !DIDerivedType(tag: DW_TAG_member, name: "driver", scope: !7468, file: !7469, line: 870, baseType: !6618, size: 1152, offset: 768)
!7735 = !DIDerivedType(tag: DW_TAG_member, name: "dynids", scope: !7468, file: !7469, line: 871, baseType: !7736, size: 128, offset: 1920)
!7736 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_dynids", file: !7469, line: 759, size: 128, elements: !7737)
!7737 = !{!7738, !7739}
!7738 = !DIDerivedType(tag: DW_TAG_member, name: "lock", scope: !7736, file: !7469, line: 760, baseType: !1670)
!7739 = !DIDerivedType(tag: DW_TAG_member, name: "list", scope: !7736, file: !7469, line: 761, baseType: !284, size: 128)
!7740 = !DIGlobalVariableExpression(var: !7741, expr: !DIExpression())
!7741 = distinct !DIGlobalVariable(name: "xlgmac_pci_tbl", scope: !2, file: !3, line: 60, type: !7742, isLocal: true, isDefinition: true)
!7742 = !DICompositeType(tag: DW_TAG_array_type, baseType: !7475, size: 512, elements: !2664)
!7743 = !DIGlobalVariableExpression(var: !7744, expr: !DIExpression())
!7744 = distinct !DIGlobalVariable(name: "___modver_attr", scope: !2, file: !3, line: 76, type: !7416, isLocal: true, isDefinition: true)
!7745 = !{i32 7, !"Dwarf Version", i32 4}
!7746 = !{i32 2, !"Debug Info Version", i32 3}
!7747 = !{i32 1, !"wchar_size", i32 2}
!7748 = !{i32 1, !"Code Model", i32 2}
!7749 = !{!"clang version 10.0.1 (https://github.com/llvm/llvm-project.git ef32c611aa214dea855364efd7ba451ec5ec3f74)"}
!7750 = distinct !DISubprogram(name: "xlgmac_pci_driver_init", scope: !3, file: !3, line: 73, type: !7751, scopeLine: 73, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !1587)
!7751 = !DISubroutineType(types: !7752)
!7752 = !{!32}
!7753 = !DILocation(line: 73, column: 1, scope: !7750)
!7754 = distinct !DISubprogram(name: "xlgmac_pci_driver_exit", scope: !3, file: !3, line: 73, type: !3809, scopeLine: 73, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !1587)
!7755 = !DILocation(line: 73, column: 1, scope: !7754)
!7756 = distinct !DISubprogram(name: "xlgmac_probe", scope: !3, file: !3, line: 25, type: !7487, scopeLine: 26, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !1587)
!7757 = !DILocalVariable(name: "pcidev", arg: 1, scope: !7756, file: !3, line: 25, type: !7489)
!7758 = !DILocation(line: 25, column: 41, scope: !7756)
!7759 = !DILocalVariable(name: "id", arg: 2, scope: !7756, file: !3, line: 25, type: !7474)
!7760 = !DILocation(line: 25, column: 77, scope: !7756)
!7761 = !DILocalVariable(name: "dev", scope: !7756, file: !3, line: 27, type: !6545)
!7762 = !DILocation(line: 27, column: 17, scope: !7756)
!7763 = !DILocation(line: 27, column: 24, scope: !7756)
!7764 = !DILocation(line: 27, column: 32, scope: !7756)
!7765 = !DILocalVariable(name: "res", scope: !7756, file: !3, line: 28, type: !7766)
!7766 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "xlgmac_resources", file: !7767, line: 537, size: 128, elements: !7768)
!7767 = !DIFile(filename: "drivers/net/ethernet/synopsys/dwc-xlgmac.h", directory: "/home/lizy2001/genbc/linux")
!7768 = !{!7769, !7770}
!7769 = !DIDerivedType(tag: DW_TAG_member, name: "addr", scope: !7766, file: !7767, line: 538, baseType: !591, size: 64)
!7770 = !DIDerivedType(tag: DW_TAG_member, name: "irq", scope: !7766, file: !7767, line: 539, baseType: !32, size: 32, offset: 64)
!7771 = !DILocation(line: 28, column: 26, scope: !7756)
!7772 = !DILocalVariable(name: "i", scope: !7756, file: !3, line: 29, type: !32)
!7773 = !DILocation(line: 29, column: 6, scope: !7756)
!7774 = !DILocalVariable(name: "ret", scope: !7756, file: !3, line: 29, type: !32)
!7775 = !DILocation(line: 29, column: 9, scope: !7756)
!7776 = !DILocation(line: 31, column: 27, scope: !7756)
!7777 = !DILocation(line: 31, column: 8, scope: !7756)
!7778 = !DILocation(line: 31, column: 6, scope: !7756)
!7779 = !DILocation(line: 32, column: 6, scope: !7780)
!7780 = distinct !DILexicalBlock(scope: !7756, file: !3, line: 32, column: 6)
!7781 = !DILocation(line: 32, column: 6, scope: !7756)
!7782 = !DILocation(line: 33, column: 3, scope: !7783)
!7783 = distinct !DILexicalBlock(scope: !7780, file: !3, line: 32, column: 11)
!7784 = !DILocation(line: 34, column: 10, scope: !7783)
!7785 = !DILocation(line: 34, column: 3, scope: !7783)
!7786 = !DILocation(line: 37, column: 9, scope: !7787)
!7787 = distinct !DILexicalBlock(scope: !7756, file: !3, line: 37, column: 2)
!7788 = !DILocation(line: 37, column: 7, scope: !7787)
!7789 = !DILocation(line: 37, column: 14, scope: !7790)
!7790 = distinct !DILexicalBlock(scope: !7787, file: !3, line: 37, column: 2)
!7791 = !DILocation(line: 37, column: 16, scope: !7790)
!7792 = !DILocation(line: 37, column: 2, scope: !7787)
!7793 = !DILocation(line: 38, column: 7, scope: !7794)
!7794 = distinct !DILexicalBlock(scope: !7795, file: !3, line: 38, column: 7)
!7795 = distinct !DILexicalBlock(scope: !7790, file: !3, line: 37, column: 41)
!7796 = !DILocation(line: 38, column: 35, scope: !7794)
!7797 = !DILocation(line: 38, column: 7, scope: !7795)
!7798 = !DILocation(line: 39, column: 4, scope: !7794)
!7799 = !DILocation(line: 40, column: 28, scope: !7795)
!7800 = !DILocation(line: 40, column: 36, scope: !7795)
!7801 = !DILocation(line: 40, column: 9, scope: !7795)
!7802 = !DILocation(line: 40, column: 7, scope: !7795)
!7803 = !DILocation(line: 41, column: 7, scope: !7804)
!7804 = distinct !DILexicalBlock(scope: !7795, file: !3, line: 41, column: 7)
!7805 = !DILocation(line: 41, column: 7, scope: !7795)
!7806 = !DILocation(line: 42, column: 11, scope: !7804)
!7807 = !DILocation(line: 42, column: 4, scope: !7804)
!7808 = !DILocation(line: 43, column: 3, scope: !7795)
!7809 = !DILocation(line: 37, column: 37, scope: !7790)
!7810 = !DILocation(line: 37, column: 2, scope: !7790)
!7811 = distinct !{!7811, !7792, !7812}
!7812 = !DILocation(line: 44, column: 2, scope: !7787)
!7813 = !DILocation(line: 46, column: 17, scope: !7756)
!7814 = !DILocation(line: 46, column: 2, scope: !7756)
!7815 = !DILocation(line: 48, column: 2, scope: !7756)
!7816 = !DILocation(line: 49, column: 12, scope: !7756)
!7817 = !DILocation(line: 49, column: 20, scope: !7756)
!7818 = !DILocation(line: 49, column: 6, scope: !7756)
!7819 = !DILocation(line: 49, column: 10, scope: !7756)
!7820 = !DILocation(line: 50, column: 30, scope: !7756)
!7821 = !DILocation(line: 50, column: 13, scope: !7756)
!7822 = !DILocation(line: 50, column: 38, scope: !7756)
!7823 = !DILocation(line: 50, column: 6, scope: !7756)
!7824 = !DILocation(line: 50, column: 11, scope: !7756)
!7825 = !DILocation(line: 52, column: 27, scope: !7756)
!7826 = !DILocation(line: 52, column: 35, scope: !7756)
!7827 = !DILocation(line: 52, column: 9, scope: !7756)
!7828 = !DILocation(line: 52, column: 2, scope: !7756)
!7829 = !DILocation(line: 53, column: 1, scope: !7756)
!7830 = distinct !DISubprogram(name: "xlgmac_remove", scope: !3, file: !3, line: 55, type: !7700, scopeLine: 56, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !1587)
!7831 = !DILocalVariable(name: "pcidev", arg: 1, scope: !7830, file: !3, line: 55, type: !7489)
!7832 = !DILocation(line: 55, column: 43, scope: !7830)
!7833 = !DILocation(line: 57, column: 21, scope: !7830)
!7834 = !DILocation(line: 57, column: 29, scope: !7830)
!7835 = !DILocation(line: 57, column: 2, scope: !7830)
!7836 = !DILocation(line: 58, column: 1, scope: !7830)
