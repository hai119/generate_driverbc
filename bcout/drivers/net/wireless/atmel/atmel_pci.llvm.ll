; ModuleID = '../bcout/drivers/net/wireless/atmel/atmel_pci.llvm.bc'
source_filename = "drivers/net/wireless/atmel/atmel_pci.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_atmel_driver_init6:\09\09\09"
module asm ".long\09atmel_driver_init - .\09\09\09"
...
@__UNIQUE_ID_author315 = internal constant [30 x i8] c"atmel_pci.author=Simon Kelley\00", section ".modinfo", align 1, !dbg !0
@__UNIQUE_ID_description316 = internal constant [81 x i8] c"atmel_pci.description=Support for Atmel at76c50x 802.11 wireless ethernet cards.\00", section ".modinfo", align 1, !dbg !7066
@__UNIQUE_ID_file317 = internal constant [52 x i8] c"atmel_pci.file=drivers/net/wireless/atmel/atmel_pci\00", section ".modinfo", align 1, !dbg !7071
@__UNIQUE_ID_license318 = internal constant [22 x i8] c"atmel_pci.license=GPL\00", section ".modinfo", align 1, !dbg !7074
@__UNIQUE_ID___addressable_atmel_driver_init319 = internal global i8* bitcast (i32 ()* @atmel_driver_init to i8*), section ".discard.addressable", align 8, !dbg !7079
@atmel_driver = internal global %struct.pci_driver { %struct.list_head zeroinitializer, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i32 0, i32 0), %struct.pci_device_id* getelementptr inbounds ([2 x %struct.pci_device_id], [2 x %struct.pci_device_id]* @card_ids, i32 0, i32 0), i32 (%struct.pci_dev*, %struct.pci_device_id*)* @atmel_pci_probe, void (%struct.pci_dev*)* @atmel_pci_remove, i32 (%struct.pci_dev*, i32)* null, i32 (%struct.pci_dev*)* null, void (%struct.pci_dev*)* null, i32 (%struct.pci_dev*, i32)* null, %struct.pci_error_handlers* null, %struct.attribute_group** null, %struct.device_driver zeroinitializer, %struct.pci_dynids zeroinitializer }, align 8, !dbg !7086
@__exitcall_atmel_driver_exit = internal global void ()* @atmel_driver_exit, section ".exitcall.exit", align 8, !dbg !7081
@.str = private unnamed_addr constant [10 x i8] c"atmel_pci\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"atmel\00", align 1
@card_ids = internal constant [2 x %struct.pci_device_id] [%struct.pci_device_id { i32 4372, i32 1286, i32 -1, i32 -1, i32 0, i32 0, i64 0 }, %struct.pci_device_id zeroinitializer], align 16, !dbg !7360
@llvm.used = appending global [7 x i8*] [i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__UNIQUE_ID_author315, i32 0, i32 0), i8* getelementptr inbounds ([81 x i8], [81 x i8]* @__UNIQUE_ID_description316, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @__UNIQUE_ID_file317, i32 0, i32 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__UNIQUE_ID_license318, i32 0, i32 0), i8* bitcast (i8** @__UNIQUE_ID___addressable_atmel_driver_init319 to i8*), i8* bitcast (void ()* @atmel_driver_exit to i8*), i8* bitcast (void ()** @__exitcall_atmel_driver_exit to i8*)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @atmel_driver_init() #0 section ".init.text" !dbg !7371 {
entry:
  %call = call i32 @__pci_register_driver(%struct.pci_driver* @atmel_driver, %struct.module* null, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0)) #4, !dbg !7374
  ret i32 %call, !dbg !7374
}

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @atmel_driver_exit() #0 section ".exit.text" !dbg !7375 {
entry:
  call void @pci_unregister_driver(%struct.pci_driver* @atmel_driver) #4, !dbg !7376
  ret void, !dbg !7376
}
...
define internal i32 @atmel_pci_probe(%struct.pci_dev* %pdev, %struct.pci_device_id* %pent) #2 !dbg !7377 {
entry:
  %retval = alloca i32, align 4
  %pdev.addr = alloca %struct.pci_dev*, align 8
  %pent.addr = alloca %struct.pci_device_id*, align 8
  %dev = alloca %struct.net_device*, align 8
  store %struct.pci_dev* %pdev, %struct.pci_dev** %pdev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.pci_dev** %pdev.addr, metadata !7378, metadata !DIExpression()), !dbg !7379
  store %struct.pci_device_id* %pent, %struct.pci_device_id** %pent.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.pci_device_id** %pent.addr, metadata !7380, metadata !DIExpression()), !dbg !7381
  call void @llvm.dbg.declare(metadata %struct.net_device** %dev, metadata !7382, metadata !DIExpression()), !dbg !7383
  %0 = load %struct.pci_dev*, %struct.pci_dev** %pdev.addr, align 8, !dbg !7384
  %call = call i32 @pci_enable_device(%struct.pci_dev* %0) #4, !dbg !7386
  %tobool = icmp ne i32 %call, 0, !dbg !7386
  br i1 %tobool, label %if.then, label %if.end, !dbg !7387

if.then:                                          ; preds = %entry
  store i32 -19, i32* %retval, align 4, !dbg !7388
  br label %return, !dbg !7388

if.end:                                           ; preds = %entry
  %1 = load %struct.pci_dev*, %struct.pci_dev** %pdev.addr, align 8, !dbg !7389
  call void @pci_set_master(%struct.pci_dev* %1) #4, !dbg !7390
  %2 = load %struct.pci_dev*, %struct.pci_dev** %pdev.addr, align 8, !dbg !7391
  %irq = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %2, i32 0, i32 43, !dbg !7392
  %3 = load i32, i32* %irq, align 4, !dbg !7392
  %conv = trunc i32 %3 to i16, !dbg !7391
  %4 = load %struct.pci_dev*, %struct.pci_dev** %pdev.addr, align 8, !dbg !7393
  %resource = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %4, i32 0, i32 44, !dbg !7394
  %arrayidx = getelementptr [17 x %struct.resource], [17 x %struct.resource]* %resource, i64 0, i64 1, !dbg !7393
  %start = getelementptr inbounds %struct.resource, %struct.resource* %arrayidx, i32 0, i32 0, !dbg !7395
  %5 = load i64, i64* %start, align 8, !dbg !7395
  %6 = load %struct.pci_dev*, %struct.pci_dev** %pdev.addr, align 8, !dbg !7396
  %dev1 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %6, i32 0, i32 41, !dbg !7397
  %call2 = call %struct.net_device* @init_atmel_card(i16 zeroext %conv, i64 %5, i32 8, %struct.device* %dev1, i32 (i8*)* null, i8* null) #4, !dbg !7398
  store %struct.net_device* %call2, %struct.net_device** %dev, align 8, !dbg !7399
  %7 = load %struct.net_device*, %struct.net_device** %dev, align 8, !dbg !7400
  %tobool3 = icmp ne %struct.net_device* %7, null, !dbg !7400
  br i1 %tobool3, label %if.end5, label %if.then4, !dbg !7402

if.then4:                                         ; preds = %if.end
  %8 = load %struct.pci_dev*, %struct.pci_dev** %pdev.addr, align 8, !dbg !7403
  call void @pci_disable_device(%struct.pci_dev* %8) #4, !dbg !7405
  store i32 -19, i32* %retval, align 4, !dbg !7406
  br label %return, !dbg !7406

if.end5:                                          ; preds = %if.end
  %9 = load %struct.pci_dev*, %struct.pci_dev** %pdev.addr, align 8, !dbg !7407
  %10 = load %struct.net_device*, %struct.net_device** %dev, align 8, !dbg !7408
  %11 = bitcast %struct.net_device* %10 to i8*, !dbg !7408
  call void @pci_set_drvdata(%struct.pci_dev* %9, i8* %11) #4, !dbg !7409
  store i32 0, i32* %retval, align 4, !dbg !7410
  br label %return, !dbg !7410

return:                                           ; preds = %if.end5, %if.then4, %if.then
  %12 = load i32, i32* %retval, align 4, !dbg !7411
  ret i32 %12, !dbg !7411
}

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @atmel_pci_remove(%struct.pci_dev* %pdev) #2 !dbg !7412 {
entry:
  %pdev.addr = alloca %struct.pci_dev*, align 8
  store %struct.pci_dev* %pdev, %struct.pci_dev** %pdev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.pci_dev** %pdev.addr, metadata !7413, metadata !DIExpression()), !dbg !7414
  %0 = load %struct.pci_dev*, %struct.pci_dev** %pdev.addr, align 8, !dbg !7415
  %call = call i8* @pci_get_drvdata(%struct.pci_dev* %0) #4, !dbg !7416
  %1 = bitcast i8* %call to %struct.net_device*, !dbg !7416
  call void @stop_atmel_card(%struct.net_device* %1) #4, !dbg !7417
  ret void, !dbg !7418
}
...
; Function Attrs: noredzone
declare dso_local %struct.net_device* @init_atmel_card(i16 zeroext, i64, i32, %struct.device*, i32 (i8*)*, i8*) #1

; Function Attrs: noredzone
declare dso_local void @pci_disable_device(%struct.pci_dev*) #1

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @pci_set_drvdata(%struct.pci_dev* %pdev, i8* %data) #2 !dbg !7419 {
entry:
  %pdev.addr = alloca %struct.pci_dev*, align 8
  %data.addr = alloca i8*, align 8
  store %struct.pci_dev* %pdev, %struct.pci_dev** %pdev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.pci_dev** %pdev.addr, metadata !7422, metadata !DIExpression()), !dbg !7423
  store i8* %data, i8** %data.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %data.addr, metadata !7424, metadata !DIExpression()), !dbg !7425
  %0 = load %struct.pci_dev*, %struct.pci_dev** %pdev.addr, align 8, !dbg !7426
  %dev = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %0, i32 0, i32 41, !dbg !7427
  %1 = load i8*, i8** %data.addr, align 8, !dbg !7428
  call void @dev_set_drvdata(%struct.device* %dev, i8* %1) #4, !dbg !7429
  ret void, !dbg !7430
}

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @dev_set_drvdata(%struct.device* %dev, i8* %data) #2 !dbg !7431 {
entry:
  %dev.addr = alloca %struct.device*, align 8
  %data.addr = alloca i8*, align 8
  store %struct.device* %dev, %struct.device** %dev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.device** %dev.addr, metadata !7434, metadata !DIExpression()), !dbg !7435
  store i8* %data, i8** %data.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %data.addr, metadata !7436, metadata !DIExpression()), !dbg !7437
  %0 = load i8*, i8** %data.addr, align 8, !dbg !7438
  %1 = load %struct.device*, %struct.device** %dev.addr, align 8, !dbg !7439
  %driver_data = getelementptr inbounds %struct.device, %struct.device* %1, i32 0, i32 8, !dbg !7440
  store i8* %0, i8** %driver_data, align 8, !dbg !7441
  ret void, !dbg !7442
}

; Function Attrs: noredzone
declare dso_local void @stop_atmel_card(%struct.net_device*) #1

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal i8* @pci_get_drvdata(%struct.pci_dev* %pdev) #2 !dbg !7443 {
entry:
  %pdev.addr = alloca %struct.pci_dev*, align 8
  store %struct.pci_dev* %pdev, %struct.pci_dev** %pdev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.pci_dev** %pdev.addr, metadata !7446, metadata !DIExpression()), !dbg !7447
  %0 = load %struct.pci_dev*, %struct.pci_dev** %pdev.addr, align 8, !dbg !7448
  %dev = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %0, i32 0, i32 41, !dbg !7449
  %call = call i8* @dev_get_drvdata(%struct.device* %dev) #4, !dbg !7450
  ret i8* %call, !dbg !7451
}

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal i8* @dev_get_drvdata(%struct.device* %dev) #2 !dbg !7452 {
entry:
  %dev.addr = alloca %struct.device*, align 8
  store %struct.device* %dev, %struct.device** %dev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.device** %dev.addr, metadata !7455, metadata !DIExpression()), !dbg !7456
  %0 = load %struct.device*, %struct.device** %dev.addr, align 8, !dbg !7457
  %driver_data = getelementptr inbounds %struct.device, %struct.device* %0, i32 0, i32 8, !dbg !7458
  %1 = load i8*, i8** %driver_data, align 8, !dbg !7458
  ret i8* %1, !dbg !7459
}
...
!llvm.dbg.cu = !{!2}
!llvm.module.flags = !{!7366, !7367, !7368, !7369}
!llvm.ident = !{!7370}

!0 = !DIGlobalVariableExpression(var: !1, expr: !DIExpression())
!1 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author315", scope: !2, file: !3, line: 16, type: !7363, isLocal: true, isDefinition: true, align: 8)
!2 = distinct !DICompileUnit(language: DW_LANG_C89, file: !3, producer: "clang version 10.0.1 (https://github.com/llvm/llvm-project.git ef32c611aa214dea855364efd7ba451ec5ec3f74)", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !7064, globals: !7065, splitDebugInlining: false, nameTableKind: None)
!3 = !DIFile(filename: "drivers/net/wireless/atmel/atmel_pci.c", directory: "/home/lizy2001/genbc/linux")
!4 = !{!5, !13, !19, !24, !30, !37, !57, !64, !95, !129, !170, !177, !208, !221, !229, !235, !242, !246, !250, !257, !263, !6491, !4289, !4384, !5051, !5070, !6198, !6627, !6707, !6783, !6791, !7052}
...
!981 = !DICompositeType(tag: DW_TAG_structure_type, name: "module", file: !982, line: 189, flags: DIFlagFwdDecl)
!982 = !DIFile(filename: "./include/linux/jump_label.h", directory: "/home/lizy2001/genbc/linux")
...
!7052 = !DICompositeType(tag: DW_TAG_enumeration_type, file: !7053, line: 14, baseType: !7, size: 32, elements: !7054)
!7053 = !DIFile(filename: "drivers/net/wireless/atmel/atmel.h", directory: "/home/lizy2001/genbc/linux")
!7054 = !{!7055, !7056, !7057, !7058, !7059, !7060, !7061, !7062, !7063}
!7055 = !DIEnumerator(name: "ATMEL_FW_TYPE_NONE", value: 0, isUnsigned: true)
!7056 = !DIEnumerator(name: "ATMEL_FW_TYPE_502", value: 1, isUnsigned: true)
!7057 = !DIEnumerator(name: "ATMEL_FW_TYPE_502D", value: 2, isUnsigned: true)
!7058 = !DIEnumerator(name: "ATMEL_FW_TYPE_502E", value: 3, isUnsigned: true)
!7059 = !DIEnumerator(name: "ATMEL_FW_TYPE_502_3COM", value: 4, isUnsigned: true)
!7060 = !DIEnumerator(name: "ATMEL_FW_TYPE_504", value: 5, isUnsigned: true)
!7061 = !DIEnumerator(name: "ATMEL_FW_TYPE_504_2958", value: 6, isUnsigned: true)
!7062 = !DIEnumerator(name: "ATMEL_FW_TYPE_504A_2958", value: 7, isUnsigned: true)
!7063 = !DIEnumerator(name: "ATMEL_FW_TYPE_506", value: 8, isUnsigned: true)
!7064 = !{!980, !591}
!7065 = !{!0, !7066, !7071, !7074, !7079, !7081, !7086, !7360}
!7066 = !DIGlobalVariableExpression(var: !7067, expr: !DIExpression())
!7067 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_description316", scope: !2, file: !3, line: 17, type: !7068, isLocal: true, isDefinition: true, align: 8)
!7068 = !DICompositeType(tag: DW_TAG_array_type, baseType: !293, size: 648, elements: !7069)
!7069 = !{!7070}
!7070 = !DISubrange(count: 81)
!7071 = !DIGlobalVariableExpression(var: !7072, expr: !DIExpression())
!7072 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file317", scope: !2, file: !3, line: 18, type: !7073, isLocal: true, isDefinition: true, align: 8)
!7073 = !DICompositeType(tag: DW_TAG_array_type, baseType: !293, size: 416, elements: !5808)
!7074 = !DIGlobalVariableExpression(var: !7075, expr: !DIExpression())
!7075 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license318", scope: !2, file: !3, line: 18, type: !7076, isLocal: true, isDefinition: true, align: 8)
!7076 = !DICompositeType(tag: DW_TAG_array_type, baseType: !293, size: 176, elements: !7077)
!7077 = !{!7078}
!7078 = !DISubrange(count: 22)
!7079 = !DIGlobalVariableExpression(var: !7080, expr: !DIExpression())
!7080 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_atmel_driver_init319", scope: !2, file: !3, line: 66, type: !591, isLocal: true, isDefinition: true)
!7081 = !DIGlobalVariableExpression(var: !7082, expr: !DIExpression())
!7082 = distinct !DIGlobalVariable(name: "__exitcall_atmel_driver_exit", scope: !2, file: !3, line: 66, type: !7083, isLocal: true, isDefinition: true)
!7083 = !DIDerivedType(tag: DW_TAG_typedef, name: "exitcall_t", file: !7084, line: 117, baseType: !7085)
!7084 = !DIFile(filename: "./include/linux/init.h", directory: "/home/lizy2001/genbc/linux")
!7085 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !3809, size: 64)
!7086 = !DIGlobalVariableExpression(var: !7087, expr: !DIExpression())
!7087 = distinct !DIGlobalVariable(name: "atmel_driver", scope: !2, file: !3, line: 31, type: !7088, isLocal: true, isDefinition: true)
!7088 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_driver", file: !7089, line: 858, size: 2048, elements: !7090)
!7089 = !DIFile(filename: "./include/linux/pci.h", directory: "/home/lizy2001/genbc/linux")
!7090 = !{!7091, !7092, !7093, !7105, !7318, !7322, !7326, !7330, !7331, !7335, !7353, !7354, !7355}
!7091 = !DIDerivedType(tag: DW_TAG_member, name: "node", scope: !7088, file: !7089, line: 859, baseType: !284, size: 128)
!7092 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !7088, file: !7089, line: 860, baseType: !292, size: 64, offset: 128)
!7093 = !DIDerivedType(tag: DW_TAG_member, name: "id_table", scope: !7088, file: !7089, line: 861, baseType: !7094, size: 64, offset: 192)
!7094 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7095, size: 64)
!7095 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !7096)
!7096 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_device_id", file: !6636, line: 38, size: 256, elements: !7097)
!7097 = !{!7098, !7099, !7100, !7101, !7102, !7103, !7104}
!7098 = !DIDerivedType(tag: DW_TAG_member, name: "vendor", scope: !7096, file: !6636, line: 39, baseType: !493, size: 32)
!7099 = !DIDerivedType(tag: DW_TAG_member, name: "device", scope: !7096, file: !6636, line: 39, baseType: !493, size: 32, offset: 32)
!7100 = !DIDerivedType(tag: DW_TAG_member, name: "subvendor", scope: !7096, file: !6636, line: 40, baseType: !493, size: 32, offset: 64)
!7101 = !DIDerivedType(tag: DW_TAG_member, name: "subdevice", scope: !7096, file: !6636, line: 40, baseType: !493, size: 32, offset: 96)
!7102 = !DIDerivedType(tag: DW_TAG_member, name: "class", scope: !7096, file: !6636, line: 41, baseType: !493, size: 32, offset: 128)
!7103 = !DIDerivedType(tag: DW_TAG_member, name: "class_mask", scope: !7096, file: !6636, line: 41, baseType: !493, size: 32, offset: 160)
!7104 = !DIDerivedType(tag: DW_TAG_member, name: "driver_data", scope: !7096, file: !6636, line: 42, baseType: !6650, size: 64, offset: 192)
!7105 = !DIDerivedType(tag: DW_TAG_member, name: "probe", scope: !7088, file: !7089, line: 862, baseType: !7106, size: 64, offset: 256)
...
!7110 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_dev", file: !7089, line: 309, size: 19264, elements: !7111)
!7111 = !{!7112, !7113, !7182, !7183, !7184, !7185, !7196, !7197, !7198, !7199, !7200, !7201, !7202, !7203, !7204, !7205, !7206, !7207, !7208, !7209, !7210, !7211, !7212, !7214, !7215, !7216, !7218, !7219, !7220, !7221, !7222, !7223, !7224, !7225, !7226, !7227, !7228, !7229, !7230, !7231, !7232, !7233, !7234, !7235, !7236, !7237, !7240, !7241, !7242, !7243, !7245, !7246, !7247, !7248, !7252, !7253, !7254, !7255, !7256, !7257, !7258, !7259, !7260, !7261, !7262, !7263, !7264, !7265, !7266, !7267, !7268, !7269, !7270, !7271, !7272, !7273, !7274, !7275, !7276, !7277, !7278, !7279, !7280, !7281, !7282, !7283, !7284, !7285, !7286, !7287, !7288, !7289, !7291, !7292, !7294, !7295, !7296, !7297, !7299, !7300, !7301, !7304, !7311, !7312, !7313, !7314, !7315, !7316, !7317}
!7112 = !DIDerivedType(tag: DW_TAG_member, name: "bus_list", scope: !7110, file: !7089, line: 310, baseType: !284, size: 128)
!7113 = !DIDerivedType(tag: DW_TAG_member, name: "bus", scope: !7110, file: !7089, line: 311, baseType: !7114, size: 64, offset: 128)
!7114 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7115, size: 64)
!7115 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_bus", file: !7089, line: 605, size: 8064, elements: !7116)
!7116 = !{!7117, !7118, !7119, !7120, !7121, !7122, !7123, !7138, !7139, !7140, !7164, !7167, !7168, !7169, !7170, !7171, !7172, !7173, !7174, !7175, !7177, !7178, !7179, !7180, !7181}
!7117 = !DIDerivedType(tag: DW_TAG_member, name: "node", scope: !7115, file: !7089, line: 606, baseType: !284, size: 128)
!7118 = !DIDerivedType(tag: DW_TAG_member, name: "parent", scope: !7115, file: !7089, line: 607, baseType: !7114, size: 64, offset: 128)
!7119 = !DIDerivedType(tag: DW_TAG_member, name: "children", scope: !7115, file: !7089, line: 608, baseType: !284, size: 128, offset: 192)
!7120 = !DIDerivedType(tag: DW_TAG_member, name: "devices", scope: !7115, file: !7089, line: 609, baseType: !284, size: 128, offset: 320)
!7121 = !DIDerivedType(tag: DW_TAG_member, name: "self", scope: !7115, file: !7089, line: 610, baseType: !7109, size: 64, offset: 448)
!7122 = !DIDerivedType(tag: DW_TAG_member, name: "slots", scope: !7115, file: !7089, line: 611, baseType: !284, size: 128, offset: 512)
!7123 = !DIDerivedType(tag: DW_TAG_member, name: "resource", scope: !7115, file: !7089, line: 613, baseType: !7124, size: 256, offset: 640)
!7124 = !DICompositeType(tag: DW_TAG_array_type, baseType: !7125, size: 256, elements: !2272)
!7125 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7126, size: 64)
!7126 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "resource", file: !7127, line: 20, size: 512, elements: !7128)
!7127 = !DIFile(filename: "./include/linux/ioport.h", directory: "/home/lizy2001/genbc/linux")
!7128 = !{!7129, !7131, !7132, !7133, !7134, !7135, !7136, !7137}
!7129 = !DIDerivedType(tag: DW_TAG_member, name: "start", scope: !7126, file: !7127, line: 21, baseType: !7130, size: 64)
!7130 = !DIDerivedType(tag: DW_TAG_typedef, name: "resource_size_t", file: !277, line: 158, baseType: !4045)
!7131 = !DIDerivedType(tag: DW_TAG_member, name: "end", scope: !7126, file: !7127, line: 22, baseType: !7130, size: 64, offset: 64)
!7132 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !7126, file: !7127, line: 23, baseType: !292, size: 64, offset: 128)
!7133 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !7126, file: !7127, line: 24, baseType: !312, size: 64, offset: 192)
!7134 = !DIDerivedType(tag: DW_TAG_member, name: "desc", scope: !7126, file: !7127, line: 25, baseType: !312, size: 64, offset: 256)
!7135 = !DIDerivedType(tag: DW_TAG_member, name: "parent", scope: !7126, file: !7127, line: 26, baseType: !7125, size: 64, offset: 320)
!7136 = !DIDerivedType(tag: DW_TAG_member, name: "sibling", scope: !7126, file: !7127, line: 26, baseType: !7125, size: 64, offset: 384)
!7137 = !DIDerivedType(tag: DW_TAG_member, name: "child", scope: !7126, file: !7127, line: 26, baseType: !7125, size: 64, offset: 448)
!7138 = !DIDerivedType(tag: DW_TAG_member, name: "resources", scope: !7115, file: !7089, line: 614, baseType: !284, size: 128, offset: 896)
!7139 = !DIDerivedType(tag: DW_TAG_member, name: "busn_res", scope: !7115, file: !7089, line: 615, baseType: !7126, size: 512, offset: 1024)
!7140 = !DIDerivedType(tag: DW_TAG_member, name: "ops", scope: !7115, file: !7089, line: 617, baseType: !7141, size: 64, offset: 1536)
!7141 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7142, size: 64)
!7142 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_ops", file: !7089, line: 731, size: 320, elements: !7143)
!7143 = !{!7144, !7148, !7152, !7156, !7160}
!7144 = !DIDerivedType(tag: DW_TAG_member, name: "add_bus", scope: !7142, file: !7089, line: 732, baseType: !7145, size: 64)
!7145 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7146, size: 64)
!7146 = !DISubroutineType(types: !7147)
!7147 = !{!32, !7114}
!7148 = !DIDerivedType(tag: DW_TAG_member, name: "remove_bus", scope: !7142, file: !7089, line: 733, baseType: !7149, size: 64, offset: 64)
!7149 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7150, size: 64)
!7150 = !DISubroutineType(types: !7151)
!7151 = !{null, !7114}
!7152 = !DIDerivedType(tag: DW_TAG_member, name: "map_bus", scope: !7142, file: !7089, line: 734, baseType: !7153, size: 64, offset: 128)
!7153 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7154, size: 64)
!7154 = !DISubroutineType(types: !7155)
!7155 = !{!591, !7114, !7, !32}
!7156 = !DIDerivedType(tag: DW_TAG_member, name: "read", scope: !7142, file: !7089, line: 735, baseType: !7157, size: 64, offset: 192)
!7157 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7158, size: 64)
!7158 = !DISubroutineType(types: !7159)
!7159 = !{!32, !7114, !7, !32, !32, !2516}
!7160 = !DIDerivedType(tag: DW_TAG_member, name: "write", scope: !7142, file: !7089, line: 736, baseType: !7161, size: 64, offset: 256)
!7161 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7162, size: 64)
!7162 = !DISubroutineType(types: !7163)
!7163 = !{!32, !7114, !7, !32, !32, !987}
!7164 = !DIDerivedType(tag: DW_TAG_member, name: "msi", scope: !7115, file: !7089, line: 618, baseType: !7165, size: 64, offset: 1600)
!7165 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7166, size: 64)
!7166 = !DICompositeType(tag: DW_TAG_structure_type, name: "msi_controller", file: !7089, line: 537, flags: DIFlagFwdDecl)
!7167 = !DIDerivedType(tag: DW_TAG_member, name: "sysdata", scope: !7115, file: !7089, line: 619, baseType: !591, size: 64, offset: 1664)
!7168 = !DIDerivedType(tag: DW_TAG_member, name: "procdir", scope: !7115, file: !7089, line: 620, baseType: !3010, size: 64, offset: 1728)
!7169 = !DIDerivedType(tag: DW_TAG_member, name: "number", scope: !7115, file: !7089, line: 622, baseType: !482, size: 8, offset: 1792)
!7170 = !DIDerivedType(tag: DW_TAG_member, name: "primary", scope: !7115, file: !7089, line: 623, baseType: !482, size: 8, offset: 1800)
!7171 = !DIDerivedType(tag: DW_TAG_member, name: "max_bus_speed", scope: !7115, file: !7089, line: 624, baseType: !482, size: 8, offset: 1808)
!7172 = !DIDerivedType(tag: DW_TAG_member, name: "cur_bus_speed", scope: !7115, file: !7089, line: 625, baseType: !482, size: 8, offset: 1816)
!7173 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !7115, file: !7089, line: 630, baseType: !457, size: 384, offset: 1824)
!7174 = !DIDerivedType(tag: DW_TAG_member, name: "bridge_ctl", scope: !7115, file: !7089, line: 632, baseType: !476, size: 16, offset: 2208)
!7175 = !DIDerivedType(tag: DW_TAG_member, name: "bus_flags", scope: !7115, file: !7089, line: 633, baseType: !7176, size: 16, offset: 2224)
!7176 = !DIDerivedType(tag: DW_TAG_typedef, name: "pci_bus_flags_t", file: !7089, line: 237, baseType: !476)
!7177 = !DIDerivedType(tag: DW_TAG_member, name: "bridge", scope: !7115, file: !7089, line: 634, baseType: !6545, size: 64, offset: 2240)
!7178 = !DIDerivedType(tag: DW_TAG_member, name: "dev", scope: !7115, file: !7089, line: 635, baseType: !6540, size: 5568, offset: 2304)
!7179 = !DIDerivedType(tag: DW_TAG_member, name: "legacy_io", scope: !7115, file: !7089, line: 636, baseType: !6171, size: 64, offset: 7872)
!7180 = !DIDerivedType(tag: DW_TAG_member, name: "legacy_mem", scope: !7115, file: !7089, line: 637, baseType: !6171, size: 64, offset: 7936)
!7181 = !DIDerivedType(tag: DW_TAG_member, name: "is_added", scope: !7115, file: !7089, line: 638, baseType: !7, size: 1, offset: 8000, flags: DIFlagBitField, extraData: i64 8000)
!7182 = !DIDerivedType(tag: DW_TAG_member, name: "subordinate", scope: !7110, file: !7089, line: 312, baseType: !7114, size: 64, offset: 192)
!7183 = !DIDerivedType(tag: DW_TAG_member, name: "sysdata", scope: !7110, file: !7089, line: 314, baseType: !591, size: 64, offset: 256)
!7184 = !DIDerivedType(tag: DW_TAG_member, name: "procent", scope: !7110, file: !7089, line: 315, baseType: !3010, size: 64, offset: 320)
!7185 = !DIDerivedType(tag: DW_TAG_member, name: "slot", scope: !7110, file: !7089, line: 316, baseType: !7186, size: 64, offset: 384)
!7186 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7187, size: 64)
!7187 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_slot", file: !7089, line: 69, size: 832, elements: !7188)
!7188 = !{!7189, !7190, !7191, !7194, !7195}
!7189 = !DIDerivedType(tag: DW_TAG_member, name: "bus", scope: !7187, file: !7089, line: 70, baseType: !7114, size: 64)
!7190 = !DIDerivedType(tag: DW_TAG_member, name: "list", scope: !7187, file: !7089, line: 71, baseType: !284, size: 128, offset: 64)
!7191 = !DIDerivedType(tag: DW_TAG_member, name: "hotplug", scope: !7187, file: !7089, line: 72, baseType: !7192, size: 64, offset: 192)
!7192 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7193, size: 64)
!7193 = !DICompositeType(tag: DW_TAG_structure_type, name: "hotplug_slot", file: !7089, line: 72, flags: DIFlagFwdDecl)
!7194 = !DIDerivedType(tag: DW_TAG_member, name: "number", scope: !7187, file: !7089, line: 73, baseType: !482, size: 8, offset: 256)
!7195 = !DIDerivedType(tag: DW_TAG_member, name: "kobj", scope: !7187, file: !7089, line: 74, baseType: !6120, size: 512, offset: 320)
!7196 = !DIDerivedType(tag: DW_TAG_member, name: "devfn", scope: !7110, file: !7089, line: 318, baseType: !7, size: 32, offset: 448)
!7197 = !DIDerivedType(tag: DW_TAG_member, name: "vendor", scope: !7110, file: !7089, line: 319, baseType: !476, size: 16, offset: 480)
!7198 = !DIDerivedType(tag: DW_TAG_member, name: "device", scope: !7110, file: !7089, line: 320, baseType: !476, size: 16, offset: 496)
!7199 = !DIDerivedType(tag: DW_TAG_member, name: "subsystem_vendor", scope: !7110, file: !7089, line: 321, baseType: !476, size: 16, offset: 512)
!7200 = !DIDerivedType(tag: DW_TAG_member, name: "subsystem_device", scope: !7110, file: !7089, line: 322, baseType: !476, size: 16, offset: 528)
!7201 = !DIDerivedType(tag: DW_TAG_member, name: "class", scope: !7110, file: !7089, line: 323, baseType: !7, size: 32, offset: 544)
!7202 = !DIDerivedType(tag: DW_TAG_member, name: "revision", scope: !7110, file: !7089, line: 324, baseType: !794, size: 8, offset: 576)
!7203 = !DIDerivedType(tag: DW_TAG_member, name: "hdr_type", scope: !7110, file: !7089, line: 325, baseType: !794, size: 8, offset: 584)
!7204 = !DIDerivedType(tag: DW_TAG_member, name: "pcie_cap", scope: !7110, file: !7089, line: 330, baseType: !794, size: 8, offset: 592)
!7205 = !DIDerivedType(tag: DW_TAG_member, name: "msi_cap", scope: !7110, file: !7089, line: 331, baseType: !794, size: 8, offset: 600)
!7206 = !DIDerivedType(tag: DW_TAG_member, name: "msix_cap", scope: !7110, file: !7089, line: 332, baseType: !794, size: 8, offset: 608)
!7207 = !DIDerivedType(tag: DW_TAG_member, name: "pcie_mpss", scope: !7110, file: !7089, line: 333, baseType: !794, size: 3, offset: 616, flags: DIFlagBitField, extraData: i64 616)
!7208 = !DIDerivedType(tag: DW_TAG_member, name: "rom_base_reg", scope: !7110, file: !7089, line: 334, baseType: !794, size: 8, offset: 624)
!7209 = !DIDerivedType(tag: DW_TAG_member, name: "pin", scope: !7110, file: !7089, line: 335, baseType: !794, size: 8, offset: 632)
!7210 = !DIDerivedType(tag: DW_TAG_member, name: "pcie_flags_reg", scope: !7110, file: !7089, line: 336, baseType: !581, size: 16, offset: 640)
!7211 = !DIDerivedType(tag: DW_TAG_member, name: "dma_alias_mask", scope: !7110, file: !7089, line: 337, baseType: !3439, size: 64, offset: 704)
!7212 = !DIDerivedType(tag: DW_TAG_member, name: "driver", scope: !7110, file: !7089, line: 339, baseType: !7213, size: 64, offset: 768)
!7213 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7088, size: 64)
!7214 = !DIDerivedType(tag: DW_TAG_member, name: "dma_mask", scope: !7110, file: !7089, line: 340, baseType: !331, size: 64, offset: 832)
!7215 = !DIDerivedType(tag: DW_TAG_member, name: "dma_parms", scope: !7110, file: !7089, line: 346, baseType: !6850, size: 128, offset: 896)
!7216 = !DIDerivedType(tag: DW_TAG_member, name: "current_state", scope: !7110, file: !7089, line: 348, baseType: !7217, size: 32, offset: 1024)
!7217 = !DIDerivedType(tag: DW_TAG_typedef, name: "pci_power_t", file: !7089, line: 155, baseType: !32)
!7218 = !DIDerivedType(tag: DW_TAG_member, name: "imm_ready", scope: !7110, file: !7089, line: 351, baseType: !7, size: 1, offset: 1056, flags: DIFlagBitField, extraData: i64 1056)
!7219 = !DIDerivedType(tag: DW_TAG_member, name: "pm_cap", scope: !7110, file: !7089, line: 352, baseType: !794, size: 8, offset: 1064)
!7220 = !DIDerivedType(tag: DW_TAG_member, name: "pme_support", scope: !7110, file: !7089, line: 353, baseType: !7, size: 5, offset: 1072, flags: DIFlagBitField, extraData: i64 1072)
!7221 = !DIDerivedType(tag: DW_TAG_member, name: "pme_poll", scope: !7110, file: !7089, line: 355, baseType: !7, size: 1, offset: 1077, flags: DIFlagBitField, extraData: i64 1072)
!7222 = !DIDerivedType(tag: DW_TAG_member, name: "d1_support", scope: !7110, file: !7089, line: 356, baseType: !7, size: 1, offset: 1078, flags: DIFlagBitField, extraData: i64 1072)
!7223 = !DIDerivedType(tag: DW_TAG_member, name: "d2_support", scope: !7110, file: !7089, line: 357, baseType: !7, size: 1, offset: 1079, flags: DIFlagBitField, extraData: i64 1072)
!7224 = !DIDerivedType(tag: DW_TAG_member, name: "no_d1d2", scope: !7110, file: !7089, line: 358, baseType: !7, size: 1, offset: 1080, flags: DIFlagBitField, extraData: i64 1072)
!7225 = !DIDerivedType(tag: DW_TAG_member, name: "no_d3cold", scope: !7110, file: !7089, line: 359, baseType: !7, size: 1, offset: 1081, flags: DIFlagBitField, extraData: i64 1072)
!7226 = !DIDerivedType(tag: DW_TAG_member, name: "bridge_d3", scope: !7110, file: !7089, line: 360, baseType: !7, size: 1, offset: 1082, flags: DIFlagBitField, extraData: i64 1072)
!7227 = !DIDerivedType(tag: DW_TAG_member, name: "d3cold_allowed", scope: !7110, file: !7089, line: 361, baseType: !7, size: 1, offset: 1083, flags: DIFlagBitField, extraData: i64 1072)
!7228 = !DIDerivedType(tag: DW_TAG_member, name: "mmio_always_on", scope: !7110, file: !7089, line: 362, baseType: !7, size: 1, offset: 1084, flags: DIFlagBitField, extraData: i64 1072)
!7229 = !DIDerivedType(tag: DW_TAG_member, name: "wakeup_prepared", scope: !7110, file: !7089, line: 364, baseType: !7, size: 1, offset: 1085, flags: DIFlagBitField, extraData: i64 1072)
!7230 = !DIDerivedType(tag: DW_TAG_member, name: "runtime_d3cold", scope: !7110, file: !7089, line: 365, baseType: !7, size: 1, offset: 1086, flags: DIFlagBitField, extraData: i64 1072)
!7231 = !DIDerivedType(tag: DW_TAG_member, name: "skip_bus_pm", scope: !7110, file: !7089, line: 369, baseType: !7, size: 1, offset: 1087, flags: DIFlagBitField, extraData: i64 1072)
!7232 = !DIDerivedType(tag: DW_TAG_member, name: "ignore_hotplug", scope: !7110, file: !7089, line: 370, baseType: !7, size: 1, offset: 1088, flags: DIFlagBitField, extraData: i64 1072)
!7233 = !DIDerivedType(tag: DW_TAG_member, name: "hotplug_user_indicators", scope: !7110, file: !7089, line: 371, baseType: !7, size: 1, offset: 1089, flags: DIFlagBitField, extraData: i64 1072)
!7234 = !DIDerivedType(tag: DW_TAG_member, name: "clear_retrain_link", scope: !7110, file: !7089, line: 374, baseType: !7, size: 1, offset: 1090, flags: DIFlagBitField, extraData: i64 1072)
!7235 = !DIDerivedType(tag: DW_TAG_member, name: "d3hot_delay", scope: !7110, file: !7089, line: 376, baseType: !7, size: 32, offset: 1120)
!7236 = !DIDerivedType(tag: DW_TAG_member, name: "d3cold_delay", scope: !7110, file: !7089, line: 377, baseType: !7, size: 32, offset: 1152)
!7237 = !DIDerivedType(tag: DW_TAG_member, name: "link_state", scope: !7110, file: !7089, line: 380, baseType: !7238, size: 64, offset: 1216)
!7238 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7239, size: 64)
!7239 = !DICompositeType(tag: DW_TAG_structure_type, name: "pcie_link_state", file: !7089, line: 303, flags: DIFlagFwdDecl)
!7240 = !DIDerivedType(tag: DW_TAG_member, name: "ltr_path", scope: !7110, file: !7089, line: 381, baseType: !7, size: 1, offset: 1280, flags: DIFlagBitField, extraData: i64 1280)
!7241 = !DIDerivedType(tag: DW_TAG_member, name: "l1ss", scope: !7110, file: !7089, line: 383, baseType: !32, size: 32, offset: 1312)
!7242 = !DIDerivedType(tag: DW_TAG_member, name: "eetlp_prefix_path", scope: !7110, file: !7089, line: 385, baseType: !7, size: 1, offset: 1344, flags: DIFlagBitField, extraData: i64 1344)
!7243 = !DIDerivedType(tag: DW_TAG_member, name: "error_state", scope: !7110, file: !7089, line: 387, baseType: !7244, size: 32, offset: 1376)
!7244 = !DIDerivedType(tag: DW_TAG_typedef, name: "pci_channel_state_t", file: !7089, line: 180, baseType: !7)
!7245 = !DIDerivedType(tag: DW_TAG_member, name: "dev", scope: !7110, file: !7089, line: 388, baseType: !6540, size: 5568, offset: 1408)
!7246 = !DIDerivedType(tag: DW_TAG_member, name: "cfg_size", scope: !7110, file: !7089, line: 390, baseType: !32, size: 32, offset: 6976)
!7247 = !DIDerivedType(tag: DW_TAG_member, name: "irq", scope: !7110, file: !7089, line: 396, baseType: !7, size: 32, offset: 7008)
!7248 = !DIDerivedType(tag: DW_TAG_member, name: "resource", scope: !7110, file: !7089, line: 397, baseType: !7249, size: 8704, offset: 7040)
!7249 = !DICompositeType(tag: DW_TAG_array_type, baseType: !7126, size: 8704, elements: !7250)
!7250 = !{!7251}
!7251 = !DISubrange(count: 17)
!7252 = !DIDerivedType(tag: DW_TAG_member, name: "match_driver", scope: !7110, file: !7089, line: 399, baseType: !771, size: 8, offset: 15744)
!7253 = !DIDerivedType(tag: DW_TAG_member, name: "transparent", scope: !7110, file: !7089, line: 401, baseType: !7, size: 1, offset: 15752, flags: DIFlagBitField, extraData: i64 15752)
!7254 = !DIDerivedType(tag: DW_TAG_member, name: "io_window", scope: !7110, file: !7089, line: 402, baseType: !7, size: 1, offset: 15753, flags: DIFlagBitField, extraData: i64 15752)
!7255 = !DIDerivedType(tag: DW_TAG_member, name: "pref_window", scope: !7110, file: !7089, line: 403, baseType: !7, size: 1, offset: 15754, flags: DIFlagBitField, extraData: i64 15752)
!7256 = !DIDerivedType(tag: DW_TAG_member, name: "pref_64_window", scope: !7110, file: !7089, line: 404, baseType: !7, size: 1, offset: 15755, flags: DIFlagBitField, extraData: i64 15752)
!7257 = !DIDerivedType(tag: DW_TAG_member, name: "multifunction", scope: !7110, file: !7089, line: 405, baseType: !7, size: 1, offset: 15756, flags: DIFlagBitField, extraData: i64 15752)
!7258 = !DIDerivedType(tag: DW_TAG_member, name: "is_busmaster", scope: !7110, file: !7089, line: 407, baseType: !7, size: 1, offset: 15757, flags: DIFlagBitField, extraData: i64 15752)
!7259 = !DIDerivedType(tag: DW_TAG_member, name: "no_msi", scope: !7110, file: !7089, line: 408, baseType: !7, size: 1, offset: 15758, flags: DIFlagBitField, extraData: i64 15752)
!7260 = !DIDerivedType(tag: DW_TAG_member, name: "no_64bit_msi", scope: !7110, file: !7089, line: 409, baseType: !7, size: 1, offset: 15759, flags: DIFlagBitField, extraData: i64 15752)
!7261 = !DIDerivedType(tag: DW_TAG_member, name: "block_cfg_access", scope: !7110, file: !7089, line: 410, baseType: !7, size: 1, offset: 15760, flags: DIFlagBitField, extraData: i64 15752)
!7262 = !DIDerivedType(tag: DW_TAG_member, name: "broken_parity_status", scope: !7110, file: !7089, line: 411, baseType: !7, size: 1, offset: 15761, flags: DIFlagBitField, extraData: i64 15752)
!7263 = !DIDerivedType(tag: DW_TAG_member, name: "irq_reroute_variant", scope: !7110, file: !7089, line: 412, baseType: !7, size: 2, offset: 15762, flags: DIFlagBitField, extraData: i64 15752)
!7264 = !DIDerivedType(tag: DW_TAG_member, name: "msi_enabled", scope: !7110, file: !7089, line: 413, baseType: !7, size: 1, offset: 15764, flags: DIFlagBitField, extraData: i64 15752)
!7265 = !DIDerivedType(tag: DW_TAG_member, name: "msix_enabled", scope: !7110, file: !7089, line: 414, baseType: !7, size: 1, offset: 15765, flags: DIFlagBitField, extraData: i64 15752)
!7266 = !DIDerivedType(tag: DW_TAG_member, name: "ari_enabled", scope: !7110, file: !7089, line: 415, baseType: !7, size: 1, offset: 15766, flags: DIFlagBitField, extraData: i64 15752)
!7267 = !DIDerivedType(tag: DW_TAG_member, name: "ats_enabled", scope: !7110, file: !7089, line: 416, baseType: !7, size: 1, offset: 15767, flags: DIFlagBitField, extraData: i64 15752)
!7268 = !DIDerivedType(tag: DW_TAG_member, name: "pasid_enabled", scope: !7110, file: !7089, line: 417, baseType: !7, size: 1, offset: 15768, flags: DIFlagBitField, extraData: i64 15752)
!7269 = !DIDerivedType(tag: DW_TAG_member, name: "pri_enabled", scope: !7110, file: !7089, line: 418, baseType: !7, size: 1, offset: 15769, flags: DIFlagBitField, extraData: i64 15752)
!7270 = !DIDerivedType(tag: DW_TAG_member, name: "is_managed", scope: !7110, file: !7089, line: 419, baseType: !7, size: 1, offset: 15770, flags: DIFlagBitField, extraData: i64 15752)
!7271 = !DIDerivedType(tag: DW_TAG_member, name: "needs_freset", scope: !7110, file: !7089, line: 420, baseType: !7, size: 1, offset: 15771, flags: DIFlagBitField, extraData: i64 15752)
!7272 = !DIDerivedType(tag: DW_TAG_member, name: "state_saved", scope: !7110, file: !7089, line: 421, baseType: !7, size: 1, offset: 15772, flags: DIFlagBitField, extraData: i64 15752)
!7273 = !DIDerivedType(tag: DW_TAG_member, name: "is_physfn", scope: !7110, file: !7089, line: 422, baseType: !7, size: 1, offset: 15773, flags: DIFlagBitField, extraData: i64 15752)
!7274 = !DIDerivedType(tag: DW_TAG_member, name: "is_virtfn", scope: !7110, file: !7089, line: 423, baseType: !7, size: 1, offset: 15774, flags: DIFlagBitField, extraData: i64 15752)
!7275 = !DIDerivedType(tag: DW_TAG_member, name: "reset_fn", scope: !7110, file: !7089, line: 424, baseType: !7, size: 1, offset: 15775, flags: DIFlagBitField, extraData: i64 15752)
!7276 = !DIDerivedType(tag: DW_TAG_member, name: "is_hotplug_bridge", scope: !7110, file: !7089, line: 425, baseType: !7, size: 1, offset: 15776, flags: DIFlagBitField, extraData: i64 15752)
!7277 = !DIDerivedType(tag: DW_TAG_member, name: "shpc_managed", scope: !7110, file: !7089, line: 426, baseType: !7, size: 1, offset: 15777, flags: DIFlagBitField, extraData: i64 15752)
!7278 = !DIDerivedType(tag: DW_TAG_member, name: "is_thunderbolt", scope: !7110, file: !7089, line: 427, baseType: !7, size: 1, offset: 15778, flags: DIFlagBitField, extraData: i64 15752)
!7279 = !DIDerivedType(tag: DW_TAG_member, name: "untrusted", scope: !7110, file: !7089, line: 435, baseType: !7, size: 1, offset: 15779, flags: DIFlagBitField, extraData: i64 15752)
!7280 = !DIDerivedType(tag: DW_TAG_member, name: "external_facing", scope: !7110, file: !7089, line: 441, baseType: !7, size: 1, offset: 15780, flags: DIFlagBitField, extraData: i64 15752)
!7281 = !DIDerivedType(tag: DW_TAG_member, name: "broken_intx_masking", scope: !7110, file: !7089, line: 442, baseType: !7, size: 1, offset: 15781, flags: DIFlagBitField, extraData: i64 15752)
!7282 = !DIDerivedType(tag: DW_TAG_member, name: "io_window_1k", scope: !7110, file: !7089, line: 443, baseType: !7, size: 1, offset: 15782, flags: DIFlagBitField, extraData: i64 15752)
!7283 = !DIDerivedType(tag: DW_TAG_member, name: "irq_managed", scope: !7110, file: !7089, line: 444, baseType: !7, size: 1, offset: 15783, flags: DIFlagBitField, extraData: i64 15752)
!7284 = !DIDerivedType(tag: DW_TAG_member, name: "non_compliant_bars", scope: !7110, file: !7089, line: 445, baseType: !7, size: 1, offset: 15784, flags: DIFlagBitField, extraData: i64 15752)
!7285 = !DIDerivedType(tag: DW_TAG_member, name: "is_probed", scope: !7110, file: !7089, line: 446, baseType: !7, size: 1, offset: 15785, flags: DIFlagBitField, extraData: i64 15752)
!7286 = !DIDerivedType(tag: DW_TAG_member, name: "link_active_reporting", scope: !7110, file: !7089, line: 447, baseType: !7, size: 1, offset: 15786, flags: DIFlagBitField, extraData: i64 15752)
!7287 = !DIDerivedType(tag: DW_TAG_member, name: "no_vf_scan", scope: !7110, file: !7089, line: 448, baseType: !7, size: 1, offset: 15787, flags: DIFlagBitField, extraData: i64 15752)
!7288 = !DIDerivedType(tag: DW_TAG_member, name: "no_command_memory", scope: !7110, file: !7089, line: 449, baseType: !7, size: 1, offset: 15788, flags: DIFlagBitField, extraData: i64 15752)
!7289 = !DIDerivedType(tag: DW_TAG_member, name: "dev_flags", scope: !7110, file: !7089, line: 450, baseType: !7290, size: 16, offset: 15792)
!7290 = !DIDerivedType(tag: DW_TAG_typedef, name: "pci_dev_flags_t", file: !7089, line: 206, baseType: !476)
!7291 = !DIDerivedType(tag: DW_TAG_member, name: "enable_cnt", scope: !7110, file: !7089, line: 451, baseType: !383, size: 32, offset: 15808)
!7292 = !DIDerivedType(tag: DW_TAG_member, name: "saved_config_space", scope: !7110, file: !7089, line: 453, baseType: !7293, size: 512, offset: 15840)
!7293 = !DICompositeType(tag: DW_TAG_array_type, baseType: !987, size: 512, elements: !269)
!7294 = !DIDerivedType(tag: DW_TAG_member, name: "saved_cap_space", scope: !7110, file: !7089, line: 454, baseType: !1581, size: 64, offset: 16384)
!7295 = !DIDerivedType(tag: DW_TAG_member, name: "rom_attr", scope: !7110, file: !7089, line: 455, baseType: !6171, size: 64, offset: 16448)
!7296 = !DIDerivedType(tag: DW_TAG_member, name: "rom_attr_enabled", scope: !7110, file: !7089, line: 456, baseType: !32, size: 32, offset: 16512)
!7297 = !DIDerivedType(tag: DW_TAG_member, name: "res_attr", scope: !7110, file: !7089, line: 457, baseType: !7298, size: 1088, offset: 16576)
!7298 = !DICompositeType(tag: DW_TAG_array_type, baseType: !6171, size: 1088, elements: !7250)
!7299 = !DIDerivedType(tag: DW_TAG_member, name: "res_attr_wc", scope: !7110, file: !7089, line: 458, baseType: !7298, size: 1088, offset: 17664)
!7300 = !DIDerivedType(tag: DW_TAG_member, name: "msi_irq_groups", scope: !7110, file: !7089, line: 469, baseType: !6157, size: 64, offset: 18752)
!7301 = !DIDerivedType(tag: DW_TAG_member, name: "vpd", scope: !7110, file: !7089, line: 471, baseType: !7302, size: 64, offset: 18816)
!7302 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7303, size: 64)
!7303 = !DICompositeType(tag: DW_TAG_structure_type, name: "pci_vpd", file: !7089, line: 304, flags: DIFlagFwdDecl)
!7304 = !DIDerivedType(tag: DW_TAG_member, scope: !7110, file: !7089, line: 478, baseType: !7305, size: 64, offset: 18880)
!7305 = distinct !DICompositeType(tag: DW_TAG_union_type, scope: !7110, file: !7089, line: 478, size: 64, elements: !7306)
!7306 = !{!7307, !7310}
!7307 = !DIDerivedType(tag: DW_TAG_member, name: "sriov", scope: !7305, file: !7089, line: 479, baseType: !7308, size: 64)
!7308 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7309, size: 64)
!7309 = !DICompositeType(tag: DW_TAG_structure_type, name: "pci_sriov", file: !7089, line: 305, flags: DIFlagFwdDecl)
!7310 = !DIDerivedType(tag: DW_TAG_member, name: "physfn", scope: !7305, file: !7089, line: 480, baseType: !7109, size: 64)
!7311 = !DIDerivedType(tag: DW_TAG_member, name: "ats_cap", scope: !7110, file: !7089, line: 482, baseType: !581, size: 16, offset: 18944)
!7312 = !DIDerivedType(tag: DW_TAG_member, name: "ats_stu", scope: !7110, file: !7089, line: 483, baseType: !794, size: 8, offset: 18960)
!7313 = !DIDerivedType(tag: DW_TAG_member, name: "acs_cap", scope: !7110, file: !7089, line: 497, baseType: !581, size: 16, offset: 18976)
!7314 = !DIDerivedType(tag: DW_TAG_member, name: "rom", scope: !7110, file: !7089, line: 498, baseType: !4045, size: 64, offset: 19008)
!7315 = !DIDerivedType(tag: DW_TAG_member, name: "romlen", scope: !7110, file: !7089, line: 499, baseType: !1039, size: 64, offset: 19072)
!7316 = !DIDerivedType(tag: DW_TAG_member, name: "driver_override", scope: !7110, file: !7089, line: 500, baseType: !1038, size: 64, offset: 19136)
!7317 = !DIDerivedType(tag: DW_TAG_member, name: "priv_flags", scope: !7110, file: !7089, line: 502, baseType: !312, size: 64, offset: 19200)
!7318 = !DIDerivedType(tag: DW_TAG_member, name: "remove", scope: !7088, file: !7089, line: 863, baseType: !7319, size: 64, offset: 320)
!7319 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7320, size: 64)
!7320 = !DISubroutineType(types: !7321)
!7321 = !{null, !7109}
!7322 = !DIDerivedType(tag: DW_TAG_member, name: "suspend", scope: !7088, file: !7089, line: 864, baseType: !7323, size: 64, offset: 384)
!7323 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7324, size: 64)
!7324 = !DISubroutineType(types: !7325)
!7325 = !{!32, !7109, !6661}
!7326 = !DIDerivedType(tag: DW_TAG_member, name: "resume", scope: !7088, file: !7089, line: 865, baseType: !7327, size: 64, offset: 448)
!7327 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7328, size: 64)
!7328 = !DISubroutineType(types: !7329)
!7329 = !{!32, !7109}
!7330 = !DIDerivedType(tag: DW_TAG_member, name: "shutdown", scope: !7088, file: !7089, line: 866, baseType: !7319, size: 64, offset: 512)
!7331 = !DIDerivedType(tag: DW_TAG_member, name: "sriov_configure", scope: !7088, file: !7089, line: 867, baseType: !7332, size: 64, offset: 576)
!7332 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7333, size: 64)
!7333 = !DISubroutineType(types: !7334)
!7334 = !{!32, !7109, !32}
!7335 = !DIDerivedType(tag: DW_TAG_member, name: "err_handler", scope: !7088, file: !7089, line: 868, baseType: !7336, size: 64, offset: 640)
!7336 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7337, size: 64)
!7337 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !7338)
!7338 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_error_handlers", file: !7089, line: 795, size: 384, elements: !7339)
!7339 = !{!7340, !7345, !7349, !7350, !7351, !7352}
!7340 = !DIDerivedType(tag: DW_TAG_member, name: "error_detected", scope: !7338, file: !7089, line: 797, baseType: !7341, size: 64)
!7341 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7342, size: 64)
!7342 = !DISubroutineType(types: !7343)
!7343 = !{!7344, !7109, !7244}
!7344 = !DIDerivedType(tag: DW_TAG_typedef, name: "pci_ers_result_t", file: !7089, line: 772, baseType: !7)
!7345 = !DIDerivedType(tag: DW_TAG_member, name: "mmio_enabled", scope: !7338, file: !7089, line: 801, baseType: !7346, size: 64, offset: 64)
!7346 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7347, size: 64)
!7347 = !DISubroutineType(types: !7348)
!7348 = !{!7344, !7109}
!7349 = !DIDerivedType(tag: DW_TAG_member, name: "slot_reset", scope: !7338, file: !7089, line: 804, baseType: !7346, size: 64, offset: 128)
!7350 = !DIDerivedType(tag: DW_TAG_member, name: "reset_prepare", scope: !7338, file: !7089, line: 807, baseType: !7319, size: 64, offset: 192)
!7351 = !DIDerivedType(tag: DW_TAG_member, name: "reset_done", scope: !7338, file: !7089, line: 808, baseType: !7319, size: 64, offset: 256)
!7352 = !DIDerivedType(tag: DW_TAG_member, name: "resume", scope: !7338, file: !7089, line: 811, baseType: !7319, size: 64, offset: 320)
!7353 = !DIDerivedType(tag: DW_TAG_member, name: "groups", scope: !7088, file: !7089, line: 869, baseType: !6157, size: 64, offset: 704)
!7354 = !DIDerivedType(tag: DW_TAG_member, name: "driver", scope: !7088, file: !7089, line: 870, baseType: !6618, size: 1152, offset: 768)
!7355 = !DIDerivedType(tag: DW_TAG_member, name: "dynids", scope: !7088, file: !7089, line: 871, baseType: !7356, size: 128, offset: 1920)
!7356 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_dynids", file: !7089, line: 759, size: 128, elements: !7357)
!7357 = !{!7358, !7359}
!7358 = !DIDerivedType(tag: DW_TAG_member, name: "lock", scope: !7356, file: !7089, line: 760, baseType: !1670)
!7359 = !DIDerivedType(tag: DW_TAG_member, name: "list", scope: !7356, file: !7089, line: 761, baseType: !284, size: 128)
!7360 = !DIGlobalVariableExpression(var: !7361, expr: !DIExpression())
!7361 = distinct !DIGlobalVariable(name: "card_ids", scope: !2, file: !3, line: 21, type: !7362, isLocal: true, isDefinition: true)
!7362 = !DICompositeType(tag: DW_TAG_array_type, baseType: !7095, size: 512, elements: !2664)
!7363 = !DICompositeType(tag: DW_TAG_array_type, baseType: !293, size: 240, elements: !7364)
!7364 = !{!7365}
!7365 = !DISubrange(count: 30)
!7366 = !{i32 7, !"Dwarf Version", i32 4}
!7367 = !{i32 2, !"Debug Info Version", i32 3}
!7368 = !{i32 1, !"wchar_size", i32 2}
!7369 = !{i32 1, !"Code Model", i32 2}
!7370 = !{!"clang version 10.0.1 (https://github.com/llvm/llvm-project.git ef32c611aa214dea855364efd7ba451ec5ec3f74)"}
!7371 = distinct !DISubprogram(name: "atmel_driver_init", scope: !3, file: !3, line: 66, type: !7372, scopeLine: 66, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !1587)
!7372 = !DISubroutineType(types: !7373)
!7373 = !{!32}
!7374 = !DILocation(line: 66, column: 1, scope: !7371)
!7375 = distinct !DISubprogram(name: "atmel_driver_exit", scope: !3, file: !3, line: 66, type: !3809, scopeLine: 66, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !1587)
!7376 = !DILocation(line: 66, column: 1, scope: !7375)
!7377 = distinct !DISubprogram(name: "atmel_pci_probe", scope: !3, file: !3, line: 39, type: !7107, scopeLine: 41, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !1587)
!7378 = !DILocalVariable(name: "pdev", arg: 1, scope: !7377, file: !3, line: 39, type: !7109)
!7379 = !DILocation(line: 39, column: 44, scope: !7377)
!7380 = !DILocalVariable(name: "pent", arg: 2, scope: !7377, file: !3, line: 40, type: !7094)
!7381 = !DILocation(line: 40, column: 38, scope: !7377)
!7382 = !DILocalVariable(name: "dev", scope: !7377, file: !3, line: 42, type: !290)
!7383 = !DILocation(line: 42, column: 21, scope: !7377)
!7384 = !DILocation(line: 44, column: 24, scope: !7385)
!7385 = distinct !DILexicalBlock(scope: !7377, file: !3, line: 44, column: 6)
!7386 = !DILocation(line: 44, column: 6, scope: !7385)
!7387 = !DILocation(line: 44, column: 6, scope: !7377)
!7388 = !DILocation(line: 45, column: 3, scope: !7385)
!7389 = !DILocation(line: 47, column: 17, scope: !7377)
!7390 = !DILocation(line: 47, column: 2, scope: !7377)
!7391 = !DILocation(line: 49, column: 24, scope: !7377)
!7392 = !DILocation(line: 49, column: 30, scope: !7377)
!7393 = !DILocation(line: 49, column: 35, scope: !7377)
!7394 = !DILocation(line: 49, column: 41, scope: !7377)
!7395 = !DILocation(line: 49, column: 53, scope: !7377)
!7396 = !DILocation(line: 51, column: 11, scope: !7377)
!7397 = !DILocation(line: 51, column: 17, scope: !7377)
!7398 = !DILocation(line: 49, column: 8, scope: !7377)
!7399 = !DILocation(line: 49, column: 6, scope: !7377)
!7400 = !DILocation(line: 52, column: 7, scope: !7401)
!7401 = distinct !DILexicalBlock(scope: !7377, file: !3, line: 52, column: 6)
!7402 = !DILocation(line: 52, column: 6, scope: !7377)
!7403 = !DILocation(line: 53, column: 22, scope: !7404)
!7404 = distinct !DILexicalBlock(scope: !7401, file: !3, line: 52, column: 12)
!7405 = !DILocation(line: 53, column: 3, scope: !7404)
!7406 = !DILocation(line: 54, column: 3, scope: !7404)
!7407 = !DILocation(line: 57, column: 18, scope: !7377)
!7408 = !DILocation(line: 57, column: 24, scope: !7377)
!7409 = !DILocation(line: 57, column: 2, scope: !7377)
!7410 = !DILocation(line: 58, column: 2, scope: !7377)
!7411 = !DILocation(line: 59, column: 1, scope: !7377)
!7412 = distinct !DISubprogram(name: "atmel_pci_remove", scope: !3, file: !3, line: 61, type: !7320, scopeLine: 62, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !1587)
!7413 = !DILocalVariable(name: "pdev", arg: 1, scope: !7412, file: !3, line: 61, type: !7109)
!7414 = !DILocation(line: 61, column: 46, scope: !7412)
!7415 = !DILocation(line: 63, column: 34, scope: !7412)
!7416 = !DILocation(line: 63, column: 18, scope: !7412)
!7417 = !DILocation(line: 63, column: 2, scope: !7412)
!7418 = !DILocation(line: 64, column: 1, scope: !7412)
!7419 = distinct !DISubprogram(name: "pci_set_drvdata", scope: !7089, file: !7089, line: 1870, type: !7420, scopeLine: 1871, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !1587)
!7420 = !DISubroutineType(types: !7421)
!7421 = !{null, !7109, !591}
!7422 = !DILocalVariable(name: "pdev", arg: 1, scope: !7419, file: !7089, line: 1870, type: !7109)
!7423 = !DILocation(line: 1870, column: 52, scope: !7419)
!7424 = !DILocalVariable(name: "data", arg: 2, scope: !7419, file: !7089, line: 1870, type: !591)
!7425 = !DILocation(line: 1870, column: 64, scope: !7419)
!7426 = !DILocation(line: 1872, column: 19, scope: !7419)
!7427 = !DILocation(line: 1872, column: 25, scope: !7419)
!7428 = !DILocation(line: 1872, column: 30, scope: !7419)
!7429 = !DILocation(line: 1872, column: 2, scope: !7419)
!7430 = !DILocation(line: 1873, column: 1, scope: !7419)
!7431 = distinct !DISubprogram(name: "dev_set_drvdata", scope: !6541, file: !6541, line: 660, type: !7432, scopeLine: 661, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !1587)
!7432 = !DISubroutineType(types: !7433)
!7433 = !{null, !6545, !591}
!7434 = !DILocalVariable(name: "dev", arg: 1, scope: !7431, file: !6541, line: 660, type: !6545)
!7435 = !DILocation(line: 660, column: 51, scope: !7431)
!7436 = !DILocalVariable(name: "data", arg: 2, scope: !7431, file: !6541, line: 660, type: !591)
!7437 = !DILocation(line: 660, column: 62, scope: !7431)
!7438 = !DILocation(line: 662, column: 21, scope: !7431)
!7439 = !DILocation(line: 662, column: 2, scope: !7431)
!7440 = !DILocation(line: 662, column: 7, scope: !7431)
!7441 = !DILocation(line: 662, column: 19, scope: !7431)
!7442 = !DILocation(line: 663, column: 1, scope: !7431)
!7443 = distinct !DISubprogram(name: "pci_get_drvdata", scope: !7089, file: !7089, line: 1865, type: !7444, scopeLine: 1866, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !1587)
!7444 = !DISubroutineType(types: !7445)
!7445 = !{!591, !7109}
!7446 = !DILocalVariable(name: "pdev", arg: 1, scope: !7443, file: !7089, line: 1865, type: !7109)
!7447 = !DILocation(line: 1865, column: 53, scope: !7443)
!7448 = !DILocation(line: 1867, column: 26, scope: !7443)
!7449 = !DILocation(line: 1867, column: 32, scope: !7443)
!7450 = !DILocation(line: 1867, column: 9, scope: !7443)
!7451 = !DILocation(line: 1867, column: 2, scope: !7443)
!7452 = distinct !DISubprogram(name: "dev_get_drvdata", scope: !6541, file: !6541, line: 655, type: !7453, scopeLine: 656, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !1587)
!7453 = !DISubroutineType(types: !7454)
!7454 = !{!591, !6891}
!7455 = !DILocalVariable(name: "dev", arg: 1, scope: !7452, file: !6541, line: 655, type: !6891)
!7456 = !DILocation(line: 655, column: 58, scope: !7452)
!7457 = !DILocation(line: 657, column: 9, scope: !7452)
!7458 = !DILocation(line: 657, column: 14, scope: !7452)
!7459 = !DILocation(line: 657, column: 2, scope: !7452)
