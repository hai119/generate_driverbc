; ModuleID = '../bcout/drivers/xen/xen-pciback/passthrough.llvm.bc'
source_filename = "drivers/xen/xen-pciback/passthrough.c"
...
%struct.passthrough_dev_data = type { %struct.list_head, %struct.mutex }
...
entry:
  ...
  %dev_data = alloca %struct.passthrough_dev_data*, align 8
  store %struct.xen_pcibk_device* %pdev, %struct.xen_pcibk_device** %pdev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.xen_pcibk_device** %pdev.addr, metadata !4613, metadata !DIExpression()), !dbg !4614
  call void @llvm.dbg.declare(metadata %struct.passthrough_dev_data** %dev_data, metadata !4615, metadata !DIExpression()), !dbg !4621
  store i64 40, i64* %size.addr.i, align 8
  store i32 3264, i32* %flags.addr.i, align 4
  %0 = load i64, i64* %size.addr.i, align 8, !dbg !4622
  %1 = call i1 @llvm.is.constant.i64(i64 %0) #6, !dbg !4623
  br i1 %1, label %if.then.i, label %if.end9.i, !dbg !4624

if.then.i:                                        ; preds = %entry
  %2 = load i64, i64* %size.addr.i, align 8, !dbg !4625
  %cmp.i = icmp ugt i64 %2, 8192, !dbg !4626
  br i1 %cmp.i, label %if.then1.i, label %if.end.i, !dbg !4627

if.then1.i:                                       ; preds = %if.then.i
  %3 = load i64, i64* %size.addr.i, align 8, !dbg !4628
  %4 = load i32, i32* %flags.addr.i, align 4, !dbg !4629
  store i64 %3, i64* %size.addr.i.i, align 8
  store i32 %4, i32* %flags.addr.i.i, align 4
  %5 = load i64, i64* %size.addr.i.i, align 8, !dbg !4630
  %call.i.i = call i32 @get_order(i64 %5) #7, !dbg !4631
  store i32 %call.i.i, i32* %order.i.i, align 4, !dbg !4606
  %6 = load i64, i64* %size.addr.i.i, align 8, !dbg !4632
  %7 = load i32, i32* %flags.addr.i.i, align 4, !dbg !4633
  %8 = load i32, i32* %order.i.i, align 4, !dbg !4634
  store i64 %6, i64* %size.addr.i.i.i, align 8
  store i32 %7, i32* %flags.addr.i.i.i, align 4
  store i32 %8, i32* %order.addr.i.i.i, align 4
  %9 = load i64, i64* %size.addr.i.i.i, align 8, !dbg !4635
  %10 = load i32, i32* %flags.addr.i.i.i, align 4, !dbg !4636
  %11 = load i32, i32* %order.addr.i.i.i, align 4, !dbg !4637
  %call.i.i.i = call noalias i8* @kmalloc_order(i64 %9, i32 %10, i32 %11) #8, !dbg !4638
  ...
  call void @llvm.assume(i1 %maskcond.i.i.i) #6, !dbg !4638
  store i8* %call.i.i.i, i8** %retval.i, align 8, !dbg !4639
  br label %kmalloc.exit, !dbg !4639

if.end.i:                                         ; preds = %if.then.i
  %12 = load i64, i64* %size.addr.i, align 8, !dbg !4640
  store i64 %12, i64* %size.addr.i11.i, align 8
  %13 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4641
  %tobool.i.i = icmp ne i64 %13, 0, !dbg !4641
...
if.end.i.i:                                       ; preds = %if.end.i
  %14 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4645
  %cmp.i.i = icmp ule i64 %14, 8, !dbg !4647
...
if.end2.i.i:                                      ; preds = %if.end.i.i
  %15 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4650
  %cmp3.i.i = icmp ugt i64 %15, 64, !dbg !4652
  br i1 %cmp3.i.i, label %land.lhs.true.i.i, label %if.end6.i.i, !dbg !4653

land.lhs.true.i.i:                                ; preds = %if.end2.i.i
  %16 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4654
  %cmp4.i.i = icmp ule i64 %16, 96, !dbg !4655
...
if.end6.i.i:                                      ; preds = %land.lhs.true.i.i, %if.end2.i.i
  %17 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4658
  %cmp7.i.i = icmp ugt i64 %17, 128, !dbg !4660
  br i1 %cmp7.i.i, label %land.lhs.true8.i.i, label %if.end11.i.i, !dbg !4661

land.lhs.true8.i.i:                               ; preds = %if.end6.i.i
  %18 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4662
  %cmp9.i.i = icmp ule i64 %18, 192, !dbg !4663
...
if.end11.i.i:                                     ; preds = %land.lhs.true8.i.i, %if.end6.i.i
  %19 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4666
  %cmp12.i.i = icmp ule i64 %19, 8, !dbg !4668
...
if.end14.i.i:                                     ; preds = %if.end11.i.i
  %20 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4671
  %cmp15.i.i = icmp ule i64 %20, 16, !dbg !4673
...
if.end17.i.i:                                     ; preds = %if.end14.i.i
  ...
  %cmp18.i.i = icmp ule i64 %21, 32, !dbg !4678
...
if.end20.i.i:                                     ; preds = %if.end17.i.i
  %22 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4681
  %cmp21.i.i = icmp ule i64 %22, 64, !dbg !4683
...
if.end23.i.i:                                     ; preds = %if.end20.i.i
  %23 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4686
  %cmp24.i.i = icmp ule i64 %23, 128, !dbg !4688
...
if.end26.i.i:                                     ; preds = %if.end23.i.i
  %24 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4691
  %cmp27.i.i = icmp ule i64 %24, 256, !dbg !4693
...
if.end29.i.i:                                     ; preds = %if.end26.i.i
  %25 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4696
  %cmp30.i.i = icmp ule i64 %25, 512, !dbg !4698
...
if.end32.i.i:                                     ; preds = %if.end29.i.i
  %26 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4701
  %cmp33.i.i = icmp ule i64 %26, 1024, !dbg !4703
...
if.end35.i.i:                                     ; preds = %if.end32.i.i
  %27 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4706
  %cmp36.i.i = icmp ule i64 %27, 2048, !dbg !4708
...
if.end38.i.i:                                     ; preds = %if.end35.i.i
  %28 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4711
  %cmp39.i.i = icmp ule i64 %28, 4096, !dbg !4713
...
if.end41.i.i:                                     ; preds = %if.end38.i.i
  %29 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4716
  %cmp42.i.i = icmp ule i64 %29, 8192, !dbg !4718
...
if.end44.i.i:                                     ; preds = %if.end41.i.i
  %30 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4721
  %cmp45.i.i = icmp ule i64 %30, 16384, !dbg !4723
...
if.end47.i.i:                                     ; preds = %if.end44.i.i
  %31 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4726
  %cmp48.i.i = icmp ule i64 %31, 32768, !dbg !4728
...
if.end50.i.i:                                     ; preds = %if.end47.i.i
  %32 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4731
  %cmp51.i.i = icmp ule i64 %32, 65536, !dbg !4733
...
if.end53.i.i:                                     ; preds = %if.end50.i.i
  %33 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4736
  %cmp54.i.i = icmp ule i64 %33, 131072, !dbg !4738
...
if.end56.i.i:                                     ; preds = %if.end53.i.i
  %34 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4741
  %cmp57.i.i = icmp ule i64 %34, 262144, !dbg !4743
...
if.end59.i.i:                                     ; preds = %if.end56.i.i
  %35 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4746
  %cmp60.i.i = icmp ule i64 %35, 524288, !dbg !4748
...
if.end62.i.i:                                     ; preds = %if.end59.i.i
  %36 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4751
  %cmp63.i.i = icmp ule i64 %36, 1048576, !dbg !4753
...
if.end65.i.i:                                     ; preds = %if.end62.i.i
  %37 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4756
  %cmp66.i.i = icmp ule i64 %37, 2097152, !dbg !4758
...
if.end68.i.i:                                     ; preds = %if.end65.i.i
  %38 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4761
  %cmp69.i.i = icmp ule i64 %38, 4194304, !dbg !4763
...
if.end71.i.i:                                     ; preds = %if.end68.i.i
  %39 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4766
  %cmp72.i.i = icmp ule i64 %39, 8388608, !dbg !4768
...
if.end74.i.i:                                     ; preds = %if.end71.i.i
  %40 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4771
  %cmp75.i.i = icmp ule i64 %40, 16777216, !dbg !4773
...
if.end77.i.i:                                     ; preds = %if.end74.i.i
  %41 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4776
  %cmp78.i.i = icmp ule i64 %41, 33554432, !dbg !4778
...
if.end80.i.i:                                     ; preds = %if.end77.i.i
  %42 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4781
  %cmp81.i.i = icmp ule i64 %42, 67108864, !dbg !4783
...
if.end83.i.i:                                     ; preds = %if.end80.i.i
  call void asm sideeffect "1:\09.byte 0x0f, 0x0b\0A.pushsection __bug_table,\22aw\22\0A2:\09.long 1b - 2b\09# bug_entry::bug_addr\0A\09.long ${0:c} - 2b\09# bug_entry::file\0A\09.word ${1:c}\09# bug_entry::line\0A\09.word ${2:c}\09# bug_entry::flags\0A\09.org 2b+${3:c}\0A.popsection", "i,i,i,i,~{dirflag},~{fpsr},~{flags}"(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.2, i64 0, i64 0), i32 382, i32 0, i64 12) #6, !dbg !4786, !srcloc !4789
  call void asm sideeffect "${0:c}:\0A\09.pushsection .discard.unreachable\0A\09.long ${0:c}b - .\0A\09.popsection\0A\09", "i,~{dirflag},~{fpsr},~{flags}"(i32 156) #6, !dbg !4790, !srcloc !4793
  unreachable, !dbg !4794

kmalloc_index.exit.i:                             ; preds = %if.then82.i.i, %if.then79.i.i, %if.then76.i.i, %if.then73.i.i, %if.then70.i.i, %if.then67.i.i, %if.then64.i.i, %if.then61.i.i, %if.then58.i.i, %if.then55.i.i, %if.then52.i.i, %if.then49.i.i, %if.then46.i.i, %if.then43.i.i, %if.then40.i.i, %if.then37.i.i, %if.then34.i.i, %if.then31.i.i, %if.then28.i.i, %if.then25.i.i, %if.then22.i.i, %if.then19.i.i, %if.then16.i.i, %if.then13.i.i, %if.then10.i.i, %if.then5.i.i, %if.then1.i.i, %if.then.i.i
  %43 = load i32, i32* %retval.i.i, align 4, !dbg !4795
  store i32 %43, i32* %index.i, align 4, !dbg !4796
  %44 = load i32, i32* %index.i, align 4, !dbg !4797
  %tobool.i = icmp ne i32 %44, 0, !dbg !4797
...
if.end4.i:                                        ; preds = %kmalloc_index.exit.i
  %45 = load i32, i32* %flags.addr.i, align 4, !dbg !4801
  store i32 %45, i32* %flags.addr.i13.i, align 4
  %46 = load i32, i32* %flags.addr.i13.i, align 4, !dbg !4802
  %and.i.i = and i32 %46, 17, !dbg !4802
...
if.end.i16.i:                                     ; preds = %if.end4.i
  %47 = load i32, i32* %flags.addr.i13.i, align 4, !dbg !4806
  %and2.i.i = and i32 %47, 1, !dbg !4807
  %tobool3.i.i = icmp ne i32 %and2.i.i, 0, !dbg !4806
  %48 = zext i1 %tobool3.i.i to i64, !dbg !4806
...
kmalloc_type.exit.i:                              ; preds = %if.end.i16.i, %if.then.i15.i
  %49 = load i32, i32* %retval.i12.i, align 4, !dbg !4809
  %idxprom.i = zext i32 %49 to i64, !dbg !4810
  ...
  %50 = load i32, i32* %index.i, align 4, !dbg !4811
  %idxprom6.i = zext i32 %50 to i64, !dbg !4810
  %arrayidx7.i = getelementptr [14 x %struct.kmem_cache*], [14 x %struct.kmem_cache*]* %arrayidx.i, i64 0, i64 %idxprom6.i, !dbg !4810
  %51 = load %struct.kmem_cache*, %struct.kmem_cache** %arrayidx7.i, align 8, !dbg !4810
  %52 = load i32, i32* %flags.addr.i, align 4, !dbg !4812
  %53 = load i64, i64* %size.addr.i, align 8, !dbg !4813
  ...
  %54 = load %struct.kmem_cache*, %struct.kmem_cache** %s.addr.i.i, align 8, !dbg !4814
  %55 = load i32, i32* %flags.addr.i17.i, align 4, !dbg !4815
  %call.i19.i = call noalias i8* @kmem_cache_alloc(%struct.kmem_cache* %54, i32 %55) #8, !dbg !4816
  ...
  call void @llvm.assume(i1 %maskcond.i.i) #6, !dbg !4816
  store i8* %call.i19.i, i8** %ret.i.i, align 8, !dbg !4575
  %56 = load %struct.kmem_cache*, %struct.kmem_cache** %s.addr.i.i, align 8, !dbg !4817
  %57 = load i8*, i8** %ret.i.i, align 8, !dbg !4818
  %58 = load i64, i64* %size.addr.i18.i, align 8, !dbg !4819
  %59 = load i32, i32* %flags.addr.i17.i, align 4, !dbg !4820
  %call1.i.i = call i8* @kasan_kmalloc(%struct.kmem_cache* %56, i8* %57, i64 %58, i32 %59) #8, !dbg !4821
  store i8* %call1.i.i, i8** %ret.i.i, align 8, !dbg !4822
  %60 = load i8*, i8** %ret.i.i, align 8, !dbg !4823
  store i8* %60, i8** %retval.i, align 8, !dbg !4824
  br label %kmalloc.exit, !dbg !4824

if.end9.i:                                        ; preds = %entry
  %61 = load i64, i64* %size.addr.i, align 8, !dbg !4825
  %62 = load i32, i32* %flags.addr.i, align 4, !dbg !4826
  %call10.i = call noalias i8* @__kmalloc(i64 %61, i32 %62) #8, !dbg !4827
  ...
  call void @llvm.assume(i1 %maskcond.i) #6, !dbg !4827
  store i8* %call10.i, i8** %retval.i, align 8, !dbg !4828
  br label %kmalloc.exit, !dbg !4828

kmalloc.exit:                                     ; preds = %if.then1.i, %if.then3.i, %kmalloc_type.exit.i, %if.end9.i
  %63 = load i8*, i8** %retval.i, align 8, !dbg !4829
  %64 = bitcast i8* %63 to %struct.passthrough_dev_data*, !dbg !4830
  store %struct.passthrough_dev_data* %64, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !4831
  %65 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !4832
  %tobool = icmp ne %struct.passthrough_dev_data* %65, null, !dbg !4832
  br i1 %tobool, label %if.end, label %if.then, !dbg !4834

if.then:                                          ; preds = %kmalloc.exit
  store i32 -12, i32* %retval, align 4, !dbg !4835
...
do.body:                                          ; preds = %if.end
  %66 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !4837
  %lock = getelementptr inbounds %struct.passthrough_dev_data, %struct.passthrough_dev_data* %66, i32 0, i32 1, !dbg !4837
  call void @__mutex_init(%struct.mutex* %lock, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i64 0, i64 0), %struct.lock_class_key* @__xen_pcibk_init_devices.__key) #9, !dbg !4837
  br label %do.end, !dbg !4837

do.end:                                           ; preds = %do.body
  %67 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !4839
  %dev_list = getelementptr inbounds %struct.passthrough_dev_data, %struct.passthrough_dev_data* %67, i32 0, i32 0, !dbg !4840
  call void @INIT_LIST_HEAD(%struct.list_head* %dev_list) #9, !dbg !4841
  %68 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !4842
  %69 = bitcast %struct.passthrough_dev_data* %68 to i8*, !dbg !4842
  %70 = load %struct.xen_pcibk_device*, %struct.xen_pcibk_device** %pdev.addr, align 8, !dbg !4843
  %pci_dev_data = getelementptr inbounds %struct.xen_pcibk_device, %struct.xen_pcibk_device* %70, i32 0, i32 0, !dbg !4844
  store i8* %69, i8** %pci_dev_data, align 8, !dbg !4845
  store i32 0, i32* %retval, align 4, !dbg !4846
  br label %return, !dbg !4846

return:                                           ; preds = %do.end, %if.then
  %71 = load i32, i32* %retval, align 4, !dbg !4847
  ret i32 %71, !dbg !4847
}

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @__xen_pcibk_release_devices(%struct.xen_pcibk_device* %pdev) #0 !dbg !4848 {
entry:
  %pdev.addr = alloca %struct.xen_pcibk_device*, align 8
  %dev_data = alloca %struct.passthrough_dev_data*, align 8
  ...
  %tmp5 = alloca %struct.pci_dev_entry*, align 8
  %dev = alloca %struct.pci_dev*, align 8
  %__mptr13 = alloca i8*, align 8
  %tmp18 = alloca %struct.pci_dev_entry*, align 8
  store %struct.xen_pcibk_device* %pdev, %struct.xen_pcibk_device** %pdev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.xen_pcibk_device** %pdev.addr, metadata !4849, metadata !DIExpression()), !dbg !4850
  call void @llvm.dbg.declare(metadata %struct.passthrough_dev_data** %dev_data, metadata !4851, metadata !DIExpression()), !dbg !4852
  %0 = load %struct.xen_pcibk_device*, %struct.xen_pcibk_device** %pdev.addr, align 8, !dbg !4853
  %pci_dev_data = getelementptr inbounds %struct.xen_pcibk_device, %struct.xen_pcibk_device* %0, i32 0, i32 0, !dbg !4854
  %1 = load i8*, i8** %pci_dev_data, align 8, !dbg !4854
  %2 = bitcast i8* %1 to %struct.passthrough_dev_data*, !dbg !4853
  store %struct.passthrough_dev_data* %2, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !4852
  call void @llvm.dbg.declare(metadata %struct.pci_dev_entry** %dev_entry, metadata !4855, metadata !DIExpression()), !dbg !4856
  call void @llvm.dbg.declare(metadata %struct.pci_dev_entry** %t, metadata !4857, metadata !DIExpression()), !dbg !4858
  call void @llvm.dbg.declare(metadata i8** %__mptr, metadata !4859, metadata !DIExpression()), !dbg !4862
  %3 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !4862
  %dev_list = getelementptr inbounds %struct.passthrough_dev_data, %struct.passthrough_dev_data* %3, i32 0, i32 0, !dbg !4862
  %next = getelementptr inbounds %struct.list_head, %struct.list_head* %dev_list, i32 0, i32 0, !dbg !4862
  %4 = load %struct.list_head*, %struct.list_head** %next, align 8, !dbg !4862
  %5 = bitcast %struct.list_head* %4 to i8*, !dbg !4862
  store i8* %5, i8** %__mptr, align 8, !dbg !4862
...
do.end:                                           ; preds = %do.body
  %6 = load i8*, i8** %__mptr, align 8, !dbg !4862
  %add.ptr = getelementptr i8, i8* %6, i64 0, !dbg !4862
  %7 = bitcast i8* %add.ptr to %struct.pci_dev_entry*, !dbg !4862
  store %struct.pci_dev_entry* %7, %struct.pci_dev_entry** %tmp, align 8, !dbg !4863
  %8 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %tmp, align 8, !dbg !4862
  store %struct.pci_dev_entry* %8, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !4865
  call void @llvm.dbg.declare(metadata i8** %__mptr1, metadata !4866, metadata !DIExpression()), !dbg !4868
  %9 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !4868
  %list = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %9, i32 0, i32 0, !dbg !4868
  %next2 = getelementptr inbounds %struct.list_head, %struct.list_head* %list, i32 0, i32 0, !dbg !4868
  %10 = load %struct.list_head*, %struct.list_head** %next2, align 8, !dbg !4868
  %11 = bitcast %struct.list_head* %10 to i8*, !dbg !4868
  store i8* %11, i8** %__mptr1, align 8, !dbg !4868
  br label %do.body3, !dbg !4868

do.body3:                                         ; preds = %do.end
  br label %do.end4, !dbg !4869

do.end4:                                          ; preds = %do.body3
  %12 = load i8*, i8** %__mptr1, align 8, !dbg !4868
  %add.ptr6 = getelementptr i8, i8* %12, i64 0, !dbg !4868
  %13 = bitcast i8* %add.ptr6 to %struct.pci_dev_entry*, !dbg !4868
  store %struct.pci_dev_entry* %13, %struct.pci_dev_entry** %tmp5, align 8, !dbg !4869
  %14 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %tmp5, align 8, !dbg !4868
  store %struct.pci_dev_entry* %14, %struct.pci_dev_entry** %t, align 8, !dbg !4865
  br label %for.cond, !dbg !4865

for.cond:                                         ; preds = %do.end17, %do.end4
  %15 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !4871
  %list7 = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %15, i32 0, i32 0, !dbg !4871
  %16 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !4871
  %dev_list8 = getelementptr inbounds %struct.passthrough_dev_data, %struct.passthrough_dev_data* %16, i32 0, i32 0, !dbg !4871
  %cmp = icmp eq %struct.list_head* %list7, %dev_list8, !dbg !4871
  %lnot = xor i1 %cmp, true, !dbg !4871
  br i1 %lnot, label %for.body, label %for.end, !dbg !4865

for.body:                                         ; preds = %for.cond
  call void @llvm.dbg.declare(metadata %struct.pci_dev** %dev, metadata !4873, metadata !DIExpression()), !dbg !4875
  %17 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !4876
  %dev9 = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %17, i32 0, i32 1, !dbg !4877
  %18 = load %struct.pci_dev*, %struct.pci_dev** %dev9, align 8, !dbg !4877
  store %struct.pci_dev* %18, %struct.pci_dev** %dev, align 8, !dbg !4875
  %19 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !4878
  %list10 = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %19, i32 0, i32 0, !dbg !4879
  call void @list_del(%struct.list_head* %list10) #9, !dbg !4880
  %20 = load %struct.pci_dev*, %struct.pci_dev** %dev, align 8, !dbg !4881
  %dev11 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %20, i32 0, i32 41, !dbg !4882
  call void @device_lock(%struct.device* %dev11) #9, !dbg !4883
  %21 = load %struct.pci_dev*, %struct.pci_dev** %dev, align 8, !dbg !4884
  call void @pcistub_put_pci_dev(%struct.pci_dev* %21) #9, !dbg !4885
  %22 = load %struct.pci_dev*, %struct.pci_dev** %dev, align 8, !dbg !4886
  %dev12 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %22, i32 0, i32 41, !dbg !4887
  call void @device_unlock(%struct.device* %dev12) #9, !dbg !4888
  %23 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !4889
  %24 = bitcast %struct.pci_dev_entry* %23 to i8*, !dbg !4889
  call void @kfree(i8* %24) #9, !dbg !4890
  br label %for.inc, !dbg !4891

for.inc:                                          ; preds = %for.body
  %25 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %t, align 8, !dbg !4871
  store %struct.pci_dev_entry* %25, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !4871
  call void @llvm.dbg.declare(metadata i8** %__mptr13, metadata !4892, metadata !DIExpression()), !dbg !4894
  %26 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %t, align 8, !dbg !4894
  %list14 = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %26, i32 0, i32 0, !dbg !4894
  %next15 = getelementptr inbounds %struct.list_head, %struct.list_head* %list14, i32 0, i32 0, !dbg !4894
  %27 = load %struct.list_head*, %struct.list_head** %next15, align 8, !dbg !4894
  %28 = bitcast %struct.list_head* %27 to i8*, !dbg !4894
  store i8* %28, i8** %__mptr13, align 8, !dbg !4894
  br label %do.body16, !dbg !4894

do.body16:                                        ; preds = %for.inc
  br label %do.end17, !dbg !4895

do.end17:                                         ; preds = %do.body16
  %29 = load i8*, i8** %__mptr13, align 8, !dbg !4894
  %add.ptr19 = getelementptr i8, i8* %29, i64 0, !dbg !4894
  %30 = bitcast i8* %add.ptr19 to %struct.pci_dev_entry*, !dbg !4894
  store %struct.pci_dev_entry* %30, %struct.pci_dev_entry** %tmp18, align 8, !dbg !4895
  %31 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %tmp18, align 8, !dbg !4894
  store %struct.pci_dev_entry* %31, %struct.pci_dev_entry** %t, align 8, !dbg !4871
  br label %for.cond, !dbg !4871, !llvm.loop !4897

for.end:                                          ; preds = %for.cond
  %32 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !4899
  %33 = bitcast %struct.passthrough_dev_data* %32 to i8*, !dbg !4899
  call void @kfree(i8* %33) #9, !dbg !4900
  %34 = load %struct.xen_pcibk_device*, %struct.xen_pcibk_device** %pdev.addr, align 8, !dbg !4901
  %pci_dev_data20 = getelementptr inbounds %struct.xen_pcibk_device, %struct.xen_pcibk_device* %34, i32 0, i32 0, !dbg !4902
  store i8* null, i8** %pci_dev_data20, align 8, !dbg !4903
  ret void, !dbg !4904
}

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal i32 @__xen_pcibk_get_pcifront_dev(%struct.pci_dev* %pcidev, %struct.xen_pcibk_device* %pdev, i32* %domain, i32* %bus, i32* %devfn) #0 !dbg !4905 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.pci_dev** %pcidev.addr, metadata !4906, metadata !DIExpression()), !dbg !4907
  store %struct.xen_pcibk_device* %pdev, %struct.xen_pcibk_device** %pdev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.xen_pcibk_device** %pdev.addr, metadata !4908, metadata !DIExpression()), !dbg !4909
  store i32* %domain, i32** %domain.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %domain.addr, metadata !4910, metadata !DIExpression()), !dbg !4911
  store i32* %bus, i32** %bus.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %bus.addr, metadata !4912, metadata !DIExpression()), !dbg !4913
  store i32* %devfn, i32** %devfn.addr, align 8
  call void @llvm.dbg.declare(metadata i32** %devfn.addr, metadata !4914, metadata !DIExpression()), !dbg !4915
  %0 = load %struct.pci_dev*, %struct.pci_dev** %pcidev.addr, align 8, !dbg !4916
  %bus1 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %0, i32 0, i32 1, !dbg !4917
  %1 = load %struct.pci_bus*, %struct.pci_bus** %bus1, align 8, !dbg !4917
  %call = call i32 @pci_domain_nr(%struct.pci_bus* %1) #9, !dbg !4918
  %2 = load i32*, i32** %domain.addr, align 8, !dbg !4919
  store i32 %call, i32* %2, align 4, !dbg !4920
  %3 = load %struct.pci_dev*, %struct.pci_dev** %pcidev.addr, align 8, !dbg !4921
  %bus2 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %3, i32 0, i32 1, !dbg !4922
  %4 = load %struct.pci_bus*, %struct.pci_bus** %bus2, align 8, !dbg !4922
  %number = getelementptr inbounds %struct.pci_bus, %struct.pci_bus* %4, i32 0, i32 13, !dbg !4923
  %5 = load i8, i8* %number, align 8, !dbg !4923
  %conv = zext i8 %5 to i32, !dbg !4921
  %6 = load i32*, i32** %bus.addr, align 8, !dbg !4924
  store i32 %conv, i32* %6, align 4, !dbg !4925
  %7 = load %struct.pci_dev*, %struct.pci_dev** %pcidev.addr, align 8, !dbg !4926
  %devfn3 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %7, i32 0, i32 6, !dbg !4927
  %8 = load i32, i32* %devfn3, align 8, !dbg !4927
  %9 = load i32*, i32** %devfn.addr, align 8, !dbg !4928
  store i32 %8, i32* %9, align 4, !dbg !4929
  ret i32 1, !dbg !4930
}

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal i32 @__xen_pcibk_publish_pci_roots(%struct.xen_pcibk_device* %pdev, i32 (%struct.xen_pcibk_device*, i32, i32)* %publish_root_cb) #0 !dbg !4931 {
entry:
  %pdev.addr = alloca %struct.xen_pcibk_device*, align 8
  %publish_root_cb.addr = alloca i32 (%struct.xen_pcibk_device*, i32, i32)*, align 8
  ...
  %tmp12 = alloca %struct.pci_dev_entry*, align 8
  %__mptr22 = alloca i8*, align 8
  %tmp27 = alloca %struct.pci_dev_entry*, align 8
  %__mptr45 = alloca i8*, align 8
  %tmp50 = alloca %struct.pci_dev_entry*, align 8
  store %struct.xen_pcibk_device* %pdev, %struct.xen_pcibk_device** %pdev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.xen_pcibk_device** %pdev.addr, metadata !4932, metadata !DIExpression()), !dbg !4933
  store i32 (%struct.xen_pcibk_device*, i32, i32)* %publish_root_cb, i32 (%struct.xen_pcibk_device*, i32, i32)** %publish_root_cb.addr, align 8
  call void @llvm.dbg.declare(metadata i32 (%struct.xen_pcibk_device*, i32, i32)** %publish_root_cb.addr, metadata !4934, metadata !DIExpression()), !dbg !4935
  call void @llvm.dbg.declare(metadata i32* %err, metadata !4936, metadata !DIExpression()), !dbg !4937
  store i32 0, i32* %err, align 4, !dbg !4937
  call void @llvm.dbg.declare(metadata %struct.passthrough_dev_data** %dev_data, metadata !4938, metadata !DIExpression()), !dbg !4939
  %0 = load %struct.xen_pcibk_device*, %struct.xen_pcibk_device** %pdev.addr, align 8, !dbg !4940
  %pci_dev_data = getelementptr inbounds %struct.xen_pcibk_device, %struct.xen_pcibk_device* %0, i32 0, i32 0, !dbg !4941
  %1 = load i8*, i8** %pci_dev_data, align 8, !dbg !4941
  %2 = bitcast i8* %1 to %struct.passthrough_dev_data*, !dbg !4940
  store %struct.passthrough_dev_data* %2, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !4939
  call void @llvm.dbg.declare(metadata %struct.pci_dev_entry** %dev_entry, metadata !4942, metadata !DIExpression()), !dbg !4943
  call void @llvm.dbg.declare(metadata %struct.pci_dev_entry** %e, metadata !4944, metadata !DIExpression()), !dbg !4945
  call void @llvm.dbg.declare(metadata %struct.pci_dev** %dev, metadata !4946, metadata !DIExpression()), !dbg !4947
  call void @llvm.dbg.declare(metadata i32* %found, metadata !4948, metadata !DIExpression()), !dbg !4949
  call void @llvm.dbg.declare(metadata i32* %domain, metadata !4950, metadata !DIExpression()), !dbg !4951
  call void @llvm.dbg.declare(metadata i32* %bus, metadata !4952, metadata !DIExpression()), !dbg !4953
  %3 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !4954
  %lock = getelementptr inbounds %struct.passthrough_dev_data, %struct.passthrough_dev_data* %3, i32 0, i32 1, !dbg !4955
  call void @mutex_lock(%struct.mutex* %lock) #9, !dbg !4956
  call void @llvm.dbg.declare(metadata i8** %__mptr, metadata !4957, metadata !DIExpression()), !dbg !4960
  %4 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !4960
  %dev_list = getelementptr inbounds %struct.passthrough_dev_data, %struct.passthrough_dev_data* %4, i32 0, i32 0, !dbg !4960
  %next = getelementptr inbounds %struct.list_head, %struct.list_head* %dev_list, i32 0, i32 0, !dbg !4960
  %5 = load %struct.list_head*, %struct.list_head** %next, align 8, !dbg !4960
  %6 = bitcast %struct.list_head* %5 to i8*, !dbg !4960
  store i8* %6, i8** %__mptr, align 8, !dbg !4960
  br label %do.body, !dbg !4960

do.body:                                          ; preds = %entry
  br label %do.end, !dbg !4961

do.end:                                           ; preds = %do.body
  %7 = load i8*, i8** %__mptr, align 8, !dbg !4960
  %add.ptr = getelementptr i8, i8* %7, i64 0, !dbg !4960
  %8 = bitcast i8* %add.ptr to %struct.pci_dev_entry*, !dbg !4960
  store %struct.pci_dev_entry* %8, %struct.pci_dev_entry** %tmp, align 8, !dbg !4961
  %9 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %tmp, align 8, !dbg !4960
  store %struct.pci_dev_entry* %9, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !4963
  br label %for.cond, !dbg !4963

for.cond:                                         ; preds = %do.end49, %do.end
  %10 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !4964
  %list = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %10, i32 0, i32 0, !dbg !4964
  %11 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !4964
  %dev_list1 = getelementptr inbounds %struct.passthrough_dev_data, %struct.passthrough_dev_data* %11, i32 0, i32 0, !dbg !4964
  %cmp = icmp eq %struct.list_head* %list, %dev_list1, !dbg !4964
  %lnot = xor i1 %cmp, true, !dbg !4964
  br i1 %lnot, label %for.body, label %for.end52, !dbg !4963

for.body:                                         ; preds = %for.cond
  store i32 0, i32* %found, align 4, !dbg !4966
  %12 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !4968
  %dev2 = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %12, i32 0, i32 1, !dbg !4969
  %13 = load %struct.pci_dev*, %struct.pci_dev** %dev2, align 8, !dbg !4969
  %bus3 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %13, i32 0, i32 1, !dbg !4970
  %14 = load %struct.pci_bus*, %struct.pci_bus** %bus3, align 8, !dbg !4970
  %self = getelementptr inbounds %struct.pci_bus, %struct.pci_bus* %14, i32 0, i32 4, !dbg !4971
  %15 = load %struct.pci_dev*, %struct.pci_dev** %self, align 8, !dbg !4971
  store %struct.pci_dev* %15, %struct.pci_dev** %dev, align 8, !dbg !4972
  br label %for.cond4, !dbg !4973

for.cond4:                                        ; preds = %for.inc29, %for.body
  %16 = load i32, i32* %found, align 4, !dbg !4974
  %tobool = icmp ne i32 %16, 0, !dbg !4974
  br i1 %tobool, label %land.end, label %land.rhs, !dbg !4977

land.rhs:                                         ; preds = %for.cond4
  %17 = load %struct.pci_dev*, %struct.pci_dev** %dev, align 8, !dbg !4978
  %cmp5 = icmp ne %struct.pci_dev* %17, null, !dbg !4979
  br label %land.end

land.end:                                         ; preds = %land.rhs, %for.cond4
  %18 = phi i1 [ false, %for.cond4 ], [ %cmp5, %land.rhs ], !dbg !4980
  br i1 %18, label %for.body6, label %for.end32, !dbg !4981

for.body6:                                        ; preds = %land.end
  call void @llvm.dbg.declare(metadata i8** %__mptr7, metadata !4982, metadata !DIExpression()), !dbg !4986
  %19 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !4986
  %dev_list8 = getelementptr inbounds %struct.passthrough_dev_data, %struct.passthrough_dev_data* %19, i32 0, i32 0, !dbg !4986
  %next9 = getelementptr inbounds %struct.list_head, %struct.list_head* %dev_list8, i32 0, i32 0, !dbg !4986
  %20 = load %struct.list_head*, %struct.list_head** %next9, align 8, !dbg !4986
  %21 = bitcast %struct.list_head* %20 to i8*, !dbg !4986
  store i8* %21, i8** %__mptr7, align 8, !dbg !4986
  br label %do.body10, !dbg !4986

do.body10:                                        ; preds = %for.body6
  br label %do.end11, !dbg !4987

do.end11:                                         ; preds = %do.body10
  %22 = load i8*, i8** %__mptr7, align 8, !dbg !4986
  %add.ptr13 = getelementptr i8, i8* %22, i64 0, !dbg !4986
  %23 = bitcast i8* %add.ptr13 to %struct.pci_dev_entry*, !dbg !4986
  store %struct.pci_dev_entry* %23, %struct.pci_dev_entry** %tmp12, align 8, !dbg !4987
  %24 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %tmp12, align 8, !dbg !4986
  store %struct.pci_dev_entry* %24, %struct.pci_dev_entry** %e, align 8, !dbg !4989
  br label %for.cond14, !dbg !4989

for.cond14:                                       ; preds = %do.end26, %do.end11
  %25 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %e, align 8, !dbg !4990
  %list15 = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %25, i32 0, i32 0, !dbg !4990
  %26 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !4990
  %dev_list16 = getelementptr inbounds %struct.passthrough_dev_data, %struct.passthrough_dev_data* %26, i32 0, i32 0, !dbg !4990
  %cmp17 = icmp eq %struct.list_head* %list15, %dev_list16, !dbg !4990
  %lnot18 = xor i1 %cmp17, true, !dbg !4990
  br i1 %lnot18, label %for.body19, label %for.end, !dbg !4989

for.body19:                                       ; preds = %for.cond14
  %27 = load %struct.pci_dev*, %struct.pci_dev** %dev, align 8, !dbg !4992
  %28 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %e, align 8, !dbg !4995
  %dev20 = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %28, i32 0, i32 1, !dbg !4996
  %29 = load %struct.pci_dev*, %struct.pci_dev** %dev20, align 8, !dbg !4996
  %cmp21 = icmp eq %struct.pci_dev* %27, %29, !dbg !4997
  br i1 %cmp21, label %if.then, label %if.end, !dbg !4998

if.then:                                          ; preds = %for.body19
  store i32 1, i32* %found, align 4, !dbg !4999
...
for.inc:                                          ; preds = %if.end
  call void @llvm.dbg.declare(metadata i8** %__mptr22, metadata !5003, metadata !DIExpression()), !dbg !5005
  %30 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %e, align 8, !dbg !5005
  %list23 = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %30, i32 0, i32 0, !dbg !5005
  %next24 = getelementptr inbounds %struct.list_head, %struct.list_head* %list23, i32 0, i32 0, !dbg !5005
  %31 = load %struct.list_head*, %struct.list_head** %next24, align 8, !dbg !5005
  %32 = bitcast %struct.list_head* %31 to i8*, !dbg !5005
  store i8* %32, i8** %__mptr22, align 8, !dbg !5005
  br label %do.body25, !dbg !5005

do.body25:                                        ; preds = %for.inc
  br label %do.end26, !dbg !5006

do.end26:                                         ; preds = %do.body25
  %33 = load i8*, i8** %__mptr22, align 8, !dbg !5005
  %add.ptr28 = getelementptr i8, i8* %33, i64 0, !dbg !5005
  %34 = bitcast i8* %add.ptr28 to %struct.pci_dev_entry*, !dbg !5005
  store %struct.pci_dev_entry* %34, %struct.pci_dev_entry** %tmp27, align 8, !dbg !5006
  %35 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %tmp27, align 8, !dbg !5005
  store %struct.pci_dev_entry* %35, %struct.pci_dev_entry** %e, align 8, !dbg !4990
  br label %for.cond14, !dbg !4990, !llvm.loop !5008

for.end:                                          ; preds = %if.then, %for.cond14
  br label %for.inc29, !dbg !5010

for.inc29:                                        ; preds = %for.end
  %36 = load %struct.pci_dev*, %struct.pci_dev** %dev, align 8, !dbg !5011
  %bus30 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %36, i32 0, i32 1, !dbg !5012
  %37 = load %struct.pci_bus*, %struct.pci_bus** %bus30, align 8, !dbg !5012
  %self31 = getelementptr inbounds %struct.pci_bus, %struct.pci_bus* %37, i32 0, i32 4, !dbg !5013
  %38 = load %struct.pci_dev*, %struct.pci_dev** %self31, align 8, !dbg !5013
  store %struct.pci_dev* %38, %struct.pci_dev** %dev, align 8, !dbg !5014
  br label %for.cond4, !dbg !5015, !llvm.loop !5016

for.end32:                                        ; preds = %land.end
  %39 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5018
  %dev33 = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %39, i32 0, i32 1, !dbg !5019
  %40 = load %struct.pci_dev*, %struct.pci_dev** %dev33, align 8, !dbg !5019
  %bus34 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %40, i32 0, i32 1, !dbg !5020
  %41 = load %struct.pci_bus*, %struct.pci_bus** %bus34, align 8, !dbg !5020
  %call = call i32 @pci_domain_nr(%struct.pci_bus* %41) #9, !dbg !5021
  store i32 %call, i32* %domain, align 4, !dbg !5022
  %42 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5023
  %dev35 = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %42, i32 0, i32 1, !dbg !5024
  %43 = load %struct.pci_dev*, %struct.pci_dev** %dev35, align 8, !dbg !5024
  %bus36 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %43, i32 0, i32 1, !dbg !5025
  %44 = load %struct.pci_bus*, %struct.pci_bus** %bus36, align 8, !dbg !5025
  %number = getelementptr inbounds %struct.pci_bus, %struct.pci_bus* %44, i32 0, i32 13, !dbg !5026
  %45 = load i8, i8* %number, align 8, !dbg !5026
  %conv = zext i8 %45 to i32, !dbg !5027
  store i32 %conv, i32* %bus, align 4, !dbg !5028
  %46 = load i32, i32* %found, align 4, !dbg !5029
  %tobool37 = icmp ne i32 %46, 0, !dbg !5029
  br i1 %tobool37, label %if.end43, label %if.then38, !dbg !5031

if.then38:                                        ; preds = %for.end32
  %47 = load i32 (%struct.xen_pcibk_device*, i32, i32)*, i32 (%struct.xen_pcibk_device*, i32, i32)** %publish_root_cb.addr, align 8, !dbg !5032
  %48 = load %struct.xen_pcibk_device*, %struct.xen_pcibk_device** %pdev.addr, align 8, !dbg !5034
  %49 = load i32, i32* %domain, align 4, !dbg !5035
  %50 = load i32, i32* %bus, align 4, !dbg !5036
  %call39 = call i32 %47(%struct.xen_pcibk_device* %48, i32 %49, i32 %50) #9, !dbg !5032
  store i32 %call39, i32* %err, align 4, !dbg !5037
  %51 = load i32, i32* %err, align 4, !dbg !5038
  %tobool40 = icmp ne i32 %51, 0, !dbg !5038
  br i1 %tobool40, label %if.then41, label %if.end42, !dbg !5040

if.then41:                                        ; preds = %if.then38
  br label %for.end52, !dbg !5041

if.end42:                                         ; preds = %if.then38
  br label %if.end43, !dbg !5042

if.end43:                                         ; preds = %if.end42, %for.end32
  br label %for.inc44, !dbg !5043

for.inc44:                                        ; preds = %if.end43
  call void @llvm.dbg.declare(metadata i8** %__mptr45, metadata !5044, metadata !DIExpression()), !dbg !5046
  %52 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5046
  %list46 = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %52, i32 0, i32 0, !dbg !5046
  %next47 = getelementptr inbounds %struct.list_head, %struct.list_head* %list46, i32 0, i32 0, !dbg !5046
  %53 = load %struct.list_head*, %struct.list_head** %next47, align 8, !dbg !5046
  %54 = bitcast %struct.list_head* %53 to i8*, !dbg !5046
  store i8* %54, i8** %__mptr45, align 8, !dbg !5046
  br label %do.body48, !dbg !5046

do.body48:                                        ; preds = %for.inc44
  br label %do.end49, !dbg !5047

do.end49:                                         ; preds = %do.body48
  %55 = load i8*, i8** %__mptr45, align 8, !dbg !5046
  %add.ptr51 = getelementptr i8, i8* %55, i64 0, !dbg !5046
  %56 = bitcast i8* %add.ptr51 to %struct.pci_dev_entry*, !dbg !5046
  store %struct.pci_dev_entry* %56, %struct.pci_dev_entry** %tmp50, align 8, !dbg !5047
  %57 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %tmp50, align 8, !dbg !5046
  store %struct.pci_dev_entry* %57, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !4964
  br label %for.cond, !dbg !4964, !llvm.loop !5049

for.end52:                                        ; preds = %if.then41, %for.cond
  %58 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !5051
  %lock53 = getelementptr inbounds %struct.passthrough_dev_data, %struct.passthrough_dev_data* %58, i32 0, i32 1, !dbg !5052
  call void @mutex_unlock(%struct.mutex* %lock53) #9, !dbg !5053
  %59 = load i32, i32* %err, align 4, !dbg !5054
  ret i32 %59, !dbg !5055
}

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @__xen_pcibk_release_pci_dev(%struct.xen_pcibk_device* %pdev, %struct.pci_dev* %dev, i1 zeroext %lock) #0 !dbg !5056 {
entry:
  %pdev.addr = alloca %struct.xen_pcibk_device*, align 8
  ...
  %tmp19 = alloca %struct.pci_dev_entry*, align 8
  store %struct.xen_pcibk_device* %pdev, %struct.xen_pcibk_device** %pdev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.xen_pcibk_device** %pdev.addr, metadata !5057, metadata !DIExpression()), !dbg !5058
  store %struct.pci_dev* %dev, %struct.pci_dev** %dev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.pci_dev** %dev.addr, metadata !5059, metadata !DIExpression()), !dbg !5060
  %frombool = zext i1 %lock to i8
  store i8 %frombool, i8* %lock.addr, align 1
  call void @llvm.dbg.declare(metadata i8* %lock.addr, metadata !5061, metadata !DIExpression()), !dbg !5062
  call void @llvm.dbg.declare(metadata %struct.passthrough_dev_data** %dev_data, metadata !5063, metadata !DIExpression()), !dbg !5064
  %0 = load %struct.xen_pcibk_device*, %struct.xen_pcibk_device** %pdev.addr, align 8, !dbg !5065
  %pci_dev_data = getelementptr inbounds %struct.xen_pcibk_device, %struct.xen_pcibk_device* %0, i32 0, i32 0, !dbg !5066
  %1 = load i8*, i8** %pci_dev_data, align 8, !dbg !5066
  %2 = bitcast i8* %1 to %struct.passthrough_dev_data*, !dbg !5065
  store %struct.passthrough_dev_data* %2, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !5064
  call void @llvm.dbg.declare(metadata %struct.pci_dev_entry** %dev_entry, metadata !5067, metadata !DIExpression()), !dbg !5068
  call void @llvm.dbg.declare(metadata %struct.pci_dev_entry** %t, metadata !5069, metadata !DIExpression()), !dbg !5070
  call void @llvm.dbg.declare(metadata %struct.pci_dev** %found_dev, metadata !5071, metadata !DIExpression()), !dbg !5072
  store %struct.pci_dev* null, %struct.pci_dev** %found_dev, align 8, !dbg !5072
  %3 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !5073
  %lock1 = getelementptr inbounds %struct.passthrough_dev_data, %struct.passthrough_dev_data* %3, i32 0, i32 1, !dbg !5074
  call void @mutex_lock(%struct.mutex* %lock1) #9, !dbg !5075
  call void @llvm.dbg.declare(metadata i8** %__mptr, metadata !5076, metadata !DIExpression()), !dbg !5079
  %4 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !5079
  %dev_list = getelementptr inbounds %struct.passthrough_dev_data, %struct.passthrough_dev_data* %4, i32 0, i32 0, !dbg !5079
  %next = getelementptr inbounds %struct.list_head, %struct.list_head* %dev_list, i32 0, i32 0, !dbg !5079
  %5 = load %struct.list_head*, %struct.list_head** %next, align 8, !dbg !5079
  %6 = bitcast %struct.list_head* %5 to i8*, !dbg !5079
  store i8* %6, i8** %__mptr, align 8, !dbg !5079
...
do.end:                                           ; preds = %do.body
  %7 = load i8*, i8** %__mptr, align 8, !dbg !5079
  %add.ptr = getelementptr i8, i8* %7, i64 0, !dbg !5079
  %8 = bitcast i8* %add.ptr to %struct.pci_dev_entry*, !dbg !5079
  store %struct.pci_dev_entry* %8, %struct.pci_dev_entry** %tmp, align 8, !dbg !5080
  %9 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %tmp, align 8, !dbg !5079
  store %struct.pci_dev_entry* %9, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5082
  call void @llvm.dbg.declare(metadata i8** %__mptr2, metadata !5083, metadata !DIExpression()), !dbg !5085
  %10 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5085
  %list = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %10, i32 0, i32 0, !dbg !5085
  %next3 = getelementptr inbounds %struct.list_head, %struct.list_head* %list, i32 0, i32 0, !dbg !5085
  %11 = load %struct.list_head*, %struct.list_head** %next3, align 8, !dbg !5085
  %12 = bitcast %struct.list_head* %11 to i8*, !dbg !5085
  store i8* %12, i8** %__mptr2, align 8, !dbg !5085
  br label %do.body4, !dbg !5085

do.body4:                                         ; preds = %do.end
  br label %do.end5, !dbg !5086

do.end5:                                          ; preds = %do.body4
  %13 = load i8*, i8** %__mptr2, align 8, !dbg !5085
  %add.ptr7 = getelementptr i8, i8* %13, i64 0, !dbg !5085
  %14 = bitcast i8* %add.ptr7 to %struct.pci_dev_entry*, !dbg !5085
  store %struct.pci_dev_entry* %14, %struct.pci_dev_entry** %tmp6, align 8, !dbg !5086
  %15 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %tmp6, align 8, !dbg !5085
  store %struct.pci_dev_entry* %15, %struct.pci_dev_entry** %t, align 8, !dbg !5082
  br label %for.cond, !dbg !5082

for.cond:                                         ; preds = %do.end18, %do.end5
  %16 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5088
  %list8 = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %16, i32 0, i32 0, !dbg !5088
  %17 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !5088
  %dev_list9 = getelementptr inbounds %struct.passthrough_dev_data, %struct.passthrough_dev_data* %17, i32 0, i32 0, !dbg !5088
  %cmp = icmp eq %struct.list_head* %list8, %dev_list9, !dbg !5088
  %lnot = xor i1 %cmp, true, !dbg !5088
  br i1 %lnot, label %for.body, label %for.end, !dbg !5082

for.body:                                         ; preds = %for.cond
  %18 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5090
  %dev10 = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %18, i32 0, i32 1, !dbg !5093
  %19 = load %struct.pci_dev*, %struct.pci_dev** %dev10, align 8, !dbg !5093
  %20 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !5094
  %cmp11 = icmp eq %struct.pci_dev* %19, %20, !dbg !5095
  br i1 %cmp11, label %if.then, label %if.end, !dbg !5096

if.then:                                          ; preds = %for.body
  %21 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5097
  %list12 = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %21, i32 0, i32 0, !dbg !5099
  call void @list_del(%struct.list_head* %list12) #9, !dbg !5100
  %22 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5101
  %dev13 = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %22, i32 0, i32 1, !dbg !5102
  %23 = load %struct.pci_dev*, %struct.pci_dev** %dev13, align 8, !dbg !5102
  store %struct.pci_dev* %23, %struct.pci_dev** %found_dev, align 8, !dbg !5103
  %24 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5104
  %25 = bitcast %struct.pci_dev_entry* %24 to i8*, !dbg !5104
  call void @kfree(i8* %25) #9, !dbg !5105
...
for.inc:                                          ; preds = %if.end
  %26 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %t, align 8, !dbg !5088
  store %struct.pci_dev_entry* %26, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5088
  call void @llvm.dbg.declare(metadata i8** %__mptr14, metadata !5108, metadata !DIExpression()), !dbg !5110
  %27 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %t, align 8, !dbg !5110
  %list15 = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %27, i32 0, i32 0, !dbg !5110
  %next16 = getelementptr inbounds %struct.list_head, %struct.list_head* %list15, i32 0, i32 0, !dbg !5110
  %28 = load %struct.list_head*, %struct.list_head** %next16, align 8, !dbg !5110
  %29 = bitcast %struct.list_head* %28 to i8*, !dbg !5110
  store i8* %29, i8** %__mptr14, align 8, !dbg !5110
  br label %do.body17, !dbg !5110

do.body17:                                        ; preds = %for.inc
  br label %do.end18, !dbg !5111

do.end18:                                         ; preds = %do.body17
  %30 = load i8*, i8** %__mptr14, align 8, !dbg !5110
  %add.ptr20 = getelementptr i8, i8* %30, i64 0, !dbg !5110
  %31 = bitcast i8* %add.ptr20 to %struct.pci_dev_entry*, !dbg !5110
  store %struct.pci_dev_entry* %31, %struct.pci_dev_entry** %tmp19, align 8, !dbg !5111
  %32 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %tmp19, align 8, !dbg !5110
  store %struct.pci_dev_entry* %32, %struct.pci_dev_entry** %t, align 8, !dbg !5088
  br label %for.cond, !dbg !5088, !llvm.loop !5113

for.end:                                          ; preds = %for.cond
  %33 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !5115
  %lock21 = getelementptr inbounds %struct.passthrough_dev_data, %struct.passthrough_dev_data* %33, i32 0, i32 1, !dbg !5116
  call void @mutex_unlock(%struct.mutex* %lock21) #9, !dbg !5117
  %34 = load %struct.pci_dev*, %struct.pci_dev** %found_dev, align 8, !dbg !5118
  %tobool = icmp ne %struct.pci_dev* %34, null, !dbg !5118
  br i1 %tobool, label %if.then22, label %if.end31, !dbg !5120

if.then22:                                        ; preds = %for.end
  %35 = load i8, i8* %lock.addr, align 1, !dbg !5121
  %tobool23 = trunc i8 %35 to i1, !dbg !5121
  br i1 %tobool23, label %if.then24, label %if.end26, !dbg !5124

if.then24:                                        ; preds = %if.then22
  %36 = load %struct.pci_dev*, %struct.pci_dev** %found_dev, align 8, !dbg !5125
  %dev25 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %36, i32 0, i32 41, !dbg !5126
  call void @device_lock(%struct.device* %dev25) #9, !dbg !5127
  br label %if.end26, !dbg !5127

if.end26:                                         ; preds = %if.then24, %if.then22
  %37 = load %struct.pci_dev*, %struct.pci_dev** %found_dev, align 8, !dbg !5128
  call void @pcistub_put_pci_dev(%struct.pci_dev* %37) #9, !dbg !5129
  %38 = load i8, i8* %lock.addr, align 1, !dbg !5130
  %tobool27 = trunc i8 %38 to i1, !dbg !5130
  br i1 %tobool27, label %if.then28, label %if.end30, !dbg !5132

if.then28:                                        ; preds = %if.end26
  %39 = load %struct.pci_dev*, %struct.pci_dev** %found_dev, align 8, !dbg !5133
  %dev29 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %39, i32 0, i32 41, !dbg !5134
  call void @device_unlock(%struct.device* %dev29) #9, !dbg !5135
  br label %if.end30, !dbg !5135

if.end30:                                         ; preds = %if.then28, %if.end26
  br label %if.end31, !dbg !5136
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal i32 @__xen_pcibk_add_pci_dev(%struct.xen_pcibk_device* %pdev, %struct.pci_dev* %dev, i32 %devid, i32 (%struct.xen_pcibk_device*, i32, i32, i32, i32)* %publish_cb) #0 !dbg !5138 {
entry:
  %s.addr.i.i = alloca %struct.kmem_cache*, align 8
  call void @llvm.dbg.declare(metadata %struct.kmem_cache** %s.addr.i.i, metadata !4558, metadata !DIExpression()), !dbg !5139
  %flags.addr.i17.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr.i17.i, metadata !4570, metadata !DIExpression()), !dbg !5142
  %size.addr.i18.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr.i18.i, metadata !4572, metadata !DIExpression()), !dbg !5143
  %ret.i.i = alloca i8*, align 8
  call void @llvm.dbg.declare(metadata i8** %ret.i.i, metadata !4574, metadata !DIExpression()), !dbg !5144
  %retval.i12.i = alloca i32, align 4
  %flags.addr.i13.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr.i13.i, metadata !4576, metadata !DIExpression()), !dbg !5145
  %retval.i.i = alloca i32, align 4
  %size.addr.i11.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr.i11.i, metadata !4582, metadata !DIExpression()), !dbg !5147
  %size.addr.i.i.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr.i.i.i, metadata !4588, metadata !DIExpression()), !dbg !5149
  %flags.addr.i.i.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr.i.i.i, metadata !4597, metadata !DIExpression()), !dbg !5152
  %order.addr.i.i.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %order.addr.i.i.i, metadata !4599, metadata !DIExpression()), !dbg !5153
  %size.addr.i.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr.i.i, metadata !4601, metadata !DIExpression()), !dbg !5154
  %flags.addr.i.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr.i.i, metadata !4603, metadata !DIExpression()), !dbg !5155
  %order.i.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %order.i.i, metadata !4605, metadata !DIExpression()), !dbg !5156
  %retval.i = alloca i8*, align 8
  %size.addr.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr.i, metadata !4607, metadata !DIExpression()), !dbg !5157
  %flags.addr.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr.i, metadata !4609, metadata !DIExpression()), !dbg !5158
  %index.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %index.i, metadata !4611, metadata !DIExpression()), !dbg !5159
  %retval = alloca i32, align 4
  %pdev.addr = alloca %struct.xen_pcibk_device*, align 8
  %dev.addr = alloca %struct.pci_dev*, align 8
  ...
  %err = alloca i32, align 4
  store %struct.xen_pcibk_device* %pdev, %struct.xen_pcibk_device** %pdev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.xen_pcibk_device** %pdev.addr, metadata !5160, metadata !DIExpression()), !dbg !5161
  store %struct.pci_dev* %dev, %struct.pci_dev** %dev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.pci_dev** %dev.addr, metadata !5162, metadata !DIExpression()), !dbg !5163
  store i32 %devid, i32* %devid.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %devid.addr, metadata !5164, metadata !DIExpression()), !dbg !5165
  ...
  call void @llvm.dbg.declare(metadata i32 (%struct.xen_pcibk_device*, i32, i32, i32, i32)** %publish_cb.addr, metadata !5166, metadata !DIExpression()), !dbg !5167
  call void @llvm.dbg.declare(metadata %struct.passthrough_dev_data** %dev_data, metadata !5168, metadata !DIExpression()), !dbg !5169
  %0 = load %struct.xen_pcibk_device*, %struct.xen_pcibk_device** %pdev.addr, align 8, !dbg !5170
  %pci_dev_data = getelementptr inbounds %struct.xen_pcibk_device, %struct.xen_pcibk_device* %0, i32 0, i32 0, !dbg !5171
  %1 = load i8*, i8** %pci_dev_data, align 8, !dbg !5171
  %2 = bitcast i8* %1 to %struct.passthrough_dev_data*, !dbg !5170
  store %struct.passthrough_dev_data* %2, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !5169
  call void @llvm.dbg.declare(metadata %struct.pci_dev_entry** %dev_entry, metadata !5172, metadata !DIExpression()), !dbg !5173
  call void @llvm.dbg.declare(metadata i32* %domain, metadata !5174, metadata !DIExpression()), !dbg !5175
  call void @llvm.dbg.declare(metadata i32* %bus, metadata !5176, metadata !DIExpression()), !dbg !5177
  call void @llvm.dbg.declare(metadata i32* %devfn, metadata !5178, metadata !DIExpression()), !dbg !5179
  call void @llvm.dbg.declare(metadata i32* %err, metadata !5180, metadata !DIExpression()), !dbg !5181
  store i64 24, i64* %size.addr.i, align 8
  store i32 3264, i32* %flags.addr.i, align 4
  %3 = load i64, i64* %size.addr.i, align 8, !dbg !5182
  %4 = call i1 @llvm.is.constant.i64(i64 %3) #6, !dbg !5183
  br i1 %4, label %if.then.i, label %if.end9.i, !dbg !5184

if.then.i:                                        ; preds = %entry
  %5 = load i64, i64* %size.addr.i, align 8, !dbg !5185
  %cmp.i = icmp ugt i64 %5, 8192, !dbg !5186
  br i1 %cmp.i, label %if.then1.i, label %if.end.i, !dbg !5187

if.then1.i:                                       ; preds = %if.then.i
  %6 = load i64, i64* %size.addr.i, align 8, !dbg !5188
  %7 = load i32, i32* %flags.addr.i, align 4, !dbg !5189
  store i64 %6, i64* %size.addr.i.i, align 8
  store i32 %7, i32* %flags.addr.i.i, align 4
  %8 = load i64, i64* %size.addr.i.i, align 8, !dbg !5190
  %call.i.i = call i32 @get_order(i64 %8) #7, !dbg !5191
  store i32 %call.i.i, i32* %order.i.i, align 4, !dbg !5156
  %9 = load i64, i64* %size.addr.i.i, align 8, !dbg !5192
  %10 = load i32, i32* %flags.addr.i.i, align 4, !dbg !5193
  %11 = load i32, i32* %order.i.i, align 4, !dbg !5194
  ...
  %12 = load i64, i64* %size.addr.i.i.i, align 8, !dbg !5195
  %13 = load i32, i32* %flags.addr.i.i.i, align 4, !dbg !5196
  %14 = load i32, i32* %order.addr.i.i.i, align 4, !dbg !5197
  %call.i.i.i = call noalias i8* @kmalloc_order(i64 %12, i32 %13, i32 %14) #8, !dbg !5198
...
if.end.i.i:                                       ; preds = %if.end.i
  ...
  %cmp.i.i = icmp ule i64 %17, 8, !dbg !5205
...
if.end2.i.i:                                      ; preds = %if.end.i.i
  ...
  %cmp3.i.i = icmp ugt i64 %18, 64, !dbg !5209
  br i1 %cmp3.i.i, label %land.lhs.true.i.i, label %if.end6.i.i, !dbg !5210

land.lhs.true.i.i:                                ; preds = %if.end2.i.i
  %19 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5211
  %cmp4.i.i = icmp ule i64 %19, 96, !dbg !5212
...
if.end6.i.i:                                      ; preds = %land.lhs.true.i.i, %if.end2.i.i
  %20 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5215
  %cmp7.i.i = icmp ugt i64 %20, 128, !dbg !5216
  br i1 %cmp7.i.i, label %land.lhs.true8.i.i, label %if.end11.i.i, !dbg !5217

land.lhs.true8.i.i:                               ; preds = %if.end6.i.i
  %21 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5218
  %cmp9.i.i = icmp ule i64 %21, 192, !dbg !5219
...
if.end11.i.i:                                     ; preds = %land.lhs.true8.i.i, %if.end6.i.i
  %22 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5222
  %cmp12.i.i = icmp ule i64 %22, 8, !dbg !5223
...
if.end14.i.i:                                     ; preds = %if.end11.i.i
  %23 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5226
  %cmp15.i.i = icmp ule i64 %23, 16, !dbg !5227
...
if.end17.i.i:                                     ; preds = %if.end14.i.i
  %24 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5230
  %cmp18.i.i = icmp ule i64 %24, 32, !dbg !5231
...
if.end20.i.i:                                     ; preds = %if.end17.i.i
  %25 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5234
  %cmp21.i.i = icmp ule i64 %25, 64, !dbg !5235
...
if.end23.i.i:                                     ; preds = %if.end20.i.i
  ...
  %cmp24.i.i = icmp ule i64 %26, 128, !dbg !5239
...
if.end26.i.i:                                     ; preds = %if.end23.i.i
  %27 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5242
  %cmp27.i.i = icmp ule i64 %27, 256, !dbg !5243
...
if.end29.i.i:                                     ; preds = %if.end26.i.i
  %28 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5246
  %cmp30.i.i = icmp ule i64 %28, 512, !dbg !5247
...
if.end32.i.i:                                     ; preds = %if.end29.i.i
  ...
  %cmp33.i.i = icmp ule i64 %29, 1024, !dbg !5251
...
if.end35.i.i:                                     ; preds = %if.end32.i.i
  %30 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5254
  %cmp36.i.i = icmp ule i64 %30, 2048, !dbg !5255
...
if.end38.i.i:                                     ; preds = %if.end35.i.i
  %31 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5258
  %cmp39.i.i = icmp ule i64 %31, 4096, !dbg !5259
...
if.end41.i.i:                                     ; preds = %if.end38.i.i
  %32 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5262
  %cmp42.i.i = icmp ule i64 %32, 8192, !dbg !5263
...
if.end44.i.i:                                     ; preds = %if.end41.i.i
  %33 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5266
  %cmp45.i.i = icmp ule i64 %33, 16384, !dbg !5267
...
if.end47.i.i:                                     ; preds = %if.end44.i.i
  %34 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5270
  %cmp48.i.i = icmp ule i64 %34, 32768, !dbg !5271
...
if.end50.i.i:                                     ; preds = %if.end47.i.i
  %35 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5274
  %cmp51.i.i = icmp ule i64 %35, 65536, !dbg !5275
...
if.end53.i.i:                                     ; preds = %if.end50.i.i
  %36 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5278
  %cmp54.i.i = icmp ule i64 %36, 131072, !dbg !5279
...
if.end56.i.i:                                     ; preds = %if.end53.i.i
  %37 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5282
  %cmp57.i.i = icmp ule i64 %37, 262144, !dbg !5283
...
if.end59.i.i:                                     ; preds = %if.end56.i.i
  %38 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5286
  %cmp60.i.i = icmp ule i64 %38, 524288, !dbg !5287
...
if.end62.i.i:                                     ; preds = %if.end59.i.i
  %39 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5290
  %cmp63.i.i = icmp ule i64 %39, 1048576, !dbg !5291
...
if.end65.i.i:                                     ; preds = %if.end62.i.i
  %40 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5294
  %cmp66.i.i = icmp ule i64 %40, 2097152, !dbg !5295
...
if.end68.i.i:                                     ; preds = %if.end65.i.i
  %41 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5298
  %cmp69.i.i = icmp ule i64 %41, 4194304, !dbg !5299
...
if.end71.i.i:                                     ; preds = %if.end68.i.i
  %42 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5302
  %cmp72.i.i = icmp ule i64 %42, 8388608, !dbg !5303
...
if.end74.i.i:                                     ; preds = %if.end71.i.i
  %43 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5306
  %cmp75.i.i = icmp ule i64 %43, 16777216, !dbg !5307
...
if.end77.i.i:                                     ; preds = %if.end74.i.i
  ...
  %cmp78.i.i = icmp ule i64 %44, 33554432, !dbg !5311
...
if.end80.i.i:                                     ; preds = %if.end77.i.i
  %45 = load i64, i64* %size.addr.i11.i, align 8, !dbg !5314
  %cmp81.i.i = icmp ule i64 %45, 67108864, !dbg !5315
...
if.end83.i.i:                                     ; preds = %if.end80.i.i
  call void asm sideeffect "1:\09.byte 0x0f, 0x0b\0A.pushsection __bug_table,\22aw\22\0A2:\09.long 1b - 2b\09# bug_entry::bug_addr\0A\09.long ${0:c} - 2b\09# bug_entry::file\0A\09.word ${1:c}\09# bug_entry::line\0A\09.word ${2:c}\09# bug_entry::flags\0A\09.org 2b+${3:c}\0A.popsection", "i,i,i,i,~{dirflag},~{fpsr},~{flags}"(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.2, i64 0, i64 0), i32 382, i32 0, i64 12) #6, !dbg !5318, !srcloc !4789
  call void asm sideeffect "${0:c}:\0A\09.pushsection .discard.unreachable\0A\09.long ${0:c}b - .\0A\09.popsection\0A\09", "i,~{dirflag},~{fpsr},~{flags}"(i32 156) #6, !dbg !5319, !srcloc !4793
  unreachable, !dbg !5320

kmalloc_index.exit.i:                             ; preds = %if.then82.i.i, %if.then79.i.i, %if.then76.i.i, %if.then73.i.i, %if.then70.i.i, %if.then67.i.i, %if.then64.i.i, %if.then61.i.i, %if.then58.i.i, %if.then55.i.i, %if.then52.i.i, %if.then49.i.i, %if.then46.i.i, %if.then43.i.i, %if.then40.i.i, %if.then37.i.i, %if.then34.i.i, %if.then31.i.i, %if.then28.i.i, %if.then25.i.i, %if.then22.i.i, %if.then19.i.i, %if.then16.i.i, %if.then13.i.i, %if.then10.i.i, %if.then5.i.i, %if.then1.i.i, %if.then.i.i
  %46 = load i32, i32* %retval.i.i, align 4, !dbg !5321
  store i32 %46, i32* %index.i, align 4, !dbg !5322
  %47 = load i32, i32* %index.i, align 4, !dbg !5323
  %tobool.i = icmp ne i32 %47, 0, !dbg !5323
...
if.end4.i:                                        ; preds = %kmalloc_index.exit.i
  %48 = load i32, i32* %flags.addr.i, align 4, !dbg !5326
  store i32 %48, i32* %flags.addr.i13.i, align 4
  %49 = load i32, i32* %flags.addr.i13.i, align 4, !dbg !5327
  %and.i.i = and i32 %49, 17, !dbg !5327
...
if.end.i16.i:                                     ; preds = %if.end4.i
  %50 = load i32, i32* %flags.addr.i13.i, align 4, !dbg !5330
  %and2.i.i = and i32 %50, 1, !dbg !5331
  %tobool3.i.i = icmp ne i32 %and2.i.i, 0, !dbg !5330
  %51 = zext i1 %tobool3.i.i to i64, !dbg !5330
...
kmalloc_type.exit.i:                              ; preds = %if.end.i16.i, %if.then.i15.i
  %52 = load i32, i32* %retval.i12.i, align 4, !dbg !5333
  %idxprom.i = zext i32 %52 to i64, !dbg !5334
  ...
  %53 = load i32, i32* %index.i, align 4, !dbg !5335
  %idxprom6.i = zext i32 %53 to i64, !dbg !5334
  %arrayidx7.i = getelementptr [14 x %struct.kmem_cache*], [14 x %struct.kmem_cache*]* %arrayidx.i, i64 0, i64 %idxprom6.i, !dbg !5334
  %54 = load %struct.kmem_cache*, %struct.kmem_cache** %arrayidx7.i, align 8, !dbg !5334
  %55 = load i32, i32* %flags.addr.i, align 4, !dbg !5336
  %56 = load i64, i64* %size.addr.i, align 8, !dbg !5337
  ...
  %57 = load %struct.kmem_cache*, %struct.kmem_cache** %s.addr.i.i, align 8, !dbg !5338
  %58 = load i32, i32* %flags.addr.i17.i, align 4, !dbg !5339
  %call.i19.i = call noalias i8* @kmem_cache_alloc(%struct.kmem_cache* %57, i32 %58) #8, !dbg !5340
  ...
  call void @llvm.assume(i1 %maskcond.i.i) #6, !dbg !5340
  store i8* %call.i19.i, i8** %ret.i.i, align 8, !dbg !5144
  %59 = load %struct.kmem_cache*, %struct.kmem_cache** %s.addr.i.i, align 8, !dbg !5341
  %60 = load i8*, i8** %ret.i.i, align 8, !dbg !5342
  %61 = load i64, i64* %size.addr.i18.i, align 8, !dbg !5343
  %62 = load i32, i32* %flags.addr.i17.i, align 4, !dbg !5344
  %call1.i.i = call i8* @kasan_kmalloc(%struct.kmem_cache* %59, i8* %60, i64 %61, i32 %62) #8, !dbg !5345
  store i8* %call1.i.i, i8** %ret.i.i, align 8, !dbg !5346
  %63 = load i8*, i8** %ret.i.i, align 8, !dbg !5347
  store i8* %63, i8** %retval.i, align 8, !dbg !5348
  br label %kmalloc.exit, !dbg !5348

if.end9.i:                                        ; preds = %entry
  %64 = load i64, i64* %size.addr.i, align 8, !dbg !5349
  %65 = load i32, i32* %flags.addr.i, align 4, !dbg !5350
  %call10.i = call noalias i8* @__kmalloc(i64 %64, i32 %65) #8, !dbg !5351
  ...
  call void @llvm.assume(i1 %maskcond.i) #6, !dbg !5351
  store i8* %call10.i, i8** %retval.i, align 8, !dbg !5352
  br label %kmalloc.exit, !dbg !5352

kmalloc.exit:                                     ; preds = %if.then1.i, %if.then3.i, %kmalloc_type.exit.i, %if.end9.i
  %66 = load i8*, i8** %retval.i, align 8, !dbg !5353
  %67 = bitcast i8* %66 to %struct.pci_dev_entry*, !dbg !5354
  store %struct.pci_dev_entry* %67, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5355
  %68 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5356
  %tobool = icmp ne %struct.pci_dev_entry* %68, null, !dbg !5356
...
if.end:                                           ; preds = %kmalloc.exit
  %69 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !5360
  %70 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5361
  %dev1 = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %70, i32 0, i32 1, !dbg !5362
  store %struct.pci_dev* %69, %struct.pci_dev** %dev1, align 8, !dbg !5363
  %71 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !5364
  %lock = getelementptr inbounds %struct.passthrough_dev_data, %struct.passthrough_dev_data* %71, i32 0, i32 1, !dbg !5365
  call void @mutex_lock(%struct.mutex* %lock) #9, !dbg !5366
  %72 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5367
  %list = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %72, i32 0, i32 0, !dbg !5368
  %73 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !5369
  %dev_list = getelementptr inbounds %struct.passthrough_dev_data, %struct.passthrough_dev_data* %73, i32 0, i32 0, !dbg !5370
  call void @list_add_tail(%struct.list_head* %list, %struct.list_head* %dev_list) #9, !dbg !5371
  %74 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !5372
  %lock2 = getelementptr inbounds %struct.passthrough_dev_data, %struct.passthrough_dev_data* %74, i32 0, i32 1, !dbg !5373
  call void @mutex_unlock(%struct.mutex* %lock2) #9, !dbg !5374
  %75 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !5375
  %bus3 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %75, i32 0, i32 1, !dbg !5376
  %76 = load %struct.pci_bus*, %struct.pci_bus** %bus3, align 8, !dbg !5376
  %call4 = call i32 @pci_domain_nr(%struct.pci_bus* %76) #9, !dbg !5377
  store i32 %call4, i32* %domain, align 4, !dbg !5378
  %77 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !5379
  %bus5 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %77, i32 0, i32 1, !dbg !5380
  %78 = load %struct.pci_bus*, %struct.pci_bus** %bus5, align 8, !dbg !5380
  %number = getelementptr inbounds %struct.pci_bus, %struct.pci_bus* %78, i32 0, i32 13, !dbg !5381
  %79 = load i8, i8* %number, align 8, !dbg !5381
  %conv = zext i8 %79 to i32, !dbg !5382
  store i32 %conv, i32* %bus, align 4, !dbg !5383
  %80 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !5384
  %devfn6 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %80, i32 0, i32 6, !dbg !5385
  %81 = load i32, i32* %devfn6, align 8, !dbg !5385
  store i32 %81, i32* %devfn, align 4, !dbg !5386
  %82 = load i32 (%struct.xen_pcibk_device*, i32, i32, i32, i32)*, i32 (%struct.xen_pcibk_device*, i32, i32, i32, i32)** %publish_cb.addr, align 8, !dbg !5387
  %83 = load %struct.xen_pcibk_device*, %struct.xen_pcibk_device** %pdev.addr, align 8, !dbg !5388
  %84 = load i32, i32* %domain, align 4, !dbg !5389
  %85 = load i32, i32* %bus, align 4, !dbg !5390
  %86 = load i32, i32* %devfn, align 4, !dbg !5391
  %87 = load i32, i32* %devid.addr, align 4, !dbg !5392
  %call7 = call i32 %82(%struct.xen_pcibk_device* %83, i32 %84, i32 %85, i32 %86, i32 %87) #9, !dbg !5387
  store i32 %call7, i32* %err, align 4, !dbg !5393
  %88 = load i32, i32* %err, align 4, !dbg !5394
  store i32 %88, i32* %retval, align 4, !dbg !5395
  br label %return, !dbg !5395

return:                                           ; preds = %if.end, %if.then
  %89 = load i32, i32* %retval, align 4, !dbg !5396
  ret i32 %89, !dbg !5396
}

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal %struct.pci_dev* @__xen_pcibk_get_pci_dev(%struct.xen_pcibk_device* %pdev, i32 %domain, i32 %bus, i32 %devfn) #0 !dbg !5397 {
entry:
  %pdev.addr = alloca %struct.xen_pcibk_device*, align 8
  ...
  %tmp20 = alloca %struct.pci_dev_entry*, align 8
  store %struct.xen_pcibk_device* %pdev, %struct.xen_pcibk_device** %pdev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.xen_pcibk_device** %pdev.addr, metadata !5398, metadata !DIExpression()), !dbg !5399
  store i32 %domain, i32* %domain.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %domain.addr, metadata !5400, metadata !DIExpression()), !dbg !5401
  store i32 %bus, i32* %bus.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %bus.addr, metadata !5402, metadata !DIExpression()), !dbg !5403
  store i32 %devfn, i32* %devfn.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %devfn.addr, metadata !5404, metadata !DIExpression()), !dbg !5405
  call void @llvm.dbg.declare(metadata %struct.passthrough_dev_data** %dev_data, metadata !5406, metadata !DIExpression()), !dbg !5407
  %0 = load %struct.xen_pcibk_device*, %struct.xen_pcibk_device** %pdev.addr, align 8, !dbg !5408
  %pci_dev_data = getelementptr inbounds %struct.xen_pcibk_device, %struct.xen_pcibk_device* %0, i32 0, i32 0, !dbg !5409
  %1 = load i8*, i8** %pci_dev_data, align 8, !dbg !5409
  %2 = bitcast i8* %1 to %struct.passthrough_dev_data*, !dbg !5408
  store %struct.passthrough_dev_data* %2, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !5407
  call void @llvm.dbg.declare(metadata %struct.pci_dev_entry** %dev_entry, metadata !5410, metadata !DIExpression()), !dbg !5411
  call void @llvm.dbg.declare(metadata %struct.pci_dev** %dev, metadata !5412, metadata !DIExpression()), !dbg !5413
  store %struct.pci_dev* null, %struct.pci_dev** %dev, align 8, !dbg !5413
  %3 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !5414
  %lock = getelementptr inbounds %struct.passthrough_dev_data, %struct.passthrough_dev_data* %3, i32 0, i32 1, !dbg !5415
  call void @mutex_lock(%struct.mutex* %lock) #9, !dbg !5416
  call void @llvm.dbg.declare(metadata i8** %__mptr, metadata !5417, metadata !DIExpression()), !dbg !5420
  %4 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !5420
  %dev_list = getelementptr inbounds %struct.passthrough_dev_data, %struct.passthrough_dev_data* %4, i32 0, i32 0, !dbg !5420
  %next = getelementptr inbounds %struct.list_head, %struct.list_head* %dev_list, i32 0, i32 0, !dbg !5420
  %5 = load %struct.list_head*, %struct.list_head** %next, align 8, !dbg !5420
  %6 = bitcast %struct.list_head* %5 to i8*, !dbg !5420
  store i8* %6, i8** %__mptr, align 8, !dbg !5420
...
do.end:                                           ; preds = %do.body
  %7 = load i8*, i8** %__mptr, align 8, !dbg !5420
  %add.ptr = getelementptr i8, i8* %7, i64 0, !dbg !5420
  %8 = bitcast i8* %add.ptr to %struct.pci_dev_entry*, !dbg !5420
  store %struct.pci_dev_entry* %8, %struct.pci_dev_entry** %tmp, align 8, !dbg !5421
  %9 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %tmp, align 8, !dbg !5420
  store %struct.pci_dev_entry* %9, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5423
  br label %for.cond, !dbg !5423

for.cond:                                         ; preds = %do.end19, %do.end
  %10 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5424
  %list = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %10, i32 0, i32 0, !dbg !5424
  %11 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !5424
  %dev_list1 = getelementptr inbounds %struct.passthrough_dev_data, %struct.passthrough_dev_data* %11, i32 0, i32 0, !dbg !5424
  %cmp = icmp eq %struct.list_head* %list, %dev_list1, !dbg !5424
  %lnot = xor i1 %cmp, true, !dbg !5424
  br i1 %lnot, label %for.body, label %for.end, !dbg !5423

for.body:                                         ; preds = %for.cond
  %12 = load i32, i32* %domain.addr, align 4, !dbg !5426
  %13 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5429
  %dev2 = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %13, i32 0, i32 1, !dbg !5430
  %14 = load %struct.pci_dev*, %struct.pci_dev** %dev2, align 8, !dbg !5430
  %bus3 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %14, i32 0, i32 1, !dbg !5431
  %15 = load %struct.pci_bus*, %struct.pci_bus** %bus3, align 8, !dbg !5431
  %call = call i32 @pci_domain_nr(%struct.pci_bus* %15) #9, !dbg !5432
  %cmp4 = icmp eq i32 %12, %call, !dbg !5433
  br i1 %cmp4, label %land.lhs.true, label %if.end, !dbg !5434

land.lhs.true:                                    ; preds = %for.body
  %16 = load i32, i32* %bus.addr, align 4, !dbg !5435
  %17 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5436
  %dev5 = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %17, i32 0, i32 1, !dbg !5437
  %18 = load %struct.pci_dev*, %struct.pci_dev** %dev5, align 8, !dbg !5437
  %bus6 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %18, i32 0, i32 1, !dbg !5438
  %19 = load %struct.pci_bus*, %struct.pci_bus** %bus6, align 8, !dbg !5438
  %number = getelementptr inbounds %struct.pci_bus, %struct.pci_bus* %19, i32 0, i32 13, !dbg !5439
  %20 = load i8, i8* %number, align 8, !dbg !5439
  %conv = zext i8 %20 to i32, !dbg !5440
  %cmp7 = icmp eq i32 %16, %conv, !dbg !5441
  br i1 %cmp7, label %land.lhs.true9, label %if.end, !dbg !5442

land.lhs.true9:                                   ; preds = %land.lhs.true
  %21 = load i32, i32* %devfn.addr, align 4, !dbg !5443
  %22 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5444
  %dev10 = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %22, i32 0, i32 1, !dbg !5445
  %23 = load %struct.pci_dev*, %struct.pci_dev** %dev10, align 8, !dbg !5445
  %devfn11 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %23, i32 0, i32 6, !dbg !5446
  %24 = load i32, i32* %devfn11, align 8, !dbg !5446
  %cmp12 = icmp eq i32 %21, %24, !dbg !5447
  br i1 %cmp12, label %if.then, label %if.end, !dbg !5448

if.then:                                          ; preds = %land.lhs.true9
  %25 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5449
  %dev14 = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %25, i32 0, i32 1, !dbg !5451
  %26 = load %struct.pci_dev*, %struct.pci_dev** %dev14, align 8, !dbg !5451
  store %struct.pci_dev* %26, %struct.pci_dev** %dev, align 8, !dbg !5452
...
for.inc:                                          ; preds = %if.end
  call void @llvm.dbg.declare(metadata i8** %__mptr15, metadata !5455, metadata !DIExpression()), !dbg !5457
  %27 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5457
  %list16 = getelementptr inbounds %struct.pci_dev_entry, %struct.pci_dev_entry* %27, i32 0, i32 0, !dbg !5457
  %next17 = getelementptr inbounds %struct.list_head, %struct.list_head* %list16, i32 0, i32 0, !dbg !5457
  %28 = load %struct.list_head*, %struct.list_head** %next17, align 8, !dbg !5457
  %29 = bitcast %struct.list_head* %28 to i8*, !dbg !5457
  store i8* %29, i8** %__mptr15, align 8, !dbg !5457
  br label %do.body18, !dbg !5457

do.body18:                                        ; preds = %for.inc
  br label %do.end19, !dbg !5458

do.end19:                                         ; preds = %do.body18
  %30 = load i8*, i8** %__mptr15, align 8, !dbg !5457
  %add.ptr21 = getelementptr i8, i8* %30, i64 0, !dbg !5457
  %31 = bitcast i8* %add.ptr21 to %struct.pci_dev_entry*, !dbg !5457
  store %struct.pci_dev_entry* %31, %struct.pci_dev_entry** %tmp20, align 8, !dbg !5458
  %32 = load %struct.pci_dev_entry*, %struct.pci_dev_entry** %tmp20, align 8, !dbg !5457
  store %struct.pci_dev_entry* %32, %struct.pci_dev_entry** %dev_entry, align 8, !dbg !5424
  br label %for.cond, !dbg !5424, !llvm.loop !5460

for.end:                                          ; preds = %if.then, %for.cond
  %33 = load %struct.passthrough_dev_data*, %struct.passthrough_dev_data** %dev_data, align 8, !dbg !5462
  %lock22 = getelementptr inbounds %struct.passthrough_dev_data, %struct.passthrough_dev_data* %33, i32 0, i32 1, !dbg !5463
  call void @mutex_unlock(%struct.mutex* %lock22) #9, !dbg !5464
  %34 = load %struct.pci_dev*, %struct.pci_dev** %dev, align 8, !dbg !5465
  ret %struct.pci_dev* %34, !dbg !5466
}
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @INIT_LIST_HEAD(%struct.list_head* %list) #0 !dbg !5467 {
entry:
  %list.addr = alloca %struct.list_head*, align 8
  store %struct.list_head* %list, %struct.list_head** %list.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %list.addr, metadata !5471, metadata !DIExpression()), !dbg !5472
  br label %do.body, !dbg !5473

do.body:                                          ; preds = %entry
  br label %do.body1, !dbg !5474

do.body1:                                         ; preds = %do.body
  br label %do.end, !dbg !5476

do.end:                                           ; preds = %do.body1
  br label %do.body2, !dbg !5474

do.body2:                                         ; preds = %do.end
  %0 = load %struct.list_head*, %struct.list_head** %list.addr, align 8, !dbg !5478
  %1 = load %struct.list_head*, %struct.list_head** %list.addr, align 8, !dbg !5478
  %next = getelementptr inbounds %struct.list_head, %struct.list_head* %1, i32 0, i32 0, !dbg !5478
  store volatile %struct.list_head* %0, %struct.list_head** %next, align 8, !dbg !5478
  br label %do.end3, !dbg !5478

do.end3:                                          ; preds = %do.body2
  br label %do.end4, !dbg !5474

do.end4:                                          ; preds = %do.end3
  %2 = load %struct.list_head*, %struct.list_head** %list.addr, align 8, !dbg !5480
  %3 = load %struct.list_head*, %struct.list_head** %list.addr, align 8, !dbg !5481
  %prev = getelementptr inbounds %struct.list_head, %struct.list_head* %3, i32 0, i32 1, !dbg !5482
  store %struct.list_head* %2, %struct.list_head** %prev, align 8, !dbg !5483
  ret void, !dbg !5484
}
...
define internal i32 @get_order(i64 %size) #5 !dbg !5485 {
entry:
  %x.addr.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %x.addr.i, metadata !5489, metadata !DIExpression()), !dbg !5494
  %bitpos.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %bitpos.i, metadata !5496, metadata !DIExpression()), !dbg !5497
  %retval = alloca i32, align 4
  %size.addr = alloca i64, align 8
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !5498, metadata !DIExpression()), !dbg !5499
  %0 = load i64, i64* %size.addr, align 8, !dbg !5500
  %1 = call i1 @llvm.is.constant.i64(i64 %0), !dbg !5502
  br i1 %1, label %if.then, label %if.end447, !dbg !5503

if.then:                                          ; preds = %entry
  %2 = load i64, i64* %size.addr, align 8, !dbg !5504
  %tobool = icmp ne i64 %2, 0, !dbg !5504
  br i1 %tobool, label %if.end, label %if.then1, !dbg !5507

if.then1:                                         ; preds = %if.then
  store i32 52, i32* %retval, align 4, !dbg !5508
  br label %return, !dbg !5508

if.end:                                           ; preds = %if.then
  %3 = load i64, i64* %size.addr, align 8, !dbg !5509
  %cmp = icmp ult i64 %3, 4096, !dbg !5511
  br i1 %cmp, label %if.then2, label %if.end3, !dbg !5512
...
if.end3:                                          ; preds = %if.end
  %4 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub = sub i64 %4, 1, !dbg !5514
  %5 = call i1 @llvm.is.constant.i64(i64 %sub), !dbg !5514
  br i1 %5, label %cond.true, label %cond.false442, !dbg !5514

cond.true:                                        ; preds = %if.end3
  %6 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub4 = sub i64 %6, 1, !dbg !5514
  %7 = call i1 @llvm.is.constant.i64(i64 %sub4), !dbg !5514
  br i1 %7, label %cond.true5, label %cond.false439, !dbg !5514

cond.true5:                                       ; preds = %cond.true
  %8 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub6 = sub i64 %8, 1, !dbg !5514
  %cmp7 = icmp ult i64 %sub6, 2, !dbg !5514
  br i1 %cmp7, label %cond.true8, label %cond.false, !dbg !5514

cond.true8:                                       ; preds = %cond.true5
  br label %cond.end437, !dbg !5514

cond.false:                                       ; preds = %cond.true5
  %9 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub9 = sub i64 %9, 1, !dbg !5514
  %and = and i64 %sub9, -9223372036854775808, !dbg !5514
  %tobool10 = icmp ne i64 %and, 0, !dbg !5514
  br i1 %tobool10, label %cond.true11, label %cond.false12, !dbg !5514

cond.true11:                                      ; preds = %cond.false
  br label %cond.end435, !dbg !5514

cond.false12:                                     ; preds = %cond.false
  %10 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub13 = sub i64 %10, 1, !dbg !5514
  %and14 = and i64 %sub13, 4611686018427387904, !dbg !5514
  %tobool15 = icmp ne i64 %and14, 0, !dbg !5514
  br i1 %tobool15, label %cond.true16, label %cond.false17, !dbg !5514

cond.true16:                                      ; preds = %cond.false12
  br label %cond.end433, !dbg !5514

cond.false17:                                     ; preds = %cond.false12
  %11 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub18 = sub i64 %11, 1, !dbg !5514
  %and19 = and i64 %sub18, 2305843009213693952, !dbg !5514
  %tobool20 = icmp ne i64 %and19, 0, !dbg !5514
  br i1 %tobool20, label %cond.true21, label %cond.false22, !dbg !5514

cond.true21:                                      ; preds = %cond.false17
  br label %cond.end431, !dbg !5514

cond.false22:                                     ; preds = %cond.false17
  %12 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub23 = sub i64 %12, 1, !dbg !5514
  %and24 = and i64 %sub23, 1152921504606846976, !dbg !5514
  %tobool25 = icmp ne i64 %and24, 0, !dbg !5514
  br i1 %tobool25, label %cond.true26, label %cond.false27, !dbg !5514

cond.true26:                                      ; preds = %cond.false22
  br label %cond.end429, !dbg !5514

cond.false27:                                     ; preds = %cond.false22
  %13 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub28 = sub i64 %13, 1, !dbg !5514
  %and29 = and i64 %sub28, 576460752303423488, !dbg !5514
  %tobool30 = icmp ne i64 %and29, 0, !dbg !5514
  br i1 %tobool30, label %cond.true31, label %cond.false32, !dbg !5514

cond.true31:                                      ; preds = %cond.false27
  br label %cond.end427, !dbg !5514

cond.false32:                                     ; preds = %cond.false27
  %14 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub33 = sub i64 %14, 1, !dbg !5514
  %and34 = and i64 %sub33, 288230376151711744, !dbg !5514
  %tobool35 = icmp ne i64 %and34, 0, !dbg !5514
  br i1 %tobool35, label %cond.true36, label %cond.false37, !dbg !5514

cond.true36:                                      ; preds = %cond.false32
  br label %cond.end425, !dbg !5514

cond.false37:                                     ; preds = %cond.false32
  %15 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub38 = sub i64 %15, 1, !dbg !5514
  %and39 = and i64 %sub38, 144115188075855872, !dbg !5514
  %tobool40 = icmp ne i64 %and39, 0, !dbg !5514
  br i1 %tobool40, label %cond.true41, label %cond.false42, !dbg !5514

cond.true41:                                      ; preds = %cond.false37
  br label %cond.end423, !dbg !5514

cond.false42:                                     ; preds = %cond.false37
  %16 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub43 = sub i64 %16, 1, !dbg !5514
  %and44 = and i64 %sub43, 72057594037927936, !dbg !5514
  %tobool45 = icmp ne i64 %and44, 0, !dbg !5514
  br i1 %tobool45, label %cond.true46, label %cond.false47, !dbg !5514

cond.true46:                                      ; preds = %cond.false42
  br label %cond.end421, !dbg !5514

cond.false47:                                     ; preds = %cond.false42
  %17 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub48 = sub i64 %17, 1, !dbg !5514
  %and49 = and i64 %sub48, 36028797018963968, !dbg !5514
  %tobool50 = icmp ne i64 %and49, 0, !dbg !5514
  br i1 %tobool50, label %cond.true51, label %cond.false52, !dbg !5514

cond.true51:                                      ; preds = %cond.false47
  br label %cond.end419, !dbg !5514

cond.false52:                                     ; preds = %cond.false47
  %18 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub53 = sub i64 %18, 1, !dbg !5514
  %and54 = and i64 %sub53, 18014398509481984, !dbg !5514
  %tobool55 = icmp ne i64 %and54, 0, !dbg !5514
  br i1 %tobool55, label %cond.true56, label %cond.false57, !dbg !5514

cond.true56:                                      ; preds = %cond.false52
  br label %cond.end417, !dbg !5514

cond.false57:                                     ; preds = %cond.false52
  %19 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub58 = sub i64 %19, 1, !dbg !5514
  %and59 = and i64 %sub58, 9007199254740992, !dbg !5514
  %tobool60 = icmp ne i64 %and59, 0, !dbg !5514
  br i1 %tobool60, label %cond.true61, label %cond.false62, !dbg !5514

cond.true61:                                      ; preds = %cond.false57
  br label %cond.end415, !dbg !5514

cond.false62:                                     ; preds = %cond.false57
  %20 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub63 = sub i64 %20, 1, !dbg !5514
  %and64 = and i64 %sub63, 4503599627370496, !dbg !5514
  %tobool65 = icmp ne i64 %and64, 0, !dbg !5514
  br i1 %tobool65, label %cond.true66, label %cond.false67, !dbg !5514

cond.true66:                                      ; preds = %cond.false62
  br label %cond.end413, !dbg !5514

cond.false67:                                     ; preds = %cond.false62
  %21 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub68 = sub i64 %21, 1, !dbg !5514
  %and69 = and i64 %sub68, 2251799813685248, !dbg !5514
  %tobool70 = icmp ne i64 %and69, 0, !dbg !5514
  br i1 %tobool70, label %cond.true71, label %cond.false72, !dbg !5514

cond.true71:                                      ; preds = %cond.false67
  br label %cond.end411, !dbg !5514

cond.false72:                                     ; preds = %cond.false67
  %22 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub73 = sub i64 %22, 1, !dbg !5514
  %and74 = and i64 %sub73, 1125899906842624, !dbg !5514
  %tobool75 = icmp ne i64 %and74, 0, !dbg !5514
  br i1 %tobool75, label %cond.true76, label %cond.false77, !dbg !5514

cond.true76:                                      ; preds = %cond.false72
  br label %cond.end409, !dbg !5514

cond.false77:                                     ; preds = %cond.false72
  %23 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub78 = sub i64 %23, 1, !dbg !5514
  %and79 = and i64 %sub78, 562949953421312, !dbg !5514
  %tobool80 = icmp ne i64 %and79, 0, !dbg !5514
  br i1 %tobool80, label %cond.true81, label %cond.false82, !dbg !5514

cond.true81:                                      ; preds = %cond.false77
  br label %cond.end407, !dbg !5514

cond.false82:                                     ; preds = %cond.false77
  %24 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub83 = sub i64 %24, 1, !dbg !5514
  %and84 = and i64 %sub83, 281474976710656, !dbg !5514
  %tobool85 = icmp ne i64 %and84, 0, !dbg !5514
  br i1 %tobool85, label %cond.true86, label %cond.false87, !dbg !5514

cond.true86:                                      ; preds = %cond.false82
  br label %cond.end405, !dbg !5514

cond.false87:                                     ; preds = %cond.false82
  %25 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub88 = sub i64 %25, 1, !dbg !5514
  %and89 = and i64 %sub88, 140737488355328, !dbg !5514
  %tobool90 = icmp ne i64 %and89, 0, !dbg !5514
  br i1 %tobool90, label %cond.true91, label %cond.false92, !dbg !5514

cond.true91:                                      ; preds = %cond.false87
  br label %cond.end403, !dbg !5514

cond.false92:                                     ; preds = %cond.false87
  %26 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub93 = sub i64 %26, 1, !dbg !5514
  %and94 = and i64 %sub93, 70368744177664, !dbg !5514
  %tobool95 = icmp ne i64 %and94, 0, !dbg !5514
  br i1 %tobool95, label %cond.true96, label %cond.false97, !dbg !5514

cond.true96:                                      ; preds = %cond.false92
  br label %cond.end401, !dbg !5514

cond.false97:                                     ; preds = %cond.false92
  %27 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub98 = sub i64 %27, 1, !dbg !5514
  %and99 = and i64 %sub98, 35184372088832, !dbg !5514
  %tobool100 = icmp ne i64 %and99, 0, !dbg !5514
  br i1 %tobool100, label %cond.true101, label %cond.false102, !dbg !5514

cond.true101:                                     ; preds = %cond.false97
  br label %cond.end399, !dbg !5514

cond.false102:                                    ; preds = %cond.false97
  %28 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub103 = sub i64 %28, 1, !dbg !5514
  %and104 = and i64 %sub103, 17592186044416, !dbg !5514
  %tobool105 = icmp ne i64 %and104, 0, !dbg !5514
  br i1 %tobool105, label %cond.true106, label %cond.false107, !dbg !5514

cond.true106:                                     ; preds = %cond.false102
  br label %cond.end397, !dbg !5514

cond.false107:                                    ; preds = %cond.false102
  %29 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub108 = sub i64 %29, 1, !dbg !5514
  %and109 = and i64 %sub108, 8796093022208, !dbg !5514
  %tobool110 = icmp ne i64 %and109, 0, !dbg !5514
  br i1 %tobool110, label %cond.true111, label %cond.false112, !dbg !5514

cond.true111:                                     ; preds = %cond.false107
  br label %cond.end395, !dbg !5514

cond.false112:                                    ; preds = %cond.false107
  %30 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub113 = sub i64 %30, 1, !dbg !5514
  %and114 = and i64 %sub113, 4398046511104, !dbg !5514
  %tobool115 = icmp ne i64 %and114, 0, !dbg !5514
  br i1 %tobool115, label %cond.true116, label %cond.false117, !dbg !5514

cond.true116:                                     ; preds = %cond.false112
  br label %cond.end393, !dbg !5514

cond.false117:                                    ; preds = %cond.false112
  %31 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub118 = sub i64 %31, 1, !dbg !5514
  %and119 = and i64 %sub118, 2199023255552, !dbg !5514
  %tobool120 = icmp ne i64 %and119, 0, !dbg !5514
  br i1 %tobool120, label %cond.true121, label %cond.false122, !dbg !5514

cond.true121:                                     ; preds = %cond.false117
  br label %cond.end391, !dbg !5514

cond.false122:                                    ; preds = %cond.false117
  %32 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub123 = sub i64 %32, 1, !dbg !5514
  %and124 = and i64 %sub123, 1099511627776, !dbg !5514
  %tobool125 = icmp ne i64 %and124, 0, !dbg !5514
  br i1 %tobool125, label %cond.true126, label %cond.false127, !dbg !5514

cond.true126:                                     ; preds = %cond.false122
  br label %cond.end389, !dbg !5514

cond.false127:                                    ; preds = %cond.false122
  %33 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub128 = sub i64 %33, 1, !dbg !5514
  %and129 = and i64 %sub128, 549755813888, !dbg !5514
  %tobool130 = icmp ne i64 %and129, 0, !dbg !5514
  br i1 %tobool130, label %cond.true131, label %cond.false132, !dbg !5514

cond.true131:                                     ; preds = %cond.false127
  br label %cond.end387, !dbg !5514

cond.false132:                                    ; preds = %cond.false127
  %34 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub133 = sub i64 %34, 1, !dbg !5514
  %and134 = and i64 %sub133, 274877906944, !dbg !5514
  %tobool135 = icmp ne i64 %and134, 0, !dbg !5514
  br i1 %tobool135, label %cond.true136, label %cond.false137, !dbg !5514

cond.true136:                                     ; preds = %cond.false132
  br label %cond.end385, !dbg !5514

cond.false137:                                    ; preds = %cond.false132
  %35 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub138 = sub i64 %35, 1, !dbg !5514
  %and139 = and i64 %sub138, 137438953472, !dbg !5514
  %tobool140 = icmp ne i64 %and139, 0, !dbg !5514
  br i1 %tobool140, label %cond.true141, label %cond.false142, !dbg !5514

cond.true141:                                     ; preds = %cond.false137
  br label %cond.end383, !dbg !5514

cond.false142:                                    ; preds = %cond.false137
  %36 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub143 = sub i64 %36, 1, !dbg !5514
  %and144 = and i64 %sub143, 68719476736, !dbg !5514
  %tobool145 = icmp ne i64 %and144, 0, !dbg !5514
  br i1 %tobool145, label %cond.true146, label %cond.false147, !dbg !5514

cond.true146:                                     ; preds = %cond.false142
  br label %cond.end381, !dbg !5514

cond.false147:                                    ; preds = %cond.false142
  %37 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub148 = sub i64 %37, 1, !dbg !5514
  %and149 = and i64 %sub148, 34359738368, !dbg !5514
  %tobool150 = icmp ne i64 %and149, 0, !dbg !5514
  br i1 %tobool150, label %cond.true151, label %cond.false152, !dbg !5514

cond.true151:                                     ; preds = %cond.false147
  br label %cond.end379, !dbg !5514

cond.false152:                                    ; preds = %cond.false147
  %38 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub153 = sub i64 %38, 1, !dbg !5514
  %and154 = and i64 %sub153, 17179869184, !dbg !5514
  %tobool155 = icmp ne i64 %and154, 0, !dbg !5514
  br i1 %tobool155, label %cond.true156, label %cond.false157, !dbg !5514

cond.true156:                                     ; preds = %cond.false152
  br label %cond.end377, !dbg !5514

cond.false157:                                    ; preds = %cond.false152
  %39 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub158 = sub i64 %39, 1, !dbg !5514
  %and159 = and i64 %sub158, 8589934592, !dbg !5514
  %tobool160 = icmp ne i64 %and159, 0, !dbg !5514
  br i1 %tobool160, label %cond.true161, label %cond.false162, !dbg !5514

cond.true161:                                     ; preds = %cond.false157
  br label %cond.end375, !dbg !5514

cond.false162:                                    ; preds = %cond.false157
  %40 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub163 = sub i64 %40, 1, !dbg !5514
  %and164 = and i64 %sub163, 4294967296, !dbg !5514
  %tobool165 = icmp ne i64 %and164, 0, !dbg !5514
  br i1 %tobool165, label %cond.true166, label %cond.false167, !dbg !5514

cond.true166:                                     ; preds = %cond.false162
  br label %cond.end373, !dbg !5514

cond.false167:                                    ; preds = %cond.false162
  %41 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub168 = sub i64 %41, 1, !dbg !5514
  %and169 = and i64 %sub168, 2147483648, !dbg !5514
  %tobool170 = icmp ne i64 %and169, 0, !dbg !5514
  br i1 %tobool170, label %cond.true171, label %cond.false172, !dbg !5514

cond.true171:                                     ; preds = %cond.false167
  br label %cond.end371, !dbg !5514

cond.false172:                                    ; preds = %cond.false167
  %42 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub173 = sub i64 %42, 1, !dbg !5514
  %and174 = and i64 %sub173, 1073741824, !dbg !5514
  %tobool175 = icmp ne i64 %and174, 0, !dbg !5514
  br i1 %tobool175, label %cond.true176, label %cond.false177, !dbg !5514

cond.true176:                                     ; preds = %cond.false172
  br label %cond.end369, !dbg !5514

cond.false177:                                    ; preds = %cond.false172
  %43 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub178 = sub i64 %43, 1, !dbg !5514
  %and179 = and i64 %sub178, 536870912, !dbg !5514
  %tobool180 = icmp ne i64 %and179, 0, !dbg !5514
  br i1 %tobool180, label %cond.true181, label %cond.false182, !dbg !5514

cond.true181:                                     ; preds = %cond.false177
  br label %cond.end367, !dbg !5514

cond.false182:                                    ; preds = %cond.false177
  %44 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub183 = sub i64 %44, 1, !dbg !5514
  %and184 = and i64 %sub183, 268435456, !dbg !5514
  %tobool185 = icmp ne i64 %and184, 0, !dbg !5514
  br i1 %tobool185, label %cond.true186, label %cond.false187, !dbg !5514

cond.true186:                                     ; preds = %cond.false182
  br label %cond.end365, !dbg !5514

cond.false187:                                    ; preds = %cond.false182
  %45 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub188 = sub i64 %45, 1, !dbg !5514
  %and189 = and i64 %sub188, 134217728, !dbg !5514
  %tobool190 = icmp ne i64 %and189, 0, !dbg !5514
  br i1 %tobool190, label %cond.true191, label %cond.false192, !dbg !5514

cond.true191:                                     ; preds = %cond.false187
  br label %cond.end363, !dbg !5514

cond.false192:                                    ; preds = %cond.false187
  %46 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub193 = sub i64 %46, 1, !dbg !5514
  %and194 = and i64 %sub193, 67108864, !dbg !5514
  %tobool195 = icmp ne i64 %and194, 0, !dbg !5514
  br i1 %tobool195, label %cond.true196, label %cond.false197, !dbg !5514

cond.true196:                                     ; preds = %cond.false192
  br label %cond.end361, !dbg !5514

cond.false197:                                    ; preds = %cond.false192
  %47 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub198 = sub i64 %47, 1, !dbg !5514
  %and199 = and i64 %sub198, 33554432, !dbg !5514
  %tobool200 = icmp ne i64 %and199, 0, !dbg !5514
  br i1 %tobool200, label %cond.true201, label %cond.false202, !dbg !5514

cond.true201:                                     ; preds = %cond.false197
  br label %cond.end359, !dbg !5514

cond.false202:                                    ; preds = %cond.false197
  %48 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub203 = sub i64 %48, 1, !dbg !5514
  %and204 = and i64 %sub203, 16777216, !dbg !5514
  %tobool205 = icmp ne i64 %and204, 0, !dbg !5514
  br i1 %tobool205, label %cond.true206, label %cond.false207, !dbg !5514

cond.true206:                                     ; preds = %cond.false202
  br label %cond.end357, !dbg !5514

cond.false207:                                    ; preds = %cond.false202
  %49 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub208 = sub i64 %49, 1, !dbg !5514
  %and209 = and i64 %sub208, 8388608, !dbg !5514
  %tobool210 = icmp ne i64 %and209, 0, !dbg !5514
  br i1 %tobool210, label %cond.true211, label %cond.false212, !dbg !5514

cond.true211:                                     ; preds = %cond.false207
  br label %cond.end355, !dbg !5514

cond.false212:                                    ; preds = %cond.false207
  %50 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub213 = sub i64 %50, 1, !dbg !5514
  %and214 = and i64 %sub213, 4194304, !dbg !5514
  %tobool215 = icmp ne i64 %and214, 0, !dbg !5514
  br i1 %tobool215, label %cond.true216, label %cond.false217, !dbg !5514

cond.true216:                                     ; preds = %cond.false212
  br label %cond.end353, !dbg !5514

cond.false217:                                    ; preds = %cond.false212
  %51 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub218 = sub i64 %51, 1, !dbg !5514
  %and219 = and i64 %sub218, 2097152, !dbg !5514
  %tobool220 = icmp ne i64 %and219, 0, !dbg !5514
  br i1 %tobool220, label %cond.true221, label %cond.false222, !dbg !5514

cond.true221:                                     ; preds = %cond.false217
  br label %cond.end351, !dbg !5514

cond.false222:                                    ; preds = %cond.false217
  %52 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub223 = sub i64 %52, 1, !dbg !5514
  %and224 = and i64 %sub223, 1048576, !dbg !5514
  %tobool225 = icmp ne i64 %and224, 0, !dbg !5514
  br i1 %tobool225, label %cond.true226, label %cond.false227, !dbg !5514

cond.true226:                                     ; preds = %cond.false222
  br label %cond.end349, !dbg !5514

cond.false227:                                    ; preds = %cond.false222
  %53 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub228 = sub i64 %53, 1, !dbg !5514
  %and229 = and i64 %sub228, 524288, !dbg !5514
  %tobool230 = icmp ne i64 %and229, 0, !dbg !5514
  br i1 %tobool230, label %cond.true231, label %cond.false232, !dbg !5514

cond.true231:                                     ; preds = %cond.false227
  br label %cond.end347, !dbg !5514

cond.false232:                                    ; preds = %cond.false227
  %54 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub233 = sub i64 %54, 1, !dbg !5514
  %and234 = and i64 %sub233, 262144, !dbg !5514
  %tobool235 = icmp ne i64 %and234, 0, !dbg !5514
  br i1 %tobool235, label %cond.true236, label %cond.false237, !dbg !5514

cond.true236:                                     ; preds = %cond.false232
  br label %cond.end345, !dbg !5514

cond.false237:                                    ; preds = %cond.false232
  %55 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub238 = sub i64 %55, 1, !dbg !5514
  %and239 = and i64 %sub238, 131072, !dbg !5514
  %tobool240 = icmp ne i64 %and239, 0, !dbg !5514
  br i1 %tobool240, label %cond.true241, label %cond.false242, !dbg !5514

cond.true241:                                     ; preds = %cond.false237
  br label %cond.end343, !dbg !5514

cond.false242:                                    ; preds = %cond.false237
  %56 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub243 = sub i64 %56, 1, !dbg !5514
  %and244 = and i64 %sub243, 65536, !dbg !5514
  %tobool245 = icmp ne i64 %and244, 0, !dbg !5514
  br i1 %tobool245, label %cond.true246, label %cond.false247, !dbg !5514

cond.true246:                                     ; preds = %cond.false242
  br label %cond.end341, !dbg !5514

cond.false247:                                    ; preds = %cond.false242
  %57 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub248 = sub i64 %57, 1, !dbg !5514
  %and249 = and i64 %sub248, 32768, !dbg !5514
  %tobool250 = icmp ne i64 %and249, 0, !dbg !5514
  br i1 %tobool250, label %cond.true251, label %cond.false252, !dbg !5514

cond.true251:                                     ; preds = %cond.false247
  br label %cond.end339, !dbg !5514

cond.false252:                                    ; preds = %cond.false247
  %58 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub253 = sub i64 %58, 1, !dbg !5514
  %and254 = and i64 %sub253, 16384, !dbg !5514
  %tobool255 = icmp ne i64 %and254, 0, !dbg !5514
  br i1 %tobool255, label %cond.true256, label %cond.false257, !dbg !5514

cond.true256:                                     ; preds = %cond.false252
  br label %cond.end337, !dbg !5514

cond.false257:                                    ; preds = %cond.false252
  %59 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub258 = sub i64 %59, 1, !dbg !5514
  %and259 = and i64 %sub258, 8192, !dbg !5514
  %tobool260 = icmp ne i64 %and259, 0, !dbg !5514
  br i1 %tobool260, label %cond.true261, label %cond.false262, !dbg !5514

cond.true261:                                     ; preds = %cond.false257
  br label %cond.end335, !dbg !5514

cond.false262:                                    ; preds = %cond.false257
  %60 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub263 = sub i64 %60, 1, !dbg !5514
  %and264 = and i64 %sub263, 4096, !dbg !5514
  %tobool265 = icmp ne i64 %and264, 0, !dbg !5514
  br i1 %tobool265, label %cond.true266, label %cond.false267, !dbg !5514

cond.true266:                                     ; preds = %cond.false262
  br label %cond.end333, !dbg !5514

cond.false267:                                    ; preds = %cond.false262
  %61 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub268 = sub i64 %61, 1, !dbg !5514
  %and269 = and i64 %sub268, 2048, !dbg !5514
  %tobool270 = icmp ne i64 %and269, 0, !dbg !5514
  br i1 %tobool270, label %cond.true271, label %cond.false272, !dbg !5514

cond.true271:                                     ; preds = %cond.false267
  br label %cond.end331, !dbg !5514

cond.false272:                                    ; preds = %cond.false267
  %62 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub273 = sub i64 %62, 1, !dbg !5514
  %and274 = and i64 %sub273, 1024, !dbg !5514
  %tobool275 = icmp ne i64 %and274, 0, !dbg !5514
  br i1 %tobool275, label %cond.true276, label %cond.false277, !dbg !5514

cond.true276:                                     ; preds = %cond.false272
  br label %cond.end329, !dbg !5514

cond.false277:                                    ; preds = %cond.false272
  %63 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub278 = sub i64 %63, 1, !dbg !5514
  %and279 = and i64 %sub278, 512, !dbg !5514
  %tobool280 = icmp ne i64 %and279, 0, !dbg !5514
  br i1 %tobool280, label %cond.true281, label %cond.false282, !dbg !5514

cond.true281:                                     ; preds = %cond.false277
  br label %cond.end327, !dbg !5514

cond.false282:                                    ; preds = %cond.false277
  %64 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub283 = sub i64 %64, 1, !dbg !5514
  %and284 = and i64 %sub283, 256, !dbg !5514
  %tobool285 = icmp ne i64 %and284, 0, !dbg !5514
  br i1 %tobool285, label %cond.true286, label %cond.false287, !dbg !5514

cond.true286:                                     ; preds = %cond.false282
  br label %cond.end325, !dbg !5514

cond.false287:                                    ; preds = %cond.false282
  %65 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub288 = sub i64 %65, 1, !dbg !5514
  %and289 = and i64 %sub288, 128, !dbg !5514
  %tobool290 = icmp ne i64 %and289, 0, !dbg !5514
  br i1 %tobool290, label %cond.true291, label %cond.false292, !dbg !5514

cond.true291:                                     ; preds = %cond.false287
  br label %cond.end323, !dbg !5514

cond.false292:                                    ; preds = %cond.false287
  %66 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub293 = sub i64 %66, 1, !dbg !5514
  %and294 = and i64 %sub293, 64, !dbg !5514
  %tobool295 = icmp ne i64 %and294, 0, !dbg !5514
  br i1 %tobool295, label %cond.true296, label %cond.false297, !dbg !5514

cond.true296:                                     ; preds = %cond.false292
  br label %cond.end321, !dbg !5514

cond.false297:                                    ; preds = %cond.false292
  %67 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub298 = sub i64 %67, 1, !dbg !5514
  %and299 = and i64 %sub298, 32, !dbg !5514
  %tobool300 = icmp ne i64 %and299, 0, !dbg !5514
  br i1 %tobool300, label %cond.true301, label %cond.false302, !dbg !5514

cond.true301:                                     ; preds = %cond.false297
  br label %cond.end319, !dbg !5514

cond.false302:                                    ; preds = %cond.false297
  %68 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub303 = sub i64 %68, 1, !dbg !5514
  %and304 = and i64 %sub303, 16, !dbg !5514
  %tobool305 = icmp ne i64 %and304, 0, !dbg !5514
  br i1 %tobool305, label %cond.true306, label %cond.false307, !dbg !5514

cond.true306:                                     ; preds = %cond.false302
  br label %cond.end317, !dbg !5514

cond.false307:                                    ; preds = %cond.false302
  %69 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub308 = sub i64 %69, 1, !dbg !5514
  %and309 = and i64 %sub308, 8, !dbg !5514
  %tobool310 = icmp ne i64 %and309, 0, !dbg !5514
  br i1 %tobool310, label %cond.true311, label %cond.false312, !dbg !5514

cond.true311:                                     ; preds = %cond.false307
  br label %cond.end, !dbg !5514

cond.false312:                                    ; preds = %cond.false307
  %70 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub313 = sub i64 %70, 1, !dbg !5514
  %and314 = and i64 %sub313, 4, !dbg !5514
  %tobool315 = icmp ne i64 %and314, 0, !dbg !5514
  %71 = zext i1 %tobool315 to i64, !dbg !5514
  %cond = select i1 %tobool315, i32 2, i32 1, !dbg !5514
  br label %cond.end, !dbg !5514

cond.end:                                         ; preds = %cond.false312, %cond.true311
  %cond316 = phi i32 [ 3, %cond.true311 ], [ %cond, %cond.false312 ], !dbg !5514
  br label %cond.end317, !dbg !5514

cond.end317:                                      ; preds = %cond.end, %cond.true306
  %cond318 = phi i32 [ 4, %cond.true306 ], [ %cond316, %cond.end ], !dbg !5514
  br label %cond.end319, !dbg !5514

cond.end319:                                      ; preds = %cond.end317, %cond.true301
  %cond320 = phi i32 [ 5, %cond.true301 ], [ %cond318, %cond.end317 ], !dbg !5514
  br label %cond.end321, !dbg !5514

cond.end321:                                      ; preds = %cond.end319, %cond.true296
  %cond322 = phi i32 [ 6, %cond.true296 ], [ %cond320, %cond.end319 ], !dbg !5514
  br label %cond.end323, !dbg !5514

cond.end323:                                      ; preds = %cond.end321, %cond.true291
  %cond324 = phi i32 [ 7, %cond.true291 ], [ %cond322, %cond.end321 ], !dbg !5514
  br label %cond.end325, !dbg !5514

cond.end325:                                      ; preds = %cond.end323, %cond.true286
  %cond326 = phi i32 [ 8, %cond.true286 ], [ %cond324, %cond.end323 ], !dbg !5514
  br label %cond.end327, !dbg !5514

cond.end327:                                      ; preds = %cond.end325, %cond.true281
  %cond328 = phi i32 [ 9, %cond.true281 ], [ %cond326, %cond.end325 ], !dbg !5514
  br label %cond.end329, !dbg !5514

cond.end329:                                      ; preds = %cond.end327, %cond.true276
  %cond330 = phi i32 [ 10, %cond.true276 ], [ %cond328, %cond.end327 ], !dbg !5514
  br label %cond.end331, !dbg !5514

cond.end331:                                      ; preds = %cond.end329, %cond.true271
  %cond332 = phi i32 [ 11, %cond.true271 ], [ %cond330, %cond.end329 ], !dbg !5514
  br label %cond.end333, !dbg !5514

cond.end333:                                      ; preds = %cond.end331, %cond.true266
  %cond334 = phi i32 [ 12, %cond.true266 ], [ %cond332, %cond.end331 ], !dbg !5514
  br label %cond.end335, !dbg !5514

cond.end335:                                      ; preds = %cond.end333, %cond.true261
  %cond336 = phi i32 [ 13, %cond.true261 ], [ %cond334, %cond.end333 ], !dbg !5514
  br label %cond.end337, !dbg !5514

cond.end337:                                      ; preds = %cond.end335, %cond.true256
  %cond338 = phi i32 [ 14, %cond.true256 ], [ %cond336, %cond.end335 ], !dbg !5514
  br label %cond.end339, !dbg !5514

cond.end339:                                      ; preds = %cond.end337, %cond.true251
  %cond340 = phi i32 [ 15, %cond.true251 ], [ %cond338, %cond.end337 ], !dbg !5514
  br label %cond.end341, !dbg !5514

cond.end341:                                      ; preds = %cond.end339, %cond.true246
  %cond342 = phi i32 [ 16, %cond.true246 ], [ %cond340, %cond.end339 ], !dbg !5514
  br label %cond.end343, !dbg !5514

cond.end343:                                      ; preds = %cond.end341, %cond.true241
  %cond344 = phi i32 [ 17, %cond.true241 ], [ %cond342, %cond.end341 ], !dbg !5514
  br label %cond.end345, !dbg !5514

cond.end345:                                      ; preds = %cond.end343, %cond.true236
  %cond346 = phi i32 [ 18, %cond.true236 ], [ %cond344, %cond.end343 ], !dbg !5514
  br label %cond.end347, !dbg !5514

cond.end347:                                      ; preds = %cond.end345, %cond.true231
  %cond348 = phi i32 [ 19, %cond.true231 ], [ %cond346, %cond.end345 ], !dbg !5514
  br label %cond.end349, !dbg !5514

cond.end349:                                      ; preds = %cond.end347, %cond.true226
  %cond350 = phi i32 [ 20, %cond.true226 ], [ %cond348, %cond.end347 ], !dbg !5514
  br label %cond.end351, !dbg !5514

cond.end351:                                      ; preds = %cond.end349, %cond.true221
  %cond352 = phi i32 [ 21, %cond.true221 ], [ %cond350, %cond.end349 ], !dbg !5514
  br label %cond.end353, !dbg !5514

cond.end353:                                      ; preds = %cond.end351, %cond.true216
  %cond354 = phi i32 [ 22, %cond.true216 ], [ %cond352, %cond.end351 ], !dbg !5514
  br label %cond.end355, !dbg !5514

cond.end355:                                      ; preds = %cond.end353, %cond.true211
  %cond356 = phi i32 [ 23, %cond.true211 ], [ %cond354, %cond.end353 ], !dbg !5514
  br label %cond.end357, !dbg !5514

cond.end357:                                      ; preds = %cond.end355, %cond.true206
  %cond358 = phi i32 [ 24, %cond.true206 ], [ %cond356, %cond.end355 ], !dbg !5514
  br label %cond.end359, !dbg !5514

cond.end359:                                      ; preds = %cond.end357, %cond.true201
  %cond360 = phi i32 [ 25, %cond.true201 ], [ %cond358, %cond.end357 ], !dbg !5514
  br label %cond.end361, !dbg !5514

cond.end361:                                      ; preds = %cond.end359, %cond.true196
  %cond362 = phi i32 [ 26, %cond.true196 ], [ %cond360, %cond.end359 ], !dbg !5514
  br label %cond.end363, !dbg !5514

cond.end363:                                      ; preds = %cond.end361, %cond.true191
  %cond364 = phi i32 [ 27, %cond.true191 ], [ %cond362, %cond.end361 ], !dbg !5514
  br label %cond.end365, !dbg !5514

cond.end365:                                      ; preds = %cond.end363, %cond.true186
  %cond366 = phi i32 [ 28, %cond.true186 ], [ %cond364, %cond.end363 ], !dbg !5514
  br label %cond.end367, !dbg !5514

cond.end367:                                      ; preds = %cond.end365, %cond.true181
  %cond368 = phi i32 [ 29, %cond.true181 ], [ %cond366, %cond.end365 ], !dbg !5514
  br label %cond.end369, !dbg !5514

cond.end369:                                      ; preds = %cond.end367, %cond.true176
  %cond370 = phi i32 [ 30, %cond.true176 ], [ %cond368, %cond.end367 ], !dbg !5514
  br label %cond.end371, !dbg !5514

cond.end371:                                      ; preds = %cond.end369, %cond.true171
  %cond372 = phi i32 [ 31, %cond.true171 ], [ %cond370, %cond.end369 ], !dbg !5514
  br label %cond.end373, !dbg !5514

cond.end373:                                      ; preds = %cond.end371, %cond.true166
  %cond374 = phi i32 [ 32, %cond.true166 ], [ %cond372, %cond.end371 ], !dbg !5514
  br label %cond.end375, !dbg !5514

cond.end375:                                      ; preds = %cond.end373, %cond.true161
  %cond376 = phi i32 [ 33, %cond.true161 ], [ %cond374, %cond.end373 ], !dbg !5514
  br label %cond.end377, !dbg !5514

cond.end377:                                      ; preds = %cond.end375, %cond.true156
  %cond378 = phi i32 [ 34, %cond.true156 ], [ %cond376, %cond.end375 ], !dbg !5514
  br label %cond.end379, !dbg !5514

cond.end379:                                      ; preds = %cond.end377, %cond.true151
  %cond380 = phi i32 [ 35, %cond.true151 ], [ %cond378, %cond.end377 ], !dbg !5514
  br label %cond.end381, !dbg !5514

cond.end381:                                      ; preds = %cond.end379, %cond.true146
  %cond382 = phi i32 [ 36, %cond.true146 ], [ %cond380, %cond.end379 ], !dbg !5514
  br label %cond.end383, !dbg !5514

cond.end383:                                      ; preds = %cond.end381, %cond.true141
  %cond384 = phi i32 [ 37, %cond.true141 ], [ %cond382, %cond.end381 ], !dbg !5514
  br label %cond.end385, !dbg !5514

cond.end385:                                      ; preds = %cond.end383, %cond.true136
  %cond386 = phi i32 [ 38, %cond.true136 ], [ %cond384, %cond.end383 ], !dbg !5514
  br label %cond.end387, !dbg !5514

cond.end387:                                      ; preds = %cond.end385, %cond.true131
  %cond388 = phi i32 [ 39, %cond.true131 ], [ %cond386, %cond.end385 ], !dbg !5514
  br label %cond.end389, !dbg !5514

cond.end389:                                      ; preds = %cond.end387, %cond.true126
  %cond390 = phi i32 [ 40, %cond.true126 ], [ %cond388, %cond.end387 ], !dbg !5514
  br label %cond.end391, !dbg !5514

cond.end391:                                      ; preds = %cond.end389, %cond.true121
  %cond392 = phi i32 [ 41, %cond.true121 ], [ %cond390, %cond.end389 ], !dbg !5514
  br label %cond.end393, !dbg !5514

cond.end393:                                      ; preds = %cond.end391, %cond.true116
  %cond394 = phi i32 [ 42, %cond.true116 ], [ %cond392, %cond.end391 ], !dbg !5514
  br label %cond.end395, !dbg !5514

cond.end395:                                      ; preds = %cond.end393, %cond.true111
  %cond396 = phi i32 [ 43, %cond.true111 ], [ %cond394, %cond.end393 ], !dbg !5514
  br label %cond.end397, !dbg !5514

cond.end397:                                      ; preds = %cond.end395, %cond.true106
  %cond398 = phi i32 [ 44, %cond.true106 ], [ %cond396, %cond.end395 ], !dbg !5514
  br label %cond.end399, !dbg !5514

cond.end399:                                      ; preds = %cond.end397, %cond.true101
  %cond400 = phi i32 [ 45, %cond.true101 ], [ %cond398, %cond.end397 ], !dbg !5514
  br label %cond.end401, !dbg !5514

cond.end401:                                      ; preds = %cond.end399, %cond.true96
  %cond402 = phi i32 [ 46, %cond.true96 ], [ %cond400, %cond.end399 ], !dbg !5514
  br label %cond.end403, !dbg !5514

cond.end403:                                      ; preds = %cond.end401, %cond.true91
  %cond404 = phi i32 [ 47, %cond.true91 ], [ %cond402, %cond.end401 ], !dbg !5514
  br label %cond.end405, !dbg !5514

cond.end405:                                      ; preds = %cond.end403, %cond.true86
  %cond406 = phi i32 [ 48, %cond.true86 ], [ %cond404, %cond.end403 ], !dbg !5514
  br label %cond.end407, !dbg !5514

cond.end407:                                      ; preds = %cond.end405, %cond.true81
  %cond408 = phi i32 [ 49, %cond.true81 ], [ %cond406, %cond.end405 ], !dbg !5514
  br label %cond.end409, !dbg !5514

cond.end409:                                      ; preds = %cond.end407, %cond.true76
  %cond410 = phi i32 [ 50, %cond.true76 ], [ %cond408, %cond.end407 ], !dbg !5514
  br label %cond.end411, !dbg !5514

cond.end411:                                      ; preds = %cond.end409, %cond.true71
  %cond412 = phi i32 [ 51, %cond.true71 ], [ %cond410, %cond.end409 ], !dbg !5514
  br label %cond.end413, !dbg !5514

cond.end413:                                      ; preds = %cond.end411, %cond.true66
  %cond414 = phi i32 [ 52, %cond.true66 ], [ %cond412, %cond.end411 ], !dbg !5514
  br label %cond.end415, !dbg !5514

cond.end415:                                      ; preds = %cond.end413, %cond.true61
  %cond416 = phi i32 [ 53, %cond.true61 ], [ %cond414, %cond.end413 ], !dbg !5514
  br label %cond.end417, !dbg !5514

cond.end417:                                      ; preds = %cond.end415, %cond.true56
  %cond418 = phi i32 [ 54, %cond.true56 ], [ %cond416, %cond.end415 ], !dbg !5514
  br label %cond.end419, !dbg !5514

cond.end419:                                      ; preds = %cond.end417, %cond.true51
  %cond420 = phi i32 [ 55, %cond.true51 ], [ %cond418, %cond.end417 ], !dbg !5514
  br label %cond.end421, !dbg !5514

cond.end421:                                      ; preds = %cond.end419, %cond.true46
  %cond422 = phi i32 [ 56, %cond.true46 ], [ %cond420, %cond.end419 ], !dbg !5514
  br label %cond.end423, !dbg !5514

cond.end423:                                      ; preds = %cond.end421, %cond.true41
  %cond424 = phi i32 [ 57, %cond.true41 ], [ %cond422, %cond.end421 ], !dbg !5514
  br label %cond.end425, !dbg !5514

cond.end425:                                      ; preds = %cond.end423, %cond.true36
  %cond426 = phi i32 [ 58, %cond.true36 ], [ %cond424, %cond.end423 ], !dbg !5514
  br label %cond.end427, !dbg !5514

cond.end427:                                      ; preds = %cond.end425, %cond.true31
  %cond428 = phi i32 [ 59, %cond.true31 ], [ %cond426, %cond.end425 ], !dbg !5514
  br label %cond.end429, !dbg !5514

cond.end429:                                      ; preds = %cond.end427, %cond.true26
  %cond430 = phi i32 [ 60, %cond.true26 ], [ %cond428, %cond.end427 ], !dbg !5514
  br label %cond.end431, !dbg !5514

cond.end431:                                      ; preds = %cond.end429, %cond.true21
  %cond432 = phi i32 [ 61, %cond.true21 ], [ %cond430, %cond.end429 ], !dbg !5514
  br label %cond.end433, !dbg !5514

cond.end433:                                      ; preds = %cond.end431, %cond.true16
  %cond434 = phi i32 [ 62, %cond.true16 ], [ %cond432, %cond.end431 ], !dbg !5514
  br label %cond.end435, !dbg !5514

cond.end435:                                      ; preds = %cond.end433, %cond.true11
  %cond436 = phi i32 [ 63, %cond.true11 ], [ %cond434, %cond.end433 ], !dbg !5514
  br label %cond.end437, !dbg !5514

cond.end437:                                      ; preds = %cond.end435, %cond.true8
  %cond438 = phi i32 [ 0, %cond.true8 ], [ %cond436, %cond.end435 ], !dbg !5514
  br label %cond.end440, !dbg !5514

cond.false439:                                    ; preds = %cond.true
  br label %cond.end440, !dbg !5514

cond.end440:                                      ; preds = %cond.false439, %cond.end437
  %cond441 = phi i32 [ %cond438, %cond.end437 ], [ -1, %cond.false439 ], !dbg !5514
  br label %cond.end444, !dbg !5514

cond.false442:                                    ; preds = %if.end3
  %72 = load i64, i64* %size.addr, align 8, !dbg !5514
  %sub443 = sub i64 %72, 1, !dbg !5514
  %call = call i32 @__ilog2_u64(i64 %sub443) #7, !dbg !5514
  br label %cond.end444, !dbg !5514

cond.end444:                                      ; preds = %cond.false442, %cond.end440
  %cond445 = phi i32 [ %cond441, %cond.end440 ], [ %call, %cond.false442 ], !dbg !5514
  %sub446 = sub i32 %cond445, 12, !dbg !5515
  %add = add i32 %sub446, 1, !dbg !5516
  store i32 %add, i32* %retval, align 4, !dbg !5517
  br label %return, !dbg !5517

if.end447:                                        ; preds = %entry
  %73 = load i64, i64* %size.addr, align 8, !dbg !5518
  %dec = add i64 %73, -1, !dbg !5518
  store i64 %dec, i64* %size.addr, align 8, !dbg !5518
  %74 = load i64, i64* %size.addr, align 8, !dbg !5519
  %shr = lshr i64 %74, 12, !dbg !5519
  store i64 %shr, i64* %size.addr, align 8, !dbg !5519
  %75 = load i64, i64* %size.addr, align 8, !dbg !5520
  store i64 %75, i64* %x.addr.i, align 8
  store i32 -1, i32* %bitpos.i, align 4, !dbg !5497
  %76 = load i32, i32* %bitpos.i, align 4, !dbg !5521
  %77 = load i64, i64* %x.addr.i, align 8, !dbg !5522
  %78 = call i32 asm "bsrq $1,${0:q}", "=r,rm,0,~{dirflag},~{fpsr},~{flags}"(i64 %77, i32 %76) #10, !dbg !5521, !srcloc !5523
  store i32 %78, i32* %bitpos.i, align 4, !dbg !5521
  %79 = load i32, i32* %bitpos.i, align 4, !dbg !5524
  %add.i = add i32 %79, 1, !dbg !5525
  store i32 %add.i, i32* %retval, align 4, !dbg !5526
  br label %return, !dbg !5526

return:                                           ; preds = %if.end447, %cond.end444, %if.then2, %if.then1
  %80 = load i32, i32* %retval, align 4, !dbg !5527
  ret i32 %80, !dbg !5527
}

; Function Attrs: noinline noredzone nounwind optnone readnone sspstrong
define internal i32 @__ilog2_u64(i64 %n) #5 !dbg !5528 {
entry:
  %x.addr.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %x.addr.i, metadata !5489, metadata !DIExpression()), !dbg !5532
  %bitpos.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %bitpos.i, metadata !5496, metadata !DIExpression()), !dbg !5534
  %n.addr = alloca i64, align 8
  store i64 %n, i64* %n.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %n.addr, metadata !5535, metadata !DIExpression()), !dbg !5536
  %0 = load i64, i64* %n.addr, align 8, !dbg !5537
  store i64 %0, i64* %x.addr.i, align 8
  store i32 -1, i32* %bitpos.i, align 4, !dbg !5534
  %1 = load i32, i32* %bitpos.i, align 4, !dbg !5538
  %2 = load i64, i64* %x.addr.i, align 8, !dbg !5539
  %3 = call i32 asm "bsrq $1,${0:q}", "=r,rm,0,~{dirflag},~{fpsr},~{flags}"(i64 %2, i32 %1) #10, !dbg !5538, !srcloc !5523
  store i32 %3, i32* %bitpos.i, align 4, !dbg !5538
  %4 = load i32, i32* %bitpos.i, align 4, !dbg !5540
  %add.i = add i32 %4, 1, !dbg !5541
  %sub = sub i32 %add.i, 1, !dbg !5542
  ret i32 %sub, !dbg !5543
}
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal i8* @kasan_kmalloc(%struct.kmem_cache* %s, i8* %object, i64 %size, i32 %flags) #0 !dbg !5544 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.kmem_cache** %s.addr, metadata !5548, metadata !DIExpression()), !dbg !5549
  store i8* %object, i8** %object.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %object.addr, metadata !5550, metadata !DIExpression()), !dbg !5551
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !5552, metadata !DIExpression()), !dbg !5553
  store i32 %flags, i32* %flags.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr, metadata !5554, metadata !DIExpression()), !dbg !5555
  %0 = load i8*, i8** %object.addr, align 8, !dbg !5556
  ret i8* %0, !dbg !5557
}

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @list_del(%struct.list_head* %entry1) #0 !dbg !5558 {
entry:
  %entry.addr = alloca %struct.list_head*, align 8
  store %struct.list_head* %entry1, %struct.list_head** %entry.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %entry.addr, metadata !5559, metadata !DIExpression()), !dbg !5560
  %0 = load %struct.list_head*, %struct.list_head** %entry.addr, align 8, !dbg !5561
  call void @__list_del_entry(%struct.list_head* %0) #9, !dbg !5562
  %1 = load %struct.list_head*, %struct.list_head** %entry.addr, align 8, !dbg !5563
  %next = getelementptr inbounds %struct.list_head, %struct.list_head* %1, i32 0, i32 0, !dbg !5564
  store %struct.list_head* bitcast (i8* getelementptr (i8, i8* inttoptr (i64 256 to i8*), i64 -2401263026318606336) to %struct.list_head*), %struct.list_head** %next, align 8, !dbg !5565
  %2 = load %struct.list_head*, %struct.list_head** %entry.addr, align 8, !dbg !5566
  %prev = getelementptr inbounds %struct.list_head, %struct.list_head* %2, i32 0, i32 1, !dbg !5567
  store %struct.list_head* bitcast (i8* getelementptr (i8, i8* inttoptr (i64 290 to i8*), i64 -2401263026318606336) to %struct.list_head*), %struct.list_head** %prev, align 8, !dbg !5568
  ret void, !dbg !5569
}

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @device_lock(%struct.device* %dev) #0 !dbg !5570 {
entry:
  %dev.addr = alloca %struct.device*, align 8
  store %struct.device* %dev, %struct.device** %dev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.device** %dev.addr, metadata !5571, metadata !DIExpression()), !dbg !5572
  %0 = load %struct.device*, %struct.device** %dev.addr, align 8, !dbg !5573
  %mutex = getelementptr inbounds %struct.device, %struct.device* %0, i32 0, i32 9, !dbg !5574
  call void @mutex_lock(%struct.mutex* %mutex) #9, !dbg !5575
  ret void, !dbg !5576
}
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @device_unlock(%struct.device* %dev) #0 !dbg !5577 {
entry:
  %dev.addr = alloca %struct.device*, align 8
  store %struct.device* %dev, %struct.device** %dev.addr, align 8
  ...
  %mutex = getelementptr inbounds %struct.device, %struct.device* %0, i32 0, i32 9, !dbg !5581
  call void @mutex_unlock(%struct.mutex* %mutex) #9, !dbg !5582
  ret void, !dbg !5583
}
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @__list_del_entry(%struct.list_head* %entry1) #0 !dbg !5584 {
entry:
  %entry.addr = alloca %struct.list_head*, align 8
  store %struct.list_head* %entry1, %struct.list_head** %entry.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %entry.addr, metadata !5585, metadata !DIExpression()), !dbg !5586
  %0 = load %struct.list_head*, %struct.list_head** %entry.addr, align 8, !dbg !5587
  %call = call zeroext i1 @__list_del_entry_valid(%struct.list_head* %0) #9, !dbg !5589
  br i1 %call, label %if.end, label %if.then, !dbg !5590

if.then:                                          ; preds = %entry
  br label %return, !dbg !5591

if.end:                                           ; preds = %entry
  %1 = load %struct.list_head*, %struct.list_head** %entry.addr, align 8, !dbg !5592
  %prev = getelementptr inbounds %struct.list_head, %struct.list_head* %1, i32 0, i32 1, !dbg !5593
  %2 = load %struct.list_head*, %struct.list_head** %prev, align 8, !dbg !5593
  %3 = load %struct.list_head*, %struct.list_head** %entry.addr, align 8, !dbg !5594
  %next = getelementptr inbounds %struct.list_head, %struct.list_head* %3, i32 0, i32 0, !dbg !5595
  %4 = load %struct.list_head*, %struct.list_head** %next, align 8, !dbg !5595
  call void @__list_del(%struct.list_head* %2, %struct.list_head* %4) #9, !dbg !5596
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal zeroext i1 @__list_del_entry_valid(%struct.list_head* %entry1) #0 !dbg !5598 {
entry:
  %entry.addr = alloca %struct.list_head*, align 8
  store %struct.list_head* %entry1, %struct.list_head** %entry.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %entry.addr, metadata !5601, metadata !DIExpression()), !dbg !5602
  ret i1 true, !dbg !5603
}

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @__list_del(%struct.list_head* %prev, %struct.list_head* %next) #0 !dbg !5604 {
entry:
  ...
  %0 = load %struct.list_head*, %struct.list_head** %prev.addr, align 8, !dbg !5611
  %1 = load %struct.list_head*, %struct.list_head** %next.addr, align 8, !dbg !5612
  %prev1 = getelementptr inbounds %struct.list_head, %struct.list_head* %1, i32 0, i32 1, !dbg !5613
  store %struct.list_head* %0, %struct.list_head** %prev1, align 8, !dbg !5614
  br label %do.body, !dbg !5615

do.body:                                          ; preds = %entry
  br label %do.body2, !dbg !5616

do.body2:                                         ; preds = %do.body
  br label %do.end, !dbg !5618

do.end:                                           ; preds = %do.body2
  br label %do.body3, !dbg !5616

do.body3:                                         ; preds = %do.end
  %2 = load %struct.list_head*, %struct.list_head** %next.addr, align 8, !dbg !5620
  %3 = load %struct.list_head*, %struct.list_head** %prev.addr, align 8, !dbg !5620
  %next4 = getelementptr inbounds %struct.list_head, %struct.list_head* %3, i32 0, i32 0, !dbg !5620
  store volatile %struct.list_head* %2, %struct.list_head** %next4, align 8, !dbg !5620
  br label %do.end5, !dbg !5620

do.end5:                                          ; preds = %do.body3
  br label %do.end6, !dbg !5616
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal i32 @pci_domain_nr(%struct.pci_bus* %bus) #0 !dbg !5623 {
entry:
  %bus.addr = alloca %struct.pci_bus*, align 8
  store %struct.pci_bus* %bus, %struct.pci_bus** %bus.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.pci_bus** %bus.addr, metadata !5625, metadata !DIExpression()), !dbg !5626
  %0 = load %struct.pci_bus*, %struct.pci_bus** %bus.addr, align 8, !dbg !5627
  %call = call %struct.pci_sysdata* @to_pci_sysdata(%struct.pci_bus* %0) #9, !dbg !5628
  %domain = getelementptr inbounds %struct.pci_sysdata, %struct.pci_sysdata* %call, i32 0, i32 0, !dbg !5629
  %1 = load i32, i32* %domain, align 8, !dbg !5629
  ret i32 %1, !dbg !5630
}

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal %struct.pci_sysdata* @to_pci_sysdata(%struct.pci_bus* %bus) #0 !dbg !5631 {
entry:
  %bus.addr = alloca %struct.pci_bus*, align 8
  store %struct.pci_bus* %bus, %struct.pci_bus** %bus.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.pci_bus** %bus.addr, metadata !5647, metadata !DIExpression()), !dbg !5648
  %0 = load %struct.pci_bus*, %struct.pci_bus** %bus.addr, align 8, !dbg !5649
  %sysdata = getelementptr inbounds %struct.pci_bus, %struct.pci_bus* %0, i32 0, i32 11, !dbg !5650
  %1 = load i8*, i8** %sysdata, align 8, !dbg !5650
  %2 = bitcast i8* %1 to %struct.pci_sysdata*, !dbg !5649
  ret %struct.pci_sysdata* %2, !dbg !5651
}

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @list_add_tail(%struct.list_head* %new, %struct.list_head* %head) #0 !dbg !5652 {
entry:
  %new.addr = alloca %struct.list_head*, align 8
  %head.addr = alloca %struct.list_head*, align 8
  store %struct.list_head* %new, %struct.list_head** %new.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %new.addr, metadata !5653, metadata !DIExpression()), !dbg !5654
  store %struct.list_head* %head, %struct.list_head** %head.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %head.addr, metadata !5655, metadata !DIExpression()), !dbg !5656
  %0 = load %struct.list_head*, %struct.list_head** %new.addr, align 8, !dbg !5657
  %1 = load %struct.list_head*, %struct.list_head** %head.addr, align 8, !dbg !5658
  %prev = getelementptr inbounds %struct.list_head, %struct.list_head* %1, i32 0, i32 1, !dbg !5659
  %2 = load %struct.list_head*, %struct.list_head** %prev, align 8, !dbg !5659
  %3 = load %struct.list_head*, %struct.list_head** %head.addr, align 8, !dbg !5660
  call void @__list_add(%struct.list_head* %0, %struct.list_head* %2, %struct.list_head* %3) #9, !dbg !5661
  ret void, !dbg !5662
}

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @__list_add(%struct.list_head* %new, %struct.list_head* %prev, %struct.list_head* %next) #0 !dbg !5663 {
entry:
  %new.addr = alloca %struct.list_head*, align 8
  %prev.addr = alloca %struct.list_head*, align 8
  %next.addr = alloca %struct.list_head*, align 8
  ...
  %0 = load %struct.list_head*, %struct.list_head** %new.addr, align 8, !dbg !5672
  %1 = load %struct.list_head*, %struct.list_head** %prev.addr, align 8, !dbg !5674
  %2 = load %struct.list_head*, %struct.list_head** %next.addr, align 8, !dbg !5675
  %call = call zeroext i1 @__list_add_valid(%struct.list_head* %0, %struct.list_head* %1, %struct.list_head* %2) #9, !dbg !5676
  br i1 %call, label %if.end, label %if.then, !dbg !5677

if.then:                                          ; preds = %entry
  br label %do.end8, !dbg !5678

if.end:                                           ; preds = %entry
  %3 = load %struct.list_head*, %struct.list_head** %new.addr, align 8, !dbg !5679
  %4 = load %struct.list_head*, %struct.list_head** %next.addr, align 8, !dbg !5680
  %prev1 = getelementptr inbounds %struct.list_head, %struct.list_head* %4, i32 0, i32 1, !dbg !5681
  store %struct.list_head* %3, %struct.list_head** %prev1, align 8, !dbg !5682
  %5 = load %struct.list_head*, %struct.list_head** %next.addr, align 8, !dbg !5683
  %6 = load %struct.list_head*, %struct.list_head** %new.addr, align 8, !dbg !5684
  %next2 = getelementptr inbounds %struct.list_head, %struct.list_head* %6, i32 0, i32 0, !dbg !5685
  store %struct.list_head* %5, %struct.list_head** %next2, align 8, !dbg !5686
  %7 = load %struct.list_head*, %struct.list_head** %prev.addr, align 8, !dbg !5687
  %8 = load %struct.list_head*, %struct.list_head** %new.addr, align 8, !dbg !5688
  %prev3 = getelementptr inbounds %struct.list_head, %struct.list_head* %8, i32 0, i32 1, !dbg !5689
  store %struct.list_head* %7, %struct.list_head** %prev3, align 8, !dbg !5690
  br label %do.body, !dbg !5691

do.body:                                          ; preds = %if.end
  br label %do.body4, !dbg !5692

do.body4:                                         ; preds = %do.body
  br label %do.end, !dbg !5694

do.end:                                           ; preds = %do.body4
  br label %do.body5, !dbg !5692

do.body5:                                         ; preds = %do.end
  %9 = load %struct.list_head*, %struct.list_head** %new.addr, align 8, !dbg !5696
  %10 = load %struct.list_head*, %struct.list_head** %prev.addr, align 8, !dbg !5696
  %next6 = getelementptr inbounds %struct.list_head, %struct.list_head* %10, i32 0, i32 0, !dbg !5696
  store volatile %struct.list_head* %9, %struct.list_head** %next6, align 8, !dbg !5696
  br label %do.end7, !dbg !5696

do.end7:                                          ; preds = %do.body5
  br label %do.end8, !dbg !5692
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal zeroext i1 @__list_add_valid(%struct.list_head* %new, %struct.list_head* %prev, %struct.list_head* %next) #0 !dbg !5699 {
entry:
  %new.addr = alloca %struct.list_head*, align 8
  %prev.addr = alloca %struct.list_head*, align 8
  %next.addr = alloca %struct.list_head*, align 8
  store %struct.list_head* %new, %struct.list_head** %new.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %new.addr, metadata !5702, metadata !DIExpression()), !dbg !5703
  store %struct.list_head* %prev, %struct.list_head** %prev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %prev.addr, metadata !5704, metadata !DIExpression()), !dbg !5705
  store %struct.list_head* %next, %struct.list_head** %next.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.list_head** %next.addr, metadata !5706, metadata !DIExpression()), !dbg !5707
  ret i1 true, !dbg !5708
}
...
!llvm.dbg.cu = !{!2}
!llvm.module.flags = !{!4553, !4554, !4555, !4556}
!llvm.ident = !{!4557}

!0 = !DIGlobalVariableExpression(var: !1, expr: !DIExpression())
!1 = distinct !DIGlobalVariable(name: "xen_pcibk_passthrough_backend", scope: !2, file: !3, line: 188, type: !4515, isLocal: false, isDefinition: true)
!2 = distinct !DICompileUnit(language: DW_LANG_C89, file: !3, producer: "clang version 10.0.1 (https://github.com/llvm/llvm-project.git ef32c611aa214dea855364efd7ba451ec5ec3f74)", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !152, globals: !4435, splitDebugInlining: false, nameTableKind: None)
!3 = !DIFile(filename: "drivers/xen/xen-pciback/passthrough.c", directory: "/home/lizy2001/genbc/linux")
...
!4437 = distinct !DIGlobalVariable(name: "__key", scope: !4438, file: !3, line: 108, type: !672, isLocal: true, isDefinition: true)
!4438 = distinct !DISubprogram(name: "__xen_pcibk_init_devices", scope: !3, file: !3, line: 100, type: !4439, scopeLine: 101, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!4439 = !DISubroutineType(types: !4440)
!4440 = !{!221, !4441}
!4441 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4442, size: 64)
!4442 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "xen_pcibk_device", file: !165, line: 34, size: 5440, elements: !4443)
!4443 = !{!4444, !4445, !4446, !4476, !4477, !4478, !4479, !4512, !4513, !4514}
!4444 = !DIDerivedType(tag: DW_TAG_member, name: "pci_dev_data", scope: !4442, file: !165, line: 35, baseType: !155, size: 64)
!4445 = !DIDerivedType(tag: DW_TAG_member, name: "dev_lock", scope: !4442, file: !165, line: 36, baseType: !1198, size: 192, offset: 64)
!4446 = !DIDerivedType(tag: DW_TAG_member, name: "xdev", scope: !4442, file: !165, line: 37, baseType: !4447, size: 64, offset: 256)
!4447 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4448, size: 64)
!4448 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "xenbus_device", file: !4449, line: 71, size: 6784, elements: !4450)
!4449 = !DIFile(filename: "./include/xen/xenbus.h", directory: "/home/lizy2001/genbc/linux")
!4450 = !{!4451, !4452, !4453, !4454, !4455, !4465, !4466, !4467, !4468, !4469}
!4451 = !DIDerivedType(tag: DW_TAG_member, name: "devicetype", scope: !4448, file: !4449, line: 72, baseType: !200, size: 64)
!4452 = !DIDerivedType(tag: DW_TAG_member, name: "nodename", scope: !4448, file: !4449, line: 73, baseType: !200, size: 64, offset: 64)
!4453 = !DIDerivedType(tag: DW_TAG_member, name: "otherend", scope: !4448, file: !4449, line: 74, baseType: !200, size: 64, offset: 128)
!4454 = !DIDerivedType(tag: DW_TAG_member, name: "otherend_id", scope: !4448, file: !4449, line: 75, baseType: !221, size: 32, offset: 192)
!4455 = !DIDerivedType(tag: DW_TAG_member, name: "otherend_watch", scope: !4448, file: !4449, line: 76, baseType: !4456, size: 256, offset: 256)
!4456 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "xenbus_watch", file: !4449, line: 57, size: 256, elements: !4457)
!4457 = !{!4458, !4459, !4460}
!4458 = !DIDerivedType(tag: DW_TAG_member, name: "list", scope: !4456, file: !4449, line: 59, baseType: !159, size: 128)
!4459 = !DIDerivedType(tag: DW_TAG_member, name: "node", scope: !4456, file: !4449, line: 62, baseType: !200, size: 64, offset: 128)
!4460 = !DIDerivedType(tag: DW_TAG_member, name: "callback", scope: !4456, file: !4449, line: 65, baseType: !4461, size: 64, offset: 192)
!4461 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4462, size: 64)
!4462 = !DISubroutineType(types: !4463)
!4463 = !{null, !4464, !200, !200}
!4464 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4456, size: 64)
!4465 = !DIDerivedType(tag: DW_TAG_member, name: "dev", scope: !4448, file: !4449, line: 77, baseType: !252, size: 5568, offset: 512)
!4466 = !DIDerivedType(tag: DW_TAG_member, name: "state", scope: !4448, file: !4449, line: 78, baseType: !128, size: 32, offset: 6080)
!4467 = !DIDerivedType(tag: DW_TAG_member, name: "down", scope: !4448, file: !4449, line: 79, baseType: !1510, size: 192, offset: 6144)
!4468 = !DIDerivedType(tag: DW_TAG_member, name: "work", scope: !4448, file: !4449, line: 80, baseType: !1966, size: 256, offset: 6336)
!4469 = !DIDerivedType(tag: DW_TAG_member, name: "reclaim_sem", scope: !4448, file: !4449, line: 81, baseType: !4470, size: 192, offset: 6592)
!4470 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "semaphore", file: !4471, line: 15, size: 192, elements: !4472)
!4471 = !DIFile(filename: "./include/linux/semaphore.h", directory: "/home/lizy2001/genbc/linux")
!4472 = !{!4473, !4474, !4475}
!4473 = !DIDerivedType(tag: DW_TAG_member, name: "lock", scope: !4470, file: !4471, line: 16, baseType: !807)
!4474 = !DIDerivedType(tag: DW_TAG_member, name: "count", scope: !4470, file: !4471, line: 17, baseType: !7, size: 32)
!4475 = !DIDerivedType(tag: DW_TAG_member, name: "wait_list", scope: !4470, file: !4471, line: 18, baseType: !159, size: 128, offset: 64)
!4476 = !DIDerivedType(tag: DW_TAG_member, name: "be_watch", scope: !4442, file: !165, line: 38, baseType: !4456, size: 256, offset: 320)
!4477 = !DIDerivedType(tag: DW_TAG_member, name: "be_watching", scope: !4442, file: !165, line: 39, baseType: !1361, size: 8, offset: 576)
!4478 = !DIDerivedType(tag: DW_TAG_member, name: "evtchn_irq", scope: !4442, file: !165, line: 40, baseType: !221, size: 32, offset: 608)
!4479 = !DIDerivedType(tag: DW_TAG_member, name: "sh_info", scope: !4442, file: !165, line: 41, baseType: !4480, size: 64, offset: 640)
!4480 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4481, size: 64)
!4481 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "xen_pci_sharedinfo", file: !4482, line: 105, size: 4576, elements: !4483)
!4482 = !DIFile(filename: "./include/xen/interface/io/pciif.h", directory: "/home/lizy2001/genbc/linux")
!4483 = !{!4484, !4485, !4504}
!4484 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !4481, file: !4482, line: 107, baseType: !586, size: 32)
!4485 = !DIDerivedType(tag: DW_TAG_member, name: "op", scope: !4481, file: !4482, line: 108, baseType: !4486, size: 4384, offset: 32)
!4486 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "xen_pci_op", file: !4482, line: 69, size: 4384, elements: !4487)
!4487 = !{!4488, !4489, !4490, !4491, !4492, !4493, !4494, !4495, !4496, !4497}
!4488 = !DIDerivedType(tag: DW_TAG_member, name: "cmd", scope: !4486, file: !4482, line: 71, baseType: !586, size: 32)
!4489 = !DIDerivedType(tag: DW_TAG_member, name: "err", scope: !4486, file: !4482, line: 74, baseType: !1592, size: 32, offset: 32)
!4490 = !DIDerivedType(tag: DW_TAG_member, name: "domain", scope: !4486, file: !4482, line: 77, baseType: !586, size: 32, offset: 64)
!4491 = !DIDerivedType(tag: DW_TAG_member, name: "bus", scope: !4486, file: !4482, line: 78, baseType: !586, size: 32, offset: 96)
!4492 = !DIDerivedType(tag: DW_TAG_member, name: "devfn", scope: !4486, file: !4482, line: 79, baseType: !586, size: 32, offset: 128)
!4493 = !DIDerivedType(tag: DW_TAG_member, name: "offset", scope: !4486, file: !4482, line: 82, baseType: !1592, size: 32, offset: 160)
!4494 = !DIDerivedType(tag: DW_TAG_member, name: "size", scope: !4486, file: !4482, line: 83, baseType: !1592, size: 32, offset: 192)
!4495 = !DIDerivedType(tag: DW_TAG_member, name: "value", scope: !4486, file: !4482, line: 86, baseType: !586, size: 32, offset: 224)
!4496 = !DIDerivedType(tag: DW_TAG_member, name: "info", scope: !4486, file: !4482, line: 88, baseType: !586, size: 32, offset: 256)
!4497 = !DIDerivedType(tag: DW_TAG_member, name: "msix_entries", scope: !4486, file: !4482, line: 90, baseType: !4498, size: 4096, offset: 288)
!4498 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4499, size: 4096, elements: !3470)
!4499 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "xen_msix_entry", file: !4482, line: 65, size: 32, elements: !4500)
!4500 = !{!4501, !4503}
!4501 = !DIDerivedType(tag: DW_TAG_member, name: "vector", scope: !4499, file: !4482, line: 66, baseType: !4502, size: 16)
!4502 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint16_t", file: !154, line: 103, baseType: !886)
!4503 = !DIDerivedType(tag: DW_TAG_member, name: "entry", scope: !4499, file: !4482, line: 67, baseType: !4502, size: 16, offset: 16)
!4504 = !DIDerivedType(tag: DW_TAG_member, name: "aer_op", scope: !4481, file: !4482, line: 109, baseType: !4505, size: 160, offset: 4416)
!4505 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "xen_pcie_aer_op", file: !4482, line: 94, size: 160, elements: !4506)
!4506 = !{!4507, !4508, !4509, !4510, !4511}
!4507 = !DIDerivedType(tag: DW_TAG_member, name: "cmd", scope: !4505, file: !4482, line: 96, baseType: !586, size: 32)
!4508 = !DIDerivedType(tag: DW_TAG_member, name: "err", scope: !4505, file: !4482, line: 98, baseType: !1592, size: 32, offset: 32)
!4509 = !DIDerivedType(tag: DW_TAG_member, name: "domain", scope: !4505, file: !4482, line: 101, baseType: !586, size: 32, offset: 64)
!4510 = !DIDerivedType(tag: DW_TAG_member, name: "bus", scope: !4505, file: !4482, line: 102, baseType: !586, size: 32, offset: 96)
!4511 = !DIDerivedType(tag: DW_TAG_member, name: "devfn", scope: !4505, file: !4482, line: 103, baseType: !586, size: 32, offset: 128)
!4512 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !4442, file: !165, line: 42, baseType: !204, size: 64, offset: 704)
!4513 = !DIDerivedType(tag: DW_TAG_member, name: "op_work", scope: !4442, file: !165, line: 43, baseType: !1966, size: 256, offset: 768)
!4514 = !DIDerivedType(tag: DW_TAG_member, name: "op", scope: !4442, file: !165, line: 44, baseType: !4486, size: 4384, offset: 1024)
!4515 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !4516)
!4516 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "xen_pcibk_backend", file: !165, line: 99, size: 512, elements: !4517)
!4517 = !{!4518, !4519, !4521, !4525, !4529, !4537, !4541, !4549}
!4518 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !4516, file: !165, line: 100, baseType: !200, size: 64)
!4519 = !DIDerivedType(tag: DW_TAG_member, name: "init", scope: !4516, file: !165, line: 101, baseType: !4520, size: 64, offset: 64)
!4520 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4439, size: 64)
!4521 = !DIDerivedType(tag: DW_TAG_member, name: "free", scope: !4516, file: !165, line: 102, baseType: !4522, size: 64, offset: 128)
!4522 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4523, size: 64)
!4523 = !DISubroutineType(types: !4524)
!4524 = !{null, !4441}
!4525 = !DIDerivedType(tag: DW_TAG_member, name: "find", scope: !4516, file: !165, line: 103, baseType: !4526, size: 64, offset: 192)
!4526 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4527, size: 64)
!4527 = !DISubroutineType(types: !4528)
!4528 = !{!221, !169, !4441, !2691, !2691, !2691}
!4529 = !DIDerivedType(tag: DW_TAG_member, name: "publish", scope: !4516, file: !165, line: 106, baseType: !4530, size: 64, offset: 256)
!4530 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4531, size: 64)
!4531 = !DISubroutineType(types: !4532)
!4532 = !{!221, !4441, !4533}
!4533 = !DIDerivedType(tag: DW_TAG_typedef, name: "publish_pci_root_cb", file: !165, line: 92, baseType: !4534)
!4534 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4535, size: 64)
!4535 = !DISubroutineType(types: !4536)
!4536 = !{!221, !4441, !7, !7}
!4537 = !DIDerivedType(tag: DW_TAG_member, name: "release", scope: !4516, file: !165, line: 107, baseType: !4538, size: 64, offset: 320)
!4538 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4539, size: 64)
!4539 = !DISubroutineType(types: !4540)
!4540 = !{null, !4441, !169, !517}
!4541 = !DIDerivedType(tag: DW_TAG_member, name: "add", scope: !4516, file: !165, line: 109, baseType: !4542, size: 64, offset: 384)
!4542 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4543, size: 64)
!4543 = !DISubroutineType(types: !4544)
!4544 = !{!221, !4441, !169, !221, !4545}
!4545 = !DIDerivedType(tag: DW_TAG_typedef, name: "publish_pci_dev_cb", file: !165, line: 89, baseType: !4546)
!4546 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4547, size: 64)
!4547 = !DISubroutineType(types: !4548)
!4548 = !{!221, !4441, !7, !7, !7, !7}
!4549 = !DIDerivedType(tag: DW_TAG_member, name: "get", scope: !4516, file: !165, line: 111, baseType: !4550, size: 64, offset: 448)
!4550 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4551, size: 64)
!4551 = !DISubroutineType(types: !4552)
!4552 = !{!169, !4441, !7, !7, !7}
!4553 = !{i32 7, !"Dwarf Version", i32 4}
!4554 = !{i32 2, !"Debug Info Version", i32 3}
!4555 = !{i32 1, !"wchar_size", i32 2}
!4556 = !{i32 1, !"Code Model", i32 2}
!4557 = !{!"clang version 10.0.1 (https://github.com/llvm/llvm-project.git ef32c611aa214dea855364efd7ba451ec5ec3f74)"}
!4558 = !DILocalVariable(name: "s", arg: 1, scope: !4559, file: !141, line: 445, type: !962)
!4559 = distinct !DISubprogram(name: "kmem_cache_alloc_trace", scope: !141, file: !141, line: 445, type: !4560, scopeLine: 447, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!4560 = !DISubroutineType(types: !4561)
!4561 = !{!155, !962, !153, !356}
...
!4564 = distinct !DILexicalBlock(scope: !4565, file: !141, line: 540, column: 34)
!4565 = distinct !DILexicalBlock(scope: !4566, file: !141, line: 540, column: 6)
!4566 = distinct !DISubprogram(name: "kmalloc", scope: !141, file: !141, line: 538, type: !4567, scopeLine: 539, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!4567 = !DISubroutineType(types: !4568)
!4568 = !{!155, !356, !153}
!4569 = distinct !DILocation(line: 104, column: 13, scope: !4438)
!4570 = !DILocalVariable(name: "flags", arg: 2, scope: !4559, file: !141, line: 446, type: !153)
!4571 = !DILocation(line: 446, column: 9, scope: !4559, inlinedAt: !4563)
!4572 = !DILocalVariable(name: "size", arg: 3, scope: !4559, file: !141, line: 446, type: !356)
!4573 = !DILocation(line: 446, column: 23, scope: !4559, inlinedAt: !4563)
!4574 = !DILocalVariable(name: "ret", scope: !4559, file: !141, line: 448, type: !155)
!4575 = !DILocation(line: 448, column: 8, scope: !4559, inlinedAt: !4563)
!4576 = !DILocalVariable(name: "flags", arg: 1, scope: !4577, file: !141, line: 318, type: !153)
!4577 = distinct !DISubprogram(name: "kmalloc_type", scope: !141, file: !141, line: 318, type: !4578, scopeLine: 319, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
...
!4582 = !DILocalVariable(name: "size", arg: 1, scope: !4583, file: !141, line: 346, type: !356)
!4583 = distinct !DISubprogram(name: "kmalloc_index", scope: !141, file: !141, line: 346, type: !4584, scopeLine: 347, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
...
!4588 = !DILocalVariable(name: "size", arg: 1, scope: !4589, file: !141, line: 472, type: !356)
!4589 = distinct !DISubprogram(name: "kmalloc_order_trace", scope: !141, file: !141, line: 472, type: !4590, scopeLine: 473, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
...
!4594 = distinct !DISubprogram(name: "kmalloc_large", scope: !141, file: !141, line: 478, type: !4567, scopeLine: 479, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!4595 = distinct !DILocation(line: 545, column: 11, scope: !4596, inlinedAt: !4569)
!4596 = distinct !DILexicalBlock(scope: !4564, file: !141, line: 544, column: 7)
!4597 = !DILocalVariable(name: "flags", arg: 2, scope: !4589, file: !141, line: 472, type: !153)
!4598 = !DILocation(line: 472, column: 40, scope: !4589, inlinedAt: !4593)
!4599 = !DILocalVariable(name: "order", arg: 3, scope: !4589, file: !141, line: 472, type: !7)
!4600 = !DILocation(line: 472, column: 60, scope: !4589, inlinedAt: !4593)
!4601 = !DILocalVariable(name: "size", arg: 1, scope: !4594, file: !141, line: 478, type: !356)
!4602 = !DILocation(line: 478, column: 51, scope: !4594, inlinedAt: !4595)
!4603 = !DILocalVariable(name: "flags", arg: 2, scope: !4594, file: !141, line: 478, type: !153)
!4604 = !DILocation(line: 478, column: 63, scope: !4594, inlinedAt: !4595)
!4605 = !DILocalVariable(name: "order", scope: !4594, file: !141, line: 480, type: !7)
!4606 = !DILocation(line: 480, column: 15, scope: !4594, inlinedAt: !4595)
!4607 = !DILocalVariable(name: "size", arg: 1, scope: !4566, file: !141, line: 538, type: !356)
!4608 = !DILocation(line: 538, column: 45, scope: !4566, inlinedAt: !4569)
!4609 = !DILocalVariable(name: "flags", arg: 2, scope: !4566, file: !141, line: 538, type: !153)
!4610 = !DILocation(line: 538, column: 57, scope: !4566, inlinedAt: !4569)
!4611 = !DILocalVariable(name: "index", scope: !4564, file: !141, line: 542, type: !7)
!4612 = !DILocation(line: 542, column: 16, scope: !4564, inlinedAt: !4569)
!4613 = !DILocalVariable(name: "pdev", arg: 1, scope: !4438, file: !3, line: 100, type: !4441)
!4614 = !DILocation(line: 100, column: 62, scope: !4438)
!4615 = !DILocalVariable(name: "dev_data", scope: !4438, file: !3, line: 102, type: !4616)
!4616 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4617, size: 64)
!4617 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "passthrough_dev_data", file: !3, line: 14, size: 320, elements: !4618)
!4618 = !{!4619, !4620}
!4619 = !DIDerivedType(tag: DW_TAG_member, name: "dev_list", scope: !4617, file: !3, line: 16, baseType: !159, size: 128)
!4620 = !DIDerivedType(tag: DW_TAG_member, name: "lock", scope: !4617, file: !3, line: 17, baseType: !1198, size: 192, offset: 128)
!4621 = !DILocation(line: 102, column: 31, scope: !4438)
!4622 = !DILocation(line: 540, column: 27, scope: !4565, inlinedAt: !4569)
!4623 = !DILocation(line: 540, column: 6, scope: !4565, inlinedAt: !4569)
!4624 = !DILocation(line: 540, column: 6, scope: !4566, inlinedAt: !4569)
!4625 = !DILocation(line: 544, column: 7, scope: !4596, inlinedAt: !4569)
!4626 = !DILocation(line: 544, column: 12, scope: !4596, inlinedAt: !4569)
!4627 = !DILocation(line: 544, column: 7, scope: !4564, inlinedAt: !4569)
!4628 = !DILocation(line: 545, column: 25, scope: !4596, inlinedAt: !4569)
!4629 = !DILocation(line: 545, column: 31, scope: !4596, inlinedAt: !4569)
!4630 = !DILocation(line: 480, column: 33, scope: !4594, inlinedAt: !4595)
!4631 = !DILocation(line: 480, column: 23, scope: !4594, inlinedAt: !4595)
!4632 = !DILocation(line: 481, column: 29, scope: !4594, inlinedAt: !4595)
!4633 = !DILocation(line: 481, column: 35, scope: !4594, inlinedAt: !4595)
!4634 = !DILocation(line: 481, column: 42, scope: !4594, inlinedAt: !4595)
!4635 = !DILocation(line: 474, column: 23, scope: !4589, inlinedAt: !4593)
!4636 = !DILocation(line: 474, column: 29, scope: !4589, inlinedAt: !4593)
!4637 = !DILocation(line: 474, column: 36, scope: !4589, inlinedAt: !4593)
!4638 = !DILocation(line: 474, column: 9, scope: !4589, inlinedAt: !4593)
!4639 = !DILocation(line: 545, column: 4, scope: !4596, inlinedAt: !4569)
!4640 = !DILocation(line: 547, column: 25, scope: !4564, inlinedAt: !4569)
!4641 = !DILocation(line: 348, column: 7, scope: !4642, inlinedAt: !4587)
!4642 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 348, column: 6)
!4643 = !DILocation(line: 348, column: 6, scope: !4583, inlinedAt: !4587)
!4644 = !DILocation(line: 349, column: 3, scope: !4642, inlinedAt: !4587)
!4645 = !DILocation(line: 351, column: 6, scope: !4646, inlinedAt: !4587)
!4646 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 351, column: 6)
!4647 = !DILocation(line: 351, column: 11, scope: !4646, inlinedAt: !4587)
!4648 = !DILocation(line: 351, column: 6, scope: !4583, inlinedAt: !4587)
!4649 = !DILocation(line: 352, column: 3, scope: !4646, inlinedAt: !4587)
!4650 = !DILocation(line: 354, column: 32, scope: !4651, inlinedAt: !4587)
!4651 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 354, column: 6)
!4652 = !DILocation(line: 354, column: 37, scope: !4651, inlinedAt: !4587)
!4653 = !DILocation(line: 354, column: 42, scope: !4651, inlinedAt: !4587)
!4654 = !DILocation(line: 354, column: 45, scope: !4651, inlinedAt: !4587)
!4655 = !DILocation(line: 354, column: 50, scope: !4651, inlinedAt: !4587)
!4656 = !DILocation(line: 354, column: 6, scope: !4583, inlinedAt: !4587)
!4657 = !DILocation(line: 355, column: 3, scope: !4651, inlinedAt: !4587)
!4658 = !DILocation(line: 356, column: 32, scope: !4659, inlinedAt: !4587)
!4659 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 356, column: 6)
!4660 = !DILocation(line: 356, column: 37, scope: !4659, inlinedAt: !4587)
!4661 = !DILocation(line: 356, column: 43, scope: !4659, inlinedAt: !4587)
!4662 = !DILocation(line: 356, column: 46, scope: !4659, inlinedAt: !4587)
!4663 = !DILocation(line: 356, column: 51, scope: !4659, inlinedAt: !4587)
!4664 = !DILocation(line: 356, column: 6, scope: !4583, inlinedAt: !4587)
!4665 = !DILocation(line: 357, column: 3, scope: !4659, inlinedAt: !4587)
!4666 = !DILocation(line: 358, column: 6, scope: !4667, inlinedAt: !4587)
!4667 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 358, column: 6)
!4668 = !DILocation(line: 358, column: 11, scope: !4667, inlinedAt: !4587)
!4669 = !DILocation(line: 358, column: 6, scope: !4583, inlinedAt: !4587)
!4670 = !DILocation(line: 358, column: 26, scope: !4667, inlinedAt: !4587)
!4671 = !DILocation(line: 359, column: 6, scope: !4672, inlinedAt: !4587)
!4672 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 359, column: 6)
!4673 = !DILocation(line: 359, column: 11, scope: !4672, inlinedAt: !4587)
!4674 = !DILocation(line: 359, column: 6, scope: !4583, inlinedAt: !4587)
!4675 = !DILocation(line: 359, column: 26, scope: !4672, inlinedAt: !4587)
!4676 = !DILocation(line: 360, column: 6, scope: !4677, inlinedAt: !4587)
!4677 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 360, column: 6)
!4678 = !DILocation(line: 360, column: 11, scope: !4677, inlinedAt: !4587)
!4679 = !DILocation(line: 360, column: 6, scope: !4583, inlinedAt: !4587)
!4680 = !DILocation(line: 360, column: 26, scope: !4677, inlinedAt: !4587)
!4681 = !DILocation(line: 361, column: 6, scope: !4682, inlinedAt: !4587)
!4682 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 361, column: 6)
!4683 = !DILocation(line: 361, column: 11, scope: !4682, inlinedAt: !4587)
!4684 = !DILocation(line: 361, column: 6, scope: !4583, inlinedAt: !4587)
!4685 = !DILocation(line: 361, column: 26, scope: !4682, inlinedAt: !4587)
!4686 = !DILocation(line: 362, column: 6, scope: !4687, inlinedAt: !4587)
!4687 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 362, column: 6)
!4688 = !DILocation(line: 362, column: 11, scope: !4687, inlinedAt: !4587)
!4689 = !DILocation(line: 362, column: 6, scope: !4583, inlinedAt: !4587)
!4690 = !DILocation(line: 362, column: 26, scope: !4687, inlinedAt: !4587)
!4691 = !DILocation(line: 363, column: 6, scope: !4692, inlinedAt: !4587)
!4692 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 363, column: 6)
!4693 = !DILocation(line: 363, column: 11, scope: !4692, inlinedAt: !4587)
!4694 = !DILocation(line: 363, column: 6, scope: !4583, inlinedAt: !4587)
!4695 = !DILocation(line: 363, column: 26, scope: !4692, inlinedAt: !4587)
!4696 = !DILocation(line: 364, column: 6, scope: !4697, inlinedAt: !4587)
!4697 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 364, column: 6)
!4698 = !DILocation(line: 364, column: 11, scope: !4697, inlinedAt: !4587)
!4699 = !DILocation(line: 364, column: 6, scope: !4583, inlinedAt: !4587)
!4700 = !DILocation(line: 364, column: 26, scope: !4697, inlinedAt: !4587)
!4701 = !DILocation(line: 365, column: 6, scope: !4702, inlinedAt: !4587)
!4702 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 365, column: 6)
!4703 = !DILocation(line: 365, column: 11, scope: !4702, inlinedAt: !4587)
!4704 = !DILocation(line: 365, column: 6, scope: !4583, inlinedAt: !4587)
!4705 = !DILocation(line: 365, column: 26, scope: !4702, inlinedAt: !4587)
!4706 = !DILocation(line: 366, column: 6, scope: !4707, inlinedAt: !4587)
!4707 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 366, column: 6)
!4708 = !DILocation(line: 366, column: 11, scope: !4707, inlinedAt: !4587)
!4709 = !DILocation(line: 366, column: 6, scope: !4583, inlinedAt: !4587)
!4710 = !DILocation(line: 366, column: 26, scope: !4707, inlinedAt: !4587)
!4711 = !DILocation(line: 367, column: 6, scope: !4712, inlinedAt: !4587)
!4712 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 367, column: 6)
!4713 = !DILocation(line: 367, column: 11, scope: !4712, inlinedAt: !4587)
!4714 = !DILocation(line: 367, column: 6, scope: !4583, inlinedAt: !4587)
!4715 = !DILocation(line: 367, column: 26, scope: !4712, inlinedAt: !4587)
!4716 = !DILocation(line: 368, column: 6, scope: !4717, inlinedAt: !4587)
!4717 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 368, column: 6)
!4718 = !DILocation(line: 368, column: 11, scope: !4717, inlinedAt: !4587)
!4719 = !DILocation(line: 368, column: 6, scope: !4583, inlinedAt: !4587)
!4720 = !DILocation(line: 368, column: 26, scope: !4717, inlinedAt: !4587)
!4721 = !DILocation(line: 369, column: 6, scope: !4722, inlinedAt: !4587)
!4722 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 369, column: 6)
!4723 = !DILocation(line: 369, column: 11, scope: !4722, inlinedAt: !4587)
!4724 = !DILocation(line: 369, column: 6, scope: !4583, inlinedAt: !4587)
!4725 = !DILocation(line: 369, column: 26, scope: !4722, inlinedAt: !4587)
!4726 = !DILocation(line: 370, column: 6, scope: !4727, inlinedAt: !4587)
!4727 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 370, column: 6)
!4728 = !DILocation(line: 370, column: 11, scope: !4727, inlinedAt: !4587)
!4729 = !DILocation(line: 370, column: 6, scope: !4583, inlinedAt: !4587)
!4730 = !DILocation(line: 370, column: 26, scope: !4727, inlinedAt: !4587)
!4731 = !DILocation(line: 371, column: 6, scope: !4732, inlinedAt: !4587)
!4732 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 371, column: 6)
!4733 = !DILocation(line: 371, column: 11, scope: !4732, inlinedAt: !4587)
!4734 = !DILocation(line: 371, column: 6, scope: !4583, inlinedAt: !4587)
!4735 = !DILocation(line: 371, column: 26, scope: !4732, inlinedAt: !4587)
!4736 = !DILocation(line: 372, column: 6, scope: !4737, inlinedAt: !4587)
!4737 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 372, column: 6)
!4738 = !DILocation(line: 372, column: 11, scope: !4737, inlinedAt: !4587)
!4739 = !DILocation(line: 372, column: 6, scope: !4583, inlinedAt: !4587)
!4740 = !DILocation(line: 372, column: 26, scope: !4737, inlinedAt: !4587)
!4741 = !DILocation(line: 373, column: 6, scope: !4742, inlinedAt: !4587)
!4742 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 373, column: 6)
!4743 = !DILocation(line: 373, column: 11, scope: !4742, inlinedAt: !4587)
!4744 = !DILocation(line: 373, column: 6, scope: !4583, inlinedAt: !4587)
!4745 = !DILocation(line: 373, column: 26, scope: !4742, inlinedAt: !4587)
!4746 = !DILocation(line: 374, column: 6, scope: !4747, inlinedAt: !4587)
!4747 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 374, column: 6)
!4748 = !DILocation(line: 374, column: 11, scope: !4747, inlinedAt: !4587)
!4749 = !DILocation(line: 374, column: 6, scope: !4583, inlinedAt: !4587)
!4750 = !DILocation(line: 374, column: 26, scope: !4747, inlinedAt: !4587)
!4751 = !DILocation(line: 375, column: 6, scope: !4752, inlinedAt: !4587)
!4752 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 375, column: 6)
!4753 = !DILocation(line: 375, column: 11, scope: !4752, inlinedAt: !4587)
!4754 = !DILocation(line: 375, column: 6, scope: !4583, inlinedAt: !4587)
!4755 = !DILocation(line: 375, column: 27, scope: !4752, inlinedAt: !4587)
!4756 = !DILocation(line: 376, column: 6, scope: !4757, inlinedAt: !4587)
!4757 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 376, column: 6)
!4758 = !DILocation(line: 376, column: 11, scope: !4757, inlinedAt: !4587)
!4759 = !DILocation(line: 376, column: 6, scope: !4583, inlinedAt: !4587)
!4760 = !DILocation(line: 376, column: 32, scope: !4757, inlinedAt: !4587)
!4761 = !DILocation(line: 377, column: 6, scope: !4762, inlinedAt: !4587)
!4762 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 377, column: 6)
!4763 = !DILocation(line: 377, column: 11, scope: !4762, inlinedAt: !4587)
!4764 = !DILocation(line: 377, column: 6, scope: !4583, inlinedAt: !4587)
!4765 = !DILocation(line: 377, column: 32, scope: !4762, inlinedAt: !4587)
!4766 = !DILocation(line: 378, column: 6, scope: !4767, inlinedAt: !4587)
!4767 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 378, column: 6)
!4768 = !DILocation(line: 378, column: 11, scope: !4767, inlinedAt: !4587)
!4769 = !DILocation(line: 378, column: 6, scope: !4583, inlinedAt: !4587)
!4770 = !DILocation(line: 378, column: 32, scope: !4767, inlinedAt: !4587)
!4771 = !DILocation(line: 379, column: 6, scope: !4772, inlinedAt: !4587)
!4772 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 379, column: 6)
!4773 = !DILocation(line: 379, column: 11, scope: !4772, inlinedAt: !4587)
!4774 = !DILocation(line: 379, column: 6, scope: !4583, inlinedAt: !4587)
!4775 = !DILocation(line: 379, column: 33, scope: !4772, inlinedAt: !4587)
!4776 = !DILocation(line: 380, column: 6, scope: !4777, inlinedAt: !4587)
!4777 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 380, column: 6)
!4778 = !DILocation(line: 380, column: 11, scope: !4777, inlinedAt: !4587)
!4779 = !DILocation(line: 380, column: 6, scope: !4583, inlinedAt: !4587)
!4780 = !DILocation(line: 380, column: 33, scope: !4777, inlinedAt: !4587)
!4781 = !DILocation(line: 381, column: 6, scope: !4782, inlinedAt: !4587)
!4782 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 381, column: 6)
!4783 = !DILocation(line: 381, column: 11, scope: !4782, inlinedAt: !4587)
!4784 = !DILocation(line: 381, column: 6, scope: !4583, inlinedAt: !4587)
!4785 = !DILocation(line: 381, column: 33, scope: !4782, inlinedAt: !4587)
!4786 = !DILocation(line: 382, column: 2, scope: !4787, inlinedAt: !4587)
!4787 = distinct !DILexicalBlock(scope: !4788, file: !141, line: 382, column: 2)
!4788 = distinct !DILexicalBlock(scope: !4583, file: !141, line: 382, column: 2)
!4789 = !{i32 -2143447072, i32 -2143447043, i32 -2143446997, i32 -2143446939, i32 -2143446885, i32 -2143446831, i32 -2143446776, i32 -2143446745}
!4790 = !DILocation(line: 382, column: 2, scope: !4791, inlinedAt: !4587)
!4791 = distinct !DILexicalBlock(scope: !4792, file: !141, line: 382, column: 2)
!4792 = distinct !DILexicalBlock(scope: !4788, file: !141, line: 382, column: 2)
!4793 = !{i32 -2143446302, i32 -2143446295, i32 -2143446241, i32 -2143446210, i32 -2143446180}
!4794 = !DILocation(line: 382, column: 2, scope: !4792, inlinedAt: !4587)
!4795 = !DILocation(line: 386, column: 1, scope: !4583, inlinedAt: !4587)
!4796 = !DILocation(line: 547, column: 9, scope: !4564, inlinedAt: !4569)
!4797 = !DILocation(line: 549, column: 8, scope: !4798, inlinedAt: !4569)
!4798 = distinct !DILexicalBlock(scope: !4564, file: !141, line: 549, column: 7)
!4799 = !DILocation(line: 549, column: 7, scope: !4564, inlinedAt: !4569)
!4800 = !DILocation(line: 550, column: 4, scope: !4798, inlinedAt: !4569)
!4801 = !DILocation(line: 553, column: 33, scope: !4564, inlinedAt: !4569)
!4802 = !DILocation(line: 325, column: 6, scope: !4803, inlinedAt: !4581)
!4803 = distinct !DILexicalBlock(scope: !4577, file: !141, line: 325, column: 6)
!4804 = !DILocation(line: 325, column: 6, scope: !4577, inlinedAt: !4581)
!4805 = !DILocation(line: 326, column: 3, scope: !4803, inlinedAt: !4581)
!4806 = !DILocation(line: 332, column: 9, scope: !4577, inlinedAt: !4581)
!4807 = !DILocation(line: 332, column: 15, scope: !4577, inlinedAt: !4581)
!4808 = !DILocation(line: 332, column: 2, scope: !4577, inlinedAt: !4581)
!4809 = !DILocation(line: 336, column: 1, scope: !4577, inlinedAt: !4581)
!4810 = !DILocation(line: 553, column: 5, scope: !4564, inlinedAt: !4569)
!4811 = !DILocation(line: 553, column: 41, scope: !4564, inlinedAt: !4569)
!4812 = !DILocation(line: 554, column: 5, scope: !4564, inlinedAt: !4569)
!4813 = !DILocation(line: 554, column: 12, scope: !4564, inlinedAt: !4569)
!4814 = !DILocation(line: 448, column: 31, scope: !4559, inlinedAt: !4563)
!4815 = !DILocation(line: 448, column: 34, scope: !4559, inlinedAt: !4563)
!4816 = !DILocation(line: 448, column: 14, scope: !4559, inlinedAt: !4563)
!4817 = !DILocation(line: 450, column: 22, scope: !4559, inlinedAt: !4563)
!4818 = !DILocation(line: 450, column: 25, scope: !4559, inlinedAt: !4563)
!4819 = !DILocation(line: 450, column: 30, scope: !4559, inlinedAt: !4563)
!4820 = !DILocation(line: 450, column: 36, scope: !4559, inlinedAt: !4563)
!4821 = !DILocation(line: 450, column: 8, scope: !4559, inlinedAt: !4563)
!4822 = !DILocation(line: 450, column: 6, scope: !4559, inlinedAt: !4563)
!4823 = !DILocation(line: 451, column: 9, scope: !4559, inlinedAt: !4563)
!4824 = !DILocation(line: 552, column: 3, scope: !4564, inlinedAt: !4569)
!4825 = !DILocation(line: 557, column: 19, scope: !4566, inlinedAt: !4569)
!4826 = !DILocation(line: 557, column: 25, scope: !4566, inlinedAt: !4569)
!4827 = !DILocation(line: 557, column: 9, scope: !4566, inlinedAt: !4569)
!4828 = !DILocation(line: 557, column: 2, scope: !4566, inlinedAt: !4569)
!4829 = !DILocation(line: 558, column: 1, scope: !4566, inlinedAt: !4569)
!4830 = !DILocation(line: 104, column: 13, scope: !4438)
!4831 = !DILocation(line: 104, column: 11, scope: !4438)
!4832 = !DILocation(line: 105, column: 7, scope: !4833)
!4833 = distinct !DILexicalBlock(scope: !4438, file: !3, line: 105, column: 6)
!4834 = !DILocation(line: 105, column: 6, scope: !4438)
!4835 = !DILocation(line: 106, column: 3, scope: !4833)
!4836 = !DILocation(line: 108, column: 2, scope: !4438)
!4837 = !DILocation(line: 108, column: 2, scope: !4838)
!4838 = distinct !DILexicalBlock(scope: !4438, file: !3, line: 108, column: 2)
!4839 = !DILocation(line: 110, column: 18, scope: !4438)
!4840 = !DILocation(line: 110, column: 28, scope: !4438)
!4841 = !DILocation(line: 110, column: 2, scope: !4438)
!4842 = !DILocation(line: 112, column: 23, scope: !4438)
!4843 = !DILocation(line: 112, column: 2, scope: !4438)
!4844 = !DILocation(line: 112, column: 8, scope: !4438)
!4845 = !DILocation(line: 112, column: 21, scope: !4438)
!4846 = !DILocation(line: 114, column: 2, scope: !4438)
!4847 = !DILocation(line: 115, column: 1, scope: !4438)
!4848 = distinct !DISubprogram(name: "__xen_pcibk_release_devices", scope: !3, file: !3, line: 159, type: !4523, scopeLine: 160, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!4849 = !DILocalVariable(name: "pdev", arg: 1, scope: !4848, file: !3, line: 159, type: !4441)
!4850 = !DILocation(line: 159, column: 66, scope: !4848)
!4851 = !DILocalVariable(name: "dev_data", scope: !4848, file: !3, line: 161, type: !4616)
!4852 = !DILocation(line: 161, column: 31, scope: !4848)
!4853 = !DILocation(line: 161, column: 42, scope: !4848)
!4854 = !DILocation(line: 161, column: 48, scope: !4848)
!4855 = !DILocalVariable(name: "dev_entry", scope: !4848, file: !3, line: 162, type: !163)
!4856 = !DILocation(line: 162, column: 24, scope: !4848)
!4857 = !DILocalVariable(name: "t", scope: !4848, file: !3, line: 162, type: !163)
!4858 = !DILocation(line: 162, column: 36, scope: !4848)
!4859 = !DILocalVariable(name: "__mptr", scope: !4860, file: !3, line: 164, type: !155)
!4860 = distinct !DILexicalBlock(scope: !4861, file: !3, line: 164, column: 2)
!4861 = distinct !DILexicalBlock(scope: !4848, file: !3, line: 164, column: 2)
!4862 = !DILocation(line: 164, column: 2, scope: !4860)
!4863 = !DILocation(line: 164, column: 2, scope: !4864)
!4864 = distinct !DILexicalBlock(scope: !4860, file: !3, line: 164, column: 2)
!4865 = !DILocation(line: 164, column: 2, scope: !4861)
!4866 = !DILocalVariable(name: "__mptr", scope: !4867, file: !3, line: 164, type: !155)
!4867 = distinct !DILexicalBlock(scope: !4861, file: !3, line: 164, column: 2)
!4868 = !DILocation(line: 164, column: 2, scope: !4867)
!4869 = !DILocation(line: 164, column: 2, scope: !4870)
!4870 = distinct !DILexicalBlock(scope: !4867, file: !3, line: 164, column: 2)
!4871 = !DILocation(line: 164, column: 2, scope: !4872)
!4872 = distinct !DILexicalBlock(scope: !4861, file: !3, line: 164, column: 2)
!4873 = !DILocalVariable(name: "dev", scope: !4874, file: !3, line: 165, type: !169)
!4874 = distinct !DILexicalBlock(scope: !4872, file: !3, line: 164, column: 68)
!4875 = !DILocation(line: 165, column: 19, scope: !4874)
!4876 = !DILocation(line: 165, column: 25, scope: !4874)
!4877 = !DILocation(line: 165, column: 36, scope: !4874)
!4878 = !DILocation(line: 166, column: 13, scope: !4874)
!4879 = !DILocation(line: 166, column: 24, scope: !4874)
!4880 = !DILocation(line: 166, column: 3, scope: !4874)
!4881 = !DILocation(line: 167, column: 16, scope: !4874)
!4882 = !DILocation(line: 167, column: 21, scope: !4874)
!4883 = !DILocation(line: 167, column: 3, scope: !4874)
!4884 = !DILocation(line: 168, column: 23, scope: !4874)
!4885 = !DILocation(line: 168, column: 3, scope: !4874)
!4886 = !DILocation(line: 169, column: 18, scope: !4874)
!4887 = !DILocation(line: 169, column: 23, scope: !4874)
!4888 = !DILocation(line: 169, column: 3, scope: !4874)
!4889 = !DILocation(line: 170, column: 9, scope: !4874)
!4890 = !DILocation(line: 170, column: 3, scope: !4874)
!4891 = !DILocation(line: 171, column: 2, scope: !4874)
!4892 = !DILocalVariable(name: "__mptr", scope: !4893, file: !3, line: 164, type: !155)
!4893 = distinct !DILexicalBlock(scope: !4872, file: !3, line: 164, column: 2)
!4894 = !DILocation(line: 164, column: 2, scope: !4893)
!4895 = !DILocation(line: 164, column: 2, scope: !4896)
!4896 = distinct !DILexicalBlock(scope: !4893, file: !3, line: 164, column: 2)
!4897 = distinct !{!4897, !4865, !4898}
!4898 = !DILocation(line: 171, column: 2, scope: !4861)
!4899 = !DILocation(line: 173, column: 8, scope: !4848)
!4900 = !DILocation(line: 173, column: 2, scope: !4848)
!4901 = !DILocation(line: 174, column: 2, scope: !4848)
!4902 = !DILocation(line: 174, column: 8, scope: !4848)
!4903 = !DILocation(line: 174, column: 21, scope: !4848)
!4904 = !DILocation(line: 175, column: 1, scope: !4848)
!4905 = distinct !DISubprogram(name: "__xen_pcibk_get_pcifront_dev", scope: !3, file: !3, line: 177, type: !4527, scopeLine: 181, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!4906 = !DILocalVariable(name: "pcidev", arg: 1, scope: !4905, file: !3, line: 177, type: !169)
!4907 = !DILocation(line: 177, column: 57, scope: !4905)
!4908 = !DILocalVariable(name: "pdev", arg: 2, scope: !4905, file: !3, line: 178, type: !4441)
!4909 = !DILocation(line: 178, column: 31, scope: !4905)
!4910 = !DILocalVariable(name: "domain", arg: 3, scope: !4905, file: !3, line: 179, type: !2691)
!4911 = !DILocation(line: 179, column: 20, scope: !4905)
!4912 = !DILocalVariable(name: "bus", arg: 4, scope: !4905, file: !3, line: 179, type: !2691)
!4913 = !DILocation(line: 179, column: 42, scope: !4905)
!4914 = !DILocalVariable(name: "devfn", arg: 5, scope: !4905, file: !3, line: 180, type: !2691)
!4915 = !DILocation(line: 180, column: 20, scope: !4905)
!4916 = !DILocation(line: 182, column: 26, scope: !4905)
!4917 = !DILocation(line: 182, column: 34, scope: !4905)
!4918 = !DILocation(line: 182, column: 12, scope: !4905)
!4919 = !DILocation(line: 182, column: 3, scope: !4905)
!4920 = !DILocation(line: 182, column: 10, scope: !4905)
!4921 = !DILocation(line: 183, column: 9, scope: !4905)
!4922 = !DILocation(line: 183, column: 17, scope: !4905)
!4923 = !DILocation(line: 183, column: 22, scope: !4905)
!4924 = !DILocation(line: 183, column: 3, scope: !4905)
!4925 = !DILocation(line: 183, column: 7, scope: !4905)
!4926 = !DILocation(line: 184, column: 11, scope: !4905)
!4927 = !DILocation(line: 184, column: 19, scope: !4905)
!4928 = !DILocation(line: 184, column: 3, scope: !4905)
!4929 = !DILocation(line: 184, column: 9, scope: !4905)
!4930 = !DILocation(line: 185, column: 2, scope: !4905)
!4931 = distinct !DISubprogram(name: "__xen_pcibk_publish_pci_roots", scope: !3, file: !3, line: 117, type: !4531, scopeLine: 119, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!4932 = !DILocalVariable(name: "pdev", arg: 1, scope: !4931, file: !3, line: 117, type: !4441)
!4933 = !DILocation(line: 117, column: 67, scope: !4931)
!4934 = !DILocalVariable(name: "publish_root_cb", arg: 2, scope: !4931, file: !3, line: 118, type: !4533)
!4935 = !DILocation(line: 118, column: 27, scope: !4931)
!4936 = !DILocalVariable(name: "err", scope: !4931, file: !3, line: 120, type: !221)
!4937 = !DILocation(line: 120, column: 6, scope: !4931)
!4938 = !DILocalVariable(name: "dev_data", scope: !4931, file: !3, line: 121, type: !4616)
!4939 = !DILocation(line: 121, column: 31, scope: !4931)
!4940 = !DILocation(line: 121, column: 42, scope: !4931)
!4941 = !DILocation(line: 121, column: 48, scope: !4931)
!4942 = !DILocalVariable(name: "dev_entry", scope: !4931, file: !3, line: 122, type: !163)
!4943 = !DILocation(line: 122, column: 24, scope: !4931)
!4944 = !DILocalVariable(name: "e", scope: !4931, file: !3, line: 122, type: !163)
!4945 = !DILocation(line: 122, column: 36, scope: !4931)
!4946 = !DILocalVariable(name: "dev", scope: !4931, file: !3, line: 123, type: !169)
!4947 = !DILocation(line: 123, column: 18, scope: !4931)
!4948 = !DILocalVariable(name: "found", scope: !4931, file: !3, line: 124, type: !221)
!4949 = !DILocation(line: 124, column: 6, scope: !4931)
!4950 = !DILocalVariable(name: "domain", scope: !4931, file: !3, line: 125, type: !7)
!4951 = !DILocation(line: 125, column: 15, scope: !4931)
!4952 = !DILocalVariable(name: "bus", scope: !4931, file: !3, line: 125, type: !7)
!4953 = !DILocation(line: 125, column: 23, scope: !4931)
!4954 = !DILocation(line: 127, column: 14, scope: !4931)
!4955 = !DILocation(line: 127, column: 24, scope: !4931)
!4956 = !DILocation(line: 127, column: 2, scope: !4931)
!4957 = !DILocalVariable(name: "__mptr", scope: !4958, file: !3, line: 129, type: !155)
!4958 = distinct !DILexicalBlock(scope: !4959, file: !3, line: 129, column: 2)
!4959 = distinct !DILexicalBlock(scope: !4931, file: !3, line: 129, column: 2)
!4960 = !DILocation(line: 129, column: 2, scope: !4958)
!4961 = !DILocation(line: 129, column: 2, scope: !4962)
!4962 = distinct !DILexicalBlock(scope: !4958, file: !3, line: 129, column: 2)
!4963 = !DILocation(line: 129, column: 2, scope: !4959)
!4964 = !DILocation(line: 129, column: 2, scope: !4965)
!4965 = distinct !DILexicalBlock(scope: !4959, file: !3, line: 129, column: 2)
!4966 = !DILocation(line: 133, column: 9, scope: !4967)
!4967 = distinct !DILexicalBlock(scope: !4965, file: !3, line: 129, column: 60)
!4968 = !DILocation(line: 134, column: 9, scope: !4967)
!4969 = !DILocation(line: 134, column: 20, scope: !4967)
!4970 = !DILocation(line: 134, column: 25, scope: !4967)
!4971 = !DILocation(line: 134, column: 30, scope: !4967)
!4972 = !DILocation(line: 134, column: 7, scope: !4967)
!4973 = !DILocation(line: 135, column: 3, scope: !4967)
!4974 = !DILocation(line: 135, column: 11, scope: !4975)
!4975 = distinct !DILexicalBlock(scope: !4976, file: !3, line: 135, column: 3)
!4976 = distinct !DILexicalBlock(scope: !4967, file: !3, line: 135, column: 3)
!4977 = !DILocation(line: 135, column: 17, scope: !4975)
!4978 = !DILocation(line: 135, column: 20, scope: !4975)
!4979 = !DILocation(line: 135, column: 24, scope: !4975)
!4980 = !DILocation(line: 0, scope: !4975)
!4981 = !DILocation(line: 135, column: 3, scope: !4976)
!4982 = !DILocalVariable(name: "__mptr", scope: !4983, file: !3, line: 136, type: !155)
!4983 = distinct !DILexicalBlock(scope: !4984, file: !3, line: 136, column: 4)
!4984 = distinct !DILexicalBlock(scope: !4985, file: !3, line: 136, column: 4)
!4985 = distinct !DILexicalBlock(scope: !4975, file: !3, line: 135, column: 55)
!4986 = !DILocation(line: 136, column: 4, scope: !4983)
!4987 = !DILocation(line: 136, column: 4, scope: !4988)
!4988 = distinct !DILexicalBlock(scope: !4983, file: !3, line: 136, column: 4)
!4989 = !DILocation(line: 136, column: 4, scope: !4984)
!4990 = !DILocation(line: 136, column: 4, scope: !4991)
!4991 = distinct !DILexicalBlock(scope: !4984, file: !3, line: 136, column: 4)
!4992 = !DILocation(line: 137, column: 9, scope: !4993)
!4993 = distinct !DILexicalBlock(scope: !4994, file: !3, line: 137, column: 9)
!4994 = distinct !DILexicalBlock(scope: !4991, file: !3, line: 136, column: 54)
!4995 = !DILocation(line: 137, column: 16, scope: !4993)
!4996 = !DILocation(line: 137, column: 19, scope: !4993)
!4997 = !DILocation(line: 137, column: 13, scope: !4993)
!4998 = !DILocation(line: 137, column: 9, scope: !4994)
!4999 = !DILocation(line: 138, column: 12, scope: !5000)
!5000 = distinct !DILexicalBlock(scope: !4993, file: !3, line: 137, column: 24)
!5001 = !DILocation(line: 139, column: 6, scope: !5000)
!5002 = !DILocation(line: 141, column: 4, scope: !4994)
!5003 = !DILocalVariable(name: "__mptr", scope: !5004, file: !3, line: 136, type: !155)
!5004 = distinct !DILexicalBlock(scope: !4991, file: !3, line: 136, column: 4)
!5005 = !DILocation(line: 136, column: 4, scope: !5004)
!5006 = !DILocation(line: 136, column: 4, scope: !5007)
!5007 = distinct !DILexicalBlock(scope: !5004, file: !3, line: 136, column: 4)
!5008 = distinct !{!5008, !4989, !5009}
!5009 = !DILocation(line: 141, column: 4, scope: !4984)
!5010 = !DILocation(line: 142, column: 3, scope: !4985)
!5011 = !DILocation(line: 135, column: 39, scope: !4975)
!5012 = !DILocation(line: 135, column: 44, scope: !4975)
!5013 = !DILocation(line: 135, column: 49, scope: !4975)
!5014 = !DILocation(line: 135, column: 37, scope: !4975)
!5015 = !DILocation(line: 135, column: 3, scope: !4975)
!5016 = distinct !{!5016, !4981, !5017}
!5017 = !DILocation(line: 142, column: 3, scope: !4976)
!5018 = !DILocation(line: 144, column: 40, scope: !4967)
!5019 = !DILocation(line: 144, column: 51, scope: !4967)
!5020 = !DILocation(line: 144, column: 56, scope: !4967)
!5021 = !DILocation(line: 144, column: 26, scope: !4967)
!5022 = !DILocation(line: 144, column: 10, scope: !4967)
!5023 = !DILocation(line: 145, column: 23, scope: !4967)
!5024 = !DILocation(line: 145, column: 34, scope: !4967)
!5025 = !DILocation(line: 145, column: 39, scope: !4967)
!5026 = !DILocation(line: 145, column: 44, scope: !4967)
!5027 = !DILocation(line: 145, column: 9, scope: !4967)
!5028 = !DILocation(line: 145, column: 7, scope: !4967)
!5029 = !DILocation(line: 147, column: 8, scope: !5030)
!5030 = distinct !DILexicalBlock(scope: !4967, file: !3, line: 147, column: 7)
!5031 = !DILocation(line: 147, column: 7, scope: !4967)
!5032 = !DILocation(line: 148, column: 10, scope: !5033)
!5033 = distinct !DILexicalBlock(scope: !5030, file: !3, line: 147, column: 15)
!5034 = !DILocation(line: 148, column: 26, scope: !5033)
!5035 = !DILocation(line: 148, column: 32, scope: !5033)
!5036 = !DILocation(line: 148, column: 40, scope: !5033)
!5037 = !DILocation(line: 148, column: 8, scope: !5033)
!5038 = !DILocation(line: 149, column: 8, scope: !5039)
!5039 = distinct !DILexicalBlock(scope: !5033, file: !3, line: 149, column: 8)
!5040 = !DILocation(line: 149, column: 8, scope: !5033)
!5041 = !DILocation(line: 150, column: 5, scope: !5039)
!5042 = !DILocation(line: 151, column: 3, scope: !5033)
!5043 = !DILocation(line: 152, column: 2, scope: !4967)
!5044 = !DILocalVariable(name: "__mptr", scope: !5045, file: !3, line: 129, type: !155)
!5045 = distinct !DILexicalBlock(scope: !4965, file: !3, line: 129, column: 2)
!5046 = !DILocation(line: 129, column: 2, scope: !5045)
!5047 = !DILocation(line: 129, column: 2, scope: !5048)
!5048 = distinct !DILexicalBlock(scope: !5045, file: !3, line: 129, column: 2)
!5049 = distinct !{!5049, !4963, !5050}
!5050 = !DILocation(line: 152, column: 2, scope: !4959)
!5051 = !DILocation(line: 154, column: 16, scope: !4931)
!5052 = !DILocation(line: 154, column: 26, scope: !4931)
!5053 = !DILocation(line: 154, column: 2, scope: !4931)
!5054 = !DILocation(line: 156, column: 9, scope: !4931)
!5055 = !DILocation(line: 156, column: 2, scope: !4931)
!5056 = distinct !DISubprogram(name: "__xen_pcibk_release_pci_dev", scope: !3, file: !3, line: 72, type: !4539, scopeLine: 74, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!5057 = !DILocalVariable(name: "pdev", arg: 1, scope: !5056, file: !3, line: 72, type: !4441)
!5058 = !DILocation(line: 72, column: 66, scope: !5056)
!5059 = !DILocalVariable(name: "dev", arg: 2, scope: !5056, file: !3, line: 73, type: !169)
!5060 = !DILocation(line: 73, column: 22, scope: !5056)
!5061 = !DILocalVariable(name: "lock", arg: 3, scope: !5056, file: !3, line: 73, type: !517)
!5062 = !DILocation(line: 73, column: 32, scope: !5056)
!5063 = !DILocalVariable(name: "dev_data", scope: !5056, file: !3, line: 75, type: !4616)
!5064 = !DILocation(line: 75, column: 31, scope: !5056)
!5065 = !DILocation(line: 75, column: 42, scope: !5056)
!5066 = !DILocation(line: 75, column: 48, scope: !5056)
!5067 = !DILocalVariable(name: "dev_entry", scope: !5056, file: !3, line: 76, type: !163)
!5068 = !DILocation(line: 76, column: 24, scope: !5056)
!5069 = !DILocalVariable(name: "t", scope: !5056, file: !3, line: 76, type: !163)
!5070 = !DILocation(line: 76, column: 36, scope: !5056)
!5071 = !DILocalVariable(name: "found_dev", scope: !5056, file: !3, line: 77, type: !169)
!5072 = !DILocation(line: 77, column: 18, scope: !5056)
!5073 = !DILocation(line: 79, column: 14, scope: !5056)
!5074 = !DILocation(line: 79, column: 24, scope: !5056)
!5075 = !DILocation(line: 79, column: 2, scope: !5056)
!5076 = !DILocalVariable(name: "__mptr", scope: !5077, file: !3, line: 81, type: !155)
!5077 = distinct !DILexicalBlock(scope: !5078, file: !3, line: 81, column: 2)
!5078 = distinct !DILexicalBlock(scope: !5056, file: !3, line: 81, column: 2)
!5079 = !DILocation(line: 81, column: 2, scope: !5077)
!5080 = !DILocation(line: 81, column: 2, scope: !5081)
!5081 = distinct !DILexicalBlock(scope: !5077, file: !3, line: 81, column: 2)
!5082 = !DILocation(line: 81, column: 2, scope: !5078)
!5083 = !DILocalVariable(name: "__mptr", scope: !5084, file: !3, line: 81, type: !155)
!5084 = distinct !DILexicalBlock(scope: !5078, file: !3, line: 81, column: 2)
!5085 = !DILocation(line: 81, column: 2, scope: !5084)
!5086 = !DILocation(line: 81, column: 2, scope: !5087)
!5087 = distinct !DILexicalBlock(scope: !5084, file: !3, line: 81, column: 2)
!5088 = !DILocation(line: 81, column: 2, scope: !5089)
!5089 = distinct !DILexicalBlock(scope: !5078, file: !3, line: 81, column: 2)
!5090 = !DILocation(line: 82, column: 7, scope: !5091)
!5091 = distinct !DILexicalBlock(scope: !5092, file: !3, line: 82, column: 7)
!5092 = distinct !DILexicalBlock(scope: !5089, file: !3, line: 81, column: 68)
!5093 = !DILocation(line: 82, column: 18, scope: !5091)
!5094 = !DILocation(line: 82, column: 25, scope: !5091)
!5095 = !DILocation(line: 82, column: 22, scope: !5091)
!5096 = !DILocation(line: 82, column: 7, scope: !5092)
!5097 = !DILocation(line: 83, column: 14, scope: !5098)
!5098 = distinct !DILexicalBlock(scope: !5091, file: !3, line: 82, column: 30)
!5099 = !DILocation(line: 83, column: 25, scope: !5098)
!5100 = !DILocation(line: 83, column: 4, scope: !5098)
!5101 = !DILocation(line: 84, column: 16, scope: !5098)
!5102 = !DILocation(line: 84, column: 27, scope: !5098)
!5103 = !DILocation(line: 84, column: 14, scope: !5098)
!5104 = !DILocation(line: 85, column: 10, scope: !5098)
!5105 = !DILocation(line: 85, column: 4, scope: !5098)
!5106 = !DILocation(line: 86, column: 3, scope: !5098)
!5107 = !DILocation(line: 87, column: 2, scope: !5092)
!5108 = !DILocalVariable(name: "__mptr", scope: !5109, file: !3, line: 81, type: !155)
!5109 = distinct !DILexicalBlock(scope: !5089, file: !3, line: 81, column: 2)
!5110 = !DILocation(line: 81, column: 2, scope: !5109)
!5111 = !DILocation(line: 81, column: 2, scope: !5112)
!5112 = distinct !DILexicalBlock(scope: !5109, file: !3, line: 81, column: 2)
!5113 = distinct !{!5113, !5082, !5114}
!5114 = !DILocation(line: 87, column: 2, scope: !5078)
!5115 = !DILocation(line: 89, column: 16, scope: !5056)
!5116 = !DILocation(line: 89, column: 26, scope: !5056)
!5117 = !DILocation(line: 89, column: 2, scope: !5056)
!5118 = !DILocation(line: 91, column: 6, scope: !5119)
!5119 = distinct !DILexicalBlock(scope: !5056, file: !3, line: 91, column: 6)
!5120 = !DILocation(line: 91, column: 6, scope: !5056)
!5121 = !DILocation(line: 92, column: 7, scope: !5122)
!5122 = distinct !DILexicalBlock(scope: !5123, file: !3, line: 92, column: 7)
!5123 = distinct !DILexicalBlock(scope: !5119, file: !3, line: 91, column: 17)
!5124 = !DILocation(line: 92, column: 7, scope: !5123)
!5125 = !DILocation(line: 93, column: 17, scope: !5122)
!5126 = !DILocation(line: 93, column: 28, scope: !5122)
!5127 = !DILocation(line: 93, column: 4, scope: !5122)
!5128 = !DILocation(line: 94, column: 23, scope: !5123)
!5129 = !DILocation(line: 94, column: 3, scope: !5123)
!5130 = !DILocation(line: 95, column: 7, scope: !5131)
!5131 = distinct !DILexicalBlock(scope: !5123, file: !3, line: 95, column: 7)
!5132 = !DILocation(line: 95, column: 7, scope: !5123)
!5133 = !DILocation(line: 96, column: 19, scope: !5131)
!5134 = !DILocation(line: 96, column: 30, scope: !5131)
!5135 = !DILocation(line: 96, column: 4, scope: !5131)
!5136 = !DILocation(line: 97, column: 2, scope: !5123)
!5137 = !DILocation(line: 98, column: 1, scope: !5056)
!5138 = distinct !DISubprogram(name: "__xen_pcibk_add_pci_dev", scope: !3, file: !3, line: 45, type: !4543, scopeLine: 48, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!5139 = !DILocation(line: 445, column: 72, scope: !4559, inlinedAt: !5140)
!5140 = distinct !DILocation(line: 552, column: 10, scope: !4564, inlinedAt: !5141)
!5141 = distinct !DILocation(line: 54, column: 14, scope: !5138)
!5142 = !DILocation(line: 446, column: 9, scope: !4559, inlinedAt: !5140)
!5143 = !DILocation(line: 446, column: 23, scope: !4559, inlinedAt: !5140)
!5144 = !DILocation(line: 448, column: 8, scope: !4559, inlinedAt: !5140)
!5145 = !DILocation(line: 318, column: 67, scope: !4577, inlinedAt: !5146)
!5146 = distinct !DILocation(line: 553, column: 20, scope: !4564, inlinedAt: !5141)
!5147 = !DILocation(line: 346, column: 58, scope: !4583, inlinedAt: !5148)
!5148 = distinct !DILocation(line: 547, column: 11, scope: !4564, inlinedAt: !5141)
!5149 = !DILocation(line: 472, column: 28, scope: !4589, inlinedAt: !5150)
!5150 = distinct !DILocation(line: 481, column: 9, scope: !4594, inlinedAt: !5151)
!5151 = distinct !DILocation(line: 545, column: 11, scope: !4596, inlinedAt: !5141)
!5152 = !DILocation(line: 472, column: 40, scope: !4589, inlinedAt: !5150)
!5153 = !DILocation(line: 472, column: 60, scope: !4589, inlinedAt: !5150)
!5154 = !DILocation(line: 478, column: 51, scope: !4594, inlinedAt: !5151)
!5155 = !DILocation(line: 478, column: 63, scope: !4594, inlinedAt: !5151)
!5156 = !DILocation(line: 480, column: 15, scope: !4594, inlinedAt: !5151)
!5157 = !DILocation(line: 538, column: 45, scope: !4566, inlinedAt: !5141)
!5158 = !DILocation(line: 538, column: 57, scope: !4566, inlinedAt: !5141)
!5159 = !DILocation(line: 542, column: 16, scope: !4564, inlinedAt: !5141)
!5160 = !DILocalVariable(name: "pdev", arg: 1, scope: !5138, file: !3, line: 45, type: !4441)
!5161 = !DILocation(line: 45, column: 61, scope: !5138)
!5162 = !DILocalVariable(name: "dev", arg: 2, scope: !5138, file: !3, line: 46, type: !169)
!5163 = !DILocation(line: 46, column: 24, scope: !5138)
!5164 = !DILocalVariable(name: "devid", arg: 3, scope: !5138, file: !3, line: 47, type: !221)
!5165 = !DILocation(line: 47, column: 12, scope: !5138)
!5166 = !DILocalVariable(name: "publish_cb", arg: 4, scope: !5138, file: !3, line: 47, type: !4545)
!5167 = !DILocation(line: 47, column: 38, scope: !5138)
!5168 = !DILocalVariable(name: "dev_data", scope: !5138, file: !3, line: 49, type: !4616)
!5169 = !DILocation(line: 49, column: 31, scope: !5138)
!5170 = !DILocation(line: 49, column: 42, scope: !5138)
!5171 = !DILocation(line: 49, column: 48, scope: !5138)
!5172 = !DILocalVariable(name: "dev_entry", scope: !5138, file: !3, line: 50, type: !163)
!5173 = !DILocation(line: 50, column: 24, scope: !5138)
!5174 = !DILocalVariable(name: "domain", scope: !5138, file: !3, line: 51, type: !7)
!5175 = !DILocation(line: 51, column: 15, scope: !5138)
!5176 = !DILocalVariable(name: "bus", scope: !5138, file: !3, line: 51, type: !7)
!5177 = !DILocation(line: 51, column: 23, scope: !5138)
!5178 = !DILocalVariable(name: "devfn", scope: !5138, file: !3, line: 51, type: !7)
!5179 = !DILocation(line: 51, column: 28, scope: !5138)
!5180 = !DILocalVariable(name: "err", scope: !5138, file: !3, line: 52, type: !221)
!5181 = !DILocation(line: 52, column: 6, scope: !5138)
!5182 = !DILocation(line: 540, column: 27, scope: !4565, inlinedAt: !5141)
!5183 = !DILocation(line: 540, column: 6, scope: !4565, inlinedAt: !5141)
!5184 = !DILocation(line: 540, column: 6, scope: !4566, inlinedAt: !5141)
!5185 = !DILocation(line: 544, column: 7, scope: !4596, inlinedAt: !5141)
!5186 = !DILocation(line: 544, column: 12, scope: !4596, inlinedAt: !5141)
!5187 = !DILocation(line: 544, column: 7, scope: !4564, inlinedAt: !5141)
!5188 = !DILocation(line: 545, column: 25, scope: !4596, inlinedAt: !5141)
!5189 = !DILocation(line: 545, column: 31, scope: !4596, inlinedAt: !5141)
!5190 = !DILocation(line: 480, column: 33, scope: !4594, inlinedAt: !5151)
!5191 = !DILocation(line: 480, column: 23, scope: !4594, inlinedAt: !5151)
!5192 = !DILocation(line: 481, column: 29, scope: !4594, inlinedAt: !5151)
!5193 = !DILocation(line: 481, column: 35, scope: !4594, inlinedAt: !5151)
!5194 = !DILocation(line: 481, column: 42, scope: !4594, inlinedAt: !5151)
!5195 = !DILocation(line: 474, column: 23, scope: !4589, inlinedAt: !5150)
!5196 = !DILocation(line: 474, column: 29, scope: !4589, inlinedAt: !5150)
!5197 = !DILocation(line: 474, column: 36, scope: !4589, inlinedAt: !5150)
!5198 = !DILocation(line: 474, column: 9, scope: !4589, inlinedAt: !5150)
!5199 = !DILocation(line: 545, column: 4, scope: !4596, inlinedAt: !5141)
!5200 = !DILocation(line: 547, column: 25, scope: !4564, inlinedAt: !5141)
!5201 = !DILocation(line: 348, column: 7, scope: !4642, inlinedAt: !5148)
!5202 = !DILocation(line: 348, column: 6, scope: !4583, inlinedAt: !5148)
!5203 = !DILocation(line: 349, column: 3, scope: !4642, inlinedAt: !5148)
!5204 = !DILocation(line: 351, column: 6, scope: !4646, inlinedAt: !5148)
!5205 = !DILocation(line: 351, column: 11, scope: !4646, inlinedAt: !5148)
!5206 = !DILocation(line: 351, column: 6, scope: !4583, inlinedAt: !5148)
!5207 = !DILocation(line: 352, column: 3, scope: !4646, inlinedAt: !5148)
!5208 = !DILocation(line: 354, column: 32, scope: !4651, inlinedAt: !5148)
!5209 = !DILocation(line: 354, column: 37, scope: !4651, inlinedAt: !5148)
!5210 = !DILocation(line: 354, column: 42, scope: !4651, inlinedAt: !5148)
!5211 = !DILocation(line: 354, column: 45, scope: !4651, inlinedAt: !5148)
!5212 = !DILocation(line: 354, column: 50, scope: !4651, inlinedAt: !5148)
!5213 = !DILocation(line: 354, column: 6, scope: !4583, inlinedAt: !5148)
!5214 = !DILocation(line: 355, column: 3, scope: !4651, inlinedAt: !5148)
!5215 = !DILocation(line: 356, column: 32, scope: !4659, inlinedAt: !5148)
!5216 = !DILocation(line: 356, column: 37, scope: !4659, inlinedAt: !5148)
!5217 = !DILocation(line: 356, column: 43, scope: !4659, inlinedAt: !5148)
!5218 = !DILocation(line: 356, column: 46, scope: !4659, inlinedAt: !5148)
!5219 = !DILocation(line: 356, column: 51, scope: !4659, inlinedAt: !5148)
!5220 = !DILocation(line: 356, column: 6, scope: !4583, inlinedAt: !5148)
!5221 = !DILocation(line: 357, column: 3, scope: !4659, inlinedAt: !5148)
!5222 = !DILocation(line: 358, column: 6, scope: !4667, inlinedAt: !5148)
!5223 = !DILocation(line: 358, column: 11, scope: !4667, inlinedAt: !5148)
!5224 = !DILocation(line: 358, column: 6, scope: !4583, inlinedAt: !5148)
!5225 = !DILocation(line: 358, column: 26, scope: !4667, inlinedAt: !5148)
!5226 = !DILocation(line: 359, column: 6, scope: !4672, inlinedAt: !5148)
!5227 = !DILocation(line: 359, column: 11, scope: !4672, inlinedAt: !5148)
!5228 = !DILocation(line: 359, column: 6, scope: !4583, inlinedAt: !5148)
!5229 = !DILocation(line: 359, column: 26, scope: !4672, inlinedAt: !5148)
!5230 = !DILocation(line: 360, column: 6, scope: !4677, inlinedAt: !5148)
!5231 = !DILocation(line: 360, column: 11, scope: !4677, inlinedAt: !5148)
!5232 = !DILocation(line: 360, column: 6, scope: !4583, inlinedAt: !5148)
!5233 = !DILocation(line: 360, column: 26, scope: !4677, inlinedAt: !5148)
!5234 = !DILocation(line: 361, column: 6, scope: !4682, inlinedAt: !5148)
!5235 = !DILocation(line: 361, column: 11, scope: !4682, inlinedAt: !5148)
!5236 = !DILocation(line: 361, column: 6, scope: !4583, inlinedAt: !5148)
!5237 = !DILocation(line: 361, column: 26, scope: !4682, inlinedAt: !5148)
!5238 = !DILocation(line: 362, column: 6, scope: !4687, inlinedAt: !5148)
!5239 = !DILocation(line: 362, column: 11, scope: !4687, inlinedAt: !5148)
!5240 = !DILocation(line: 362, column: 6, scope: !4583, inlinedAt: !5148)
!5241 = !DILocation(line: 362, column: 26, scope: !4687, inlinedAt: !5148)
!5242 = !DILocation(line: 363, column: 6, scope: !4692, inlinedAt: !5148)
!5243 = !DILocation(line: 363, column: 11, scope: !4692, inlinedAt: !5148)
!5244 = !DILocation(line: 363, column: 6, scope: !4583, inlinedAt: !5148)
!5245 = !DILocation(line: 363, column: 26, scope: !4692, inlinedAt: !5148)
!5246 = !DILocation(line: 364, column: 6, scope: !4697, inlinedAt: !5148)
!5247 = !DILocation(line: 364, column: 11, scope: !4697, inlinedAt: !5148)
!5248 = !DILocation(line: 364, column: 6, scope: !4583, inlinedAt: !5148)
!5249 = !DILocation(line: 364, column: 26, scope: !4697, inlinedAt: !5148)
!5250 = !DILocation(line: 365, column: 6, scope: !4702, inlinedAt: !5148)
!5251 = !DILocation(line: 365, column: 11, scope: !4702, inlinedAt: !5148)
!5252 = !DILocation(line: 365, column: 6, scope: !4583, inlinedAt: !5148)
!5253 = !DILocation(line: 365, column: 26, scope: !4702, inlinedAt: !5148)
!5254 = !DILocation(line: 366, column: 6, scope: !4707, inlinedAt: !5148)
!5255 = !DILocation(line: 366, column: 11, scope: !4707, inlinedAt: !5148)
!5256 = !DILocation(line: 366, column: 6, scope: !4583, inlinedAt: !5148)
!5257 = !DILocation(line: 366, column: 26, scope: !4707, inlinedAt: !5148)
!5258 = !DILocation(line: 367, column: 6, scope: !4712, inlinedAt: !5148)
!5259 = !DILocation(line: 367, column: 11, scope: !4712, inlinedAt: !5148)
!5260 = !DILocation(line: 367, column: 6, scope: !4583, inlinedAt: !5148)
!5261 = !DILocation(line: 367, column: 26, scope: !4712, inlinedAt: !5148)
!5262 = !DILocation(line: 368, column: 6, scope: !4717, inlinedAt: !5148)
!5263 = !DILocation(line: 368, column: 11, scope: !4717, inlinedAt: !5148)
!5264 = !DILocation(line: 368, column: 6, scope: !4583, inlinedAt: !5148)
!5265 = !DILocation(line: 368, column: 26, scope: !4717, inlinedAt: !5148)
!5266 = !DILocation(line: 369, column: 6, scope: !4722, inlinedAt: !5148)
!5267 = !DILocation(line: 369, column: 11, scope: !4722, inlinedAt: !5148)
!5268 = !DILocation(line: 369, column: 6, scope: !4583, inlinedAt: !5148)
!5269 = !DILocation(line: 369, column: 26, scope: !4722, inlinedAt: !5148)
!5270 = !DILocation(line: 370, column: 6, scope: !4727, inlinedAt: !5148)
!5271 = !DILocation(line: 370, column: 11, scope: !4727, inlinedAt: !5148)
!5272 = !DILocation(line: 370, column: 6, scope: !4583, inlinedAt: !5148)
!5273 = !DILocation(line: 370, column: 26, scope: !4727, inlinedAt: !5148)
!5274 = !DILocation(line: 371, column: 6, scope: !4732, inlinedAt: !5148)
!5275 = !DILocation(line: 371, column: 11, scope: !4732, inlinedAt: !5148)
!5276 = !DILocation(line: 371, column: 6, scope: !4583, inlinedAt: !5148)
!5277 = !DILocation(line: 371, column: 26, scope: !4732, inlinedAt: !5148)
!5278 = !DILocation(line: 372, column: 6, scope: !4737, inlinedAt: !5148)
!5279 = !DILocation(line: 372, column: 11, scope: !4737, inlinedAt: !5148)
!5280 = !DILocation(line: 372, column: 6, scope: !4583, inlinedAt: !5148)
!5281 = !DILocation(line: 372, column: 26, scope: !4737, inlinedAt: !5148)
!5282 = !DILocation(line: 373, column: 6, scope: !4742, inlinedAt: !5148)
!5283 = !DILocation(line: 373, column: 11, scope: !4742, inlinedAt: !5148)
!5284 = !DILocation(line: 373, column: 6, scope: !4583, inlinedAt: !5148)
!5285 = !DILocation(line: 373, column: 26, scope: !4742, inlinedAt: !5148)
!5286 = !DILocation(line: 374, column: 6, scope: !4747, inlinedAt: !5148)
!5287 = !DILocation(line: 374, column: 11, scope: !4747, inlinedAt: !5148)
!5288 = !DILocation(line: 374, column: 6, scope: !4583, inlinedAt: !5148)
!5289 = !DILocation(line: 374, column: 26, scope: !4747, inlinedAt: !5148)
!5290 = !DILocation(line: 375, column: 6, scope: !4752, inlinedAt: !5148)
!5291 = !DILocation(line: 375, column: 11, scope: !4752, inlinedAt: !5148)
!5292 = !DILocation(line: 375, column: 6, scope: !4583, inlinedAt: !5148)
!5293 = !DILocation(line: 375, column: 27, scope: !4752, inlinedAt: !5148)
!5294 = !DILocation(line: 376, column: 6, scope: !4757, inlinedAt: !5148)
!5295 = !DILocation(line: 376, column: 11, scope: !4757, inlinedAt: !5148)
!5296 = !DILocation(line: 376, column: 6, scope: !4583, inlinedAt: !5148)
!5297 = !DILocation(line: 376, column: 32, scope: !4757, inlinedAt: !5148)
!5298 = !DILocation(line: 377, column: 6, scope: !4762, inlinedAt: !5148)
!5299 = !DILocation(line: 377, column: 11, scope: !4762, inlinedAt: !5148)
!5300 = !DILocation(line: 377, column: 6, scope: !4583, inlinedAt: !5148)
!5301 = !DILocation(line: 377, column: 32, scope: !4762, inlinedAt: !5148)
!5302 = !DILocation(line: 378, column: 6, scope: !4767, inlinedAt: !5148)
!5303 = !DILocation(line: 378, column: 11, scope: !4767, inlinedAt: !5148)
!5304 = !DILocation(line: 378, column: 6, scope: !4583, inlinedAt: !5148)
!5305 = !DILocation(line: 378, column: 32, scope: !4767, inlinedAt: !5148)
!5306 = !DILocation(line: 379, column: 6, scope: !4772, inlinedAt: !5148)
!5307 = !DILocation(line: 379, column: 11, scope: !4772, inlinedAt: !5148)
!5308 = !DILocation(line: 379, column: 6, scope: !4583, inlinedAt: !5148)
!5309 = !DILocation(line: 379, column: 33, scope: !4772, inlinedAt: !5148)
!5310 = !DILocation(line: 380, column: 6, scope: !4777, inlinedAt: !5148)
!5311 = !DILocation(line: 380, column: 11, scope: !4777, inlinedAt: !5148)
!5312 = !DILocation(line: 380, column: 6, scope: !4583, inlinedAt: !5148)
!5313 = !DILocation(line: 380, column: 33, scope: !4777, inlinedAt: !5148)
!5314 = !DILocation(line: 381, column: 6, scope: !4782, inlinedAt: !5148)
!5315 = !DILocation(line: 381, column: 11, scope: !4782, inlinedAt: !5148)
!5316 = !DILocation(line: 381, column: 6, scope: !4583, inlinedAt: !5148)
!5317 = !DILocation(line: 381, column: 33, scope: !4782, inlinedAt: !5148)
!5318 = !DILocation(line: 382, column: 2, scope: !4787, inlinedAt: !5148)
!5319 = !DILocation(line: 382, column: 2, scope: !4791, inlinedAt: !5148)
!5320 = !DILocation(line: 382, column: 2, scope: !4792, inlinedAt: !5148)
!5321 = !DILocation(line: 386, column: 1, scope: !4583, inlinedAt: !5148)
!5322 = !DILocation(line: 547, column: 9, scope: !4564, inlinedAt: !5141)
!5323 = !DILocation(line: 549, column: 8, scope: !4798, inlinedAt: !5141)
!5324 = !DILocation(line: 549, column: 7, scope: !4564, inlinedAt: !5141)
!5325 = !DILocation(line: 550, column: 4, scope: !4798, inlinedAt: !5141)
!5326 = !DILocation(line: 553, column: 33, scope: !4564, inlinedAt: !5141)
!5327 = !DILocation(line: 325, column: 6, scope: !4803, inlinedAt: !5146)
!5328 = !DILocation(line: 325, column: 6, scope: !4577, inlinedAt: !5146)
!5329 = !DILocation(line: 326, column: 3, scope: !4803, inlinedAt: !5146)
!5330 = !DILocation(line: 332, column: 9, scope: !4577, inlinedAt: !5146)
!5331 = !DILocation(line: 332, column: 15, scope: !4577, inlinedAt: !5146)
!5332 = !DILocation(line: 332, column: 2, scope: !4577, inlinedAt: !5146)
!5333 = !DILocation(line: 336, column: 1, scope: !4577, inlinedAt: !5146)
!5334 = !DILocation(line: 553, column: 5, scope: !4564, inlinedAt: !5141)
!5335 = !DILocation(line: 553, column: 41, scope: !4564, inlinedAt: !5141)
!5336 = !DILocation(line: 554, column: 5, scope: !4564, inlinedAt: !5141)
!5337 = !DILocation(line: 554, column: 12, scope: !4564, inlinedAt: !5141)
!5338 = !DILocation(line: 448, column: 31, scope: !4559, inlinedAt: !5140)
!5339 = !DILocation(line: 448, column: 34, scope: !4559, inlinedAt: !5140)
!5340 = !DILocation(line: 448, column: 14, scope: !4559, inlinedAt: !5140)
!5341 = !DILocation(line: 450, column: 22, scope: !4559, inlinedAt: !5140)
!5342 = !DILocation(line: 450, column: 25, scope: !4559, inlinedAt: !5140)
!5343 = !DILocation(line: 450, column: 30, scope: !4559, inlinedAt: !5140)
!5344 = !DILocation(line: 450, column: 36, scope: !4559, inlinedAt: !5140)
!5345 = !DILocation(line: 450, column: 8, scope: !4559, inlinedAt: !5140)
!5346 = !DILocation(line: 450, column: 6, scope: !4559, inlinedAt: !5140)
!5347 = !DILocation(line: 451, column: 9, scope: !4559, inlinedAt: !5140)
!5348 = !DILocation(line: 552, column: 3, scope: !4564, inlinedAt: !5141)
!5349 = !DILocation(line: 557, column: 19, scope: !4566, inlinedAt: !5141)
!5350 = !DILocation(line: 557, column: 25, scope: !4566, inlinedAt: !5141)
!5351 = !DILocation(line: 557, column: 9, scope: !4566, inlinedAt: !5141)
!5352 = !DILocation(line: 557, column: 2, scope: !4566, inlinedAt: !5141)
!5353 = !DILocation(line: 558, column: 1, scope: !4566, inlinedAt: !5141)
!5354 = !DILocation(line: 54, column: 14, scope: !5138)
!5355 = !DILocation(line: 54, column: 12, scope: !5138)
!5356 = !DILocation(line: 55, column: 7, scope: !5357)
!5357 = distinct !DILexicalBlock(scope: !5138, file: !3, line: 55, column: 6)
!5358 = !DILocation(line: 55, column: 6, scope: !5138)
!5359 = !DILocation(line: 56, column: 3, scope: !5357)
!5360 = !DILocation(line: 57, column: 19, scope: !5138)
!5361 = !DILocation(line: 57, column: 2, scope: !5138)
!5362 = !DILocation(line: 57, column: 13, scope: !5138)
!5363 = !DILocation(line: 57, column: 17, scope: !5138)
!5364 = !DILocation(line: 59, column: 14, scope: !5138)
!5365 = !DILocation(line: 59, column: 24, scope: !5138)
!5366 = !DILocation(line: 59, column: 2, scope: !5138)
!5367 = !DILocation(line: 60, column: 17, scope: !5138)
!5368 = !DILocation(line: 60, column: 28, scope: !5138)
!5369 = !DILocation(line: 60, column: 35, scope: !5138)
!5370 = !DILocation(line: 60, column: 45, scope: !5138)
!5371 = !DILocation(line: 60, column: 2, scope: !5138)
!5372 = !DILocation(line: 61, column: 16, scope: !5138)
!5373 = !DILocation(line: 61, column: 26, scope: !5138)
!5374 = !DILocation(line: 61, column: 2, scope: !5138)
!5375 = !DILocation(line: 64, column: 39, scope: !5138)
!5376 = !DILocation(line: 64, column: 44, scope: !5138)
!5377 = !DILocation(line: 64, column: 25, scope: !5138)
!5378 = !DILocation(line: 64, column: 9, scope: !5138)
!5379 = !DILocation(line: 65, column: 22, scope: !5138)
!5380 = !DILocation(line: 65, column: 27, scope: !5138)
!5381 = !DILocation(line: 65, column: 32, scope: !5138)
!5382 = !DILocation(line: 65, column: 8, scope: !5138)
!5383 = !DILocation(line: 65, column: 6, scope: !5138)
!5384 = !DILocation(line: 66, column: 10, scope: !5138)
!5385 = !DILocation(line: 66, column: 15, scope: !5138)
!5386 = !DILocation(line: 66, column: 8, scope: !5138)
!5387 = !DILocation(line: 67, column: 8, scope: !5138)
!5388 = !DILocation(line: 67, column: 19, scope: !5138)
!5389 = !DILocation(line: 67, column: 25, scope: !5138)
!5390 = !DILocation(line: 67, column: 33, scope: !5138)
!5391 = !DILocation(line: 67, column: 38, scope: !5138)
!5392 = !DILocation(line: 67, column: 45, scope: !5138)
!5393 = !DILocation(line: 67, column: 6, scope: !5138)
!5394 = !DILocation(line: 69, column: 9, scope: !5138)
!5395 = !DILocation(line: 69, column: 2, scope: !5138)
!5396 = !DILocation(line: 70, column: 1, scope: !5138)
!5397 = distinct !DISubprogram(name: "__xen_pcibk_get_pci_dev", scope: !3, file: !3, line: 20, type: !4551, scopeLine: 24, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!5398 = !DILocalVariable(name: "pdev", arg: 1, scope: !5397, file: !3, line: 20, type: !4441)
!5399 = !DILocation(line: 20, column: 73, scope: !5397)
!5400 = !DILocalVariable(name: "domain", arg: 2, scope: !5397, file: !3, line: 21, type: !7)
!5401 = !DILocation(line: 21, column: 26, scope: !5397)
!5402 = !DILocalVariable(name: "bus", arg: 3, scope: !5397, file: !3, line: 22, type: !7)
!5403 = !DILocation(line: 22, column: 26, scope: !5397)
!5404 = !DILocalVariable(name: "devfn", arg: 4, scope: !5397, file: !3, line: 23, type: !7)
!5405 = !DILocation(line: 23, column: 26, scope: !5397)
!5406 = !DILocalVariable(name: "dev_data", scope: !5397, file: !3, line: 25, type: !4616)
!5407 = !DILocation(line: 25, column: 31, scope: !5397)
!5408 = !DILocation(line: 25, column: 42, scope: !5397)
!5409 = !DILocation(line: 25, column: 48, scope: !5397)
!5410 = !DILocalVariable(name: "dev_entry", scope: !5397, file: !3, line: 26, type: !163)
!5411 = !DILocation(line: 26, column: 24, scope: !5397)
!5412 = !DILocalVariable(name: "dev", scope: !5397, file: !3, line: 27, type: !169)
!5413 = !DILocation(line: 27, column: 18, scope: !5397)
!5414 = !DILocation(line: 29, column: 14, scope: !5397)
!5415 = !DILocation(line: 29, column: 24, scope: !5397)
!5416 = !DILocation(line: 29, column: 2, scope: !5397)
!5417 = !DILocalVariable(name: "__mptr", scope: !5418, file: !3, line: 31, type: !155)
!5418 = distinct !DILexicalBlock(scope: !5419, file: !3, line: 31, column: 2)
!5419 = distinct !DILexicalBlock(scope: !5397, file: !3, line: 31, column: 2)
!5420 = !DILocation(line: 31, column: 2, scope: !5418)
!5421 = !DILocation(line: 31, column: 2, scope: !5422)
!5422 = distinct !DILexicalBlock(scope: !5418, file: !3, line: 31, column: 2)
!5423 = !DILocation(line: 31, column: 2, scope: !5419)
!5424 = !DILocation(line: 31, column: 2, scope: !5425)
!5425 = distinct !DILexicalBlock(scope: !5419, file: !3, line: 31, column: 2)
!5426 = !DILocation(line: 32, column: 7, scope: !5427)
!5427 = distinct !DILexicalBlock(scope: !5428, file: !3, line: 32, column: 7)
!5428 = distinct !DILexicalBlock(scope: !5425, file: !3, line: 31, column: 60)
!5429 = !DILocation(line: 32, column: 45, scope: !5427)
!5430 = !DILocation(line: 32, column: 56, scope: !5427)
!5431 = !DILocation(line: 32, column: 61, scope: !5427)
!5432 = !DILocation(line: 32, column: 31, scope: !5427)
!5433 = !DILocation(line: 32, column: 14, scope: !5427)
!5434 = !DILocation(line: 33, column: 7, scope: !5427)
!5435 = !DILocation(line: 33, column: 10, scope: !5427)
!5436 = !DILocation(line: 33, column: 31, scope: !5427)
!5437 = !DILocation(line: 33, column: 42, scope: !5427)
!5438 = !DILocation(line: 33, column: 47, scope: !5427)
!5439 = !DILocation(line: 33, column: 52, scope: !5427)
!5440 = !DILocation(line: 33, column: 17, scope: !5427)
!5441 = !DILocation(line: 33, column: 14, scope: !5427)
!5442 = !DILocation(line: 34, column: 7, scope: !5427)
!5443 = !DILocation(line: 34, column: 10, scope: !5427)
!5444 = !DILocation(line: 34, column: 19, scope: !5427)
!5445 = !DILocation(line: 34, column: 30, scope: !5427)
!5446 = !DILocation(line: 34, column: 35, scope: !5427)
!5447 = !DILocation(line: 34, column: 16, scope: !5427)
!5448 = !DILocation(line: 32, column: 7, scope: !5428)
!5449 = !DILocation(line: 35, column: 10, scope: !5450)
!5450 = distinct !DILexicalBlock(scope: !5427, file: !3, line: 34, column: 42)
!5451 = !DILocation(line: 35, column: 21, scope: !5450)
!5452 = !DILocation(line: 35, column: 8, scope: !5450)
!5453 = !DILocation(line: 36, column: 4, scope: !5450)
!5454 = !DILocation(line: 38, column: 2, scope: !5428)
!5455 = !DILocalVariable(name: "__mptr", scope: !5456, file: !3, line: 31, type: !155)
!5456 = distinct !DILexicalBlock(scope: !5425, file: !3, line: 31, column: 2)
!5457 = !DILocation(line: 31, column: 2, scope: !5456)
!5458 = !DILocation(line: 31, column: 2, scope: !5459)
!5459 = distinct !DILexicalBlock(scope: !5456, file: !3, line: 31, column: 2)
!5460 = distinct !{!5460, !5423, !5461}
!5461 = !DILocation(line: 38, column: 2, scope: !5419)
!5462 = !DILocation(line: 40, column: 16, scope: !5397)
!5463 = !DILocation(line: 40, column: 26, scope: !5397)
!5464 = !DILocation(line: 40, column: 2, scope: !5397)
!5465 = !DILocation(line: 42, column: 9, scope: !5397)
!5466 = !DILocation(line: 42, column: 2, scope: !5397)
!5467 = distinct !DISubprogram(name: "INIT_LIST_HEAD", scope: !5468, file: !5468, line: 33, type: !5469, scopeLine: 34, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!5468 = !DIFile(filename: "./include/linux/list.h", directory: "/home/lizy2001/genbc/linux")
!5469 = !DISubroutineType(types: !5470)
!5470 = !{null, !158}
!5471 = !DILocalVariable(name: "list", arg: 1, scope: !5467, file: !5468, line: 33, type: !158)
!5472 = !DILocation(line: 33, column: 53, scope: !5467)
!5473 = !DILocation(line: 35, column: 2, scope: !5467)
!5474 = !DILocation(line: 35, column: 2, scope: !5475)
!5475 = distinct !DILexicalBlock(scope: !5467, file: !5468, line: 35, column: 2)
!5476 = !DILocation(line: 35, column: 2, scope: !5477)
!5477 = distinct !DILexicalBlock(scope: !5475, file: !5468, line: 35, column: 2)
!5478 = !DILocation(line: 35, column: 2, scope: !5479)
!5479 = distinct !DILexicalBlock(scope: !5475, file: !5468, line: 35, column: 2)
!5480 = !DILocation(line: 36, column: 15, scope: !5467)
!5481 = !DILocation(line: 36, column: 2, scope: !5467)
!5482 = !DILocation(line: 36, column: 8, scope: !5467)
!5483 = !DILocation(line: 36, column: 13, scope: !5467)
!5484 = !DILocation(line: 37, column: 1, scope: !5467)
!5485 = distinct !DISubprogram(name: "get_order", scope: !5486, file: !5486, line: 29, type: !5487, scopeLine: 30, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!5486 = !DIFile(filename: "./include/asm-generic/getorder.h", directory: "/home/lizy2001/genbc/linux")
!5487 = !DISubroutineType(types: !5488)
!5488 = !{!221, !204}
!5489 = !DILocalVariable(name: "x", arg: 1, scope: !5490, file: !5491, line: 366, type: !195)
!5490 = distinct !DISubprogram(name: "fls64", scope: !5491, file: !5491, line: 366, type: !5492, scopeLine: 367, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!5491 = !DIFile(filename: "./arch/x86/include/asm/bitops.h", directory: "/home/lizy2001/genbc/linux")
!5492 = !DISubroutineType(types: !5493)
!5493 = !{!221, !195}
!5494 = !DILocation(line: 366, column: 40, scope: !5490, inlinedAt: !5495)
!5495 = distinct !DILocation(line: 46, column: 9, scope: !5485)
!5496 = !DILocalVariable(name: "bitpos", scope: !5490, file: !5491, line: 368, type: !221)
!5497 = !DILocation(line: 368, column: 6, scope: !5490, inlinedAt: !5495)
!5498 = !DILocalVariable(name: "size", arg: 1, scope: !5485, file: !5486, line: 29, type: !204)
!5499 = !DILocation(line: 29, column: 63, scope: !5485)
!5500 = !DILocation(line: 31, column: 27, scope: !5501)
!5501 = distinct !DILexicalBlock(scope: !5485, file: !5486, line: 31, column: 6)
!5502 = !DILocation(line: 31, column: 6, scope: !5501)
!5503 = !DILocation(line: 31, column: 6, scope: !5485)
!5504 = !DILocation(line: 32, column: 8, scope: !5505)
!5505 = distinct !DILexicalBlock(scope: !5506, file: !5486, line: 32, column: 7)
!5506 = distinct !DILexicalBlock(scope: !5501, file: !5486, line: 31, column: 34)
!5507 = !DILocation(line: 32, column: 7, scope: !5506)
!5508 = !DILocation(line: 33, column: 4, scope: !5505)
!5509 = !DILocation(line: 35, column: 7, scope: !5510)
!5510 = distinct !DILexicalBlock(scope: !5506, file: !5486, line: 35, column: 7)
!5511 = !DILocation(line: 35, column: 12, scope: !5510)
!5512 = !DILocation(line: 35, column: 7, scope: !5506)
!5513 = !DILocation(line: 36, column: 4, scope: !5510)
!5514 = !DILocation(line: 38, column: 10, scope: !5506)
!5515 = !DILocation(line: 38, column: 28, scope: !5506)
!5516 = !DILocation(line: 38, column: 41, scope: !5506)
!5517 = !DILocation(line: 38, column: 3, scope: !5506)
!5518 = !DILocation(line: 41, column: 6, scope: !5485)
!5519 = !DILocation(line: 42, column: 7, scope: !5485)
!5520 = !DILocation(line: 46, column: 15, scope: !5485)
!5521 = !DILocation(line: 374, column: 2, scope: !5490, inlinedAt: !5495)
!5522 = !DILocation(line: 376, column: 14, scope: !5490, inlinedAt: !5495)
!5523 = !{i32 276925}
!5524 = !DILocation(line: 377, column: 9, scope: !5490, inlinedAt: !5495)
!5525 = !DILocation(line: 377, column: 16, scope: !5490, inlinedAt: !5495)
!5526 = !DILocation(line: 46, column: 2, scope: !5485)
!5527 = !DILocation(line: 48, column: 1, scope: !5485)
!5528 = distinct !DISubprogram(name: "__ilog2_u64", scope: !5529, file: !5529, line: 30, type: !5530, scopeLine: 31, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!5529 = !DIFile(filename: "./include/linux/log2.h", directory: "/home/lizy2001/genbc/linux")
!5530 = !DISubroutineType(types: !5531)
!5531 = !{!221, !193}
!5532 = !DILocation(line: 366, column: 40, scope: !5490, inlinedAt: !5533)
!5533 = distinct !DILocation(line: 32, column: 9, scope: !5528)
!5534 = !DILocation(line: 368, column: 6, scope: !5490, inlinedAt: !5533)
!5535 = !DILocalVariable(name: "n", arg: 1, scope: !5528, file: !5529, line: 30, type: !193)
!5536 = !DILocation(line: 30, column: 21, scope: !5528)
!5537 = !DILocation(line: 32, column: 15, scope: !5528)
!5538 = !DILocation(line: 374, column: 2, scope: !5490, inlinedAt: !5533)
!5539 = !DILocation(line: 376, column: 14, scope: !5490, inlinedAt: !5533)
!5540 = !DILocation(line: 377, column: 9, scope: !5490, inlinedAt: !5533)
!5541 = !DILocation(line: 377, column: 16, scope: !5490, inlinedAt: !5533)
!5542 = !DILocation(line: 32, column: 18, scope: !5528)
!5543 = !DILocation(line: 32, column: 2, scope: !5528)
!5544 = distinct !DISubprogram(name: "kasan_kmalloc", scope: !5545, file: !5545, line: 137, type: !5546, scopeLine: 139, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!5545 = !DIFile(filename: "./include/linux/kasan.h", directory: "/home/lizy2001/genbc/linux")
!5546 = !DISubroutineType(types: !5547)
!5547 = !{!155, !962, !2135, !356, !153}
!5548 = !DILocalVariable(name: "s", arg: 1, scope: !5544, file: !5545, line: 137, type: !962)
!5549 = !DILocation(line: 137, column: 54, scope: !5544)
!5550 = !DILocalVariable(name: "object", arg: 2, scope: !5544, file: !5545, line: 137, type: !2135)
!5551 = !DILocation(line: 137, column: 69, scope: !5544)
!5552 = !DILocalVariable(name: "size", arg: 3, scope: !5544, file: !5545, line: 138, type: !356)
!5553 = !DILocation(line: 138, column: 12, scope: !5544)
!5554 = !DILocalVariable(name: "flags", arg: 4, scope: !5544, file: !5545, line: 138, type: !153)
!5555 = !DILocation(line: 138, column: 24, scope: !5544)
!5556 = !DILocation(line: 140, column: 17, scope: !5544)
!5557 = !DILocation(line: 140, column: 2, scope: !5544)
!5558 = distinct !DISubprogram(name: "list_del", scope: !5468, file: !5468, line: 144, type: !5469, scopeLine: 145, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!5559 = !DILocalVariable(name: "entry", arg: 1, scope: !5558, file: !5468, line: 144, type: !158)
!5560 = !DILocation(line: 144, column: 47, scope: !5558)
!5561 = !DILocation(line: 146, column: 19, scope: !5558)
!5562 = !DILocation(line: 146, column: 2, scope: !5558)
!5563 = !DILocation(line: 147, column: 2, scope: !5558)
!5564 = !DILocation(line: 147, column: 9, scope: !5558)
!5565 = !DILocation(line: 147, column: 14, scope: !5558)
!5566 = !DILocation(line: 148, column: 2, scope: !5558)
!5567 = !DILocation(line: 148, column: 9, scope: !5558)
!5568 = !DILocation(line: 148, column: 14, scope: !5558)
!5569 = !DILocation(line: 149, column: 1, scope: !5558)
!5570 = distinct !DISubprogram(name: "device_lock", scope: !73, file: !73, line: 729, type: !3403, scopeLine: 730, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!5571 = !DILocalVariable(name: "dev", arg: 1, scope: !5570, file: !73, line: 729, type: !251)
!5572 = !DILocation(line: 729, column: 47, scope: !5570)
!5573 = !DILocation(line: 731, column: 14, scope: !5570)
!5574 = !DILocation(line: 731, column: 19, scope: !5570)
!5575 = !DILocation(line: 731, column: 2, scope: !5570)
!5576 = !DILocation(line: 732, column: 1, scope: !5570)
!5577 = distinct !DISubprogram(name: "device_unlock", scope: !73, file: !73, line: 744, type: !3403, scopeLine: 745, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!5578 = !DILocalVariable(name: "dev", arg: 1, scope: !5577, file: !73, line: 744, type: !251)
!5579 = !DILocation(line: 744, column: 49, scope: !5577)
!5580 = !DILocation(line: 746, column: 16, scope: !5577)
!5581 = !DILocation(line: 746, column: 21, scope: !5577)
!5582 = !DILocation(line: 746, column: 2, scope: !5577)
!5583 = !DILocation(line: 747, column: 1, scope: !5577)
!5584 = distinct !DISubprogram(name: "__list_del_entry", scope: !5468, file: !5468, line: 130, type: !5469, scopeLine: 131, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!5585 = !DILocalVariable(name: "entry", arg: 1, scope: !5584, file: !5468, line: 130, type: !158)
!5586 = !DILocation(line: 130, column: 55, scope: !5584)
!5587 = !DILocation(line: 132, column: 30, scope: !5588)
!5588 = distinct !DILexicalBlock(scope: !5584, file: !5468, line: 132, column: 6)
!5589 = !DILocation(line: 132, column: 7, scope: !5588)
!5590 = !DILocation(line: 132, column: 6, scope: !5584)
!5591 = !DILocation(line: 133, column: 3, scope: !5588)
!5592 = !DILocation(line: 135, column: 13, scope: !5584)
!5593 = !DILocation(line: 135, column: 20, scope: !5584)
!5594 = !DILocation(line: 135, column: 26, scope: !5584)
!5595 = !DILocation(line: 135, column: 33, scope: !5584)
!5596 = !DILocation(line: 135, column: 2, scope: !5584)
!5597 = !DILocation(line: 136, column: 1, scope: !5584)
!5598 = distinct !DISubprogram(name: "__list_del_entry_valid", scope: !5468, file: !5468, line: 51, type: !5599, scopeLine: 52, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!5599 = !DISubroutineType(types: !5600)
!5600 = !{!517, !158}
!5601 = !DILocalVariable(name: "entry", arg: 1, scope: !5598, file: !5468, line: 51, type: !158)
!5602 = !DILocation(line: 51, column: 61, scope: !5598)
!5603 = !DILocation(line: 53, column: 2, scope: !5598)
!5604 = distinct !DISubprogram(name: "__list_del", scope: !5468, file: !5468, line: 110, type: !5605, scopeLine: 111, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!5605 = !DISubroutineType(types: !5606)
!5606 = !{null, !158, !158}
!5607 = !DILocalVariable(name: "prev", arg: 1, scope: !5604, file: !5468, line: 110, type: !158)
!5608 = !DILocation(line: 110, column: 50, scope: !5604)
!5609 = !DILocalVariable(name: "next", arg: 2, scope: !5604, file: !5468, line: 110, type: !158)
!5610 = !DILocation(line: 110, column: 75, scope: !5604)
!5611 = !DILocation(line: 112, column: 15, scope: !5604)
!5612 = !DILocation(line: 112, column: 2, scope: !5604)
!5613 = !DILocation(line: 112, column: 8, scope: !5604)
!5614 = !DILocation(line: 112, column: 13, scope: !5604)
!5615 = !DILocation(line: 113, column: 2, scope: !5604)
!5616 = !DILocation(line: 113, column: 2, scope: !5617)
!5617 = distinct !DILexicalBlock(scope: !5604, file: !5468, line: 113, column: 2)
!5618 = !DILocation(line: 113, column: 2, scope: !5619)
!5619 = distinct !DILexicalBlock(scope: !5617, file: !5468, line: 113, column: 2)
!5620 = !DILocation(line: 113, column: 2, scope: !5621)
!5621 = distinct !DILexicalBlock(scope: !5617, file: !5468, line: 113, column: 2)
!5622 = !DILocation(line: 114, column: 1, scope: !5604)
!5623 = distinct !DISubprogram(name: "pci_domain_nr", scope: !5624, file: !5624, line: 44, type: !219, scopeLine: 45, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!5624 = !DIFile(filename: "./arch/x86/include/asm/pci.h", directory: "/home/lizy2001/genbc/linux")
!5625 = !DILocalVariable(name: "bus", arg: 1, scope: !5623, file: !5624, line: 44, type: !175)
!5626 = !DILocation(line: 44, column: 49, scope: !5623)
!5627 = !DILocation(line: 46, column: 24, scope: !5623)
!5628 = !DILocation(line: 46, column: 9, scope: !5623)
!5629 = !DILocation(line: 46, column: 30, scope: !5623)
!5630 = !DILocation(line: 46, column: 2, scope: !5623)
!5631 = distinct !DISubprogram(name: "to_pci_sysdata", scope: !5624, file: !5624, line: 36, type: !5632, scopeLine: 37, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!5632 = !DISubroutineType(types: !5633)
!5633 = !{!5634, !5645}
!5634 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !5635, size: 64)
!5635 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pci_sysdata", file: !5624, line: 15, size: 320, elements: !5636)
!5636 = !{!5637, !5638, !5639, !5642, !5643, !5644}
!5637 = !DIDerivedType(tag: DW_TAG_member, name: "domain", scope: !5635, file: !5624, line: 16, baseType: !221, size: 32)
!5638 = !DIDerivedType(tag: DW_TAG_member, name: "node", scope: !5635, file: !5624, line: 17, baseType: !221, size: 32, offset: 32)
!5639 = !DIDerivedType(tag: DW_TAG_member, name: "companion", scope: !5635, file: !5624, line: 19, baseType: !5640, size: 64, offset: 64)
!5640 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !5641, size: 64)
!5641 = !DICompositeType(tag: DW_TAG_structure_type, name: "acpi_device", file: !3439, line: 228, flags: DIFlagFwdDecl)
!5642 = !DIDerivedType(tag: DW_TAG_member, name: "iommu", scope: !5635, file: !5624, line: 22, baseType: !155, size: 64, offset: 128)
!5643 = !DIDerivedType(tag: DW_TAG_member, name: "fwnode", scope: !5635, file: !5624, line: 25, baseType: !155, size: 64, offset: 192)
!5644 = !DIDerivedType(tag: DW_TAG_member, name: "vmd_dev", scope: !5635, file: !5624, line: 28, baseType: !169, size: 64, offset: 256)
!5645 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !5646, size: 64)
!5646 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !176)
!5647 = !DILocalVariable(name: "bus", arg: 1, scope: !5631, file: !5624, line: 36, type: !5645)
!5648 = !DILocation(line: 36, column: 72, scope: !5631)
!5649 = !DILocation(line: 38, column: 9, scope: !5631)
!5650 = !DILocation(line: 38, column: 14, scope: !5631)
!5651 = !DILocation(line: 38, column: 2, scope: !5631)
!5652 = distinct !DISubprogram(name: "list_add_tail", scope: !5468, file: !5468, line: 98, type: !5605, scopeLine: 99, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!5653 = !DILocalVariable(name: "new", arg: 1, scope: !5652, file: !5468, line: 98, type: !158)
!5654 = !DILocation(line: 98, column: 52, scope: !5652)
!5655 = !DILocalVariable(name: "head", arg: 2, scope: !5652, file: !5468, line: 98, type: !158)
!5656 = !DILocation(line: 98, column: 75, scope: !5652)
!5657 = !DILocation(line: 100, column: 13, scope: !5652)
!5658 = !DILocation(line: 100, column: 18, scope: !5652)
!5659 = !DILocation(line: 100, column: 24, scope: !5652)
!5660 = !DILocation(line: 100, column: 30, scope: !5652)
!5661 = !DILocation(line: 100, column: 2, scope: !5652)
!5662 = !DILocation(line: 101, column: 1, scope: !5652)
!5663 = distinct !DISubprogram(name: "__list_add", scope: !5468, file: !5468, line: 63, type: !5664, scopeLine: 66, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!5664 = !DISubroutineType(types: !5665)
!5665 = !{null, !158, !158, !158}
!5666 = !DILocalVariable(name: "new", arg: 1, scope: !5663, file: !5468, line: 63, type: !158)
!5667 = !DILocation(line: 63, column: 49, scope: !5663)
!5668 = !DILocalVariable(name: "prev", arg: 2, scope: !5663, file: !5468, line: 64, type: !158)
!5669 = !DILocation(line: 64, column: 28, scope: !5663)
!5670 = !DILocalVariable(name: "next", arg: 3, scope: !5663, file: !5468, line: 65, type: !158)
!5671 = !DILocation(line: 65, column: 28, scope: !5663)
!5672 = !DILocation(line: 67, column: 24, scope: !5673)
!5673 = distinct !DILexicalBlock(scope: !5663, file: !5468, line: 67, column: 6)
!5674 = !DILocation(line: 67, column: 29, scope: !5673)
!5675 = !DILocation(line: 67, column: 35, scope: !5673)
!5676 = !DILocation(line: 67, column: 7, scope: !5673)
!5677 = !DILocation(line: 67, column: 6, scope: !5663)
!5678 = !DILocation(line: 68, column: 3, scope: !5673)
!5679 = !DILocation(line: 70, column: 15, scope: !5663)
!5680 = !DILocation(line: 70, column: 2, scope: !5663)
!5681 = !DILocation(line: 70, column: 8, scope: !5663)
!5682 = !DILocation(line: 70, column: 13, scope: !5663)
!5683 = !DILocation(line: 71, column: 14, scope: !5663)
!5684 = !DILocation(line: 71, column: 2, scope: !5663)
!5685 = !DILocation(line: 71, column: 7, scope: !5663)
!5686 = !DILocation(line: 71, column: 12, scope: !5663)
!5687 = !DILocation(line: 72, column: 14, scope: !5663)
!5688 = !DILocation(line: 72, column: 2, scope: !5663)
!5689 = !DILocation(line: 72, column: 7, scope: !5663)
!5690 = !DILocation(line: 72, column: 12, scope: !5663)
!5691 = !DILocation(line: 73, column: 2, scope: !5663)
!5692 = !DILocation(line: 73, column: 2, scope: !5693)
!5693 = distinct !DILexicalBlock(scope: !5663, file: !5468, line: 73, column: 2)
!5694 = !DILocation(line: 73, column: 2, scope: !5695)
!5695 = distinct !DILexicalBlock(scope: !5693, file: !5468, line: 73, column: 2)
!5696 = !DILocation(line: 73, column: 2, scope: !5697)
!5697 = distinct !DILexicalBlock(scope: !5693, file: !5468, line: 73, column: 2)
!5698 = !DILocation(line: 74, column: 1, scope: !5663)
!5699 = distinct !DISubprogram(name: "__list_add_valid", scope: !5468, file: !5468, line: 45, type: !5700, scopeLine: 48, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !282)
!5700 = !DISubroutineType(types: !5701)
!5701 = !{!517, !158, !158, !158}
!5702 = !DILocalVariable(name: "new", arg: 1, scope: !5699, file: !5468, line: 45, type: !158)
!5703 = !DILocation(line: 45, column: 55, scope: !5699)
!5704 = !DILocalVariable(name: "prev", arg: 2, scope: !5699, file: !5468, line: 46, type: !158)
!5705 = !DILocation(line: 46, column: 23, scope: !5699)
!5706 = !DILocalVariable(name: "next", arg: 3, scope: !5699, file: !5468, line: 47, type: !158)
!5707 = !DILocation(line: 47, column: 23, scope: !5699)
!5708 = !DILocation(line: 49, column: 2, scope: !5699)
