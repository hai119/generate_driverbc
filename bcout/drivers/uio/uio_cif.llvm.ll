; ModuleID = '../bcout/drivers/uio/uio_cif.llvm.bc'
source_filename = "drivers/uio/uio_cif.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64"

module asm ".section\09\22.initcall6.init\22, \22a\22\09"
module asm "__initcall_hilscher_pci_driver_init6:\09\09\09"
module asm ".long\09hilscher_pci_driver_init - .\09\09\09"
...
@__UNIQUE_ID___addressable_hilscher_pci_driver_init234 = internal global i8* bitcast (i32 ()* @hilscher_pci_driver_init to i8*), section ".discard.addressable", align 8, !dbg !0
@hilscher_pci_driver = internal global %struct.pci_driver { %struct.list_head zeroinitializer, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i32 0, i32 0), %struct.pci_device_id* getelementptr inbounds ([3 x %struct.pci_device_id], [3 x %struct.pci_device_id]* @hilscher_pci_ids, i32 0, i32 0), i32 (%struct.pci_dev*, %struct.pci_device_id*)* @hilscher_pci_probe, void (%struct.pci_dev*)* @hilscher_pci_remove, i32 (%struct.pci_dev*, i32)* null, i32 (%struct.pci_dev*)* null, void (%struct.pci_dev*)* null, i32 (%struct.pci_dev*, i32)* null, %struct.pci_error_handlers* null, %struct.attribute_group** null, %struct.device_driver zeroinitializer, %struct.pci_dynids zeroinitializer }, align 8, !dbg !138
@__exitcall_hilscher_pci_driver_exit = internal global void ()* @hilscher_pci_driver_exit, section ".exitcall.exit", align 8, !dbg !114
@__UNIQUE_ID_file235 = internal constant [33 x i8] c"uio_cif.file=drivers/uio/uio_cif\00", section ".modinfo", align 1, !dbg !121
@__UNIQUE_ID_license236 = internal constant [23 x i8] c"uio_cif.license=GPL v2\00", section ".modinfo", align 1, !dbg !128
@__UNIQUE_ID_author237 = internal constant [47 x i8] c"uio_cif.author=Hans J. Koch, Benedikt Spranger\00", section ".modinfo", align 1, !dbg !133
@.str = private unnamed_addr constant [8 x i8] c"uio_cif\00", align 1
@.str.1 = private unnamed_addr constant [9 x i8] c"hilscher\00", align 1
@hilscher_pci_ids = internal global [3 x %struct.pci_device_id] [%struct.pci_device_id { i32 4277, i32 36912, i32 5400, i32 1072, i32 0, i32 0, i64 0 }, %struct.pci_device_id { i32 4277, i32 36912, i32 5400, i32 1074, i32 0, i32 0, i64 0 }, %struct.pci_device_id zeroinitializer], align 16, !dbg !4027
@.str.2 = private unnamed_addr constant [13 x i8] c"CIF_Profibus\00", align 1
@.str.3 = private unnamed_addr constant [14 x i8] c"CIF_Devicenet\00", align 1
@.str.4 = private unnamed_addr constant [8 x i8] c"CIF_???\00", align 1
@.str.5 = private unnamed_addr constant [6 x i8] c"0.0.1\00", align 1
@kmalloc_caches = external dso_local global [3 x [14 x %struct.kmem_cache*]], align 16
@.str.6 = private unnamed_addr constant [21 x i8] c"include/linux/slab.h\00", align 1
@llvm.used = appending global [6 x i8*] [i8* bitcast (i8** @__UNIQUE_ID___addressable_hilscher_pci_driver_init234 to i8*), i8* bitcast (void ()* @hilscher_pci_driver_exit to i8*), i8* bitcast (void ()** @__exitcall_hilscher_pci_driver_exit to i8*), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @__UNIQUE_ID_file235, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__UNIQUE_ID_license236, i32 0, i32 0), i8* getelementptr inbounds ([47 x i8], [47 x i8]* @__UNIQUE_ID_author237, i32 0, i32 0)], section "llvm.metadata"

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal i32 @hilscher_pci_driver_init() #0 section ".init.text" !dbg !4035 {
entry:
  %call = call i32 @__pci_register_driver(%struct.pci_driver* @hilscher_pci_driver, %struct.module* null, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0)) #7, !dbg !4038
  ret i32 %call, !dbg !4038
}

; Function Attrs: cold noinline noredzone nounwind optnone sspstrong
define internal void @hilscher_pci_driver_exit() #0 section ".exit.text" !dbg !4039 {
entry:
  call void @pci_unregister_driver(%struct.pci_driver* @hilscher_pci_driver) #7, !dbg !4040
  ret void, !dbg !4040
}
...
define internal i32 @hilscher_pci_probe(%struct.pci_dev* %dev, %struct.pci_device_id* %id) #2 !dbg !4041 {
entry:
  ...
  %call = call i8* @kzalloc(i64 568, i32 3264) #7, !dbg !4115
  %0 = bitcast i8* %call to %struct.uio_info*, !dbg !4115
  store %struct.uio_info* %0, %struct.uio_info** %info, align 8, !dbg !4116
  %1 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4117
  %tobool = icmp ne %struct.uio_info* %1, null, !dbg !4117
  br i1 %tobool, label %if.end, label %if.then, !dbg !4119

if.then:                                          ; preds = %entry
  store i32 -12, i32* %retval, align 4, !dbg !4120
  br label %return, !dbg !4120

if.end:                                           ; preds = %entry
  %2 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4121
  %call1 = call i32 @pci_enable_device(%struct.pci_dev* %2) #7, !dbg !4123
  %tobool2 = icmp ne i32 %call1, 0, !dbg !4123
  br i1 %tobool2, label %if.then3, label %if.end4, !dbg !4124

if.then3:                                         ; preds = %if.end
  br label %out_free, !dbg !4125

if.end4:                                          ; preds = %if.end
  %3 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4126
  %call5 = call i32 @pci_request_regions(%struct.pci_dev* %3, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0)) #7, !dbg !4128
  %tobool6 = icmp ne i32 %call5, 0, !dbg !4128
  br i1 %tobool6, label %if.then7, label %if.end8, !dbg !4129

if.then7:                                         ; preds = %if.end4
  br label %out_disable, !dbg !4130

if.end8:                                          ; preds = %if.end4
  %4 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4131
  %resource = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %4, i32 0, i32 44, !dbg !4131
  %arrayidx = getelementptr [17 x %struct.resource], [17 x %struct.resource]* %resource, i64 0, i64 0, !dbg !4131
  %start = getelementptr inbounds %struct.resource, %struct.resource* %arrayidx, i32 0, i32 0, !dbg !4131
  %5 = load i64, i64* %start, align 8, !dbg !4131
  %6 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4132
  %mem = getelementptr inbounds %struct.uio_info, %struct.uio_info* %6, i32 0, i32 3, !dbg !4133
  %arrayidx9 = getelementptr [5 x %struct.uio_mem], [5 x %struct.uio_mem]* %mem, i64 0, i64 0, !dbg !4132
  %addr = getelementptr inbounds %struct.uio_mem, %struct.uio_mem* %arrayidx9, i32 0, i32 1, !dbg !4134
  store i64 %5, i64* %addr, align 8, !dbg !4135
  %7 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4136
  %mem10 = getelementptr inbounds %struct.uio_info, %struct.uio_info* %7, i32 0, i32 3, !dbg !4138
  %arrayidx11 = getelementptr [5 x %struct.uio_mem], [5 x %struct.uio_mem]* %mem10, i64 0, i64 0, !dbg !4136
  %addr12 = getelementptr inbounds %struct.uio_mem, %struct.uio_mem* %arrayidx11, i32 0, i32 1, !dbg !4139
  %8 = load i64, i64* %addr12, align 8, !dbg !4139
  %tobool13 = icmp ne i64 %8, 0, !dbg !4136
  br i1 %tobool13, label %if.end15, label %if.then14, !dbg !4140

if.then14:                                        ; preds = %if.end8
  br label %out_release, !dbg !4141

if.end15:                                         ; preds = %if.end8
  %9 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4142
  %call16 = call i8* @pci_ioremap_bar(%struct.pci_dev* %9, i32 0) #7, !dbg !4143
  %10 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4144
  %mem17 = getelementptr inbounds %struct.uio_info, %struct.uio_info* %10, i32 0, i32 3, !dbg !4145
  %arrayidx18 = getelementptr [5 x %struct.uio_mem], [5 x %struct.uio_mem]* %mem17, i64 0, i64 0, !dbg !4144
  %internal_addr = getelementptr inbounds %struct.uio_mem, %struct.uio_mem* %arrayidx18, i32 0, i32 5, !dbg !4146
  store i8* %call16, i8** %internal_addr, align 8, !dbg !4147
  %11 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4148
  %mem19 = getelementptr inbounds %struct.uio_info, %struct.uio_info* %11, i32 0, i32 3, !dbg !4150
  %arrayidx20 = getelementptr [5 x %struct.uio_mem], [5 x %struct.uio_mem]* %mem19, i64 0, i64 0, !dbg !4148
  %internal_addr21 = getelementptr inbounds %struct.uio_mem, %struct.uio_mem* %arrayidx20, i32 0, i32 5, !dbg !4151
  %12 = load i8*, i8** %internal_addr21, align 8, !dbg !4151
  %tobool22 = icmp ne i8* %12, null, !dbg !4148
  br i1 %tobool22, label %if.end24, label %if.then23, !dbg !4152

if.then23:                                        ; preds = %if.end15
  br label %out_release, !dbg !4153

if.end24:                                         ; preds = %if.end15
  %13 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4154
  %resource25 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %13, i32 0, i32 44, !dbg !4154
  %arrayidx26 = getelementptr [17 x %struct.resource], [17 x %struct.resource]* %resource25, i64 0, i64 0, !dbg !4154
  %start27 = getelementptr inbounds %struct.resource, %struct.resource* %arrayidx26, i32 0, i32 0, !dbg !4154
  %14 = load i64, i64* %start27, align 8, !dbg !4154
  %cmp = icmp eq i64 %14, 0, !dbg !4154
  br i1 %cmp, label %land.lhs.true, label %cond.false, !dbg !4154

land.lhs.true:                                    ; preds = %if.end24
  %15 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4154
  %resource28 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %15, i32 0, i32 44, !dbg !4154
  %arrayidx29 = getelementptr [17 x %struct.resource], [17 x %struct.resource]* %resource28, i64 0, i64 0, !dbg !4154
  %end = getelementptr inbounds %struct.resource, %struct.resource* %arrayidx29, i32 0, i32 1, !dbg !4154
  %16 = load i64, i64* %end, align 8, !dbg !4154
  %17 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4154
  %resource30 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %17, i32 0, i32 44, !dbg !4154
  %arrayidx31 = getelementptr [17 x %struct.resource], [17 x %struct.resource]* %resource30, i64 0, i64 0, !dbg !4154
  %start32 = getelementptr inbounds %struct.resource, %struct.resource* %arrayidx31, i32 0, i32 0, !dbg !4154
  %18 = load i64, i64* %start32, align 8, !dbg !4154
  %cmp33 = icmp eq i64 %16, %18, !dbg !4154
  br i1 %cmp33, label %cond.true, label %cond.false, !dbg !4154

cond.true:                                        ; preds = %land.lhs.true
  br label %cond.end, !dbg !4154

cond.false:                                       ; preds = %land.lhs.true, %if.end24
  %19 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4154
  %resource34 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %19, i32 0, i32 44, !dbg !4154
  %arrayidx35 = getelementptr [17 x %struct.resource], [17 x %struct.resource]* %resource34, i64 0, i64 0, !dbg !4154
  %end36 = getelementptr inbounds %struct.resource, %struct.resource* %arrayidx35, i32 0, i32 1, !dbg !4154
  %20 = load i64, i64* %end36, align 8, !dbg !4154
  %21 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4154
  %resource37 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %21, i32 0, i32 44, !dbg !4154
  %arrayidx38 = getelementptr [17 x %struct.resource], [17 x %struct.resource]* %resource37, i64 0, i64 0, !dbg !4154
  %start39 = getelementptr inbounds %struct.resource, %struct.resource* %arrayidx38, i32 0, i32 0, !dbg !4154
  %22 = load i64, i64* %start39, align 8, !dbg !4154
  %sub = sub i64 %20, %22, !dbg !4154
  %add = add i64 %sub, 1, !dbg !4154
  br label %cond.end, !dbg !4154

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i64 [ 0, %cond.true ], [ %add, %cond.false ], !dbg !4154
  %23 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4155
  %mem40 = getelementptr inbounds %struct.uio_info, %struct.uio_info* %23, i32 0, i32 3, !dbg !4156
  %arrayidx41 = getelementptr [5 x %struct.uio_mem], [5 x %struct.uio_mem]* %mem40, i64 0, i64 0, !dbg !4155
  %size = getelementptr inbounds %struct.uio_mem, %struct.uio_mem* %arrayidx41, i32 0, i32 3, !dbg !4157
  store i64 %cond, i64* %size, align 8, !dbg !4158
  %24 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4159
  %mem42 = getelementptr inbounds %struct.uio_info, %struct.uio_info* %24, i32 0, i32 3, !dbg !4160
  %arrayidx43 = getelementptr [5 x %struct.uio_mem], [5 x %struct.uio_mem]* %mem42, i64 0, i64 0, !dbg !4159
  %memtype = getelementptr inbounds %struct.uio_mem, %struct.uio_mem* %arrayidx43, i32 0, i32 4, !dbg !4161
  store i32 1, i32* %memtype, align 8, !dbg !4162
  %25 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4163
  %resource44 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %25, i32 0, i32 44, !dbg !4163
  %arrayidx45 = getelementptr [17 x %struct.resource], [17 x %struct.resource]* %resource44, i64 0, i64 2, !dbg !4163
  %start46 = getelementptr inbounds %struct.resource, %struct.resource* %arrayidx45, i32 0, i32 0, !dbg !4163
  %26 = load i64, i64* %start46, align 8, !dbg !4163
  %27 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4164
  %mem47 = getelementptr inbounds %struct.uio_info, %struct.uio_info* %27, i32 0, i32 3, !dbg !4165
  %arrayidx48 = getelementptr [5 x %struct.uio_mem], [5 x %struct.uio_mem]* %mem47, i64 0, i64 1, !dbg !4164
  %addr49 = getelementptr inbounds %struct.uio_mem, %struct.uio_mem* %arrayidx48, i32 0, i32 1, !dbg !4166
  store i64 %26, i64* %addr49, align 8, !dbg !4167
  %28 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4168
  %resource50 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %28, i32 0, i32 44, !dbg !4168
  %arrayidx51 = getelementptr [17 x %struct.resource], [17 x %struct.resource]* %resource50, i64 0, i64 2, !dbg !4168
  %start52 = getelementptr inbounds %struct.resource, %struct.resource* %arrayidx51, i32 0, i32 0, !dbg !4168
  %29 = load i64, i64* %start52, align 8, !dbg !4168
  %cmp53 = icmp eq i64 %29, 0, !dbg !4168
  br i1 %cmp53, label %land.lhs.true54, label %cond.false63, !dbg !4168

land.lhs.true54:                                  ; preds = %cond.end
  %30 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4168
  %resource55 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %30, i32 0, i32 44, !dbg !4168
  %arrayidx56 = getelementptr [17 x %struct.resource], [17 x %struct.resource]* %resource55, i64 0, i64 2, !dbg !4168
  %end57 = getelementptr inbounds %struct.resource, %struct.resource* %arrayidx56, i32 0, i32 1, !dbg !4168
  %31 = load i64, i64* %end57, align 8, !dbg !4168
  %32 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4168
  %resource58 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %32, i32 0, i32 44, !dbg !4168
  %arrayidx59 = getelementptr [17 x %struct.resource], [17 x %struct.resource]* %resource58, i64 0, i64 2, !dbg !4168
  %start60 = getelementptr inbounds %struct.resource, %struct.resource* %arrayidx59, i32 0, i32 0, !dbg !4168
  %33 = load i64, i64* %start60, align 8, !dbg !4168
  %cmp61 = icmp eq i64 %31, %33, !dbg !4168
  br i1 %cmp61, label %cond.true62, label %cond.false63, !dbg !4168

cond.true62:                                      ; preds = %land.lhs.true54
  br label %cond.end72, !dbg !4168

cond.false63:                                     ; preds = %land.lhs.true54, %cond.end
  %34 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4168
  %resource64 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %34, i32 0, i32 44, !dbg !4168
  %arrayidx65 = getelementptr [17 x %struct.resource], [17 x %struct.resource]* %resource64, i64 0, i64 2, !dbg !4168
  %end66 = getelementptr inbounds %struct.resource, %struct.resource* %arrayidx65, i32 0, i32 1, !dbg !4168
  %35 = load i64, i64* %end66, align 8, !dbg !4168
  %36 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4168
  %resource67 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %36, i32 0, i32 44, !dbg !4168
  %arrayidx68 = getelementptr [17 x %struct.resource], [17 x %struct.resource]* %resource67, i64 0, i64 2, !dbg !4168
  %start69 = getelementptr inbounds %struct.resource, %struct.resource* %arrayidx68, i32 0, i32 0, !dbg !4168
  %37 = load i64, i64* %start69, align 8, !dbg !4168
  %sub70 = sub i64 %35, %37, !dbg !4168
  %add71 = add i64 %sub70, 1, !dbg !4168
  br label %cond.end72, !dbg !4168

cond.end72:                                       ; preds = %cond.false63, %cond.true62
  %cond73 = phi i64 [ 0, %cond.true62 ], [ %add71, %cond.false63 ], !dbg !4168
  %38 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4169
  %mem74 = getelementptr inbounds %struct.uio_info, %struct.uio_info* %38, i32 0, i32 3, !dbg !4170
  %arrayidx75 = getelementptr [5 x %struct.uio_mem], [5 x %struct.uio_mem]* %mem74, i64 0, i64 1, !dbg !4169
  %size76 = getelementptr inbounds %struct.uio_mem, %struct.uio_mem* %arrayidx75, i32 0, i32 3, !dbg !4171
  store i64 %cond73, i64* %size76, align 8, !dbg !4172
  %39 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4173
  %mem77 = getelementptr inbounds %struct.uio_info, %struct.uio_info* %39, i32 0, i32 3, !dbg !4174
  %arrayidx78 = getelementptr [5 x %struct.uio_mem], [5 x %struct.uio_mem]* %mem77, i64 0, i64 1, !dbg !4173
  %memtype79 = getelementptr inbounds %struct.uio_mem, %struct.uio_mem* %arrayidx78, i32 0, i32 4, !dbg !4175
  store i32 1, i32* %memtype79, align 8, !dbg !4176
  %40 = load %struct.pci_device_id*, %struct.pci_device_id** %id.addr, align 8, !dbg !4177
  %subdevice = getelementptr inbounds %struct.pci_device_id, %struct.pci_device_id* %40, i32 0, i32 3, !dbg !4178
  %41 = load i32, i32* %subdevice, align 4, !dbg !4178
  switch i32 %41, label %sw.default [
    i32 1072, label %sw.bb
    i32 1074, label %sw.bb80
  ], !dbg !4179

sw.bb:                                            ; preds = %cond.end72
  %42 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4180
  %name = getelementptr inbounds %struct.uio_info, %struct.uio_info* %42, i32 0, i32 1, !dbg !4182
  store i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.2, i64 0, i64 0), i8** %name, align 8, !dbg !4183
  br label %sw.epilog, !dbg !4184

sw.bb80:                                          ; preds = %cond.end72
  %43 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4185
  %name81 = getelementptr inbounds %struct.uio_info, %struct.uio_info* %43, i32 0, i32 1, !dbg !4186
  store i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.3, i64 0, i64 0), i8** %name81, align 8, !dbg !4187
  br label %sw.epilog, !dbg !4188

sw.default:                                       ; preds = %cond.end72
  %44 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4189
  %name82 = getelementptr inbounds %struct.uio_info, %struct.uio_info* %44, i32 0, i32 1, !dbg !4190
  store i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i64 0, i64 0), i8** %name82, align 8, !dbg !4191
  br label %sw.epilog, !dbg !4192

sw.epilog:                                        ; preds = %sw.default, %sw.bb80, %sw.bb
  %45 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4193
  %version = getelementptr inbounds %struct.uio_info, %struct.uio_info* %45, i32 0, i32 2, !dbg !4194
  store i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.5, i64 0, i64 0), i8** %version, align 8, !dbg !4195
  %46 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4196
  %irq = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %46, i32 0, i32 43, !dbg !4197
  %47 = load i32, i32* %irq, align 4, !dbg !4197
  %conv = zext i32 %47 to i64, !dbg !4196
  %48 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4198
  %irq83 = getelementptr inbounds %struct.uio_info, %struct.uio_info* %48, i32 0, i32 5, !dbg !4199
  store i64 %conv, i64* %irq83, align 8, !dbg !4200
  %49 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4201
  %irq_flags = getelementptr inbounds %struct.uio_info, %struct.uio_info* %49, i32 0, i32 6, !dbg !4202
  store i64 128, i64* %irq_flags, align 8, !dbg !4203
  %50 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4204
  %handler = getelementptr inbounds %struct.uio_info, %struct.uio_info* %50, i32 0, i32 8, !dbg !4205
  store i32 (i32, %struct.uio_info*)* @hilscher_handler, i32 (i32, %struct.uio_info*)** %handler, align 8, !dbg !4206
  %51 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4207
  %dev84 = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %51, i32 0, i32 41, !dbg !4207
  %52 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4207
  %call85 = call i32 @__uio_register_device(%struct.module* null, %struct.device* %dev84, %struct.uio_info* %52) #7, !dbg !4207
  %tobool86 = icmp ne i32 %call85, 0, !dbg !4207
  br i1 %tobool86, label %if.then87, label %if.end88, !dbg !4209

if.then87:                                        ; preds = %sw.epilog
  br label %out_unmap, !dbg !4210

if.end88:                                         ; preds = %sw.epilog
  %53 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4211
  %54 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4212
  %55 = bitcast %struct.uio_info* %54 to i8*, !dbg !4212
  call void @pci_set_drvdata(%struct.pci_dev* %53, i8* %55) #7, !dbg !4213
  store i32 0, i32* %retval, align 4, !dbg !4214
  br label %return, !dbg !4214

out_unmap:                                        ; preds = %if.then87
  call void @llvm.dbg.label(metadata !4215), !dbg !4216
  %56 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4217
  %mem89 = getelementptr inbounds %struct.uio_info, %struct.uio_info* %56, i32 0, i32 3, !dbg !4218
  %arrayidx90 = getelementptr [5 x %struct.uio_mem], [5 x %struct.uio_mem]* %mem89, i64 0, i64 0, !dbg !4217
  %internal_addr91 = getelementptr inbounds %struct.uio_mem, %struct.uio_mem* %arrayidx90, i32 0, i32 5, !dbg !4219
  %57 = load i8*, i8** %internal_addr91, align 8, !dbg !4219
  call void @iounmap(i8* %57) #7, !dbg !4220
  br label %out_release, !dbg !4220

out_release:                                      ; preds = %out_unmap, %if.then23, %if.then14
  call void @llvm.dbg.label(metadata !4221), !dbg !4222
  %58 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4223
  call void @pci_release_regions(%struct.pci_dev* %58) #7, !dbg !4224
  br label %out_disable, !dbg !4224

out_disable:                                      ; preds = %out_release, %if.then7
  call void @llvm.dbg.label(metadata !4225), !dbg !4226
  %59 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4227
  call void @pci_disable_device(%struct.pci_dev* %59) #7, !dbg !4228
  br label %out_free, !dbg !4228

out_free:                                         ; preds = %out_disable, %if.then3
  call void @llvm.dbg.label(metadata !4229), !dbg !4230
  %60 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4231
  %61 = bitcast %struct.uio_info* %60 to i8*, !dbg !4231
  call void @kfree(i8* %61) #7, !dbg !4232
  store i32 -19, i32* %retval, align 4, !dbg !4233
  br label %return, !dbg !4233

return:                                           ; preds = %out_free, %if.end88, %if.then
  %62 = load i32, i32* %retval, align 4, !dbg !4234
  ret i32 %62, !dbg !4234
}

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @hilscher_pci_remove(%struct.pci_dev* %dev) #2 !dbg !4235 {
entry:
  %dev.addr = alloca %struct.pci_dev*, align 8
  %info = alloca %struct.uio_info*, align 8
  store %struct.pci_dev* %dev, %struct.pci_dev** %dev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.pci_dev** %dev.addr, metadata !4236, metadata !DIExpression()), !dbg !4237
  call void @llvm.dbg.declare(metadata %struct.uio_info** %info, metadata !4238, metadata !DIExpression()), !dbg !4239
  %0 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4240
  %call = call i8* @pci_get_drvdata(%struct.pci_dev* %0) #7, !dbg !4241
  %1 = bitcast i8* %call to %struct.uio_info*, !dbg !4241
  store %struct.uio_info* %1, %struct.uio_info** %info, align 8, !dbg !4239
  %2 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4242
  call void @uio_unregister_device(%struct.uio_info* %2) #7, !dbg !4243
  %3 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4244
  call void @pci_release_regions(%struct.pci_dev* %3) #7, !dbg !4245
  %4 = load %struct.pci_dev*, %struct.pci_dev** %dev.addr, align 8, !dbg !4246
  call void @pci_disable_device(%struct.pci_dev* %4) #7, !dbg !4247
  %5 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4248
  %mem = getelementptr inbounds %struct.uio_info, %struct.uio_info* %5, i32 0, i32 3, !dbg !4249
  %arrayidx = getelementptr [5 x %struct.uio_mem], [5 x %struct.uio_mem]* %mem, i64 0, i64 0, !dbg !4248
  %internal_addr = getelementptr inbounds %struct.uio_mem, %struct.uio_mem* %arrayidx, i32 0, i32 5, !dbg !4250
  %6 = load i8*, i8** %internal_addr, align 8, !dbg !4250
  call void @iounmap(i8* %6) #7, !dbg !4251
  %7 = load %struct.uio_info*, %struct.uio_info** %info, align 8, !dbg !4252
  %8 = bitcast %struct.uio_info* %7 to i8*, !dbg !4252
  call void @kfree(i8* %8) #7, !dbg !4253
  ret void, !dbg !4254
}
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal i8* @kzalloc(i64 %size, i32 %flags) #2 !dbg !4255 {
entry:
  %s.addr.i.i = alloca %struct.kmem_cache*, align 8
  call void @llvm.dbg.declare(metadata %struct.kmem_cache** %s.addr.i.i, metadata !4258, metadata !DIExpression()), !dbg !4262
  %flags.addr.i17.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr.i17.i, metadata !4268, metadata !DIExpression()), !dbg !4269
  %size.addr.i18.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr.i18.i, metadata !4270, metadata !DIExpression()), !dbg !4271
  %ret.i.i = alloca i8*, align 8
  call void @llvm.dbg.declare(metadata i8** %ret.i.i, metadata !4272, metadata !DIExpression()), !dbg !4273
  %retval.i12.i = alloca i32, align 4
  %flags.addr.i13.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr.i13.i, metadata !4274, metadata !DIExpression()), !dbg !4278
  %retval.i.i = alloca i32, align 4
  %size.addr.i11.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr.i11.i, metadata !4280, metadata !DIExpression()), !dbg !4284
  %size.addr.i.i.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr.i.i.i, metadata !4286, metadata !DIExpression()), !dbg !4290
  %flags.addr.i.i.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr.i.i.i, metadata !4295, metadata !DIExpression()), !dbg !4296
  %order.addr.i.i.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %order.addr.i.i.i, metadata !4297, metadata !DIExpression()), !dbg !4298
  %size.addr.i.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr.i.i, metadata !4299, metadata !DIExpression()), !dbg !4300
  %flags.addr.i.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr.i.i, metadata !4301, metadata !DIExpression()), !dbg !4302
  %order.i.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %order.i.i, metadata !4303, metadata !DIExpression()), !dbg !4304
  %retval.i = alloca i8*, align 8
  %size.addr.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr.i, metadata !4305, metadata !DIExpression()), !dbg !4306
  %flags.addr.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr.i, metadata !4307, metadata !DIExpression()), !dbg !4308
  %index.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %index.i, metadata !4309, metadata !DIExpression()), !dbg !4310
  ...
  %0 = load i64, i64* %size.addr, align 8, !dbg !4315
  %1 = load i32, i32* %flags.addr, align 4, !dbg !4316
  %or = or i32 %1, 256, !dbg !4317
  store i64 %0, i64* %size.addr.i, align 8
  store i32 %or, i32* %flags.addr.i, align 4
  %2 = load i64, i64* %size.addr.i, align 8, !dbg !4318
  %3 = call i1 @llvm.is.constant.i64(i64 %2) #8, !dbg !4319
  br i1 %3, label %if.then.i, label %if.end9.i, !dbg !4320

if.then.i:                                        ; preds = %entry
  %4 = load i64, i64* %size.addr.i, align 8, !dbg !4321
  %cmp.i = icmp ugt i64 %4, 8192, !dbg !4322
  br i1 %cmp.i, label %if.then1.i, label %if.end.i, !dbg !4323

if.then1.i:                                       ; preds = %if.then.i
  %5 = load i64, i64* %size.addr.i, align 8, !dbg !4324
  %6 = load i32, i32* %flags.addr.i, align 4, !dbg !4325
  store i64 %5, i64* %size.addr.i.i, align 8
  store i32 %6, i32* %flags.addr.i.i, align 4
  %7 = load i64, i64* %size.addr.i.i, align 8, !dbg !4326
  %call.i.i = call i32 @get_order(i64 %7) #9, !dbg !4327
  store i32 %call.i.i, i32* %order.i.i, align 4, !dbg !4304
  %8 = load i64, i64* %size.addr.i.i, align 8, !dbg !4328
  %9 = load i32, i32* %flags.addr.i.i, align 4, !dbg !4329
  %10 = load i32, i32* %order.i.i, align 4, !dbg !4330
  store i64 %8, i64* %size.addr.i.i.i, align 8
  store i32 %9, i32* %flags.addr.i.i.i, align 4
  store i32 %10, i32* %order.addr.i.i.i, align 4
  %11 = load i64, i64* %size.addr.i.i.i, align 8, !dbg !4331
  %12 = load i32, i32* %flags.addr.i.i.i, align 4, !dbg !4332
  %13 = load i32, i32* %order.addr.i.i.i, align 4, !dbg !4333
  %call.i.i.i = call noalias i8* @kmalloc_order(i64 %11, i32 %12, i32 %13) #10, !dbg !4334
  %ptrint.i.i.i = ptrtoint i8* %call.i.i.i to i64, !dbg !4334
  %maskedptr.i.i.i = and i64 %ptrint.i.i.i, 4095, !dbg !4334
  %maskcond.i.i.i = icmp eq i64 %maskedptr.i.i.i, 0, !dbg !4334
  call void @llvm.assume(i1 %maskcond.i.i.i) #8, !dbg !4334
  store i8* %call.i.i.i, i8** %retval.i, align 8, !dbg !4335
  br label %kmalloc.exit, !dbg !4335

if.end.i:                                         ; preds = %if.then.i
  %14 = load i64, i64* %size.addr.i, align 8, !dbg !4336
  store i64 %14, i64* %size.addr.i11.i, align 8
  %15 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4337
  %tobool.i.i = icmp ne i64 %15, 0, !dbg !4337
  br i1 %tobool.i.i, label %if.end.i.i, label %if.then.i.i, !dbg !4339

if.then.i.i:                                      ; preds = %if.end.i
  store i32 0, i32* %retval.i.i, align 4, !dbg !4340
  br label %kmalloc_index.exit.i, !dbg !4340

if.end.i.i:                                       ; preds = %if.end.i
  %16 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4341
  %cmp.i.i = icmp ule i64 %16, 8, !dbg !4343
  br i1 %cmp.i.i, label %if.then1.i.i, label %if.end2.i.i, !dbg !4344

if.then1.i.i:                                     ; preds = %if.end.i.i
  store i32 3, i32* %retval.i.i, align 4, !dbg !4345
  br label %kmalloc_index.exit.i, !dbg !4345

if.end2.i.i:                                      ; preds = %if.end.i.i
  %17 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4346
  %cmp3.i.i = icmp ugt i64 %17, 64, !dbg !4348
  br i1 %cmp3.i.i, label %land.lhs.true.i.i, label %if.end6.i.i, !dbg !4349

land.lhs.true.i.i:                                ; preds = %if.end2.i.i
  %18 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4350
  %cmp4.i.i = icmp ule i64 %18, 96, !dbg !4351
  br i1 %cmp4.i.i, label %if.then5.i.i, label %if.end6.i.i, !dbg !4352

if.then5.i.i:                                     ; preds = %land.lhs.true.i.i
  store i32 1, i32* %retval.i.i, align 4, !dbg !4353
  br label %kmalloc_index.exit.i, !dbg !4353

if.end6.i.i:                                      ; preds = %land.lhs.true.i.i, %if.end2.i.i
  %19 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4354
  %cmp7.i.i = icmp ugt i64 %19, 128, !dbg !4356
  br i1 %cmp7.i.i, label %land.lhs.true8.i.i, label %if.end11.i.i, !dbg !4357

land.lhs.true8.i.i:                               ; preds = %if.end6.i.i
  %20 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4358
  %cmp9.i.i = icmp ule i64 %20, 192, !dbg !4359
  br i1 %cmp9.i.i, label %if.then10.i.i, label %if.end11.i.i, !dbg !4360

if.then10.i.i:                                    ; preds = %land.lhs.true8.i.i
  store i32 2, i32* %retval.i.i, align 4, !dbg !4361
  br label %kmalloc_index.exit.i, !dbg !4361

if.end11.i.i:                                     ; preds = %land.lhs.true8.i.i, %if.end6.i.i
  %21 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4362
  %cmp12.i.i = icmp ule i64 %21, 8, !dbg !4364
  br i1 %cmp12.i.i, label %if.then13.i.i, label %if.end14.i.i, !dbg !4365
...
if.end14.i.i:                                     ; preds = %if.end11.i.i
  %22 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4367
  %cmp15.i.i = icmp ule i64 %22, 16, !dbg !4369
  br i1 %cmp15.i.i, label %if.then16.i.i, label %if.end17.i.i, !dbg !4370

if.then16.i.i:                                    ; preds = %if.end14.i.i
  store i32 4, i32* %retval.i.i, align 4, !dbg !4371
  br label %kmalloc_index.exit.i, !dbg !4371

if.end17.i.i:                                     ; preds = %if.end14.i.i
  %23 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4372
  %cmp18.i.i = icmp ule i64 %23, 32, !dbg !4374
  br i1 %cmp18.i.i, label %if.then19.i.i, label %if.end20.i.i, !dbg !4375

if.then19.i.i:                                    ; preds = %if.end17.i.i
  store i32 5, i32* %retval.i.i, align 4, !dbg !4376
  br label %kmalloc_index.exit.i, !dbg !4376

if.end20.i.i:                                     ; preds = %if.end17.i.i
  %24 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4377
  %cmp21.i.i = icmp ule i64 %24, 64, !dbg !4379
  br i1 %cmp21.i.i, label %if.then22.i.i, label %if.end23.i.i, !dbg !4380

if.then22.i.i:                                    ; preds = %if.end20.i.i
  store i32 6, i32* %retval.i.i, align 4, !dbg !4381
  br label %kmalloc_index.exit.i, !dbg !4381

if.end23.i.i:                                     ; preds = %if.end20.i.i
  %25 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4382
  %cmp24.i.i = icmp ule i64 %25, 128, !dbg !4384
  br i1 %cmp24.i.i, label %if.then25.i.i, label %if.end26.i.i, !dbg !4385

if.then25.i.i:                                    ; preds = %if.end23.i.i
  store i32 7, i32* %retval.i.i, align 4, !dbg !4386
  br label %kmalloc_index.exit.i, !dbg !4386

if.end26.i.i:                                     ; preds = %if.end23.i.i
  %26 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4387
  %cmp27.i.i = icmp ule i64 %26, 256, !dbg !4389
  br i1 %cmp27.i.i, label %if.then28.i.i, label %if.end29.i.i, !dbg !4390

if.then28.i.i:                                    ; preds = %if.end26.i.i
  store i32 8, i32* %retval.i.i, align 4, !dbg !4391
  br label %kmalloc_index.exit.i, !dbg !4391

if.end29.i.i:                                     ; preds = %if.end26.i.i
  %27 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4392
  %cmp30.i.i = icmp ule i64 %27, 512, !dbg !4394
  br i1 %cmp30.i.i, label %if.then31.i.i, label %if.end32.i.i, !dbg !4395

if.then31.i.i:                                    ; preds = %if.end29.i.i
  store i32 9, i32* %retval.i.i, align 4, !dbg !4396
  br label %kmalloc_index.exit.i, !dbg !4396

if.end32.i.i:                                     ; preds = %if.end29.i.i
  %28 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4397
  %cmp33.i.i = icmp ule i64 %28, 1024, !dbg !4399
  br i1 %cmp33.i.i, label %if.then34.i.i, label %if.end35.i.i, !dbg !4400

if.then34.i.i:                                    ; preds = %if.end32.i.i
  store i32 10, i32* %retval.i.i, align 4, !dbg !4401
  br label %kmalloc_index.exit.i, !dbg !4401

if.end35.i.i:                                     ; preds = %if.end32.i.i
  %29 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4402
  %cmp36.i.i = icmp ule i64 %29, 2048, !dbg !4404
  br i1 %cmp36.i.i, label %if.then37.i.i, label %if.end38.i.i, !dbg !4405

if.then37.i.i:                                    ; preds = %if.end35.i.i
  store i32 11, i32* %retval.i.i, align 4, !dbg !4406
  br label %kmalloc_index.exit.i, !dbg !4406

if.end38.i.i:                                     ; preds = %if.end35.i.i
  %30 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4407
  %cmp39.i.i = icmp ule i64 %30, 4096, !dbg !4409
  br i1 %cmp39.i.i, label %if.then40.i.i, label %if.end41.i.i, !dbg !4410

if.then40.i.i:                                    ; preds = %if.end38.i.i
  store i32 12, i32* %retval.i.i, align 4, !dbg !4411
  br label %kmalloc_index.exit.i, !dbg !4411

if.end41.i.i:                                     ; preds = %if.end38.i.i
  %31 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4412
  %cmp42.i.i = icmp ule i64 %31, 8192, !dbg !4414
  br i1 %cmp42.i.i, label %if.then43.i.i, label %if.end44.i.i, !dbg !4415

if.then43.i.i:                                    ; preds = %if.end41.i.i
  store i32 13, i32* %retval.i.i, align 4, !dbg !4416
  br label %kmalloc_index.exit.i, !dbg !4416

if.end44.i.i:                                     ; preds = %if.end41.i.i
  %32 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4417
  %cmp45.i.i = icmp ule i64 %32, 16384, !dbg !4419
  br i1 %cmp45.i.i, label %if.then46.i.i, label %if.end47.i.i, !dbg !4420

if.then46.i.i:                                    ; preds = %if.end44.i.i
  store i32 14, i32* %retval.i.i, align 4, !dbg !4421
  br label %kmalloc_index.exit.i, !dbg !4421

if.end47.i.i:                                     ; preds = %if.end44.i.i
  %33 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4422
  %cmp48.i.i = icmp ule i64 %33, 32768, !dbg !4424
  br i1 %cmp48.i.i, label %if.then49.i.i, label %if.end50.i.i, !dbg !4425

if.then49.i.i:                                    ; preds = %if.end47.i.i
  store i32 15, i32* %retval.i.i, align 4, !dbg !4426
  br label %kmalloc_index.exit.i, !dbg !4426

if.end50.i.i:                                     ; preds = %if.end47.i.i
  %34 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4427
  %cmp51.i.i = icmp ule i64 %34, 65536, !dbg !4429
  br i1 %cmp51.i.i, label %if.then52.i.i, label %if.end53.i.i, !dbg !4430

if.then52.i.i:                                    ; preds = %if.end50.i.i
  store i32 16, i32* %retval.i.i, align 4, !dbg !4431
  br label %kmalloc_index.exit.i, !dbg !4431

if.end53.i.i:                                     ; preds = %if.end50.i.i
  %35 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4432
  %cmp54.i.i = icmp ule i64 %35, 131072, !dbg !4434
  br i1 %cmp54.i.i, label %if.then55.i.i, label %if.end56.i.i, !dbg !4435

if.then55.i.i:                                    ; preds = %if.end53.i.i
  store i32 17, i32* %retval.i.i, align 4, !dbg !4436
  br label %kmalloc_index.exit.i, !dbg !4436

if.end56.i.i:                                     ; preds = %if.end53.i.i
  %36 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4437
  %cmp57.i.i = icmp ule i64 %36, 262144, !dbg !4439
  br i1 %cmp57.i.i, label %if.then58.i.i, label %if.end59.i.i, !dbg !4440

if.then58.i.i:                                    ; preds = %if.end56.i.i
  store i32 18, i32* %retval.i.i, align 4, !dbg !4441
  br label %kmalloc_index.exit.i, !dbg !4441

if.end59.i.i:                                     ; preds = %if.end56.i.i
  %37 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4442
  %cmp60.i.i = icmp ule i64 %37, 524288, !dbg !4444
  br i1 %cmp60.i.i, label %if.then61.i.i, label %if.end62.i.i, !dbg !4445

if.then61.i.i:                                    ; preds = %if.end59.i.i
  store i32 19, i32* %retval.i.i, align 4, !dbg !4446
  br label %kmalloc_index.exit.i, !dbg !4446

if.end62.i.i:                                     ; preds = %if.end59.i.i
  %38 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4447
  %cmp63.i.i = icmp ule i64 %38, 1048576, !dbg !4449
  br i1 %cmp63.i.i, label %if.then64.i.i, label %if.end65.i.i, !dbg !4450

if.then64.i.i:                                    ; preds = %if.end62.i.i
  store i32 20, i32* %retval.i.i, align 4, !dbg !4451
  br label %kmalloc_index.exit.i, !dbg !4451

if.end65.i.i:                                     ; preds = %if.end62.i.i
  %39 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4452
  %cmp66.i.i = icmp ule i64 %39, 2097152, !dbg !4454
  br i1 %cmp66.i.i, label %if.then67.i.i, label %if.end68.i.i, !dbg !4455

if.then67.i.i:                                    ; preds = %if.end65.i.i
  store i32 21, i32* %retval.i.i, align 4, !dbg !4456
  br label %kmalloc_index.exit.i, !dbg !4456

if.end68.i.i:                                     ; preds = %if.end65.i.i
  %40 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4457
  %cmp69.i.i = icmp ule i64 %40, 4194304, !dbg !4459
  br i1 %cmp69.i.i, label %if.then70.i.i, label %if.end71.i.i, !dbg !4460

if.then70.i.i:                                    ; preds = %if.end68.i.i
  store i32 22, i32* %retval.i.i, align 4, !dbg !4461
  br label %kmalloc_index.exit.i, !dbg !4461

if.end71.i.i:                                     ; preds = %if.end68.i.i
  %41 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4462
  %cmp72.i.i = icmp ule i64 %41, 8388608, !dbg !4464
  br i1 %cmp72.i.i, label %if.then73.i.i, label %if.end74.i.i, !dbg !4465

if.then73.i.i:                                    ; preds = %if.end71.i.i
  store i32 23, i32* %retval.i.i, align 4, !dbg !4466
  br label %kmalloc_index.exit.i, !dbg !4466

if.end74.i.i:                                     ; preds = %if.end71.i.i
  %42 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4467
  %cmp75.i.i = icmp ule i64 %42, 16777216, !dbg !4469
  br i1 %cmp75.i.i, label %if.then76.i.i, label %if.end77.i.i, !dbg !4470

if.then76.i.i:                                    ; preds = %if.end74.i.i
  store i32 24, i32* %retval.i.i, align 4, !dbg !4471
  br label %kmalloc_index.exit.i, !dbg !4471

if.end77.i.i:                                     ; preds = %if.end74.i.i
  %43 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4472
  %cmp78.i.i = icmp ule i64 %43, 33554432, !dbg !4474
  br i1 %cmp78.i.i, label %if.then79.i.i, label %if.end80.i.i, !dbg !4475

if.then79.i.i:                                    ; preds = %if.end77.i.i
  store i32 25, i32* %retval.i.i, align 4, !dbg !4476
  br label %kmalloc_index.exit.i, !dbg !4476

if.end80.i.i:                                     ; preds = %if.end77.i.i
  %44 = load i64, i64* %size.addr.i11.i, align 8, !dbg !4477
  %cmp81.i.i = icmp ule i64 %44, 67108864, !dbg !4479
  br i1 %cmp81.i.i, label %if.then82.i.i, label %if.end83.i.i, !dbg !4480

if.then82.i.i:                                    ; preds = %if.end80.i.i
  store i32 26, i32* %retval.i.i, align 4, !dbg !4481
  br label %kmalloc_index.exit.i, !dbg !4481

if.end83.i.i:                                     ; preds = %if.end80.i.i
  call void asm sideeffect "1:\09.byte 0x0f, 0x0b\0A.pushsection __bug_table,\22aw\22\0A2:\09.long 1b - 2b\09# bug_entry::bug_addr\0A\09.long ${0:c} - 2b\09# bug_entry::file\0A\09.word ${1:c}\09# bug_entry::line\0A\09.word ${2:c}\09# bug_entry::flags\0A\09.org 2b+${3:c}\0A.popsection", "i,i,i,i,~{dirflag},~{fpsr},~{flags}"(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.6, i64 0, i64 0), i32 382, i32 0, i64 12) #8, !dbg !4482, !srcloc !4485
  call void asm sideeffect "${0:c}:\0A\09.pushsection .discard.unreachable\0A\09.long ${0:c}b - .\0A\09.popsection\0A\09", "i,~{dirflag},~{fpsr},~{flags}"(i32 160) #8, !dbg !4486, !srcloc !4489
  unreachable, !dbg !4490

kmalloc_index.exit.i:                             ; preds = %if.then82.i.i, %if.then79.i.i, %if.then76.i.i, %if.then73.i.i, %if.then70.i.i, %if.then67.i.i, %if.then64.i.i, %if.then61.i.i, %if.then58.i.i, %if.then55.i.i, %if.then52.i.i, %if.then49.i.i, %if.then46.i.i, %if.then43.i.i, %if.then40.i.i, %if.then37.i.i, %if.then34.i.i, %if.then31.i.i, %if.then28.i.i, %if.then25.i.i, %if.then22.i.i, %if.then19.i.i, %if.then16.i.i, %if.then13.i.i, %if.then10.i.i, %if.then5.i.i, %if.then1.i.i, %if.then.i.i
  %45 = load i32, i32* %retval.i.i, align 4, !dbg !4491
  store i32 %45, i32* %index.i, align 4, !dbg !4492
  %46 = load i32, i32* %index.i, align 4, !dbg !4493
  %tobool.i = icmp ne i32 %46, 0, !dbg !4493
  br i1 %tobool.i, label %if.end4.i, label %if.then3.i, !dbg !4495

if.then3.i:                                       ; preds = %kmalloc_index.exit.i
  store i8* inttoptr (i64 16 to i8*), i8** %retval.i, align 8, !dbg !4496
  br label %kmalloc.exit, !dbg !4496

if.end4.i:                                        ; preds = %kmalloc_index.exit.i
  %47 = load i32, i32* %flags.addr.i, align 4, !dbg !4497
  store i32 %47, i32* %flags.addr.i13.i, align 4
  %48 = load i32, i32* %flags.addr.i13.i, align 4, !dbg !4498
  %and.i.i = and i32 %48, 17, !dbg !4498
  %cmp.i14.i = icmp eq i32 %and.i.i, 0, !dbg !4498
  %lnot.i.i = xor i1 %cmp.i14.i, true, !dbg !4498
  %lnot.ext.i.i = zext i1 %cmp.i14.i to i32, !dbg !4498
  %conv.i.i = sext i32 %lnot.ext.i.i to i64, !dbg !4498
  br i1 %cmp.i14.i, label %if.then.i15.i, label %if.end.i16.i, !dbg !4500

if.then.i15.i:                                    ; preds = %if.end4.i
  store i32 0, i32* %retval.i12.i, align 4, !dbg !4501
  br label %kmalloc_type.exit.i, !dbg !4501

if.end.i16.i:                                     ; preds = %if.end4.i
  %49 = load i32, i32* %flags.addr.i13.i, align 4, !dbg !4502
  %and2.i.i = and i32 %49, 1, !dbg !4503
  %tobool3.i.i = icmp ne i32 %and2.i.i, 0, !dbg !4502
  %50 = zext i1 %tobool3.i.i to i64, !dbg !4502
  %cond.i.i = select i1 %tobool3.i.i, i32 2, i32 1, !dbg !4502
  store i32 %cond.i.i, i32* %retval.i12.i, align 4, !dbg !4504
  br label %kmalloc_type.exit.i, !dbg !4504

kmalloc_type.exit.i:                              ; preds = %if.end.i16.i, %if.then.i15.i
  %51 = load i32, i32* %retval.i12.i, align 4, !dbg !4505
  %idxprom.i = zext i32 %51 to i64, !dbg !4506
  %arrayidx.i = getelementptr [3 x [14 x %struct.kmem_cache*]], [3 x [14 x %struct.kmem_cache*]]* @kmalloc_caches, i64 0, i64 %idxprom.i, !dbg !4506
  %52 = load i32, i32* %index.i, align 4, !dbg !4507
  %idxprom6.i = zext i32 %52 to i64, !dbg !4506
  %arrayidx7.i = getelementptr [14 x %struct.kmem_cache*], [14 x %struct.kmem_cache*]* %arrayidx.i, i64 0, i64 %idxprom6.i, !dbg !4506
  %53 = load %struct.kmem_cache*, %struct.kmem_cache** %arrayidx7.i, align 8, !dbg !4506
  %54 = load i32, i32* %flags.addr.i, align 4, !dbg !4508
  %55 = load i64, i64* %size.addr.i, align 8, !dbg !4509
  store %struct.kmem_cache* %53, %struct.kmem_cache** %s.addr.i.i, align 8
  store i32 %54, i32* %flags.addr.i17.i, align 4
  store i64 %55, i64* %size.addr.i18.i, align 8
  %56 = load %struct.kmem_cache*, %struct.kmem_cache** %s.addr.i.i, align 8, !dbg !4510
  %57 = load i32, i32* %flags.addr.i17.i, align 4, !dbg !4511
  %call.i19.i = call noalias i8* @kmem_cache_alloc(%struct.kmem_cache* %56, i32 %57) #10, !dbg !4512
  %ptrint.i.i = ptrtoint i8* %call.i19.i to i64, !dbg !4512
  %maskedptr.i.i = and i64 %ptrint.i.i, 7, !dbg !4512
  %maskcond.i.i = icmp eq i64 %maskedptr.i.i, 0, !dbg !4512
  call void @llvm.assume(i1 %maskcond.i.i) #8, !dbg !4512
  store i8* %call.i19.i, i8** %ret.i.i, align 8, !dbg !4273
  %58 = load %struct.kmem_cache*, %struct.kmem_cache** %s.addr.i.i, align 8, !dbg !4513
  %59 = load i8*, i8** %ret.i.i, align 8, !dbg !4514
  %60 = load i64, i64* %size.addr.i18.i, align 8, !dbg !4515
  %61 = load i32, i32* %flags.addr.i17.i, align 4, !dbg !4516
  %call1.i.i = call i8* @kasan_kmalloc(%struct.kmem_cache* %58, i8* %59, i64 %60, i32 %61) #10, !dbg !4517
  store i8* %call1.i.i, i8** %ret.i.i, align 8, !dbg !4518
  %62 = load i8*, i8** %ret.i.i, align 8, !dbg !4519
  store i8* %62, i8** %retval.i, align 8, !dbg !4520
  br label %kmalloc.exit, !dbg !4520

if.end9.i:                                        ; preds = %entry
  %63 = load i64, i64* %size.addr.i, align 8, !dbg !4521
  %64 = load i32, i32* %flags.addr.i, align 4, !dbg !4522
  %call10.i = call noalias i8* @__kmalloc(i64 %63, i32 %64) #10, !dbg !4523
  %ptrint.i = ptrtoint i8* %call10.i to i64, !dbg !4523
  %maskedptr.i = and i64 %ptrint.i, 7, !dbg !4523
  %maskcond.i = icmp eq i64 %maskedptr.i, 0, !dbg !4523
  call void @llvm.assume(i1 %maskcond.i) #8, !dbg !4523
  store i8* %call10.i, i8** %retval.i, align 8, !dbg !4524
  br label %kmalloc.exit, !dbg !4524

kmalloc.exit:                                     ; preds = %if.then1.i, %if.then3.i, %kmalloc_type.exit.i, %if.end9.i
  %65 = load i8*, i8** %retval.i, align 8, !dbg !4525
  ret i8* %65, !dbg !4526
}
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal i32 @hilscher_handler(i32 %irq, %struct.uio_info* %dev_info) #2 !dbg !4527 {
entry:
  %retval = alloca i32, align 4
  %irq.addr = alloca i32, align 4
  %dev_info.addr = alloca %struct.uio_info*, align 8
  %plx_intscr = alloca i8*, align 8
  store i32 %irq, i32* %irq.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %irq.addr, metadata !4528, metadata !DIExpression()), !dbg !4529
  store %struct.uio_info* %dev_info, %struct.uio_info** %dev_info.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.uio_info** %dev_info.addr, metadata !4530, metadata !DIExpression()), !dbg !4531
  call void @llvm.dbg.declare(metadata i8** %plx_intscr, metadata !4532, metadata !DIExpression()), !dbg !4533
  %0 = load %struct.uio_info*, %struct.uio_info** %dev_info.addr, align 8, !dbg !4534
  %mem = getelementptr inbounds %struct.uio_info, %struct.uio_info* %0, i32 0, i32 3, !dbg !4535
  %arrayidx = getelementptr [5 x %struct.uio_mem], [5 x %struct.uio_mem]* %mem, i64 0, i64 0, !dbg !4534
  %internal_addr = getelementptr inbounds %struct.uio_mem, %struct.uio_mem* %arrayidx, i32 0, i32 5, !dbg !4536
  %1 = load i8*, i8** %internal_addr, align 8, !dbg !4536
  %add.ptr = getelementptr i8, i8* %1, i64 76, !dbg !4537
  store i8* %add.ptr, i8** %plx_intscr, align 8, !dbg !4533
  %2 = load i8*, i8** %plx_intscr, align 8, !dbg !4538
  %call = call i32 @ioread8(i8* %2) #7, !dbg !4540
  %and = and i32 %call, 5, !dbg !4541
  %cmp = icmp ne i32 %and, 5, !dbg !4542
...
if.end:                                           ; preds = %entry
  %3 = load i8*, i8** %plx_intscr, align 8, !dbg !4545
  %call1 = call i32 @ioread8(i8* %3) #7, !dbg !4546
  %and2 = and i32 %call1, -2, !dbg !4547
  %conv = trunc i32 %and2 to i8, !dbg !4546
  %4 = load i8*, i8** %plx_intscr, align 8, !dbg !4548
  call void @iowrite8(i8 zeroext %conv, i8* %4) #7, !dbg !4549
  store i32 1, i32* %retval, align 4, !dbg !4550
  br label %return, !dbg !4550

return:                                           ; preds = %if.end, %if.then
  %5 = load i32, i32* %retval, align 4, !dbg !4551
  ret i32 %5, !dbg !4551
}
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @pci_set_drvdata(%struct.pci_dev* %pdev, i8* %data) #2 !dbg !4552 {
entry:
  %pdev.addr = alloca %struct.pci_dev*, align 8
  %data.addr = alloca i8*, align 8
  store %struct.pci_dev* %pdev, %struct.pci_dev** %pdev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.pci_dev** %pdev.addr, metadata !4555, metadata !DIExpression()), !dbg !4556
  store i8* %data, i8** %data.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %data.addr, metadata !4557, metadata !DIExpression()), !dbg !4558
  %0 = load %struct.pci_dev*, %struct.pci_dev** %pdev.addr, align 8, !dbg !4559
  %dev = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %0, i32 0, i32 41, !dbg !4560
  %1 = load i8*, i8** %data.addr, align 8, !dbg !4561
  call void @dev_set_drvdata(%struct.device* %dev, i8* %1) #7, !dbg !4562
  ret void, !dbg !4563
}
...
define internal i32 @get_order(i64 %size) #6 !dbg !4564 {
entry:
  %x.addr.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %x.addr.i, metadata !4568, metadata !DIExpression()), !dbg !4573
  %bitpos.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %bitpos.i, metadata !4575, metadata !DIExpression()), !dbg !4576
  %retval = alloca i32, align 4
  %size.addr = alloca i64, align 8
  store i64 %size, i64* %size.addr, align 8
  ...
  %1 = call i1 @llvm.is.constant.i64(i64 %0), !dbg !4581
  br i1 %1, label %if.then, label %if.end447, !dbg !4582

if.then:                                          ; preds = %entry
  %2 = load i64, i64* %size.addr, align 8, !dbg !4583
  %tobool = icmp ne i64 %2, 0, !dbg !4583
  br i1 %tobool, label %if.end, label %if.then1, !dbg !4586

if.then1:                                         ; preds = %if.then
  store i32 52, i32* %retval, align 4, !dbg !4587
  br label %return, !dbg !4587

if.end:                                           ; preds = %if.then
  %3 = load i64, i64* %size.addr, align 8, !dbg !4588
  %cmp = icmp ult i64 %3, 4096, !dbg !4590
  br i1 %cmp, label %if.then2, label %if.end3, !dbg !4591
...
if.end3:                                          ; preds = %if.end
  %4 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub = sub i64 %4, 1, !dbg !4593
  %5 = call i1 @llvm.is.constant.i64(i64 %sub), !dbg !4593
  br i1 %5, label %cond.true, label %cond.false442, !dbg !4593

cond.true:                                        ; preds = %if.end3
  %6 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub4 = sub i64 %6, 1, !dbg !4593
  %7 = call i1 @llvm.is.constant.i64(i64 %sub4), !dbg !4593
  br i1 %7, label %cond.true5, label %cond.false439, !dbg !4593

cond.true5:                                       ; preds = %cond.true
  %8 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub6 = sub i64 %8, 1, !dbg !4593
  %cmp7 = icmp ult i64 %sub6, 2, !dbg !4593
  br i1 %cmp7, label %cond.true8, label %cond.false, !dbg !4593

cond.true8:                                       ; preds = %cond.true5
  br label %cond.end437, !dbg !4593

cond.false:                                       ; preds = %cond.true5
  %9 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub9 = sub i64 %9, 1, !dbg !4593
  %and = and i64 %sub9, -9223372036854775808, !dbg !4593
  %tobool10 = icmp ne i64 %and, 0, !dbg !4593
  br i1 %tobool10, label %cond.true11, label %cond.false12, !dbg !4593

cond.true11:                                      ; preds = %cond.false
  br label %cond.end435, !dbg !4593

cond.false12:                                     ; preds = %cond.false
  %10 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub13 = sub i64 %10, 1, !dbg !4593
  %and14 = and i64 %sub13, 4611686018427387904, !dbg !4593
  %tobool15 = icmp ne i64 %and14, 0, !dbg !4593
  br i1 %tobool15, label %cond.true16, label %cond.false17, !dbg !4593

cond.true16:                                      ; preds = %cond.false12
  br label %cond.end433, !dbg !4593

cond.false17:                                     ; preds = %cond.false12
  %11 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub18 = sub i64 %11, 1, !dbg !4593
  %and19 = and i64 %sub18, 2305843009213693952, !dbg !4593
  %tobool20 = icmp ne i64 %and19, 0, !dbg !4593
  br i1 %tobool20, label %cond.true21, label %cond.false22, !dbg !4593

cond.true21:                                      ; preds = %cond.false17
  br label %cond.end431, !dbg !4593

cond.false22:                                     ; preds = %cond.false17
  %12 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub23 = sub i64 %12, 1, !dbg !4593
  %and24 = and i64 %sub23, 1152921504606846976, !dbg !4593
  %tobool25 = icmp ne i64 %and24, 0, !dbg !4593
  br i1 %tobool25, label %cond.true26, label %cond.false27, !dbg !4593

cond.true26:                                      ; preds = %cond.false22
  br label %cond.end429, !dbg !4593

cond.false27:                                     ; preds = %cond.false22
  %13 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub28 = sub i64 %13, 1, !dbg !4593
  %and29 = and i64 %sub28, 576460752303423488, !dbg !4593
  %tobool30 = icmp ne i64 %and29, 0, !dbg !4593
  br i1 %tobool30, label %cond.true31, label %cond.false32, !dbg !4593

cond.true31:                                      ; preds = %cond.false27
  br label %cond.end427, !dbg !4593

cond.false32:                                     ; preds = %cond.false27
  %14 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub33 = sub i64 %14, 1, !dbg !4593
  %and34 = and i64 %sub33, 288230376151711744, !dbg !4593
  %tobool35 = icmp ne i64 %and34, 0, !dbg !4593
  br i1 %tobool35, label %cond.true36, label %cond.false37, !dbg !4593

cond.true36:                                      ; preds = %cond.false32
  br label %cond.end425, !dbg !4593

cond.false37:                                     ; preds = %cond.false32
  %15 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub38 = sub i64 %15, 1, !dbg !4593
  %and39 = and i64 %sub38, 144115188075855872, !dbg !4593
  %tobool40 = icmp ne i64 %and39, 0, !dbg !4593
  br i1 %tobool40, label %cond.true41, label %cond.false42, !dbg !4593

cond.true41:                                      ; preds = %cond.false37
  br label %cond.end423, !dbg !4593

cond.false42:                                     ; preds = %cond.false37
  %16 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub43 = sub i64 %16, 1, !dbg !4593
  %and44 = and i64 %sub43, 72057594037927936, !dbg !4593
  %tobool45 = icmp ne i64 %and44, 0, !dbg !4593
  br i1 %tobool45, label %cond.true46, label %cond.false47, !dbg !4593

cond.true46:                                      ; preds = %cond.false42
  br label %cond.end421, !dbg !4593

cond.false47:                                     ; preds = %cond.false42
  %17 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub48 = sub i64 %17, 1, !dbg !4593
  %and49 = and i64 %sub48, 36028797018963968, !dbg !4593
  %tobool50 = icmp ne i64 %and49, 0, !dbg !4593
  br i1 %tobool50, label %cond.true51, label %cond.false52, !dbg !4593

cond.true51:                                      ; preds = %cond.false47
  br label %cond.end419, !dbg !4593

cond.false52:                                     ; preds = %cond.false47
  %18 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub53 = sub i64 %18, 1, !dbg !4593
  %and54 = and i64 %sub53, 18014398509481984, !dbg !4593
  %tobool55 = icmp ne i64 %and54, 0, !dbg !4593
  br i1 %tobool55, label %cond.true56, label %cond.false57, !dbg !4593

cond.true56:                                      ; preds = %cond.false52
  br label %cond.end417, !dbg !4593

cond.false57:                                     ; preds = %cond.false52
  %19 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub58 = sub i64 %19, 1, !dbg !4593
  %and59 = and i64 %sub58, 9007199254740992, !dbg !4593
  %tobool60 = icmp ne i64 %and59, 0, !dbg !4593
  br i1 %tobool60, label %cond.true61, label %cond.false62, !dbg !4593

cond.true61:                                      ; preds = %cond.false57
  br label %cond.end415, !dbg !4593

cond.false62:                                     ; preds = %cond.false57
  %20 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub63 = sub i64 %20, 1, !dbg !4593
  %and64 = and i64 %sub63, 4503599627370496, !dbg !4593
  %tobool65 = icmp ne i64 %and64, 0, !dbg !4593
  br i1 %tobool65, label %cond.true66, label %cond.false67, !dbg !4593

cond.true66:                                      ; preds = %cond.false62
  br label %cond.end413, !dbg !4593

cond.false67:                                     ; preds = %cond.false62
  %21 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub68 = sub i64 %21, 1, !dbg !4593
  %and69 = and i64 %sub68, 2251799813685248, !dbg !4593
  %tobool70 = icmp ne i64 %and69, 0, !dbg !4593
  br i1 %tobool70, label %cond.true71, label %cond.false72, !dbg !4593

cond.true71:                                      ; preds = %cond.false67
  br label %cond.end411, !dbg !4593

cond.false72:                                     ; preds = %cond.false67
  %22 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub73 = sub i64 %22, 1, !dbg !4593
  %and74 = and i64 %sub73, 1125899906842624, !dbg !4593
  %tobool75 = icmp ne i64 %and74, 0, !dbg !4593
  br i1 %tobool75, label %cond.true76, label %cond.false77, !dbg !4593

cond.true76:                                      ; preds = %cond.false72
  br label %cond.end409, !dbg !4593

cond.false77:                                     ; preds = %cond.false72
  %23 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub78 = sub i64 %23, 1, !dbg !4593
  %and79 = and i64 %sub78, 562949953421312, !dbg !4593
  %tobool80 = icmp ne i64 %and79, 0, !dbg !4593
  br i1 %tobool80, label %cond.true81, label %cond.false82, !dbg !4593

cond.true81:                                      ; preds = %cond.false77
  br label %cond.end407, !dbg !4593

cond.false82:                                     ; preds = %cond.false77
  %24 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub83 = sub i64 %24, 1, !dbg !4593
  %and84 = and i64 %sub83, 281474976710656, !dbg !4593
  %tobool85 = icmp ne i64 %and84, 0, !dbg !4593
  br i1 %tobool85, label %cond.true86, label %cond.false87, !dbg !4593

cond.true86:                                      ; preds = %cond.false82
  br label %cond.end405, !dbg !4593

cond.false87:                                     ; preds = %cond.false82
  %25 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub88 = sub i64 %25, 1, !dbg !4593
  %and89 = and i64 %sub88, 140737488355328, !dbg !4593
  %tobool90 = icmp ne i64 %and89, 0, !dbg !4593
  br i1 %tobool90, label %cond.true91, label %cond.false92, !dbg !4593

cond.true91:                                      ; preds = %cond.false87
  br label %cond.end403, !dbg !4593

cond.false92:                                     ; preds = %cond.false87
  %26 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub93 = sub i64 %26, 1, !dbg !4593
  %and94 = and i64 %sub93, 70368744177664, !dbg !4593
  %tobool95 = icmp ne i64 %and94, 0, !dbg !4593
  br i1 %tobool95, label %cond.true96, label %cond.false97, !dbg !4593

cond.true96:                                      ; preds = %cond.false92
  br label %cond.end401, !dbg !4593

cond.false97:                                     ; preds = %cond.false92
  %27 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub98 = sub i64 %27, 1, !dbg !4593
  %and99 = and i64 %sub98, 35184372088832, !dbg !4593
  %tobool100 = icmp ne i64 %and99, 0, !dbg !4593
  br i1 %tobool100, label %cond.true101, label %cond.false102, !dbg !4593

cond.true101:                                     ; preds = %cond.false97
  br label %cond.end399, !dbg !4593

cond.false102:                                    ; preds = %cond.false97
  %28 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub103 = sub i64 %28, 1, !dbg !4593
  %and104 = and i64 %sub103, 17592186044416, !dbg !4593
  %tobool105 = icmp ne i64 %and104, 0, !dbg !4593
  br i1 %tobool105, label %cond.true106, label %cond.false107, !dbg !4593

cond.true106:                                     ; preds = %cond.false102
  br label %cond.end397, !dbg !4593

cond.false107:                                    ; preds = %cond.false102
  %29 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub108 = sub i64 %29, 1, !dbg !4593
  %and109 = and i64 %sub108, 8796093022208, !dbg !4593
  %tobool110 = icmp ne i64 %and109, 0, !dbg !4593
  br i1 %tobool110, label %cond.true111, label %cond.false112, !dbg !4593

cond.true111:                                     ; preds = %cond.false107
  br label %cond.end395, !dbg !4593

cond.false112:                                    ; preds = %cond.false107
  %30 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub113 = sub i64 %30, 1, !dbg !4593
  %and114 = and i64 %sub113, 4398046511104, !dbg !4593
  %tobool115 = icmp ne i64 %and114, 0, !dbg !4593
  br i1 %tobool115, label %cond.true116, label %cond.false117, !dbg !4593

cond.true116:                                     ; preds = %cond.false112
  br label %cond.end393, !dbg !4593

cond.false117:                                    ; preds = %cond.false112
  %31 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub118 = sub i64 %31, 1, !dbg !4593
  %and119 = and i64 %sub118, 2199023255552, !dbg !4593
  %tobool120 = icmp ne i64 %and119, 0, !dbg !4593
  br i1 %tobool120, label %cond.true121, label %cond.false122, !dbg !4593

cond.true121:                                     ; preds = %cond.false117
  br label %cond.end391, !dbg !4593

cond.false122:                                    ; preds = %cond.false117
  %32 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub123 = sub i64 %32, 1, !dbg !4593
  %and124 = and i64 %sub123, 1099511627776, !dbg !4593
  %tobool125 = icmp ne i64 %and124, 0, !dbg !4593
  br i1 %tobool125, label %cond.true126, label %cond.false127, !dbg !4593

cond.true126:                                     ; preds = %cond.false122
  br label %cond.end389, !dbg !4593

cond.false127:                                    ; preds = %cond.false122
  %33 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub128 = sub i64 %33, 1, !dbg !4593
  %and129 = and i64 %sub128, 549755813888, !dbg !4593
  %tobool130 = icmp ne i64 %and129, 0, !dbg !4593
  br i1 %tobool130, label %cond.true131, label %cond.false132, !dbg !4593

cond.true131:                                     ; preds = %cond.false127
  br label %cond.end387, !dbg !4593

cond.false132:                                    ; preds = %cond.false127
  %34 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub133 = sub i64 %34, 1, !dbg !4593
  %and134 = and i64 %sub133, 274877906944, !dbg !4593
  %tobool135 = icmp ne i64 %and134, 0, !dbg !4593
  br i1 %tobool135, label %cond.true136, label %cond.false137, !dbg !4593

cond.true136:                                     ; preds = %cond.false132
  br label %cond.end385, !dbg !4593

cond.false137:                                    ; preds = %cond.false132
  %35 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub138 = sub i64 %35, 1, !dbg !4593
  %and139 = and i64 %sub138, 137438953472, !dbg !4593
  %tobool140 = icmp ne i64 %and139, 0, !dbg !4593
  br i1 %tobool140, label %cond.true141, label %cond.false142, !dbg !4593

cond.true141:                                     ; preds = %cond.false137
  br label %cond.end383, !dbg !4593

cond.false142:                                    ; preds = %cond.false137
  %36 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub143 = sub i64 %36, 1, !dbg !4593
  %and144 = and i64 %sub143, 68719476736, !dbg !4593
  %tobool145 = icmp ne i64 %and144, 0, !dbg !4593
  br i1 %tobool145, label %cond.true146, label %cond.false147, !dbg !4593

cond.true146:                                     ; preds = %cond.false142
  br label %cond.end381, !dbg !4593

cond.false147:                                    ; preds = %cond.false142
  %37 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub148 = sub i64 %37, 1, !dbg !4593
  %and149 = and i64 %sub148, 34359738368, !dbg !4593
  %tobool150 = icmp ne i64 %and149, 0, !dbg !4593
  br i1 %tobool150, label %cond.true151, label %cond.false152, !dbg !4593

cond.true151:                                     ; preds = %cond.false147
  br label %cond.end379, !dbg !4593

cond.false152:                                    ; preds = %cond.false147
  %38 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub153 = sub i64 %38, 1, !dbg !4593
  %and154 = and i64 %sub153, 17179869184, !dbg !4593
  %tobool155 = icmp ne i64 %and154, 0, !dbg !4593
  br i1 %tobool155, label %cond.true156, label %cond.false157, !dbg !4593

cond.true156:                                     ; preds = %cond.false152
  br label %cond.end377, !dbg !4593

cond.false157:                                    ; preds = %cond.false152
  %39 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub158 = sub i64 %39, 1, !dbg !4593
  %and159 = and i64 %sub158, 8589934592, !dbg !4593
  %tobool160 = icmp ne i64 %and159, 0, !dbg !4593
  br i1 %tobool160, label %cond.true161, label %cond.false162, !dbg !4593

cond.true161:                                     ; preds = %cond.false157
  br label %cond.end375, !dbg !4593

cond.false162:                                    ; preds = %cond.false157
  %40 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub163 = sub i64 %40, 1, !dbg !4593
  %and164 = and i64 %sub163, 4294967296, !dbg !4593
  %tobool165 = icmp ne i64 %and164, 0, !dbg !4593
  br i1 %tobool165, label %cond.true166, label %cond.false167, !dbg !4593

cond.true166:                                     ; preds = %cond.false162
  br label %cond.end373, !dbg !4593

cond.false167:                                    ; preds = %cond.false162
  %41 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub168 = sub i64 %41, 1, !dbg !4593
  %and169 = and i64 %sub168, 2147483648, !dbg !4593
  %tobool170 = icmp ne i64 %and169, 0, !dbg !4593
  br i1 %tobool170, label %cond.true171, label %cond.false172, !dbg !4593

cond.true171:                                     ; preds = %cond.false167
  br label %cond.end371, !dbg !4593

cond.false172:                                    ; preds = %cond.false167
  %42 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub173 = sub i64 %42, 1, !dbg !4593
  %and174 = and i64 %sub173, 1073741824, !dbg !4593
  %tobool175 = icmp ne i64 %and174, 0, !dbg !4593
  br i1 %tobool175, label %cond.true176, label %cond.false177, !dbg !4593

cond.true176:                                     ; preds = %cond.false172
  br label %cond.end369, !dbg !4593

cond.false177:                                    ; preds = %cond.false172
  %43 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub178 = sub i64 %43, 1, !dbg !4593
  %and179 = and i64 %sub178, 536870912, !dbg !4593
  %tobool180 = icmp ne i64 %and179, 0, !dbg !4593
  br i1 %tobool180, label %cond.true181, label %cond.false182, !dbg !4593

cond.true181:                                     ; preds = %cond.false177
  br label %cond.end367, !dbg !4593

cond.false182:                                    ; preds = %cond.false177
  %44 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub183 = sub i64 %44, 1, !dbg !4593
  %and184 = and i64 %sub183, 268435456, !dbg !4593
  %tobool185 = icmp ne i64 %and184, 0, !dbg !4593
  br i1 %tobool185, label %cond.true186, label %cond.false187, !dbg !4593

cond.true186:                                     ; preds = %cond.false182
  br label %cond.end365, !dbg !4593

cond.false187:                                    ; preds = %cond.false182
  %45 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub188 = sub i64 %45, 1, !dbg !4593
  %and189 = and i64 %sub188, 134217728, !dbg !4593
  %tobool190 = icmp ne i64 %and189, 0, !dbg !4593
  br i1 %tobool190, label %cond.true191, label %cond.false192, !dbg !4593

cond.true191:                                     ; preds = %cond.false187
  br label %cond.end363, !dbg !4593

cond.false192:                                    ; preds = %cond.false187
  %46 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub193 = sub i64 %46, 1, !dbg !4593
  %and194 = and i64 %sub193, 67108864, !dbg !4593
  %tobool195 = icmp ne i64 %and194, 0, !dbg !4593
  br i1 %tobool195, label %cond.true196, label %cond.false197, !dbg !4593

cond.true196:                                     ; preds = %cond.false192
  br label %cond.end361, !dbg !4593

cond.false197:                                    ; preds = %cond.false192
  %47 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub198 = sub i64 %47, 1, !dbg !4593
  %and199 = and i64 %sub198, 33554432, !dbg !4593
  %tobool200 = icmp ne i64 %and199, 0, !dbg !4593
  br i1 %tobool200, label %cond.true201, label %cond.false202, !dbg !4593

cond.true201:                                     ; preds = %cond.false197
  br label %cond.end359, !dbg !4593

cond.false202:                                    ; preds = %cond.false197
  %48 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub203 = sub i64 %48, 1, !dbg !4593
  %and204 = and i64 %sub203, 16777216, !dbg !4593
  %tobool205 = icmp ne i64 %and204, 0, !dbg !4593
  br i1 %tobool205, label %cond.true206, label %cond.false207, !dbg !4593

cond.true206:                                     ; preds = %cond.false202
  br label %cond.end357, !dbg !4593

cond.false207:                                    ; preds = %cond.false202
  %49 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub208 = sub i64 %49, 1, !dbg !4593
  %and209 = and i64 %sub208, 8388608, !dbg !4593
  %tobool210 = icmp ne i64 %and209, 0, !dbg !4593
  br i1 %tobool210, label %cond.true211, label %cond.false212, !dbg !4593

cond.true211:                                     ; preds = %cond.false207
  br label %cond.end355, !dbg !4593

cond.false212:                                    ; preds = %cond.false207
  %50 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub213 = sub i64 %50, 1, !dbg !4593
  %and214 = and i64 %sub213, 4194304, !dbg !4593
  %tobool215 = icmp ne i64 %and214, 0, !dbg !4593
  br i1 %tobool215, label %cond.true216, label %cond.false217, !dbg !4593

cond.true216:                                     ; preds = %cond.false212
  br label %cond.end353, !dbg !4593

cond.false217:                                    ; preds = %cond.false212
  %51 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub218 = sub i64 %51, 1, !dbg !4593
  %and219 = and i64 %sub218, 2097152, !dbg !4593
  %tobool220 = icmp ne i64 %and219, 0, !dbg !4593
  br i1 %tobool220, label %cond.true221, label %cond.false222, !dbg !4593

cond.true221:                                     ; preds = %cond.false217
  br label %cond.end351, !dbg !4593

cond.false222:                                    ; preds = %cond.false217
  %52 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub223 = sub i64 %52, 1, !dbg !4593
  %and224 = and i64 %sub223, 1048576, !dbg !4593
  %tobool225 = icmp ne i64 %and224, 0, !dbg !4593
  br i1 %tobool225, label %cond.true226, label %cond.false227, !dbg !4593

cond.true226:                                     ; preds = %cond.false222
  br label %cond.end349, !dbg !4593

cond.false227:                                    ; preds = %cond.false222
  %53 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub228 = sub i64 %53, 1, !dbg !4593
  %and229 = and i64 %sub228, 524288, !dbg !4593
  %tobool230 = icmp ne i64 %and229, 0, !dbg !4593
  br i1 %tobool230, label %cond.true231, label %cond.false232, !dbg !4593

cond.true231:                                     ; preds = %cond.false227
  br label %cond.end347, !dbg !4593

cond.false232:                                    ; preds = %cond.false227
  %54 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub233 = sub i64 %54, 1, !dbg !4593
  %and234 = and i64 %sub233, 262144, !dbg !4593
  %tobool235 = icmp ne i64 %and234, 0, !dbg !4593
  br i1 %tobool235, label %cond.true236, label %cond.false237, !dbg !4593

cond.true236:                                     ; preds = %cond.false232
  br label %cond.end345, !dbg !4593

cond.false237:                                    ; preds = %cond.false232
  %55 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub238 = sub i64 %55, 1, !dbg !4593
  %and239 = and i64 %sub238, 131072, !dbg !4593
  %tobool240 = icmp ne i64 %and239, 0, !dbg !4593
  br i1 %tobool240, label %cond.true241, label %cond.false242, !dbg !4593

cond.true241:                                     ; preds = %cond.false237
  br label %cond.end343, !dbg !4593

cond.false242:                                    ; preds = %cond.false237
  %56 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub243 = sub i64 %56, 1, !dbg !4593
  %and244 = and i64 %sub243, 65536, !dbg !4593
  %tobool245 = icmp ne i64 %and244, 0, !dbg !4593
  br i1 %tobool245, label %cond.true246, label %cond.false247, !dbg !4593

cond.true246:                                     ; preds = %cond.false242
  br label %cond.end341, !dbg !4593

cond.false247:                                    ; preds = %cond.false242
  %57 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub248 = sub i64 %57, 1, !dbg !4593
  %and249 = and i64 %sub248, 32768, !dbg !4593
  %tobool250 = icmp ne i64 %and249, 0, !dbg !4593
  br i1 %tobool250, label %cond.true251, label %cond.false252, !dbg !4593

cond.true251:                                     ; preds = %cond.false247
  br label %cond.end339, !dbg !4593

cond.false252:                                    ; preds = %cond.false247
  %58 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub253 = sub i64 %58, 1, !dbg !4593
  %and254 = and i64 %sub253, 16384, !dbg !4593
  %tobool255 = icmp ne i64 %and254, 0, !dbg !4593
  br i1 %tobool255, label %cond.true256, label %cond.false257, !dbg !4593

cond.true256:                                     ; preds = %cond.false252
  br label %cond.end337, !dbg !4593

cond.false257:                                    ; preds = %cond.false252
  %59 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub258 = sub i64 %59, 1, !dbg !4593
  %and259 = and i64 %sub258, 8192, !dbg !4593
  %tobool260 = icmp ne i64 %and259, 0, !dbg !4593
  br i1 %tobool260, label %cond.true261, label %cond.false262, !dbg !4593

cond.true261:                                     ; preds = %cond.false257
  br label %cond.end335, !dbg !4593

cond.false262:                                    ; preds = %cond.false257
  %60 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub263 = sub i64 %60, 1, !dbg !4593
  %and264 = and i64 %sub263, 4096, !dbg !4593
  %tobool265 = icmp ne i64 %and264, 0, !dbg !4593
  br i1 %tobool265, label %cond.true266, label %cond.false267, !dbg !4593

cond.true266:                                     ; preds = %cond.false262
  br label %cond.end333, !dbg !4593

cond.false267:                                    ; preds = %cond.false262
  %61 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub268 = sub i64 %61, 1, !dbg !4593
  %and269 = and i64 %sub268, 2048, !dbg !4593
  %tobool270 = icmp ne i64 %and269, 0, !dbg !4593
  br i1 %tobool270, label %cond.true271, label %cond.false272, !dbg !4593

cond.true271:                                     ; preds = %cond.false267
  br label %cond.end331, !dbg !4593

cond.false272:                                    ; preds = %cond.false267
  %62 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub273 = sub i64 %62, 1, !dbg !4593
  %and274 = and i64 %sub273, 1024, !dbg !4593
  %tobool275 = icmp ne i64 %and274, 0, !dbg !4593
  br i1 %tobool275, label %cond.true276, label %cond.false277, !dbg !4593

cond.true276:                                     ; preds = %cond.false272
  br label %cond.end329, !dbg !4593

cond.false277:                                    ; preds = %cond.false272
  %63 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub278 = sub i64 %63, 1, !dbg !4593
  %and279 = and i64 %sub278, 512, !dbg !4593
  %tobool280 = icmp ne i64 %and279, 0, !dbg !4593
  br i1 %tobool280, label %cond.true281, label %cond.false282, !dbg !4593

cond.true281:                                     ; preds = %cond.false277
  br label %cond.end327, !dbg !4593

cond.false282:                                    ; preds = %cond.false277
  %64 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub283 = sub i64 %64, 1, !dbg !4593
  %and284 = and i64 %sub283, 256, !dbg !4593
  %tobool285 = icmp ne i64 %and284, 0, !dbg !4593
  br i1 %tobool285, label %cond.true286, label %cond.false287, !dbg !4593

cond.true286:                                     ; preds = %cond.false282
  br label %cond.end325, !dbg !4593

cond.false287:                                    ; preds = %cond.false282
  %65 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub288 = sub i64 %65, 1, !dbg !4593
  %and289 = and i64 %sub288, 128, !dbg !4593
  %tobool290 = icmp ne i64 %and289, 0, !dbg !4593
  br i1 %tobool290, label %cond.true291, label %cond.false292, !dbg !4593

cond.true291:                                     ; preds = %cond.false287
  br label %cond.end323, !dbg !4593

cond.false292:                                    ; preds = %cond.false287
  %66 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub293 = sub i64 %66, 1, !dbg !4593
  %and294 = and i64 %sub293, 64, !dbg !4593
  %tobool295 = icmp ne i64 %and294, 0, !dbg !4593
  br i1 %tobool295, label %cond.true296, label %cond.false297, !dbg !4593

cond.true296:                                     ; preds = %cond.false292
  br label %cond.end321, !dbg !4593

cond.false297:                                    ; preds = %cond.false292
  %67 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub298 = sub i64 %67, 1, !dbg !4593
  %and299 = and i64 %sub298, 32, !dbg !4593
  %tobool300 = icmp ne i64 %and299, 0, !dbg !4593
  br i1 %tobool300, label %cond.true301, label %cond.false302, !dbg !4593

cond.true301:                                     ; preds = %cond.false297
  br label %cond.end319, !dbg !4593

cond.false302:                                    ; preds = %cond.false297
  %68 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub303 = sub i64 %68, 1, !dbg !4593
  %and304 = and i64 %sub303, 16, !dbg !4593
  %tobool305 = icmp ne i64 %and304, 0, !dbg !4593
  br i1 %tobool305, label %cond.true306, label %cond.false307, !dbg !4593

cond.true306:                                     ; preds = %cond.false302
  br label %cond.end317, !dbg !4593

cond.false307:                                    ; preds = %cond.false302
  %69 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub308 = sub i64 %69, 1, !dbg !4593
  %and309 = and i64 %sub308, 8, !dbg !4593
  %tobool310 = icmp ne i64 %and309, 0, !dbg !4593
  br i1 %tobool310, label %cond.true311, label %cond.false312, !dbg !4593

cond.true311:                                     ; preds = %cond.false307
  br label %cond.end, !dbg !4593

cond.false312:                                    ; preds = %cond.false307
  %70 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub313 = sub i64 %70, 1, !dbg !4593
  %and314 = and i64 %sub313, 4, !dbg !4593
  %tobool315 = icmp ne i64 %and314, 0, !dbg !4593
  %71 = zext i1 %tobool315 to i64, !dbg !4593
  %cond = select i1 %tobool315, i32 2, i32 1, !dbg !4593
  br label %cond.end, !dbg !4593

cond.end:                                         ; preds = %cond.false312, %cond.true311
  %cond316 = phi i32 [ 3, %cond.true311 ], [ %cond, %cond.false312 ], !dbg !4593
  br label %cond.end317, !dbg !4593

cond.end317:                                      ; preds = %cond.end, %cond.true306
  %cond318 = phi i32 [ 4, %cond.true306 ], [ %cond316, %cond.end ], !dbg !4593
  br label %cond.end319, !dbg !4593

cond.end319:                                      ; preds = %cond.end317, %cond.true301
  %cond320 = phi i32 [ 5, %cond.true301 ], [ %cond318, %cond.end317 ], !dbg !4593
  br label %cond.end321, !dbg !4593

cond.end321:                                      ; preds = %cond.end319, %cond.true296
  %cond322 = phi i32 [ 6, %cond.true296 ], [ %cond320, %cond.end319 ], !dbg !4593
  br label %cond.end323, !dbg !4593

cond.end323:                                      ; preds = %cond.end321, %cond.true291
  %cond324 = phi i32 [ 7, %cond.true291 ], [ %cond322, %cond.end321 ], !dbg !4593
  br label %cond.end325, !dbg !4593

cond.end325:                                      ; preds = %cond.end323, %cond.true286
  %cond326 = phi i32 [ 8, %cond.true286 ], [ %cond324, %cond.end323 ], !dbg !4593
  br label %cond.end327, !dbg !4593

cond.end327:                                      ; preds = %cond.end325, %cond.true281
  %cond328 = phi i32 [ 9, %cond.true281 ], [ %cond326, %cond.end325 ], !dbg !4593
  br label %cond.end329, !dbg !4593

cond.end329:                                      ; preds = %cond.end327, %cond.true276
  %cond330 = phi i32 [ 10, %cond.true276 ], [ %cond328, %cond.end327 ], !dbg !4593
  br label %cond.end331, !dbg !4593

cond.end331:                                      ; preds = %cond.end329, %cond.true271
  %cond332 = phi i32 [ 11, %cond.true271 ], [ %cond330, %cond.end329 ], !dbg !4593
  br label %cond.end333, !dbg !4593

cond.end333:                                      ; preds = %cond.end331, %cond.true266
  %cond334 = phi i32 [ 12, %cond.true266 ], [ %cond332, %cond.end331 ], !dbg !4593
  br label %cond.end335, !dbg !4593

cond.end335:                                      ; preds = %cond.end333, %cond.true261
  %cond336 = phi i32 [ 13, %cond.true261 ], [ %cond334, %cond.end333 ], !dbg !4593
  br label %cond.end337, !dbg !4593

cond.end337:                                      ; preds = %cond.end335, %cond.true256
  %cond338 = phi i32 [ 14, %cond.true256 ], [ %cond336, %cond.end335 ], !dbg !4593
  br label %cond.end339, !dbg !4593

cond.end339:                                      ; preds = %cond.end337, %cond.true251
  %cond340 = phi i32 [ 15, %cond.true251 ], [ %cond338, %cond.end337 ], !dbg !4593
  br label %cond.end341, !dbg !4593

cond.end341:                                      ; preds = %cond.end339, %cond.true246
  %cond342 = phi i32 [ 16, %cond.true246 ], [ %cond340, %cond.end339 ], !dbg !4593
  br label %cond.end343, !dbg !4593

cond.end343:                                      ; preds = %cond.end341, %cond.true241
  %cond344 = phi i32 [ 17, %cond.true241 ], [ %cond342, %cond.end341 ], !dbg !4593
  br label %cond.end345, !dbg !4593

cond.end345:                                      ; preds = %cond.end343, %cond.true236
  %cond346 = phi i32 [ 18, %cond.true236 ], [ %cond344, %cond.end343 ], !dbg !4593
  br label %cond.end347, !dbg !4593

cond.end347:                                      ; preds = %cond.end345, %cond.true231
  %cond348 = phi i32 [ 19, %cond.true231 ], [ %cond346, %cond.end345 ], !dbg !4593
  br label %cond.end349, !dbg !4593

cond.end349:                                      ; preds = %cond.end347, %cond.true226
  %cond350 = phi i32 [ 20, %cond.true226 ], [ %cond348, %cond.end347 ], !dbg !4593
  br label %cond.end351, !dbg !4593

cond.end351:                                      ; preds = %cond.end349, %cond.true221
  %cond352 = phi i32 [ 21, %cond.true221 ], [ %cond350, %cond.end349 ], !dbg !4593
  br label %cond.end353, !dbg !4593

cond.end353:                                      ; preds = %cond.end351, %cond.true216
  %cond354 = phi i32 [ 22, %cond.true216 ], [ %cond352, %cond.end351 ], !dbg !4593
  br label %cond.end355, !dbg !4593

cond.end355:                                      ; preds = %cond.end353, %cond.true211
  %cond356 = phi i32 [ 23, %cond.true211 ], [ %cond354, %cond.end353 ], !dbg !4593
  br label %cond.end357, !dbg !4593

cond.end357:                                      ; preds = %cond.end355, %cond.true206
  %cond358 = phi i32 [ 24, %cond.true206 ], [ %cond356, %cond.end355 ], !dbg !4593
  br label %cond.end359, !dbg !4593

cond.end359:                                      ; preds = %cond.end357, %cond.true201
  %cond360 = phi i32 [ 25, %cond.true201 ], [ %cond358, %cond.end357 ], !dbg !4593
  br label %cond.end361, !dbg !4593

cond.end361:                                      ; preds = %cond.end359, %cond.true196
  %cond362 = phi i32 [ 26, %cond.true196 ], [ %cond360, %cond.end359 ], !dbg !4593
  br label %cond.end363, !dbg !4593

cond.end363:                                      ; preds = %cond.end361, %cond.true191
  %cond364 = phi i32 [ 27, %cond.true191 ], [ %cond362, %cond.end361 ], !dbg !4593
  br label %cond.end365, !dbg !4593

cond.end365:                                      ; preds = %cond.end363, %cond.true186
  %cond366 = phi i32 [ 28, %cond.true186 ], [ %cond364, %cond.end363 ], !dbg !4593
  br label %cond.end367, !dbg !4593

cond.end367:                                      ; preds = %cond.end365, %cond.true181
  %cond368 = phi i32 [ 29, %cond.true181 ], [ %cond366, %cond.end365 ], !dbg !4593
  br label %cond.end369, !dbg !4593

cond.end369:                                      ; preds = %cond.end367, %cond.true176
  %cond370 = phi i32 [ 30, %cond.true176 ], [ %cond368, %cond.end367 ], !dbg !4593
  br label %cond.end371, !dbg !4593

cond.end371:                                      ; preds = %cond.end369, %cond.true171
  %cond372 = phi i32 [ 31, %cond.true171 ], [ %cond370, %cond.end369 ], !dbg !4593
  br label %cond.end373, !dbg !4593

cond.end373:                                      ; preds = %cond.end371, %cond.true166
  %cond374 = phi i32 [ 32, %cond.true166 ], [ %cond372, %cond.end371 ], !dbg !4593
  br label %cond.end375, !dbg !4593

cond.end375:                                      ; preds = %cond.end373, %cond.true161
  %cond376 = phi i32 [ 33, %cond.true161 ], [ %cond374, %cond.end373 ], !dbg !4593
  br label %cond.end377, !dbg !4593

cond.end377:                                      ; preds = %cond.end375, %cond.true156
  %cond378 = phi i32 [ 34, %cond.true156 ], [ %cond376, %cond.end375 ], !dbg !4593
  br label %cond.end379, !dbg !4593

cond.end379:                                      ; preds = %cond.end377, %cond.true151
  %cond380 = phi i32 [ 35, %cond.true151 ], [ %cond378, %cond.end377 ], !dbg !4593
  br label %cond.end381, !dbg !4593

cond.end381:                                      ; preds = %cond.end379, %cond.true146
  %cond382 = phi i32 [ 36, %cond.true146 ], [ %cond380, %cond.end379 ], !dbg !4593
  br label %cond.end383, !dbg !4593

cond.end383:                                      ; preds = %cond.end381, %cond.true141
  %cond384 = phi i32 [ 37, %cond.true141 ], [ %cond382, %cond.end381 ], !dbg !4593
  br label %cond.end385, !dbg !4593

cond.end385:                                      ; preds = %cond.end383, %cond.true136
  %cond386 = phi i32 [ 38, %cond.true136 ], [ %cond384, %cond.end383 ], !dbg !4593
  br label %cond.end387, !dbg !4593

cond.end387:                                      ; preds = %cond.end385, %cond.true131
  %cond388 = phi i32 [ 39, %cond.true131 ], [ %cond386, %cond.end385 ], !dbg !4593
  br label %cond.end389, !dbg !4593

cond.end389:                                      ; preds = %cond.end387, %cond.true126
  %cond390 = phi i32 [ 40, %cond.true126 ], [ %cond388, %cond.end387 ], !dbg !4593
  br label %cond.end391, !dbg !4593

cond.end391:                                      ; preds = %cond.end389, %cond.true121
  %cond392 = phi i32 [ 41, %cond.true121 ], [ %cond390, %cond.end389 ], !dbg !4593
  br label %cond.end393, !dbg !4593

cond.end393:                                      ; preds = %cond.end391, %cond.true116
  %cond394 = phi i32 [ 42, %cond.true116 ], [ %cond392, %cond.end391 ], !dbg !4593
  br label %cond.end395, !dbg !4593

cond.end395:                                      ; preds = %cond.end393, %cond.true111
  %cond396 = phi i32 [ 43, %cond.true111 ], [ %cond394, %cond.end393 ], !dbg !4593
  br label %cond.end397, !dbg !4593

cond.end397:                                      ; preds = %cond.end395, %cond.true106
  %cond398 = phi i32 [ 44, %cond.true106 ], [ %cond396, %cond.end395 ], !dbg !4593
  br label %cond.end399, !dbg !4593

cond.end399:                                      ; preds = %cond.end397, %cond.true101
  %cond400 = phi i32 [ 45, %cond.true101 ], [ %cond398, %cond.end397 ], !dbg !4593
  br label %cond.end401, !dbg !4593

cond.end401:                                      ; preds = %cond.end399, %cond.true96
  %cond402 = phi i32 [ 46, %cond.true96 ], [ %cond400, %cond.end399 ], !dbg !4593
  br label %cond.end403, !dbg !4593

cond.end403:                                      ; preds = %cond.end401, %cond.true91
  %cond404 = phi i32 [ 47, %cond.true91 ], [ %cond402, %cond.end401 ], !dbg !4593
  br label %cond.end405, !dbg !4593

cond.end405:                                      ; preds = %cond.end403, %cond.true86
  %cond406 = phi i32 [ 48, %cond.true86 ], [ %cond404, %cond.end403 ], !dbg !4593
  br label %cond.end407, !dbg !4593

cond.end407:                                      ; preds = %cond.end405, %cond.true81
  %cond408 = phi i32 [ 49, %cond.true81 ], [ %cond406, %cond.end405 ], !dbg !4593
  br label %cond.end409, !dbg !4593

cond.end409:                                      ; preds = %cond.end407, %cond.true76
  %cond410 = phi i32 [ 50, %cond.true76 ], [ %cond408, %cond.end407 ], !dbg !4593
  br label %cond.end411, !dbg !4593

cond.end411:                                      ; preds = %cond.end409, %cond.true71
  %cond412 = phi i32 [ 51, %cond.true71 ], [ %cond410, %cond.end409 ], !dbg !4593
  br label %cond.end413, !dbg !4593

cond.end413:                                      ; preds = %cond.end411, %cond.true66
  %cond414 = phi i32 [ 52, %cond.true66 ], [ %cond412, %cond.end411 ], !dbg !4593
  br label %cond.end415, !dbg !4593

cond.end415:                                      ; preds = %cond.end413, %cond.true61
  %cond416 = phi i32 [ 53, %cond.true61 ], [ %cond414, %cond.end413 ], !dbg !4593
  br label %cond.end417, !dbg !4593

cond.end417:                                      ; preds = %cond.end415, %cond.true56
  %cond418 = phi i32 [ 54, %cond.true56 ], [ %cond416, %cond.end415 ], !dbg !4593
  br label %cond.end419, !dbg !4593

cond.end419:                                      ; preds = %cond.end417, %cond.true51
  %cond420 = phi i32 [ 55, %cond.true51 ], [ %cond418, %cond.end417 ], !dbg !4593
  br label %cond.end421, !dbg !4593

cond.end421:                                      ; preds = %cond.end419, %cond.true46
  %cond422 = phi i32 [ 56, %cond.true46 ], [ %cond420, %cond.end419 ], !dbg !4593
  br label %cond.end423, !dbg !4593

cond.end423:                                      ; preds = %cond.end421, %cond.true41
  %cond424 = phi i32 [ 57, %cond.true41 ], [ %cond422, %cond.end421 ], !dbg !4593
  br label %cond.end425, !dbg !4593

cond.end425:                                      ; preds = %cond.end423, %cond.true36
  %cond426 = phi i32 [ 58, %cond.true36 ], [ %cond424, %cond.end423 ], !dbg !4593
  br label %cond.end427, !dbg !4593

cond.end427:                                      ; preds = %cond.end425, %cond.true31
  %cond428 = phi i32 [ 59, %cond.true31 ], [ %cond426, %cond.end425 ], !dbg !4593
  br label %cond.end429, !dbg !4593

cond.end429:                                      ; preds = %cond.end427, %cond.true26
  %cond430 = phi i32 [ 60, %cond.true26 ], [ %cond428, %cond.end427 ], !dbg !4593
  br label %cond.end431, !dbg !4593

cond.end431:                                      ; preds = %cond.end429, %cond.true21
  %cond432 = phi i32 [ 61, %cond.true21 ], [ %cond430, %cond.end429 ], !dbg !4593
  br label %cond.end433, !dbg !4593

cond.end433:                                      ; preds = %cond.end431, %cond.true16
  %cond434 = phi i32 [ 62, %cond.true16 ], [ %cond432, %cond.end431 ], !dbg !4593
  br label %cond.end435, !dbg !4593

cond.end435:                                      ; preds = %cond.end433, %cond.true11
  %cond436 = phi i32 [ 63, %cond.true11 ], [ %cond434, %cond.end433 ], !dbg !4593
  br label %cond.end437, !dbg !4593

cond.end437:                                      ; preds = %cond.end435, %cond.true8
  %cond438 = phi i32 [ 0, %cond.true8 ], [ %cond436, %cond.end435 ], !dbg !4593
  br label %cond.end440, !dbg !4593

cond.false439:                                    ; preds = %cond.true
  br label %cond.end440, !dbg !4593

cond.end440:                                      ; preds = %cond.false439, %cond.end437
  %cond441 = phi i32 [ %cond438, %cond.end437 ], [ -1, %cond.false439 ], !dbg !4593
  br label %cond.end444, !dbg !4593

cond.false442:                                    ; preds = %if.end3
  %72 = load i64, i64* %size.addr, align 8, !dbg !4593
  %sub443 = sub i64 %72, 1, !dbg !4593
  %call = call i32 @__ilog2_u64(i64 %sub443) #9, !dbg !4593
  br label %cond.end444, !dbg !4593

cond.end444:                                      ; preds = %cond.false442, %cond.end440
  %cond445 = phi i32 [ %cond441, %cond.end440 ], [ %call, %cond.false442 ], !dbg !4593
  %sub446 = sub i32 %cond445, 12, !dbg !4594
  %add = add i32 %sub446, 1, !dbg !4595
  store i32 %add, i32* %retval, align 4, !dbg !4596
  br label %return, !dbg !4596

if.end447:                                        ; preds = %entry
  %73 = load i64, i64* %size.addr, align 8, !dbg !4597
  %dec = add i64 %73, -1, !dbg !4597
  store i64 %dec, i64* %size.addr, align 8, !dbg !4597
  %74 = load i64, i64* %size.addr, align 8, !dbg !4598
  %shr = lshr i64 %74, 12, !dbg !4598
  store i64 %shr, i64* %size.addr, align 8, !dbg !4598
  %75 = load i64, i64* %size.addr, align 8, !dbg !4599
  store i64 %75, i64* %x.addr.i, align 8
  store i32 -1, i32* %bitpos.i, align 4, !dbg !4576
  %76 = load i32, i32* %bitpos.i, align 4, !dbg !4600
  %77 = load i64, i64* %x.addr.i, align 8, !dbg !4601
  %78 = call i32 asm "bsrq $1,${0:q}", "=r,rm,0,~{dirflag},~{fpsr},~{flags}"(i64 %77, i32 %76) #11, !dbg !4600, !srcloc !4602
  store i32 %78, i32* %bitpos.i, align 4, !dbg !4600
  %79 = load i32, i32* %bitpos.i, align 4, !dbg !4603
  %add.i = add i32 %79, 1, !dbg !4604
  store i32 %add.i, i32* %retval, align 4, !dbg !4605
  br label %return, !dbg !4605

return:                                           ; preds = %if.end447, %cond.end444, %if.then2, %if.then1
  %80 = load i32, i32* %retval, align 4, !dbg !4606
  ret i32 %80, !dbg !4606
}

; Function Attrs: noinline noredzone nounwind optnone readnone sspstrong
define internal i32 @__ilog2_u64(i64 %n) #6 !dbg !4607 {
entry:
  %x.addr.i = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %x.addr.i, metadata !4568, metadata !DIExpression()), !dbg !4611
  %bitpos.i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %bitpos.i, metadata !4575, metadata !DIExpression()), !dbg !4613
  %n.addr = alloca i64, align 8
  store i64 %n, i64* %n.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %n.addr, metadata !4614, metadata !DIExpression()), !dbg !4615
  %0 = load i64, i64* %n.addr, align 8, !dbg !4616
  store i64 %0, i64* %x.addr.i, align 8
  store i32 -1, i32* %bitpos.i, align 4, !dbg !4613
  %1 = load i32, i32* %bitpos.i, align 4, !dbg !4617
  %2 = load i64, i64* %x.addr.i, align 8, !dbg !4618
  %3 = call i32 asm "bsrq $1,${0:q}", "=r,rm,0,~{dirflag},~{fpsr},~{flags}"(i64 %2, i32 %1) #11, !dbg !4617, !srcloc !4602
  store i32 %3, i32* %bitpos.i, align 4, !dbg !4617
  %4 = load i32, i32* %bitpos.i, align 4, !dbg !4619
  %add.i = add i32 %4, 1, !dbg !4620
  %sub = sub i32 %add.i, 1, !dbg !4621
  ret i32 %sub, !dbg !4622
}
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal i8* @kasan_kmalloc(%struct.kmem_cache* %s, i8* %object, i64 %size, i32 %flags) #2 !dbg !4623 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %struct.kmem_cache** %s.addr, metadata !4627, metadata !DIExpression()), !dbg !4628
  store i8* %object, i8** %object.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %object.addr, metadata !4629, metadata !DIExpression()), !dbg !4630
  store i64 %size, i64* %size.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %size.addr, metadata !4631, metadata !DIExpression()), !dbg !4632
  store i32 %flags, i32* %flags.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %flags.addr, metadata !4633, metadata !DIExpression()), !dbg !4634
  %0 = load i8*, i8** %object.addr, align 8, !dbg !4635
  ret i8* %0, !dbg !4636
}
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal void @dev_set_drvdata(%struct.device* %dev, i8* %data) #2 !dbg !4637 {
entry:
  ...
  store i8* %data, i8** %data.addr, align 8
  call void @llvm.dbg.declare(metadata i8** %data.addr, metadata !4642, metadata !DIExpression()), !dbg !4643
  %0 = load i8*, i8** %data.addr, align 8, !dbg !4644
  %1 = load %struct.device*, %struct.device** %dev.addr, align 8, !dbg !4645
  %driver_data = getelementptr inbounds %struct.device, %struct.device* %1, i32 0, i32 8, !dbg !4646
  store i8* %0, i8** %driver_data, align 8, !dbg !4647
  ret void, !dbg !4648
}

; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal i8* @pci_get_drvdata(%struct.pci_dev* %pdev) #2 !dbg !4649 {
entry:
  %pdev.addr = alloca %struct.pci_dev*, align 8
  store %struct.pci_dev* %pdev, %struct.pci_dev** %pdev.addr, align 8
  call void @llvm.dbg.declare(metadata %struct.pci_dev** %pdev.addr, metadata !4652, metadata !DIExpression()), !dbg !4653
  %0 = load %struct.pci_dev*, %struct.pci_dev** %pdev.addr, align 8, !dbg !4654
  %dev = getelementptr inbounds %struct.pci_dev, %struct.pci_dev* %0, i32 0, i32 41, !dbg !4655
  %call = call i8* @dev_get_drvdata(%struct.device* %dev) #7, !dbg !4656
  ret i8* %call, !dbg !4657
}
...
; Function Attrs: noinline noredzone nounwind optnone sspstrong
define internal i8* @dev_get_drvdata(%struct.device* %dev) #2 !dbg !4658 {
entry:
  %dev.addr = alloca %struct.device*, align 8
  store %struct.device* %dev, %struct.device** %dev.addr, align 8
  ...
  %driver_data = getelementptr inbounds %struct.device, %struct.device* %0, i32 0, i32 8, !dbg !4664
  %1 = load i8*, i8** %driver_data, align 8, !dbg !4664
  ret i8* %1, !dbg !4665
}
...
!1 = distinct !DIGlobalVariable(name: "__UNIQUE_ID___addressable_hilscher_pci_driver_init234", scope: !2, file: !3, line: 135, type: !112, isLocal: true, isDefinition: true)
...
!3 = !DIFile(filename: "drivers/uio/uio_cif.c", directory: "/home/lizy2001/genbc/linux")
...
!115 = distinct !DIGlobalVariable(name: "__exitcall_hilscher_pci_driver_exit", scope: !2, file: !3, line: 135, type: !116, isLocal: true, isDefinition: true)
...
!122 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_file235", scope: !2, file: !3, line: 137, type: !123, isLocal: true, isDefinition: true, align: 8)
...
!129 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_license236", scope: !2, file: !3, line: 137, type: !130, isLocal: true, isDefinition: true, align: 8)
!130 = !DICompositeType(tag: DW_TAG_array_type, baseType: !124, size: 184, elements: !131)
!131 = !{!132}
!132 = !DISubrange(count: 23)
!133 = !DIGlobalVariableExpression(var: !134, expr: !DIExpression())
!134 = distinct !DIGlobalVariable(name: "__UNIQUE_ID_author237", scope: !2, file: !3, line: 138, type: !135, isLocal: true, isDefinition: true, align: 8)
!135 = !DICompositeType(tag: DW_TAG_array_type, baseType: !124, size: 376, elements: !136)
!136 = !{!137}
!137 = !DISubrange(count: 47)
!138 = !DIGlobalVariableExpression(var: !139, expr: !DIExpression())
!139 = distinct !DIGlobalVariable(name: "hilscher_pci_driver", scope: !2, file: !3, line: 128, type: !140, isLocal: true, isDefinition: true)
...
!4028 = distinct !DIGlobalVariable(name: "hilscher_pci_ids", scope: !2, file: !3, line: 112, type: !4029, isLocal: true, isDefinition: true)
!4029 = !DICompositeType(tag: DW_TAG_array_type, baseType: !154, size: 768, elements: !318)
...
!4035 = distinct !DISubprogram(name: "hilscher_pci_driver_init", scope: !3, file: !3, line: 135, type: !4036, scopeLine: 135, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !290)
!4036 = !DISubroutineType(types: !4037)
!4037 = !{!172}
!4038 = !DILocation(line: 135, column: 1, scope: !4035)
!4039 = distinct !DISubprogram(name: "hilscher_pci_driver_exit", scope: !3, file: !3, line: 135, type: !119, scopeLine: 135, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !290)
!4040 = !DILocation(line: 135, column: 1, scope: !4039)
!4041 = distinct !DISubprogram(name: "hilscher_pci_probe", scope: !3, file: !3, line: 41, type: !170, scopeLine: 43, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !290)
!4042 = !DILocalVariable(name: "dev", arg: 1, scope: !4041, file: !3, line: 41, type: !173)
!4043 = !DILocation(line: 41, column: 47, scope: !4041)
!4044 = !DILocalVariable(name: "id", arg: 2, scope: !4041, file: !3, line: 42, type: !152)
!4045 = !DILocation(line: 42, column: 34, scope: !4041)
!4046 = !DILocalVariable(name: "info", scope: !4041, file: !3, line: 44, type: !4047)
...
!4113 = !{!172, !4047, !1474}
!4114 = !DILocation(line: 44, column: 19, scope: !4041)
!4115 = !DILocation(line: 46, column: 9, scope: !4041)
!4116 = !DILocation(line: 46, column: 7, scope: !4041)
!4117 = !DILocation(line: 47, column: 7, scope: !4118)
!4118 = distinct !DILexicalBlock(scope: !4041, file: !3, line: 47, column: 6)
!4119 = !DILocation(line: 47, column: 6, scope: !4041)
!4120 = !DILocation(line: 48, column: 3, scope: !4118)
!4121 = !DILocation(line: 50, column: 24, scope: !4122)
!4122 = distinct !DILexicalBlock(scope: !4041, file: !3, line: 50, column: 6)
!4123 = !DILocation(line: 50, column: 6, scope: !4122)
!4124 = !DILocation(line: 50, column: 6, scope: !4041)
!4125 = !DILocation(line: 51, column: 3, scope: !4122)
!4126 = !DILocation(line: 53, column: 26, scope: !4127)
!4127 = distinct !DILexicalBlock(scope: !4041, file: !3, line: 53, column: 6)
!4128 = !DILocation(line: 53, column: 6, scope: !4127)
!4129 = !DILocation(line: 53, column: 6, scope: !4041)
!4130 = !DILocation(line: 54, column: 3, scope: !4127)
!4131 = !DILocation(line: 56, column: 22, scope: !4041)
!4132 = !DILocation(line: 56, column: 2, scope: !4041)
!4133 = !DILocation(line: 56, column: 8, scope: !4041)
!4134 = !DILocation(line: 56, column: 15, scope: !4041)
!4135 = !DILocation(line: 56, column: 20, scope: !4041)
!4136 = !DILocation(line: 57, column: 7, scope: !4137)
!4137 = distinct !DILexicalBlock(scope: !4041, file: !3, line: 57, column: 6)
!4138 = !DILocation(line: 57, column: 13, scope: !4137)
!4139 = !DILocation(line: 57, column: 20, scope: !4137)
!4140 = !DILocation(line: 57, column: 6, scope: !4041)
!4141 = !DILocation(line: 58, column: 3, scope: !4137)
!4142 = !DILocation(line: 59, column: 47, scope: !4041)
!4143 = !DILocation(line: 59, column: 31, scope: !4041)
!4144 = !DILocation(line: 59, column: 2, scope: !4041)
!4145 = !DILocation(line: 59, column: 8, scope: !4041)
!4146 = !DILocation(line: 59, column: 15, scope: !4041)
!4147 = !DILocation(line: 59, column: 29, scope: !4041)
!4148 = !DILocation(line: 60, column: 7, scope: !4149)
!4149 = distinct !DILexicalBlock(scope: !4041, file: !3, line: 60, column: 6)
!4150 = !DILocation(line: 60, column: 13, scope: !4149)
!4151 = !DILocation(line: 60, column: 20, scope: !4149)
!4152 = !DILocation(line: 60, column: 6, scope: !4041)
!4153 = !DILocation(line: 61, column: 3, scope: !4149)
!4154 = !DILocation(line: 63, column: 22, scope: !4041)
!4155 = !DILocation(line: 63, column: 2, scope: !4041)
!4156 = !DILocation(line: 63, column: 8, scope: !4041)
!4157 = !DILocation(line: 63, column: 15, scope: !4041)
!4158 = !DILocation(line: 63, column: 20, scope: !4041)
!4159 = !DILocation(line: 64, column: 2, scope: !4041)
!4160 = !DILocation(line: 64, column: 8, scope: !4041)
!4161 = !DILocation(line: 64, column: 15, scope: !4041)
!4162 = !DILocation(line: 64, column: 23, scope: !4041)
!4163 = !DILocation(line: 65, column: 22, scope: !4041)
!4164 = !DILocation(line: 65, column: 2, scope: !4041)
!4165 = !DILocation(line: 65, column: 8, scope: !4041)
!4166 = !DILocation(line: 65, column: 15, scope: !4041)
!4167 = !DILocation(line: 65, column: 20, scope: !4041)
!4168 = !DILocation(line: 66, column: 22, scope: !4041)
!4169 = !DILocation(line: 66, column: 2, scope: !4041)
!4170 = !DILocation(line: 66, column: 8, scope: !4041)
!4171 = !DILocation(line: 66, column: 15, scope: !4041)
!4172 = !DILocation(line: 66, column: 20, scope: !4041)
!4173 = !DILocation(line: 67, column: 2, scope: !4041)
!4174 = !DILocation(line: 67, column: 8, scope: !4041)
!4175 = !DILocation(line: 67, column: 15, scope: !4041)
!4176 = !DILocation(line: 67, column: 23, scope: !4041)
!4177 = !DILocation(line: 68, column: 10, scope: !4041)
!4178 = !DILocation(line: 68, column: 14, scope: !4041)
!4179 = !DILocation(line: 68, column: 2, scope: !4041)
!4180 = !DILocation(line: 70, column: 4, scope: !4181)
!4181 = distinct !DILexicalBlock(scope: !4041, file: !3, line: 68, column: 25)
!4182 = !DILocation(line: 70, column: 10, scope: !4181)
!4183 = !DILocation(line: 70, column: 15, scope: !4181)
!4184 = !DILocation(line: 71, column: 4, scope: !4181)
!4185 = !DILocation(line: 73, column: 4, scope: !4181)
!4186 = !DILocation(line: 73, column: 10, scope: !4181)
!4187 = !DILocation(line: 73, column: 15, scope: !4181)
!4188 = !DILocation(line: 74, column: 4, scope: !4181)
!4189 = !DILocation(line: 76, column: 4, scope: !4181)
!4190 = !DILocation(line: 76, column: 10, scope: !4181)
!4191 = !DILocation(line: 76, column: 15, scope: !4181)
!4192 = !DILocation(line: 77, column: 2, scope: !4181)
!4193 = !DILocation(line: 78, column: 2, scope: !4041)
!4194 = !DILocation(line: 78, column: 8, scope: !4041)
!4195 = !DILocation(line: 78, column: 16, scope: !4041)
!4196 = !DILocation(line: 79, column: 14, scope: !4041)
!4197 = !DILocation(line: 79, column: 19, scope: !4041)
!4198 = !DILocation(line: 79, column: 2, scope: !4041)
!4199 = !DILocation(line: 79, column: 8, scope: !4041)
!4200 = !DILocation(line: 79, column: 12, scope: !4041)
!4201 = !DILocation(line: 80, column: 2, scope: !4041)
!4202 = !DILocation(line: 80, column: 8, scope: !4041)
!4203 = !DILocation(line: 80, column: 18, scope: !4041)
!4204 = !DILocation(line: 81, column: 2, scope: !4041)
!4205 = !DILocation(line: 81, column: 8, scope: !4041)
!4206 = !DILocation(line: 81, column: 16, scope: !4041)
!4207 = !DILocation(line: 83, column: 6, scope: !4208)
!4208 = distinct !DILexicalBlock(scope: !4041, file: !3, line: 83, column: 6)
!4209 = !DILocation(line: 83, column: 6, scope: !4041)
!4210 = !DILocation(line: 84, column: 3, scope: !4208)
!4211 = !DILocation(line: 86, column: 18, scope: !4041)
!4212 = !DILocation(line: 86, column: 23, scope: !4041)
!4213 = !DILocation(line: 86, column: 2, scope: !4041)
!4214 = !DILocation(line: 88, column: 2, scope: !4041)
!4215 = !DILabel(scope: !4041, name: "out_unmap", file: !3, line: 89)
!4216 = !DILocation(line: 89, column: 1, scope: !4041)
!4217 = !DILocation(line: 90, column: 10, scope: !4041)
!4218 = !DILocation(line: 90, column: 16, scope: !4041)
!4219 = !DILocation(line: 90, column: 23, scope: !4041)
!4220 = !DILocation(line: 90, column: 2, scope: !4041)
!4221 = !DILabel(scope: !4041, name: "out_release", file: !3, line: 91)
!4222 = !DILocation(line: 91, column: 1, scope: !4041)
!4223 = !DILocation(line: 92, column: 22, scope: !4041)
!4224 = !DILocation(line: 92, column: 2, scope: !4041)
!4225 = !DILabel(scope: !4041, name: "out_disable", file: !3, line: 93)
!4226 = !DILocation(line: 93, column: 1, scope: !4041)
!4227 = !DILocation(line: 94, column: 21, scope: !4041)
!4228 = !DILocation(line: 94, column: 2, scope: !4041)
!4229 = !DILabel(scope: !4041, name: "out_free", file: !3, line: 95)
!4230 = !DILocation(line: 95, column: 1, scope: !4041)
!4231 = !DILocation(line: 96, column: 9, scope: !4041)
!4232 = !DILocation(line: 96, column: 2, scope: !4041)
!4233 = !DILocation(line: 97, column: 2, scope: !4041)
!4234 = !DILocation(line: 98, column: 1, scope: !4041)
!4235 = distinct !DISubprogram(name: "hilscher_pci_remove", scope: !3, file: !3, line: 100, type: !3987, scopeLine: 101, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !290)
!4236 = !DILocalVariable(name: "dev", arg: 1, scope: !4235, file: !3, line: 100, type: !173)
!4237 = !DILocation(line: 100, column: 49, scope: !4235)
!4238 = !DILocalVariable(name: "info", scope: !4235, file: !3, line: 102, type: !4047)
!4239 = !DILocation(line: 102, column: 19, scope: !4235)
!4240 = !DILocation(line: 102, column: 42, scope: !4235)
!4241 = !DILocation(line: 102, column: 26, scope: !4235)
!4242 = !DILocation(line: 104, column: 24, scope: !4235)
!4243 = !DILocation(line: 104, column: 2, scope: !4235)
!4244 = !DILocation(line: 105, column: 22, scope: !4235)
!4245 = !DILocation(line: 105, column: 2, scope: !4235)
!4246 = !DILocation(line: 106, column: 21, scope: !4235)
!4247 = !DILocation(line: 106, column: 2, scope: !4235)
!4248 = !DILocation(line: 107, column: 10, scope: !4235)
!4249 = !DILocation(line: 107, column: 16, scope: !4235)
!4250 = !DILocation(line: 107, column: 23, scope: !4235)
!4251 = !DILocation(line: 107, column: 2, scope: !4235)
!4252 = !DILocation(line: 109, column: 9, scope: !4235)
!4253 = !DILocation(line: 109, column: 2, scope: !4235)
!4254 = !DILocation(line: 110, column: 1, scope: !4235)
!4255 = distinct !DISubprogram(name: "kzalloc", scope: !100, file: !100, line: 662, type: !4256, scopeLine: 663, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !290)
!4256 = !DISubroutineType(types: !4257)
!4257 = !{!112, !363, !110}
!4258 = !DILocalVariable(name: "s", arg: 1, scope: !4259, file: !100, line: 445, type: !968)
!4259 = distinct !DISubprogram(name: "kmem_cache_alloc_trace", scope: !100, file: !100, line: 445, type: !4260, scopeLine: 447, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !290)
!4260 = !DISubroutineType(types: !4261)
!4261 = !{!112, !968, !110, !363}
!4262 = !DILocation(line: 445, column: 72, scope: !4259, inlinedAt: !4263)
!4263 = distinct !DILocation(line: 552, column: 10, scope: !4264, inlinedAt: !4267)
!4264 = distinct !DILexicalBlock(scope: !4265, file: !100, line: 540, column: 34)
!4265 = distinct !DILexicalBlock(scope: !4266, file: !100, line: 540, column: 6)
!4266 = distinct !DISubprogram(name: "kmalloc", scope: !100, file: !100, line: 538, type: !4256, scopeLine: 539, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !290)
!4267 = distinct !DILocation(line: 664, column: 9, scope: !4255)
!4268 = !DILocalVariable(name: "flags", arg: 2, scope: !4259, file: !100, line: 446, type: !110)
!4269 = !DILocation(line: 446, column: 9, scope: !4259, inlinedAt: !4263)
!4270 = !DILocalVariable(name: "size", arg: 3, scope: !4259, file: !100, line: 446, type: !363)
!4271 = !DILocation(line: 446, column: 23, scope: !4259, inlinedAt: !4263)
!4272 = !DILocalVariable(name: "ret", scope: !4259, file: !100, line: 448, type: !112)
!4273 = !DILocation(line: 448, column: 8, scope: !4259, inlinedAt: !4263)
!4274 = !DILocalVariable(name: "flags", arg: 1, scope: !4275, file: !100, line: 318, type: !110)
!4275 = distinct !DISubprogram(name: "kmalloc_type", scope: !100, file: !100, line: 318, type: !4276, scopeLine: 319, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !290)
!4276 = !DISubroutineType(types: !4277)
!4277 = !{!99, !110}
!4278 = !DILocation(line: 318, column: 67, scope: !4275, inlinedAt: !4279)
!4279 = distinct !DILocation(line: 553, column: 20, scope: !4264, inlinedAt: !4267)
!4280 = !DILocalVariable(name: "size", arg: 1, scope: !4281, file: !100, line: 346, type: !363)
!4281 = distinct !DISubprogram(name: "kmalloc_index", scope: !100, file: !100, line: 346, type: !4282, scopeLine: 347, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !290)
!4282 = !DISubroutineType(types: !4283)
!4283 = !{!7, !363}
!4284 = !DILocation(line: 346, column: 58, scope: !4281, inlinedAt: !4285)
!4285 = distinct !DILocation(line: 547, column: 11, scope: !4264, inlinedAt: !4267)
!4286 = !DILocalVariable(name: "size", arg: 1, scope: !4287, file: !100, line: 472, type: !363)
!4287 = distinct !DISubprogram(name: "kmalloc_order_trace", scope: !100, file: !100, line: 472, type: !4288, scopeLine: 473, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !290)
!4288 = !DISubroutineType(types: !4289)
!4289 = !{!112, !363, !110, !7}
!4290 = !DILocation(line: 472, column: 28, scope: !4287, inlinedAt: !4291)
!4291 = distinct !DILocation(line: 481, column: 9, scope: !4292, inlinedAt: !4293)
!4292 = distinct !DISubprogram(name: "kmalloc_large", scope: !100, file: !100, line: 478, type: !4256, scopeLine: 479, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !290)
!4293 = distinct !DILocation(line: 545, column: 11, scope: !4294, inlinedAt: !4267)
!4294 = distinct !DILexicalBlock(scope: !4264, file: !100, line: 544, column: 7)
!4295 = !DILocalVariable(name: "flags", arg: 2, scope: !4287, file: !100, line: 472, type: !110)
!4296 = !DILocation(line: 472, column: 40, scope: !4287, inlinedAt: !4291)
!4297 = !DILocalVariable(name: "order", arg: 3, scope: !4287, file: !100, line: 472, type: !7)
!4298 = !DILocation(line: 472, column: 60, scope: !4287, inlinedAt: !4291)
!4299 = !DILocalVariable(name: "size", arg: 1, scope: !4292, file: !100, line: 478, type: !363)
!4300 = !DILocation(line: 478, column: 51, scope: !4292, inlinedAt: !4293)
!4301 = !DILocalVariable(name: "flags", arg: 2, scope: !4292, file: !100, line: 478, type: !110)
!4302 = !DILocation(line: 478, column: 63, scope: !4292, inlinedAt: !4293)
!4303 = !DILocalVariable(name: "order", scope: !4292, file: !100, line: 480, type: !7)
!4304 = !DILocation(line: 480, column: 15, scope: !4292, inlinedAt: !4293)
!4305 = !DILocalVariable(name: "size", arg: 1, scope: !4266, file: !100, line: 538, type: !363)
!4306 = !DILocation(line: 538, column: 45, scope: !4266, inlinedAt: !4267)
!4307 = !DILocalVariable(name: "flags", arg: 2, scope: !4266, file: !100, line: 538, type: !110)
!4308 = !DILocation(line: 538, column: 57, scope: !4266, inlinedAt: !4267)
!4309 = !DILocalVariable(name: "index", scope: !4264, file: !100, line: 542, type: !7)
!4310 = !DILocation(line: 542, column: 16, scope: !4264, inlinedAt: !4267)
!4311 = !DILocalVariable(name: "size", arg: 1, scope: !4255, file: !100, line: 662, type: !363)
!4312 = !DILocation(line: 662, column: 36, scope: !4255)
!4313 = !DILocalVariable(name: "flags", arg: 2, scope: !4255, file: !100, line: 662, type: !110)
!4314 = !DILocation(line: 662, column: 48, scope: !4255)
!4315 = !DILocation(line: 664, column: 17, scope: !4255)
!4316 = !DILocation(line: 664, column: 23, scope: !4255)
!4317 = !DILocation(line: 664, column: 29, scope: !4255)
!4318 = !DILocation(line: 540, column: 27, scope: !4265, inlinedAt: !4267)
!4319 = !DILocation(line: 540, column: 6, scope: !4265, inlinedAt: !4267)
!4320 = !DILocation(line: 540, column: 6, scope: !4266, inlinedAt: !4267)
!4321 = !DILocation(line: 544, column: 7, scope: !4294, inlinedAt: !4267)
!4322 = !DILocation(line: 544, column: 12, scope: !4294, inlinedAt: !4267)
!4323 = !DILocation(line: 544, column: 7, scope: !4264, inlinedAt: !4267)
!4324 = !DILocation(line: 545, column: 25, scope: !4294, inlinedAt: !4267)
!4325 = !DILocation(line: 545, column: 31, scope: !4294, inlinedAt: !4267)
!4326 = !DILocation(line: 480, column: 33, scope: !4292, inlinedAt: !4293)
!4327 = !DILocation(line: 480, column: 23, scope: !4292, inlinedAt: !4293)
!4328 = !DILocation(line: 481, column: 29, scope: !4292, inlinedAt: !4293)
!4329 = !DILocation(line: 481, column: 35, scope: !4292, inlinedAt: !4293)
!4330 = !DILocation(line: 481, column: 42, scope: !4292, inlinedAt: !4293)
!4331 = !DILocation(line: 474, column: 23, scope: !4287, inlinedAt: !4291)
!4332 = !DILocation(line: 474, column: 29, scope: !4287, inlinedAt: !4291)
!4333 = !DILocation(line: 474, column: 36, scope: !4287, inlinedAt: !4291)
!4334 = !DILocation(line: 474, column: 9, scope: !4287, inlinedAt: !4291)
!4335 = !DILocation(line: 545, column: 4, scope: !4294, inlinedAt: !4267)
!4336 = !DILocation(line: 547, column: 25, scope: !4264, inlinedAt: !4267)
!4337 = !DILocation(line: 348, column: 7, scope: !4338, inlinedAt: !4285)
!4338 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 348, column: 6)
!4339 = !DILocation(line: 348, column: 6, scope: !4281, inlinedAt: !4285)
!4340 = !DILocation(line: 349, column: 3, scope: !4338, inlinedAt: !4285)
!4341 = !DILocation(line: 351, column: 6, scope: !4342, inlinedAt: !4285)
!4342 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 351, column: 6)
!4343 = !DILocation(line: 351, column: 11, scope: !4342, inlinedAt: !4285)
!4344 = !DILocation(line: 351, column: 6, scope: !4281, inlinedAt: !4285)
!4345 = !DILocation(line: 352, column: 3, scope: !4342, inlinedAt: !4285)
!4346 = !DILocation(line: 354, column: 32, scope: !4347, inlinedAt: !4285)
!4347 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 354, column: 6)
!4348 = !DILocation(line: 354, column: 37, scope: !4347, inlinedAt: !4285)
!4349 = !DILocation(line: 354, column: 42, scope: !4347, inlinedAt: !4285)
!4350 = !DILocation(line: 354, column: 45, scope: !4347, inlinedAt: !4285)
!4351 = !DILocation(line: 354, column: 50, scope: !4347, inlinedAt: !4285)
!4352 = !DILocation(line: 354, column: 6, scope: !4281, inlinedAt: !4285)
!4353 = !DILocation(line: 355, column: 3, scope: !4347, inlinedAt: !4285)
!4354 = !DILocation(line: 356, column: 32, scope: !4355, inlinedAt: !4285)
!4355 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 356, column: 6)
!4356 = !DILocation(line: 356, column: 37, scope: !4355, inlinedAt: !4285)
!4357 = !DILocation(line: 356, column: 43, scope: !4355, inlinedAt: !4285)
!4358 = !DILocation(line: 356, column: 46, scope: !4355, inlinedAt: !4285)
!4359 = !DILocation(line: 356, column: 51, scope: !4355, inlinedAt: !4285)
!4360 = !DILocation(line: 356, column: 6, scope: !4281, inlinedAt: !4285)
!4361 = !DILocation(line: 357, column: 3, scope: !4355, inlinedAt: !4285)
!4362 = !DILocation(line: 358, column: 6, scope: !4363, inlinedAt: !4285)
!4363 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 358, column: 6)
!4364 = !DILocation(line: 358, column: 11, scope: !4363, inlinedAt: !4285)
!4365 = !DILocation(line: 358, column: 6, scope: !4281, inlinedAt: !4285)
!4366 = !DILocation(line: 358, column: 26, scope: !4363, inlinedAt: !4285)
!4367 = !DILocation(line: 359, column: 6, scope: !4368, inlinedAt: !4285)
!4368 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 359, column: 6)
!4369 = !DILocation(line: 359, column: 11, scope: !4368, inlinedAt: !4285)
!4370 = !DILocation(line: 359, column: 6, scope: !4281, inlinedAt: !4285)
!4371 = !DILocation(line: 359, column: 26, scope: !4368, inlinedAt: !4285)
!4372 = !DILocation(line: 360, column: 6, scope: !4373, inlinedAt: !4285)
!4373 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 360, column: 6)
!4374 = !DILocation(line: 360, column: 11, scope: !4373, inlinedAt: !4285)
!4375 = !DILocation(line: 360, column: 6, scope: !4281, inlinedAt: !4285)
!4376 = !DILocation(line: 360, column: 26, scope: !4373, inlinedAt: !4285)
!4377 = !DILocation(line: 361, column: 6, scope: !4378, inlinedAt: !4285)
!4378 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 361, column: 6)
!4379 = !DILocation(line: 361, column: 11, scope: !4378, inlinedAt: !4285)
!4380 = !DILocation(line: 361, column: 6, scope: !4281, inlinedAt: !4285)
!4381 = !DILocation(line: 361, column: 26, scope: !4378, inlinedAt: !4285)
!4382 = !DILocation(line: 362, column: 6, scope: !4383, inlinedAt: !4285)
!4383 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 362, column: 6)
!4384 = !DILocation(line: 362, column: 11, scope: !4383, inlinedAt: !4285)
!4385 = !DILocation(line: 362, column: 6, scope: !4281, inlinedAt: !4285)
!4386 = !DILocation(line: 362, column: 26, scope: !4383, inlinedAt: !4285)
!4387 = !DILocation(line: 363, column: 6, scope: !4388, inlinedAt: !4285)
!4388 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 363, column: 6)
!4389 = !DILocation(line: 363, column: 11, scope: !4388, inlinedAt: !4285)
!4390 = !DILocation(line: 363, column: 6, scope: !4281, inlinedAt: !4285)
!4391 = !DILocation(line: 363, column: 26, scope: !4388, inlinedAt: !4285)
!4392 = !DILocation(line: 364, column: 6, scope: !4393, inlinedAt: !4285)
!4393 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 364, column: 6)
!4394 = !DILocation(line: 364, column: 11, scope: !4393, inlinedAt: !4285)
!4395 = !DILocation(line: 364, column: 6, scope: !4281, inlinedAt: !4285)
!4396 = !DILocation(line: 364, column: 26, scope: !4393, inlinedAt: !4285)
!4397 = !DILocation(line: 365, column: 6, scope: !4398, inlinedAt: !4285)
!4398 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 365, column: 6)
!4399 = !DILocation(line: 365, column: 11, scope: !4398, inlinedAt: !4285)
!4400 = !DILocation(line: 365, column: 6, scope: !4281, inlinedAt: !4285)
!4401 = !DILocation(line: 365, column: 26, scope: !4398, inlinedAt: !4285)
!4402 = !DILocation(line: 366, column: 6, scope: !4403, inlinedAt: !4285)
!4403 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 366, column: 6)
!4404 = !DILocation(line: 366, column: 11, scope: !4403, inlinedAt: !4285)
!4405 = !DILocation(line: 366, column: 6, scope: !4281, inlinedAt: !4285)
!4406 = !DILocation(line: 366, column: 26, scope: !4403, inlinedAt: !4285)
!4407 = !DILocation(line: 367, column: 6, scope: !4408, inlinedAt: !4285)
!4408 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 367, column: 6)
!4409 = !DILocation(line: 367, column: 11, scope: !4408, inlinedAt: !4285)
!4410 = !DILocation(line: 367, column: 6, scope: !4281, inlinedAt: !4285)
!4411 = !DILocation(line: 367, column: 26, scope: !4408, inlinedAt: !4285)
!4412 = !DILocation(line: 368, column: 6, scope: !4413, inlinedAt: !4285)
!4413 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 368, column: 6)
!4414 = !DILocation(line: 368, column: 11, scope: !4413, inlinedAt: !4285)
!4415 = !DILocation(line: 368, column: 6, scope: !4281, inlinedAt: !4285)
!4416 = !DILocation(line: 368, column: 26, scope: !4413, inlinedAt: !4285)
!4417 = !DILocation(line: 369, column: 6, scope: !4418, inlinedAt: !4285)
!4418 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 369, column: 6)
!4419 = !DILocation(line: 369, column: 11, scope: !4418, inlinedAt: !4285)
!4420 = !DILocation(line: 369, column: 6, scope: !4281, inlinedAt: !4285)
!4421 = !DILocation(line: 369, column: 26, scope: !4418, inlinedAt: !4285)
!4422 = !DILocation(line: 370, column: 6, scope: !4423, inlinedAt: !4285)
!4423 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 370, column: 6)
!4424 = !DILocation(line: 370, column: 11, scope: !4423, inlinedAt: !4285)
!4425 = !DILocation(line: 370, column: 6, scope: !4281, inlinedAt: !4285)
!4426 = !DILocation(line: 370, column: 26, scope: !4423, inlinedAt: !4285)
!4427 = !DILocation(line: 371, column: 6, scope: !4428, inlinedAt: !4285)
!4428 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 371, column: 6)
!4429 = !DILocation(line: 371, column: 11, scope: !4428, inlinedAt: !4285)
!4430 = !DILocation(line: 371, column: 6, scope: !4281, inlinedAt: !4285)
!4431 = !DILocation(line: 371, column: 26, scope: !4428, inlinedAt: !4285)
!4432 = !DILocation(line: 372, column: 6, scope: !4433, inlinedAt: !4285)
!4433 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 372, column: 6)
!4434 = !DILocation(line: 372, column: 11, scope: !4433, inlinedAt: !4285)
!4435 = !DILocation(line: 372, column: 6, scope: !4281, inlinedAt: !4285)
!4436 = !DILocation(line: 372, column: 26, scope: !4433, inlinedAt: !4285)
!4437 = !DILocation(line: 373, column: 6, scope: !4438, inlinedAt: !4285)
!4438 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 373, column: 6)
!4439 = !DILocation(line: 373, column: 11, scope: !4438, inlinedAt: !4285)
!4440 = !DILocation(line: 373, column: 6, scope: !4281, inlinedAt: !4285)
!4441 = !DILocation(line: 373, column: 26, scope: !4438, inlinedAt: !4285)
!4442 = !DILocation(line: 374, column: 6, scope: !4443, inlinedAt: !4285)
!4443 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 374, column: 6)
!4444 = !DILocation(line: 374, column: 11, scope: !4443, inlinedAt: !4285)
!4445 = !DILocation(line: 374, column: 6, scope: !4281, inlinedAt: !4285)
!4446 = !DILocation(line: 374, column: 26, scope: !4443, inlinedAt: !4285)
!4447 = !DILocation(line: 375, column: 6, scope: !4448, inlinedAt: !4285)
!4448 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 375, column: 6)
!4449 = !DILocation(line: 375, column: 11, scope: !4448, inlinedAt: !4285)
!4450 = !DILocation(line: 375, column: 6, scope: !4281, inlinedAt: !4285)
!4451 = !DILocation(line: 375, column: 27, scope: !4448, inlinedAt: !4285)
!4452 = !DILocation(line: 376, column: 6, scope: !4453, inlinedAt: !4285)
!4453 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 376, column: 6)
!4454 = !DILocation(line: 376, column: 11, scope: !4453, inlinedAt: !4285)
!4455 = !DILocation(line: 376, column: 6, scope: !4281, inlinedAt: !4285)
!4456 = !DILocation(line: 376, column: 32, scope: !4453, inlinedAt: !4285)
!4457 = !DILocation(line: 377, column: 6, scope: !4458, inlinedAt: !4285)
!4458 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 377, column: 6)
!4459 = !DILocation(line: 377, column: 11, scope: !4458, inlinedAt: !4285)
!4460 = !DILocation(line: 377, column: 6, scope: !4281, inlinedAt: !4285)
!4461 = !DILocation(line: 377, column: 32, scope: !4458, inlinedAt: !4285)
!4462 = !DILocation(line: 378, column: 6, scope: !4463, inlinedAt: !4285)
!4463 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 378, column: 6)
!4464 = !DILocation(line: 378, column: 11, scope: !4463, inlinedAt: !4285)
!4465 = !DILocation(line: 378, column: 6, scope: !4281, inlinedAt: !4285)
!4466 = !DILocation(line: 378, column: 32, scope: !4463, inlinedAt: !4285)
!4467 = !DILocation(line: 379, column: 6, scope: !4468, inlinedAt: !4285)
!4468 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 379, column: 6)
!4469 = !DILocation(line: 379, column: 11, scope: !4468, inlinedAt: !4285)
!4470 = !DILocation(line: 379, column: 6, scope: !4281, inlinedAt: !4285)
!4471 = !DILocation(line: 379, column: 33, scope: !4468, inlinedAt: !4285)
!4472 = !DILocation(line: 380, column: 6, scope: !4473, inlinedAt: !4285)
!4473 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 380, column: 6)
!4474 = !DILocation(line: 380, column: 11, scope: !4473, inlinedAt: !4285)
!4475 = !DILocation(line: 380, column: 6, scope: !4281, inlinedAt: !4285)
!4476 = !DILocation(line: 380, column: 33, scope: !4473, inlinedAt: !4285)
!4477 = !DILocation(line: 381, column: 6, scope: !4478, inlinedAt: !4285)
!4478 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 381, column: 6)
!4479 = !DILocation(line: 381, column: 11, scope: !4478, inlinedAt: !4285)
!4480 = !DILocation(line: 381, column: 6, scope: !4281, inlinedAt: !4285)
!4481 = !DILocation(line: 381, column: 33, scope: !4478, inlinedAt: !4285)
!4482 = !DILocation(line: 382, column: 2, scope: !4483, inlinedAt: !4285)
!4483 = distinct !DILexicalBlock(scope: !4484, file: !100, line: 382, column: 2)
!4484 = distinct !DILexicalBlock(scope: !4281, file: !100, line: 382, column: 2)
!4485 = !{i32 -2143277350, i32 -2143277321, i32 -2143277275, i32 -2143277217, i32 -2143277163, i32 -2143277109, i32 -2143277054, i32 -2143277023}
!4486 = !DILocation(line: 382, column: 2, scope: !4487, inlinedAt: !4285)
!4487 = distinct !DILexicalBlock(scope: !4488, file: !100, line: 382, column: 2)
!4488 = distinct !DILexicalBlock(scope: !4484, file: !100, line: 382, column: 2)
!4489 = !{i32 -2143276580, i32 -2143276573, i32 -2143276519, i32 -2143276488, i32 -2143276458}
!4490 = !DILocation(line: 382, column: 2, scope: !4488, inlinedAt: !4285)
!4491 = !DILocation(line: 386, column: 1, scope: !4281, inlinedAt: !4285)
!4492 = !DILocation(line: 547, column: 9, scope: !4264, inlinedAt: !4267)
!4493 = !DILocation(line: 549, column: 8, scope: !4494, inlinedAt: !4267)
!4494 = distinct !DILexicalBlock(scope: !4264, file: !100, line: 549, column: 7)
!4495 = !DILocation(line: 549, column: 7, scope: !4264, inlinedAt: !4267)
!4496 = !DILocation(line: 550, column: 4, scope: !4494, inlinedAt: !4267)
!4497 = !DILocation(line: 553, column: 33, scope: !4264, inlinedAt: !4267)
!4498 = !DILocation(line: 325, column: 6, scope: !4499, inlinedAt: !4279)
!4499 = distinct !DILexicalBlock(scope: !4275, file: !100, line: 325, column: 6)
!4500 = !DILocation(line: 325, column: 6, scope: !4275, inlinedAt: !4279)
!4501 = !DILocation(line: 326, column: 3, scope: !4499, inlinedAt: !4279)
!4502 = !DILocation(line: 332, column: 9, scope: !4275, inlinedAt: !4279)
!4503 = !DILocation(line: 332, column: 15, scope: !4275, inlinedAt: !4279)
!4504 = !DILocation(line: 332, column: 2, scope: !4275, inlinedAt: !4279)
!4505 = !DILocation(line: 336, column: 1, scope: !4275, inlinedAt: !4279)
!4506 = !DILocation(line: 553, column: 5, scope: !4264, inlinedAt: !4267)
!4507 = !DILocation(line: 553, column: 41, scope: !4264, inlinedAt: !4267)
!4508 = !DILocation(line: 554, column: 5, scope: !4264, inlinedAt: !4267)
!4509 = !DILocation(line: 554, column: 12, scope: !4264, inlinedAt: !4267)
!4510 = !DILocation(line: 448, column: 31, scope: !4259, inlinedAt: !4263)
!4511 = !DILocation(line: 448, column: 34, scope: !4259, inlinedAt: !4263)
!4512 = !DILocation(line: 448, column: 14, scope: !4259, inlinedAt: !4263)
!4513 = !DILocation(line: 450, column: 22, scope: !4259, inlinedAt: !4263)
!4514 = !DILocation(line: 450, column: 25, scope: !4259, inlinedAt: !4263)
!4515 = !DILocation(line: 450, column: 30, scope: !4259, inlinedAt: !4263)
!4516 = !DILocation(line: 450, column: 36, scope: !4259, inlinedAt: !4263)
!4517 = !DILocation(line: 450, column: 8, scope: !4259, inlinedAt: !4263)
!4518 = !DILocation(line: 450, column: 6, scope: !4259, inlinedAt: !4263)
!4519 = !DILocation(line: 451, column: 9, scope: !4259, inlinedAt: !4263)
!4520 = !DILocation(line: 552, column: 3, scope: !4264, inlinedAt: !4267)
!4521 = !DILocation(line: 557, column: 19, scope: !4266, inlinedAt: !4267)
!4522 = !DILocation(line: 557, column: 25, scope: !4266, inlinedAt: !4267)
!4523 = !DILocation(line: 557, column: 9, scope: !4266, inlinedAt: !4267)
!4524 = !DILocation(line: 557, column: 2, scope: !4266, inlinedAt: !4267)
!4525 = !DILocation(line: 558, column: 1, scope: !4266, inlinedAt: !4267)
!4526 = !DILocation(line: 664, column: 2, scope: !4255)
!4527 = distinct !DISubprogram(name: "hilscher_handler", scope: !3, file: !3, line: 27, type: !4098, scopeLine: 28, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !290)
!4528 = !DILocalVariable(name: "irq", arg: 1, scope: !4527, file: !3, line: 27, type: !172)
!4529 = !DILocation(line: 27, column: 41, scope: !4527)
!4530 = !DILocalVariable(name: "dev_info", arg: 2, scope: !4527, file: !3, line: 27, type: !4047)
!4531 = !DILocation(line: 27, column: 63, scope: !4527)
!4532 = !DILocalVariable(name: "plx_intscr", scope: !4527, file: !3, line: 29, type: !112)
!4533 = !DILocation(line: 29, column: 16, scope: !4527)
!4534 = !DILocation(line: 29, column: 29, scope: !4527)
!4535 = !DILocation(line: 29, column: 39, scope: !4527)
!4536 = !DILocation(line: 29, column: 46, scope: !4527)
!4537 = !DILocation(line: 30, column: 6, scope: !4527)
!4538 = !DILocation(line: 32, column: 15, scope: !4539)
!4539 = distinct !DILexicalBlock(scope: !4527, file: !3, line: 32, column: 6)
!4540 = !DILocation(line: 32, column: 7, scope: !4539)
!4541 = !DILocation(line: 32, column: 27, scope: !4539)
!4542 = !DILocation(line: 33, column: 6, scope: !4539)
!4543 = !DILocation(line: 32, column: 6, scope: !4527)
!4544 = !DILocation(line: 34, column: 3, scope: !4539)
!4545 = !DILocation(line: 37, column: 19, scope: !4527)
!4546 = !DILocation(line: 37, column: 11, scope: !4527)
!4547 = !DILocation(line: 37, column: 31, scope: !4527)
!4548 = !DILocation(line: 37, column: 54, scope: !4527)
!4549 = !DILocation(line: 37, column: 2, scope: !4527)
!4550 = !DILocation(line: 38, column: 2, scope: !4527)
!4551 = !DILocation(line: 39, column: 1, scope: !4527)
!4552 = distinct !DISubprogram(name: "pci_set_drvdata", scope: !141, file: !141, line: 1870, type: !4553, scopeLine: 1871, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !290)
!4553 = !DISubroutineType(types: !4554)
!4554 = !{null, !173, !112}
!4555 = !DILocalVariable(name: "pdev", arg: 1, scope: !4552, file: !141, line: 1870, type: !173)
!4556 = !DILocation(line: 1870, column: 52, scope: !4552)
!4557 = !DILocalVariable(name: "data", arg: 2, scope: !4552, file: !141, line: 1870, type: !112)
!4558 = !DILocation(line: 1870, column: 64, scope: !4552)
!4559 = !DILocation(line: 1872, column: 19, scope: !4552)
!4560 = !DILocation(line: 1872, column: 25, scope: !4552)
!4561 = !DILocation(line: 1872, column: 30, scope: !4552)
!4562 = !DILocation(line: 1872, column: 2, scope: !4552)
!4563 = !DILocation(line: 1873, column: 1, scope: !4552)
!4564 = distinct !DISubprogram(name: "get_order", scope: !4565, file: !4565, line: 29, type: !4566, scopeLine: 30, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !290)
!4565 = !DIFile(filename: "./include/asm-generic/getorder.h", directory: "/home/lizy2001/genbc/linux")
!4566 = !DISubroutineType(types: !4567)
!4567 = !{!172, !167}
!4568 = !DILocalVariable(name: "x", arg: 1, scope: !4569, file: !4570, line: 366, type: !198)
!4569 = distinct !DISubprogram(name: "fls64", scope: !4570, file: !4570, line: 366, type: !4571, scopeLine: 367, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !290)
!4570 = !DIFile(filename: "./arch/x86/include/asm/bitops.h", directory: "/home/lizy2001/genbc/linux")
!4571 = !DISubroutineType(types: !4572)
!4572 = !{!172, !198}
!4573 = !DILocation(line: 366, column: 40, scope: !4569, inlinedAt: !4574)
!4574 = distinct !DILocation(line: 46, column: 9, scope: !4564)
!4575 = !DILocalVariable(name: "bitpos", scope: !4569, file: !4570, line: 368, type: !172)
!4576 = !DILocation(line: 368, column: 6, scope: !4569, inlinedAt: !4574)
!4577 = !DILocalVariable(name: "size", arg: 1, scope: !4564, file: !4565, line: 29, type: !167)
!4578 = !DILocation(line: 29, column: 63, scope: !4564)
!4579 = !DILocation(line: 31, column: 27, scope: !4580)
!4580 = distinct !DILexicalBlock(scope: !4564, file: !4565, line: 31, column: 6)
!4581 = !DILocation(line: 31, column: 6, scope: !4580)
!4582 = !DILocation(line: 31, column: 6, scope: !4564)
!4583 = !DILocation(line: 32, column: 8, scope: !4584)
!4584 = distinct !DILexicalBlock(scope: !4585, file: !4565, line: 32, column: 7)
!4585 = distinct !DILexicalBlock(scope: !4580, file: !4565, line: 31, column: 34)
!4586 = !DILocation(line: 32, column: 7, scope: !4585)
!4587 = !DILocation(line: 33, column: 4, scope: !4584)
!4588 = !DILocation(line: 35, column: 7, scope: !4589)
!4589 = distinct !DILexicalBlock(scope: !4585, file: !4565, line: 35, column: 7)
!4590 = !DILocation(line: 35, column: 12, scope: !4589)
!4591 = !DILocation(line: 35, column: 7, scope: !4585)
!4592 = !DILocation(line: 36, column: 4, scope: !4589)
!4593 = !DILocation(line: 38, column: 10, scope: !4585)
!4594 = !DILocation(line: 38, column: 28, scope: !4585)
!4595 = !DILocation(line: 38, column: 41, scope: !4585)
!4596 = !DILocation(line: 38, column: 3, scope: !4585)
!4597 = !DILocation(line: 41, column: 6, scope: !4564)
!4598 = !DILocation(line: 42, column: 7, scope: !4564)
!4599 = !DILocation(line: 46, column: 15, scope: !4564)
!4600 = !DILocation(line: 374, column: 2, scope: !4569, inlinedAt: !4574)
!4601 = !DILocation(line: 376, column: 14, scope: !4569, inlinedAt: !4574)
!4602 = !{i32 378519}
!4603 = !DILocation(line: 377, column: 9, scope: !4569, inlinedAt: !4574)
!4604 = !DILocation(line: 377, column: 16, scope: !4569, inlinedAt: !4574)
!4605 = !DILocation(line: 46, column: 2, scope: !4564)
!4606 = !DILocation(line: 48, column: 1, scope: !4564)
!4607 = distinct !DISubprogram(name: "__ilog2_u64", scope: !4608, file: !4608, line: 30, type: !4609, scopeLine: 31, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !290)
!4608 = !DIFile(filename: "./include/linux/log2.h", directory: "/home/lizy2001/genbc/linux")
!4609 = !DISubroutineType(types: !4610)
!4610 = !{!172, !196}
!4611 = !DILocation(line: 366, column: 40, scope: !4569, inlinedAt: !4612)
!4612 = distinct !DILocation(line: 32, column: 9, scope: !4607)
!4613 = !DILocation(line: 368, column: 6, scope: !4569, inlinedAt: !4612)
!4614 = !DILocalVariable(name: "n", arg: 1, scope: !4607, file: !4608, line: 30, type: !196)
!4615 = !DILocation(line: 30, column: 21, scope: !4607)
!4616 = !DILocation(line: 32, column: 15, scope: !4607)
!4617 = !DILocation(line: 374, column: 2, scope: !4569, inlinedAt: !4612)
!4618 = !DILocation(line: 376, column: 14, scope: !4569, inlinedAt: !4612)
!4619 = !DILocation(line: 377, column: 9, scope: !4569, inlinedAt: !4612)
!4620 = !DILocation(line: 377, column: 16, scope: !4569, inlinedAt: !4612)
!4621 = !DILocation(line: 32, column: 18, scope: !4607)
!4622 = !DILocation(line: 32, column: 2, scope: !4607)
!4623 = distinct !DISubprogram(name: "kasan_kmalloc", scope: !4624, file: !4624, line: 137, type: !4625, scopeLine: 139, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !290)
!4624 = !DIFile(filename: "./include/linux/kasan.h", directory: "/home/lizy2001/genbc/linux")
!4625 = !DISubroutineType(types: !4626)
!4626 = !{!112, !968, !2155, !363, !110}
!4627 = !DILocalVariable(name: "s", arg: 1, scope: !4623, file: !4624, line: 137, type: !968)
!4628 = !DILocation(line: 137, column: 54, scope: !4623)
!4629 = !DILocalVariable(name: "object", arg: 2, scope: !4623, file: !4624, line: 137, type: !2155)
!4630 = !DILocation(line: 137, column: 69, scope: !4623)
!4631 = !DILocalVariable(name: "size", arg: 3, scope: !4623, file: !4624, line: 138, type: !363)
!4632 = !DILocation(line: 138, column: 12, scope: !4623)
!4633 = !DILocalVariable(name: "flags", arg: 4, scope: !4623, file: !4624, line: 138, type: !110)
!4634 = !DILocation(line: 138, column: 24, scope: !4623)
!4635 = !DILocation(line: 140, column: 17, scope: !4623)
!4636 = !DILocation(line: 140, column: 2, scope: !4623)
!4637 = distinct !DISubprogram(name: "dev_set_drvdata", scope: !73, file: !73, line: 660, type: !4638, scopeLine: 661, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !290)
!4638 = !DISubroutineType(types: !4639)
!4639 = !{null, !259, !112}
!4640 = !DILocalVariable(name: "dev", arg: 1, scope: !4637, file: !73, line: 660, type: !259)
!4641 = !DILocation(line: 660, column: 51, scope: !4637)
!4642 = !DILocalVariable(name: "data", arg: 2, scope: !4637, file: !73, line: 660, type: !112)
!4643 = !DILocation(line: 660, column: 62, scope: !4637)
!4644 = !DILocation(line: 662, column: 21, scope: !4637)
!4645 = !DILocation(line: 662, column: 2, scope: !4637)
!4646 = !DILocation(line: 662, column: 7, scope: !4637)
!4647 = !DILocation(line: 662, column: 19, scope: !4637)
!4648 = !DILocation(line: 663, column: 1, scope: !4637)
!4649 = distinct !DISubprogram(name: "pci_get_drvdata", scope: !141, file: !141, line: 1865, type: !4650, scopeLine: 1866, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !290)
!4650 = !DISubroutineType(types: !4651)
!4651 = !{!112, !173}
!4652 = !DILocalVariable(name: "pdev", arg: 1, scope: !4649, file: !141, line: 1865, type: !173)
!4653 = !DILocation(line: 1865, column: 53, scope: !4649)
!4654 = !DILocation(line: 1867, column: 26, scope: !4649)
!4655 = !DILocation(line: 1867, column: 32, scope: !4649)
!4656 = !DILocation(line: 1867, column: 9, scope: !4649)
!4657 = !DILocation(line: 1867, column: 2, scope: !4649)
!4658 = distinct !DISubprogram(name: "dev_get_drvdata", scope: !73, file: !73, line: 655, type: !4659, scopeLine: 656, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !290)
!4659 = !DISubroutineType(types: !4660)
!4660 = !{!112, !3735}
!4661 = !DILocalVariable(name: "dev", arg: 1, scope: !4658, file: !73, line: 655, type: !3735)
!4662 = !DILocation(line: 655, column: 58, scope: !4658)
!4663 = !DILocation(line: 657, column: 9, scope: !4658)
!4664 = !DILocation(line: 657, column: 14, scope: !4658)
!4665 = !DILocation(line: 657, column: 2, scope: !4658)
